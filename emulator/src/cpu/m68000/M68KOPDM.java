...
/*TODO*///
/*TODO*///
/*TODO*///void m68000_move_pd7_al_8(void)
/*TODO*///{
/*TODO*///	uint res = m68ki_read_8(EA_AL);
/*TODO*///	uint ea_dst = CPU_A[7] -= 2;
/*TODO*///
...
/*TODO*///
/*TODO*///
/*TODO*///void m68000_muls_ix_16(void)
/*TODO*///{
/*TODO*///	uint *d_dst = &DX;
/*TODO*///	uint res = MAKE_INT_16(m68ki_read_16(EA_IX)) * MAKE_INT_16(MASK_OUT_ABOVE_16(*d_dst));
/*TODO*///
/*TODO*///	*d_dst = res;
/*TODO*///
/*TODO*///	CPU_NOT_Z = res;
