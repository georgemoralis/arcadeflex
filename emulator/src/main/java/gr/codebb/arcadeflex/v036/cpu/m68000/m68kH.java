...
public class m68kH {
    ...
    public static class m68k_cpu_context {
        ...
        public long[] dr = new long[8];
        /* Data Registers */
        public long[] ar = new long[8];
        /* Address Registers */
        public long ppc;
        /* Previous program counter */
        public long pc;
        /* Program Counter */
        public long[] sp = new long[4];
        /* User, Interrupt, and Master Stack Pointers */
        public long vbr;
        ...
        public long cacr;
        /* Cache Control Register (m68020+) */
        public long caar;
        /* Cache Address Register (m68020+) */
        public long ir;
        ...
        public long n_flag;
        /* Negative */
        public long not_z_flag;
        /* Zero, inverted for speedups */
        public long v_flag;
        /* Overflow */
        public long c_flag;
        /* Carry */
        public long int_mask;
        /* I0-I2 */
        public long int_state;
        ...
        public long pref_addr;
        /* Last prefetch address */
        public long pref_data;
        /* Data in the prefetch queue */

 /* Callbacks to host */
        IrqCallbackHandlerPtr int_ack_callback;
        /* Interrupt Acknowledge */
        bkpt_ack_callbackPtr bkpt_ack_callback;
        /* Breakpoint Acknowledge */
        reset_instr_callbackPtr reset_instr_callback;
        /* Called when a RESET instruction is encountered */
        pc_changed_callbackPtr pc_changed_callback;
        /* Called when the PC changes by a large amount */
        set_fc_callbackPtr set_fc_callback;
        /* Called when the CPU function code changes */
        instr_hook_callbackPtr instr_hook_callback;
