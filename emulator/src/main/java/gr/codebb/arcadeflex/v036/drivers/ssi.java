...
public class ssi
{
	...
	static InputPortHandlerPtr input_ports_ssi = new InputPortHandlerPtr(){ public void handler() { 
		PORT_START();       /* IN0 */
	...
	static InputPortHandlerPtr input_ports_majest12 = new InputPortHandlerPtr(){ public void handler() { 
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );
	...
	***************************************************************************/
	...
	static RomLoadHandlerPtr rom_ssi = new RomLoadHandlerPtr(){ public void handler(){ 
	...
	static RomLoadHandlerPtr rom_majest12 = new RomLoadHandlerPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );    /* 512k for 68000 code */
