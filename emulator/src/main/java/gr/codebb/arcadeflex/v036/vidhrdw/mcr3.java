...
public class mcr3
{
	...
	static int[][] dotron_palettes=new int[3][3*256];
	...
	static void mcr3_update_sprites(osd_bitmap bitmap, int color_mask, int code_xor, int dx, int dy)
	{
		int offs;
	...
	public static VhUpdatePtr mcr3_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	 ...
	 *
	 *************************************/
	static rectangle clip = new rectangle( 0, 30*16-1, 0, 30*16-1 );
        
	public static VhUpdatePtr spyhunt_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
...
/*TODO*///			buffer=sprintf( "%s  %s  %s  %s  %s",
/*TODO*///					spyhunt_lamp[0]!=0 ? "OIL" : "   ",
/*TODO*///					spyhunt_lamp[1]!=0 ? "MISSILE" : "       ",
/*TODO*///					spyhunt_lamp[2]!=0 ? "VAN" : "   ",
/*TODO*///					spyhunt_lamp[3]!=0 ? "SMOKE" : "     ",
...
/*TODO*///		}
	...
	static void dotron_change_light(int light)
	{
		light_status = light;
	}
	...
	{
		UBytePtr new_palette=new UBytePtr();
		int i, offset;
...
/*TODO*///			palette_change_color(i + offset, new_palette[i * 3], new_palette[i * 3 + 1], new_palette[i * 3 + 2]);
	...
	public static VhUpdatePtr dotron_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
