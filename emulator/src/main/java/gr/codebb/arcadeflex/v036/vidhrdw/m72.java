...
public class m72 {
    ...
    public static InitMachineHandlerPtr m72_init_machine = new InitMachineHandlerPtr() {
        public void handler() {
            int i;
    ...
    public static InitMachineHandlerPtr xmultipl_init_machine = new InitMachineHandlerPtr() {
        public void handler() {
            irq1 = 0x08;
            irq2 = 0x0a;
            m72_init_sound.handler();
     ...
     **************************************************************************
     */
    public static WriteHandlerPtr m72_get_bg_tile_info = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr m72_get_fg_tile_info = new WriteHandlerPtr() {
        public void handler(int col, int row) {
            int tile_index = 4 * (64 * row + col);
    ...
    public static WriteHandlerPtr dbreed_get_bg_tile_info = new WriteHandlerPtr() {
        public void handler(int col, int row) {
            int tile_index = 4 * (64 * row + col);
            /*unsigned*/ char attr = m72_videoram2.read(tile_index + 1);
            SET_TILE_INFO(2, m72_videoram2.read(tile_index) + ((attr & 0x3f) << 8), m72_videoram2.read(tile_index + 2) & 0x0f);
    ...
    public static WriteHandlerPtr rtype2_get_bg_tile_info = new WriteHandlerPtr() {
        public void handler(int col, int row) {
            int tile_index = 4 * (64 * row + col);
    ...
    public static WriteHandlerPtr rtype2_get_fg_tile_info = new WriteHandlerPtr() {
        public void handler(int col, int row) {
            int tile_index = 4 * (64 * row + col);
 ...
 /* (videoram[tile_index+3] & 0xfe) are used as well */
    ...
    public static WriteHandlerPtr majtitle_get_bg_tile_info = new WriteHandlerPtr() {
        public void handler(int col, int row) {
    ...
    public static WriteHandlerPtr hharry_get_bg_tile_info = new WriteHandlerPtr() {
        public void handler(int col, int row) {
            hharry_get_tile_info(1, m72_videoram2, col, row);
        }
    };

    public static WriteHandlerPtr hharry_get_fg_tile_info = new WriteHandlerPtr() {
        public void handler(int col, int row) {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr m72_vh_start = new VhStartHandlerPtr() {
        public int handler() {
            int i;
 ...
 /* layer enalbe register */
    ...
    public static VhStartHandlerPtr dbreed_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStartHandlerPtr rtype2_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStartHandlerPtr majtitle_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStartHandlerPtr hharry_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStopHandlerPtr m72_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
            m72_spriteram = null;
        }
    };
     ...
     **************************************************************************
     */
    public static ReadHandlerPtr m72_palette1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return paletteram.read(offset);
        }
    };

    public static ReadHandlerPtr m72_palette2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static WriteHandlerPtr m72_palette1_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr m72_palette2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr m72_videoram1_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return m72_videoram1.read(offset);
        }
    };

    public static ReadHandlerPtr m72_videoram2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return m72_videoram2.read(offset);
        }
    };

    public static WriteHandlerPtr m72_videoram1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr m72_videoram2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr majtitle_videoram2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (m72_videoram2.read(offset) != data) {
                m72_videoram2.write(offset, data);
    ...
    public static WriteHandlerPtr m72_irq_line_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            offset *= 8;
    ...
    public static WriteHandlerPtr m72_scrollx1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int i;
    ...
    public static WriteHandlerPtr m72_scrollx2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int i;
    ...
    public static WriteHandlerPtr m72_scrolly1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int i;
    ...
    public static WriteHandlerPtr m72_scrolly2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            int i;
    ...
    public static WriteHandlerPtr m72_spritectrl_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /* rtype2 uses bits 4,5,6 and 7 - of course it could be a different chip */
    ...
    public static WriteHandlerPtr hharry_spritectrl_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            //if (errorlog != 0) fprintf(errorlog,"%04x: write %02x to sprite ctrl+%d\n",cpu_get_pc(),data,offset);
            if (offset == 0) {
                memcpy(m72_spriteram, spriteram, spriteram_size[0]);
    ...
    public static WriteHandlerPtr hharryu_spritectrl_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            //if (errorlog != 0) fprintf(errorlog,"%04x: write %02x to sprite ctrl+%d\n",cpu_get_pc(),data,offset);
            if (offset == 1) {
                memcpy(m72_spriteram, spriteram, spriteram_size[0]);
 ...
 /* majtitle uses bits 2,3,5,6 and 7 - of course it could be a different chip */
    ...
    static void draw_layer(osd_bitmap bitmap,
        ...
        do {
            ...
            while (scrollx[i + 1] == scrollx[start] && scrolly[i + 1] == scrolly[start]
                ...
                i++;
                if (i == 255) {
                    break;//check the boundries of table (shadow)
                }
            }
    ...
    public static VhUpdateHandlerPtr m72_vh_screenrefresh = new VhUpdateHandlerPtr() {
    ...
    public static VhUpdateHandlerPtr dbreed_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            tilemap_set_clip(fg_tilemap, null);
            tilemap_set_clip(bg_tilemap, null);
    ...
    public static VhUpdateHandlerPtr majtitle_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int i;
