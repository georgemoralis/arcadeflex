...
public class ajax
{
	...
	*/
	...
	{
/*TODO*///		set_led_status(1,data & 0x02);	/* super weapon lamp */
/*TODO*///		set_led_status(2,data & 0x04);	/* power up lamps */
/*TODO*///		set_led_status(5,data & 0x04);	/* power up lamps */
/*TODO*///		set_led_status(0,data & 0x20);	/* start lamp */
/*TODO*///		set_led_status(3,data & 0x40);	/* game over lamps */
/*TODO*///		set_led_status(6,data & 0x40);	/* game over lamps */
/*TODO*///		set_led_status(4,data & 0x80);	/* game over lamps */
/*TODO*///		set_led_status(7,data & 0x80);	/* game over lamps */
	} };
