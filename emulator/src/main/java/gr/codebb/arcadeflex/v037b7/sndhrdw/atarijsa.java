...
/*TODO*///	/*************************************
/*TODO*///	 *
/*TODO*///	 *	JSA I I/O handlers
/*TODO*///	 *
/*TODO*///	 *************************************/
/*TODO*///	
/*TODO*///	public static ReadHandlerPtr jsa1_io_r  = new ReadHandlerPtr() { public int handler(int offset)
/*TODO*///	{
...
/*TODO*///					0x10 = TMS5220 ready (active low)
/*TODO*///					0x08 = +5V
/*TODO*///					0x04 = +5V
/*TODO*///					0x02 = coin 2
/*TODO*///					0x01 = coin 1
...
/*TODO*///				if (!has_tms5220 || tms5220_ready_r()) result ^= 0x10;
/*TODO*///				break;
/*TODO*///	
...
/*TODO*///	
/*TODO*///	
/*TODO*///	public static WriteHandlerPtr jsa1_io_w = new WriteHandlerPtr() {public void handler(int offset, int data)
/*TODO*///	{
/*TODO*///		switch (offset & 0x206)
/*TODO*///		{
/*TODO*///			case 0x000:		/* n/c */
...
/*TODO*///					0x08 = squeak (tweaks the 5220 frequency)
/*TODO*///					0x04 = TMS5220 reset (active low)
/*TODO*///					0x02 = TMS5220 write strobe (active low)
/*TODO*///					0x01 = YM2151 reset (active low)
/*TODO*///				*/
/*TODO*///	
/*TODO*///				/* handle TMS5220 I/O */
/*TODO*///				if (has_tms5220 != 0)
/*TODO*///				{
/*TODO*///					int count;
/*TODO*///	
/*TODO*///					if (((data ^ last_ctl) & 0x02) && (data & 0x02))
/*TODO*///						tms5220_data_w(0, speech_data);
/*TODO*///					count = 5 | ((data >> 2) & 2);
/*TODO*///					tms5220_set_frequency(ATARI_CLOCK_14MHz/2 / (16 - count));
/*TODO*///				}
/*TODO*///	
...
/*TODO*///			case 0x206:		/* MIX */
/*TODO*///				/*
/*TODO*///					0xc0 = TMS5220 volume (0-3)
/*TODO*///					0x30 = POKEY volume (0-3)
/*TODO*///					0x0e = YM2151 volume (0-7)
/*TODO*///					0x01 = low-pass filter enable
/*TODO*///				*/
/*TODO*///				tms5220_volume = ((data >> 6) & 3) * 100 / 3;
/*TODO*///				pokey_volume = ((data >> 4) & 3) * 100 / 3;
...
/*TODO*///		new MemoryWriteAddress( 0x2800, 0x2bff, jsa1_io_w ),
...
/*TODO*///	
/*TODO*///	
/*TODO*///	static YM2151interface atarijsa_ym2151_interface_stereo_swapped = new YM2151interface
/*TODO*///	(
/*TODO*///		1,			/* 1 chip */
/*TODO*///		ATARI_CLOCK_14MHz/4,
/*TODO*///		new int[] { YM3012_VOL(60,MIXER_PAN_RIGHT,60,MIXER_PAN_LEFT) },
/*TODO*///		new WriteYmHandlerPtr[] { atarigen_ym2151_irq_gen }
/*TODO*///	);
