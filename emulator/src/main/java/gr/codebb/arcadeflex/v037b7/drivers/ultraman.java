...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.ultraman.*;
import static gr.codebb.arcadeflex.v036.mame.memoryH.COMBINE_WORD;

public class ultraman
{
	
	public static UBytePtr  ultraman_regs = new UBytePtr();
	...
	{
		return K051316_2_r.handler(offset >> 1);
	} };
	...
	{
		if ((data & 0x00ff0000) == 0)
			K051316_2_w.handler(offset >> 1, data & 0xff);
	} };
	...
	{
		if ((data & 0x00ff0000) == 0)
			K051316_ctrl_2_w.handler(offset >> 1, data & 0xff);
	} };
	...
	{
		int oldword = ultraman_regs.READ_WORD(offset);
		int newword = COMBINE_WORD(oldword, data);
	
		ultraman_regs.WRITE_WORD(offset,newword);
		...
		switch (offset){
			...
			case 0x30:	/* watchdog timer */
				watchdog_reset_w.handler(0, newword & 0xff);
				break;
		}
	} };
