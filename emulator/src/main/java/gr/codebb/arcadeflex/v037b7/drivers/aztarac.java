...
import static arcadeflex.toberemoved.v036.vidhrdw.vector.vector_vh_stop;
import static arcadeflex.toberemoved.v036.vidhrdw.vector.vector_vh_update;
...
import static arcadeflex.toberemoved.v036.machine.foodf.foodf_nvram_handler;
import static arcadeflex.toberemoved.v036.machine.foodf.foodf_nvram_r;
import static arcadeflex.toberemoved.v036.machine.foodf.foodf_nvram_w;
...
public class aztarac {
 ...
 /* from sndhrdw/aztarac.c */
    public static ReadHandlerPtr aztarac_joystick_r = new ReadHandlerPtr() {
    ...
    static InputPortHandlerPtr input_ports_aztarac = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_aztarac = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    public static InitDriverHandlerPtr init_aztarac = new InitDriverHandlerPtr() {
        public void handler() {
