...
import static gr.codebb.arcadeflex.v037b7.sndhrdw.mcrH.SOUND_CPU_SSIO;
import static gr.codebb.arcadeflex.v037b7.sndhrdw.mcrH.SOUND_SSIO;
...
/*TODO*///	extern UINT8 spyhunt_sprite_color_mask;
/*TODO*///	extern INT16 spyhunt_scroll_offset;
/*TODO*///	extern UINT8 spyhunt_draw_lamps;
/*TODO*///	extern UINT8 spyhunt_lamp[8];
	
/*TODO*///	extern UINT8 *spyhunt_alpharam;
/*TODO*///	extern size_t spyhunt_alpharam_size;
	
	
	
	
/*TODO*///	void dotron_change_light(int light);
...
/*TODO*///		csdeluxe_data_w(offset, data);
	...
	public static nvramPtr mcr3_nvram_handler  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
	...
	public static nvramPtr spyhunt_nvram_handler  = new nvramPtr() { public void handler(Object file, int read_or_write) 
	{
		UBytePtr ram = new UBytePtr(memory_region(REGION_CPU1));
...
/*TODO*///		new IOReadPort( 0x07, 0x07, ssio_status_r ),
...
/*TODO*///		new IOWritePort( 0x1c, 0x1f, ssio_data_w ),
	...
	(
		...
		2048,//RGN_FRAC(1,2),
		4,
		new int[] { 0x20000 * 8, 0x20000 * 8+1, 0, 1 },
...
/*TODO*///		ROM_LOAD( "ttprog1.bin",  0x2000, 0x2000, BADCRC( 0xb0505e18 );
...
/*TODO*///		install_mem_read_handler(1, 0x3000, 0x3fff, MRA_RAM);
/*TODO*///		install_mem_write_handler(1, 0x3000, 0x3fff, MWA_RAM);
	} };
...
/*TODO*///		MCR_CONFIGURE_SOUND(MCR_SSIO | MCR_SQUAWK_N_TALK);
	...
	public static InitDriverPtr init_destderb = new InitDriverPtr() { public void handler() 
	{
/*TODO*///		MCR_CONFIGURE_SOUND(MCR_TURBO_CHIP_SQUEAK);
/*TODO*///		install_port_write_handler(0, 0x04, 0x04, turbocs_data_w);
	} };
	
	
	public static InitDriverPtr init_destderm = new InitDriverPtr() { public void handler() 
	{
/*TODO*///		MCR_CONFIGURE_SOUND(MCR_TURBO_CHIP_SQUEAK);
/*TODO*///		install_port_write_handler(0, 0x06, 0x06, turbocs_data_w);
		mcrmono_decode();
	} };
...
/*TODO*///	public static GameDriver driver_destderb	   = new GameDriver("1984"	,"destderb"	,"mcr3.java"	,rom_destderb,null	,machine_driver_destderb	,input_ports_destderb	,init_destderb	,ROT0	,	"Bally Midway", "Demolition Derby" );
/*TODO*///	public static GameDriver driver_destderm	   = new GameDriver("1984"	,"destderm"	,"mcr3.java"	,rom_destderm,driver_destderb	,machine_driver_sarge	,input_ports_destderb	,init_destderm	,ROT0	,	"Bally Midway", "Demolition Derby (2-Player Mono Board Version)" );
/*TODO*///	public static GameDriver driver_sarge	   = new GameDriver("1985"	,"sarge"	,"mcr3.java"	,rom_sarge,null	,machine_driver_sarge	,input_ports_sarge	,init_sarge	,ROT0	,	"Bally Midway", "Sarge" );
