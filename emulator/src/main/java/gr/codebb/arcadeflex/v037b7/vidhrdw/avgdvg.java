...
import static gr.codebb.arcadeflex.v037b7.vidhrdw.avgdvgH.*;
...
/*TODO*///	#define BZONE_CLIP \
/*TODO*///		vector_add_clip (xmin<<VEC_SHIFT, BZONE_TOP<<VEC_SHIFT, \
/*TODO*///						xmax<<VEC_SHIFT, ymax<<VEC_SHIFT)
/*TODO*///	#define BZONE_NOCLIP \
/*TODO*///		vector_add_clip (xmin<<VEC_SHIFT, ymin <<VEC_SHIFT, \
/*TODO*///						xmax<<VEC_SHIFT, ymax<<VEC_SHIFT)

	public static final int MHAVOC_YWINDOW = 0x0048;
/*TODO*///	#define MHAVOC_CLIP \
/*TODO*///		vector_add_clip (xmin<<VEC_SHIFT, MHAVOC_YWINDOW<<VEC_SHIFT, \
/*TODO*///						xmax<<VEC_SHIFT, ymax<<VEC_SHIFT)
/*TODO*///	#define MHAVOC_NOCLIP \
/*TODO*///		vector_add_clip (xmin<<VEC_SHIFT, ymin <<VEC_SHIFT, \
/*TODO*///						xmax<<VEC_SHIFT, ymax<<VEC_SHIFT)
...
/*TODO*///	static int colorram.read(16); /* colorram entries */
	...
	public static int twos_comp_val(int num, int bits){ return ((num&(1<<(bits-1)))!=0?(num|~((1<<bits)-1)):(num&((1<<bits)-1))); }
...
/*TODO*///			     "jsrl", "rtsl", "jmpl", "svec" };
	...
	public static int VECTORRAM(int offset){ return (vectorbank[(offset)>>BANK_BITS].read(offset)&(BANK_SIZE-1)); }
	static UBytePtr[] vectorbank = new UBytePtr[NUM_BANKS];

	public static int map_addr(int n){ return (((n)<<1)); }
	public static int memrdwd(int offset){ return (VECTORRAM(offset) | (VECTORRAM(offset+1)<<8)); }
	/* The AVG used by Star Wars reads the bytes in the opposite order */
	public static int memrdwd_flip(int offset){ return (VECTORRAM(offset+1) | (VECTORRAM(offset)<<8)); }
...
/*TODO*///	public static WriteHandlerPtr avgdvg_reset_w = new WriteHandlerPtr() {public void handler(int offset, int data)
/*TODO*///	{
...
/*TODO*///	#endif
	...
	static void avg_init_palette (int paltype, char[] palette, char[] colortable, UBytePtr color_prom)
	{
		...
		/* initialize the colorram */
                colorram = new UBytePtr(128*1024);
		for (i = 0; i < 16; i++)
...
/*TODO*///		int trans[]= { 7, 15, 3, 11, 6, 14, 2, 10, 5, 13, 1,  9, 4, 12, 0,  8 };
/*TODO*///	#else /* high intensity */
/*TODO*///		int trans[]= { 7,  7, 3,  3, 6,  6, 2,  2, 5,  5, 1,  1, 4,  4, 0,  0 };
/*TODO*///	#endif
...
/*TODO*///	{
/*TODO*///	#if 0 /* with low intensity bit */
/*TODO*///		int trans[]= { 7, 6, 5, 4, 15, 14, 13, 12, 3, 2, 1, 0, 11, 10, 9, 8 };
/*TODO*///	#else /* high intensity */
/*TODO*///		int trans[]= { 7, 6, 5, 4,  7,  6,  5,  4, 3, 2, 1, 0,  3,  2, 1, 0 };
/*TODO*///	#endif
...
/*TODO*///	
/*TODO*///	
/*TODO*///	public static WriteHandlerPtr quantum_colorram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
/*TODO*///	{
...
/*TODO*///	*/
/*TODO*///	
/*TODO*///		int trans[]= { 7/*white*/, 0, 3, 1/*blue*/, 2/*green*/, 5, 6, 4/*red*/,
/*TODO*///			       7/*white*/, 0, 3, 1/*blue*/, 2/*green*/, 5, 6, 4/*red*/};
/*TODO*///	
/*TODO*///		colorram_w (offset >> 1, trans[data & 0x0f]);
/*TODO*///	} };
...
/*TODO*///	}
/*TODO*///	
/*TODO*///	int avg_start_starwars(void)
/*TODO*///	{
/*TODO*///		return avgdvg_init (USE_AVG_SWARS);
/*TODO*///	}
/*TODO*///	
