...
public class _2203intf extends snd_interface {
    ...
    public static TimerCallbackHandlerPtr TimerCallbackHandlerPtr_2203 = new TimerCallbackHandlerPtr() {
    ...
    public static FM_TIMERHANDLER_Ptr TimerHandler = new FM_TIMERHANDLER_Ptr() {
        ...
        public void handler(int n, int c, double count, double stepTime) {
            if (count == 0) {
                ...
                if (Timer[n][c] == null) {
                    Timer[n][c] = timer_set(timeSec, (c << 7) | n, TimerCallbackHandlerPtr_2203);
                }
            }
        }
    };
