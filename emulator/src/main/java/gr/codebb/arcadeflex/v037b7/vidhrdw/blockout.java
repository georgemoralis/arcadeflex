...
public class blockout {
    ...
    public static WriteHandlerPtr blockout_paletteram_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr blockout_frontcolor_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            setcolor(512, data);
        }
    };
    ...
    public static WriteHandlerPtr blockout_videoram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr blockout_videoram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return blockout_videoram.READ_WORD(offset);
        }
    };

    public static WriteHandlerPtr blockout_frontvideoram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            COMBINE_WORD_MEM(blockout_frontvideoram, offset, data);
        }
    };

    public static ReadHandlerPtr blockout_frontvideoram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
                ...
                for (y = 0; y < 256; y++) {
                    for (x = 0; x < 320; x += 8) {
                        ...
                        if (d != 0) {
                            ...
                            if ((d & 0x40) != 0) {
                                plot_pixel.handler(bitmap, x + 1, y, color);
                            }
                            if ((d & 0x20) != 0) {
                                plot_pixel.handler(bitmap, x + 2, y, color);
                            }
                            if ((d & 0x10) != 0) {
                                plot_pixel.handler(bitmap, x + 3, y, color);
                            }
                            if ((d & 0x08) != 0) {
                                plot_pixel.handler(bitmap, x + 4, y, color);
                            }
                            if ((d & 0x04) != 0) {
                                plot_pixel.handler(bitmap, x + 5, y, color);
                            }
                            if ((d & 0x02) != 0) {
                                plot_pixel.handler(bitmap, x + 6, y, color);
                            }
                            if ((d & 0x01) != 0) {
                                plot_pixel.handler(bitmap, x + 7, y, color);
                            }
                        }
                    }
                }
