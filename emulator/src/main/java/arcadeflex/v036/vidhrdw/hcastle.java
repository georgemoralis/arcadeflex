...
public class hcastle {
    ...
    public static WriteHandlerPtr hcastle_pf1_video_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr hcastle_pf2_video_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr hcastle_gfxbank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            gfx_bank = data;
        }
    };

    public static ReadHandlerPtr hcastle_gfxbank_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return gfx_bank;
        }
    };

    public static WriteHandlerPtr hcastle_pf1_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (offset == 3) {
                if ((data & 0x8) == 0) {
    ...
    public static WriteHandlerPtr hcastle_pf2_control_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (offset == 3) {
                if ((data & 0x8) == 0) {
    ...
    public static VhUpdatePtr hcastle_vh_screenrefresh = new VhUpdatePtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            ...
            if ((K007121_ctrlram[0][3] & 0x01) != 0) {
                pf1_bankbase += 0x2000;
            }
            if ((K007121_ctrlram[1][3] & 0x01) != 0) {
                pf2_bankbase += 0x2000;
            }
            ...
            for (my = 0; my < 32; my++) {
                for (mx = 0; mx < 64; mx++) {
                    ...
                    if (dirty_pf1[offs] == 0 && dirty_pf1[offs + 0x400] == 0) {
                        continue;
                    }
            ...
            for (my = 0; my < 32; my++) {
                for (mx = 0; mx < 64; mx++) {
                    ...
                    if (dirty_pf2[offs] == 0 && dirty_pf2[offs + 0x400] == 0) {
                        continue;
                    }
