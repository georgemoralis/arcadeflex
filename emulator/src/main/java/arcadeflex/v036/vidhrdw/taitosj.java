...
public class taitosj {
 ...
 /* layers has top priority when this one is transparent */
    ...
    public static VhStopPtr taitosj_vh_stop = new VhStopPtr() {
        public void handler() {
            ...
            if (sprite_sprite_collbitmap2 != null) {
                osd_free_bitmap(sprite_sprite_collbitmap2);
            }
            if (sprite_sprite_collbitmap1 != null) {
                osd_free_bitmap(sprite_sprite_collbitmap1);
            }
            if (sprite_plane_collbitmap1 != null) {
                osd_free_bitmap(sprite_plane_collbitmap1);
            }

            for (i = 0; i < 3; i++) {
                if (taitosj_tmpbitmap[i] != null) {
                    osd_free_bitmap(taitosj_tmpbitmap[i]);
                }
                if (sprite_plane_collbitmap2[i] != null) {
                    osd_free_bitmap(sprite_plane_collbitmap2[i]);
                }
            }
    ...
    public static WriteHandlerPtr taitosj_colorbank_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (taitosj_colorbank.read(offset) != data) {
                if (errorlog != null) {
                    fprintf(errorlog, "colorbank %d = %02x\n", offset, data);
                }
    ...
    public static WriteHandlerPtr taitosj_videoenable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (taitosj_video_enable != data) {
                if (errorlog != null) {
                    fprintf(errorlog, "videoenable = %02x\n", data);
                }
    ...
    public static ReadHandlerPtr check_sprite_plane_bitpattern = new ReadHandlerPtr() {
