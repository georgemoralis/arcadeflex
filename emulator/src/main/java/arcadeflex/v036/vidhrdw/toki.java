...
public class toki {
    ...
    public static int XBG1SCROLL_ADJUST(int x) {
        return (-(x) + 0x103);
    }

    public static int XBG2SCROLL_ADJUST(int x) {
        return (-(x) + 0x101);
    }

    public static int YBGSCROLL_ADJUST(int x) {
        return (-(x) - 1);
    }
    ...
    /*signed char*/
    public static byte[] toki_linescroll = new byte[256];
    ...
    public static char[] frg_dirtybuffer;
    /* foreground */
    public static char[] bg1_dirtybuffer;
    /* background 1 */
    public static char[] bg2_dirtybuffer;
    /* background 2 */

    public static osd_bitmap bitmap_frg;
    /* foreground bitmap */
    public static osd_bitmap bitmap_bg1;
    /* background bitmap 1 */
    public static osd_bitmap bitmap_bg2;
    /* background bitmap 2 */
     ...
     ************************************
     */
    public static WriteHandlerPtr toki_foreground_videoram_w = new WriteHandlerPtr() {
    ...
    public static ReadHandlerPtr toki_foreground_videoram_r = new ReadHandlerPtr() {
     ...
     ************************************
     */
    public static WriteHandlerPtr toki_background1_videoram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr toki_background1_videoram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
     ...
     ************************************
     */
    public static WriteHandlerPtr toki_background2_videoram_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static ReadHandlerPtr toki_background2_videoram_r = new ReadHandlerPtr() {
        public int handler(int offset) {
    ...
    public static void toki_render_sprites(osd_bitmap bitmap) {
        ...
        for (offs = 0; offs < toki_sprites_dataram_size[0]; offs += 8) {
            ...
            if (SprRegs.READ_WORD(SPRITE_Y) == 0xf100) {
                break;
            }
    ...
    public static WriteHandlerPtr toki_linescroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (offset == 2) {
                int currline;
