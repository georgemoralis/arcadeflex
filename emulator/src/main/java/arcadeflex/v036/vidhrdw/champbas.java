...
public class champbas {
    ...
    public static VhConvertColorPromHandlerPtr champbas_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
 ...
 /* sprites use the same color lookup table as characters */
     ...
     **************************************************************************
     */
    public static VhUpdateHandlerPtr champbas_vh_screenrefresh = new VhUpdateHandlerPtr() {
