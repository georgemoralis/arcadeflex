...
public class tumblep {
     ...
     * ***************************************************************************
     */
    public static WriteHandlerPtr tumblep_pf2_data_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr tumblep_pf3_data_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    static int last = 0;
    public static WriteHandlerPtr tumblep_control_0_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
