...
public class contra {
    ...
    public static WriteHandlerPtr contra_bankswitch_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr contra_sh_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_cause_interrupt(1, M6809_INT_IRQ);
        }
    };

    public static WriteHandlerPtr contra_coin_counter_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if ((data & 0x01) != 0) {
                coin_counter_w.handler(0, data & 0x01);
            }
            if ((data & 0x02) != 0) {
                coin_counter_w.handler(1, (data & 0x02) >> 1);
            }
        }
    };
    ...
    static InputPortHandlerPtr input_ports_contra = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
...
.*		1,			/* 1 chip */
 ...
 /*		{ YM3012_VOL(60,MIXER_PAN_RIGHT,60,MIXER_PAN_LEFT) },
    ...
    static RomLoadHandlerPtr rom_contra = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_contrab = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* 64k for code + 96k for banked ROMs */
    ...
    static RomLoadHandlerPtr rom_contraj = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* 64k for code + 96k for banked ROMs */
    ...
    static RomLoadHandlerPtr rom_contrajb = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* 64k for code + 96k for banked ROMs */
    ...
    static RomLoadHandlerPtr rom_gryzor = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* 64k for code + 96k for banked ROMs */
