...
public class galaxian {
    ...
    public static final double SOUND_CLOCK = (XTAL / 6 / 2);
    /* 1.536 Mhz */

    //#define SAMPLES 1
    public static final double RNG_RATE = (XTAL / 3);
    /* RNG clock is XTAL/3 */
    public static final double NOISE_RATE = (XTAL / 3 / 192 / 2 / 2);
    /* 2V = 8kHz */
    public static final double NOISE_LENGTH = (NOISE_RATE * 4);
 ...
 /* key off */
    ...
    public static ShStopHandlerPtr galaxian_sh_stop = new ShStopHandlerPtr() {
        public void handler() {
            if (lfotimer != null) {
    ...
    public static ShUpdateHandlerPtr galaxian_sh_update = new ShUpdateHandlerPtr() {
        public void handler() {
            /*
