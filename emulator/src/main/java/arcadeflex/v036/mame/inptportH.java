...
import static arcadeflex.v036.mame.inptport.ipdn_defaultstrings;
...
public class inptportH {
    ...
    public static class InputPort {
        ...
        public int[] seq = new int[SEQ_MAX];

        /* input sequence affecting the input bits */
        public InputPort() {
 ...
 /* input bits to this, the bit will be inverted while a vertical blank is happening. */
    ...
    public static final int IPT_EXTENSION = 53;
 ...
 /* -nocheat command line option is specified. */
    ...
    public static final int IPF_PLAYERMASK = 0x00030000;
    /* use IPF_PLAYERn if more than one person can */
    public static final int IPF_PLAYER1 = 0;
    /* play at the same time. The IPT_ should be the same */
    public static final int IPF_PLAYER2 = 0x00010000;
    /* for all players (e.g. IPT_BUTTON1 | IPF_PLAYER2) */
    public static final int IPF_PLAYER3 = 0x00020000;
    /* IPF_PLAYER1 is the default and can be left out to */
    public static final int IPF_PLAYER4 = 0x00030000;
    /* increase readability. */

    public static final int IPF_COCKTAIL = IPF_PLAYER2;
    /* the bit is used in cocktail mode only */

    public static final int IPF_8WAY = 0;
    /* Joystick modes of operation. 8WAY is the default, */
    public static final int IPF_4WAY = 0x00080000;
