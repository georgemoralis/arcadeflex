...
public class inputH {
    ...
    public static class KeyboardInfo {
        ...
        /* CODE_xxx equivalent from list below, or CODE_OTHER if n/a */
    }
...
/*TODO*///
 ...
 /* special */
    public static final int CODE_NONE = 0x8000;
    /* no code, also marker of sequence end */
    public static final int CODE_OTHER = 0x8001;
    /* OS code not mapped to any other code */
    public static final int CODE_DEFAULT = 0x8002;
    /* special for input port definitions */
    public static final int CODE_PREVIOUS = 0x8003;
    /* special for input port definitions */
    public static final int CODE_NOT = 0x8004;
    /* operators for sequences */
    public static final int CODE_OR = 0x8005;
    /* operators for sequences */
