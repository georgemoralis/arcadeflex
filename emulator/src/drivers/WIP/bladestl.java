...
Interrupts:
 *
 * CPU #0 (6309): -------------- IRQ: not used. FIRQ: generated by VBLANK. NMI:
 * writes the sound command to the 6809.
 *
 * CPU #1 (6809): -------------- IRQ: triggered by the 6309 when a sound command
 * is written. FIRQ: not used. NMI: not used.
 *
 * Notes: The protection is not fully understood(Konami 051733). The game is
 * playable, but is not 100% accurate. Missing samples.
 *
 **************************************************************************
 */
