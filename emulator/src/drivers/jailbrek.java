...
public class jailbrek
{
	...
	public static ReadHandlerPtr jailbrek_speech_r = new ReadHandlerPtr() { public int handler(int offs){
/*TODO*///		return ( VLM5030_BSY() ? 1 : 0 );
            return 0;
	} };
	
	public static WriteHandlerPtr jailbrek_speech_w = new WriteHandlerPtr() { public void handler(int offs, int data){
/*TODO*///		VLM5030_VCU( data & 1 );
/*TODO*///		VLM5030_ST( ( data >> 1 ) & 1 );
/*TODO*///		VLM5030_RST( ( data >> 2 ) & 1 );
	} };
...
/*TODO*///		new MemoryWriteAddress( 0x5000, 0x5000, VLM5030_data_w ), /* speech data */
...
/*TODO*///		0,          /* memory size of speech rom */
