...
public class wiz
{
	...
	public static CharPtr wiz_videoram2=new CharPtr();
	public static CharPtr wiz_colorram2=new CharPtr();
	public static CharPtr wiz_attributesram=new CharPtr();
	public static CharPtr wiz_attributesram2=new CharPtr();
	
	static int flipx, flipy;
	
	public static CharPtr wiz_sprite_bank=new CharPtr();
	...
	***************************************************************************/
	public static VhConvertColorPromPtr wiz_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
		...
		for (i = 0;i < Machine.drv.total_colors;i++)
		{
			...
			palette[p_inc++].set((char)(0x0e * bit0 + 0x1f * bit1 + 0x42 * bit2 + 0x90 * bit3));
		...
		/* copy the temporary bitmap to the screen */
		{
			...
			if (flipx != 0)
			{
				for (i = 0;i < 32;i++)
				{
					...
					if (flipy != 0) scroll[31-i] = -scroll[31-i];
				}
			}
			else
			{
	...
	static void draw_sprites(osd_bitmap bitmap, CharPtr sprite_ram,
	...
	***************************************************************************/
	public static VhUpdatePtr wiz_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int bank;
	...
	public static VhUpdatePtr stinger_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
