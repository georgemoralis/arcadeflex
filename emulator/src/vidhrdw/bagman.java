...
public class bagman
{
	...
	***************************************************************************/
	public static VhConvertColorPromPtr bagman_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	public static VhUpdatePtr bagman_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		...
		for (offs = videoram_size[0] - 1;offs >= 0;offs--)
		{
			if (dirtybuffer[offs]!=0)
			{
				...
				bank = 0;
				if (Machine.gfx[2]!=null && (colorram.read(offs) & 0x10)!=0) bank = 2;
