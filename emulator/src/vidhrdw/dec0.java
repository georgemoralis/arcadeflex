...
public class dec0
{
	...
	public static final int TEXTRAM_SIZE	=0x2000; /* Size of text layer */
	public static final int  TILERAM_SIZE	=0x800;	/* Size of background and foreground */
	...
	public static WriteHandlerPtr dec0_update_sprites = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr dec0_paletteram_w_rg = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(paletteram,offset,data);
		update_24bitcol(offset);
	} };
	
	public static WriteHandlerPtr dec0_paletteram_w_b = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static void dec0_pf1_update()
	{
		...
		switch (dec0_pf1_control_0.READ_WORD(6)&0xf)
		{
			...
			case 2:	/* 1x4 */
				...
				break;
			default:
				if (errorlog != null) fprintf(errorlog,"error: pf1_update with unknown shape %04x\n",dec0_pf1_control_0.READ_WORD(6));
				return;
		}
	...
	public static WriteHandlerPtr dec0_pf2_update = new WriteHandlerPtr() { public void handler(int transparent, int special)
	{
		int offs,mx,my,color,tile,quarter;
		int[] offsetx=new int[4];
                int[] offsety=new int[4];
		...
		switch (dec0_pf2_control_0.READ_WORD(6)&0xf)
		{
			...
			case 2:	/* 1x4 */
				...
				break;
			default:
				if (errorlog != null) fprintf(errorlog,"error: pf2_update with unknown shape %04x\n",dec0_pf2_control_0.READ_WORD(6));
				return;
		}
	...
	public static WriteHandlerPtr dec0_pf3_update = new WriteHandlerPtr() { public void handler(int transparent, int special)
	{
		int offs,mx,my,color,tile,quarter;
		int[] offsetx=new int[4];
                int[] offsety=new int[4];
		...
		switch (dec0_pf3_control_0.READ_WORD(6)&0xf)
		{
			...
			case 2:	/* 1x4 */
				...
				break;
			default:
				if (errorlog != null) fprintf(errorlog,"error: pf3_update with unknown shape %04x\n",dec0_pf3_control_0.READ_WORD(6));
				return;
		}
	...
	public static VhUpdatePtr baddudes_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		...
		if ((dec0_pri & 0x01) == 0)
		{
			dec0_pf2_update.handler(0,1); /* Foreground pens of pf2 only */
