...
public class funkybee
{
	...
	public static CharPtr funkyb_row_scroll=new CharPtr();
	
	static int gfx_bank;
	
	
	public static VhConvertColorPromPtr funkybee_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	***************************************************************************/
	static void draw_chars(osd_bitmap _tmpbitmap, osd_bitmap bitmap)
	{
		...
		/* copy the temporary bitmap to the screen */
		{
			...
			copyscrollbitmap(bitmap,_tmpbitmap,32,scroll,0,null,Machine.drv.visible_area,TRANSPARENCY_NONE,0);
		}
	}
	
	
	public static VhUpdatePtr funkybee_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
