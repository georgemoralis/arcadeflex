...
public class troangel
{
	...
	***************************************************************************/
	static int TOTAL_COLORS(int gfxn) 
        ...
        public static VhConvertColorPromPtr troangel_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	static void draw_background( osd_bitmap bitmap )
	{
	...
	
		{
			...
			copyscrollbitmap(bitmap,tmpbitmap,256,xscroll,0,null,Machine.drv.visible_area,TRANSPARENCY_NONE,0);
		}
	}
	...
	public static VhUpdatePtr troangel_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
