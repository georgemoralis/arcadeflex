...
public class sonson {
     ...
     * for characters, one for sprites). The palette PROMs are connected to the
     * RGB output this way:
     *
     * I don't know the exact values of the resistors between the PROMs and the
     * RGB output. I assumed these values (the same as Commando) bit 7 -- 220
     * ohm resistor -- GREEN -- 470 ohm resistor -- GREEN -- 1 kohm resistor --
     * GREEN -- 2.2kohm resistor -- GREEN -- 220 ohm resistor -- BLUE -- 470 ohm
     * resistor -- BLUE -- 1 kohm resistor -- BLUE bit 0 -- 2.2kohm resistor --
     * BLUE
     *
     * bit 7 -- unused -- unused -- unused -- unused -- 220 ohm resistor -- RED
