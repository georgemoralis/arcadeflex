...
public class timeplt
{
	...
	public static InitDriverPtr init_timeplt = new InitDriverPtr() { public void handler() 
	{
		sprite_multiplex_hack = 1;
	}};
	public static InitDriverPtr init_psurge = new InitDriverPtr() { public void handler() 
	{
	...
	***************************************************************************/
	...
	public static VhConvertColorPromPtr timeplt_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
