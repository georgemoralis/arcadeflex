...
public class superqix
{
	...
	public static CharPtr superqix_bitmapram;
        public static CharPtr superqix_bitmapram2;
	...
	public static VhStartPtr superqix_vh_start = new VhStartPtr() { public int handler() 
	{
		...
		/*if ((superqix_bitmapram = malloc(0x7000 * sizeof(unsigned char))) == 0)
		{
			...
			return 1;
                ...
                superqix_bitmapram=new CharPtr(0x7000);
                /*
		if ((superqix_bitmapram2 = malloc(0x7000 * sizeof(unsigned char))) == 0)
		{
			...
			return 1;
                ...
                superqix_bitmapram2=new CharPtr(0x7000);
	...
	***************************************************************************/
	public static VhUpdatePtr superqix_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs,i;
