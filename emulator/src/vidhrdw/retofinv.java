...
public class retofinv
{
	...
	public static CharPtr retofinv_sprite_ram1=new CharPtr();
	public static CharPtr retofinv_sprite_ram2=new CharPtr();
	public static CharPtr retofinv_sprite_ram3=new CharPtr();
	public static CharPtr retofinv_fg_char_bank=new CharPtr();
	public static CharPtr retofinv_bg_char_bank=new CharPtr();
	public static CharPtr retofinv_bg_videoram=new CharPtr();
	public static CharPtr retofinv_fg_videoram=new CharPtr();
	public static CharPtr retofinv_bg_colorram=new CharPtr();
	public static CharPtr retofinv_fg_colorram=new CharPtr();
	...
	public static VhConvertColorPromPtr retofinv_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
