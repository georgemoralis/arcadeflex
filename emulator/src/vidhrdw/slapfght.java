...
public class slapfght
{
	...
	public static CharPtr slapfight_videoram= new CharPtr();
	public static CharPtr slapfight_colorram= new CharPtr();
	public static int[] slapfight_videoram_size=new int[1];
	public static CharPtr slapfight_scrollx_lo= new CharPtr(); 
        public static CharPtr slapfight_scrollx_hi= new CharPtr();
        public static CharPtr slapfight_scrolly= new CharPtr();
	...
	***************************************************************************/
	public static VhConvertColorPromPtr slapfight_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
