...
public class kangaroo
{
	...
	public static CharPtr kangaroo_video_control=new CharPtr();
	public static CharPtr kangaroo_bank_select=new CharPtr();
	public static CharPtr kangaroo_blitter=new CharPtr();
	...
	***************************************************************************/
	public static VhConvertColorPromPtr kangaroo_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
	    int i;
	...
	***************************************************************************/
	public static VhStartPtr kangaroo_vh_start = new VhStartPtr() { public int handler() 
	{
	    ...
	    if ((videoram = new CharPtr(Machine.drv.screen_width*Machine.drv.screen_height)) == null)
	    {
	        osd_free_bitmap(tmpbitmap);
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr kangaroo_redraw_4pixels = new WriteHandlerPtr() { public void handler(int x, int y)
	{
	...
	***************************************************************************/
	public static VhUpdatePtr kangaroo_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
