...
public class rallyx
{
	public static CharPtr rallyx_videoram2= new CharPtr();
        ...
        public static CharPtr rallyx_radarx= new CharPtr();
        public static CharPtr rallyx_radary= new CharPtr();
        public static CharPtr rallyx_radarattr= new CharPtr();
	...
	***************************************************************************/
	...
	public static VhConvertColorPromPtr rallyx_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	public static VhConvertColorPromPtr locomotn_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
		//#define TOTAL_COLORS(gfxn) (Machine.gfx[gfxn].total_colors * Machine.gfx[gfxn].color_granularity)
		//#define COLOR(gfxn,offs) (colortable[Machine.drv.gfxdecodeinfo[gfxn].color_codes_start + offs])
		...
		for (i = 0;i < Machine.drv.total_colors;i++)
		{
			...
			bit1 = (color_prom.read() >> 7) & 0x01;
                        palette[p_inc++].set((char)(0x50 * bit0 + 0xab * bit1));
	...
	***************************************************************************/
	...
	public static VhUpdatePtr rallyx_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs,sx,sy;
		int scrollx,scrolly;
                int displacement = 1;
	...
	public static VhUpdatePtr jungler_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs,sx,sy;
		int scrollx,scrolly;
                int displacement = 0;
	...
	public static VhUpdatePtr locomotn_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs,sx,sy;
	...
	public static VhUpdatePtr commsega_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs,sx,sy;
