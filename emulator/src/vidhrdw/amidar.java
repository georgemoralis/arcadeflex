...
public class amidar
{
	...
	***************************************************************************/
	static int TOTAL_COLORS(int gfxn) 
        ...
        public static VhConvertColorPromPtr amidar_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
		...
		{
			if ((i & 3) != 0) colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] = (char)i;
			else colortable[Machine.drv.gfxdecodeinfo[0].color_codes_start + i] = (char)0;	/* 00 is always black, regardless of the contents of the PROM */
		}
	} };
