...
public class prehisle
{
	...
	public static VhUpdatePtr prehisle_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{      
	...
	public static WriteHandlerPtr prehisle_video_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr prehisle_video_r = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr prehisle_control_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset) {
			case 0x10: /* Player 2 */
			...
			default:
				if (errorlog != null) fprintf(errorlog,"%06x: read unknown control %02x\n",cpu_get_pc(),offset);
				return 0;
		}
	} };
	
	public static WriteHandlerPtr prehisle_control_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		switch (offset) {
			case 0:
			...
			default:
				if (errorlog != null) fprintf(errorlog,"%06x: write unknown control %02x\n",cpu_get_pc(),offset);
				break;
		}
	} };
}
