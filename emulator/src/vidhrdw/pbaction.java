...
public class pbaction
{
	...
	public static CharPtr pbaction_videoram2=new CharPtr();
        public static CharPtr pbaction_colorram2=new CharPtr();
	...
	***************************************************************************/
	public static VhStartPtr pbaction_vh_start = new VhStartPtr() { public int handler() 
	{
		...
		for (i = 0;i < 16;i++) palette_used_colors.write(8 * i,PALETTE_COLOR_TRANSPARENT);
