...
public class higemaru
{
	...
	***************************************************************************/
	...
	public static VhConvertColorPromPtr higemaru_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
		...
		color_prom.inc(128);	/* the bottom half of the PROM doesn't seem to be used */
	...
	{
            if (errorlog!=null && (data & 0x7c)!=0) fprintf(errorlog,"c800 = %02x\n",data);
