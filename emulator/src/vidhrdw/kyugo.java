...
public class kyugo
{
	...
	public static CharPtr kyugo_videoram=new CharPtr();
	public static int[] kyugo_videoram_size=new int[1];
	public static CharPtr kyugo_back_scrollY_lo=new CharPtr();
	public static CharPtr kyugo_back_scrollX=new CharPtr();
	...
	***************************************************************************/
	public static VhConvertColorPromPtr kyugo_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	static void draw_sprites(osd_bitmap bitmap)
	{
		...
		CharPtr spriteram_area1 = new CharPtr(spriteram,0x28);
		CharPtr spriteram_area2 = new CharPtr(spriteram_2,0x28);
		CharPtr spriteram_area3 = new CharPtr(kyugo_videoram,0x28);
	...
	public static VhUpdatePtr kyugo_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
