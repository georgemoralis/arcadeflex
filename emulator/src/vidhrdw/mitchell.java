...
public class mitchell
{
	...
	****************************************************************************/
	...
	{
	if (errorlog != null) fprintf(errorlog,"PC %04x: pang_gfxctrl_w %02x\n",cpu_get_pc(),data);
	{
		//char baf[40];
	...
	***************************************************************************/
	...
	public static VhUpdatePtr pang_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int i;
