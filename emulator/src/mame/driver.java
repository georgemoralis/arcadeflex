...
import static drivers.pacland.*;
import static drivers.skykid.*;
import static drivers.baraduke.*;
import static drivers.psychic5.*;
import static drivers.wardner.*;
import static drivers.galivan.*;
import static drivers.tehkanwc.*;
import static drivers.solomon.*;
import static drivers.sauro.*;
import static drivers.shootout.*;
import static drivers.ccastles.*;
import static drivers.centiped.*;
import static drivers.foodf.*;
import static drivers.aeroboto.*;
import static drivers.goindol.*;
import static drivers.bjtwin.*;
import static drivers.docastle.*;
import static drivers.higemaru.*;
import static drivers.fastfred.*;
import static drivers.zodiack.*;
import static drivers.taitosj.*;
...
import static drivers.ajax.*;
import static drivers.parodius.*;
import static drivers.m72.*;
import static drivers.raiden.*;
import static drivers.dynduke.*;
import static drivers.m92.*;
import static drivers.sf1.*;
import static drivers.rastan.*;
import static drivers.rainbow.*;
import static drivers.cabal.*;
import static drivers.xmen.*;
import static drivers.tmnt.*;
import static drivers.toki.*;
import static drivers.snk68.*;
import static drivers.ddragon3.*;
import static drivers.galpanic.*;
import static drivers.tumblep.*;
import static drivers.dec0.*;
import static drivers.kaneko16.*;
import static drivers.prehisle.*;
import static drivers.cps1.*;
import static drivers.alpha68k.*;
import static drivers.superman.*;
import static drivers.aerofgt.*;
import static drivers.neogeo.*;
import static drivers.lastduel.*;
import static drivers.bloodbro.*;
import static drivers.nemesis.*;
import static drivers.sbasketb.*;
import static drivers.terracre.*;
import static drivers.punchout.*;
import static drivers.astrof.*;
import static drivers.karnov.*;
import static drivers.shuuz.*;
import static drivers.berzerk.*;
import static drivers.ssi.*;
import static drivers.taitof2.*;
