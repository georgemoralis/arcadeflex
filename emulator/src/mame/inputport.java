...
/*TODO*///}
    ...
    public static int[] input_port_seq(int in_ptr)
    {
            ...
            while (seq_get_1(Machine.input_ports[in_ptr].seq) == CODE_PREVIOUS) in_ptr--;
				...
				else
				{
					...
					if (seq_pressed(seq))
					{
                                                     ...
                                                     (Machine.input_ports[in_ptr].type & ~IPF_MASK) <= IPT_JOYSTICKLEFT_RIGHT)
                                                {
                                                     ...
                                                     player = 0;
                                                     if ((Machine.input_ports[in_ptr].type & IPF_PLAYERMASK) == IPF_PLAYER2) player = 1;
                                                     else if ((Machine.input_ports[in_ptr].type & IPF_PLAYERMASK) == IPF_PLAYER3) player = 2;
                                                     else if ((Machine.input_ports[in_ptr].type & IPF_PLAYERMASK) == IPF_PLAYER4) player = 3;
