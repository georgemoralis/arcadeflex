...
/*TODO*/ //set_RC_filter(3*chip + channel,1000,5100,0,C);
	}
	
	public static WriteHandlerPtr scramble_filter_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
/*TODO*/ //filter_w(1, 0, (offset >>  0) & 3);
/*TODO*/ //filter_w(1, 1, (offset >>  2) & 3);
/*TODO*/ //filter_w(1, 2, (offset >>  4) & 3);
/*TODO*/ //filter_w(0, 0, (offset >>  6) & 3);
/*TODO*/ //filter_w(0, 1, (offset >>  8) & 3);
/*TODO*/ //filter_w(0, 2, (offset >> 10) & 3);
	} };
}
