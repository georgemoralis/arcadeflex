...
public class theglob
{
	...
	public static ReadHandlerPtr theglob_decrypt_rom = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		switch(counter)
		{
			case 0x08:	cpu_setbank (1, new UBytePtr(RAM,0x10000));		break;
			case 0x09:	cpu_setbank (1, new UBytePtr(RAM,0x14000));		break;
			case 0x0A:	cpu_setbank (1, new UBytePtr(RAM,0x18000));		break;
			case 0x0B:	cpu_setbank (1, new UBytePtr(RAM,0x1C000));		break;
			default:
				if (errorlog != null) fprintf(errorlog,"Invalid counter = %02X\n",counter);
				break;
		}
