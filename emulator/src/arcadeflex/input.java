...
public class input {
 ...
 /*TODO the rest codes */
	/*new KeyboardInfo( "0",			KEY_0,				KEYCODE_0 ),
	new KeyboardInfo( "1",			KEY_1,				KEYCODE_1 ),
	new KeyboardInfo( "2",			KEY_2,				KEYCODE_2 ),
	new KeyboardInfo( "3",			KEY_3,				KEYCODE_3 ),
	new KeyboardInfo( "4",			KEY_4,				KEYCODE_4 ),
	new KeyboardInfo( "5",			KEY_5,				KEYCODE_5 ),
	new KeyboardInfo( "6",			KEY_6,				KEYCODE_6 ),
	new KeyboardInfo( "7",			KEY_7,				KEYCODE_7 ),
	new KeyboardInfo( "8",			KEY_8,				KEYCODE_8 ),
	new KeyboardInfo( "9",			KEY_9,				KEYCODE_9 ),
