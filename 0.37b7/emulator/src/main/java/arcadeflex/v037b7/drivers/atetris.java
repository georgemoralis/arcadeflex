...
//platform imports
import static arcadeflex.v037b7.platform.fileio.*;
//sound imports
import static arcadeflex.v037b7.sound.pokey.*;
import static arcadeflex.v037b7.sound.pokeyH.*;
//vidhrdw imports
...
public class atetris {
    ...
    static InputPortHandlerPtr input_ports_atetris = new InputPortHandlerPtr() {
        public void handler() {
    ...
    static InputPortHandlerPtr input_ports_atetcktl = new InputPortHandlerPtr() {
        public void handler() {
            // These ports are read via the Pokeys
            PORT_START();
            /* IN0 */
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_atetris = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_atetrisa = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
    ...
    static RomLoadHandlerPtr rom_atetrisb = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
 ...
 /* however doesn't seem to be required to run the game in this driver. */
    ...
    static RomLoadHandlerPtr rom_atetcktl = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
    ...
    static RomLoadHandlerPtr rom_atetckt2 = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x14000, REGION_CPU1);
            /* 80k for code */
    ...
    public static InitDriverHandlerPtr init_atetris = new InitDriverHandlerPtr() {
        public void handler() {
