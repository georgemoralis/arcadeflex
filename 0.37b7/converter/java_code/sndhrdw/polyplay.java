...
public class polyplay
{
	...
	public static ShStartPtr polyplay_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShStopPtr polyplay_sh_stop = new ShStopPtr() { public void handler() 
	{
		mixer_stop_sample(channellfo+0);
		mixer_stop_sample(channellfo+1);
	} };
	
	public static ShUpdatePtr polyplay_sh_update = new ShUpdatePtr() { public void handler() 
	{
