...
public class williams
{
	...
	****************************************************************************/
	...
	static MemoryReadAddress williams_cvsd_readmem[] =
	{
	...
	static MemoryWriteAddress williams_cvsd_writemem[] =
	{
	...
	static MemoryReadAddress williams_adpcm_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x1fff, MRA_RAM ),
		new MemoryReadAddress( 0x2401, 0x2401, williams_ym2151_r ),
		new MemoryReadAddress( 0x2c00, 0x2c00, OKIM6295_status_0_r ),
		new MemoryReadAddress( 0x3000, 0x3000, williams_adpcm_command_r ),
		new MemoryReadAddress( 0x4000, 0xbfff, MRA_BANK6 ),
		new MemoryReadAddress( 0xc000, 0xffff, MRA_ROM ),
		new MemoryReadAddress( -1 )
	};
	
	static MemoryWriteAddress williams_adpcm_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x1fff, MWA_RAM ),
		new MemoryWriteAddress( 0x2000, 0x2000, williams_adpcm_bank_select_w ),
		new MemoryWriteAddress( 0x2400, 0x2401, williams_ym2151_w ),
		new MemoryWriteAddress( 0x2800, 0x2800, williams_dac_data_w ),
		new MemoryWriteAddress( 0x2c00, 0x2c00, OKIM6295_data_0_w ),
		new MemoryWriteAddress( 0x3400, 0x3400, williams_adpcm_6295_bank_select_w ),
		new MemoryWriteAddress( 0x3c00, 0x3c00, MWA_NOP ),/*mk_sound_talkback_w }, -- talkback port? */
	...
	static MemoryReadAddress williams_narc_master_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x1fff, MRA_RAM ),
		new MemoryReadAddress( 0x2001, 0x2001, williams_ym2151_r ),
		new MemoryReadAddress( 0x3000, 0x3000, MRA_NOP ),
		new MemoryReadAddress( 0x3400, 0x3400, williams_narc_command_r ),
		new MemoryReadAddress( 0x4000, 0xbfff, MRA_BANK6 ),
		new MemoryReadAddress( 0xc000, 0xffff, MRA_ROM ),
		new MemoryReadAddress( -1 )
	};
	
	static MemoryWriteAddress williams_narc_master_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x1fff, MWA_RAM ),
		new MemoryWriteAddress( 0x2000, 0x2001, williams_ym2151_w ),
		new MemoryWriteAddress( 0x2800, 0x2800, MWA_NOP ),/*mk_sound_talkback_w }, -- talkback port? */
	...
	static MemoryReadAddress williams_narc_slave_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x1fff, MRA_RAM ),
		new MemoryReadAddress( 0x3000, 0x3000, MRA_NOP ),
		new MemoryReadAddress( 0x3400, 0x3400, williams_narc_command2_r ),
		new MemoryReadAddress( 0x4000, 0xbfff, MRA_BANK5 ),
		new MemoryReadAddress( 0xc000, 0xffff, MRA_ROM ),
		new MemoryReadAddress( -1 )
	};
	
	static MemoryWriteAddress williams_narc_slave_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x1fff, MWA_RAM ),
		new MemoryWriteAddress( 0x2000, 0x2000, hc55516_0_clock_set_w ),
		new MemoryWriteAddress( 0x2400, 0x2400, hc55516_0_digit_clock_clear_w ),
		new MemoryWriteAddress( 0x3000, 0x3000, williams_dac2_data_w ),
		new MemoryWriteAddress( 0x3800, 0x3800, williams_narc_slave_bank_select_w ),
	...
	static MemoryReadAddress williams_dcs_readmem[] =
	{
		new MemoryReadAddress( ADSP_DATA_ADDR_RANGE(0x0000, 0x1fff), MRA_RAM ),						/* ??? */
		new MemoryReadAddress( ADSP_DATA_ADDR_RANGE(0x2000, 0x2fff), williams_dcs_bank_r ),			/* banked roms read */
		new MemoryReadAddress( ADSP_DATA_ADDR_RANGE(0x3400, 0x3400), williams_dcs_latch_r ),			/* soundlatch read */
		new MemoryReadAddress( ADSP_DATA_ADDR_RANGE(0x3800, 0x39ff), MRA_RAM ),						/* internal data ram */
		new MemoryReadAddress( ADSP_PGM_ADDR_RANGE (0x0000, 0x1fff), MRA_RAM ),						/* internal/external program ram */
		new MemoryReadAddress( -1 )  /* end of table */
	};
	
	
	static MemoryWriteAddress williams_dcs_writemem[] =
	{
		new MemoryWriteAddress( ADSP_DATA_ADDR_RANGE(0x0000, 0x1fff), MWA_RAM ),						/* ??? */
		new MemoryWriteAddress( ADSP_DATA_ADDR_RANGE(0x3000, 0x3000), williams_dcs_bank_select_w ),	/* bank selector */
		new MemoryWriteAddress( ADSP_DATA_ADDR_RANGE(0x3400, 0x3400), williams_dcs_latch_w ),			/* soundlatch write */
		new MemoryWriteAddress( ADSP_DATA_ADDR_RANGE(0x3800, 0x39ff), MWA_RAM ),						/* internal data ram */
		new MemoryWriteAddress( ADSP_DATA_ADDR_RANGE(0x3fe0, 0x3fff), williams_dcs_control_w ),		/* adsp control regs */
		new MemoryWriteAddress( ADSP_PGM_ADDR_RANGE (0x0000, 0x1fff), MWA_RAM ),						/* internal/external program ram */
	...
	****************************************************************************/
	...
	static YM2151interface williams_cvsd_ym2151_interface = new YM2151interface
	(
		1,			/* 1 chip */
		3579580,
	...
	static YM2151interface williams_adpcm_ym2151_interface = new YM2151interface
	(
		1,			/* 1 chip */
		3579580,
		new int[] { YM3012_VOL(10,MIXER_PAN_CENTER,10,MIXER_PAN_CENTER) },
		new WriteYmHandlerPtr[] { williams_adpcm_ym2151_irq }
	);
	...
	/* CVSD structure */
	static hc55516_interface williams_cvsd_interface = new hc55516_interface
	(
		1,			/* 1 chip */
		new int[] { 80 }
	);
	...
	static OKIM6295interface williams_adpcm_6295_interface_REGION_SOUND1 = new OKIM6295interface
	(
		1,          	/* 1 chip */
		new int[] { 8000 },       /* 8000 Hz frequency */
		new int[] { REGION_SOUND1 },  /* memory */
		new int[] { 50 }
	);
	...
	(
		dcs_custom_start,dcs_custom_stop,null
);
	...
	****************************************************************************/
	...
	public static WriteHandlerPtr williams_dcs_bank_select_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		dcs.bank = data & 0x7ff;
	...
	public static ReadHandlerPtr williams_dcs_bank_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	****************************************************************************/
	...
	public static WriteHandlerPtr williams_adpcm_data_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	****************************************************************************/
	...
	public static WriteHandlerPtr williams_narc_data_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		soundlatch_w.handler(0, data & 0xff);
		if (!(data & 0x100))
	...
	****************************************************************************/
	...
	public static ReadHandlerPtr williams_dcs_data_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr williams_dcs_data_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* data is actually only 8 bit (read from d8-d15) */
	...
	public static ReadHandlerPtr williams_dcs_control_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr williams_dcs_latch_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		dcs.latch_control |= 0x800;
		/* clear the irq line */
		cpu_set_irq_line( williams_cpunum, ADSP2105_IRQ2, CLEAR_LINE );
	...
	public static WriteHandlerPtr williams_dcs_latch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	*/
	...
	public static WriteHandlerPtr williams_dcs_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	****************************************************************************/
	...
	public static WriteHandlerPtr dcs_speedup1_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	/*
	...
	*/
	...
	public static WriteHandlerPtr dcs_speedup2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	/*
