...
public class targ
{
	...
	public static ShStartPtr targ_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr targ_sh_stop = new ShStopPtr() { public void handler() 
	{
