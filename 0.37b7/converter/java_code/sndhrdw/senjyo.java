...
public class senjyo
{
	...
	public static ShStartPtr senjyo_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	    int i;
	...
	public static ShStopPtr senjyo_sh_stop = new ShStopPtr() { public void handler() 
	{
		free(_single);
	} };
	...
	public static ShUpdatePtr senjyo_sh_update = new ShUpdatePtr() { public void handler() 
	{
		double period;
