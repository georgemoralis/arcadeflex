...
public class pleiads
{
	...
	public static ShStartPtr pleiads_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStartPtr naughtyb_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStartPtr popflame_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
