...
public class rastan
{
	...
	*/
	...
	public static ReadHandlerPtr rastan_a001_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr rastan_a000_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int pom;
	...
	public static WriteHandlerPtr rastan_a001_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		data &= 0x0f;
