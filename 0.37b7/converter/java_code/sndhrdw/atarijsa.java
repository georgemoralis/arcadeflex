...
public class atarijsa
{
	...
	static MemoryReadAddress atarijsa3s_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x1fff, MRA_RAM ),
		new MemoryReadAddress( 0x2000, 0x2001, YM2151_status_port_0_r ),
		new MemoryReadAddress( 0x2800, 0x2bff, jsa3s_io_r ),
		new MemoryReadAddress( 0x3000, 0xffff, MRA_ROM ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	
	
	static MemoryWriteAddress atarijsa3s_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x1fff, MWA_RAM ),
		new MemoryWriteAddress( 0x2000, 0x2000, YM2151_register_port_0_w ),
		new MemoryWriteAddress( 0x2001, 0x2001, YM2151_data_port_0_w ),
		new MemoryWriteAddress( 0x2800, 0x2bff, jsa3s_io_w ),
		new MemoryWriteAddress( 0x3000, 0xffff, MWA_ROM ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	static YM2151interface atarijsa_ym2151_interface_mono = new YM2151interface
	(
		1,			/* 1 chip */
		ATARI_CLOCK_14MHz/4,
	...
	static YM2151interface atarijsa_ym2151_interface_stereo = new YM2151interface
	(
		1,			/* 1 chip */
		ATARI_CLOCK_14MHz/4,
	...
	static YM2151interface atarijsa_ym2151_interface_stereo_swapped = new YM2151interface
	(
		1,			/* 1 chip */
		ATARI_CLOCK_14MHz/4,
	...
	static OKIM6295interface atarijsa_okim6295_interface_REGION_SOUND1 = new OKIM6295interface
	(
		1,              /* 1 chip */
	...
	static OKIM6295interface atarijsa_okim6295s_interface_REGION_SOUND1 = new OKIM6295interface
	(
		2, 				/* 2 chips */
		new int[] { ATARI_CLOCK_14MHz/4/3/132, ATARI_CLOCK_14MHz/4/3/132 },
