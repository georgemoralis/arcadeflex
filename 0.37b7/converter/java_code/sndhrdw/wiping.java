...
public class wiping
{
	...
	public static ShStartPtr wiping_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr wiping_sh_stop = new ShStopPtr() { public void handler() 
	{
		free (mixer_table);
		free (mixer_buffer);
	} };
