...
public class polepos
{
	...
	/* Sound handler start              */
	/************************************/
	public static ShStartPtr polepos_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i, bits, last=0;
	...
	/* Sound handler stop               */
	/************************************/
	public static ShStopPtr polepos_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (speech != 0)
			free(speech);
		speech = NULL;
	...
	/************************************/
	public static ShUpdatePtr polepos_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
