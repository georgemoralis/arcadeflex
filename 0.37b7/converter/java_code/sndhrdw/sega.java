...
public class sega
{
	...
	*/
	...
	public static ShStartPtr sega_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShUpdatePtr sega_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int sound;
	...
	public static ShStartPtr tacscan_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		roarPlaying = 0;
		return 0;
	} };
	...
	public static ShUpdatePtr tacscan_sh_update = new ShUpdatePtr() { public void handler() 
	{
