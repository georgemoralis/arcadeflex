...
public class bzone
{
	...
	public static ShStartPtr bzone_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	    int i;
	...
	public static ShStopPtr bzone_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (discharge != 0)
			free(discharge);
		discharge = NULL;
	...
	public static ShUpdatePtr bzone_sh_update = new ShUpdatePtr() { public void handler() 
	{
		stream_update(channel, 0);
	} };
