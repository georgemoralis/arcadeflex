...
public class leland
{
	...
	public static ShStartPtr leland_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		/* reset globals */
	...
	public static ShStopPtr leland_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (dac_buffer[0])
			free(dac_buffer[0]);
		if (dac_buffer[1])
	...
	public static ShStartPtr leland_i186_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShStartPtr redline_i186_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	static IOWritePort redline_i86_writeport[] =
	{
