...
public class redbaron
{
	...
	public static ShStartPtr redbaron_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	    int i;
	...
	public static ShStopPtr redbaron_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (vol_lookup != 0)
			free(vol_lookup);
		vol_lookup = NULL;
	...
	public static ShUpdatePtr redbaron_sh_update = new ShUpdatePtr() { public void handler() 
	{
		stream_update(channel, 0);
	} };
