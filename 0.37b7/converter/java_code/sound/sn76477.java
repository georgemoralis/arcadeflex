...
public class sn76477
{
	...
	public static ShStartPtr SN76477_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShStopPtr SN76477_sh_stop = new ShStopPtr() { public void handler() 
	{
		int i;
		for( i = 0; i < intf.num; i++ )
		{
	...
	public static ShUpdatePtr SN76477_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int i;
		for( i = 0; i < intf.num; i++ )
			stream_update(i,0);
