...
public class _3812intf
{
	...
	static public static ShStartPtr nonemu_YM3812_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	static public static ShStopPtr nonemu_YM3812_sh_stop = new ShStopPtr() { public void handler() 
	{
		YM3812_sh_reset();
		free(nonemu_state);
	} };
	...
	/************************************************/
	static public static ShStartPtr emu_YM3812_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	/* Sound Hardware Stop							*/
	/************************************************/
	static public static ShStopPtr emu_YM3812_sh_stop = new ShStopPtr() { public void handler() 
	{
		int i;
	...
	static public static ShStartPtr OPL_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStartPtr YM3812_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		chiptype = OPL_TYPE_YM3812;
		return OPL_sh_start(msound);
	} };
	
	public static ShStopPtr YM3812_sh_stop = new ShStopPtr() { public void handler()  {
		(*sh_stop)();
	} };
	 ...
	 **********************************************************************************************/
	public static ShStartPtr YM3526_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	 ...
	 **********************************************************************************************/
	#if (HAS_Y8950)
	public static ShStartPtr Y8950_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
