...
public class tms36xx
{
	...
	public static ShStartPtr tms36xx_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i, j;
	...
	public static ShStopPtr tms36xx_sh_stop = new ShStopPtr() { public void handler() 
	{
		int i;
		for( i = 0; i < intf.num; i++ )
		{
	...
	public static ShUpdatePtr tms36xx_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int i;
	    for( i = 0; i < intf.num; i++ )
			stream_update(i,0);
