...
public class cem3394
{
	...
	********************************************************************************/
	...
	public static ShStartPtr cem3394_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr cem3394_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (mixer_buffer != 0)
			free(mixer_buffer);
