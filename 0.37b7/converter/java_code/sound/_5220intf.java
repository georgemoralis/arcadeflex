...
public class _5220intf
{
	...
	***********************************************************************************************/
	...
	public static ShStartPtr tms5220_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	***********************************************************************************************/
	...
	public static ShStopPtr tms5220_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
	...
	***********************************************************************************************/
	...
	public static ShUpdatePtr tms5220_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
