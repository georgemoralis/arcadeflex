...
public class _2608intf
{
	...
	public static timer_callback timer_callback_2608 = new timer_callback() { public void handler(int param) 
	{
		int n=param&0x7f;
		int c=param>>7;
	...
	public static ShStartPtr YM2608_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i,j;
	...
	/* Sound Hardware Stop							*/
	/************************************************/
	public static ShStopPtr YM2608_sh_stop = new ShStopPtr() { public void handler() 
	{
		YM2608Shutdown();
		if (rhythm_buf != 0) free(rhythm_buf);
		rhythm_buf = 0;
	} };
	/* reset */
