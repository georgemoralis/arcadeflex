...
public class k005289
{
	...
	public static ShStartPtr K005289_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr K005289_sh_stop = new ShStopPtr() { public void handler() 
	{
		free (mixer_table);
		free (mixer_buffer);
	} };
