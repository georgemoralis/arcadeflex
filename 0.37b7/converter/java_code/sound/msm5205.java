...
public class msm5205
{
	...
	public static ShStartPtr MSM5205_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShStopPtr MSM5205_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
	...
	public static ShUpdatePtr MSM5205_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
