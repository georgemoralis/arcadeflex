...
public class k053260
{
	...
	public static WriteHandlerPtr K053260_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int i, t;
		int r = offset;
		int v = data;
	...
	public static ReadHandlerPtr K053260_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch ( offset ) {
