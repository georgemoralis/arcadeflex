...
public class vlm5030
{
	...
	public static ShStartPtr VLM5030_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int emulation_rate;
	...
	/* update VLM5030 */
	public static ShUpdatePtr VLM5030_sh_update = new ShUpdatePtr() { public void handler() 
	{
		VLM5030_update();
	} };
	
	/* stop VLM5030 */
	public static ShStopPtr VLM5030_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
}
