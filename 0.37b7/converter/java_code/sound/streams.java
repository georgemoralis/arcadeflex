...
public class streams
{
	...
	*/
	...
	public static ShStopPtr streams_sh_stop = new ShStopPtr() { public void handler() 
	{
		int i;
	...
	public static ShUpdatePtr streams_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int channel,i;
