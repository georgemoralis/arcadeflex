...
public class _2151intf
{
	...
	public static timer_callback timer_callback_2151 = new timer_callback() { public void handler(int param) 
	{
		int n=param&0x7f;
		int c=param>>7;
	...
	#if (HAS_YM2151)
	public static ShStartPtr YM2151_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr YM2151_sh_stop = new ShStopPtr() { public void handler() 
	{
		switch(FMMode)
		{
	#if (HAS_YM2151)
