...
public class namco
{
	...
	public static ShStartPtr namco_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr namco_sh_stop = new ShStopPtr() { public void handler() 
	{
		free (mixer_table);
		free (mixer_buffer);
	} };
