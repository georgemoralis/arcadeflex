...
public class _5110intf
{
	...
	******************************************************************************/
	...
	public static ShStartPtr tms5110_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	******************************************************************************/
	...
	public static ShStopPtr tms5110_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
	...
	******************************************************************************/
	...
	public static ShUpdatePtr tms5110_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
