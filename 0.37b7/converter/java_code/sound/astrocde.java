...
public class astrocde
{
	...
	public static ShStartPtr astrocade_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShStopPtr astrocade_sh_stop = new ShStopPtr() { public void handler() 
	{
		int i;
	...
	public static ShUpdatePtr astrocade_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int num;
