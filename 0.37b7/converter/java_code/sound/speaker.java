...
public class speaker
{
	...
	public static ShStartPtr speaker_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShStopPtr speaker_sh_stop = new ShStopPtr() { public void handler() 
	{
		/* nothing */
	} };
	
	public static ShUpdatePtr speaker_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int i;
		for( i = 0; i < intf.num; i++ )
