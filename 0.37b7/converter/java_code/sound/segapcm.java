...
public class segapcm
{
	...
	/*                                              */
	/************************************************/
	public static ShStopPtr SEGAPCM_sh_stop = new ShStopPtr() { public void handler() 
	{
		SEGAPCMShutdown();
	} };
	/************************************************/
	/*                                              */
	/************************************************/
	public static ShUpdatePtr SEGAPCM_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
