...
public class adpcm
{
	...
	***********************************************************************************************/
	...
	public static ShStartPtr ADPCM_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	***********************************************************************************************/
	...
	public static ShStopPtr ADPCM_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
	...
	***********************************************************************************************/
	...
	public static ShUpdatePtr ADPCM_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
	...
	***********************************************************************************************/
	...
	public static ShStartPtr OKIM6295_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	***********************************************************************************************/
	...
	public static ShStopPtr OKIM6295_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
	...
	***********************************************************************************************/
	...
	public static ShUpdatePtr OKIM6295_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
