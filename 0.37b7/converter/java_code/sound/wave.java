...
public class wave
{
	...
	public static ShStartPtr wave_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
		int i;
	...
	public static ShStopPtr wave_sh_stop = new ShStopPtr() { public void handler() 
	{
		int i;
	...
	public static ShUpdatePtr wave_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int i;
