...
public class nes_apu
{
	...
	public static ShStartPtr NESPSG_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	/* HALT APU SYSTEM */
	public static ShStopPtr NESPSG_sh_stop = new ShStopPtr() { public void handler() 
	{
	  int i;
	...
	/* UPDATE APU SYSTEM */
	public static ShUpdatePtr NESPSG_sh_update = new ShUpdatePtr() { public void handler() 
	{
	  int i;
