...
public class k051649
{
	...
	public static ShStartPtr K051649_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr K051649_sh_stop = new ShStopPtr() { public void handler() 
	{
		free (mixer_table);
		free (mixer_buffer);
	} };
