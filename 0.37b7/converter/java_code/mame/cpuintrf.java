...
public class cpuintrf
{
	...
	static static double cpu_computerate(int value);
	static 
	...
	***************************************************************************/
	public static WriteHandlerPtr cpu_0_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(0, offset, data); } };
	public static WriteHandlerPtr cpu_1_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(1, offset, data); } };
	public static WriteHandlerPtr cpu_2_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(2, offset, data); } };
	public static WriteHandlerPtr cpu_3_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(3, offset, data); } };
	public static WriteHandlerPtr cpu_4_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(4, offset, data); } };
	public static WriteHandlerPtr cpu_5_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(5, offset, data); } };
	public static WriteHandlerPtr cpu_6_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(6, offset, data); } };
	public static WriteHandlerPtr cpu_7_irq_line_vector_w = new WriteHandlerPtr() {public void handler(int offset, int data) { cpu_irq_line_vector_w(7, offset, data); } };
	...
	***************************************************************************/
	...
	#if (HAS_M68000 || HAS_M68010 || HAS_M68020 || HAS_M68EC020)
	public static InterruptPtr m68_level1_irq = new InterruptPtr() { public int handler() 
	{
		int cpunum = (activecpu < 0) ? 0 : activecpu;
		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
		return MC68000_IRQ_1;
	} };
	public static InterruptPtr m68_level2_irq = new InterruptPtr() { public int handler() 
	{
		int cpunum = (activecpu < 0) ? 0 : activecpu;
		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
		return MC68000_IRQ_2;
	} };
	public static InterruptPtr m68_level3_irq = new InterruptPtr() { public int handler() 
	{
		int cpunum = (activecpu < 0) ? 0 : activecpu;
		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
		return MC68000_IRQ_3;
	} };
	public static InterruptPtr m68_level4_irq = new InterruptPtr() { public int handler() 
	{
		int cpunum = (activecpu < 0) ? 0 : activecpu;
		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
		return MC68000_IRQ_4;
	} };
	public static InterruptPtr m68_level5_irq = new InterruptPtr() { public int handler() 
	{
		int cpunum = (activecpu < 0) ? 0 : activecpu;
		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
		return MC68000_IRQ_5;
	} };
	public static InterruptPtr m68_level6_irq = new InterruptPtr() { public int handler() 
	{
		int cpunum = (activecpu < 0) ? 0 : activecpu;
		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
		return MC68000_IRQ_6;
	} };
	public static InterruptPtr m68_level7_irq = new InterruptPtr() { public int handler() 
	{
		int cpunum = (activecpu < 0) ? 0 : activecpu;
		if (interrupt_enable[cpunum] == 0) return MC68000_INT_NONE;
