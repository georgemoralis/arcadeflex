...
public class drawgfx
{
		...
		while (srcheight)
		{
			...
			while (dstdata <= end - 4)
			{
				...
				if ((col4 = *(sd4++)) != trans4)
				{
					...
					{
						if ((xod4 & 0xff000000) != 0) dstdata[BL3] = col4 >> 24;
						if ((xod4 & 0x00ff0000) != 0) dstdata[BL2] = col4 >> 16;
						if ((xod4 & 0x0000ff00) != 0) dstdata[BL1] = col4 >>  8;
						if ((xod4 & 0x000000ff) != 0) dstdata[BL0] = col4;
					}
				}
				dstdata += 4;
			}
		...
		while (srcheight)
		{
			...
			while (dstdata <= end - 4)
			{
				...
				if ((col4 = *(sd4--)) != trans4)
				{
					...
					xod4 = col4 ^ trans4;
					if ((xod4 & 0x000000ff) != 0) dstdata[BL3] = col4;
					if ((xod4 & 0x0000ff00) != 0) dstdata[BL2] = col4 >>  8;
					if ((xod4 & 0x00ff0000) != 0) dstdata[BL1] = col4 >> 16;
					if ((xod4 & 0xff000000) != 0) dstdata[BL0] = col4 >> 24;
				}
				dstdata += 4;
			}
			srcdata = (UINT8 *)sd4;
	...
	***************************************************************************/
	...
	public static plot_pixel_procPtr pp_8_nd  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[y][x] = p; } };
	public static plot_pixel_procPtr pp_8_nd_fx  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[y][b.width-1-x] = p; } };
	public static plot_pixel_procPtr pp_8_nd_fy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[b.height-1-y][x] = p; } };
	public static plot_pixel_procPtr pp_8_nd_fxy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[b.height-1-y][b.width-1-x] = p; } };
	public static plot_pixel_procPtr pp_8_nd_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[x][y] = p; } };
	public static plot_pixel_procPtr pp_8_nd_fx_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[x][b.width-1-y] = p; } };
	public static plot_pixel_procPtr pp_8_nd_fy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[b.height-1-x][y] = p; } };
	public static plot_pixel_procPtr pp_8_nd_fxy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[b.height-1-x][b.width-1-y] = p; } };
	
	public static plot_pixel_procPtr pp_8_d  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[y][x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_8_d_fx  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x;  b.line[y][x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_8_d_fy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.height-1-y; b.line[y][x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_8_d_fxy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x; y = b.height-1-y; b.line[y][x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_8_d_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[x][y] = p; osd_mark_dirty (y,x,y,x,0); } };
	public static plot_pixel_procPtr pp_8_d_fx_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.width-1-y; b.line[x][y] = p; osd_mark_dirty (y,x,y,x,0); } };
	public static plot_pixel_procPtr pp_8_d_fy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; b.line[x][y] = p; osd_mark_dirty (y,x,y,x,0); } };
	public static plot_pixel_procPtr pp_8_d_fxy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; y = b.width-1-y; b.line[x][y] = p; osd_mark_dirty (y,x,y,x,0); } };
	
	public static plot_pixel_procPtr pp_16_nd  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[y])[x] = p; } };
	public static plot_pixel_procPtr pp_16_nd_fx  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[y])[b.width-1-x] = p; } };
	public static plot_pixel_procPtr pp_16_nd_fy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[b.height-1-y])[x] = p; } };
	public static plot_pixel_procPtr pp_16_nd_fxy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[b.height-1-y])[b.width-1-x] = p; } };
	public static plot_pixel_procPtr pp_16_nd_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[x])[y] = p; } };
	public static plot_pixel_procPtr pp_16_nd_fx_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[x])[b.width-1-y] = p; } };
	public static plot_pixel_procPtr pp_16_nd_fy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[b.height-1-x])[y] = p; } };
	public static plot_pixel_procPtr pp_16_nd_fxy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[b.height-1-x])[b.width-1-y] = p; } };
	
	public static plot_pixel_procPtr pp_16_d  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_16_d_fx  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x;  ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_16_d_fy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.height-1-y; ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_16_d_fxy  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.width-1-x; y = b.height-1-y; ((UINT16 *)b.line[y])[x] = p; osd_mark_dirty (x,y,x,y,0); } };
	public static plot_pixel_procPtr pp_16_d_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty (y,x,y,x,0); } };
	public static plot_pixel_procPtr pp_16_d_fx_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { y = b.width-1-y; ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty (y,x,y,x,0); } };
	public static plot_pixel_procPtr pp_16_d_fy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty (y,x,y,x,0); } };
	public static plot_pixel_procPtr pp_16_d_fxy_s  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { x = b.height-1-x; y = b.width-1-y; ((UINT16 *)b.line[x])[y] = p; osd_mark_dirty (y,x,y,x,0); } };
	...
	public static plot_box_procPtr pb_8_nd  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_8_nd_fx  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_8_nd_fy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->height-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_8_nd_fxy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; y = b->height-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x--; } y--; } } };
	public static plot_box_procPtr pb_8_nd_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_8_nd_fx_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->width-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_8_nd_fy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_8_nd_fxy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; y = b->width-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x--; } y--; } } };
	
	public static plot_box_procPtr pb_8_d  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty (t,y,t+w-1,y+h-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_8_d_fx  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x;  osd_mark_dirty (t-w+1,y,t,y+h-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_8_d_fy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->height-1-y; osd_mark_dirty (t,y-h+1,t+w-1,y,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_8_d_fxy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; y = b->height-1-y; osd_mark_dirty (t-w+1,y-h+1,t,y,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[y][x] = p; x--; } y--; } } };
	public static plot_box_procPtr pb_8_d_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty (y,t,y+h-1,t+w-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_8_d_fx_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->width-1-y;  osd_mark_dirty (y-h+1,t,y,t+w-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_8_d_fy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; osd_mark_dirty (y,t-w+1,y+h-1,t,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_8_d_fxy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; y = b->width-1-y; osd_mark_dirty (y-h+1,t-w+1,y,t,0); while(h-->0){ int c=w; x=t; while(c-->0){ b->line[x][y] = p; x--; } y--; } } };
	
	public static plot_box_procPtr pb_16_nd  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_16_nd_fx  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_16_nd_fy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->height-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_16_nd_fxy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; y = b->height-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x--; } y--; } } };
	public static plot_box_procPtr pb_16_nd_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_16_nd_fx_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->width-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_16_nd_fy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_16_nd_fxy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; y = b->width-1-y; while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x--; } y--; } } };
	
	public static plot_box_procPtr pb_16_d  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty (t,y,t+w-1,y+h-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_16_d_fx  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x;  osd_mark_dirty (t-w+1,y,t,y+h-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_16_d_fy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->height-1-y; osd_mark_dirty (t,y-h+1,t+w-1,y,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_16_d_fxy  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->width-1-x; y = b->height-1-y; osd_mark_dirty (t-w+1,y-h+1,t,y,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[y])[x] = p; x--; } y--; } } };
	public static plot_box_procPtr pb_16_d_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; osd_mark_dirty (y,t,y+h-1,t+w-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x++; } y++; } } };
	public static plot_box_procPtr pb_16_d_fx_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=x; y = b->width-1-y; osd_mark_dirty (y-h+1,t,y,t+w-1,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x++; } y--; } } };
	public static plot_box_procPtr pb_16_d_fy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; osd_mark_dirty (y,t-w+1,y+h-1,t,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x--; } y++; } } };
	public static plot_box_procPtr pb_16_d_fxy_s  = new plot_box_procPtr() { public void handler(osd_bitmap b, int x, int y, int w, int h, int p)   { int t=b->height-1-x; y = b->width-1-y; osd_mark_dirty (y-h+1,t-w+1,y,t,0); while(h-->0){ int c=w; x=t; while(c-->0){ ((UINT16 *)b->line[x])[y] = p; x--; } y--; } } };
		...
		while (srcheight)
		{
			...
			while (dstdata <= end - 4)
			{
				...
				if ((col4 = *(sd4++)) != trans4)
				{
					...
					xod4 = col4 ^ trans4;
					if ((xod4 & 0x000000ff) != 0) dstdata[BL0] = paldata[(col4) & 0xff];
					if ((xod4 & 0x0000ff00) != 0) dstdata[BL1] = paldata[(col4 >>  8) & 0xff];
					if ((xod4 & 0x00ff0000) != 0) dstdata[BL2] = paldata[(col4 >> 16) & 0xff];
					if ((xod4 & 0xff000000) != 0) dstdata[BL3] = paldata[col4 >> 24];
				}
				dstdata += 4;
			}
			srcdata = (UINT8 *)sd4;
		...
		while (srcheight)
		{
			...
			while (dstdata <= end - 4)
			{
				...
				if ((col4 = *(sd4--)) != trans4)
				{
					...
					xod4 = col4 ^ trans4;
					if ((xod4 & 0xff000000) != 0) dstdata[BL0] = paldata[col4 >> 24];
					if ((xod4 & 0x00ff0000) != 0) dstdata[BL1] = paldata[(col4 >> 16) & 0xff];
					if ((xod4 & 0x0000ff00) != 0) dstdata[BL2] = paldata[(col4 >>  8) & 0xff];
					if ((xod4 & 0x000000ff) != 0) dstdata[BL3] = paldata[col4 & 0xff];
				}
				dstdata += 4;
			}
			srcdata = (UINT8 *)sd4;
		...
		while (srcheight)
		{
			...
			while (dstdata <= end - 4)
			{
				...
				if ((col4 = *(sd4++)) != trans4)
				{
					...
					xod4 = col4 ^ trans4;
					if ((xod4 & 0x000000ff) != 0) dstdata[BL0] = colorbase + ((col4) & 0xff);
					if ((xod4 & 0x0000ff00) != 0) dstdata[BL1] = colorbase + ((col4 >>  8) & 0xff);
					if ((xod4 & 0x00ff0000) != 0) dstdata[BL2] = colorbase + ((col4 >> 16) & 0xff);
					if ((xod4 & 0xff000000) != 0) dstdata[BL3] = colorbase + (col4 >> 24);
				}
				dstdata += 4;
			}
			srcdata = (UINT8 *)sd4;
		...
		while (srcheight)
		{
			...
			while (dstdata <= end - 4)
			{
				...
				if ((col4 = *(sd4--)) != trans4)
				{
					...
					xod4 = col4 ^ trans4;
					if ((xod4 & 0xff000000) != 0) dstdata[BL0] = colorbase + (col4 >> 24);
					if ((xod4 & 0x00ff0000) != 0) dstdata[BL1] = colorbase + ((col4 >> 16) & 0xff);
					if ((xod4 & 0x0000ff00) != 0) dstdata[BL2] = colorbase + ((col4 >>  8) & 0xff);
					if ((xod4 & 0x000000ff) != 0) dstdata[BL3] = colorbase + (col4 & 0xff);
				}
				dstdata += 4;
			}
			srcdata = (UINT8 *)sd4;
			...
			const UINT16 *paldata,int transmask),
	{
		...
		while (srcheight)
		{
			...
			while (((long)srcdata & 3) && dstdata < end)	/* longword align */
			{
				...
				col = *(srcdata++);
				if (PEN_IS_OPAQUE != 0) *dstdata = paldata[col];
				dstdata++;
			}
			sd4 = (UINT32 *)srcdata;
			while (dstdata <= end - 4)
			{
				...
				col4 = *(sd4++);
				col = (col4 >>  0) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL0] = paldata[col];
				col = (col4 >>  8) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL1] = paldata[col];
				col = (col4 >> 16) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL2] = paldata[col];
				col = (col4 >> 24) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL3] = paldata[col];
				dstdata += 4;
			}
			srcdata = (UINT8 *)sd4;
			while (dstdata < end)
			...
			unsigned int colorbase,int transmask),
	{
		...
		while (srcheight)
		{
			...
			while (((long)srcdata & 3) && dstdata < end)	/* longword align */
			{
				...
				col = *(srcdata++);
				if (PEN_IS_OPAQUE != 0) *dstdata = colorbase + col;
				dstdata++;
			}
			sd4 = (UINT32 *)srcdata;
			while (dstdata <= end - 4)
			{
				...
				col4 = *(sd4++);
				col = (col4 >>  0) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL0] = colorbase + col;
				col = (col4 >>  8) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL1] = colorbase + col;
				col = (col4 >> 16) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL2] = colorbase + col;
				col = (col4 >> 24) & 0xff;
				if (PEN_IS_OPAQUE != 0) dstdata[BL3] = colorbase + col;
				dstdata += 4;
			}
			srcdata = (UINT8 *)sd4;
			while (dstdata < end)
