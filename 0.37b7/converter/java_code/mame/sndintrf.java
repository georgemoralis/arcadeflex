...
public class sndintrf
{
	...
	***************************************************************************/
	...
	public static timer_callback soundlatch3_callback = new timer_callback() { public void handler(int param) 
	{
	...
	public static timer_callback soundlatch4_callback = new timer_callback() { public void handler(int param) 
	{
	...
	***************************************************************************/
	...
	public static ShStartPtr custom_sh_start = new ShStartPtr() { public int handler(MachineSound msound) 
	{
	...
	public static ShStopPtr custom_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (cust_intf.sh_stop) (*cust_intf.sh_stop)();
	} };
	public static ShUpdatePtr custom_sh_update = new ShUpdatePtr() { public void handler() 
	{
