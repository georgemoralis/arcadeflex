...
public static WriteHandlerPtr shiftreg_w = new WriteHandlerPtr() {public void handler(int offset, int data)
{
...
public static ReadHandlerPtr shiftreg_r  = new ReadHandlerPtr() { public int handler(int offset)
{
...
public static ReadHandlerPtr dummy_shiftreg_r  = new ReadHandlerPtr() { public int handler(int offset)
{
	return state.shiftreg[0];
} };
