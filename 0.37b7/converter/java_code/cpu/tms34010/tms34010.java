...
public class tms34010
{
	...
	**#################################################################################################*/
	...
	extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern 
	...
	extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern extern 
	...
	**#################################################################################################*/
	...
	/* read memory byte */
	INLINE public static ReadHandlerPtr RBYTE  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UINT32 ret;
		RFIELDMAC_8;
		return ret;
	...
	/* write memory byte */
	INLINE public static WriteHandlerPtr WBYTE = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		WFIELDMAC_8;
	} };
	
	/* read memory long */
	INLINE public static ReadHandlerPtr RLONG  = new ReadHandlerPtr() { public int handler(int offset)
	{
		RFIELDMAC_32;
	} };
	
	/* write memory long */
	INLINE public static WriteHandlerPtr WLONG = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		WFIELDMAC_32;
	} };
	...
	**#################################################################################################*/
	...
	public static ReadHandlerPtr read_pixel_1  = new ReadHandlerPtr() { public int handler(int offset) { RP(0x0f,0x01) } };
	public static ReadHandlerPtr read_pixel_2  = new ReadHandlerPtr() { public int handler(int offset) { RP(0x0e,0x03) } };
	public static ReadHandlerPtr read_pixel_4  = new ReadHandlerPtr() { public int handler(int offset) { RP(0x0c,0x0f) } };
	public static ReadHandlerPtr read_pixel_8  = new ReadHandlerPtr() { public int handler(int offset) { RP(0x08,0xff) } };
	public static ReadHandlerPtr read_pixel_16  = new ReadHandlerPtr() { public int handler(int offset)
	{
		/* TODO: Plane masking */
	...
	/* Shift register read */
	public static ReadHandlerPtr read_pixel_shiftreg  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	**#################################################################################################*/
	...
	/* No Raster Op + No Transparency */
	public static WriteHandlerPtr write_pixel_1 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP(0x0f, 0x01); } };
	public static WriteHandlerPtr write_pixel_2 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP(0x0e, 0x03); } };
	public static WriteHandlerPtr write_pixel_4 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP(0x0c, 0x0f); } };
	public static WriteHandlerPtr write_pixel_8 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP(0x08, 0xff); } };
	public static WriteHandlerPtr write_pixel_16 = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* TODO: plane masking */
	...
	/* No Raster Op + Transparency */
	public static WriteHandlerPtr write_pixel_t_1 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_T(0x0f, 0x01); } };
	public static WriteHandlerPtr write_pixel_t_2 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_T(0x0e, 0x03); } };
	public static WriteHandlerPtr write_pixel_t_4 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_T(0x0c, 0x0f); } };
	public static WriteHandlerPtr write_pixel_t_8 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_T(0x08, 0xff); } };
	public static WriteHandlerPtr write_pixel_t_16 = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* TODO: plane masking */
		if (data != 0)
			TMS34010_WRMEM_WORD(TOBYTE(offset & 0xfffffff0), data);
	...
	/* Raster Op + No Transparency */
	public static WriteHandlerPtr write_pixel_r_1 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R(0x0f, 0x01); } };
	public static WriteHandlerPtr write_pixel_r_2 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R(0x0e, 0x03); } };
	public static WriteHandlerPtr write_pixel_r_4 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R(0x0c, 0x0f); } };
	public static WriteHandlerPtr write_pixel_r_8 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R(0x08, 0xff); } };
	public static WriteHandlerPtr write_pixel_r_16 = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* TODO: plane masking */
		UINT32 a = TOBYTE(offset & 0xfffffff0);
	...
	/* Raster Op + Transparency */
	public static WriteHandlerPtr write_pixel_r_t_1 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R_T(0x0f,0x01); } };
	public static WriteHandlerPtr write_pixel_r_t_2 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R_T(0x0e,0x03); } };
	public static WriteHandlerPtr write_pixel_r_t_4 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R_T(0x0c,0x0f); } };
	public static WriteHandlerPtr write_pixel_r_t_8 = new WriteHandlerPtr() {public void handler(int offset, int data) { WP_R_T(0x08,0xff); } };
	public static WriteHandlerPtr write_pixel_r_t_16 = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* TODO: plane masking */
		UINT32 a = TOBYTE(offset & 0xfffffff0);
	...
	public static WriteHandlerPtr write_pixel_shiftreg = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	**#################################################################################################*/
	...
	public static WriteHandlerPtr tms34010_io_register_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr tms34020_io_register_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if (!host_interface_context)
	...
	**#################################################################################################*/
	...
	public static ReadHandlerPtr tms34010_io_register_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (!host_interface_context)
	...
	public static ReadHandlerPtr tms34020_io_register_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (!host_interface_context)
