...
static void wr_tx0(INT32 val)	{ if (adsp2105_tx_callback != 0) (*adsp2105_tx_callback)( 0, val ); }
static void wr_tx1(INT32 val)	{ if (adsp2105_tx_callback != 0) (*adsp2105_tx_callback)( 1, val ); }
...
#if SUPPORT_2101_EXTENSIONS
static INT32 rd_rx0(void)	{ if (adsp2105_rx_callback != 0) return (*adsp2105_rx_callback)( 0 ); else return 0; }
static INT32 rd_rx1(void)	{ if (adsp2105_rx_callback != 0) return (*adsp2105_rx_callback)( 1 ); else return 0; }
#endif
