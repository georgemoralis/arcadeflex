...
public class i8039
{
	...
	static void jmp(void)
	{
	  ...
	  if (newpc == oldpc) { if (i8039_ICount > 0) i8039_ICount = 0; } /* speed up busy loop */
		...
		static void jf0(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (M_F0y != 0) { R.PC.w.l = (R.PC.w.l & 0xf00) | i; change_pc(R.PC.w.l); } }
		static void jf_1(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (R.f1)	{ R.PC.w.l = (R.PC.w.l & 0xf00) | i; change_pc(R.PC.w.l); } }
		static void jnc(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (M_Cn != 0)	{ R.PC.w.l = (R.PC.w.l & 0xf00) | i; change_pc(R.PC.w.l); } }
		static void jc(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (M_Cy != 0)	{ R.PC.w.l = (R.PC.w.l & 0xf00) | i; change_pc(R.PC.w.l); } }
		...
		static void jf0(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (M_F0y != 0) { R.PC.w.l = (R.PC.w.l & 0xf00) | i; } }
		static void jf_1(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (R.f1)	{ R.PC.w.l = (R.PC.w.l & 0xf00) | i; } }
		static void jnc(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (M_Cn != 0)	{ R.PC.w.l = (R.PC.w.l & 0xf00) | i; } }
		static void jc(void)		 { UINT8 i=M_RDMEM_OPCODE(); if (M_Cy != 0)	{ R.PC.w.l = (R.PC.w.l & 0xf00) | i; } }
