...
public class gunsmoke
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );/* probably unused */
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );/* probably unused */
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_COCKTAIL );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );/* probably unused */
	
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x03, "30k, 100k & every 100k");	PORT_DIPSETTING(    0x02, "30k, 80k & every 80k" );	PORT_DIPSETTING(    0x01, "30k & 100K only");	PORT_DIPSETTING(    0x00, "30k, 100k & every 150k" );	PORT_DIPNAME( 0x04, 0x04, "Demonstration" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x20, "Easy" );	PORT_DIPSETTING(    0x30, "Normal" );	PORT_DIPSETTING(    0x10, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x40, 0x40, "Freeze" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gunsmoke = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "11f_gs01.bin", 0x00000, 0x4000, 0xb61ece9b );/* Characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "06c_gs13.bin", 0x00000, 0x8000, 0xf6769fc5 );/* 32x32 tiles planes 2-3 */
		ROM_LOAD( "05c_gs12.bin", 0x08000, 0x8000, 0xd997b78c );	ROM_LOAD( "04c_gs11.bin", 0x10000, 0x8000, 0x125ba58e );	ROM_LOAD( "02c_gs10.bin", 0x18000, 0x8000, 0xf469c13c );	ROM_LOAD( "06a_gs09.bin", 0x20000, 0x8000, 0x539f182d );/* 32x32 tiles planes 0-1 */
		ROM_LOAD( "05a_gs08.bin", 0x28000, 0x8000, 0xe87e526d );	ROM_LOAD( "04a_gs07.bin", 0x30000, 0x8000, 0x4382c0d2 );	ROM_LOAD( "02a_gs06.bin", 0x38000, 0x8000, 0x4cafe7a6 );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "06n_gs22.bin", 0x00000, 0x8000, 0xdc9c508c );/* Sprites planes 2-3 */
		...
		ROM_REGION( 0x0a00, REGION_PROMS );	ROM_LOAD( "03b_g-01.bin", 0x0000, 0x0100, 0x02f55589 );/* red component */
