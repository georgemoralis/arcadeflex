...
public class megasys1
{
	...
	***************************************************************************/
	...
	static MemoryReadAddress readmem_##_shortname_[] =\
	{ \
		new MemoryReadAddress( 0x000000, 0x05ffff, MRA_ROM					), \
		new MemoryReadAddress( _ram_start_, _ram_end_, MRA_BANK1				), \
	...
	static MemoryWriteAddress writemem_##_shortname_[] =\
	{ \
	 	new MemoryWriteAddress( 0x000000, 0x05ffff, MWA_ROM											), \
		new MemoryWriteAddress( _ram_start_, _ram_end_, MWA_BANK1,			megasys1_ram			), \
	...
	***************************************************************************/
	...
	{ \
		...
		new MemoryReadAddress( 0x100000, 0x100001, protection_##_shortname_##_r	), /* Protection */ \
		new MemoryReadAddress( -1 ) \
	}; \
	static MemoryWriteAddress writemem_##_shortname_[] =\
	{ \
		...
		new MemoryWriteAddress( 0x100000, 0x100001, protection_##_shortname_##_w						), /* Protection */ \
		new MemoryWriteAddress( -1 ) \
	};
	...
	*/
	...
	public static WriteHandlerPtr ms_soundlatch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		...
		soundlatch_w.handler(0, READ_WORD(val) );
	} };
	...
	public static WriteHandlerPtr ms_soundlatch2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		static unsigned char val[2];
		COMBINE_WORD_MEM(val,data);
		soundlatch2_w.handler(0, READ_WORD(val) );
	} };
	...
	***************************************************************************/
	...
	#if SOUND_HACK
		new MemoryReadAddress( 0x0a0000, 0x0a0001, MRA_NOP					),
		new MemoryReadAddress( 0x0c0000, 0x0c0001, MRA_NOP					),
	#else
	...
	***************************************************************************/
	...
	static YM2151interface ym2151_interface_##_shortname_ = new YM2151interface\
	( \
		1, \
		_fm_clock_, \
	 ...
	 \
	static OKIM6295interface okim6295_interface_##_shortname_ = new OKIM6295interface\
	( \
		2, \
		new int[] {_oki1_clock_, _oki2_clock_},\
	...
	( \
		new MachineCPU[] { \
			new MachineCPU( \
				CPU_M68000, \
				_main_clock_, \
				readmem_##_shortname_,writemem_##_shortname_,null,null, \
	...
	***************************************************************************/
	...
	#define MEGASYS1_MACHINE_Z(	_type_, \
								_shortname_,_main_clock_,_sound_clock_, \
								_fm_clock_,_oki1_clock_,_oki2_clock_) \
	static YM2203interface ym2203_interface_##_shortname_ = new YM2203interface\
	( \
		1, \
		_fm_clock_, \
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_64street = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "64th_03.rom", 0x000000, 0x040000, 0xed6c6942 );	ROM_LOAD_ODD(  "64th_02.rom", 0x000000, 0x040000, 0x0621ed1d );
		ROM_LOAD_64STREET
	...
	static RomLoadPtr rom_64streej = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "91105-3.bin", 0x000000, 0x040000, 0xa211a83b );	ROM_LOAD_ODD(  "91105-2.bin", 0x000000, 0x040000, 0x27c1f436 );
		ROM_LOAD_64STREET
	...
	//	fire	jump
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x18, "Normal" );	PORT_DIPSETTING(    0x08, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x60, 0x20, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x40, "1" );	PORT_DIPSETTING(    0x60, "2" );	PORT_DIPSETTING(    0x20, "3" );	PORT_DIPSETTING(    0x00, "5" );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_astyanax = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "astyan2.bin", 0x00000, 0x20000, 0x1b598dcc );	ROM_LOAD_ODD(  "astyan1.bin", 0x00000, 0x20000, 0x1a1ad3cf );	ROM_LOAD_EVEN( "astyan3.bin", 0x40000, 0x10000, 0x097b53a6 );	ROM_LOAD_ODD(  "astyan4.bin", 0x40000, 0x10000, 0x1e1cbdb2 );
		ASTYANAX_ROM_LOAD
	...
	static RomLoadPtr rom_lordofk = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "lokj02.bin", 0x00000, 0x20000, 0x0d7f9b4a );	ROM_LOAD_ODD(  "lokj01.bin", 0x00000, 0x20000, 0xbed3cb93 );	ROM_LOAD_EVEN( "lokj03.bin", 0x40000, 0x20000, 0xd8702c91 );	ROM_LOAD_ODD(  "lokj04.bin", 0x40000, 0x20000, 0xeccbf8c9 );
		ASTYANAX_ROM_LOAD
	...
	//	PORT_DIPSETTING(    0x30, DEF_STR( "1C_1C") );	// 1_5
		...
		PORT_DIPSETTING(    0x04, "30k 70k 110k then every 30k" );	PORT_DIPSETTING(    0x00, "50k 100k then every 40k" );	PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "2" );	PORT_DIPSETTING(    0x18, "3" );	PORT_DIPSETTING(    0x10, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x20, "Normal" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x40, 0x40, "Swap 1P/2P Controls" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_avspirit = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "spirit05.rom",  0x000000, 0x020000, 0xb26a341a );	ROM_CONTINUE (                  0x080000 & ~1, 0x020000 | ROMFLAG_ALTERNATE );	ROM_LOAD_ODD(  "spirit06.rom",  0x000000, 0x020000, 0x609f71fe );	ROM_CONTINUE (                  0x080000 | 1, 0x020000 | ROMFLAG_ALTERNATE );
		ROM_REGION( 0x40000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "spirit01.rom",  0x000000, 0x020000, 0xd02ec045 );	ROM_LOAD_ODD(  "spirit02.rom",  0x000000, 0x020000, 0x30213390 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		...
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "ph.bin",        0x0000, 0x0200, 0x8359650a );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_phantasm = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "phntsm02.bin", 0x000000, 0x020000, 0xd96a3584 );	ROM_LOAD_ODD(  "phntsm01.bin", 0x000000, 0x020000, 0xa54b4b87 );	ROM_LOAD_EVEN( "phntsm03.bin", 0x040000, 0x010000, 0x1d96ce20 );	ROM_LOAD_ODD(  "phntsm04.bin", 0x040000, 0x010000, 0xdc0c4994 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "phntsm05.bin", 0x000000, 0x010000, 0x3b169b4a );	ROM_LOAD_ODD(  "phntsm06.bin", 0x000000, 0x010000, 0xdf2dfb2e );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
	//	ROM_LOAD( "phntsm14.bin",  0x000000, 0x080000, 0x728335d4 );	ROM_LOAD( "spirit12.rom",  0x000000, 0x080000, 0x728335d4 );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
	//	ROM_LOAD( "phntsm18.bin",  0x000000, 0x080000, 0x7896f6b0 );	ROM_LOAD( "spirit11.rom",  0x000000, 0x080000, 0x7896f6b0 );
		ROM_REGION( 0x20000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* Scroll 2 */
	//	ROM_LOAD( "phntsm19.bin",  0x000000, 0x020000, 0x0c37edf7 );	ROM_LOAD( "spirit09.rom",  0x000000, 0x020000, 0x0c37edf7 );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
	//	ROM_LOAD( "phntsm23.bin",  0x000000, 0x080000, 0x2b1180b3 );	ROM_LOAD( "spirit10.rom",  0x000000, 0x080000, 0x2b1180b3 );
		ROM_REGION( 0x40000, REGION_SOUND1 );	/* Samples */
	//	ROM_LOAD( "phntsm10.bin", 0x000000, 0x040000, 0x13be9979 );	ROM_LOAD( "spirit14.rom", 0x000000, 0x040000, 0x13be9979 );
		ROM_REGION( 0x40000, REGION_SOUND2 );	/* Samples */
	//	ROM_LOAD( "phntsm08.bin", 0x000000, 0x040000, 0x05bc04d9 );	ROM_LOAD( "spirit13.rom", 0x000000, 0x040000, 0x05bc04d9 );
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "ph.bin",        0x0000, 0x0200, 0x8359650a );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bigstrik = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "91105v11.3", 0x000000, 0x020000, 0x5d6e08ec );	ROM_LOAD_ODD(  "91105v11.2", 0x000000, 0x020000, 0x2120f05b );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "91105v10.8", 0x000000, 0x010000, 0x7dd69ece );	ROM_LOAD_ODD(  "91105v10.7", 0x000000, 0x010000, 0xbc2c1508 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		...
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "prom",         0x0000, 0x0200, 0x00000000 );ROM_END(); }}; 
	...
	//	PORT_DIPSETTING(    0x60, DEF_STR( "2C_3C") );
		...
		PORT_DIPSETTING(    0x02, "Easy"    );	PORT_DIPSETTING(    0x06, "Normal"  );	PORT_DIPSETTING(    0x04, "Hard"    );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x18, 0x18, "Time" );	PORT_DIPSETTING(    0x00, "Very Short" );	PORT_DIPSETTING(    0x10, "Short" );	PORT_DIPSETTING(    0x18, "Normal" );	PORT_DIPSETTING(    0x08, "Long" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x20, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x40, "1 Credit 2 Play" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_chimerab = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "prg3.bin", 0x000000, 0x040000, 0x70f1448f );	ROM_LOAD_ODD(  "prg2.bin", 0x000000, 0x040000, 0x821dbb85 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "prg8.bin", 0x000000, 0x010000, 0xa682b1ca );	ROM_LOAD_ODD(  "prg7.bin", 0x000000, 0x010000, 0x83b9982d );
		...
		ROM_REGION( 0x100000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "b2.bin",   0x000000, 0x080000, 0x6e7f1778 );	ROM_LOAD( "b1.bin",   0x080000, 0x080000, 0x29c0385e );
	...
	//	fire	jump	unused?(shown in service mode, but not in instructions)
		...
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x18, "Normal" );	PORT_DIPSETTING(    0x08, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x60, 0x20, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x40, "1" );	PORT_DIPSETTING(    0x60, "2" );	PORT_DIPSETTING(    0x20, "3" );	PORT_DIPSETTING(    0x00, "4" );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 			/* DSW B */
		COINAGE_8BITS
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cybattlr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "cb_03.rom", 0x000000, 0x040000, 0xbee20587 );	ROM_LOAD_ODD(  "cb_02.rom", 0x000000, 0x040000, 0x2ed14c50 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "cb_08.rom", 0x000000, 0x010000, 0xbf7b3558 );	ROM_LOAD_ODD(  "cb_07.rom", 0x000000, 0x010000, 0x85d219d7 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		...
		ROM_REGION( 0x100000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "cb_m03.rom", 0x000000, 0x080000, 0x4cd49f58 );	ROM_LOAD( "cb_m02.rom", 0x080000, 0x080000, 0x882825db );
		ROM_REGION( 0x040000, REGION_SOUND1 );	/* Samples */
	...
	//	fire	sword
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_edf = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	/* Main CPU Code: 00000-3ffff & 80000-bffff */
		ROM_LOAD_EVEN( "edf_05.rom",  0x000000, 0x020000, 0x105094d1 );	ROM_CONTINUE (                0x080000 & ~1, 0x020000 | ROMFLAG_ALTERNATE );	ROM_LOAD_ODD(  "edf_06.rom",  0x000000, 0x020000, 0x94da2f0c );	ROM_CONTINUE (                0x080000 | 1, 0x020000 | ROMFLAG_ALTERNATE );
		ROM_REGION( 0x40000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "edf_01.rom",  0x000000, 0x020000, 0x2290ea19 );	ROM_LOAD_ODD(  "edf_02.rom",  0x000000, 0x020000, 0xce93643e );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		...
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "prom.14m",    0x0000, 0x0200, 0x1d877538 );ROM_END(); }}; 
	...
	//	fire	unfold_weapons
		...
		PORT_DIPNAME( 0x07, 0x07, "DSW-B bits 2-0" );	PORT_DIPSETTING(    0x00, "0" );	PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x05, "5" );	PORT_DIPSETTING(    0x06, "6" );	PORT_DIPSETTING(    0x07, "7" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "4" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x00, "0" );	PORT_DIPSETTING(    0x30, "1" );	PORT_DIPSETTING(    0x10, "2" );	PORT_DIPSETTING(    0x20, "3" );	PORT_DIPNAME( 0x40, 0x40, "DSW-B bit 6" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hachoo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "hacho02.rom", 0x000000, 0x020000, 0x49489c27 );	ROM_LOAD_ODD(  "hacho01.rom", 0x000000, 0x020000, 0x97fc9515 );
		HACHOO_ROM_LOAD
	...
	//	fire	jump
		...
		PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "2" );	PORT_DIPSETTING(    0x10, "1" );	PORT_DIPSETTING(    0x00, "0" );	PORT_DIPNAME( 0x40, 0x40, "Unknown 2-6" );// unused?
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
	...
	#if 0
	static RomLoadPtr rom_hachoo1 = new RomLoadPtr(){ public void handler(){ 
	
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
			ROM_LOAD_EVEN( "hacho02.rom", 0x000000, 0x020000, 0x49489c27 );		ROM_LOAD_ODD(  "hacho01.rom", 0x000000, 0x020000, 0x97fc9515 );		ROM_LOAD_EVEN( "rom-2", 0x000000, 0x010000, 0x3f56efb8 );		ROM_LOAD_ODD(  "rom-1", 0x000000, 0x010000, 0xc44bd605 );
		HACHOO_ROM_LOAD
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_iganinju = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "iga_02.bin", 0x000000, 0x020000, 0xbd00c280 );	ROM_LOAD_ODD(  "iga_01.bin", 0x000000, 0x020000, 0xfa416a9e );	ROM_LOAD_EVEN( "iga_03.bin", 0x040000, 0x010000, 0xde5937ad );	ROM_LOAD_ODD(  "iga_04.bin", 0x040000, 0x010000, 0xafaf0480 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "iga_05.bin", 0x000000, 0x010000, 0x13580868 );	ROM_LOAD_ODD(  "iga_06.bin", 0x000000, 0x010000, 0x7904d5dd );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
	...
	//	fire	jump
		...
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BITX(    0x80, 0x80, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Freeze Screen", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 			/* IN5 - 0x80007.b */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x01, "3" );	PORT_DIPSETTING(    0x02, "4" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Inifinite", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x04, "50k" );	PORT_DIPSETTING(    0x00, "200k" );	PORT_DIPNAME( 0x08, 0x08, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x08, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, "?Difficulty?" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "2" );	PORT_DIPSETTING(    0x10, "1" );	PORT_DIPSETTING(    0x00, "0" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Cabinet") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_kickoff = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "kioff03.rom", 0x000000, 0x010000, 0x3b01be65 );	ROM_LOAD_ODD(  "kioff01.rom", 0x000000, 0x010000, 0xae6e68a1 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "kioff09.rom", 0x000000, 0x010000, 0x1770e980 );	ROM_LOAD_ODD(  "kioff19.rom", 0x000000, 0x010000, 0x1b03bbe4 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "kioff05.rom", 0x000000, 0x020000, 0xe7232103 );	ROM_LOAD( "kioff06.rom", 0x020000, 0x020000, 0xa0b3cb75 );	ROM_LOAD( "kioff07.rom", 0x040000, 0x020000, 0xed649919 );	ROM_LOAD( "kioff10.rom", 0x060000, 0x020000, 0xfd739fec );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
		// scroll 1 is unused
		...
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "kioff27.rom", 0x000000, 0x020000, 0xca221ae2 );	ROM_LOAD( "kioff18.rom", 0x020000, 0x020000, 0xd7909ada );	ROM_LOAD( "kioff17.rom", 0x040000, 0x020000, 0xf171559e );	ROM_LOAD( "kioff26.rom", 0x060000, 0x020000, 0x2a90df1b );
		ROM_REGION( 0x040000, REGION_SOUND1 );	/* Samples */
		ROM_LOAD( "kioff20.rom", 0x000000, 0x020000, 0x5c28bd2d );	ROM_LOAD( "kioff21.rom", 0x020000, 0x020000, 0x195940cf );
		ROM_REGION( 0x040000, REGION_SOUND2 );	/* Samples */
	...
	//	shoot	pass
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BITX(    0x20, 0x20, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Freeze Screen", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "Text" );	PORT_DIPSETTING(    0x80, "Japanese" );	PORT_DIPSETTING(    0x00, "English" );// show "Japan Only" warning
	
		PORT_START(); 			/* IN5 0x80007.b */
		PORT_DIPNAME( 0x03, 0x03, "Time" );// . !f0082.w
		PORT_DIPSETTING(    0x03, "3'" );	PORT_DIPSETTING(    0x02, "4'" );	PORT_DIPSETTING(    0x01, "5'" );	PORT_DIPSETTING(    0x00, "6'" );	PORT_DIPNAME( 0x04, 0x04, "Unknown 2-2" );// unused?
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Unknown 2-3" );// unused?
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		...
		PORT_DIPSETTING(    0x30, "0" );	PORT_DIPSETTING(    0x20, "1" );	PORT_DIPSETTING(    0x10, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPNAME( 0x40, 0x00, "Controls" );	PORT_DIPSETTING(    0x40, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, "Joystick" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_lomakai = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "lom_30.rom", 0x000000, 0x020000, 0xba6d65b8 );	ROM_LOAD_ODD(  "lom_20.rom", 0x000000, 0x020000, 0x56a00dc2 );
		...
		ROM_LOAD( "makaiden.9",  0x0000, 0x0100, 0x3567065d );	ROM_LOAD( "makaiden.10", 0x0100, 0x0100, 0xe6709c51 );ROM_END(); }}; 
	
	static RomLoadPtr rom_makaiden = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "makaiden.3a", 0x000000, 0x020000, 0x87cf81d1 );	ROM_LOAD_ODD(  "makaiden.2a", 0x000000, 0x020000, 0xd40e0fea );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* Sound CPU Code (Z80) */
		ROM_LOAD( "lom_01.rom",  0x0000, 0x10000, 0x46e85e90 );
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "lom_05.rom", 0x000000, 0x020000, 0xd04fc713 );
	...
	//	fire	jump
		...
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, "?Difficulty?" );	PORT_DIPSETTING(    0x00, "Easy" );	PORT_DIPSETTING(    0x30, "Normal" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x10, "Hardest" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_p47 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "p47us3.bin", 0x000000, 0x020000, 0x022e58b8 );	ROM_LOAD_ODD(  "p47us1.bin", 0x000000, 0x020000, 0xed926bd8 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "p47j_9.bin",  0x000000, 0x010000, 0xffcf318e );	ROM_LOAD_ODD(  "p47j_19.bin", 0x000000, 0x010000, 0xadb8c12e );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "p47j_5.bin",  0x000000, 0x020000, 0xfe65b65c );	ROM_LOAD( "p47j_6.bin",  0x020000, 0x020000, 0xe191d2d2 );	ROM_LOAD( "p47j_7.bin",  0x040000, 0x020000, 0xf77723b7 );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "p47j_23.bin", 0x000000, 0x020000, 0x6e9bc864 );	ROM_RELOAD(              0x020000, 0x020000 );/* why? */
		ROM_LOAD( "p47j_12.bin", 0x040000, 0x020000, 0x5268395f );
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* Scroll 2 */
		ROM_LOAD( "p47us16.bin", 0x000000, 0x010000, 0x5a682c8f );
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "p47j_27.bin", 0x000000, 0x020000, 0x9e2bde8e );	ROM_LOAD( "p47j_18.bin", 0x020000, 0x020000, 0x29d8f676 );	ROM_LOAD( "p47j_26.bin", 0x040000, 0x020000, 0x4d07581a );	ROM_RELOAD(              0x060000, 0x020000 );/* why? */
	
		ROM_REGION( 0x040000, REGION_SOUND1 );	/* Samples */
		ROM_LOAD( "p47j_20.bin", 0x000000, 0x020000, 0x2ed53624 );	ROM_LOAD( "p47j_21.bin", 0x020000, 0x020000, 0x6f56b56d );
		ROM_REGION( 0x040000, REGION_SOUND2 );	/* Samples */
		ROM_LOAD( "p47j_10.bin", 0x000000, 0x020000, 0xb9d79c1e );	ROM_LOAD( "p47j_11.bin", 0x020000, 0x020000, 0xfa0d1887 );
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "prom.14m",    0x0000, 0x0200, 0x1d877538 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_p47j = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "p47j_3.bin", 0x000000, 0x020000, 0x11c655e5 );	ROM_LOAD_ODD(  "p47j_1.bin", 0x000000, 0x020000, 0x0a5998de );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "p47j_9.bin",  0x000000, 0x010000, 0xffcf318e );	ROM_LOAD_ODD(  "p47j_19.bin", 0x000000, 0x010000, 0xadb8c12e );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "p47j_5.bin",  0x000000, 0x020000, 0xfe65b65c );	ROM_LOAD( "p47j_6.bin",  0x020000, 0x020000, 0xe191d2d2 );	ROM_LOAD( "p47j_7.bin",  0x040000, 0x020000, 0xf77723b7 );
	...
	//	fire	bomb
		...
		PORT_DIPSETTING(    0x00, "Easy" );	PORT_DIPSETTING(    0x30, "Normal" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x10, "Hardest" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_peekaboo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "j3", 0x000000, 0x020000, 0xf5f4cf33 );	ROM_LOAD_ODD(  "j2", 0x000000, 0x020000, 0x7b3d430d );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		...
		ROM_LOAD( "peeksamp.124", 0x000000, 0x020000, 0xe1206fa8 );	ROM_CONTINUE(             0x040000, 0x0e0000             );
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
	...
	static InputPortPtr input_ports_peekaboo = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_BUTTON3 );	// called "stage clear"
		PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_BUTTON4 );	// called "option"
		PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	#define PEEKABOO_PADDLE(_FLAG_)	\
		...
		PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x00, "0" );	PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x08, 0x08, "Movement?" );				// 1f0392<-!
		PORT_DIPSETTING(    0x08, "Paddles" );	PORT_DIPSETTING(    0x00, "Buttons" );	PORT_DIPNAME( 0x30, 0x30, "Nudity" );				// 1f0356<-!
		PORT_DIPSETTING(    0x30, "Female and Male (Full); )
		PORT_DIPSETTING(    0x20, "Female (Full); )
		PORT_DIPSETTING(    0x10, "Female (Partial); )
		PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Cabinet") );			// 1f006a<-!
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_plusalph = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "pa-rom2.bin", 0x000000, 0x020000, 0x33244799 );	ROM_LOAD_ODD(  "pa-rom1.bin", 0x000000, 0x020000, 0xa32fdcae );	ROM_LOAD_EVEN( "pa-rom3.bin", 0x040000, 0x010000, 0x1b739835 );	ROM_LOAD_ODD(  "pa-rom4.bin", 0x040000, 0x010000, 0xff760e80 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "pa-rom5.bin", 0x000000, 0x010000, 0xddc2739b );	ROM_LOAD_ODD(  "pa-rom6.bin", 0x000000, 0x010000, 0xf6f8a167 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "pa-rom11.bin", 0x000000, 0x020000, 0xeb709ae7 );	ROM_LOAD( "pa-rom12.bin", 0x020000, 0x020000, 0xcacbc350 );	ROM_LOAD( "pa-rom13.bin", 0x040000, 0x020000, 0xfad093dd );	ROM_LOAD( "pa-rom14.bin", 0x060000, 0x020000, 0xd3676cd1 );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "pa-rom15.bin", 0x000000, 0x020000, 0x8787735b );	ROM_LOAD( "pa-rom16.bin", 0x020000, 0x020000, 0xa06b813b );	ROM_LOAD( "pa-rom17.bin", 0x040000, 0x020000, 0xc6b38a4b );	/* empty place */
	
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* Scroll 2 */
		ROM_LOAD( "pa-rom19.bin", 0x000000, 0x010000, 0x39ef193c );
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "pa-rom20.bin", 0x000000, 0x020000, 0x86c557a8 );	ROM_LOAD( "pa-rom21.bin", 0x020000, 0x020000, 0x81140a88 );	ROM_LOAD( "pa-rom22.bin", 0x040000, 0x020000, 0x97e39886 );	ROM_LOAD( "pa-rom23.bin", 0x060000, 0x020000, 0x0383fb65 );
		ROM_REGION( 0x040000, REGION_SOUND1 );	/* Samples */
		ROM_LOAD( "pa-rom9.bin",  0x000000, 0x020000, 0x065364bd );	ROM_LOAD( "pa-rom10.bin", 0x020000, 0x020000, 0x395df3b2 );
		ROM_REGION( 0x040000, REGION_SOUND2 );	/* Samples */
		ROM_LOAD( "pa-rom7.bin",  0x000000, 0x020000, 0x9f5d800e );	ROM_LOAD( "pa-rom8.bin",  0x020000, 0x020000, 0xae007750 );
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "prom.14m",     0x0000, 0x0200, 0x1d877538 );ROM_END(); }}; 
	...
	//	fire	bomb
		...
		PORT_START(); 			/* IN5 0x80007.b */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x02, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Inifinite", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x04, 0x04, "Bombs" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x08, "70k and every 130k");	PORT_DIPSETTING(    0x00, "100k and every 200k");	PORT_DIPNAME( 0x30, 0x30, "?Difficulty?" );	PORT_DIPSETTING(    0x30, "3" );// 1
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rodland = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "rl_02.rom", 0x000000, 0x020000, 0xc7e00593 );	ROM_LOAD_ODD(  "rl_01.rom", 0x000000, 0x020000, 0x2e748ca1 );	ROM_LOAD_EVEN( "rl_03.rom", 0x040000, 0x010000, 0x62fdf6d7 );	ROM_LOAD_ODD(  "rl_04.rom", 0x040000, 0x010000, 0x44163c86 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "rl_05.rom", 0x000000, 0x010000, 0xc1617c28 );	ROM_LOAD_ODD(  "rl_06.rom", 0x000000, 0x010000, 0x663392b2 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "rl_23.rom", 0x000000, 0x020000, 0xac60e771 );	ROM_CONTINUE(          0x030000, 0x010000             );	ROM_CONTINUE(          0x050000, 0x010000             );	ROM_CONTINUE(          0x020000, 0x010000             );	ROM_CONTINUE(          0x040000, 0x010000             );	ROM_CONTINUE(          0x060000, 0x020000             );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
		...
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "rl.bin",    0x0000, 0x0200, 0x8914e72d );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_rodlandj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "rl19.bin", 0x000000, 0x010000, 0x028de21f );	ROM_LOAD_ODD(  "rl17.bin", 0x000000, 0x010000, 0x9c720046 );	ROM_LOAD_EVEN( "rl20.bin", 0x020000, 0x010000, 0x3f536d07 );	ROM_LOAD_ODD(  "rl18.bin", 0x020000, 0x010000, 0x5aa61717 );	ROM_LOAD_EVEN( "rl12.bin", 0x040000, 0x010000, 0xc5b1075f );// ~ rl_03.rom
		ROM_LOAD_ODD(  "rl11.bin", 0x040000, 0x010000, 0x9ec61048 );// ~ rl_04.rom
	
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "rl02.bin", 0x000000, 0x010000, 0xd26eae8f );	ROM_LOAD_ODD(  "rl01.bin", 0x000000, 0x010000, 0x04cf24bc );
		// bg RL_23 = 27, 28, 29b, 29a, 31a?, 30?, ?, 31b?
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "rl27.bin",  0x000000, 0x010000, 0x673a5986 );	ROM_LOAD( "rl28.bin",  0x010000, 0x010000, 0x523a731d );	ROM_LOAD( "rl26.bin",  0x020000, 0x010000, 0x4d0a5c97 );	ROM_LOAD( "rl29a.bin", 0x030000, 0x010000, 0x9fd628f1 );	ROM_LOAD( "rl29b.bin", 0x040000, 0x010000, 0x2279cb76 );	ROM_LOAD( "rl30.bin",  0x050000, 0x010000, 0xb155f39e );	ROM_LOAD( "rl31a.bin", 0x060000, 0x010000, 0xa9bc5b84 );	ROM_LOAD( "rl31b.bin", 0x070000, 0x010000, 0xfb2faa69 );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "rl21.bin",  0x000000, 0x010000, 0x32fc0bc6 );// bg = RL_18
		ROM_LOAD( "rl22.bin",  0x010000, 0x010000, 0x0969daa9 );	ROM_LOAD( "rl13.bin",  0x020000, 0x010000, 0x1203cdf6 );	ROM_LOAD( "rl14.bin",  0x030000, 0x010000, 0xd53e094b );	ROM_LOAD( "rl24.bin",  0x040000, 0x010000, 0xb04343e6 );	ROM_LOAD( "rl23.bin",  0x050000, 0x010000, 0x70aa7e2c );	ROM_LOAD( "rl15.bin",  0x060000, 0x010000, 0x38ac846e );	ROM_LOAD( "rl16.bin",  0x070000, 0x010000, 0x5e31f0b2 );
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* Scroll 2 */
		...
		ROM_LOAD( "rl05.bin",  0x010000, 0x010000, 0x38c05d15 );	ROM_LOAD( "rl07.bin",  0x020000, 0x010000, 0xe117cb72 );	ROM_LOAD( "rl08.bin",  0x030000, 0x010000, 0x2f9b40c3 );	ROM_LOAD( "rl03.bin",  0x040000, 0x010000, 0xf6a88efd );	ROM_LOAD( "rl06.bin",  0x050000, 0x010000, 0x90a78af1 );	ROM_LOAD( "rl09.bin",  0x060000, 0x010000, 0x427a0908 );	ROM_LOAD( "rl10.bin",  0x070000, 0x010000, 0x53cc2c11 );
		ROM_REGION( 0x040000, REGION_SOUND1 );	/* Samples */
		ROM_LOAD( "rl_10.rom", 0x000000, 0x040000, 0xe1d1cd99 );
		ROM_REGION( 0x040000, REGION_SOUND2 );	/* Samples */
		ROM_LOAD( "rl_08.rom", 0x000000, 0x040000, 0x8a49d3a7 );
	...
	//	fire	ladder
		...
		PORT_DIPSETTING(    0x04, "2" );	PORT_DIPSETTING(    0x0c, "3" );	PORT_DIPSETTING(    0x08, "4" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Inifinite", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x10, 0x10, "Default episode" );	PORT_DIPSETTING(    0x10, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x20, "Easy?" );	PORT_DIPSETTING(    0x60, "Normal" );	PORT_DIPSETTING(    0x40, "Hard?" );	PORT_DIPSETTING(    0x00, "Hardest?" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_stdragon = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "jsd-02.bin", 0x000000, 0x020000, 0xcc29ab19 );	ROM_LOAD_ODD(  "jsd-01.bin", 0x000000, 0x020000, 0x67429a57 );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "jsd-05.bin", 0x000000, 0x010000, 0x8c04feaa );	ROM_LOAD_ODD(  "jsd-06.bin", 0x000000, 0x010000, 0x0bb62f3a );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "jsd-11.bin", 0x000000, 0x020000, 0x2783b7b1 );	ROM_LOAD( "jsd-12.bin", 0x020000, 0x020000, 0x89466ab7 );	ROM_LOAD( "jsd-13.bin", 0x040000, 0x020000, 0x9896ae82 );	ROM_LOAD( "jsd-14.bin", 0x060000, 0x020000, 0x7e8da371 );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "jsd-15.bin", 0x000000, 0x020000, 0xe296bf59 );	ROM_LOAD( "jsd-16.bin", 0x020000, 0x020000, 0xd8919c06 );	ROM_LOAD( "jsd-17.bin", 0x040000, 0x020000, 0x4f7ad563 );	ROM_LOAD( "jsd-18.bin", 0x060000, 0x020000, 0x1f4da822 );
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* Scroll 2 */
		ROM_LOAD( "jsd-19.bin", 0x000000, 0x010000, 0x25ce807d );
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "jsd-20.bin", 0x000000, 0x020000, 0x2c6e93bb );	ROM_LOAD( "jsd-21.bin", 0x020000, 0x020000, 0x864bcc61 );	ROM_LOAD( "jsd-22.bin", 0x040000, 0x020000, 0x44fe2547 );	ROM_LOAD( "jsd-23.bin", 0x060000, 0x020000, 0x6b010e1a );
		ROM_REGION( 0x040000, REGION_SOUND1 );	/* Samples */
		ROM_LOAD( "jsd-09.bin", 0x000000, 0x020000, 0xe366bc5a );	ROM_LOAD( "jsd-10.bin", 0x020000, 0x020000, 0x4a8f4fe6 );
		ROM_REGION( 0x040000, REGION_SOUND2 );	/* Samples */
		ROM_LOAD( "jsd-07.bin", 0x000000, 0x020000, 0x6a48e979 );	ROM_LOAD( "jsd-08.bin", 0x020000, 0x020000, 0x40704962 );
		ROM_REGION( 0x0200, REGION_PROMS );	/* Priority PROM */
		ROM_LOAD( "prom.14m",    0x0000, 0x0200, 0x1d877538 );ROM_END(); }}; 
	...
	//	fire	fire
		...
		PORT_START(); 			/* IN5 0x80007.b */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x04, 0x04, "Unknown 2-2" );// unused?
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Unknown 2-3" );// unused?
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_soldamj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "soldam2.bin", 0x000000, 0x020000, 0xc73d29e4 );	ROM_LOAD_ODD(  "soldam1.bin", 0x000000, 0x020000, 0xe7cb0c20 );	ROM_LOAD_EVEN( "soldam3.bin", 0x040000, 0x010000, 0xc5382a07 );	ROM_LOAD_ODD(  "soldam4.bin", 0x040000, 0x010000, 0x1df7816f );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "soldam5.bin", 0x000000, 0x010000, 0xd1019a67 );	ROM_LOAD_ODD(  "soldam6.bin", 0x000000, 0x010000, 0x3ed219b4 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
	...
	COINS						/* IN0 0x80001.b */
		...
		PORT_DIPSETTING(    0x00, "Easy"   );	PORT_DIPSETTING(    0x03, "Normal" );	PORT_DIPSETTING(    0x02, "Hard"   );	PORT_DIPSETTING(    0x01, "Hadest" );	PORT_DIPNAME( 0x0c, 0x0c, "Games To Play (Vs); )
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x0c, "2" );	PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPNAME( 0x10, 0x10, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x10, DEF_STR( "On") ); )
		PORT_DIPNAME( 0x20, 0x20, "Credits To Start (Vs); )
		PORT_DIPSETTING(    0x20, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x40, 0x40, "Credits To Continue (Vs); )
		PORT_DIPSETTING(    0x40, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") ); )
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_tshingen = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	/* Main CPU Code */
		ROM_LOAD_EVEN( "takeda2.bin", 0x000000, 0x020000, 0x6ddfc9f3 );	ROM_LOAD_ODD(  "takeda1.bin", 0x000000, 0x020000, 0x1afc6b7d );
		ROM_REGION( 0x20000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD_EVEN( "takeda5.bin", 0x000000, 0x010000, 0xfbdc51c0 );	ROM_LOAD_ODD(  "takeda6.bin", 0x000000, 0x010000, 0x8fa65b69 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Scroll 0 */
		ROM_LOAD( "takeda11.bin", 0x000000, 0x020000, 0xbf0b40a6 );	ROM_LOAD( "takeda12.bin", 0x020000, 0x020000, 0x07987d89 );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Scroll 1 */
		ROM_LOAD( "takeda15.bin", 0x000000, 0x020000, 0x4c316b79 );	ROM_LOAD( "takeda16.bin", 0x020000, 0x020000, 0xceda9dd6 );	ROM_LOAD( "takeda17.bin", 0x040000, 0x020000, 0x3d4371dc );
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* Scroll 2 */
		ROM_LOAD( "takeda19.bin", 0x000000, 0x010000, 0x2ca2420d );
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "takeda20.bin", 0x000000, 0x020000, 0x1bfd636f );	ROM_LOAD( "takeda21.bin", 0x020000, 0x020000, 0x12fb006b );	ROM_LOAD( "takeda22.bin", 0x040000, 0x020000, 0xb165b6ae );	ROM_LOAD( "takeda23.bin", 0x060000, 0x020000, 0x37cb9214 );
		ROM_REGION( 0x040000, REGION_SOUND1 );	/* Samples */
		ROM_LOAD( "takeda9.bin",  0x000000, 0x020000, 0xdb7f3f4f );	ROM_LOAD( "takeda10.bin", 0x020000, 0x020000, 0xc9959d71 );
		ROM_REGION( 0x040000, REGION_SOUND2 );	/* Samples */
	...
	COINS						/* IN0 0x80001.b */
		...
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x01, "3" );	PORT_DIPSETTING(    0x02, "4" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Inifinite", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x0c, "20k" );	PORT_DIPSETTING(    0x04, "30k" );	PORT_DIPSETTING(    0x08, "40k" );	PORT_DIPSETTING(    0x00, "50k" );	PORT_DIPNAME( 0x30, 0x10, DEF_STR( "Difficulty") ); // damage when hit
	...
	static public static InitDriverPtr init_tshingen = new InitDriverPtr() { public void handler() 
	{
		phantasm_rom_decode(0);
	} };
