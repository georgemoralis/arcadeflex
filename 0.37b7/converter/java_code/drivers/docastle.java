...
public class docastle
{
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY | IPF_COCKTAIL );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );/* reported as not used */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );/* reported as 2 Player Fire */
		...
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );/* reported as test */
	/* coin input must be active for 32 frames to be consistently recognized */
		PORT_BIT_IMPULSE( 0x04, IP_ACTIVE_LOW, IPT_COIN3, 32 );	PORT_DIPNAME( 0x08, 0x08, "Freeze" );	PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* reported as not used */
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );/* reported as not used */
	
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Medium" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_BITX(    0x04, 0x04, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Rack Test", KEYCODE_F1, IP_JOY_NONE );	PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );	/* flip screen? doesn't work */
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x10, 0x10, "Extra" );	PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0xc0, "3" );	PORT_DIPSETTING(    0x80, "4" );	PORT_DIPSETTING(    0x40, "5" );
		COINAGE_PORT
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY | IPF_COCKTAIL );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY | IPF_COCKTAIL );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START2 );
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Reported as Test */
	/* coin input must be active for 32 frames to be consistently recognized */
		PORT_BIT_IMPULSE( 0x04, IP_ACTIVE_LOW, IPT_COIN3, 32 );	PORT_DIPNAME( 0x08, 0x08, "Freeze" );	PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Medium" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x40, 0x40, "Special" );	PORT_DIPSETTING(    0x40, "Given" );	PORT_DIPSETTING(    0x00, "Not Given" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Lives") );
	...
	/* coin input must be active for 32 frames to be consistently recognized */
		...
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, "Difficulty?" );	PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Medium" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_BITX(    0x04, 0x04, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Rack Test", KEYCODE_F1, IP_JOY_NONE );	PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	/* coin input must be active for 32 frames to be consistently recognized */
		...
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x10, 0x10, "DSW4" );	PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x40, 0x40, "DSW2" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "DSW1" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_docastle = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "01p_a1.bin",   0x0000, 0x2000, 0x17c6fc24 );	ROM_LOAD( "01n_a2.bin",   0x2000, 0x2000, 0x1d2fc7f4 );	ROM_LOAD( "01l_a3.bin",   0x4000, 0x2000, 0x71a70ba9 );	ROM_LOAD( "01k_a4.bin",   0x6000, 0x2000, 0x479a745e );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "07n_a0.bin",   0x0000, 0x4000, 0xf23b5cdb );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "03a_a5.bin",   0x0000, 0x4000, 0x0636b8f4 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "04m_a6.bin",   0x0000, 0x2000, 0x3bbc9b26 );	ROM_LOAD( "04l_a7.bin",   0x2000, 0x2000, 0x3dfaa9d1 );	ROM_LOAD( "04j_a8.bin",   0x4000, 0x2000, 0x9afb16e9 );	ROM_LOAD( "04h_a9.bin",   0x6000, 0x2000, 0xaf24bce0 );
		ROM_REGION( 0x0400, REGION_PROMS );	ROM_LOAD( "09c.bin",      0x0000, 0x0200, 0x066f52bc );/* color prom */
		ROM_LOAD( "01d.bin",      0x0200, 0x0200, 0x2747ca77 );/* ??? */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_docastl2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "a1",           0x0000, 0x2000, 0x0d81fafc );	ROM_LOAD( "a2",           0x2000, 0x2000, 0xa13dc4ac );	ROM_LOAD( "a3",           0x4000, 0x2000, 0xa1f04ffb );	ROM_LOAD( "a4",           0x6000, 0x2000, 0x1fb14aa6 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
	...
	static RomLoadPtr rom_douni = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "dorev1.bin",   0x0000, 0x2000, 0x1e2cbb3c );	ROM_LOAD( "dorev2.bin",   0x2000, 0x2000, 0x18418f83 );	ROM_LOAD( "dorev3.bin",   0x4000, 0x2000, 0x7b9e2061 );	ROM_LOAD( "dorev4.bin",   0x6000, 0x2000, 0xe013954d );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "dorev10.bin",  0x0000, 0x4000, 0x4b1925e3 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "03a_a5.bin",   0x0000, 0x4000, 0x0636b8f4 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dorev6.bin",   0x0000, 0x2000, 0x9e335bf8 );	ROM_LOAD( "dorev7.bin",   0x2000, 0x2000, 0xf5d5701d );	ROM_LOAD( "dorev8.bin",   0x4000, 0x2000, 0x7143ca68 );	ROM_LOAD( "dorev9.bin",   0x6000, 0x2000, 0x893fc004 );
		ROM_REGION( 0x0400, REGION_PROMS );	ROM_LOAD( "dorevc9.bin",  0x0000, 0x0200, 0x96624ebe );/* color prom */
		ROM_LOAD( "01d.bin",      0x0200, 0x0200, 0x2747ca77 );/* ??? */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_dorunruc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "rev-0-1.p1",   0x0000, 0x2000, 0x49906ebd );	ROM_LOAD( "rev-0-2.n1",   0x2000, 0x2000, 0xdbe3e7db );	ROM_LOAD( "rev-0-3.l1",   0x4000, 0x2000, 0xe9b8181a );	ROM_LOAD( "rev-0-4.k1",   0x6000, 0x2000, 0xa63d0b89 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "rev-0-2.n7",   0x0000, 0x4000, 0x6dac2fa3 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rev-0-5.a3",   0x0000, 0x4000, 0xe20795b7 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2764.m4",      0x0000, 0x2000, 0x4bb231a0 );	ROM_LOAD( "2764.l4",      0x2000, 0x2000, 0x0c08508a );	ROM_LOAD( "2764.j4",      0x4000, 0x2000, 0x79287039 );	ROM_LOAD( "2764.h4",      0x6000, 0x2000, 0x523aa999 );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "dorunrun.clr", 0x0000, 0x0100, 0xd5bab5d5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_dorunrun = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "2764.p1",      0x0000, 0x2000, 0x95c86f8e );	ROM_LOAD( "2764.l1",      0x4000, 0x2000, 0xe9a65ba7 );	ROM_LOAD( "2764.k1",      0x6000, 0x2000, 0xb1195d3d );	ROM_LOAD( "2764.n1",      0x8000, 0x2000, 0x6a8160d1 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "27128.p7",     0x0000, 0x4000, 0x8b06d461 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "27128.a3",     0x0000, 0x4000, 0x4be96dcf );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2764.m4",      0x0000, 0x2000, 0x4bb231a0 );	ROM_LOAD( "2764.l4",      0x2000, 0x2000, 0x0c08508a );	ROM_LOAD( "2764.j4",      0x4000, 0x2000, 0x79287039 );	ROM_LOAD( "2764.h4",      0x6000, 0x2000, 0x523aa999 );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "dorunrun.clr", 0x0000, 0x0100, 0xd5bab5d5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_dorunru2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "p1",           0x0000, 0x2000, 0x12a99365 );	ROM_LOAD( "l1",           0x4000, 0x2000, 0x38609287 );	ROM_LOAD( "k1",           0x6000, 0x2000, 0x099aaf54 );	ROM_LOAD( "n1",           0x8000, 0x2000, 0x4f8fcbae );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "27128.p7",     0x0000, 0x4000, 0x8b06d461 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "27128.a3",     0x0000, 0x4000, 0x4be96dcf );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2764.m4",      0x0000, 0x2000, 0x4bb231a0 );	ROM_LOAD( "2764.l4",      0x2000, 0x2000, 0x0c08508a );	ROM_LOAD( "2764.j4",      0x4000, 0x2000, 0x79287039 );	ROM_LOAD( "2764.h4",      0x6000, 0x2000, 0x523aa999 );
	...
	static RomLoadPtr rom_spiero = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "sp1.bin",      0x0000, 0x2000, 0x08d23e38 );	ROM_LOAD( "sp3.bin",      0x4000, 0x2000, 0xfaa0c18c );	ROM_LOAD( "sp4.bin",      0x6000, 0x2000, 0x639b4e5d );	ROM_LOAD( "sp2.bin",      0x8000, 0x2000, 0x3a29ccb0 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "27128.p7",     0x0000, 0x4000, 0x8b06d461 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sp5.bin",      0x0000, 0x4000, 0x1b704bb0 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sp6.bin",      0x0000, 0x2000, 0x00f893a7 );	ROM_LOAD( "sp7.bin",      0x2000, 0x2000, 0x173e5c6a );	ROM_LOAD( "sp8.bin",      0x4000, 0x2000, 0x2e66525a );	ROM_LOAD( "sp9.bin",      0x6000, 0x2000, 0x9c571525 );
		ROM_REGION( 0x0400, REGION_PROMS );	ROM_LOAD( "bprom1.bin",   0x0000, 0x0200, 0xfc1b66ff );/* color prom */
		ROM_LOAD( "bprom2.bin",   0x0200, 0x0200, 0x2747ca77 );/* ??? */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_dowild = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "w1",           0x0000, 0x2000, 0x097de78b );	ROM_LOAD( "w3",           0x4000, 0x2000, 0xfc6a1cbb );	ROM_LOAD( "w4",           0x6000, 0x2000, 0x8aac1d30 );	ROM_LOAD( "w2",           0x8000, 0x2000, 0x0914ab69 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "w10",          0x0000, 0x4000, 0xd1f37fba );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "w5",           0x0000, 0x4000, 0xb294b151 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "w6",           0x0000, 0x2000, 0x57e0208b );	ROM_LOAD( "w7",           0x2000, 0x2000, 0x5001a6f7 );	ROM_LOAD( "w8",           0x4000, 0x2000, 0xec503251 );	ROM_LOAD( "w9",           0x6000, 0x2000, 0xaf7bd7eb );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "dowild.clr",   0x0000, 0x0100, 0xa703dea5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_jjack = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "j1.bin",       0x0000, 0x2000, 0x87f29bd2 );	ROM_LOAD( "j3.bin",       0x4000, 0x2000, 0x35b0517e );	ROM_LOAD( "j4.bin",       0x6000, 0x2000, 0x35bb316a );	ROM_LOAD( "j2.bin",       0x8000, 0x2000, 0xdec52e80 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "j0.bin",       0x0000, 0x4000, 0xab042f04 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "j5.bin",       0x0000, 0x4000, 0x75038ff9 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "j6.bin",       0x0000, 0x2000, 0x5937bd7b );	ROM_LOAD( "j7.bin",       0x2000, 0x2000, 0xcf8ae8e7 );	ROM_LOAD( "j8.bin",       0x4000, 0x2000, 0x84f6fc8c );	ROM_LOAD( "j9.bin",       0x6000, 0x2000, 0x3f9bb09f );
		ROM_REGION( 0x0400, REGION_PROMS );	ROM_LOAD( "bprom1.bin",   0x0000, 0x0200, 0x2f0955f2 );/* color prom */
		ROM_LOAD( "bprom2.bin",   0x0200, 0x0200, 0x2747ca77 );/* ??? */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_kickridr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "k1",           0x0000, 0x2000, 0xdfdd1ab4 );	ROM_LOAD( "k3",           0x4000, 0x2000, 0x412244da );	ROM_LOAD( "k4",           0x6000, 0x2000, 0xa67dd2ec );	ROM_LOAD( "k2",           0x8000, 0x2000, 0xe193fb5c );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the second CPU */
		ROM_LOAD( "k10",          0x0000, 0x4000, 0x6843dbc0 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "k5",           0x0000, 0x4000, 0x3f7d7e49 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "k6",           0x0000, 0x2000, 0x94252ed3 );	ROM_LOAD( "k7",           0x2000, 0x2000, 0x7ef2420e );	ROM_LOAD( "k8",           0x4000, 0x2000, 0x29bed201 );	ROM_LOAD( "k9",           0x6000, 0x2000, 0x847584d3 );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "kickridr.clr", 0x0000, 0x0100, 0x73ec281c );ROM_END(); }}; 
