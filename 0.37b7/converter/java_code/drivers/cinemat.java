...
public class cinemat
{
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_DIPNAME( SW2|SW1, SW2ON |SW1ON,  "Time" );	PORT_DIPSETTING( 	   SW2OFF|SW1OFF, "0:45/coin" );	PORT_DIPSETTING( 	   SW2ON |SW1ON,  "1:00/coin" );	PORT_DIPSETTING( 	   SW2ON |SW1OFF, "1:30/coin" );	PORT_DIPSETTING( 	   SW2OFF|SW1ON,  "2:00/coin" );	PORT_DIPNAME( SW7,	   SW7OFF,		  DEF_STR( "Unknown") );
		PORT_DIPSETTING(	   SW7OFF,		  DEF_STR( "Off") );
		PORT_DIPSETTING(	   SW7ON,		  DEF_STR( "On") );
		PORT_BIT ( 0x08, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT ( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x02, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT ( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER2 );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER2 );	PORT_BITX( 0x0800, IP_ACTIVE_LOW, 0, "Option 0", KEYCODE_0_PAD, IP_JOY_NONE );	PORT_BITX( 0x0400, IP_ACTIVE_LOW, 0, "Option 5", KEYCODE_5_PAD, IP_JOY_NONE );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER1 );	PORT_BITX( 0x0080, IP_ACTIVE_LOW, 0, "Option 7", KEYCODE_7_PAD, IP_JOY_NONE );	PORT_BITX( 0x0040, IP_ACTIVE_LOW, 0, "Option 2", KEYCODE_2_PAD, IP_JOY_NONE );	PORT_BITX( 0x0020, IP_ACTIVE_LOW, 0, "Option 6", KEYCODE_6_PAD, IP_JOY_NONE );	PORT_BITX( 0x0010, IP_ACTIVE_LOW, 0, "Option 1", KEYCODE_1_PAD, IP_JOY_NONE );	PORT_BITX( 0x0008, IP_ACTIVE_LOW, 0, "Option 9", KEYCODE_9_PAD, IP_JOY_NONE );	PORT_BITX( 0x0004, IP_ACTIVE_LOW, 0, "Option 4", KEYCODE_4_PAD, IP_JOY_NONE );	PORT_BITX( 0x0002, IP_ACTIVE_LOW, 0, "Option 8", KEYCODE_8_PAD, IP_JOY_NONE );	PORT_BITX( 0x0001, IP_ACTIVE_LOW, 0, "Option 3", KEYCODE_3_PAD, IP_JOY_NONE );
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_DIPNAME( SW1, SW1ON,  DEF_STR( "Lives") );
		PORT_DIPSETTING(   SW1ON,  "3" );	PORT_DIPSETTING(   SW1OFF, "5" );	PORT_DIPNAME( SW2, SW2OFF, DEF_STR( "Demo_Sounds") );
		...
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BITX( 0x0040, IP_ACTIVE_LOW, 0, "Skill C", KEYCODE_C, IP_JOY_NONE );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_4WAY | IPF_PLAYER1 );	PORT_BITX( 0x0004, IP_ACTIVE_LOW, 0, "Skill B", KEYCODE_B, IP_JOY_NONE );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BITX( 0x0001, IP_ACTIVE_LOW, 0, "Skill A", KEYCODE_A, IP_JOY_NONE );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 2 );	PORT_DIPNAME( SW7,	   SW7OFF,		  DEF_STR( "Unknown") );
		PORT_DIPSETTING(	   SW7OFF,		  DEF_STR( "Off") );
		PORT_DIPSETTING(	   SW7ON,		  DEF_STR( "On") );
		PORT_BIT ( SW6, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT ( SW5, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( SW4, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( SW3, IP_ACTIVE_LOW, IPT_START1 );	PORT_DIPNAME( SW2|SW1, SW2OFF|SW1OFF, "Game Time" );	PORT_DIPSETTING(	   SW2OFF|SW1OFF, "2:00/4:00" );	PORT_DIPSETTING(	   SW2ON |SW1OFF, "1:30/3:00" );	PORT_DIPSETTING(	   SW2OFF|SW1ON,  "1:00/2:00" );	PORT_DIPSETTING(	   SW2ON |SW1ON,  "0:45/1:30" );
		PORT_START();  /* input */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER1 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7,     SW7ON );	PORT_DIPNAME( SW4|SW3, SW4OFF|SW3OFF, DEF_STR( "Coinage") );
		...
		PORT_DIPSETTING(       SW2OFF|SW1OFF, "3" );	PORT_DIPSETTING(       SW2ON |SW1OFF, "4" );	PORT_DIPSETTING(       SW2OFF|SW1ON,  "5" );	PORT_DIPSETTING(       SW2ON |SW1ON,  "6" );	PORT_DIPNAME( SW5,     SW5OFF,        DEF_STR( "Unknown") );
		PORT_DIPSETTING(       SW5OFF,        DEF_STR( "Off") );
		PORT_DIPSETTING(       SW5ON,         DEF_STR( "On") );
		PORT_DIPNAME( SW6,     SW6OFF,        DEF_STR( "Unknown") );
		PORT_DIPSETTING(       SW6OFF,        DEF_STR( "Off") );
		...
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_DIPNAME( SW6|SW2|SW1, SW6OFF|SW2OFF|SW1OFF, "Shield Points" );	PORT_DIPSETTING(		   SW6ON |SW2ON |SW1ON,  "15" );	PORT_DIPSETTING(		   SW6ON |SW2OFF|SW1ON,  "20" );	PORT_DIPSETTING(		   SW6ON |SW2ON |SW1OFF, "30" );	PORT_DIPSETTING(		   SW6ON |SW2OFF|SW1OFF, "40" );	PORT_DIPSETTING(		   SW6OFF|SW2ON |SW1ON,  "50" );	PORT_DIPSETTING(		   SW6OFF|SW2OFF|SW1ON,  "60" );	PORT_DIPSETTING(		   SW6OFF|SW2ON |SW1OFF, "70" );	PORT_DIPSETTING(		   SW6OFF|SW2OFF|SW1OFF, "80" );	PORT_DIPNAME( SW3,		   SW3OFF,				 DEF_STR( "Coinage") );
		...
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick X */
		PORT_ANALOG( 0xfff, 0x800, IPT_AD_STICK_X, 100, 50, 0x200, 0xe00 );
		PORT_START();  /* analog stick Y */
		PORT_ANALOG( 0xfff, 0x800, IPT_AD_STICK_Y, 100, 50, 0x200, 0xe00 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7,	   SW7OFF );	PORT_DIPNAME( SW6,	   SW6ON,		  "Scores" );	PORT_DIPSETTING(	   SW6ON,		  "Individual" );	PORT_DIPSETTING(	   SW6OFF,		  "Combined" );	PORT_DIPNAME( SW5,	   SW5ON,		  DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(	   SW4OFF|SW3ON,  DEF_STR( "2C_3C") );
		PORT_DIPNAME( SW2|SW1, SW2OFF|SW1OFF, DEF_STR( "Lives") );
		PORT_DIPSETTING(	   SW2ON |SW1OFF, "4" );	PORT_DIPSETTING(	   SW2OFF|SW1OFF, "8" );	PORT_DIPSETTING(	   SW2ON |SW1ON,  "12" );	PORT_DIPSETTING(	   SW2OFF|SW1ON,  "16" );
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER2 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr speedfrk_input_port_1_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (input_port_1_r.handler(0) & 0x80)
	        val |= 0x80;
		else
	        val &= ~0x80;
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_DIPNAME( SW7,     SW7OFF,        DEF_STR( "Unknown") );
		PORT_DIPSETTING(       SW7OFF,        DEF_STR( "Off") );
		PORT_DIPSETTING(       SW7ON,         DEF_STR( "On") );
		PORT_DIPNAME( SW6,     SW6OFF,        DEF_STR( "Unknown") );
		PORT_DIPSETTING(       SW6OFF,        DEF_STR( "Off") );
		...
		PORT_DIPSETTING(       SW3OFF,        DEF_STR( "Off") );
		PORT_DIPSETTING(       SW3ON,         DEF_STR( "On") );
		PORT_DIPNAME( SW2|SW1, SW2OFF|SW1ON,  "Extra Time" );	PORT_DIPSETTING(       SW2ON |SW1ON,  "69" );	PORT_DIPSETTING(       SW2ON |SW1OFF, "99" );	PORT_DIPSETTING(       SW2OFF|SW1ON,  "129" );	PORT_DIPSETTING(       SW2OFF|SW1OFF, "159" );
		PORT_START();  /* inputs */
		PORT_BIT (  0x8000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT (  0x4000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT (  0x2000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT (  0x1000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT (  0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT (  0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT (  0x0200, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT (  0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );/* gas */
		PORT_BIT (  0x0080, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT (  0x0070, IP_ACTIVE_LOW, IPT_UNUSED );/* gear shift, fake below */
		...
		PORT_BIT ( 0x0f, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BITX( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2, "1st gear", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2, "2nd gear", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2, "3rd gear", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2, "4th gear", IP_KEY_DEFAULT, IP_JOY_DEFAULT );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_DIPNAME( SW5,	   SW5OFF,		 DEF_STR( "Unknown") );
		PORT_DIPSETTING(	   SW5OFF,		 DEF_STR( "Off") );
		PORT_DIPSETTING(	   SW5ON, 		 DEF_STR( "On") );
		PORT_DIPNAME( SW6,	   SW6OFF,		 DEF_STR( "Unknown") );
		PORT_DIPSETTING(	   SW6OFF,		 DEF_STR( "Off") );
		...
		PORT_DIPSETTING(	   SW4ON,		 "1 coin/2 players" );	PORT_DIPSETTING(	   SW4OFF,		 "2 coins/2 players" );	PORT_DIPNAME( SW3,	   SW3ON,		 "Language" );	PORT_DIPSETTING(	   SW3OFF,		 "Japanese" );	PORT_DIPSETTING(	   SW3ON,		 "English" );	PORT_DIPNAME( SW2|SW1, SW2OFF|SW1ON, "Time" );	PORT_DIPSETTING(	   SW2ON |SW1ON,  "0:45/coin" );	PORT_DIPSETTING(	   SW2OFF|SW1ON,  "1:00/coin" );	PORT_DIPSETTING(	   SW2ON |SW1OFF, "1:30/coin" );	PORT_DIPSETTING(	   SW2OFF|SW1OFF, "2:00/coin" );
		PORT_START();  /* inputs */
		...
		PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_UNUSED );/* 4 suns */
		PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );/* Grid */
		PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );/* 3 suns */
		PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );/* player 2 motion */
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		...
		PORT_DIPSETTING(   SW4OFF, DEF_STR( "Off") );
		PORT_DIPSETTING(   SW4ON,  DEF_STR( "On") );
		PORT_SERVICE( SW3, SW3ON );	PORT_DIPNAME( SW2, SW2OFF, DEF_STR( "Unknown") );
		...
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7,     SW7ON );	PORT_DIPNAME( SW5,     SW5OFF,        DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(       SW5OFF,        DEF_STR( "Off") );
		PORT_DIPSETTING(       SW5ON,         DEF_STR( "On") );
		...
		PORT_DIPSETTING(       SW4OFF|SW3ON,  DEF_STR( "2C_3C") );
		PORT_DIPNAME( SW2|SW1, SW2OFF|SW1OFF, DEF_STR( "Lives") );
		PORT_DIPSETTING(       SW2ON |SW1ON,  "2" );	PORT_DIPSETTING(       SW2OFF|SW1ON,  "3" );	PORT_DIPSETTING(       SW2ON |SW1OFF, "4" );	PORT_DIPSETTING(       SW2OFF|SW1OFF, "5" );
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER2 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW,  IPT_UNUSED );
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7,	   SW7ON );	PORT_DIPNAME( SW2,	   SW2OFF,		  DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(	   SW2OFF,		  "25 captures" );	PORT_DIPSETTING(	   SW2ON, 		  "40 captures" );	PORT_DIPNAME( SW6,	   SW6OFF,		  DEF_STR( "Free_Play") );
		PORT_DIPSETTING(	   SW6OFF,		  DEF_STR( "Off") );
		PORT_DIPSETTING(	   SW6ON,		  DEF_STR( "On") );
		...
		PORT_DIPSETTING(	   SW5OFF|SW4OFF, "2" );	PORT_DIPSETTING(	   SW5ON |SW4OFF, "3" );	PORT_DIPSETTING(	   SW5OFF|SW4ON,  "4" );	PORT_DIPSETTING(	   SW5ON |SW4ON,  "5" );
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_START1 );/* also hyperspace */
		PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_START2 );/* also nova */
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_DIPNAME( SW7,     SW7OFF,        DEF_STR( "Free_Play") );
		PORT_DIPSETTING(       SW7OFF,        DEF_STR( "Off") );
		PORT_DIPSETTING(       SW7ON,         DEF_STR( "On") );
		PORT_DIPNAME( SW6,     SW6OFF,        DEF_STR( "Unknown") );
		PORT_DIPSETTING(       SW6OFF,        DEF_STR( "Off") );
		...
		PORT_DIPSETTING(       SW3ON |SW4ON,  "3");	PORT_DIPSETTING(       SW3OFF|SW4ON,  "4" );	PORT_DIPSETTING(       SW3ON |SW4OFF, "5" );	PORT_DIPSETTING(       SW3OFF|SW4OFF, "6" );	PORT_DIPNAME( SW2|SW1, SW2OFF|SW1OFF, DEF_STR( "Coinage") );
		...
		PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER2 );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_TILT );	PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER1 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7, SW7OFF );	PORT_DIPNAME( SW6, SW6OFF, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(   SW6OFF, DEF_STR( "Off") );
		PORT_DIPSETTING(   SW6ON,  DEF_STR( "On") );
		...
		PORT_DIPSETTING(   SW2OFF, "3" );	PORT_DIPSETTING(   SW2ON,  "5" );	PORT_DIPNAME( SW1, SW1OFF, DEF_STR( "Unknown") );
		PORT_DIPSETTING(   SW1OFF, DEF_STR( "Off") );
		PORT_DIPSETTING(   SW1ON,  DEF_STR( "On") );
		PORT_DIPNAME( SW3, SW3OFF, DEF_STR( "Unknown") );
		PORT_DIPSETTING(   SW3OFF, DEF_STR( "Off") );
		...
		PORT_START();  /* inputs */
		PORT_BIT ( 0x8000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x4000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x2000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT ( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	PORT_START();  /* switches */
		PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_SERVICE( SW7,	   SW7ON );	PORT_DIPNAME( SW6,	   SW6OFF,		  DEF_STR( "Free_Play") );
		PORT_DIPSETTING(	   SW6OFF,		  DEF_STR( "Off") );
		PORT_DIPSETTING(	   SW6ON,		  DEF_STR( "On") );
		...
		PORT_DIPSETTING(	   SW4ON,		  "30,000" );	PORT_DIPSETTING(	   SW4OFF,		  "50,000" );	PORT_DIPNAME( SW3,	   SW3ON,		  DEF_STR( "Lives") );
		PORT_DIPSETTING(	   SW3OFF,		  "3" );	PORT_DIPSETTING(	   SW3ON,		  "5" );	PORT_DIPNAME( SW2|SW1, SW2OFF|SW1OFF, DEF_STR( "Coinage") );
		PORT_DIPSETTING(	   SW2ON |SW1OFF, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(	   SW2ON |SW1ON,  DEF_STR( "4C_3C") );
		PORT_DIPSETTING(	   SW2OFF|SW1OFF, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(	   SW2OFF|SW1ON,  DEF_STR( "2C_3C") );
		...
		PORT_BIT ( 0x0800, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT ( 0x0400, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT ( 0x0200, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT ( 0x0100, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT ( 0x0080, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT ( 0x0040, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BIT ( 0x0020, IP_ACTIVE_LOW,  IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT ( 0x0010, IP_ACTIVE_LOW,  IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW,  IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT ( 0x0008, IP_ACTIVE_LOW,  IPT_START2 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW,  IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT ( 0x0004, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT ( 0x0002, IP_ACTIVE_LOW,  IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT ( 0x0001, IP_ACTIVE_LOW,  IPT_BUTTON1 | IPF_PLAYER2 );
		PORT_START();  /* analog stick X - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* analog stick Y - unused */
		PORT_BIT ( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* fake (in4) */
		PORT_ANALOG( 0xff, 0x80, IPT_DIAL, 100, 5, 0x00, 0xff );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_demon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD         ( "demon.snd", 0x0000, 0x1000, 0x1e2cc262 );ROM_END(); }}; 
