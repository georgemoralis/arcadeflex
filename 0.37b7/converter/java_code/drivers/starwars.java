...
public class starwars
{
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT ( 0x01, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT ( 0x02, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT ( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT ( 0x08, IP_ACTIVE_LOW, IPT_TILT );	PORT_SERVICE( 0x10, IP_ACTIVE_LOW );	PORT_BIT ( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT ( 0x40, IP_ACTIVE_LOW, IPT_BUTTON4 );	PORT_BIT ( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 );
		PORT_START(); 	/* IN1 */
		PORT_BIT ( 0x01, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT ( 0x02, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BITX( 0x04, IP_ACTIVE_LOW, IPT_SERVICE, "Diagnostic Step", KEYCODE_F1, IP_JOY_NONE );	PORT_BIT ( 0x08, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT ( 0x10, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT ( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );	/* Bit 6 is MATH_RUN - see machine/starwars.c */
		PORT_BIT ( 0x40, IP_ACTIVE_HIGH, IPT_UNUSED );	/* Bit 7 is VG_HALT - see machine/starwars.c */
		PORT_BIT ( 0x80, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME(0x03, 0x00, "Starting Shields" );	PORT_DIPSETTING (  0x00, "6" );	PORT_DIPSETTING (  0x01, "7" );	PORT_DIPSETTING (  0x02, "8" );	PORT_DIPSETTING (  0x03, "9" );	PORT_DIPNAME(0x0c, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING (  0x00, "Easy" );	PORT_DIPSETTING (  0x04, "Moderate" );	PORT_DIPSETTING (  0x08, "Hard" );	PORT_DIPSETTING (  0x0c, "Hardest" );	PORT_DIPNAME(0x30, 0x00, "Bonus Shields" );	PORT_DIPSETTING (  0x00, "0" );	PORT_DIPSETTING (  0x10, "1" );	PORT_DIPSETTING (  0x20, "2" );	PORT_DIPSETTING (  0x30, "3" );	PORT_DIPNAME(0x40, 0x00, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING (  0x00, "*1" );	PORT_DIPSETTING (  0x10, "*2" );	PORT_DIPNAME(0xe0, 0x00, "Bonus Coinage" );	PORT_DIPSETTING (  0x20, "2 gives 1" );	PORT_DIPSETTING (  0x60, "4 gives 2" );	PORT_DIPSETTING (  0xa0, "3 gives 1" );	PORT_DIPSETTING (  0x40, "4 gives 1" );	PORT_DIPSETTING (  0x80, "5 gives 1" );	PORT_DIPSETTING (  0x00, "None" );/* 0xc0 and 0xe0 None */
	
		PORT_START(); 	/* IN4 */
		PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_Y, 70, 30, 0, 255 );
		PORT_START(); 	/* IN5 */
		PORT_ANALOG( 0xff, 0x80, IPT_AD_STICK_X, 50, 30, 0, 255 );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT ( 0x80, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME(0x03, 0x03, "Starting Shields" );	PORT_DIPSETTING (  0x01, "2" );	PORT_DIPSETTING (  0x00, "3" );	PORT_DIPSETTING (  0x03, "4" );	PORT_DIPSETTING (  0x02, "5" );	PORT_DIPNAME(0x0c, 0x0c, DEF_STR( "Difficulty") );
		PORT_DIPSETTING (  0x08, "Easy" );	PORT_DIPSETTING (  0x0c, "Moderate" );	PORT_DIPSETTING (  0x00, "Hard" );	PORT_DIPSETTING (  0x04, "Hardest" );	PORT_DIPNAME(0x30, 0x30, "Jedi-Letter Mode" );	PORT_DIPSETTING (  0x00, "Level Only" );	PORT_DIPSETTING (  0x10, "Level" );	PORT_DIPSETTING (  0x20, "Increment Only" );	PORT_DIPSETTING (  0x30, "Increment" );	PORT_DIPNAME(0x40, 0x40, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPNAME(0x0c, 0x00, DEF_STR( "Coin_B") );
		PORT_DIPSETTING (  0x00, "*1" );	PORT_DIPSETTING (  0x04, "*4" );	PORT_DIPSETTING (  0x08, "*5" );	PORT_DIPSETTING (  0x0c, "*6" );	PORT_DIPNAME(0x10, 0x00, DEF_STR( "Coin_A") );
		PORT_DIPSETTING (  0x00, "*1" );	PORT_DIPSETTING (  0x10, "*2" );	PORT_DIPNAME(0xe0, 0xe0, "Bonus Coinage" );	PORT_DIPSETTING (  0x20, "2 gives 1" );	PORT_DIPSETTING (  0x60, "4 gives 2" );	PORT_DIPSETTING (  0xa0, "3 gives 1" );	PORT_DIPSETTING (  0x40, "4 gives 1" );	PORT_DIPSETTING (  0x80, "5 gives 1" );	PORT_DIPSETTING (  0xe0, "None" );/* 0xc0 and 0x00 None */
	...
	(
		...
		new MachineCPU[] {
			...
			new MachineCPU(
				...
				null, null,
				null, null	/* no regular interrupts, see sndhrdw/starwars.c */
			)
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_starwar1 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(            0x10000, 0x2000 );	ROM_LOAD( "136021.102",   0x8000, 0x2000, 0xf725e344 );/*  8k ROM 1 bank */
	...
	static RomLoadPtr rom_esb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "136031.101",   0x06000, 0x2000, 0xef1e3ae5 );	ROM_CONTINUE(             0x10000, 0x2000 );	/* $8000 - $9fff : slapstic page */
		ROM_LOAD( "136031.102",   0x0a000, 0x2000, 0x62ce5c12 );	ROM_CONTINUE(             0x1c000, 0x2000 );	ROM_LOAD( "136031.203",   0x0c000, 0x2000, 0x27b0889b );	ROM_CONTINUE(             0x1e000, 0x2000 );	ROM_LOAD( "136031.104",   0x0e000, 0x2000, 0xfd5c725e );	ROM_CONTINUE(             0x20000, 0x2000 );
		...
		/* Sound ROMS */
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "136031.113",   0x4000, 0x2000, 0x24ae3815 );/* Sound ROM 0 */
