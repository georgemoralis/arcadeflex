...
public class raiden
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x01, 0x01, "Coin Mode" );	PORT_DIPSETTING(    0x01, "A" );	PORT_DIPSETTING(    0x00, "B" );	/* Coin Mode A */
	...
	/*	PORT_DIPNAME( 0x06, 0x06, DEF_STR( "Coin_A") );
		PORT_DIPSETTING(    0x00, "5C/1C or Free if Coin B too" );	PORT_DIPSETTING(    0x02, DEF_STR( "3C_1C") );
		...
		PORT_DIPNAME( 0x20, 0x20, "Credits to Start" );	PORT_DIPSETTING(    0x20, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unused") );
		...
		PORT_DIPSETTING(    0x02, "1" );	PORT_DIPSETTING(    0x01, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x08, "80000 300000" );	PORT_DIPSETTING(    0x0c, "150000 400000" );	PORT_DIPSETTING(    0x04, "300000 1000000" );	PORT_DIPSETTING(    0x00, "1000000 5000000" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		...
		PORT_START(); 	/* Coins */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );INPUT_PORTS_END(); }}; 
	...
	static public static VhEofCallbackPtr raiden_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
	...
	(
		...
		new MachineCPU[] {
			...
			new MachineCPU(
				CPU_V30, /* NEC V30 CPU */
				19000000, /* 20MHz is correct, but glitched!? */
				sub_readmem,sub_writemem,0,null,
				raiden_interrupt,1
			),
			new MachineCPU(
	...
	(
		...
		new MachineCPU[] {
			new MachineCPU(
				CPU_V30, /* NEC V30 CPU */
				19000000, /* 20MHz is correct, but glitched!? */
				alt_readmem,alt_writemem,0,null,
				raiden_interrupt,1
			),
			new MachineCPU(
				CPU_V30, /* NEC V30 CPU */
	...
	static RomLoadPtr rom_raiden = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "rai6.bin", 0x000000, 0x08000, 0x723a483b );	ROM_CONTINUE(         0x010000, 0x08000 );
		ROM_REGION( 0x010000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rai9.bin",     0x00000, 0x08000, 0x1922b25e );/* chars */
		ROM_LOAD( "rai10.bin",    0x08000, 0x08000, 0x5f90786a );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "raiu0919.bin", 0x00000, 0x80000, 0xda151f0b );/* tiles */
	
		ROM_REGION( 0x080000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "raiu0920.bin", 0x00000, 0x80000, 0xac1f57ac );/* tiles */
	
		ROM_REGION( 0x090000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "raiu165.bin",  0x00000, 0x80000, 0x946d7bde );/* sprites */
	
		ROM_REGION( 0x10000, REGION_SOUND1 ); /* ADPCM samples */
		ROM_LOAD( "rai7.bin", 0x00000, 0x10000, 0x8f927822 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_raidena = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x18000, REGION_CPU3 );/* 64k code for sound Z80 */
		ROM_LOAD( "raiden08.rom", 0x000000, 0x08000, 0x731adb43 );	ROM_CONTINUE(             0x010000, 0x08000 );
		ROM_REGION( 0x010000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rai9.bin",     0x00000, 0x08000, 0x1922b25e );/* chars */
		ROM_LOAD( "rai10.bin",    0x08000, 0x08000, 0x5f90786a );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "raiu0919.bin", 0x00000, 0x80000, 0xda151f0b );/* tiles */
	...
	static RomLoadPtr rom_raidenk = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x18000, REGION_CPU3 );/* 64k code for sound Z80 */
		ROM_LOAD( "8b",           0x000000, 0x08000, 0x99ee7505 );	ROM_CONTINUE(             0x010000, 0x08000 );
		ROM_REGION( 0x010000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rai9.bin",     0x00000, 0x08000, 0x1922b25e );/* chars */
		ROM_LOAD( "rai10.bin",    0x08000, 0x08000, 0x5f90786a );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "raiu0919.bin", 0x00000, 0x80000, 0xda151f0b );/* tiles */
