...
public class bublbobl
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bublbobl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "a78-06.51",    0x00000, 0x08000, 0x32c8305b );    /* ROMs banked at 8000-bfff */
		...
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "a78-09.12",    0x00000, 0x8000, 0x20358c22 );   /* 1st plane */
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "a71-25.41",    0x0000, 0x0100, 0x2d0f8545 );/* video timing */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_bublbobr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "a78-25.51",    0x00000, 0x08000, 0x2d901c9d );    /* ROMs banked at 8000-bfff */
	...
	static RomLoadPtr rom_boblbobl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "bb3",          0x00000, 0x08000, 0x01f81936 );    /* ROMs banked at 8000-bfff */
	...
	static RomLoadPtr rom_sboblbob = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "bbb-3.rom",    0x00000, 0x08000, 0xf304152a );    /* ROMs banked at 8000-bfff */
	...
	static RomLoadPtr rom_tokio = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "a71-08.256",   0x00000, 0x8000, 0x0439ab13 );   /* 1st plane */
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "a71-25.bin",   0x0000, 0x0100, 0x2d0f8545 );/* video timing */
	ROM_END(); }}; 
