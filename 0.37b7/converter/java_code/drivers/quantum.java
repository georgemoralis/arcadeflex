...
public class quantum
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
	/* first POKEY is SW2, second is SW1 -- more confusion! */
		...
		PORT_DIPNAME( 0x30, 0x00, "Right Coin" );	PORT_DIPSETTING(    0x00, "*1" );	PORT_DIPSETTING(    0x20, "*4" );	PORT_DIPSETTING(    0x10, "*5" );	PORT_DIPSETTING(    0x30, "*6" );	PORT_DIPNAME( 0x08, 0x00, "Left Coin" );	PORT_DIPSETTING(    0x00, "*1" );	PORT_DIPSETTING(    0x08, "*2" );	PORT_DIPNAME( 0x07, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x01, "1 each 5" );	PORT_DIPSETTING(    0x02, "1 each 4" );	PORT_DIPSETTING(    0x05, "1 each 3" );	PORT_DIPSETTING(    0x06, "2 each 4" );
		PORT_START();  /* DSW1 */
		PORT_BIT( 0xff, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* IN2 */
		PORT_ANALOG( 0x0f, 0, IPT_TRACKBALL_Y | IPF_REVERSE, 10, 10, 0,0);
		PORT_START();       /* IN3 */
		PORT_ANALOG( 0x0f, 0, IPT_TRACKBALL_X, 10, 10, 0, 0 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_quantum = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x014000, REGION_CPU1 );    ROM_LOAD_EVEN( "136016.201",   0x000000, 0x002000, 0x7e7be63a );    ROM_LOAD_ODD ( "136016.206",   0x000000, 0x002000, 0x2d8f5759 );    ROM_LOAD_EVEN( "136016.102",   0x004000, 0x002000, 0x408d34f4 );    ROM_LOAD_ODD ( "136016.107",   0x004000, 0x002000, 0x63154484 );    ROM_LOAD_EVEN( "136016.203",   0x008000, 0x002000, 0xbdc52fad );    ROM_LOAD_ODD ( "136016.208",   0x008000, 0x002000, 0xdab4066b );    ROM_LOAD_EVEN( "136016.104",   0x00C000, 0x002000, 0xbf271e5c );    ROM_LOAD_ODD ( "136016.109",   0x00C000, 0x002000, 0xd2894424 );    ROM_LOAD_EVEN( "136016.105",   0x010000, 0x002000, 0x13ec512c );    ROM_LOAD_ODD ( "136016.110",   0x010000, 0x002000, 0xacb50363 );ROM_END(); }}; 
	
	static RomLoadPtr rom_quantum1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x014000, REGION_CPU1 );    ROM_LOAD_EVEN( "136016.101",   0x000000, 0x002000, 0x5af0bd5b );    ROM_LOAD_ODD ( "136016.106",   0x000000, 0x002000, 0xf9724666 );    ROM_LOAD_EVEN( "136016.102",   0x004000, 0x002000, 0x408d34f4 );    ROM_LOAD_ODD ( "136016.107",   0x004000, 0x002000, 0x63154484 );    ROM_LOAD_EVEN( "136016.103",   0x008000, 0x002000, 0x948f228b );    ROM_LOAD_ODD ( "136016.108",   0x008000, 0x002000, 0xe4c48e4e );    ROM_LOAD_EVEN( "136016.104",   0x00C000, 0x002000, 0xbf271e5c );    ROM_LOAD_ODD ( "136016.109",   0x00C000, 0x002000, 0xd2894424 );    ROM_LOAD_EVEN( "136016.105",   0x010000, 0x002000, 0x13ec512c );    ROM_LOAD_ODD ( "136016.110",   0x010000, 0x002000, 0xacb50363 );ROM_END(); }}; 
	
	static RomLoadPtr rom_quantump = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x014000, REGION_CPU1 );    ROM_LOAD_EVEN( "quantump.2e",  0x000000, 0x002000, 0x176d73d3 );    ROM_LOAD_ODD ( "quantump.3e",  0x000000, 0x002000, 0x12fc631f );    ROM_LOAD_EVEN( "quantump.2f",  0x004000, 0x002000, 0xb64fab48 );    ROM_LOAD_ODD ( "quantump.3f",  0x004000, 0x002000, 0xa52a9433 );    ROM_LOAD_EVEN( "quantump.2h",  0x008000, 0x002000, 0x5b29cba3 );    ROM_LOAD_ODD ( "quantump.3h",  0x008000, 0x002000, 0xc64fc03a );    ROM_LOAD_EVEN( "quantump.2k",  0x00C000, 0x002000, 0x854f9c09 );    ROM_LOAD_ODD ( "quantump.3k",  0x00C000, 0x002000, 0x1aac576c );    ROM_LOAD_EVEN( "quantump.2l",  0x010000, 0x002000, 0x1285b5e7 );    ROM_LOAD_ODD ( "quantump.3l",  0x010000, 0x002000, 0xe19de844 );ROM_END(); }}; 
