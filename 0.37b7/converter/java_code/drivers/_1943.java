...
public class _1943
{
	...
	extern UBytePtr c1943_scrollx;
	extern UBytePtr c1943_scrolly;
	extern UBytePtr c1943_bgscrolly;
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );/* actually, this is VBLANK */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );/* probably unused */
		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );/* probably unused */
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Button 3, probably unused */
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Button 3, probably unused */
		PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x0f, 0x0f, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x0f, "1 (Easiest); )
		PORT_DIPSETTING(    0x0e, "2" );	PORT_DIPSETTING(    0x0d, "3" );	PORT_DIPSETTING(    0x0c, "4" );	PORT_DIPSETTING(    0x0b, "5" );	PORT_DIPSETTING(    0x0a, "6" );	PORT_DIPSETTING(    0x09, "7" );	PORT_DIPSETTING(    0x08, "8" );	PORT_DIPSETTING(    0x07, "9" );	PORT_DIPSETTING(    0x06, "10" );	PORT_DIPSETTING(    0x05, "11" );	PORT_DIPSETTING(    0x04, "12" );	PORT_DIPSETTING(    0x03, "13" );	PORT_DIPSETTING(    0x02, "14" );	PORT_DIPSETTING(    0x01, "15" );	PORT_DIPSETTING(    0x00, "16 (Hardest); )
		PORT_DIPNAME( 0x10, 0x10, "2 Players Game" );	PORT_DIPSETTING(    0x00, "1 Credit" );	PORT_DIPSETTING(    0x10, "2 Credits" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_1943 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "1943.01",      0x00000, 0x08000, 0xc686cc5c );	ROM_LOAD( "1943.02",      0x10000, 0x10000, 0xd8880a41 );	ROM_LOAD( "1943.03",      0x20000, 0x10000, 0x3f0ee26c );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "1943.05",      0x00000, 0x8000, 0xee2bd2d7 );
		ROM_REGION( 0x8000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943.04",      0x00000, 0x8000, 0x46cb9d3d );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943.15",      0x00000, 0x8000, 0x6b1a0443 );/* bg tiles */
		ROM_LOAD( "1943.16",      0x08000, 0x8000, 0x23c908c2 );	ROM_LOAD( "1943.17",      0x10000, 0x8000, 0x46bcdd07 );	ROM_LOAD( "1943.18",      0x18000, 0x8000, 0xe6ae7ba0 );	ROM_LOAD( "1943.19",      0x20000, 0x8000, 0x868ababc );	ROM_LOAD( "1943.20",      0x28000, 0x8000, 0x0917e5d4 );	ROM_LOAD( "1943.21",      0x30000, 0x8000, 0x9bfb0d89 );	ROM_LOAD( "1943.22",      0x38000, 0x8000, 0x04f3c274 );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943.24",      0x00000, 0x8000, 0x11134036 );/* fg tiles */
		ROM_LOAD( "1943.25",      0x08000, 0x8000, 0x092cf9c1 );
		ROM_REGION( 0x40000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943.06",      0x00000, 0x8000, 0x97acc8af );/* sprites */
		ROM_LOAD( "1943.07",      0x08000, 0x8000, 0xd78f7197 );	ROM_LOAD( "1943.08",      0x10000, 0x8000, 0x1a626608 );	ROM_LOAD( "1943.09",      0x18000, 0x8000, 0x92408400 );	ROM_LOAD( "1943.10",      0x20000, 0x8000, 0x8438a44a );	ROM_LOAD( "1943.11",      0x28000, 0x8000, 0x6c69351d );	ROM_LOAD( "1943.12",      0x30000, 0x8000, 0x5e7efdb7 );	ROM_LOAD( "1943.13",      0x38000, 0x8000, 0x1143829a );
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "bmprom.01",    0x0000, 0x0100, 0x74421f18 );/* red component */
	...
	static RomLoadPtr rom_1943j = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );/* 64k for code + 128k for the banked ROMs images */
		ROM_LOAD( "1943jap.001",  0x00000, 0x08000, 0xf6935937 );	ROM_LOAD( "1943jap.002",  0x10000, 0x10000, 0xaf971575 );	ROM_LOAD( "1943jap.003",  0x20000, 0x10000, 0x300ec713 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "1943.05",      0x00000, 0x8000, 0xee2bd2d7 );
		ROM_REGION( 0x8000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943.04",      0x00000, 0x8000, 0x46cb9d3d );/* characters */
	...
	static RomLoadPtr rom_1943kai = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );/* 64k for code + 128k for the banked ROMs images */
		ROM_LOAD( "1943kai.01",   0x00000, 0x08000, 0x7d2211db );	ROM_LOAD( "1943kai.02",   0x10000, 0x10000, 0x2ebbc8c5 );	ROM_LOAD( "1943kai.03",   0x20000, 0x10000, 0x475a6ac5 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "1943kai.05",   0x00000, 0x8000, 0x25f37957 );
		ROM_REGION( 0x8000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943kai.04",   0x00000, 0x8000, 0x884a8692 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943kai.15",   0x00000, 0x8000, 0x6b1a0443 );/* bg tiles */
		ROM_LOAD( "1943kai.16",   0x08000, 0x8000, 0x9416fe0d );	ROM_LOAD( "1943kai.17",   0x10000, 0x8000, 0x3d5acab9 );	ROM_LOAD( "1943kai.18",   0x18000, 0x8000, 0x7b62da1d );	ROM_LOAD( "1943kai.19",   0x20000, 0x8000, 0x868ababc );	ROM_LOAD( "1943kai.20",   0x28000, 0x8000, 0xb90364c1 );	ROM_LOAD( "1943kai.21",   0x30000, 0x8000, 0x8c7fe74a );	ROM_LOAD( "1943kai.22",   0x38000, 0x8000, 0xd5ef8a0e );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943kai.24",   0x00000, 0x8000, 0xbf186ef2 );/* fg tiles */
		ROM_LOAD( "1943kai.25",   0x08000, 0x8000, 0xa755faf1 );
		ROM_REGION( 0x40000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1943kai.06",   0x00000, 0x8000, 0x5f7e38b3 );/* sprites */
		ROM_LOAD( "1943kai.07",   0x08000, 0x8000, 0xff3751fd );	ROM_LOAD( "1943kai.08",   0x10000, 0x8000, 0x159d51bd );	ROM_LOAD( "1943kai.09",   0x18000, 0x8000, 0x8683e3d2 );	ROM_LOAD( "1943kai.10",   0x20000, 0x8000, 0x1e0d9571 );	ROM_LOAD( "1943kai.11",   0x28000, 0x8000, 0xf1fc5ee1 );	ROM_LOAD( "1943kai.12",   0x30000, 0x8000, 0x0f50c001 );	ROM_LOAD( "1943kai.13",   0x38000, 0x8000, 0xfd1acf8e );
		ROM_REGION( 0x10000, REGION_GFX5 );/* tilemaps */
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "bmk01.bin",    0x0000, 0x0100, 0xe001ea33 );/* red component */
