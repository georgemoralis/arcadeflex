...
public class crimfght
{
	...
	***************************************************************************/
	...
	PORT_START(); 	/* DSW #1 */
		...
		PORT_DIPSETTING(    0x00, "1 Coin/99 Credits" );/*	PORT_DIPNAME( 0xf0, 0xf0, DEF_STR( "Coin_B") );
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_SERVICE( 0x04, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_crimfght = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "821l02.f24", 0x10000, 0x18000, 0x588e7da6 );	ROM_CONTINUE(           0x08000, 0x08000 );
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "821a08.i15", 0x0000, 0x0100, 0x7da55800 );/* priority encoder (not used) */
	
		ROM_REGION( 0x40000, REGION_SOUND1 );/* data for the 007232 */
		ROM_LOAD( "821k03.e5",  0x00000, 0x40000, 0xfef8505a );ROM_END(); }}; 
	
	static RomLoadPtr rom_crimfgtj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x28000, REGION_CPU1 );/* code + banked roms */
		ROM_LOAD( "821p02.bin", 0x10000, 0x18000, 0xf33fa2e1 );	ROM_CONTINUE(           0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the sound CPU */
		ROM_LOAD( "821l01.h4",  0x0000, 0x8000, 0x0faca89e );
		ROM_REGION( 0x080000, REGION_GFX1 );/* graphics ( don't dispose as the program can read them ) */
		ROM_LOAD( "821k06.k13", 0x000000, 0x040000, 0xa1eadb24 );/* characters */
	...
	ROM_REGION( 0x28000, REGION_CPU1 );/* code + banked roms */
		ROM_LOAD( "crimefb.r02", 0x10000, 0x18000, 0x4ecdd923 );	ROM_CONTINUE(           0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the sound CPU */
		ROM_LOAD( "821l01.h4",  0x0000, 0x8000, 0x0faca89e );
		ROM_REGION( 0x080000, REGION_GFX1 );/* graphics ( don't dispose as the program can read them ) */
		ROM_LOAD( "821k06.k13", 0x000000, 0x040000, 0xa1eadb24 );/* characters */
