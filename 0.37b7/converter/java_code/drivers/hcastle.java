...
public class hcastle
{
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* IN1 */
		...
		PORT_DIPSETTING(    0x18, "Easy" );	PORT_DIPSETTING(    0x10, "Normal" );	PORT_DIPSETTING(    0x08, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x60, 0x60, "Energy" );	PORT_DIPSETTING(    0x60, "Strong" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Weak" );	PORT_DIPSETTING(    0x00, "Very Weak" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Upright Controls" );	PORT_DIPSETTING(    0x02, "Single" );	PORT_DIPSETTING(    0x00, "Dual" );	PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x08, 0x08, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
	...
	static RomLoadPtr rom_hcastle = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "768.k03",      0x08000, 0x08000, 0x40ce4f38 );	ROM_LOAD( "768.g06",      0x10000, 0x20000, 0xcdade920 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "768.e01",      0x00000, 0x08000, 0xb9fff184 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "d95.g21",      0x000000, 0x80000, 0xe3be3fdd );	ROM_LOAD( "d94.g19",      0x080000, 0x80000, 0x9633db8b );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "d91.j5",       0x000000, 0x80000, 0x2960680e );	ROM_LOAD( "d92.j6",       0x080000, 0x80000, 0x65a2f227 );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "768c13.j21",   0x0000, 0x0100, 0xf5de80cb );/* 007121 #0 sprite lookup table */
		...
		ROM_LOAD( "d93.e17",      0x00000, 0x80000, 0x01f9889c );ROM_END(); }}; 
	
	static RomLoadPtr rom_hcastlea = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "m03.k12",      0x08000, 0x08000, 0xd85e743d );	ROM_LOAD( "b06.k8",       0x10000, 0x20000, 0xabd07866 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "768.e01",      0x00000, 0x08000, 0xb9fff184 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "d95.g21",      0x000000, 0x80000, 0xe3be3fdd );	ROM_LOAD( "d94.g19",      0x080000, 0x80000, 0x9633db8b );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "d91.j5",       0x000000, 0x80000, 0x2960680e );	ROM_LOAD( "d92.j6",       0x080000, 0x80000, 0x65a2f227 );
	...
	static RomLoadPtr rom_hcastlej = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "768p03.k12",0x08000, 0x08000, 0xd509e340 );	ROM_LOAD( "768j06.k8", 0x10000, 0x20000, 0x42283c3e );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "768.e01",   0x00000, 0x08000, 0xb9fff184 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "d95.g21",      0x000000, 0x80000, 0xe3be3fdd );	ROM_LOAD( "d94.g19",      0x080000, 0x80000, 0x9633db8b );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "d91.j5",       0x000000, 0x80000, 0x2960680e );	ROM_LOAD( "d92.j6",       0x080000, 0x80000, 0x65a2f227 );
