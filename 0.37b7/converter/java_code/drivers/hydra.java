...
public class hydra
{
	...
	PORT_START(); 		/* fc0000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON5 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON6 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON4 );	PORT_BIT( 0x0fe0, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x2000, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_SERVICE( 0x4000, IP_ACTIVE_LOW );	PORT_BIT( 0x8000, IP_ACTIVE_HIGH, IPT_VBLANK );
		PORT_START(); 		/* ADC 0 @ fc8000 */
		PORT_ANALOG( 0x00ff, 0x0080, IPT_AD_STICK_X, 50, 10, 0, 255 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* ADC 1 @ fc8000 */
		PORT_ANALOG( 0x00ff, 0x0080, IPT_AD_STICK_Y, 70, 10, 0, 255 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	(
		...
		new int[] { 0, 0, 1, 2, 3 },
	#if HIGH_RES
		new int[] { 0x40000*8+0,0x40000*8+0, 0x40000*8+4,0x40000*8+4, 0,0, 4,4,
	...
	static RomLoadPtr rom_hydra = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "hydr3028.bin", 0x00000, 0x10000, 0x43475f73 );	ROM_LOAD_ODD ( "hydr3029.bin", 0x00000, 0x10000, 0x886e1de8 );	ROM_LOAD_EVEN( "hydr3034.bin", 0x20000, 0x10000, 0x5115aa36 );	ROM_LOAD_ODD ( "hydr3035.bin", 0x20000, 0x10000, 0xa28ba44b );	ROM_LOAD_EVEN( "hydr1032.bin", 0x40000, 0x10000, 0xecd1152a );	ROM_LOAD_ODD ( "hydr1033.bin", 0x40000, 0x10000, 0x2ebe1939 );	ROM_LOAD_EVEN( "hydr1030.bin", 0x60000, 0x10000, 0xb31fd41f );	ROM_LOAD_ODD ( "hydr1031.bin", 0x60000, 0x10000, 0x453d076f );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "hydraa0.bin", 0x10000, 0x4000, 0x619d7319 );	ROM_CONTINUE(            0x04000, 0xc000 );
		ROM_REGION( 0x0a0000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "hydr1017.bin",  0x000000, 0x10000, 0xbd77b747 );/* playfield, planes 0-3 odd */
		ROM_LOAD( "hydr1018.bin",  0x010000, 0x10000, 0x7c24e637 );	ROM_LOAD( "hydr1019.bin",  0x020000, 0x10000, 0xaa2fb07b );	ROM_LOAD( "hydr1020.bin",  0x030000, 0x10000, 0x906ccd98 );	ROM_LOAD( "hydr1021.bin",  0x040000, 0x10000, 0xf88cdac2 );/* playfield, planes 0-3 even */
		ROM_LOAD( "hydr1022.bin",  0x050000, 0x10000, 0xa9c612ff );	ROM_LOAD( "hydr1023.bin",  0x060000, 0x10000, 0xb706aa6e );	ROM_LOAD( "hydr1024.bin",  0x070000, 0x10000, 0xc49eac53 );	ROM_LOAD( "hydr1025.bin",  0x080000, 0x10000, 0x98b5b1a1 );/* playfield plane 4 */
		ROM_LOAD( "hydr1026.bin",  0x090000, 0x10000, 0xd68d44aa );
		ROM_REGION( 0x020000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "hydr1027.bin",  0x000000, 0x20000, 0xf9135b9b );/* alphanumerics */
	
		ROM_REGION( 0x100000, REGION_GFX3 );	ROM_LOAD_ODD ( "hydr1001.bin", 0x00000, 0x10000, 0x3f757a53 );	ROM_LOAD_EVEN( "hydr1002.bin", 0x00000, 0x10000, 0xa1169469 );	ROM_LOAD_ODD ( "hydr1003.bin", 0x20000, 0x10000, 0xaa21ec33 );	ROM_LOAD_EVEN( "hydr1004.bin", 0x20000, 0x10000, 0xc0a2be66 );	ROM_LOAD_ODD ( "hydr1005.bin", 0x40000, 0x10000, 0x80c285b3 );	ROM_LOAD_EVEN( "hydr1006.bin", 0x40000, 0x10000, 0xad831c59 );	ROM_LOAD_ODD ( "hydr1007.bin", 0x60000, 0x10000, 0xe0688cc0 );	ROM_LOAD_EVEN( "hydr1008.bin", 0x60000, 0x10000, 0xe6827f6b );	ROM_LOAD_ODD ( "hydr1009.bin", 0x80000, 0x10000, 0x33624d07 );	ROM_LOAD_EVEN( "hydr1010.bin", 0x80000, 0x10000, 0x9de4c689 );	ROM_LOAD_ODD ( "hydr1011.bin", 0xa0000, 0x10000, 0xd55c6e49 );	ROM_LOAD_EVEN( "hydr1012.bin", 0xa0000, 0x10000, 0x43af45d0 );	ROM_LOAD_ODD ( "hydr1013.bin", 0xc0000, 0x10000, 0x2647a82b );	ROM_LOAD_EVEN( "hydr1014.bin", 0xc0000, 0x10000, 0x8897d5e9 );	ROM_LOAD_ODD ( "hydr1015.bin", 0xe0000, 0x10000, 0xcf7f69fd );	ROM_LOAD_EVEN( "hydr1016.bin", 0xe0000, 0x10000, 0x61aaf14f );
		ROM_REGION( 0x30000, REGION_SOUND1 );/* 192k for ADPCM samples */
		ROM_LOAD( "hydr1037.bin",  0x00000, 0x10000, 0xb974d3d0 );	ROM_LOAD( "hydr1038.bin",  0x10000, 0x10000, 0xa2eda15b );	ROM_LOAD( "hydr1039.bin",  0x20000, 0x10000, 0xeb9eaeb7 );ROM_END(); }}; 
	
	static RomLoadPtr rom_hydrap = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 8*64k for 68000 code */
		ROM_LOAD_EVEN( "hydhi0.bin", 0x00000, 0x10000, 0xdab2e8a2 );	ROM_LOAD_ODD ( "hydlo0.bin", 0x00000, 0x10000, 0xc18d4f16 );	ROM_LOAD_EVEN( "hydhi1.bin", 0x20000, 0x10000, 0x50c12bb9 );	ROM_LOAD_ODD ( "hydlo1.bin", 0x20000, 0x10000, 0x5ee0a846 );	ROM_LOAD_EVEN( "hydhi2.bin", 0x40000, 0x10000, 0x436a6d81 );	ROM_LOAD_ODD ( "hydlo2.bin", 0x40000, 0x10000, 0x182bfd6a );	ROM_LOAD_EVEN( "hydhi3.bin", 0x60000, 0x10000, 0x29e9e03e );	ROM_LOAD_ODD ( "hydlo3.bin", 0x60000, 0x10000, 0x7b5047f0 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "hydraa0.bin", 0x10000, 0x4000, BADCRC(0x619d7319));
		ROM_CONTINUE(            0x04000, 0xc000 );
		ROM_REGION( 0x0a0000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "hydr1017.bin",  0x000000, 0x10000, 0xbd77b747 );/* playfield, planes 0-3 odd */
		ROM_LOAD( "hydr1018.bin",  0x010000, 0x10000, 0x7c24e637 );	ROM_LOAD( "hydr1019.bin",  0x020000, 0x10000, 0xaa2fb07b );	ROM_LOAD( "hydpl03.bin",   0x030000, 0x10000, 0x1f0dfe60 );	ROM_LOAD( "hydr1021.bin",  0x040000, 0x10000, 0xf88cdac2 );/* playfield, planes 0-3 even */
		ROM_LOAD( "hydr1022.bin",  0x050000, 0x10000, 0xa9c612ff );	ROM_LOAD( "hydr1023.bin",  0x060000, 0x10000, 0xb706aa6e );	ROM_LOAD( "hydphi3.bin",   0x070000, 0x10000, 0x917e250c );	ROM_LOAD( "hydr1025.bin",  0x080000, 0x10000, 0x98b5b1a1 );/* playfield plane 4 */
		ROM_LOAD( "hydpl41.bin",   0x090000, 0x10000, 0x85f9afa6 );
		ROM_REGION( 0x020000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "hydalph.bin",   0x000000, 0x20000, 0x7dd2b062 );/* alphanumerics */
	
		ROM_REGION( 0x100000, REGION_GFX3 );	ROM_LOAD_ODD ( "hydmhi0.bin", 0x00000, 0x10000, 0x3c83b42d );	ROM_LOAD_EVEN( "hydmlo0.bin", 0x00000, 0x10000, 0x6d49650c );	ROM_LOAD_ODD ( "hydmhi1.bin", 0x20000, 0x10000, 0x689b3376 );	ROM_LOAD_EVEN( "hydmlo1.bin", 0x20000, 0x10000, 0xc81a4e88 );	ROM_LOAD_ODD ( "hydmhi2.bin", 0x40000, 0x10000, 0x77098e14 );	ROM_LOAD_EVEN( "hydmlo2.bin", 0x40000, 0x10000, 0x40015d9d );	ROM_LOAD_ODD ( "hydmhi3.bin", 0x60000, 0x10000, 0xdfebdcbd );	ROM_LOAD_EVEN( "hydmlo3.bin", 0x60000, 0x10000, 0x213c407c );	ROM_LOAD_ODD ( "hydmhi4.bin", 0x80000, 0x10000, 0x2897765f );	ROM_LOAD_EVEN( "hydmlo4.bin", 0x80000, 0x10000, 0x730157f3 );	ROM_LOAD_ODD ( "hydmhi5.bin", 0xa0000, 0x10000, 0xecd061ae );	ROM_LOAD_EVEN( "hydmlo5.bin", 0xa0000, 0x10000, 0xa5a08c53 );	ROM_LOAD_ODD ( "hydmhi6.bin", 0xc0000, 0x10000, 0xaa3f2903 );	ROM_LOAD_EVEN( "hydmlo6.bin", 0xc0000, 0x10000, 0xdb8ea56f );	ROM_LOAD_ODD ( "hydmhi7.bin", 0xe0000, 0x10000, 0x71fc3e43 );	ROM_LOAD_EVEN( "hydmlo7.bin", 0xe0000, 0x10000, 0x7960b0c2 );
		ROM_REGION( 0x30000, REGION_SOUND1 );/* 192k for ADPCM samples */
	...
	static RomLoadPtr rom_pitfight = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 8*64k for 68000 code */
		ROM_LOAD_EVEN( "4028", 0x00000, 0x10000, 0xf7cb1a4b );	ROM_LOAD_ODD ( "4029", 0x00000, 0x10000, 0x13ae0d4f );	ROM_LOAD_EVEN( "3030", 0x20000, 0x10000, 0xb053e779 );	ROM_LOAD_ODD ( "3031", 0x20000, 0x10000, 0x2b8c4d13 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "1060", 0x10000, 0x4000, 0x231d71d7 );	ROM_CONTINUE(     0x04000, 0xc000 );
		ROM_REGION( 0x0a0000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1017",  0x000000, 0x10000, 0xad3cfea5 );/* playfield, planes 0-3 odd */
		ROM_LOAD( "1018",  0x010000, 0x10000, 0x1a0f8bcf );	ROM_LOAD( "1021",  0x040000, 0x10000, 0x777efee3 );/* playfield, planes 0-3 even */
		ROM_LOAD( "1022",  0x050000, 0x10000, 0x524319d0 );	ROM_LOAD( "1025",  0x080000, 0x10000, 0xfc41691a );/* playfield plane 4 */
	
		ROM_REGION( 0x020000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1027",  0x000000, 0x10000, 0xa59f381d );/* alphanumerics */
	
		ROM_REGION( 0x200000, REGION_GFX3 );	ROM_LOAD_ODD ( "1001", 0x000000, 0x20000, 0x3af31444 );	ROM_LOAD_EVEN( "1002", 0x000000, 0x20000, 0xf1d76a4c );	ROM_LOAD_ODD ( "1003", 0x040000, 0x20000, 0x28c41c2a );	ROM_LOAD_EVEN( "1004", 0x040000, 0x20000, 0x977744da );	ROM_LOAD_ODD ( "1005", 0x080000, 0x20000, 0xae59aef2 );	ROM_LOAD_EVEN( "1006", 0x080000, 0x20000, 0xb6ccd77e );	ROM_LOAD_ODD ( "1007", 0x0c0000, 0x20000, 0xba33b0c0 );	ROM_LOAD_EVEN( "1008", 0x0c0000, 0x20000, 0x09bd047c );	ROM_LOAD_ODD ( "1009", 0x100000, 0x20000, 0xab85b00b );	ROM_LOAD_EVEN( "1010", 0x100000, 0x20000, 0xeca94bdc );	ROM_LOAD_ODD ( "1011", 0x140000, 0x20000, 0xa86582fd );	ROM_LOAD_EVEN( "1012", 0x140000, 0x20000, 0xefd1152d );	ROM_LOAD_ODD ( "1013", 0x180000, 0x20000, 0xa141379e );	ROM_LOAD_EVEN( "1014", 0x180000, 0x20000, 0x93bfcc15 );	ROM_LOAD_ODD ( "1015", 0x1c0000, 0x20000, 0x9378ad0b );	ROM_LOAD_EVEN( "1016", 0x1c0000, 0x20000, 0x19c3fbe0 );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* 256k for ADPCM samples */
		ROM_LOAD( "1061",  0x00000, 0x10000, 0x5b0468c6 );	ROM_LOAD( "1062",  0x10000, 0x10000, 0xf73fe3cb );	ROM_LOAD( "1063",  0x20000, 0x10000, 0xaa93421d );	ROM_LOAD( "1064",  0x30000, 0x10000, 0x33f045d5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_pitfigh3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 8*64k for 68000 code */
		ROM_LOAD_EVEN( "3028", 0x00000, 0x10000, 0x99530da4 );	ROM_LOAD_ODD ( "3029", 0x00000, 0x10000, 0x78c7afbf );	ROM_LOAD_EVEN( "3030", 0x20000, 0x10000, 0xb053e779 );	ROM_LOAD_ODD ( "3031", 0x20000, 0x10000, 0x2b8c4d13 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "1060", 0x10000, 0x4000, 0x231d71d7 );	ROM_CONTINUE(     0x04000, 0xc000 );
		ROM_REGION( 0x0a0000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1017",  0x000000, 0x10000, 0xad3cfea5 );/* playfield, planes 0-3 odd */
		ROM_LOAD( "1018",  0x010000, 0x10000, 0x1a0f8bcf );	ROM_LOAD( "1021",  0x040000, 0x10000, 0x777efee3 );/* playfield, planes 0-3 even */
