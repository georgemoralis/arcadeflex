...
public class zerozone
{
	...
	PORT_START();       /* IN0 */
		...
		PORT_DIPSETTING(    0x0c, "1");	PORT_DIPSETTING(    0x04, "2");	PORT_DIPSETTING(    0x08, "3");	PORT_DIPSETTING(    0x00, "4");	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_zerozone = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "zz-4.rom", 0x0000, 0x10000, 0x83718b9b );	ROM_LOAD_ODD ( "zz-5.rom", 0x0000, 0x10000, 0x18557f41 );
		ROM_REGION( 0x10000, REGION_CPU2 );     /* sound cpu */
		ROM_LOAD( "zz-1.rom", 0x00000, 0x08000, 0x223ccce5 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "zz-6.rom", 0x00000, 0x80000, 0xc8b906b9 );
		ROM_REGION( 0x40000, REGION_SOUND1 );     /* ADPCM samples */
		ROM_LOAD( "zz-2.rom", 0x00000, 0x20000, 0xc7551e81 );	ROM_LOAD( "zz-3.rom", 0x20000, 0x20000, 0xe348ff5e );ROM_END(); }}; 
