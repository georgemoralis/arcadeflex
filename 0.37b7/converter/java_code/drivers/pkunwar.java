...
public class pkunwar
{
	...
	PORT_START(); 	/* IN0 */
	    PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY );    PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY );    PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 );    PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START1 );    PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_VBLANK );
		PORT_START(); 	/* IN1 */
	    PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_COCKTAIL );    PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_COCKTAIL );    PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );    PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );    PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START2 );	PORT_SERVICE( 0x40, IP_ACTIVE_LOW );    PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START(); 	/* DSW0 */
		...
		PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x30, "Medium" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_pkunwar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "pkwar.01r",    0x0000, 0x4000, 0xce2d2c7b );	ROM_LOAD( "pkwar.02r",    0x4000, 0x4000, 0xabc1f661 );	ROM_LOAD( "pkwar.03r",    0xe000, 0x2000, 0x56faebea );
		ROM_REGION( 0x10000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pkwar.01y",    0x0000, 0x2000, 0x428d3b92 );	ROM_CONTINUE(             0x8000, 0x2000 );	ROM_LOAD( "pkwar.02y",    0x2000, 0x2000, 0xce1da7bc );	ROM_CONTINUE(             0xa000, 0x2000 );	ROM_LOAD( "pkwar.03y",    0x4000, 0x2000, 0x63204400 );	ROM_CONTINUE(             0xc000, 0x2000 );	ROM_LOAD( "pkwar.04y",    0x6000, 0x2000, 0x061dfca8 );	ROM_CONTINUE(             0xe000, 0x2000 );
		ROM_REGION( 0x0020, REGION_PROMS );	ROM_LOAD( "pkwar.col",    0x0000, 0x0020, 0xaf0fc5e2 );ROM_END(); }}; 
	
	static RomLoadPtr rom_pkunwarj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "pgunwar.6",    0x0000, 0x4000, 0x357f3ef3 );	ROM_LOAD( "pgunwar.5",    0x4000, 0x4000, 0x0092e49e );	ROM_LOAD( "pkwar.03r",    0xe000, 0x2000, 0x56faebea );
		ROM_REGION( 0x10000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pkwar.01y",    0x0000, 0x2000, 0x428d3b92 );	ROM_CONTINUE(             0x8000, 0x2000 );	ROM_LOAD( "pkwar.02y",    0x2000, 0x2000, 0xce1da7bc );	ROM_CONTINUE(             0xa000, 0x2000 );	ROM_LOAD( "pgunwar.2",    0x4000, 0x2000, 0xa2a43443 );	ROM_CONTINUE(             0xc000, 0x2000 );	ROM_LOAD( "pkwar.04y",    0x6000, 0x2000, 0x061dfca8 );	ROM_CONTINUE(             0xe000, 0x2000 );
		ROM_REGION( 0x0020, REGION_PROMS );	ROM_LOAD( "pkwar.col",    0x0000, 0x0020, 0xaf0fc5e2 );ROM_END(); }}; 
