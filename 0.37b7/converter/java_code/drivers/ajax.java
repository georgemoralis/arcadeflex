...
public class ajax
{
	...
	//	PORT_DIPSETTING(    0x00, "Coin Slot 2 Invalidity" );
		...
		PORT_DIPSETTING(	0x18, "30000 150000" );	PORT_DIPSETTING(	0x10, "50000 200000" );	PORT_DIPSETTING(	0x08, "30000" );	PORT_DIPSETTING(	0x00, "50000" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		...
		PORT_DIPSETTING(	0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Upright Controls" );	PORT_DIPSETTING(    0x02, "Single" );	PORT_DIPSETTING(    0x00, "Dual" );	PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x08, 0x08, "Control in 3D Stages" );	PORT_DIPSETTING(	0x08, "Normal" );	PORT_DIPSETTING(	0x00, "Inverted" );	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	*/
	...
	static RomLoadPtr rom_ajax = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0200, REGION_PROMS );	ROM_LOAD( "63s241.j11",	0x0000, 0x0200, 0x9bdd719f );/* priority encoder (not used) */
		...
		ROM_LOAD( "770c11",		0x000000, 0x080000, 0x299a615a );ROM_END(); }}; 
