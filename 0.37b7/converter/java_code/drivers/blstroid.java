...
public class blstroid
{
	...
	PORT_START();       /* ff9800 */
		PORT_ANALOG( 0x00ff, 0, IPT_DIAL | IPF_PLAYER1, 60, 10, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();       /* ff9804 */
		PORT_ANALOG( 0x00ff, 0, IPT_DIAL | IPF_PLAYER2, 60, 10, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* ff9c00 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* ff9c02 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0xfff0, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	static RomLoadPtr rom_blstroid = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "057-4123",  0x00000, 0x10000, 0xd14badc4 );	ROM_LOAD_ODD ( "057-4121",  0x00000, 0x10000, 0xae3e93e8 );	ROM_LOAD_EVEN( "057-4124",  0x20000, 0x10000, 0xfd2365df );	ROM_LOAD_ODD ( "057-4122",  0x20000, 0x10000, 0xc364706e );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "blstroid.snd", 0x10000, 0x4000, 0xbaa8b5fe );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x040000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blstroid.1l",  0x000000, 0x10000, 0x3c2daa5b );/* playfield */
		...
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blstroid.5m",  0x000000, 0x10000, 0x50e0823f );/* mo */
	...
	static RomLoadPtr rom_blstroi2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "blstroid.6c",  0x00000, 0x10000, 0x5a092513 );	ROM_LOAD_ODD ( "blstroid.6b",  0x00000, 0x10000, 0x486aac51 );	ROM_LOAD_EVEN( "blstroid.4c",  0x20000, 0x10000, 0xd0fa38fe );	ROM_LOAD_ODD ( "blstroid.4b",  0x20000, 0x10000, 0x744bf921 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "blstroid.snd", 0x10000, 0x4000, 0xbaa8b5fe );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x040000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blstroid.1l",  0x000000, 0x10000, 0x3c2daa5b );/* playfield */
		ROM_LOAD( "blstroid.1m",  0x010000, 0x10000, 0xf84f0b97 );/* playfield */
	...
	static RomLoadPtr rom_blsthead = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "eheadh0.c6",  0x00000, 0x10000, 0x061f0898 );	ROM_LOAD_ODD ( "eheadl0.b6",  0x00000, 0x10000, 0xae8df7cb );	ROM_LOAD_EVEN( "eheadh1.c5",  0x20000, 0x10000, 0x0b7a3cb6 );	ROM_LOAD_ODD ( "eheadl1.b5",  0x20000, 0x10000, 0x43971694 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "blstroid.snd", 0x10000, 0x4000, 0xbaa8b5fe );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x040000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blstroid.1l",  0x000000, 0x10000, 0x3c2daa5b );/* playfield */
		ROM_LOAD( "blstroid.1m",  0x010000, 0x10000, 0xf84f0b97 );/* playfield */
