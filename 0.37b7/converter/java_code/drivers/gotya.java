...
public class gotya
{
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );	PORT_SERVICE( 0x10, IP_ACTIVE_LOW );	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1, "P1 Paper", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x40, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1, "P1 Scissors", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1, "P1 Rock", IP_KEY_DEFAULT, IP_JOY_DEFAULT );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_DIPNAME( 0x10, 0x10, "Sound Test" );	PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2, "P2 Paper", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x40, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2, "P2 Scissors", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x80, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2, "P2 Rock", IP_KEY_DEFAULT, IP_JOY_DEFAULT );
		PORT_START(); 	/* DSW1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Cocktail") );
		PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START2 );	PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x00, "Easy" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x20, "15000" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x40, "5" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Unknown") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gotya = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "gb-06.bin",	0x0000, 0x1000, 0x7793985a );	ROM_LOAD( "gb-05.bin",	0x1000, 0x1000, 0x683d188b );	ROM_LOAD( "gb-04.bin",	0x2000, 0x1000, 0x15b72f09 );	ROM_LOAD( "gb-03.bin",	0x3000, 0x1000, 0xf34d90ab );   /* this is the only ROM that passes the ROM test */
		...
		ROM_REGION( 0x0120,  REGION_PROMS );	ROM_LOAD( "prom.1a",    0x0000, 0x0020, 0x4864a5a0 );   /* color PROM */
		ROM_LOAD( "prom.4c",    0x0020, 0x0100, 0x4745b5f6 );   /* lookup table */
	
		ROM_REGION( 0x1000,  REGION_USER1 );	/* no idea what these are */
		ROM_LOAD( "gb-01.bin",	0x0000, 0x0800, 0xc31dba64 );	ROM_LOAD( "gb-02.bin",	0x0800, 0x0800, 0x65a7e284 );
		ROM_REGION( 0x4000,  REGION_USER2 );	/* HD38880 code? */
		ROM_LOAD( "gb-10.bin",	0x0000, 0x1000, 0x8101915f );	ROM_LOAD( "gb-09.bin",	0x1000, 0x1000, 0x619bba76 );	ROM_LOAD( "gb-08.bin",	0x2000, 0x1000, 0x82f59528 );	ROM_LOAD( "gb-07.bin",	0x3000, 0x1000, 0x92a9f8bf );ROM_END(); }}; 
