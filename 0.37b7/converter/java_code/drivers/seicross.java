...
public class seicross
{
	...
	PORT_START();       /* IN0 */
		...
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_SERVICE( 0x20, IP_ACTIVE_HIGH );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_DIPNAME( 0x80, 0x00, "Counter Check" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x80, DEF_STR( "On") );
	
		PORT_START();       /* Test */
		PORT_DIPNAME( 0x01, 0x00, "Test Mode" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x00, "Connection Error" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	PORT_START();       /* IN0 */
		...
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* Test */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0xfc, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* probably unused */
		...
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x06, "5" );	PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x08, DEF_STR( "On") );
		PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* DSW2 */
		PORT_DIPNAME( 0x07, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, "0" );	PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x05, "5" );	PORT_DIPSETTING(    0x06, "6" );	PORT_DIPSETTING(    0x07, "7" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Free_Play") );
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START2 );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* probably unused */
		PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_COCKTAIL );
		PORT_START();       /* Test */
		PORT_SERVICE( 0x01, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x02, 0x00, "Connection Error" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x02, DEF_STR( "On") );
		PORT_BIT( 0xfc, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* probably unused */
		...
		PORT_DIPSETTING(    0x00, "0" );	PORT_DIPSETTING(    0x04, "1" );	PORT_DIPSETTING(    0x08, "2" );	PORT_DIPSETTING(    0x0c, "3" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* DSW2 */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		...
		PORT_DIPSETTING(    0x08, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x0c, "5" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* DSW3 */
		...
		PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* Debug */
		PORT_BIT( 0x1f, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_DIPNAME( 0x20, 0x20, "Debug Mode" );	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_friskyt = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "ftom.01",      0x0000, 0x1000, 0xbce5d486 );	ROM_LOAD( "ftom.02",      0x1000, 0x1000, 0x63157d6e );	ROM_LOAD( "ftom.03",      0x2000, 0x1000, 0xc8d9ef2c );	ROM_LOAD( "ftom.04",      0x3000, 0x1000, 0x23a01aac );	ROM_LOAD( "ftom.05",      0x4000, 0x1000, 0xbfaf702a );	ROM_LOAD( "ftom.06",      0x5000, 0x1000, 0xbce70b9c );	ROM_LOAD( "ftom.07",      0x6000, 0x1000, 0xb2ef303a );	ROM_LOAD( "ft8_8.rom",    0x7000, 0x0800, 0x10461a24 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the protection mcu */
		/* filled in later */
	
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ftom.11",      0x0000, 0x1000, 0x1ec6ff65 );	ROM_LOAD( "ftom.12",      0x1000, 0x1000, 0x3b8f40b5 );	ROM_LOAD( "ftom.09",      0x2000, 0x1000, 0x60642f25 );	ROM_LOAD( "ftom.10",      0x3000, 0x1000, 0x07b9dcfc );
		ROM_REGION( 0x0040, REGION_PROMS );	ROM_LOAD( "ft.9c",        0x0000, 0x0020, 0x0032167e );	ROM_LOAD( "ft.9b",        0x0020, 0x0020, 0x6b364e69 );ROM_END(); }}; 
	
	static RomLoadPtr rom_radrad = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "1.3a",         0x0000, 0x1000, 0xb1e958ca );	ROM_LOAD( "2.3b",         0x1000, 0x1000, 0x30ba76b3 );	ROM_LOAD( "3.3c",         0x2000, 0x1000, 0x1c9f397b );	ROM_LOAD( "4.3d",         0x3000, 0x1000, 0x453966a3 );	ROM_LOAD( "5.3e",         0x4000, 0x1000, 0xc337c4bd );	ROM_LOAD( "6.3f",         0x5000, 0x1000, 0x06e15b59 );	ROM_LOAD( "7.3g",         0x6000, 0x1000, 0x02b1f9c9 );	ROM_LOAD( "8.3h",         0x7000, 0x0800, 0x911c90e8 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the protection mcu */
		/* filled in later */
	
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "11.l7",        0x0000, 0x1000, 0x4ace7afb );	ROM_LOAD( "12.n7",        0x1000, 0x1000, 0xb19b8473 );	ROM_LOAD( "9.j7",         0x2000, 0x1000, 0x229939a3 );	ROM_LOAD( "10.j7",        0x3000, 0x1000, 0x79237913 );
		ROM_REGION( 0x0040, REGION_PROMS );	ROM_LOAD( "clr.9c",       0x0000, 0x0020, 0xc9d88422 );	ROM_LOAD( "clr.9b",       0x0020, 0x0020, 0xee81af16 );ROM_END(); }}; 
	
	static RomLoadPtr rom_seicross = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "smc1",         0x0000, 0x1000, 0xf6c3aeca );	ROM_LOAD( "smc2",         0x1000, 0x1000, 0x0ec6c218 );	ROM_LOAD( "smc3",         0x2000, 0x1000, 0xceb3c8f4 );	ROM_LOAD( "smc4",         0x3000, 0x1000, 0x3112af59 );	ROM_LOAD( "smc5",         0x4000, 0x1000, 0xb494a993 );	ROM_LOAD( "smc6",         0x5000, 0x1000, 0x09d5b9da );	ROM_LOAD( "smc7",         0x6000, 0x1000, 0x13052b03 );	ROM_LOAD( "smc8",         0x7000, 0x0800, 0x2093461d );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the protection mcu */
		/* filled in later */
	
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sz11.7k",      0x0000, 0x1000, 0xfbd9b91d );	ROM_LOAD( "smcd",         0x1000, 0x1000, 0xc3c953c4 );	ROM_LOAD( "sz9.7j",       0x2000, 0x1000, 0x4819f0cd );	ROM_LOAD( "sz10.7h",      0x3000, 0x1000, 0x4c268778 );
		ROM_REGION( 0x0040, REGION_PROMS );	ROM_LOAD( "sz73.10c",     0x0000, 0x0020, 0x4d218a3c );	ROM_LOAD( "sz74.10b",     0x0020, 0x0020, 0xc550531c );ROM_END(); }}; 
	
	static RomLoadPtr rom_sectrzon = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "sz1.3a",       0x0000, 0x1000, 0xf0a45cb4 );	ROM_LOAD( "sz2.3c",       0x1000, 0x1000, 0xfea68ddb );	ROM_LOAD( "sz3.3d",       0x2000, 0x1000, 0xbaad4294 );	ROM_LOAD( "sz4.3e",       0x3000, 0x1000, 0x75f2ca75 );	ROM_LOAD( "sz5.3fg",      0x4000, 0x1000, 0xdc14f2c8 );	ROM_LOAD( "sz6.3h",       0x5000, 0x1000, 0x397a38c5 );	ROM_LOAD( "sz7.3i",       0x6000, 0x1000, 0x7b34dc1c );	ROM_LOAD( "sz8.3j",       0x7000, 0x0800, 0x9933526a );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the protection mcu */
		/* filled in later */
	
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sz11.7k",      0x0000, 0x1000, 0xfbd9b91d );	ROM_LOAD( "sz12.7m",      0x1000, 0x1000, 0x2bdef9ad );	ROM_LOAD( "sz9.7j",       0x2000, 0x1000, 0x4819f0cd );	ROM_LOAD( "sz10.7h",      0x3000, 0x1000, 0x4c268778 );
		ROM_REGION( 0x0040, REGION_PROMS );	ROM_LOAD( "sz73.10c",     0x0000, 0x0020, 0x4d218a3c );	ROM_LOAD( "sz74.10b",     0x0020, 0x0020, 0xc550531c );ROM_END(); }}; 
