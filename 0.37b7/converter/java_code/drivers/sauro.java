...
public class sauro
{
	...
	PORT_START();       /* IN0 */
		...
		PORT_START(); 
		PORT_SERVICE( 0x01, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Demo_Sounds") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_sauro = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sauro-4.bin",     0x00000, 0x8000, 0x9b617cda );	ROM_LOAD( "sauro-5.bin",     0x08000, 0x8000, 0xa6e2640d );
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sauro-6.bin",     0x00000, 0x8000, 0x4b77cb0f );	ROM_LOAD( "sauro-7.bin",     0x08000, 0x8000, 0x187da060 );
		ROM_REGION( 0x20000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sauro-8.bin",     0x00000, 0x8000, 0xe08b5d5e );	ROM_LOAD( "sauro-9.bin",     0x08000, 0x8000, 0x7c707195 );	ROM_LOAD( "sauro-10.bin",    0x10000, 0x8000, 0xc93380d1 );	ROM_LOAD( "sauro-11.bin",    0x18000, 0x8000, 0xf47982a8 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "82s137-3.bin",    0x0000, 0x0400, 0xd52c4cd0 ); /* Red component */
