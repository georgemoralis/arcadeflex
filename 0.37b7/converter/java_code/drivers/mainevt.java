...
public class mainevt
{
	...
	static MemoryReadAddress sound_readmem[] =
	{
		...
		new MemoryReadAddress( 0xd000, 0xd000, UPD7759_0_busy_r ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	...
	static MemoryWriteAddress sound_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x9000, 0x9000, UPD7759_0_message_w ),
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x18, 0x10, "Bonus Energy" );	PORT_DIPSETTING(    0x00, "60" );	PORT_DIPSETTING(    0x08, "70" );	PORT_DIPSETTING(    0x10, "80" );	PORT_DIPSETTING(    0x18, "90" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN1 */
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_DIPSETTING(    0x18, "150 and every 200" );	PORT_DIPSETTING(    0x10, "150 and every 250" );	PORT_DIPSETTING(    0x08, "150" );	PORT_DIPSETTING(    0x00, "200" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_mainevt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD( "799c02.k11",   0x10000, 0x08000, 0xe2e7dbd5 );	ROM_CONTINUE(             0x08000, 0x08000 );
		...
		ROM_LOAD( "799b04.h4",    0x00000, 0x80000, 0x323e0c2b );	ROM_LOAD( "799b05.k4",    0x80000, 0x80000, 0x571c5831 );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "63s141n.bin",  0x0000, 0x0100, 0x61f6c8d1 );/* priority encoder (not used) */
		...
		ROM_LOAD( "799b06.c22",   0x20000, 0x80000, 0x2c8c47d7 );ROM_END(); }}; 
	
	static RomLoadPtr rom_mainevt2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD( "02",           0x10000, 0x08000, 0xc143596b );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "799c01.f7",    0x00000, 0x08000, 0x447c4c5c );
		ROM_REGION( 0x20000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD_GFX_EVEN( "799c06.f22",   0x00000, 0x08000, 0xf839cb58 )
	...
	static RomLoadPtr rom_ringohja = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD( "799n02.k11",   0x10000, 0x08000, 0xf9305dd0 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "799c01.f7",    0x00000, 0x08000, 0x447c4c5c );
		ROM_REGION( 0x20000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD_GFX_EVEN( "799c06.f22",   0x00000, 0x08000, 0xf839cb58 )
	...
	static RomLoadPtr rom_devstors = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD( "890-z02.k11",  0x10000, 0x08000, 0xebeb306f );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		...
		ROM_REGION( 0x100000, REGION_GFX2 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "dev-f04.rom",  0x00000, 0x80000, 0xf16cd1fa );	ROM_LOAD( "dev-f05.rom",  0x80000, 0x80000, 0xda37db05 );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "devaprom.bin", 0x0000, 0x0100, 0xd3620106 );/* priority encoder (not used) */
	
		ROM_REGION( 0x80000, REGION_SOUND1 );/* 512k for 007232 samples */
	 	ROM_LOAD( "dev-f03.rom",  0x00000, 0x80000, 0x19065031 );ROM_END(); }}; 
	
	static RomLoadPtr rom_devstor2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD( "dev-x02.rom",  0x10000, 0x08000, 0xe58ebb35 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "dev-k01.rom",  0x00000, 0x08000, 0xd44b3eb0 );
		ROM_REGION( 0x40000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD_GFX_EVEN( "dev-f06.rom",  0x00000, 0x10000, 0x26592155 )
	...
	static RomLoadPtr rom_devstor3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD( "890k02.k11",   0x10000, 0x08000, 0x52f4ccdd );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "dev-k01.rom",  0x00000, 0x08000, 0xd44b3eb0 );
		ROM_REGION( 0x40000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD_GFX_EVEN( "dev-f06.rom",  0x00000, 0x10000, 0x26592155 )
	...
	static RomLoadPtr rom_garuka = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD( "890w02.bin",   0x10000, 0x08000, 0xb2f6f538 );	ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "dev-k01.rom",  0x00000, 0x08000, 0xd44b3eb0 );
		ROM_REGION( 0x40000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD_GFX_EVEN( "dev-f06.rom",  0x00000, 0x10000, 0x26592155 )
