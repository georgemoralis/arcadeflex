...
public class cchasm
{
	...
	PORT_START();  /* DSW */
		...
		PORT_DIPSETTING(    0x06, "40000" );	PORT_DIPSETTING(    0x04, "60000" );	PORT_DIPSETTING(    0x02, "80000" );	PORT_DIPSETTING(    0x00, "100000" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x00, "Easy" );	PORT_DIPSETTING(    0x08, "Hard" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "Once" );	PORT_DIPSETTING(    0x10, "Every" );	PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Demo_Sounds") );
		...
		PORT_START();  /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START2 );
		PORT_START();  /* IN3 */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BITX(0x01, IP_ACTIVE_LOW, 0, "Test 1", KEYCODE_F1, IP_JOY_NONE );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNUSED );/* Test 2, not used in cchasm */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cchasm = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x010000, REGION_CPU1 );    ROM_LOAD_EVEN( "chasm.u4",  0x000000, 0x001000, 0x19244f25 );    ROM_LOAD_ODD ( "chasm.u12", 0x000000, 0x001000, 0x5d702c7d );    ROM_LOAD_EVEN( "chasm.u8",  0x002000, 0x001000, 0x56a7ce8a );    ROM_LOAD_ODD ( "chasm.u16", 0x002000, 0x001000, 0x2e192db0 );    ROM_LOAD_EVEN( "chasm.u3",  0x004000, 0x001000, 0x9c71c600 );    ROM_LOAD_ODD ( "chasm.u11",  0x004000, 0x001000, 0xa4eb59a5 );    ROM_LOAD_EVEN( "chasm.u7",  0x006000, 0x001000, 0x8308dd6e );    ROM_LOAD_ODD ( "chasm.u15", 0x006000, 0x001000, 0x9d3abf97 );    ROM_LOAD_EVEN( "u2",        0x008000, 0x001000, 0x4e076ae7 );    ROM_LOAD_ODD ( "u10",       0x008000, 0x001000, 0xcc9e19ca );    ROM_LOAD_EVEN( "chasm.u6",  0x00a000, 0x001000, 0xa96525d2 );    ROM_LOAD_ODD ( "chasm.u14", 0x00a000, 0x001000, 0x8e426628 );    ROM_LOAD_EVEN( "u1",        0x00c000, 0x001000, 0x88b71027 );    ROM_LOAD_ODD ( "chasm.u9",  0x00c000, 0x001000, 0xd90c9773 );    ROM_LOAD_EVEN( "chasm.u5",  0x00e000, 0x001000, 0xe4a58b7d );    ROM_LOAD_ODD ( "chasm.u13", 0x00e000, 0x001000, 0x877e849c );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "2732.bin", 0x0000, 0x1000, 0x715adc4a );ROM_END(); }}; 
	
	static RomLoadPtr rom_cchasm1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x010000, REGION_CPU1 );    ROM_LOAD_EVEN( "chasm.u4",  0x000000, 0x001000, 0x19244f25 );    ROM_LOAD_ODD ( "chasm.u12", 0x000000, 0x001000, 0x5d702c7d );    ROM_LOAD_EVEN( "chasm.u8",  0x002000, 0x001000, 0x56a7ce8a );    ROM_LOAD_ODD ( "chasm.u16", 0x002000, 0x001000, 0x2e192db0 );    ROM_LOAD_EVEN( "chasm.u3",  0x004000, 0x001000, 0x9c71c600 );    ROM_LOAD_ODD ( "chasm.u11", 0x004000, 0x001000, 0xa4eb59a5 );    ROM_LOAD_EVEN( "chasm.u7",  0x006000, 0x001000, 0x8308dd6e );    ROM_LOAD_ODD ( "chasm.u15", 0x006000, 0x001000, 0x9d3abf97 );    ROM_LOAD_EVEN( "chasm.u2",  0x008000, 0x001000, 0x008b26ef );    ROM_LOAD_ODD ( "chasm.u10", 0x008000, 0x001000, 0xc2c532a3 );    ROM_LOAD_EVEN( "chasm.u6",  0x00a000, 0x001000, 0xa96525d2 );    ROM_LOAD_ODD ( "chasm.u14", 0x00a000, 0x001000, 0x8e426628 );    ROM_LOAD_EVEN( "chasm.u1",  0x00c000, 0x001000, 0xe02293f8 );    ROM_LOAD_ODD ( "chasm.u9",  0x00c000, 0x001000, 0xd90c9773 );    ROM_LOAD_EVEN( "chasm.u5",  0x00e000, 0x001000, 0xe4a58b7d );    ROM_LOAD_ODD ( "chasm.u13", 0x00e000, 0x001000, 0x877e849c );
