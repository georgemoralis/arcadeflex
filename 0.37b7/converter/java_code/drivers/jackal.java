...
public class jackal
{
	...
	{
		if ((intenable & 0x02) != 0) return nmi_interrupt();
	...
	PORT_START(); 	/* DSW1 */
		...
		PORT_DIPSETTING(    0x18, "30000 150000" );	PORT_DIPSETTING(    0x10, "50000 200000" );	PORT_DIPSETTING(    0x08, "30000" );	PORT_DIPSETTING(    0x00, "50000" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x00, "Sound Mode" );	PORT_DIPSETTING(    0x04, "Mono" );	PORT_DIPSETTING(    0x00, "Stereo" );	PORT_DIPNAME( 0x08, 0x00, "Sound Adj" );	PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		...
		PORT_ANALOGX( 0xff, 0x00, IPT_DIAL | IPF_PLAYER2, 25, 10, 0, 0, KEYCODE_N, KEYCODE_M, 0, 0 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_jackal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "j-v02.rom",    0x04000, 0x8000, 0x0b7e0584 );	ROM_CONTINUE(             0x14000, 0x8000 );	ROM_LOAD( "j-v03.rom",    0x0c000, 0x4000, 0x3e0dfb83 );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for 2nd cpu (Graphics & Sound)*/
		ROM_LOAD( "631t01.bin",   0x8000, 0x8000, 0xb189af6a );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "631t04.bin",   0x00000, 0x20000, 0x457f42f0 );	ROM_LOAD( "631t06.bin",   0x20000, 0x20000, 0x2d10e56e );	ROM_LOAD( "631t05.bin",   0x40000, 0x20000, 0x732b3fc1 );	ROM_LOAD( "631t07.bin",   0x60000, 0x20000, 0x4961c397 );
		ROM_REGION( 0x0200, REGION_PROMS );/* color lookup tables */
		ROM_LOAD( "631r08.bpr",   0x0000, 0x0100, 0x7553a172 );	ROM_LOAD( "631r09.bpr",   0x0100, 0x0100, 0xa74dd86c );ROM_END(); }}; 
	
	static RomLoadPtr rom_topgunr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1 );/* Banked 64k for 1st CPU */
		ROM_LOAD( "tgnr15d.bin",  0x04000, 0x8000, 0xf7e28426 );	ROM_CONTINUE(             0x14000, 0x8000 );	ROM_LOAD( "tgnr16d.bin",  0x0c000, 0x4000, 0xc086844e );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for 2nd cpu (Graphics & Sound)*/
		ROM_LOAD( "631t01.bin",   0x8000, 0x8000, 0xb189af6a );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tgnr7h.bin",   0x00000, 0x20000, 0x50122a12 );	ROM_LOAD( "tgnr12h.bin",  0x20000, 0x20000, 0x37dbbdb0 );	ROM_LOAD( "tgnr8h.bin",   0x40000, 0x20000, 0x6943b1a4 );	ROM_LOAD( "tgnr13h.bin",  0x60000, 0x20000, 0x22effcc8 );
		ROM_REGION( 0x0200, REGION_PROMS );/* color lookup tables */
		ROM_LOAD( "631r08.bpr",   0x0000, 0x0100, 0x7553a172 );	ROM_LOAD( "631r09.bpr",   0x0100, 0x0100, 0xa74dd86c );ROM_END(); }}; 
	
	static RomLoadPtr rom_jackalj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1 );/* Banked 64k for 1st CPU */
		ROM_LOAD( "631t02.bin",   0x04000, 0x8000, 0x14db6b1a );	ROM_CONTINUE(             0x14000, 0x8000 );	ROM_LOAD( "631t03.bin",   0x0c000, 0x4000, 0xfd5f9624 );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for 2nd cpu (Graphics & Sound)*/
		ROM_LOAD( "631t01.bin",   0x8000, 0x8000, 0xb189af6a );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "631t04.bin",   0x00000, 0x20000, 0x457f42f0 );	ROM_LOAD( "631t06.bin",   0x20000, 0x20000, 0x2d10e56e );	ROM_LOAD( "631t05.bin",   0x40000, 0x20000, 0x732b3fc1 );	ROM_LOAD( "631t07.bin",   0x60000, 0x20000, 0x4961c397 );
		ROM_REGION( 0x0200, REGION_PROMS );/* color lookup tables */
	...
	static RomLoadPtr rom_topgunbl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1 );/* Banked 64k for 1st CPU */
		ROM_LOAD( "t-3.c5",       0x04000, 0x8000, 0x7826ad38 );	ROM_LOAD( "t-4.c4",       0x14000, 0x8000, 0x976c8431 );	ROM_LOAD( "t-2.c6",       0x0c000, 0x4000, 0xd53172e5 );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for 2nd cpu (Graphics & Sound)*/
		ROM_LOAD( "t-1.c14",      0x8000, 0x8000, 0x54aa2d29 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "t-17.n12",     0x00000, 0x08000, 0xe8875110 );	ROM_LOAD( "t-18.n13",     0x08000, 0x08000, 0xcf14471d );	ROM_LOAD( "t-19.n14",     0x10000, 0x08000, 0x46ee5dd2 );	ROM_LOAD( "t-20.n15",     0x18000, 0x08000, 0x3f472344 );	ROM_LOAD( "t-13.n8",      0x20000, 0x08000, 0x5d669abb );	ROM_LOAD( "t-14.n9",      0x28000, 0x08000, 0xf349369b );	ROM_LOAD( "t-15.n10",     0x30000, 0x08000, 0x7c5a91dd );	ROM_LOAD( "t-16.n11",     0x38000, 0x08000, 0x5ec46d8e );	ROM_LOAD( "t-6.n1",       0x40000, 0x08000, 0x539cc48c );	ROM_LOAD( "t-5.m1",       0x48000, 0x08000, 0x2dd9a5e9 );	ROM_LOAD( "t-7.n2",       0x50000, 0x08000, 0x0ecd31b1 );	ROM_LOAD( "t-8.n3",       0x58000, 0x08000, 0xf946ada7 );	ROM_LOAD( "t-9.n4",       0x60000, 0x08000, 0x8269caca );	ROM_LOAD( "t-10.n5",      0x68000, 0x08000, 0x25393e4f );	ROM_LOAD( "t-11.n6",      0x70000, 0x08000, 0x7895c22d );	ROM_LOAD( "t-12.n7",      0x78000, 0x08000, 0x15606dfc );
		ROM_REGION( 0x0200, REGION_PROMS );/* color lookup tables */
		ROM_LOAD( "631r08.bpr",   0x0000, 0x0100, 0x7553a172 );	ROM_LOAD( "631r09.bpr",   0x0100, 0x0100, 0xa74dd86c );ROM_END(); }}; 
