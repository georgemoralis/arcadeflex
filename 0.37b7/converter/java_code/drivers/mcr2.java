...
public class mcr2
{
	...
	static RomLoadPtr rom_shollow = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sh-bg.00",     0x00000, 0x2000, 0x3e2b333c );	ROM_LOAD( "sh-bg.01",     0x02000, 0x2000, 0xd1d70cc4 );
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sh-fg.00",     0x00000, 0x2000, 0x33f4554e );	ROM_LOAD( "sh-fg.01",     0x02000, 0x2000, 0xba1a38b4 );	ROM_LOAD( "sh-fg.02",     0x04000, 0x2000, 0x6b57f6da );	ROM_LOAD( "sh-fg.03",     0x06000, 0x2000, 0x37ea9d07 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_tron = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "scpu_bgg.bin", 0x00000, 0x2000, 0x1a9ed2f5 );	ROM_LOAD( "scpu_bgh.bin", 0x02000, 0x2000, 0x3220f974 );
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "vg_3.bin",     0x00000, 0x2000, 0xbc036d1d );	ROM_LOAD( "vg_2.bin",     0x02000, 0x2000, 0x58ee14d3 );	ROM_LOAD( "vg_1.bin",     0x04000, 0x2000, 0x3329f9d4 );	ROM_LOAD( "vg_0.bin",     0x06000, 0x2000, 0x9743f873 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_kroozr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "kozmkcpu.3g",  0x00000, 0x2000, 0xeda6ed2d );	ROM_LOAD( "kozmkcpu.4g",  0x02000, 0x2000, 0xddde894b );
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "kozmkvid.1e",  0x00000, 0x2000, 0xca60e2cc );	ROM_LOAD( "kozmkvid.1d",  0x02000, 0x2000, 0x4e23b35b );	ROM_LOAD( "kozmkvid.1b",  0x04000, 0x2000, 0xc6041ba7 );	ROM_LOAD( "kozmkvid.1a",  0x06000, 0x2000, 0xb57fb0ff );ROM_END(); }}; 
	...
	static RomLoadPtr rom_domino = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dmanbg0.bin",  0x00000, 0x2000, 0x9163007f );	ROM_LOAD( "dmanbg1.bin",  0x02000, 0x2000, 0x28615c56 );
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dmanfg0.bin",  0x00000, 0x2000, 0x0b1f9f9e );	ROM_LOAD( "dmanfg1.bin",  0x02000, 0x2000, 0x16aa4b9b );	ROM_LOAD( "dmanfg2.bin",  0x04000, 0x2000, 0x4a8e76b8 );	ROM_LOAD( "dmanfg3.bin",  0x06000, 0x2000, 0x1f39257e );ROM_END(); }}; 
	...
	static RomLoadPtr rom_wacko = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "wackocpu.3g",  0x00000, 0x2000, 0x33160eb1 );	ROM_LOAD( "wackocpu.4g",  0x02000, 0x2000, 0xdaf37d7c );
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "wackovid.1e",  0x00000, 0x2000, 0xdca59be7 );	ROM_LOAD( "wackovid.1d",  0x02000, 0x2000, 0xa02f1672 );	ROM_LOAD( "wackovid.1b",  0x04000, 0x2000, 0x7d899790 );	ROM_LOAD( "wackovid.1a",  0x06000, 0x2000, 0x080be3ad );ROM_END(); }}; 
	...
	static RomLoadPtr rom_twotiger = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2tgrbg0.bin",  0x00000, 0x2000, 0x52f69068 );	ROM_LOAD( "2tgrbg1.bin",  0x02000, 0x2000, 0x758d4f7d );
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2tgrfg0.bin",  0x00000, 0x2000, 0x4abf3ca0 );	ROM_LOAD( "2tgrfg1.bin",  0x02000, 0x2000, 0xfbcaffa5 );	ROM_LOAD( "2tgrfg2.bin",  0x04000, 0x2000, 0x08e3e1a6 );	ROM_LOAD( "2tgrfg3.bin",  0x06000, 0x2000, 0x9b22697b );ROM_END(); }}; 
