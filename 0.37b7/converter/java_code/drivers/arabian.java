...
public class arabian
{
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_SERVICE( 0x04, IP_ACTIVE_HIGH );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* DSW1 */
		...
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* IN2 */
		...
		PORT_START();       /* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* IN4 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* IN5 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START();       /* DSW2 */
		PORT_DIPNAME( 0x01, 0x00, "Coin Chutes" );	PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x04, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x04, "20000" );	PORT_DIPSETTING(    0x08, "40000" );	PORT_DIPSETTING(    0x0c, "20000 50000 +100K" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Unused") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_arabian = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "ic1rev2.87",       0x0000, 0x2000, 0x5e1c98b8 );	ROM_LOAD( "ic2rev2.88",       0x2000, 0x2000, 0x092f587e );	ROM_LOAD( "ic3rev2.89",       0x4000, 0x2000, 0x15145f23 );	ROM_LOAD( "ic4rev2.90",       0x6000, 0x2000, 0x32b77b44 );
	...
	static RomLoadPtr rom_arabiana = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "ic1.87",       0x0000, 0x2000, 0x51e9a6b1 );	ROM_LOAD( "ic2.88",       0x2000, 0x2000, 0x1cdcc1ab );	ROM_LOAD( "ic3.89",       0x4000, 0x2000, 0xb7b7faa0 );	ROM_LOAD( "ic4.90",       0x6000, 0x2000, 0xdbded961 );
		ROM_REGION( 0x10000, REGION_GFX1 );/* graphics roms */
		ROM_LOAD( "ic84.91",      0x0000, 0x2000, 0xc4637822 );/* because of very rare way */
		ROM_LOAD( "ic85.92",      0x2000, 0x2000, 0xf7c6866d ); /* CRT controller uses these roms */
		ROM_LOAD( "ic86.93",      0x4000, 0x2000, 0x71acd48d ); /* there's no way, but to decode */
