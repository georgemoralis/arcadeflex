...
public class vendetta
{
	...
	***************************************************************************/
	...
	public static timer_callback z80_nmi_callback = new timer_callback() { public void handler(int param) 
	{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_vendetta = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "081u01", 0x10000, 0x38000, 0xb4d9ade5 );	ROM_CONTINUE(		0x08000, 0x08000 );
		...
		ROM_LOAD( "081a03", 0x000000, 0x100000, 0x14b6baea );ROM_END(); }}; 
	
	static RomLoadPtr rom_vendett2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x49000, REGION_CPU1 );/* code + banked roms + banked ram */
		ROM_LOAD( "081d01", 0x10000, 0x38000, 0x335da495 );	ROM_CONTINUE(		0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the sound CPU */
		ROM_LOAD( "081b02", 0x000000, 0x10000, 0x4c604d9b );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics ( don't dispose as the program can read them ) */
		ROM_LOAD( "081a09", 0x000000, 0x080000, 0xb4c777a9 );/* characters */
	...
	static RomLoadPtr rom_vendettj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x49000, REGION_CPU1 );/* code + banked roms + banked ram */
		ROM_LOAD( "081p01", 0x10000, 0x38000, 0x5fe30242 );	ROM_CONTINUE(		0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the sound CPU */
		ROM_LOAD( "081b02", 0x000000, 0x10000, 0x4c604d9b );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics ( don't dispose as the program can read them ) */
		ROM_LOAD( "081a09", 0x000000, 0x080000, 0xb4c777a9 );/* characters */
