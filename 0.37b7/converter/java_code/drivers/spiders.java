...
public class spiders
{
	...
	//	new MemoryReadAddress( 0x1c00, 0x1cff, MRA_RAM ),	// Data page
	//	new MemoryReadAddress( 0x4000, 0x5bff, MRA_RAM ),	// Video ram 1
	//	new MemoryReadAddress( 0x8000, 0x9bff, MRA_RAM ),	// Video ram 2
	//	new MemoryReadAddress( 0x7800, 0x7fff, MRA_RAM ),	// Stack space
		new MemoryReadAddress( 0xc001, 0xc001, crtc6845_register_r ),
		new MemoryReadAddress( 0xc044, 0xc047, pia_0_r ),
		new MemoryReadAddress( 0xc048, 0xc04b, pia_1_r ),
		new MemoryReadAddress( 0xc050, 0xc053, pia_2_r ),
		new MemoryReadAddress( 0xc060, 0xc060, input_port_2_r ),
		new MemoryReadAddress( 0xc080, 0xc080, input_port_3_r ),
		new MemoryReadAddress( 0xc0a0, 0xc0a0, input_port_4_r ),
		new MemoryReadAddress( 0xc100, 0xffff, MRA_ROM ),
		new MemoryReadAddress( -1 ) /* end of table */
	};
	
	static MemoryWriteAddress writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0xbfff, MWA_RAM ),
	//	new MemoryWriteAddress( 0x1c00, 0x1cff, MWA_RAM ),
	//	new MemoryWriteAddress( 0x4000, 0x5bff, MWA_RAM ),
	//	new MemoryWriteAddress( 0x8000, 0x9bff, MWA_RAM ),
	//	new MemoryWriteAddress( 0x7800, 0x7fff, MWA_RAM ),
		new MemoryWriteAddress( 0xc000, 0xc000, crtc6845_address_w ),
		new MemoryWriteAddress( 0xc001, 0xc001, crtc6845_register_w ),
		new MemoryWriteAddress( 0xc044, 0xc047, pia_0_w ),
		new MemoryWriteAddress( 0xc048, 0xc04b, pia_1_w ),
		new MemoryWriteAddress( 0xc050, 0xc053, pia_2_w ),
		new MemoryWriteAddress( 0xc100, 0xffff, MWA_ROM ),
    ...
    PORT_START();       /* IN0 */
	    PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );    PORT_BITX(0x02, 0x00, IP_ACTIVE_HIGH , "PS2 (Operator coin);, KEYCODE_4, IP_JOY_NONE )
	    PORT_BITX(0x04, 0x00, IP_ACTIVE_HIGH , "PS3 (Coin Counter);, KEYCODE_F1, IP_JOY_NONE )
	    PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_BUTTON1 );    PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_START1 );    PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_START2 );    PORT_BIT( 0x90, IP_ACTIVE_HIGH, IPT_UNUSED );
	    PORT_START();       /* IN1 */
	    PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_2WAY );    PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_2WAY );    PORT_BIT( 0xF3, IP_ACTIVE_HIGH, IPT_UNUSED );
	    PORT_START();   /* DSW1 */
...
//        )
	...
	static RomLoadPtr rom_spiders = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "sp-ic74",      0xc000, 0x1000, 0x6a2578f6 );	ROM_LOAD( "sp-ic73",      0xd000, 0x1000, 0xd69b2f21 );	ROM_LOAD( "sp-ic72",      0xe000, 0x1000, 0x464125da );	ROM_LOAD( "sp-ic71",      0xf000, 0x1000, 0xa9539b18 );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for the audio CPU */
		ROM_LOAD( "sp-ic3",       0xf800, 0x0800, 0x944d761e );
		ROM_REGION( 0x10000, REGION_GFX1 );    /* 64k graphics block used at runtime */
		ROM_LOAD( "sp-ic33",      0x0000, 0x1000, 0xb6731baa );	ROM_LOAD( "sp-ic25",      0x1000, 0x1000, 0xbaec64e7 );	ROM_LOAD( "sp-ic24",      0x2000, 0x1000, 0xa40a5517 );	ROM_LOAD( "sp-ic23",      0x3000, 0x1000, 0x3ca08053 );	ROM_LOAD( "sp-ic22",      0x4000, 0x1000, 0x07ea073c );	ROM_LOAD( "sp-ic21",      0x5000, 0x1000, 0x41b344b4 );	ROM_LOAD( "sp-ic20",      0x6000, 0x1000, 0x4d37da5a );ROM_END(); }}; 
	
	static RomLoadPtr rom_spiders2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "sp-ic74",      0xc000, 0x1000, 0x6a2578f6 );	ROM_LOAD( "sp2.bin",      0xd000, 0x1000, 0xcf71d12b );	ROM_LOAD( "sp-ic72",      0xe000, 0x1000, 0x464125da );	ROM_LOAD( "sp4.bin",      0xf000, 0x1000, 0xf3d126bb );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for the audio CPU */
		ROM_LOAD( "sp-ic3",       0xf800, 0x0800, 0x944d761e );
		ROM_REGION( 0x10000, REGION_GFX1 );    /* 64k graphics block used at runtime */
		ROM_LOAD( "sp-ic33",      0x0000, 0x1000, 0xb6731baa );	ROM_LOAD( "sp-ic25",      0x1000, 0x1000, 0xbaec64e7 );	ROM_LOAD( "sp-ic24",      0x2000, 0x1000, 0xa40a5517 );	ROM_LOAD( "sp-ic23",      0x3000, 0x1000, 0x3ca08053 );	ROM_LOAD( "sp-ic22",      0x4000, 0x1000, 0x07ea073c );	ROM_LOAD( "sp-ic21",      0x5000, 0x1000, 0x41b344b4 );	ROM_LOAD( "sp-ic20",      0x6000, 0x1000, 0x4d37da5a );ROM_END(); }}; 
