...
public class blktiger
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN2 );
		PORT_START(); 	/* IN1 */
		...
		PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPSETTING(    0x00, "7");	PORT_DIPNAME( 0x1c, 0x1c, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x1c, "1 (Easiest);
		PORT_DIPSETTING(    0x18, "2" );	PORT_DIPSETTING(    0x14, "3" );	PORT_DIPSETTING(    0x10, "4" );	PORT_DIPSETTING(    0x0c, "5 (Normal); )
		PORT_DIPSETTING(    0x08, "6" );	PORT_DIPSETTING(    0x04, "7" );	PORT_DIPSETTING(    0x00, "8 (Hardest); )
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_blktiger = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blktiger.2n",  0x00000, 0x08000, 0x70175d78 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blktiger.5b",  0x00000, 0x10000, 0xc4524993 );/* tiles */
		ROM_LOAD( "blktiger.4b",  0x10000, 0x10000, 0x7932c86f );	ROM_LOAD( "blktiger.9b",  0x20000, 0x10000, 0xdc49593a );	ROM_LOAD( "blktiger.8b",  0x30000, 0x10000, 0x7ed7a122 );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blktiger.5a",  0x00000, 0x10000, 0xe2f17438 );/* sprites */
		ROM_LOAD( "blktiger.4a",  0x10000, 0x10000, 0x5fccbd27 );	ROM_LOAD( "blktiger.9a",  0x20000, 0x10000, 0xfc33ccc6 );	ROM_LOAD( "blktiger.8a",  0x30000, 0x10000, 0xf449de01 );
		ROM_REGION( 0x0400, REGION_PROMS );/* PROMs (function unknown) */
		ROM_LOAD( "mb7114e.8j",   0x0000, 0x0100, 0x29b459e5 );	ROM_LOAD( "mb7114e.9j",   0x0100, 0x0100, 0x8b741e66 );	ROM_LOAD( "mb7114e.11k",  0x0200, 0x0100, 0x27201c75 );	ROM_LOAD( "mb7114e.11l",  0x0300, 0x0100, 0xe5490b68 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_blkdrgon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "blktiger.1l",  0x0000, 0x8000, 0x2cf54274 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blkdrgon.2n",  0x00000, 0x08000, 0x3821ab29 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blkdrgon.5b",  0x00000, 0x10000, 0x22d0a4b0 );/* tiles */
		ROM_LOAD( "blkdrgon.4b",  0x10000, 0x10000, 0xc8b5fc52 );	ROM_LOAD( "blkdrgon.9b",  0x20000, 0x10000, 0x9498c378 );	ROM_LOAD( "blkdrgon.8b",  0x30000, 0x10000, 0x5b0df8ce );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blktiger.5a",  0x00000, 0x10000, 0xe2f17438 );/* sprites */
		ROM_LOAD( "blktiger.4a",  0x10000, 0x10000, 0x5fccbd27 );	ROM_LOAD( "blktiger.9a",  0x20000, 0x10000, 0xfc33ccc6 );	ROM_LOAD( "blktiger.8a",  0x30000, 0x10000, 0xf449de01 );
		ROM_REGION( 0x0400, REGION_PROMS );/* PROMs (function unknown) */
		ROM_LOAD( "mb7114e.8j",   0x0000, 0x0100, 0x29b459e5 );	ROM_LOAD( "mb7114e.9j",   0x0100, 0x0100, 0x8b741e66 );	ROM_LOAD( "mb7114e.11k",  0x0200, 0x0100, 0x27201c75 );	ROM_LOAD( "mb7114e.11l",  0x0300, 0x0100, 0xe5490b68 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_blkdrgnb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "blktiger.1l",  0x0000, 0x8000, 0x2cf54274 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "j15-2n",       0x00000, 0x08000, 0x852ad2b7 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blkdrgon.5b",  0x00000, 0x10000, 0x22d0a4b0 );/* tiles */
		ROM_LOAD( "j11-4b",       0x10000, 0x10000, 0x053ab15c );	ROM_LOAD( "blkdrgon.9b",  0x20000, 0x10000, 0x9498c378 );	ROM_LOAD( "j13-8b",       0x30000, 0x10000, 0x663d5afa );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "blktiger.5a",  0x00000, 0x10000, 0xe2f17438 );/* sprites */
		ROM_LOAD( "blktiger.4a",  0x10000, 0x10000, 0x5fccbd27 );	ROM_LOAD( "blktiger.9a",  0x20000, 0x10000, 0xfc33ccc6 );	ROM_LOAD( "blktiger.8a",  0x30000, 0x10000, 0xf449de01 );
		ROM_REGION( 0x0400, REGION_PROMS );/* PROMs (function unknown) */
		ROM_LOAD( "mb7114e.8j",   0x0000, 0x0100, 0x29b459e5 );	ROM_LOAD( "mb7114e.9j",   0x0100, 0x0100, 0x8b741e66 );	ROM_LOAD( "mb7114e.11k",  0x0200, 0x0100, 0x27201c75 );	ROM_LOAD( "mb7114e.11l",  0x0300, 0x0100, 0xe5490b68 );ROM_END(); }}; 
