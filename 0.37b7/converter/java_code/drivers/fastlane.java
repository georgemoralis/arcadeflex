...
public class fastlane
{
	...
	static MemoryReadAddress fastlane_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x005f, MRA_RAM ),
		new MemoryReadAddress( 0x0800, 0x0800, input_port_2_r ), 	/* DIPSW #3 */
		new MemoryReadAddress( 0x0801, 0x0801, input_port_5_r ), 	/* 2P inputs */
		new MemoryReadAddress( 0x0802, 0x0802, input_port_4_r ), 	/* 1P inputs */
		new MemoryReadAddress( 0x0803, 0x0803, input_port_3_r ), 	/* COINSW */
		new MemoryReadAddress( 0x0900, 0x0900, input_port_0_r ), 	/* DIPSW #1 */
		new MemoryReadAddress( 0x0901, 0x0901, input_port_1_r ), 	/* DISPW #2 */
		new MemoryReadAddress( 0x0d00, 0x0d0d, fastlane_K007232_read_port_0_r ),/* 007232 registers (chip 1) */
		new MemoryReadAddress( 0x0e00, 0x0e0d, fastlane_K007232_read_port_1_r ),/* 007232 registers (chip 2) */
		new MemoryReadAddress( 0x0f00, 0x0f1f, K051733_r ),			/* 051733 (protection) */
		new MemoryReadAddress( 0x1000, 0x1fff, MRA_RAM ),			/* Palette RAM/Work RAM */
		new MemoryReadAddress( 0x2000, 0x3fff, MRA_RAM ),			/* Video RAM + Sprite RAM */
		new MemoryReadAddress( 0x4000, 0x7fff, MRA_BANK1 ),			/* banked ROM */
		new MemoryReadAddress( 0x8000, 0xffff, MRA_ROM ),			/* ROM */
		new MemoryReadAddress( -1 )	/* end of table */
	};
	
	static MemoryWriteAddress fastlane_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x005f, k007121_registers_w, fastlane_k007121_regs ),/* 007121 registers */
		new MemoryWriteAddress( 0x0b00, 0x0b00, watchdog_reset_w ),		/* watchdog reset */
		new MemoryWriteAddress( 0x0c00, 0x0c00, fastlane_bankswitch_w ),	/* bankswitch control */
		new MemoryWriteAddress( 0x0d00, 0x0d0d, fastlane_K007232_write_port_0_w ),	/* 007232 registers (chip 1) */
		new MemoryWriteAddress( 0x0e00, 0x0e0d, fastlane_K007232_write_port_1_w ),	/* 007232 registers (chip 2) */
		new MemoryWriteAddress( 0x0f00, 0x0f1f, K051733_w ),				/* 051733 (protection) */
		new MemoryWriteAddress( 0x1000, 0x17ff, paletteram_xBBBBBGGGGGRRRRR_swap_w, paletteram ),/* palette RAM */
		new MemoryWriteAddress( 0x1800, 0x1fff, MWA_RAM ),				/* Work RAM */
		new MemoryWriteAddress( 0x2000, 0x27ff, fastlane_vram1_w, fastlane_videoram1 ),
		new MemoryWriteAddress( 0x2800, 0x2fff, fastlane_vram2_w, fastlane_videoram2 ),
		new MemoryWriteAddress( 0x3000, 0x3fff, MWA_RAM, spriteram ),	/* Sprite RAM */
		new MemoryWriteAddress( 0x4000, 0xffff, MWA_ROM ),				/* ROM/banked ROM */
	...
	***************************************************************************/
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, gfxlayout, 0, 64 ),
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_fastlane = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "fl_m02.rom", 0x00000, 0x80000, 0xa126e82d ); /* tiles + sprites */
	
		ROM_REGION( 0x0400, REGION_PROMS );	ROM_LOAD( "prom1",      0x0000, 0x0100, 0x00000000 );	ROM_LOAD( "prom2",      0x0100, 0x0100, 0x00000000 );	ROM_LOAD( "prom3",      0x0200, 0x0100, 0x00000000 );	ROM_LOAD( "prom4",      0x0300, 0x0100, 0x00000000 );
