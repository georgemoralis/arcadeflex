...
public class rpunch
{
	...
	static MemoryReadAddress readmem[] =
	{
		...
		new MemoryReadAddress( 0x040000, 0x04ffff, MRA_BANK1 ),
		new MemoryReadAddress( 0x060000, 0x060fff, MRA_BANK2 ),
		new MemoryReadAddress( 0x080000, 0x083fff, MRA_BANK3 ),
		new MemoryReadAddress( 0x0c0018, 0x0c001b, common_port_r ),
		new MemoryReadAddress( 0x0c001c, 0x0c001d, input_port_3_r ),
		new MemoryReadAddress( 0x0c001e, 0x0c001f, sound_busy_r ),
		new MemoryReadAddress( 0x0a0000, 0x0a07ff, MRA_BANK4 ),
		new MemoryReadAddress( 0x0fc000, 0x0fffff, MRA_BANK5 ),
		new MemoryReadAddress( 0x100000, 0xffffff, mirror_r ),
	...
	static MemoryWriteAddress writemem[] =
	{
		...
		new MemoryWriteAddress( 0x040000, 0x04ffff, rpunch_bitmap_w, rpunch_bitmapram, rpunch_bitmapram_size ),
		new MemoryWriteAddress( 0x060000, 0x060fff, MWA_BANK2, spriteram, spriteram_size ),
		new MemoryWriteAddress( 0x080000, 0x083fff, rpunch_videoram_w, videoram, videoram_size ),
		new MemoryWriteAddress( 0x0a0000, 0x0a07ff, paletteram_xRRRRRGGGGGBBBBB_word_w, paletteram ),
		new MemoryWriteAddress( 0x0c0000, 0x0c0007, rpunch_scrollreg_w ),
		new MemoryWriteAddress( 0x0c0008, 0x0c0009, rpunch_crtc_data_w ),
		new MemoryWriteAddress( 0x0c000c, 0x0c000d, rpunch_videoreg_w ),
		new MemoryWriteAddress( 0x0c000e, 0x0c000f, sound_command_w ),
		new MemoryWriteAddress( 0x0c0010, 0x0c0013, rpunch_ins_w ),
		new MemoryWriteAddress( 0x0c0028, 0x0c0029, rpunch_crtc_register_w ),
		new MemoryWriteAddress( 0x0fc000, 0x0fffff, MWA_BANK5 ),
		new MemoryWriteAddress( 0x100000, 0xffffff, mirror_w ),
	...
	static MemoryReadAddress readmem_sound[] =
	{
		...
		new MemoryReadAddress( 0xf000, 0xf001, YM2151_status_port_0_r ),
		new MemoryReadAddress( 0xf200, 0xf200, sound_command_r ),
	...
	static MemoryWriteAddress writemem_sound[] =
	{
		...
		new MemoryWriteAddress( 0xf400, 0xf400, upd_control_w ),
		new MemoryWriteAddress( 0xf600, 0xf600, upd_data_w ),
	...
	PORT_START(); 	/* c0018 lower 8 bits */
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0xffc0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* c001a lower 8 bits */
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0xffc0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* c0018/c001a upper 8 bits */
		PORT_BIT( 0x00ff, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_SERVICE( 0x0200, IP_ACTIVE_HIGH );	PORT_BIT( 0x0400, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x1000, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x2000, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x4000, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x8000, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* c001c DIP switches */
		PORT_DIPNAME( 0x000f, 0x0000, DEF_STR( "Coin_A") );
		PORT_DIPSETTING(      0x000d, DEF_STR( "3C_1C") );
		PORT_DIPSETTING(      0x000c, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(      0x0005, "6 Coins/4 Credits");	PORT_DIPSETTING(      0x0000, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(      0x0003, "5 Coins/6 Credits" );	PORT_DIPSETTING(      0x0002, DEF_STR( "4C_5C") );
		...
		PORT_DIPSETTING(      0x0050, "6 Coins/4 Credits");	PORT_DIPSETTING(      0x0000, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(      0x0030, "5 Coins/6 Credits" );	PORT_DIPSETTING(      0x0020, DEF_STR( "4C_5C") );
		...
		PORT_DIPSETTING(      0x0200, "Easy" );	PORT_DIPSETTING(      0x0000, "Normal" );	PORT_DIPSETTING(      0x0100, "Hard" );	PORT_DIPSETTING(      0x0300, "Hardest" );	PORT_DIPNAME( 0x0400, 0x0400, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0000, "2" );	PORT_DIPSETTING(      0x0400, "3" );	PORT_DIPNAME( 0x0800, 0x0000, "Laser" );	PORT_DIPSETTING(      0x0000, "Manual" );	PORT_DIPSETTING(      0x0800, "Semi-Automatic" );	PORT_DIPNAME( 0x1000, 0x0000, "Extended Play" );	PORT_DIPSETTING(      0x0000, "500000 points" );	PORT_DIPSETTING(      0x1000, "None" );	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x2000, DEF_STR( "On") );
		PORT_DIPNAME( 0x4000, 0x0000, "Continues" );	PORT_DIPSETTING(      0x4000, DEF_STR( "Off") );
	...
	PORT_START(); 	/* c0018 lower 8 bits */
		...
		PORT_DIPSETTING(      0x0040, DEF_STR( "1C_6C") );
		PORT_DIPNAME( 0x0300, 0x0000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0200, "Easy" );	PORT_DIPSETTING(      0x0000, "Normal" );	PORT_DIPSETTING(      0x0100, "Hard" );	PORT_DIPSETTING(      0x0300, "Hardest" );	PORT_DIPNAME( 0x0400, 0x0000, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0400, "2" );	PORT_DIPSETTING(      0x0000, "3" );	PORT_DIPNAME( 0x0800, 0x0000, "Laser" );	PORT_DIPSETTING(      0x0800, "Manual" );	PORT_DIPSETTING(      0x0000, "Semi-Automatic" );	PORT_DIPNAME( 0x1000, 0x0000, "Extended Play" );	PORT_DIPSETTING(      0x0000, "500000 points" );	PORT_DIPSETTING(      0x1000, "300000 points" );	PORT_DIPNAME( 0x2000, 0x0000, DEF_STR( "Demo_Sounds") );
	...
	PORT_START(); 	/* c0018 lower 8 bits */
		...
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0xffc0, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* c0018/c001a upper 8 bits */
		PORT_BIT( 0x00ff, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0700, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x1000, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x2000, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x4000, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x8000, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* c001c DIP switches */
		PORT_DIPNAME( 0x000f, 0x0000, DEF_STR( "Coin_A") );
		PORT_DIPSETTING(      0x000d, DEF_STR( "3C_1C") );
		PORT_DIPSETTING(      0x000c, DEF_STR( "2C_1C") );
		...
		PORT_DIPSETTING(      0x00b0, DEF_STR( "1C_5C") );
		PORT_DIPSETTING(      0x0040, DEF_STR( "1C_6C") );
		PORT_DIPNAME( 0x0100, 0x0000, "Game Time");	PORT_DIPSETTING(      0x0100, "2 min/1 min" );	PORT_DIPSETTING(      0x0000, "3 min/1.5 min" );	PORT_DIPNAME( 0x0600, 0x0000, "2P Starting Score" );	PORT_DIPSETTING(      0x0600, "0-0" );	PORT_DIPSETTING(      0x0400, "5-5" );	PORT_DIPSETTING(      0x0000, "7-7" );	PORT_DIPSETTING(      0x0200, "9-9" );	PORT_DIPNAME( 0x1800, 0x0000, "1P Starting Score" );	PORT_DIPSETTING(      0x1000, "9-11" );	PORT_DIPSETTING(      0x1800, "10-10" );	PORT_DIPSETTING(      0x0800, "10-11" );	PORT_DIPSETTING(      0x0000, "11-11" );	PORT_SERVICE( 0x2000, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x4000, 0x0000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
	...
	(
		...
		new WriteYmHandlerPtr[] { ym2151_irq_gen }
	);
	...
	static RomLoadPtr rom_rpunch = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1 );	ROM_LOAD_EVEN( "rpunch.20", 0x00000, 0x08000, 0xa2028d59 );	ROM_LOAD_ODD ( "rpunch.21", 0x00000, 0x08000, 0x1cdb13d3 );	ROM_LOAD_EVEN( "rpunch.2",  0x10000, 0x08000, 0x9b9729bb );	ROM_LOAD_ODD ( "rpunch.3",  0x10000, 0x08000, 0x5704a688 );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "rpunch.92", 0x00000, 0x10000, 0x5e1870e3 );
		ROM_REGION( 0x60000, REGION_GFX1 );	ROM_LOAD( "rl_c13.bin", 0x00000, 0x40000, 0x7c8403b0 );	ROM_LOAD( "rl_c10.bin", 0x40000, 0x08000, 0x312eb260 );	ROM_LOAD( "rl_c12.bin", 0x48000, 0x08000, 0xbea85219 );
		ROM_REGION( 0x60000, REGION_GFX2 );	ROM_LOAD( "rl_a10.bin", 0x00000, 0x40000, 0xc2a77619 );	ROM_LOAD( "rl_a13.bin", 0x40000, 0x08000, 0xa39c2c16 );	ROM_LOAD( "rpunch.54",  0x48000, 0x08000, 0xe2969747 );
		ROM_REGION( 0x60000, REGION_GFX3 );	ROM_LOAD_GFX_EVEN( "rl_4g.bin", 0x00000, 0x20000, 0xc5cb4b7a )
		...
		ROM_REGION( 0x60000, REGION_SOUND1 );	ROM_LOAD( "rl_f18.bin", 0x20000, 0x20000, 0x47840673 );//	ROM_LOAD( "rpunch.91", 0x00000, 0x0f000, 0x7512cc59 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_rabiolep = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x20000, REGION_CPU1 );	ROM_LOAD_EVEN( "rl_e2.bin", 0x00000, 0x08000, 0x7d936a12 );	ROM_LOAD_ODD ( "rl_d2.bin", 0x00000, 0x08000, 0xd8d85429 );	ROM_LOAD_EVEN( "rl_e4.bin", 0x10000, 0x08000, 0x5bfaee12 );	ROM_LOAD_ODD ( "rl_d4.bin", 0x10000, 0x08000, 0xe64216bf );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "rl_f20.bin", 0x00000, 0x10000, 0xa6f50351 );
		ROM_REGION( 0x60000, REGION_GFX1 );	ROM_LOAD( "rl_c13.bin", 0x00000, 0x40000, 0x7c8403b0 );	ROM_LOAD( "rl_c10.bin", 0x40000, 0x08000, 0x312eb260 );	ROM_LOAD( "rl_c12.bin", 0x48000, 0x08000, 0xbea85219 );
		ROM_REGION( 0x60000, REGION_GFX2 );	ROM_LOAD( "rl_a10.bin", 0x00000, 0x40000, 0xc2a77619 );	ROM_LOAD( "rl_a13.bin", 0x40000, 0x08000, 0xa39c2c16 );	ROM_LOAD( "rl_a12.bin", 0x48000, 0x08000, 0x970b0e32 );
		ROM_REGION( 0x60000, REGION_GFX3 );	ROM_LOAD_GFX_EVEN( "rl_4g.bin", 0x00000, 0x20000, 0xc5cb4b7a )
		ROM_LOAD_GFX_ODD ( "rl_4h.bin", 0x00000, 0x20000, 0x8a4d3c99 )
		ROM_LOAD_GFX_EVEN( "rl_1g.bin", 0x40000, 0x08000, 0x74d41b2e )
		ROM_LOAD_GFX_ODD ( "rl_1h.bin", 0x40000, 0x08000, 0x7dcb32bb )
		...
		ROM_REGION( 0x60000, REGION_SOUND1 );	ROM_LOAD( "rl_f18.bin", 0x20000, 0x20000, 0x47840673 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_svolley = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "sps_13.bin", 0x00000, 0x10000, 0x2fbc5dcf );	ROM_LOAD_ODD ( "sps_11.bin", 0x00000, 0x10000, 0x51b025c9 );	ROM_LOAD_EVEN( "sps_14.bin", 0x20000, 0x08000, 0xe7630122 );	ROM_LOAD_ODD ( "sps_12.bin", 0x20000, 0x08000, 0xb6b24910 );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "sps_17.bin", 0x00000, 0x10000, 0x48b89688 );
		ROM_REGION( 0x60000, REGION_GFX1 );	ROM_LOAD( "sps_02.bin", 0x00000, 0x10000, 0x1a0abe75 );	ROM_LOAD( "sps_03.bin", 0x10000, 0x10000, 0x36279075 );	ROM_LOAD( "sps_04.bin", 0x20000, 0x10000, 0x7cede7d9 );	ROM_LOAD( "sps_01.bin", 0x30000, 0x08000, 0x6425e6d7 );	ROM_LOAD( "sps_10.bin", 0x40000, 0x08000, 0xa12b1589 );
		ROM_REGION( 0x60000, REGION_GFX2 );	ROM_LOAD( "sps_05.bin", 0x00000, 0x10000, 0xb0671d12 );	ROM_LOAD( "sps_06.bin", 0x10000, 0x10000, 0xc231957e );	ROM_LOAD( "sps_07.bin", 0x20000, 0x10000, 0x904b7709 );	ROM_LOAD( "sps_08.bin", 0x30000, 0x10000, 0x5430ffac );	ROM_LOAD( "sps_09.bin", 0x40000, 0x10000, 0x414a6278 );
		ROM_REGION( 0x60000, REGION_GFX3 );	ROM_LOAD_GFX_EVEN( "sps_20.bin", 0x00000, 0x10000, 0xc9e7206d )
		...
		ROM_REGION( 0x60000, REGION_SOUND1 );	ROM_LOAD( "sps_16.bin", 0x20000, 0x20000, 0x456d0f36 );	ROM_LOAD( "sps_15.bin", 0x40000, 0x10000, 0xf33f415f );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_svolleyk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "a14.bin", 0x00000, 0x10000, 0xdbab3bf9 );	ROM_LOAD_ODD ( "a11.bin", 0x00000, 0x10000, 0x92afd56f );	ROM_LOAD_EVEN( "a15.bin", 0x20000, 0x08000, 0xd8f89c4a );	ROM_LOAD_ODD ( "a12.bin", 0x20000, 0x08000, 0xde3dd5cb );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "sps_17.bin", 0x00000, 0x10000, 0x48b89688 );
		ROM_REGION( 0x60000, REGION_GFX1 );	ROM_LOAD( "sps_02.bin", 0x00000, 0x10000, 0x1a0abe75 );	ROM_LOAD( "sps_03.bin", 0x10000, 0x10000, 0x36279075 );	ROM_LOAD( "sps_04.bin", 0x20000, 0x10000, 0x7cede7d9 );	ROM_LOAD( "sps_01.bin", 0x30000, 0x08000, 0x6425e6d7 );	ROM_LOAD( "sps_10.bin", 0x40000, 0x08000, 0xa12b1589 );
	...
	static public static InitDriverPtr init_svolleyk = new InitDriverPtr() { public void handler() 
	{
		/* the main differences between Super Volleyball and Rabbit Punch are */
		/* the lack of direct-mapped bitmap, a smaller sprite range, and a */
		/* different palette base for sprites */
	...
	public static GameDriver driver_svolleyk	   = new GameDriver("1989"	,"svolleyk"	,"rpunch.java"	,rom_svolleyk,driver_svolley	,machine_driver_rpunch	,input_ports_svolley	,init_svolleyk	,ROT0	,	"V-System Co.", "Super Volleyball (Korea)" )
}
