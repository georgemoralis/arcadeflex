...
public class rollerg
{
	...
	***************************************************************************/
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START2 );
		PORT_START(); 
	...
	//	PORT_DIPSETTING(    0x00, "Disabled" );
		...
		PORT_DIPNAME( 0x18, 0x10, "Bonus Energy" );	PORT_DIPSETTING(    0x00, "1/2 for Stage Winner" );	PORT_DIPSETTING(    0x08, "1/4 for Stage Winner" );	PORT_DIPSETTING(    0x10, "1/4 for Cycle Winner" );	PORT_DIPSETTING(    0x18, "None" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN3 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rollerg = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "999m02.g7",  0x10000, 0x18000, 0x3df8db93 );	ROM_CONTINUE(           0x08000, 0x08000 );
		...
		ROM_LOAD( "999h09.c5",  0x000000, 0x080000, 0xc5188783 );ROM_END(); }}; 
	
	static RomLoadPtr rom_rollergj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x28000, REGION_CPU1 );/* code + banked roms */
		ROM_LOAD( "999v02.bin", 0x10000, 0x18000, 0x0dd8c3ac );	ROM_CONTINUE(           0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the sound CPU */
		ROM_LOAD( "999m01.e11", 0x0000, 0x8000, 0x1fcfb22f );
		ROM_REGION( 0x200000, REGION_GFX1 );/* graphics ( don't dispose as the program can read them ) */
		ROM_LOAD( "999h06.k2",  0x000000, 0x100000, 0xeda05130 );/* sprites */
