...
public class snk
{
	...
	*/
	...
	static RomLoadPtr rom_tnk3 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "tnk3-p1.bin",  0x0000, 0x4000, 0x0d2a8ca9 );	ROM_LOAD( "tnk3-p2.bin",  0x4000, 0x4000, 0x0ae0a483 );	ROM_LOAD( "tnk3-p3.bin",  0x8000, 0x4000, 0xd16dd4db );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for cpuB code */
		ROM_LOAD( "tnk3-p4.bin",  0x0000, 0x4000, 0x01b45a90 );	ROM_LOAD( "tnk3-p5.bin",  0x4000, 0x4000, 0x60db6667 );	ROM_LOAD( "tnk3-p6.bin",  0x8000, 0x4000, 0x4761fde7 );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for sound code */
		ROM_LOAD( "tnk3-p10.bin",  0x0000, 0x4000, 0x7bf0a517 );	ROM_LOAD( "tnk3-p11.bin",  0x4000, 0x4000, 0x0569ce27 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "7122.2",  0x000, 0x400, 0x34c06bc6 );	ROM_LOAD( "7122.1",  0x400, 0x400, 0x6d0ac66a );	ROM_LOAD( "7122.0",  0x800, 0x400, 0x4662b4c8 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "tnk3-p14.bin", 0x0000, 0x2000, 0x1fd18c43 );	ROM_RELOAD(               0x2000, 0x2000 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* background tiles */
		ROM_LOAD( "tnk3-p12.bin", 0x0000, 0x4000, 0xff495a16 );	ROM_LOAD( "tnk3-p13.bin", 0x4000, 0x4000, 0xf8344843 );
		ROM_REGION( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "tnk3-p7.bin", 0x00000, 0x4000, 0x06b92c88 );	ROM_LOAD( "tnk3-p8.bin", 0x08000, 0x4000, 0x63d0e2eb );	ROM_LOAD( "tnk3-p9.bin", 0x10000, 0x4000, 0x872e3fac );ROM_END(); }}; 
	
	static RomLoadPtr rom_tnk3j = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for cpuA code */
		ROM_LOAD( "p1.4e",  0x0000, 0x4000, 0x03aca147 );	ROM_LOAD( "tnk3-p2.bin",  0x4000, 0x4000, 0x0ae0a483 );	ROM_LOAD( "tnk3-p3.bin",  0x8000, 0x4000, 0xd16dd4db );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for cpuB code */
		ROM_LOAD( "tnk3-p4.bin",  0x0000, 0x4000, 0x01b45a90 );	ROM_LOAD( "tnk3-p5.bin",  0x4000, 0x4000, 0x60db6667 );	ROM_LOAD( "tnk3-p6.bin",  0x8000, 0x4000, 0x4761fde7 );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for sound code */
		ROM_LOAD( "tnk3-p10.bin",  0x0000, 0x4000, 0x7bf0a517 );	ROM_LOAD( "tnk3-p11.bin",  0x4000, 0x4000, 0x0569ce27 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "7122.2",  0x000, 0x400, 0x34c06bc6 );	ROM_LOAD( "7122.1",  0x400, 0x400, 0x6d0ac66a );	ROM_LOAD( "7122.0",  0x800, 0x400, 0x4662b4c8 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "p14.1e", 0x0000, 0x2000, 0x6bd575ca );	ROM_RELOAD(         0x2000, 0x2000 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* background tiles */
		ROM_LOAD( "tnk3-p12.bin", 0x0000, 0x4000, 0xff495a16 );	ROM_LOAD( "tnk3-p13.bin", 0x4000, 0x4000, 0xf8344843 );
		ROM_REGION( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "tnk3-p7.bin", 0x00000, 0x4000, 0x06b92c88 );	ROM_LOAD( "tnk3-p8.bin", 0x08000, 0x4000, 0x63d0e2eb );	ROM_LOAD( "tnk3-p9.bin", 0x10000, 0x4000, 0x872e3fac );ROM_END(); }}; 
	...
	static RomLoadPtr rom_athena = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for cpuA code */
		ROM_LOAD( "up02_p4.rom",  0x0000, 0x4000,  0x900a113c );	ROM_LOAD( "up02_m4.rom",  0x4000, 0x8000,  0x61c69474 );
		ROM_REGION(  0x10000 , REGION_CPU2 );/* 64k for cpuB code */
		ROM_LOAD( "up02_p8.rom",  0x0000, 0x4000, 0xdf50af7e );	ROM_LOAD( "up02_m8.rom",  0x4000, 0x8000, 0xf3c933df );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for sound code */
		ROM_LOAD( "up02_g6.rom",  0x0000, 0x4000, 0x42dbe029 );	ROM_LOAD( "up02_k6.rom",  0x4000, 0x8000, 0x596f1c8a );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "up02_c2.rom",  0x000, 0x400, 0x294279ae );	ROM_LOAD( "up02_b1.rom",  0x400, 0x400, 0xd25c9099 );	ROM_LOAD( "up02_c1.rom",  0x800, 0x400, 0xa4a4e7dc );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "up01_d2.rom",  0x0000, 0x4000,  0x18b4bcca );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* background tiles */
		ROM_LOAD( "up01_b2.rom",  0x0000, 0x8000,  0xf269c0eb );
		ROM_REGION( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "up01_p2.rom",  0x00000, 0x8000, 0xc63a871f );	ROM_LOAD( "up01_s2.rom",  0x08000, 0x8000, 0x760568d8 );	ROM_LOAD( "up01_t2.rom",  0x10000, 0x8000, 0x57b35c73 );ROM_END(); }}; 
	
	/***********************************************************************/
	
	static RomLoadPtr rom_fitegolf = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for cpuA code */
		ROM_LOAD( "gu2",    0x0000, 0x4000, 0x19be7ad6 );	ROM_LOAD( "gu1",    0x4000, 0x8000, 0xbc32568f );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for cpuB code */
		ROM_LOAD( "gu6",    0x0000, 0x4000, 0x2b9978c5 );	ROM_LOAD( "gu5",    0x4000, 0x8000, 0xea3d138c );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for sound code */
		ROM_LOAD( "gu3",    0x0000, 0x4000, 0x811b87d7 );	ROM_LOAD( "gu4",    0x4000, 0x8000, 0x2d998e2b );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "82s137.2c",  0x00000, 0x00400, 0x6e4c7836 );	ROM_LOAD( "82s137.1b",  0x00400, 0x00400, 0x29e7986f );	ROM_LOAD( "82s137.1c",  0x00800, 0x00400, 0x27ba9ff9 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		...
		ROM_LOAD( "gu9",   0x00000, 0x8000, 0xd4957ec5 );	ROM_LOAD( "gu10",  0x08000, 0x8000, 0xb3acdac2 );	ROM_LOAD( "gu11",  0x10000, 0x8000, 0xb99cf73b );ROM_END(); }}; 
	...
	static RomLoadPtr rom_ikari = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "7122er.prm",  0x000, 0x400, 0xb9bf2c2c );	ROM_LOAD( "7122eg.prm",  0x400, 0x400, 0x0703a770 );	ROM_LOAD( "7122eb.prm",  0x800, 0x400, 0x0a11cdde );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "7.rom",    0x00000, 0x4000, 0xa7eb4917 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "17.rom", 0x00000, 0x8000, 0xe0dba976 );	ROM_LOAD( "18.rom", 0x08000, 0x8000, 0x24947d5f );	ROM_LOAD( "19.rom", 0x10000, 0x8000, 0x9ee59e91 );	ROM_LOAD( "20.rom", 0x18000, 0x8000, 0x5da7ec1a );
		ROM_REGION( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "8.rom",  0x00000, 0x8000, 0x9827c14a );	ROM_LOAD( "9.rom",  0x08000, 0x8000, 0x545c790c );	ROM_LOAD( "10.rom", 0x10000, 0x8000, 0xec9ba07e );
		ROM_REGION( 0x30000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "11.rom", 0x00000, 0x8000, 0x5c75ea8f );	ROM_LOAD( "14.rom", 0x08000, 0x8000, 0x3293fde4 );	ROM_LOAD( "12.rom", 0x10000, 0x8000, 0x95138498 );	ROM_LOAD( "15.rom", 0x18000, 0x8000, 0x65a61c99 );	ROM_LOAD( "13.rom", 0x20000, 0x8000, 0x315383d7 );	ROM_LOAD( "16.rom", 0x28000, 0x8000, 0xe9b03e07 );ROM_END(); }}; 
	
	static RomLoadPtr rom_ikarijp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for cpuA code */
		ROM_LOAD( "up03_l4.rom",  0x0000, 0x4000, 0xcde006be );	ROM_LOAD( "up03_k4.rom",  0x4000, 0x8000, 0x26948850 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for cpuB code */
		ROM_LOAD( "ik3",  0x0000, 0x4000, 0x9bb385f8 );	ROM_LOAD( "ik4",  0x4000, 0x8000, 0x3a144bca );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for sound code */
		ROM_LOAD( "ik5",  0x0000, 0x4000, 0x863448fa );	ROM_LOAD( "ik6",  0x4000, 0x8000, 0x9b16aa57 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "7122er.prm",  0x000, 0x400, 0xb9bf2c2c );	ROM_LOAD( "7122eg.prm",  0x400, 0x400, 0x0703a770 );	ROM_LOAD( "7122eb.prm",  0x800, 0x400, 0x0a11cdde );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "ik7",    0x00000, 0x4000, 0x9e88f536 );/* characters */
	
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "17.rom", 0x00000, 0x8000, 0xe0dba976 );	ROM_LOAD( "18.rom", 0x08000, 0x8000, 0x24947d5f );	ROM_LOAD( "ik19", 0x10000, 0x8000, 0x566242ec );	ROM_LOAD( "20.rom", 0x18000, 0x8000, 0x5da7ec1a );
		ROM_REGION( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "ik8",  0x00000, 0x8000, 0x75d796d0 );	ROM_LOAD( "ik9",  0x08000, 0x8000, 0x2c34903b );	ROM_LOAD( "ik10", 0x10000, 0x8000, 0xda9ccc94 );
		ROM_REGION( 0x30000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "11.rom", 0x00000, 0x8000, 0x5c75ea8f );	ROM_LOAD( "14.rom", 0x08000, 0x8000, 0x3293fde4 );	ROM_LOAD( "12.rom", 0x10000, 0x8000, 0x95138498 );	ROM_LOAD( "15.rom", 0x18000, 0x8000, 0x65a61c99 );	ROM_LOAD( "13.rom", 0x20000, 0x8000, 0x315383d7 );	ROM_LOAD( "16.rom", 0x28000, 0x8000, 0xe9b03e07 );ROM_END(); }}; 
	
	static RomLoadPtr rom_ikarijpb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* CPU A */
		ROM_LOAD( "ik1",	  0x00000, 0x4000, 0x2ef87dce );	ROM_LOAD( "up03_k4.rom",  0x04000, 0x8000, 0x26948850 );
	...
	static RomLoadPtr rom_victroad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "mb7122e.1k", 0x000, 0x400, 0x491ab831 );	ROM_LOAD( "mb7122e.2l", 0x400, 0x400, 0x8feca424 );	ROM_LOAD( "mb7122e.1l", 0x800, 0x400, 0x220076ca );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "p7",  0x0000, 0x4000,  0x2b6ed95b );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "p17",  0x00000, 0x8000, 0x19d4518c );	ROM_LOAD( "p18",  0x08000, 0x8000, 0xd818be43 );	ROM_LOAD( "p19",  0x10000, 0x8000, 0xd64e0f89 );	ROM_LOAD( "p20",  0x18000, 0x8000, 0xedba0f31 );
		ROM_REGION( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "p8",  0x00000, 0x8000, 0xdf7f252a );	ROM_LOAD( "p9",  0x08000, 0x8000, 0x9897bc05 );	ROM_LOAD( "p10", 0x10000, 0x8000, 0xecd3c0ea );
		ROM_REGION( 0x40000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "p11", 0x00000, 0x8000, 0x668b25a4 );	ROM_LOAD( "p14", 0x08000, 0x8000, 0xa7031d4a );	ROM_LOAD( "p12", 0x10000, 0x8000, 0xf44e95fa );	ROM_LOAD( "p15", 0x18000, 0x8000, 0x120d2450 );	ROM_LOAD( "p13", 0x20000, 0x8000, 0x980ca3d8 );	ROM_LOAD( "p16", 0x28000, 0x8000, 0x9f820e8a );
		ROM_REGION( 0x20000, REGION_SOUND1 );	ROM_LOAD( "p4",  0x00000, 0x10000, 0xe10fb8cc );	ROM_LOAD( "p5",  0x10000, 0x10000, 0x93e5f110 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_dogosoke = new RomLoadPtr(){ public void handler(){  /* Victory Road Japan */
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "up03_k1.rom",  0x000, 0x400, 0x10a2ce2b );	ROM_LOAD( "up03_l2.rom",  0x400, 0x400, 0x99dc9792 );	ROM_LOAD( "up03_l1.rom",  0x800, 0x400, 0xe7213160 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "up02_b3.rom",  0x0000, 0x4000,  0x51a4ec83 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "p17",  0x00000, 0x8000, 0x19d4518c );	ROM_LOAD( "p18",  0x08000, 0x8000, 0xd818be43 );	ROM_LOAD( "p19",  0x10000, 0x8000, 0xd64e0f89 );	ROM_LOAD( "p20",  0x18000, 0x8000, 0xedba0f31 );
		ROM_REGION( 0x18000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "up02_d3.rom",  0x00000, 0x8000, 0xd43044f8 );	ROM_LOAD( "up02_e3.rom",  0x08000, 0x8000, 0x365ed2d8 );	ROM_LOAD( "up02_g3.rom",  0x10000, 0x8000, 0x92579bf3 );
		ROM_REGION( 0x30000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "p11", 0x00000, 0x8000, 0x668b25a4 );	ROM_LOAD( "p14", 0x08000, 0x8000, 0xa7031d4a );	ROM_LOAD( "p12", 0x10000, 0x8000, 0xf44e95fa );	ROM_LOAD( "p15", 0x18000, 0x8000, 0x120d2450 );	ROM_LOAD( "p13", 0x20000, 0x8000, 0x980ca3d8 );	ROM_LOAD( "p16", 0x28000, 0x8000, 0x9f820e8a );
		ROM_REGION( 0x20000, REGION_SOUND1 );	ROM_LOAD( "up03_f5.rom", 0x00000, 0x10000, 0x5b43fe9f );	ROM_LOAD( "up03_g5.rom", 0x10000, 0x10000, 0xaae30cd6 );ROM_END(); }}; 
	
	/***********************************************************************/
	
	static RomLoadPtr rom_gwar = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "7g",  0x00000, 0x10000, 0x5bcfa7dc );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "g02",  0x00000, 0x10000, 0x86d931bf );
		ROM_REGION( 0x10000, REGION_CPU3 );	ROM_LOAD( "g03",  0x00000, 0x10000, 0xeb544ab9 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */
		ROM_LOAD( "guprom.2", 0x400, 0x400, 0x9147de69 );/* green */
		ROM_LOAD( "guprom.1", 0x800, 0x400, 0x7f9c839e );/* blue */
	
		ROM_REGION( 0x8000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g05",  0x0000, 0x08000, 0x80f73e2e );
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g06",  0x00000, 0x10000, 0xf1dcdaef );	ROM_LOAD( "g07",  0x10000, 0x10000, 0x326e4e5e );	ROM_LOAD( "g08",  0x20000, 0x10000, 0x0aa70967 );	ROM_LOAD( "g09",  0x30000, 0x10000, 0xb7686336 );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g10",  0x00000, 0x10000, 0x58600f7d );	ROM_LOAD( "g11",  0x10000, 0x10000, 0xa3f9b463 );	ROM_LOAD( "g12",  0x20000, 0x10000, 0x092501be );	ROM_LOAD( "g13",  0x30000, 0x10000, 0x25801ea6 );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g20",  0x00000, 0x10000, 0x2b46edff );	ROM_LOAD( "g21",  0x10000, 0x10000, 0xbe19888d );	ROM_LOAD( "g18",  0x20000, 0x10000, 0x2d653f0c );	ROM_LOAD( "g19",  0x30000, 0x10000, 0xebbf3ba2 );	ROM_LOAD( "g16",  0x40000, 0x10000, 0xaeb3707f );	ROM_LOAD( "g17",  0x50000, 0x10000, 0x0808f95f );	ROM_LOAD( "g14",  0x60000, 0x10000, 0x8dfc7b87 );	ROM_LOAD( "g15",  0x70000, 0x10000, 0x06822aac );
		ROM_REGION( 0x10000, REGION_SOUND1 );	ROM_LOAD( "g04",  0x00000, 0x10000, 0x2255f8dd );ROM_END(); }}; 
	
	static RomLoadPtr rom_gwara = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "gv3",  0x00000, 0x10000, 0x24936d83 );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "gv4",  0x00000, 0x10000, 0x26335a55 );
		ROM_REGION( 0x10000, REGION_CPU3 );	ROM_LOAD( "gv2",  0x00000, 0x10000, 0x896682dd );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */
		ROM_LOAD( "guprom.2", 0x400, 0x400, 0x9147de69 );/* green */
		ROM_LOAD( "guprom.1", 0x800, 0x400, 0x7f9c839e );/* blue */
	...
	static RomLoadPtr rom_gwarj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "7y3047",  0x00000, 0x10000, 0x7f8a880c );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "g02",  0x00000, 0x10000, 0x86d931bf );
		ROM_REGION( 0x10000, REGION_CPU3 );	ROM_LOAD( "g03",  0x00000, 0x10000, 0xeb544ab9 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */
		ROM_LOAD( "guprom.2", 0x400, 0x400, 0x9147de69 );/* green */
		...
		ROM_REGION( 0x8000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "792001",  0x0000, 0x08000, 0x99d7ddf3 );
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g06",  0x00000, 0x10000, 0xf1dcdaef );	ROM_LOAD( "g07",  0x10000, 0x10000, 0x326e4e5e );	ROM_LOAD( "g08",  0x20000, 0x10000, 0x0aa70967 );	ROM_LOAD( "g09",  0x30000, 0x10000, 0xb7686336 );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g10",  0x00000, 0x10000, 0x58600f7d );	ROM_LOAD( "g11",  0x10000, 0x10000, 0xa3f9b463 );	ROM_LOAD( "g12",  0x20000, 0x10000, 0x092501be );	ROM_LOAD( "g13",  0x30000, 0x10000, 0x25801ea6 );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g20",  0x00000, 0x10000, 0x2b46edff );	ROM_LOAD( "g21",  0x10000, 0x10000, 0xbe19888d );	ROM_LOAD( "g18",  0x20000, 0x10000, 0x2d653f0c );	ROM_LOAD( "g19",  0x30000, 0x10000, 0xebbf3ba2 );	ROM_LOAD( "g16",  0x40000, 0x10000, 0xaeb3707f );	ROM_LOAD( "g17",  0x50000, 0x10000, 0x0808f95f );	ROM_LOAD( "g14",  0x60000, 0x10000, 0x8dfc7b87 );	ROM_LOAD( "g15",  0x70000, 0x10000, 0x06822aac );
		ROM_REGION( 0x10000, REGION_SOUND1 );	ROM_LOAD( "g04",  0x00000, 0x10000, 0x2255f8dd );ROM_END(); }}; 
	...
	static RomLoadPtr rom_gwarb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "guprom.3", 0x000, 0x400, 0x090236a3 );/* red */ // up03_k1.rom
		...
		ROM_LOAD( "g06",  0x00000, 0x10000, 0xf1dcdaef );	ROM_LOAD( "g07",  0x10000, 0x10000, 0x326e4e5e );	ROM_LOAD( "g08",  0x20000, 0x10000, 0x0aa70967 );	ROM_LOAD( "g09",  0x30000, 0x10000, 0xb7686336 );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "g10",  0x00000, 0x10000, 0x58600f7d );	ROM_LOAD( "g11",  0x10000, 0x10000, 0xa3f9b463 );	ROM_LOAD( "g12",  0x20000, 0x10000, 0x092501be );	ROM_LOAD( "g13",  0x30000, 0x10000, 0x25801ea6 );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "g20",  0x00000, 0x10000, 0x2b46edff );	ROM_LOAD( "g21",  0x10000, 0x10000, 0xbe19888d );	ROM_LOAD( "g18",  0x20000, 0x10000, 0x2d653f0c );	ROM_LOAD( "g19",  0x30000, 0x10000, 0xebbf3ba2 );	ROM_LOAD( "g16",  0x40000, 0x10000, 0xaeb3707f );	ROM_LOAD( "g17",  0x50000, 0x10000, 0x0808f95f );	ROM_LOAD( "g14",  0x60000, 0x10000, 0x8dfc7b87 );	ROM_LOAD( "g15",  0x70000, 0x10000, 0x06822aac );
		ROM_REGION( 0x10000, REGION_SOUND1 );	ROM_LOAD( "g04",  0x00000, 0x10000, 0x2255f8dd );ROM_END(); }}; 
	...
	static RomLoadPtr rom_bermudat = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS );	ROM_LOAD( "btj_01r.prm", 0x0000, 0x0400, 0xf4b54d06 );/* red */
		...
		ROM_LOAD( "bt_p22.rom", 0x00000, 0x10000, 0x8daf7df4 );	ROM_LOAD( "bt_p21.rom", 0x10000, 0x10000, 0xb7689599 );	ROM_LOAD( "bt_p20.rom", 0x20000, 0x10000, 0xab6217b7 );	ROM_LOAD( "bt_p19.rom", 0x30000, 0x10000, 0x8ed759a0 );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "bt_p6.rom",  0x00000, 0x8000, 0x8ffdf969 );	ROM_LOAD( "bt_p7.rom",  0x10000, 0x8000, 0x268d10df );	ROM_LOAD( "bt_p8.rom",  0x20000, 0x8000, 0x3e39e9dd );	ROM_LOAD( "bt_p9.rom",  0x30000, 0x8000, 0xbf56da61 );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "bt_p11.rom", 0x00000, 0x10000, 0xaae7410e );	ROM_LOAD( "bt_p12.rom", 0x10000, 0x10000, 0x18914f70 );	ROM_LOAD( "bt_p13.rom", 0x20000, 0x10000, 0xcd79ce81 );	ROM_LOAD( "bt_p14.rom", 0x30000, 0x10000, 0xedc57117 );	ROM_LOAD( "bt_p15.rom", 0x40000, 0x10000, 0x448bf9f4 );	ROM_LOAD( "bt_p16.rom", 0x50000, 0x10000, 0x119999eb );	ROM_LOAD( "bt_p17.rom", 0x60000, 0x10000, 0xb5462139 );	ROM_LOAD( "bt_p18.rom", 0x70000, 0x10000, 0xcb416227 );
		ROM_REGION( 0x20000, REGION_SOUND1 );	ROM_LOAD( "bt_p4.rom",  0x00000, 0x10000, 0x4bc83229 );	ROM_LOAD( "bt_p5.rom",  0x10000, 0x10000, 0x817bd62c );ROM_END(); }}; 
	...
	static RomLoadPtr rom_bermudaj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "bt_p11.rom",  0x00000, 0x10000, 0xaae7410e );	ROM_LOAD( "bt_p12.rom",  0x10000, 0x10000, 0x18914f70 );	ROM_LOAD( "bt_p13.rom",  0x20000, 0x10000, 0xcd79ce81 );	ROM_LOAD( "bt_p14.rom",  0x30000, 0x10000, 0xedc57117 );	ROM_LOAD( "bt_p15.rom",  0x40000, 0x10000, 0x448bf9f4 );	ROM_LOAD( "bt_p16.rom",  0x50000, 0x10000, 0x119999eb );	ROM_LOAD( "bt_p17.rom",  0x60000, 0x10000, 0xb5462139 );	ROM_LOAD( "bt_p18.rom",  0x70000, 0x10000, 0xcb416227 );
		ROM_REGION( 0x20000, REGION_SOUND1 );	ROM_LOAD( "btj_p04.bin", 0x00000, 0x10000, 0xb2e01129 );	ROM_LOAD( "btj_p05.bin", 0x10000, 0x10000, 0x924c24f7 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_worldwar = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS );	ROM_LOAD( "ww_r.bin",    0x0000, 0x0400, 0xb88e95f0 );/* red */
		...
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "ww11.bin", 0x00000, 0x10000, 0x603ddcb5 );	ROM_LOAD( "ww14.bin", 0x10000, 0x10000, 0x04c784be );	ROM_LOAD( "ww13.bin", 0x20000, 0x10000, 0x83a7ef62 );	ROM_LOAD( "ww12.bin", 0x30000, 0x10000, 0x388093ff );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "ww7.bin",  0x30000, 0x08000, 0x53c4b24e );	ROM_LOAD( "ww8.bin",  0x20000, 0x08000, 0x0ec15086 );	ROM_LOAD( "ww9.bin",  0x10000, 0x08000, 0xd9d35911 );	ROM_LOAD( "ww10.bin", 0x00000, 0x08000, 0xf68a2d51 );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "ww15.bin", 0x40000, 0x10000, 0xd55ce063 );	ROM_LOAD( "ww16.bin", 0x50000, 0x10000, 0xa2d19ce5 );	ROM_LOAD( "ww17.bin", 0x60000, 0x10000, 0xa9a6b128 );	ROM_LOAD( "ww18.bin", 0x70000, 0x10000, 0xc712d24c );	ROM_LOAD( "ww19.bin", 0x20000, 0x10000, 0xc39ac1a7 );	ROM_LOAD( "ww20.bin", 0x30000, 0x10000, 0x8504170f );	ROM_LOAD( "ww21.bin", 0x00000, 0x10000, 0xbe974fbe );	ROM_LOAD( "ww22.bin", 0x10000, 0x10000, 0x9914972a );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM samples */
		ROM_LOAD( "bt_p4.rom",  0x00000, 0x10000, 0x4bc83229 );	ROM_LOAD( "bt_p5.rom",  0x10000, 0x10000, 0x817bd62c );ROM_END(); }}; 
	...
	static RomLoadPtr rom_bermudaa = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS );	ROM_LOAD( "mb7122e.1k",  0x0000, 0x0400, 0x1e8fc4c3 );/* red */
	...
	static RomLoadPtr rom_psychos = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1400, REGION_PROMS );	ROM_LOAD( "up03_k1.rom",  0x00000, 0x00400, 0x27b8ca8c );/* red */
		...
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "up01_f1.rom",  0x00000, 0x10000, 0x167e5765 );	ROM_LOAD( "up01_d1.rom",  0x10000, 0x10000, 0x8b0fe8d0 );	ROM_LOAD( "up01_c1.rom",  0x20000, 0x10000, 0xf4361c50 );	ROM_LOAD( "up01_a1.rom",  0x30000, 0x10000, 0xe4b0b95e );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "up02_f3.rom",  0x00000, 0x8000, 0xf96f82db );	ROM_LOAD( "up02_e3.rom",  0x10000, 0x8000, 0x2b007733 );	ROM_LOAD( "up02_c3.rom",  0x20000, 0x8000, 0xefa830e1 );	ROM_LOAD( "up02_b3.rom",  0x30000, 0x8000, 0x24559ee1 );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "up01_f10.rom",  0x00000, 0x10000, 0x2bac250e );	ROM_LOAD( "up01_h10.rom",  0x10000, 0x10000, 0x5e1ba353 );	ROM_LOAD( "up01_j10.rom",  0x20000, 0x10000, 0x9ff91a97 );	ROM_LOAD( "up01_l10.rom",  0x30000, 0x10000, 0xae1965ef );	ROM_LOAD( "up01_m10.rom",  0x40000, 0x10000, 0xdf283b67 );	ROM_LOAD( "up01_n10.rom",  0x50000, 0x10000, 0x914f051f );	ROM_LOAD( "up01_r10.rom",  0x60000, 0x10000, 0xc4488472 );	ROM_LOAD( "up01_s10.rom",  0x70000, 0x10000, 0x8ec7fe18 );
		ROM_REGION( 0x40000, REGION_SOUND1 );	ROM_LOAD( "p1",  0x00000, 0x10000, 0x58f1683f );	ROM_LOAD( "p2",  0x10000, 0x10000, 0xda3abda1 );	ROM_LOAD( "p3",  0x20000, 0x10000, 0xf3683ae8 );	ROM_LOAD( "p4",  0x30000, 0x10000, 0x437d775a );ROM_END(); }}; 
	...
	static RomLoadPtr rom_psychosj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "up01_f10.rom",  0x00000, 0x10000, 0x2bac250e );	ROM_LOAD( "up01_h10.rom",  0x10000, 0x10000, 0x5e1ba353 );	ROM_LOAD( "up01_j10.rom",  0x20000, 0x10000, 0x9ff91a97 );	ROM_LOAD( "up01_l10.rom",  0x30000, 0x10000, 0xae1965ef );	ROM_LOAD( "up01_m10.rom",  0x40000, 0x10000, 0xdf283b67 );	ROM_LOAD( "up01_n10.rom",  0x50000, 0x10000, 0x914f051f );	ROM_LOAD( "up01_r10.rom",  0x60000, 0x10000, 0xc4488472 );	ROM_LOAD( "up01_s10.rom",  0x70000, 0x10000, 0x8ec7fe18 );
		ROM_REGION( 0x40000, REGION_SOUND1 );	ROM_LOAD( "up03_b5.rom",  0x00000, 0x10000, 0x0f8e8276 );	ROM_LOAD( "up03_c5.rom",  0x10000, 0x10000, 0x34e41dfb );	ROM_LOAD( "up03_d5.rom",  0x20000, 0x10000, 0xaa583c5e );	ROM_LOAD( "up03_f5.rom",  0x30000, 0x10000, 0x7e8bce7a );ROM_END(); }}; 
	...
	static RomLoadPtr rom_chopper = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "up03_k1.rom",  0x0000, 0x0400, 0x7f07a45c );/* red */
		...
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "kk_10.rom",  0x00000, 0x10000, 0x5cf4d22b );	ROM_LOAD( "kk_11.rom",  0x10000, 0x10000, 0x9af4cad0 );	ROM_LOAD( "kk_12.rom",  0x20000, 0x10000, 0x02fec778 );	ROM_LOAD( "kk_13.rom",  0x30000, 0x10000, 0x2756817d );
		ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
		ROM_LOAD( "kk_09.rom",  0x00000, 0x08000, 0x653c4342 );	ROM_LOAD( "kk_08.rom",  0x10000, 0x08000, 0x2da45894 );	ROM_LOAD( "kk_07.rom",  0x20000, 0x08000, 0xa0ebebdf );	ROM_LOAD( "kk_06.rom",  0x30000, 0x08000, 0x284fad9e );
		ROM_REGION( 0x80000, REGION_GFX4 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "kk_18.rom",  0x00000, 0x10000, 0x6abbff36 );	ROM_LOAD( "kk_19.rom",  0x10000, 0x10000, 0x5283b4d3 );	ROM_LOAD( "kk_20.rom",  0x20000, 0x10000, 0x6403ddf2 );	ROM_LOAD( "kk_21.rom",  0x30000, 0x10000, 0x9f411940 );	ROM_LOAD( "kk_14.rom",  0x40000, 0x10000, 0x9bad9e25 );	ROM_LOAD( "kk_15.rom",  0x50000, 0x10000, 0x89faf590 );	ROM_LOAD( "kk_16.rom",  0x60000, 0x10000, 0xefb1fb6c );	ROM_LOAD( "kk_17.rom",  0x70000, 0x10000, 0x6b7fb0a5 );
		ROM_REGION( 0x10000, REGION_SOUND1 );	ROM_LOAD( "kk_02.rom",  0x00000, 0x10000, 0x06169ae0 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_ftsoccer = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "prom2.bin", 0x000, 0x400, 0xbf4ac706 );/* red */
		...
		ROM_LOAD( "ft-014.bin",  0x00000, 0x10000, 0x38c38b40 );	ROM_LOAD( "ft-015.bin",  0x10000, 0x10000, 0xa614834f );
	//	ROM_REGION( 0x40000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 16x16 sprites */
	
		ROM_REGION( 0x80000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "ft-005.bin",  0x10000, 0x10000, 0xdef2f1d8 );	ROM_LOAD( "ft-006.bin",  0x00000, 0x10000, 0x588d14b3 );
		ROM_LOAD( "ft-007.bin",  0x30000, 0x10000, 0xd584964b );	ROM_LOAD( "ft-008.bin",  0x20000, 0x10000, 0x11156a7d );
		ROM_LOAD( "ft-009.bin",  0x50000, 0x10000, 0xd8112aa6 );	ROM_LOAD( "ft-010.bin",  0x40000, 0x10000, 0xe42864d8 );
		ROM_LOAD( "ft-011.bin",  0x70000, 0x10000, 0x022f3e96 );	ROM_LOAD( "ft-012.bin",  0x60000, 0x10000, 0xb2442c30 );
		ROM_REGION( 0x10000, REGION_SOUND1 );	ROM_LOAD( "ft-004.bin",  0x00000, 0x10000, 0x435c3716 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_tdfever = new RomLoadPtr(){ public void handler(){  /* USA set */
		...
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "up03_e8.rom",  0x000, 0x00400, 0x67bdf8a0 );	ROM_LOAD( "up03_d8.rom",  0x400, 0x00400, 0x9c4a9198 );	ROM_LOAD( "up03_e9.rom",  0x800, 0x00400, 0xc93c18e8 );
		ROM_REGION( 0x8000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* characters */
		ROM_LOAD( "td14ver3.4n",  0x0000, 0x8000,  0xe841bf1a );
		ROM_REGION( 0x50000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "up01_d8.rom",  0x00000, 0x10000, 0xad6e0927 );	ROM_LOAD( "up01_e8.rom",  0x10000, 0x10000, 0x181db036 );	ROM_LOAD( "up01_f8.rom",  0x20000, 0x10000, 0xc5decca3 );	ROM_LOAD( "td18ver2.8gh", 0x30000, 0x10000, 0x3924da37 );	ROM_LOAD( "up01_j8.rom",  0x40000, 0x10000, 0xbc17ea7f );
		ROM_REGION( 0x80000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "up01_k2.rom",  0x00000, 0x10000, 0x72a5590d );	ROM_LOAD( "up01_l2.rom",  0x30000, 0x10000, 0x28f49182 );	ROM_LOAD( "up01_n2.rom",  0x20000, 0x10000, 0xa8979657 );	ROM_LOAD( "up01_j2.rom",  0x10000, 0x10000, 0x9b6d4053 );	ROM_LOAD( "up01_r2.rom",  0x40000, 0x10000, 0xa0d53fbd );	ROM_LOAD( "up01_p2.rom",  0x50000, 0x10000, 0xc8c71c7b );	ROM_LOAD( "up01_t2.rom",  0x60000, 0x10000, 0x88e2e819 );	ROM_LOAD( "up01_s2.rom",  0x70000, 0x10000, 0xf6f83d63 );
		ROM_REGION( 0x20000, REGION_SOUND1 );	ROM_LOAD( "up02_n6.rom",  0x00000, 0x10000, 0x155e472e );	ROM_LOAD( "up02_p6.rom",  0x10000, 0x10000, 0x04794557 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_tdfeverj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x50000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* tiles */
		ROM_LOAD( "up01_d8.rom",  0x00000, 0x10000, 0xad6e0927 );	ROM_LOAD( "up01_e8.rom",  0x10000, 0x10000, 0x181db036 );	ROM_LOAD( "up01_f8.rom",  0x20000, 0x10000, 0xc5decca3 );	ROM_LOAD( "up01_g8.rom",  0x30000, 0x10000, 0x4512cdfb );	ROM_LOAD( "up01_j8.rom",  0x40000, 0x10000, 0xbc17ea7f );
		ROM_REGION( 0x80000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* 32x32 sprites */
		ROM_LOAD( "up01_k2.rom",  0x00000, 0x10000, 0x72a5590d );	ROM_LOAD( "up01_l2.rom",  0x30000, 0x10000, 0x28f49182 );	ROM_LOAD( "up01_n2.rom",  0x20000, 0x10000, 0xa8979657 );	ROM_LOAD( "up01_j2.rom",  0x10000, 0x10000, 0x9b6d4053 );	ROM_LOAD( "up01_t2.rom",  0x40000, 0x10000, 0x88e2e819 );	ROM_LOAD( "up01_s2.rom",  0x50000, 0x10000, 0xf6f83d63 );	ROM_LOAD( "up01_r2.rom",  0x60000, 0x10000, 0xa0d53fbd );	ROM_LOAD( "up01_p2.rom",  0x70000, 0x10000, 0xc8c71c7b );
		ROM_REGION( 0x20000, REGION_SOUND1 );	ROM_LOAD( "up02_n6.rom",  0x00000, 0x10000, 0x155e472e );	ROM_LOAD( "up02_p6.rom",  0x10000, 0x10000, 0x04794557 );ROM_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		SNK_JOY1_PORT
		...
		PORT_START();  /* DSW 1 */
		PORT_DIPNAME( 0x01, 0x01, "Allow killing each other" );	PORT_DIPSETTING(    0x01, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x02, 0x02, "P1 & P2 Fire Buttons" );	PORT_DIPSETTING(    0x02, "Separate" );	PORT_DIPSETTING(    0x00, "Common" );	PORT_DIPNAME( 0x04, 0x04, "Bonus Occurrence" );	PORT_DIPSETTING(    0x04, "1st & every 2nd" );	PORT_DIPSETTING(    0x00, "1st & 2nd only" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "5" );	SNK_COINAGE
	
		PORT_START();  /* DSW 2 */
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x08, "Game Mode" );	PORT_DIPSETTING(    0x0c, "Demo Sounds Off" );	PORT_DIPSETTING(    0x08, "Demo Sounds On" );	PORT_DIPSETTING(    0x04, "Freeze" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "50k 100k" );	PORT_DIPSETTING(    0x20, "60k 120k" );	PORT_DIPSETTING(    0x10, "100k 200k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40 ,0x40, DEF_STR( "Unused") );
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW,IPT_UNKNOWN );/* sound CPU status */
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );/* tilt? */
	...
	PORT_START(); 
		...
		PORT_START();  /* DSW 1 */
		PORT_BITX( 0x01,    0x01, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Kill friend & walk everywhere" ,0 ,0 );	PORT_DIPSETTING(    0x01, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x02, 0x02, "P1 & P2 Fire Buttons" );	PORT_DIPSETTING(    0x02, "Separate" );	PORT_DIPSETTING(    0x00, "Common" );	PORT_DIPNAME( 0x04, 0x04, "Bonus Occurrence" );	PORT_DIPSETTING(    0x04, "1st & every 2nd" );	PORT_DIPSETTING(    0x00, "1st & 2nd only" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "5" );	SNK_COINAGE
		...
		PORT_START();  /* DSW 2 */
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x08, "Game Mode" );	PORT_DIPSETTING(    0x0c, "Demo Sounds Off" );	PORT_DIPSETTING(    0x08, "Demo Sounds On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "50k 100k" );	PORT_DIPSETTING(    0x20, "60k 120k" );	PORT_DIPSETTING(    0x10, "100k 200k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40 ,0x00, "Allow Continue" );	PORT_DIPSETTING(    0x40, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	/* sound related ??? */
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );/* causes reset */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		SNK_JOY1_PORT
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Bonus Occurrence" );	PORT_DIPSETTING(    0x04, "1st & every 2nd" );	PORT_DIPSETTING(    0x00, "1st & 2nd only" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "5" );	SNK_COINAGE
	
		PORT_START();  /* DSW 2 */
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Freeze" );	PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "30k 50k" );	PORT_DIPSETTING(    0x20, "40k 80k" );	PORT_DIPSETTING(    0x10, "50k 100k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40 ,0x40, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "50k 100k" );	PORT_DIPSETTING(    0x20, "80k 160k" );	PORT_DIPSETTING(    0x10, "100k 200k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unused") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "Energy" );	PORT_DIPSETTING(    0x80, "12" );	PORT_DIPSETTING(    0x00, "14" );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_tnk3 = new InputPortPtr(){ public void handler() { 
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );/* sound CPU status */
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_ANALOGX( 0xf0, 0x00, IPT_DIAL, 25, 10, 0, 0, KEYCODE_Z, KEYCODE_X, 0, 0 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_COCKTAIL );	PORT_ANALOGX( 0xf0, 0x00, IPT_DIAL | IPF_PLAYER2, 25, 10, 0, 0, KEYCODE_N, KEYCODE_M, 0, 0 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW1 */
		PORT_BITX( 0x01,    0x01, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Walk everywhere", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Cocktail") );
		...
		PORT_DIPSETTING(    0xc0, "20k 60k" );	PORT_DIPSETTING(    0x80, "40k 90k" );	PORT_DIPSETTING(    0x40, "50k 120k" );	PORT_DIPSETTING(    0x00, "None" );
		PORT_START(); 	/* DSW2 */
		...
		PORT_DIPSETTING(    0x06, "Easy?" );	PORT_DIPSETTING(    0x04, "Normal?" );	PORT_DIPSETTING(    0x02, "Hard?" );	PORT_DIPSETTING(    0x00, "Hardest?" );	PORT_DIPNAME( 0x18, 0x10, "Game Mode" );	PORT_DIPSETTING(    0x18, "Demo Sounds Off" );	PORT_DIPSETTING(    0x10, "Demo Sounds On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x08, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );/* sound CPU status */
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );/* tile? */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		SNK_JOY1_PORT
		...
		PORT_START();   /* DSW 1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Bonus Occurrence" );	PORT_DIPSETTING(    0x04, "1st & every 2nd" );	PORT_DIPSETTING(    0x00, "1st & 2nd only" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "5" );	SNK_COINAGE
		...
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x08, "Game Mode" );	PORT_DIPSETTING(    0x0c, "Demo Sounds Off" );	PORT_DIPSETTING(    0x08, "Demo Sounds On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "50k 100k" );	PORT_DIPSETTING(    0x20, "60k 120k" );	PORT_DIPSETTING(    0x10, "100k 200k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0xc0, 0xc0, "Game Style" );	PORT_DIPSETTING(    0xc0, "Normal without continue" );	PORT_DIPSETTING(    0x80, "Normal with continue" );	PORT_DIPSETTING(    0x40, "Time attack 3 minutes" );	PORT_DIPSETTING(    0x00, "Time attack 5 minutes" );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_START();   /* DSW 1 */
		PORT_DIPNAME( 0x01, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x01, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x08, "Game Mode" );	PORT_DIPSETTING(    0x0c, "Demo Sounds Off" );	PORT_DIPSETTING(    0x08, "Demo Sounds On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "25k 50k" );	PORT_DIPSETTING(    0x20, "35k 70k" );	PORT_DIPSETTING(    0x10, "50K 100k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_BIT( 0xc0, IP_ACTIVE_HIGH, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x08, "Game Mode" );	PORT_DIPSETTING(    0x0c, "Demo Sounds Off" );	PORT_DIPSETTING(    0x08, "Demo Sounds On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "50k 100k" );	PORT_DIPSETTING(    0x20, "80k 120k" );	PORT_DIPSETTING(    0x10, "100k 200k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_BIT( 0xc0, IP_ACTIVE_HIGH, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_psychos = new InputPortPtr(){ public void handler() { 
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN ); /* sound related */
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN ); /* reset */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );
		SNK_BUTTON_PORT
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Bonus Occurrence" );	PORT_DIPSETTING(    0x00, "1st & every 2nd" );	PORT_DIPSETTING(    0x04, "1st & 2nd only" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "5" );	SNK_COINAGE
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN ); /* sound CPU status */
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_TILT ); /* Reset */
		PORT_BITX(0x08, 0x08, IPT_SERVICE, DEF_STR( "Service_Mode")); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		...
		PORT_START();   /* DSW 2 */
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x02, "Easy" );	PORT_DIPSETTING(    0x03, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x0c, "Game Mode" );	PORT_DIPSETTING(    0x08, "Demo Sounds Off" );	PORT_DIPSETTING(    0x0c, "Demo Sounds On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x30, "50k 100k" );	PORT_DIPSETTING(    0x20, "75k 150k" );	PORT_DIPSETTING(    0x10, "100k 200k" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40, 0x40, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
	...
	PORT_START(); 
		...
		PORT_START(); 	/* DSW1 */
		PORT_DIPNAME( 0x01, 0x01, "Continue?" );	PORT_DIPSETTING(    0x01, "Coin Up" );	PORT_DIPSETTING(    0x00, "Standard" );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Bonus?" );	PORT_DIPSETTING(    0x04, "Every?" );	PORT_DIPSETTING(    0x00, "Only?" );	PORT_DIPNAME( 0x08, 0x08, "Lives?" );	PORT_DIPSETTING(    0x08, "3" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Coin_A") );
		PORT_DIPSETTING(    0x00, DEF_STR( "4C_1C") );
		PORT_DIPSETTING(    0x10, DEF_STR( "3C_1C") );
		PORT_DIPSETTING(    0x20, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x30, DEF_STR( "1C_1C") );
		...
		PORT_START();  /* DSW2 */
		PORT_DIPNAME( 0x03, 0x03, "Difficulty?" );	PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x0c, "Game Mode" );	PORT_DIPSETTING(    0x08, "Demo Sound Off" );	PORT_DIPSETTING(    0x0c, "Demo Sound On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Never Finish?", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x30, 0x30, "Bonus?" );	PORT_DIPSETTING(    0x30, "50k 100k?" );	PORT_DIPSETTING(    0x20, "60k 120k?" );	PORT_DIPSETTING(    0x10, "100k 200k?" );	PORT_DIPSETTING(    0x00, "None?" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN ); /* sound CPU status */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START2 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_START(); 
	
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );// START5?
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON4 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );
		PORT_START(); 
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL, 25, 10, 0, 0, KEYCODE_Z, KEYCODE_X, 0, 0 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER2, 25, 10, 0, 0, KEYCODE_N, KEYCODE_M, 0, 0 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER3, 25, 10, 0, 0, 0, 0, 0, 0 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER4, 25, 10, 0, 0, 0, 0, 0, 0 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		...
		PORT_DIPNAME( 0x0c, 0x04, "Version" );	PORT_DIPSETTING(    0x04, "Europe" );	PORT_DIPSETTING(    0x00, "USA" );	PORT_DIPSETTING(    0x08, "Japan" );/* 	PORT_DIPSETTING(    0x0c, "Europe" );*/
		SNK_COINAGE
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x0c, "Game Mode" );	PORT_DIPSETTING(    0x08, "Demo Sound Off" );	PORT_DIPSETTING(    0x0c, "Demo Sound On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Never Finish", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x70, 0x70, "Play Time" );	PORT_DIPSETTING(    0x10, "1:00" );	PORT_DIPSETTING(    0x60, "1:10" );	PORT_DIPSETTING(    0x50, "1:20" );	PORT_DIPSETTING(    0x40, "1:30" );	PORT_DIPSETTING(    0x30, "1:40" );	PORT_DIPSETTING(    0x20, "1:50" );	PORT_DIPSETTING(    0x70, "2:00" );	PORT_DIPSETTING(    0x00, "2:10" );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_tdfever = new InputPortPtr(){ public void handler() { 
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN ); /* sound CPU status */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START2 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_START(); 
	
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );
		PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );
		PORT_START(); 
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL, 25, 10, 0, 0, KEYCODE_Z, KEYCODE_X, 0, 0 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_ANALOGX( 0x7f, 0x00, IPT_DIAL | IPF_PLAYER2, 25, 10, 0, 0, KEYCODE_N, KEYCODE_M, 0, 0 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );
		...
		PORT_DIPNAME( 0x01, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x01, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x02, 0x02, "Max Players" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x00, "4" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x00, "1 Coin/1 Credit 4/5" );	PORT_DIPSETTING(    0x10, "1 Coin/1 Credit 3/4" );	PORT_DIPSETTING(    0x20, "1 Coin/1 Credit 2/3" );	PORT_DIPSETTING(    0x30, DEF_STR( "1C_2C") );
		PORT_DIPNAME( 0xc0, 0x00, DEF_STR( "Coin_B") );
		PORT_DIPSETTING(    0x00, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(    0x40, DEF_STR( "1C_3C") );
		PORT_DIPSETTING(    0x80, DEF_STR( "1C_4C") );
		...
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x08, "Game Mode" );	PORT_DIPSETTING(    0x0c, "Demo Sound Off" );	PORT_DIPSETTING(    0x08, "Demo Sound On" );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_BITX( 0,       0x04, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Never Finish?", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x70, 0x70, "Play Time" );	PORT_DIPSETTING(    0x70, "1:00" );	PORT_DIPSETTING(    0x60, "1:10" );	PORT_DIPSETTING(    0x50, "1:20" );	PORT_DIPSETTING(    0x40, "1:30" );	PORT_DIPSETTING(    0x30, "1:40" );	PORT_DIPSETTING(    0x20, "1:50" );	PORT_DIPSETTING(    0x10, "2:00" );	PORT_DIPSETTING(    0x00, "2:10" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
