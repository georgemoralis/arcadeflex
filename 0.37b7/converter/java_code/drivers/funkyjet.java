...
public class funkyjet
{
	...
	*/
	...
	PORT_START(); 	/* Player 1 controls */
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* button 3 - unused? */
		...
		PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x30, "Normal" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
	...
	static RomLoadPtr rom_funkyjet = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "jk00.12f", 0x00000, 0x40000, 0x712089c1 );	ROM_LOAD_ODD ( "jk01.13f", 0x00000, 0x40000, 0xbe3920d7 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "jk02.16f",    0x00000, 0x10000, 0x748c0bd8 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mat02", 0x000000, 0x80000, 0xe4b94c7e );/* chars */
	
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );  	ROM_LOAD( "mat00", 0x000000, 0x80000, 0xfbda0228 );/* sprites */
		ROM_LOAD( "mat01", 0x080000, 0x80000, 0x24093a8d );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM samples */
	  	ROM_LOAD( "jk03.15h",    0x00000, 0x20000, 0x69a0eaf7 );ROM_END(); }}; 
