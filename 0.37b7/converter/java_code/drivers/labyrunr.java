...
public class labyrunr
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_labyrunr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "771d01.14a",	0x00000, 0x40000, 0x15c8f5f9 );/* tiles + sprites */
	
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "771d02.08d", 0x0000, 0x0100, 0x3d34bb5a );/* sprite lookup table */
