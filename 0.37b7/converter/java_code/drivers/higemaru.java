...
public class higemaru
{
	...
	PORT_START();       /* IN0 */
		...
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_DIPNAME( 0x04, 0x04, "Freeze" );/* could be Tilt? */
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START();       /* DSW0 */
		...
		PORT_DIPSETTING(    0x0e, "10000 50000 50000" );	PORT_DIPSETTING(    0x0c, "10000 60000 60000" );	PORT_DIPSETTING(    0x0a, "20000 60000 60000" );	PORT_DIPSETTING(    0x08, "20000 70000 70000" );	PORT_DIPSETTING(    0x06, "30000 70000 70000" );	PORT_DIPSETTING(    0x04, "30000 80000 80000" );	PORT_DIPSETTING(    0x02, "40000 100000 100000" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x10, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, "Demo Music" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_higemaru = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "hg4",          0x0000, 0x2000, 0xdc67a7f9 );	ROM_LOAD( "hg5",          0x2000, 0x2000, 0xf65a4b68 );	ROM_LOAD( "hg6",          0x4000, 0x2000, 0x5f5296aa );	ROM_LOAD( "hg7",          0x6000, 0x2000, 0xdc5d455d );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "hg3",          0x0000, 0x2000, 0xb37b88c8 );/* characters */
	
		ROM_REGION( 0x4000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "hg1",          0x0000, 0x2000, 0xef4c2f5d );/* tiles */
		ROM_LOAD( "hg2",          0x2000, 0x2000, 0x9133f804 );
		ROM_REGION( 0x0420, REGION_PROMS );	ROM_LOAD( "hgb3",         0x0000, 0x0020, 0x629cebd8 );/* palette */
