...
public class berzerk
{
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x1c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x60, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
	
		PORT_START();       /* IN3 */
		PORT_BITX(    0x01, 0x00, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Input Test Mode", KEYCODE_F2, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_BITX(    0x02, 0x00, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Crosshair Pattern", KEYCODE_F4, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x02, DEF_STR( "On") );
		PORT_BIT( 0x3c, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_DIPNAME( 0xc0, 0x00, "Language" );	PORT_DIPSETTING(    0x00, "English" );	PORT_DIPSETTING(    0x40, "German" );	PORT_DIPSETTING(    0x80, "French" );	PORT_DIPSETTING(    0xc0, "Spanish" );
		PORT_START();       /* IN4 */
		PORT_BITX(    0x03, 0x00, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Color Test", KEYCODE_F5, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x03, DEF_STR( "On") );
		PORT_BIT( 0x3c, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_DIPNAME( 0xc0, 0xc0, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0xc0, "5000 and 10000" );	PORT_DIPSETTING(    0x40, "5000" );	PORT_DIPSETTING(    0x80, "10000" );	PORT_DIPSETTING(    0x00, "None" );
		PORT_START();       /* IN5 */
		COINAGE(3)
		...
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_BIT( 0x7e, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BITX(0x80, IP_ACTIVE_HIGH, 0, "Stats", KEYCODE_F1, IP_JOY_NONE );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_frenzy = new InputPortPtr(){ public void handler() { 
	PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0xe0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x60, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		...
		PORT_DIPSETTING(    0x01, "1000" );	PORT_DIPSETTING(    0x02, "2000" );	PORT_DIPSETTING(    0x03, "3000" );	PORT_DIPSETTING(    0x04, "4000" );	PORT_DIPSETTING(    0x05, "5000" );	PORT_DIPSETTING(    0x06, "6000" );	PORT_DIPSETTING(    0x07, "7000" );	PORT_DIPSETTING(    0x08, "8000" );	PORT_DIPSETTING(    0x09, "9000" );	PORT_DIPSETTING(    0x0a, "10000" );	PORT_DIPSETTING(    0x0b, "11000" );	PORT_DIPSETTING(    0x0c, "12000" );	PORT_DIPSETTING(    0x0d, "13000" );	PORT_DIPSETTING(    0x0e, "14000" );	PORT_DIPSETTING(    0x0f, "15000" );	PORT_DIPSETTING(    0x00, "None" );	PORT_BIT( 0x30, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_DIPNAME( 0xc0, 0x00, "Language" );	PORT_DIPSETTING(    0x00, "English" );	PORT_DIPSETTING(    0x40, "German" );	PORT_DIPSETTING(    0x80, "French" );	PORT_DIPSETTING(    0xc0, "Spanish" );
		PORT_START();       /* IN4 */
		PORT_BIT( 0x03, IP_ACTIVE_HIGH, IPT_UNUSED ); /* Bit 0 does some more hardware tests */
		PORT_BITX(    0x04, 0x00, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Input Test Mode", KEYCODE_F2, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_BITX(    0x08, 0x00, IPT_DIPSWITCH_NAME | IPF_TOGGLE, "Crosshair Pattern", KEYCODE_F4, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x08, DEF_STR( "On") );
		PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNUSED );
		/* The following 3 ports use all 8 bits, but I didn't feel like adding all 256 values :-) */
		PORT_START();       /* IN5 */
		PORT_DIPNAME( 0x0f, 0x01, "Coins/Credit B" );	/*PORT_DIPSETTING(    0x00, "0" );   Can't insert coins  */
		...
		PORT_START();       /* IN6 */
		PORT_DIPNAME( 0x0f, 0x01, "Coins/Credit A" );	/*PORT_DIPSETTING(    0x00, "0" );   Can't insert coins  */
		PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x05, "5" );	PORT_DIPSETTING(    0x06, "6" );	PORT_DIPSETTING(    0x07, "7" );	PORT_DIPSETTING(    0x08, "8" );	PORT_DIPSETTING(    0x09, "9" );	PORT_DIPSETTING(    0x0a, "10" );	PORT_DIPSETTING(    0x0b, "11" );	PORT_DIPSETTING(    0x0c, "12" );	PORT_DIPSETTING(    0x0d, "13" );	PORT_DIPSETTING(    0x0e, "14" );	PORT_DIPSETTING(    0x0f, "15" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH,  IPT_UNUSED );
		PORT_START();       /* IN7 */
		PORT_DIPNAME( 0x0f, 0x01, "Coin Multiplier" );	PORT_DIPSETTING(    0x00, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x05, "5" );	PORT_DIPSETTING(    0x06, "6" );	PORT_DIPSETTING(    0x07, "7" );	PORT_DIPSETTING(    0x08, "8" );	PORT_DIPSETTING(    0x09, "9" );	PORT_DIPSETTING(    0x0a, "10" );	PORT_DIPSETTING(    0x0b, "11" );	PORT_DIPSETTING(    0x0c, "12" );	PORT_DIPSETTING(    0x0d, "13" );	PORT_DIPSETTING(    0x0e, "14" );	PORT_DIPSETTING(    0x0f, "15" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH,  IPT_UNUSED );
		PORT_START();       /* IN8 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x7e, IP_ACTIVE_LOW,  IPT_UNUSED );	PORT_BITX(0x80, IP_ACTIVE_HIGH, 0, "Stats", KEYCODE_F1, IP_JOY_NONE );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_berzerk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "1c-0",         0x0000, 0x0800, 0xca566dbc );	ROM_LOAD( "1d-1",         0x1000, 0x0800, 0x7ba69fde );	ROM_LOAD( "3d-2",         0x1800, 0x0800, 0xa1d5248b );	ROM_LOAD( "5d-3",         0x2000, 0x0800, 0xfcaefa95 );	ROM_LOAD( "6d-4",         0x2800, 0x0800, 0x1e35b9a0 );	ROM_LOAD( "5c-5",         0x3000, 0x0800, 0xc8c665e5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_berzerk1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "rom0.1c",      0x0000, 0x0800, 0x5b7eb77d );	ROM_LOAD( "rom1.1d",      0x1000, 0x0800, 0xe58c8678 );	ROM_LOAD( "rom2.3d",      0x1800, 0x0800, 0x705bb339 );	ROM_LOAD( "rom3.5d",      0x2000, 0x0800, 0x6a1936b4 );	ROM_LOAD( "rom4.6d",      0x2800, 0x0800, 0xfa5dce40 );	ROM_LOAD( "rom5.5c",      0x3000, 0x0800, 0x2579b9f4 );ROM_END(); }}; 
	
	static RomLoadPtr rom_frenzy = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "1c-0",         0x0000, 0x1000, 0xabdd25b8 );	ROM_LOAD( "1d-1",         0x1000, 0x1000, 0x536e4ae8 );	ROM_LOAD( "3d-2",         0x2000, 0x1000, 0x3eb9bc9b );	ROM_LOAD( "5d-3",         0x3000, 0x1000, 0xe1d3133c );	ROM_LOAD( "6d-4",         0xc000, 0x1000, 0x5581a7b1 );	/* 1c & 2c are the voice ROMs */
	ROM_END(); }}; 
