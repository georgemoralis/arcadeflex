...
public class nemesis
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x18, "50k and every 100k" );	PORT_DIPSETTING(    0x10, "30k" );	PORT_DIPSETTING(    0x08, "50k" );	PORT_DIPSETTING(    0x00, "100k" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x04, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "20k and every 70k" );	PORT_DIPSETTING(    0x10, "30k and every 80k" );	PORT_DIPSETTING(    0x08, "20k" );	PORT_DIPSETTING(    0x00, "30k" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON3 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_BUTTON4 );
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* TEST */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* DSW0 */
		GX400_COINAGE_DIP
		...
		PORT_DIPSETTING(    0x30, "Easy" );	PORT_DIPSETTING(    0x20, "Normal" );	PORT_DIPSETTING(    0x10, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unknown") );
		...
		PORT_START(); 	/* IN6 */
		PORT_ANALOG( 0xff, 0x40, IPT_DIAL, 25, 10, 0x00, 0x7f );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_BUTTON3 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_BUTTON4 );
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* TEST */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Flip_Screen") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x30, "Easy" );	PORT_DIPSETTING(    0x20, "Normal" );	PORT_DIPSETTING(    0x10, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x03, "1" );	PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x01, "3" );	PORT_DIPSETTING(    0x00, "7" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "30k 100k 200k 400k" );	PORT_DIPSETTING(    0x10, "40k 120k 240k 480k" );	PORT_DIPSETTING(    0x08, "50k 150k 300k 600k" );	PORT_DIPSETTING(    0x00, "100k 200k 400k 800k" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN2 */
		...
		PORT_START(); 	/* DSW1 */
		PORT_DIPNAME( 0x03, 0x01, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPSETTING(    0x00, "7" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "30k and every 70k" );	PORT_DIPSETTING(    0x10, "40k and every 80k" );	PORT_DIPSETTING(    0x08, "50k and every 100k" );	PORT_DIPSETTING(    0x00, "100k and every 100k" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x04, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "20k and every 70k" );	PORT_DIPSETTING(    0x10, "30k and every 80k" );	PORT_DIPSETTING(    0x08, "20k only" );	PORT_DIPSETTING(    0x00, "30k only" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x0a, DEF_STR( "1C_6C") );
		PORT_DIPSETTING(    0x09, DEF_STR( "1C_7C") );
		PORT_DIPSETTING(    0x00, "Disabled" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
		...
		PORT_START(); 	/* DSW1 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPSETTING(    0x00, "7" );	PORT_DIPNAME( 0x04, 0x04, "Coin Slot(s); )
		PORT_DIPSETTING(    0x04, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x18, 0x00, "Max Credit(s); )
		PORT_DIPSETTING(    0x18, "1" );	PORT_DIPSETTING(    0x10, "3" );	PORT_DIPSETTING(    0x08, "5" );	PORT_DIPSETTING(    0x00, "9" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_DIPNAME( 0x80, 0x00, "Sound Type" );	PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Cocktail") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		...
		PORT_DIPSETTING(    0x0a, DEF_STR( "1C_6C") );
		PORT_DIPSETTING(    0x09, DEF_STR( "1C_7C") );
		PORT_DIPSETTING(    0x00, "Disabled" );	PORT_DIPNAME( 0xf0, 0xf0, DEF_STR( "Coin_B") );
		PORT_DIPSETTING(    0x20, DEF_STR( "4C_1C") );
		PORT_DIPSETTING(    0x50, DEF_STR( "3C_1C") );
		PORT_DIPSETTING(    0x80, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x40, DEF_STR( "3C_2C") );
		...
		PORT_START(); 	/* DSW1 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x02, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0x04, 0x04, "Coin Counter(s); )
		PORT_DIPSETTING(    0x04, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "70k and every 200k" );	PORT_DIPSETTING(    0x10, "100k and every 300k" );	PORT_DIPSETTING(    0x08, "70k only" );	PORT_DIPSETTING(    0x00, "100k only" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x60, "Easy" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x20, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_nemesis = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "12a_01.bin",   0x00000, 0x8000, 0x35ff1aaa );	ROM_LOAD_ODD ( "12c_05.bin",   0x00000, 0x8000, 0x23155faa );	ROM_LOAD_EVEN( "13a_02.bin",   0x10000, 0x8000, 0xac0cf163 );	ROM_LOAD_ODD ( "13c_06.bin",   0x10000, 0x8000, 0x023f22a9 );	ROM_LOAD_EVEN( "14a_03.bin",   0x20000, 0x8000, 0x8cefb25f );	ROM_LOAD_ODD ( "14c_07.bin",   0x20000, 0x8000, 0xd50b82cb );	ROM_LOAD_EVEN( "15a_04.bin",   0x30000, 0x8000, 0x9ca75592 );	ROM_LOAD_ODD ( "15c_08.bin",   0x30000, 0x8000, 0x03c0b7f5 );
		...
		ROM_LOAD(      "400-a01.fse",  0x00000, 0x0100, 0x5827b1e8 );	ROM_LOAD(      "400-a02.fse",  0x00100, 0x0100, 0x2f44f970 );ROM_END(); }}; 
	
	static RomLoadPtr rom_nemesuk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );   /* 4 * 64k for code and rom */
		ROM_LOAD_EVEN( "12a_01.uk",    0x00000, 0x8000, 0xe1993f91 );	ROM_LOAD_ODD ( "12c_05.uk",    0x00000, 0x8000, 0xc9761c78 );	ROM_LOAD_EVEN( "13a_02.uk",    0x10000, 0x8000, 0xf6169c4b );	ROM_LOAD_ODD ( "13c_06.uk",    0x10000, 0x8000, 0xaf58c548 );	ROM_LOAD_EVEN( "14a_03.bin",   0x20000, 0x8000, 0x8cefb25f );	ROM_LOAD_ODD ( "14c_07.bin",   0x20000, 0x8000, 0xd50b82cb );	ROM_LOAD_EVEN( "15a_04.uk",    0x30000, 0x8000, 0x322423d0 );	ROM_LOAD_ODD ( "15c_08.uk",    0x30000, 0x8000, 0xeb656266 );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
		ROM_LOAD(      "09c_snd.bin",  0x00000, 0x4000, 0x26bf9636 );
		ROM_REGION( 0x0200,  REGION_SOUND1 );     /* 2x 256 byte for 0005289 wavetable data */
		ROM_LOAD(      "400-a01.fse",  0x00000, 0x0100, 0x5827b1e8 );	ROM_LOAD(      "400-a02.fse",  0x00100, 0x0100, 0x2f44f970 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_konamigt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );   /* 4 * 64k for code and rom */
		ROM_LOAD_EVEN( "c01.rom",      0x00000, 0x8000, 0x56245bfd );	ROM_LOAD_ODD ( "c05.rom",      0x00000, 0x8000, 0x8d651f44 );	ROM_LOAD_EVEN( "c02.rom",      0x10000, 0x8000, 0x3407b7cb );	ROM_LOAD_ODD ( "c06.rom",      0x10000, 0x8000, 0x209942d4 );	ROM_LOAD_EVEN( "b03.rom",      0x20000, 0x8000, 0xaef7df48 );	ROM_LOAD_ODD ( "b07.rom",      0x20000, 0x8000, 0xe9bd6250 );	ROM_LOAD_EVEN( "b04.rom",      0x30000, 0x8000, 0x94bd4bd7 );	ROM_LOAD_ODD ( "b08.rom",      0x30000, 0x8000, 0xb7236567 );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
	...
	static RomLoadPtr rom_rf2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "400-a06.15l",  0x00000, 0x08000, 0xb99d8cff );	ROM_LOAD_ODD ( "400-a04.10l",  0x00000, 0x08000, 0xd02c9552 );	ROM_LOAD_EVEN( "561-a07.17l",  0x80000, 0x20000, 0xed6e7098 );	ROM_LOAD_ODD ( "561-a05.12l",  0x80000, 0x20000, 0xdfe04425 );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
	...
	static RomLoadPtr rom_twinbee = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );   /* 5 * 64k for code and rom */
		ROM_LOAD_EVEN( "400-a06.15l",  0x00000, 0x08000, 0xb99d8cff );	ROM_LOAD_ODD ( "400-a04.10l",  0x00000, 0x08000, 0xd02c9552 );	ROM_LOAD_EVEN( "412-a07.17l",  0x80000, 0x20000, 0xd93c5499 );	ROM_LOAD_ODD ( "412-a05.12l",  0x80000, 0x20000, 0x2b357069 );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
		ROM_LOAD(      "400-e03.5l",   0x00000, 0x02000, 0xa5a8e57d );
		ROM_REGION( 0x0200,  REGION_SOUND1 );     /* 2x 256 byte for 0005289 wavetable data */
		ROM_LOAD(      "400-a01.fse",  0x00000, 0x0100, 0x5827b1e8 );	ROM_LOAD(      "400-a02.fse",  0x00100, 0x0100, 0x2f44f970 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_gradius = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );   /* 5 * 64k for code and rom */
		ROM_LOAD_EVEN( "400-a06.15l",  0x00000, 0x08000, 0xb99d8cff );	ROM_LOAD_ODD ( "400-a04.10l",  0x00000, 0x08000, 0xd02c9552 );	ROM_LOAD_EVEN( "456-a07.17l",  0x80000, 0x20000, 0x92df792c );	ROM_LOAD_ODD ( "456-a05.12l",  0x80000, 0x20000, 0x5cafb263 );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
	...
	static RomLoadPtr rom_gwarrior = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );   /* 5 * 64k for code and rom */
		ROM_LOAD_EVEN( "400-a06.15l",  0x00000, 0x08000, 0xb99d8cff );	ROM_LOAD_ODD ( "400-a04.10l",  0x00000, 0x08000, 0xd02c9552 );	ROM_LOAD_EVEN( "578-a07.17l",  0x80000, 0x20000, 0x0aedacb5 );	ROM_LOAD_ODD ( "578-a05.12l",  0x80000, 0x20000, 0x76240e2e );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
		ROM_LOAD(      "400-e03.5l",   0x00000, 0x02000, 0xa5a8e57d );
		ROM_REGION( 0x0200,  REGION_SOUND1 );     /* 2x 256 byte for 0005289 wavetable data */
		ROM_LOAD(      "400-a01.fse",  0x00000, 0x0100, 0x5827b1e8 );	ROM_LOAD(      "400-a02.fse",  0x00100, 0x0100, 0x2f44f970 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_salamand = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "18b.bin",      0x00000, 0x10000, 0xa42297f9 );	ROM_LOAD_ODD ( "18c.bin",      0x00000, 0x10000, 0xf9130b0a );	ROM_LOAD_EVEN( "17b.bin",      0x40000, 0x20000, 0xe5caf6e6 );	ROM_LOAD_ODD ( "17c.bin",      0x40000, 0x20000, 0xc2f567ea );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
		...
		ROM_LOAD(      "10a.bin",      0x00000, 0x20000, 0x09fe0632 );ROM_END(); }}; 
	
	static RomLoadPtr rom_lifefrce = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );   /* 64k for code */
		ROM_LOAD_EVEN( "587-k02.bin",  0x00000, 0x10000, 0x4a44da18 );	ROM_LOAD_ODD ( "587-k05.bin",  0x00000, 0x10000, 0x2f8c1cbd );	ROM_LOAD_EVEN( "17b.bin",      0x40000, 0x20000, 0xe5caf6e6 );	ROM_LOAD_ODD ( "17c.bin",      0x40000, 0x20000, 0xc2f567ea );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
	...
	static RomLoadPtr rom_lifefrcj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );   /* 64k for code */
		ROM_LOAD_EVEN( "587-n02.bin",  0x00000, 0x10000, 0x235dba71 );	ROM_LOAD_ODD ( "587-n05.bin",  0x00000, 0x10000, 0x054e569f );	ROM_LOAD_EVEN( "587-n03.bin",  0x40000, 0x20000, 0x9041f850 );	ROM_LOAD_ODD ( "587-n06.bin",  0x40000, 0x20000, 0xfba8b6aa );
		ROM_REGION( 0x10000, REGION_CPU2 );   /* 64k for sound */
