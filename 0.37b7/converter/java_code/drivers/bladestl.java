...
public class bladestl
{
	...
	static MemoryReadAddress bladestl_readmem_sound[] =
	{
		...
		new MemoryReadAddress( 0x4000, 0x4000, UPD7759_0_busy_r ),		/* UPD7759? */
	...
	***************************************************************************/
	...
	PORT_START(); 	/* DSW #1 */
		...
		PORT_DIPNAME( 0x18, 0x18, "Bonus time set" );	PORT_DIPSETTING(    0x18, "30 secs" );	PORT_DIPSETTING(    0x10, "20 secs" );	PORT_DIPSETTING(    0x08, "15 secs" );	PORT_DIPSETTING(    0x00, "10 secs" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		...
		/* Trackball 1P */
		PORT_START(); 
		PORT_ANALOG( 0xff, 0x00, IPT_TRACKBALL_Y | IPF_REVERSE | IPF_PLAYER1, 100, 63, 0, 0);	PORT_START(); 
		PORT_ANALOG( 0xff, 0x00, IPT_TRACKBALL_X | IPF_PLAYER1, 100, 63, 0, 0);
		/* Trackball 2P */
		PORT_START(); 
		PORT_ANALOG( 0xff, 0x00, IPT_TRACKBALL_Y | IPF_REVERSE | IPF_PLAYER2, 100, 63, 0, 0);	PORT_START(); 
		PORT_ANALOG( 0xff, 0x00, IPT_TRACKBALL_X | IPF_PLAYER2, 100, 63, 0, 0);INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bladestl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "797a05",	0x000000, 0x40000, 0x5491ba28 );/* tiles */
		ROM_LOAD( "797a06",	0x040000, 0x40000, 0xd055f5cc );/* sprites */
	
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "797a07", 0x0000, 0x0100, 0x7aecad4e );/* sprites lookup table */
		...
		ROM_LOAD( "797a04",	0x000000, 0x40000, 0x9ac8ea4e );ROM_END(); }}; 
