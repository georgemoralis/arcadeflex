...
public class mexico86
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_kikikai = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "a85-15.rom", 0x00000, 0x10000, 0xaebc8c32 );	ROM_LOAD( "a85-14.rom", 0x10000, 0x10000, 0xa9df0453 );	ROM_LOAD( "a85-13.rom", 0x20000, 0x10000, 0x3eeaf878 );	ROM_LOAD( "a85-12.rom", 0x30000, 0x10000, 0x91e58067 );
		ROM_REGION( 0x0300, REGION_PROMS );	ROM_LOAD( "a85-08.rom", 0x0000, 0x0100, 0xd15f61a8 );	ROM_LOAD( "a85-10.rom", 0x0100, 0x0100, 0x8fc3fa86 );	ROM_LOAD( "a85-09.rom", 0x0200, 0x0100, 0xb931c94d );ROM_END(); }}; 
	...
	static RomLoadPtr rom_kicknrun = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "a87-05.bin", 0x08000, 0x08000, 0x4eee3a8a );	ROM_CONTINUE(           0x00000, 0x08000 );	ROM_LOAD( "a87-04.bin", 0x10000, 0x08000, 0x8b438d20 );	ROM_RELOAD(             0x18000, 0x08000 );	ROM_LOAD( "a87-03.bin", 0x28000, 0x08000, 0xf42e8a88 );	ROM_CONTINUE(           0x20000, 0x08000 );	ROM_LOAD( "a87-02.bin", 0x30000, 0x08000, 0x64f1a85f );	ROM_RELOAD(             0x38000, 0x08000 );
		ROM_REGION( 0x0300, REGION_PROMS );	ROM_LOAD( "a87-10.bin", 0x0000, 0x0100, 0xbe6eb1f0 );	ROM_LOAD( "a87-12.bin", 0x0100, 0x0100, 0x3e953444 );	ROM_LOAD( "a87-11.bin", 0x0200, 0x0100, 0x14f6c28d );ROM_END(); }}; 
