...
public class popeye
{
	...
	static InputPortPtr input_ports_popeye = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_COIN1 );
		PORT_START(); 	/* DSW0 */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_popeye = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0800, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "v-5n",         0x0000, 0x0800, 0xcca61ddd );/* first half is empty */
		ROM_CONTINUE(             0x0000, 0x0800 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "v-1e",         0x0000, 0x2000, 0x0f2cd853 );	ROM_LOAD( "v-1f",         0x2000, 0x2000, 0x888f3474 );	ROM_LOAD( "v-1j",         0x4000, 0x2000, 0x7e864668 );	ROM_LOAD( "v-1k",         0x6000, 0x2000, 0x49e1d170 );
		ROM_REGION( 0x0340, REGION_PROMS );	ROM_LOAD( "prom-cpu.4a",  0x0000, 0x0020, 0x375e1602 );/* background palette */
	...
	static RomLoadPtr rom_popeyef = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "tpp2-c_f.7a",  0x0000, 0x2000, 0x5fc5264d );	ROM_LOAD( "tpp2-c_f.7b",  0x2000, 0x2000, 0x51de48e8 );	ROM_LOAD( "tpp2-c_f.7c",  0x4000, 0x2000, 0x62df9647 );	ROM_LOAD( "7e",           0x6000, 0x2000, 0xb64aa314 );
		ROM_REGION( 0x0800, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "v-5n",         0x0000, 0x0800, 0xcca61ddd );/* first half is empty */
		ROM_CONTINUE(             0x0000, 0x0800 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "v-1e",         0x0000, 0x2000, 0x0f2cd853 );	ROM_LOAD( "v-1f",         0x2000, 0x2000, 0x888f3474 );	ROM_LOAD( "v-1j",         0x4000, 0x2000, 0x7e864668 );	ROM_LOAD( "v-1k",         0x6000, 0x2000, 0x49e1d170 );
		ROM_REGION( 0x0340, REGION_PROMS );	ROM_LOAD( "prom-cpu.4a",  0x0000, 0x0020, 0x375e1602 );/* background palette */
	...
	static RomLoadPtr rom_popeyebl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(             0x0000, 0x0800 );
		ROM_REGION( 0x8000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "v-1e",         0x0000, 0x2000, 0x0f2cd853 );	ROM_LOAD( "v-1f",         0x2000, 0x2000, 0x888f3474 );	ROM_LOAD( "v-1j",         0x4000, 0x2000, 0x7e864668 );	ROM_LOAD( "v-1k",         0x6000, 0x2000, 0x49e1d170 );
		ROM_REGION( 0x0240, REGION_PROMS );	ROM_LOAD( "popeye.pr1",   0x0000, 0x0020, 0xd138e8a4 );/* background palette */
