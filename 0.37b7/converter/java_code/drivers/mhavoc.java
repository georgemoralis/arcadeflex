...
public class mhavoc
{
	...
	PORT_START(); 	/* IN0 - alpha (player_1 = 0) */
		PORT_BIT ( 0x0f, IP_ACTIVE_HIGH, IPT_UNKNOWN );	/* PORT_BIT ( 0x10, IP_ACTIVE_LOW, IPT_SERVICE, "Diag Step", KEYCODE_T, IP_JOY_NONE );*/
		PORT_BIT ( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX( 0x20, IP_ACTIVE_LOW, IPT_SERVICE, "Diag Step/Coin C", KEYCODE_F1, IP_JOY_NONE );	PORT_BIT ( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );/* Left Coin Switch  */
		PORT_BIT ( 0x80, IP_ACTIVE_LOW, IPT_COIN2 );/* Right Coin */
	
		PORT_START(); 	/* IN1 - gamma */
		PORT_BIT ( 0x0f, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT ( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT ( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT ( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT ( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 );
		PORT_START(); 	/* IN2 - gamma */
		PORT_ANALOG( 0xff, 0x00, IPT_DIAL | IPF_REVERSE, 100, 40, 0, 0 );
		PORT_START();  /* DIP Switch at position 13/14S */
		PORT_DIPNAME( 0x01, 0x00, "Adaptive Difficulty" );	PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x0c, "50000");	PORT_DIPSETTING(    0x00, "100000");	PORT_DIPSETTING(    0x04, "200000");	PORT_DIPSETTING(    0x08, "None");	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x10, "Easy");	PORT_DIPSETTING(    0x00, "Medium");	PORT_DIPSETTING(    0x30, "Hard");	PORT_DIPSETTING(    0x20, "Demo");	PORT_DIPNAME( 0xc0, 0x00, DEF_STR( "Lives") );
		...
		PORT_DIPNAME( 0x0c, 0x0c, "Right Coin Mechanism" );	PORT_DIPSETTING(    0x0c, "x1" );	PORT_DIPSETTING(    0x08, "x4" );	PORT_DIPSETTING(    0x04, "x5" );	PORT_DIPSETTING(    0x00, "x6" );	PORT_DIPNAME( 0x10, 0x10, "Left Coin Mechanism" );	PORT_DIPSETTING(    0x10, "x1" );	PORT_DIPSETTING(    0x00, "x2" );	PORT_DIPNAME( 0xe0, 0xe0, "Bonus Credits" );	PORT_DIPSETTING(    0x80, "2 each 4" );	PORT_DIPSETTING(    0x40, "1 each 3" );	PORT_DIPSETTING(    0xa0, "1 each 4" );	PORT_DIPSETTING(    0x60, "1 each 5" );	PORT_DIPSETTING(    0xe0, "None" );
		PORT_START(); 	/* IN5 - dummy for player_1 = 1 on alpha */
		PORT_BIT ( 0x3f, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_DIPNAME( 0x40, 0x40, "Credit to start" );	PORT_DIPSETTING(    0x40, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 - alpha (player_1 = 0) */
		...
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x01, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x03, "4" );	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x0c, "50000");	PORT_DIPSETTING(    0x00, "100000");	PORT_DIPSETTING(    0x04, "200000");	PORT_DIPSETTING(    0x08, "None");	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x10, "Easy");	PORT_DIPSETTING(    0x00, "Medium");	PORT_DIPSETTING(    0x30, "Hard");	PORT_DIPSETTING(    0x20, "Demo");	PORT_DIPNAME( 0xc0, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "3 (2 in Free Play);
		PORT_DIPSETTING(    0xc0, "4 (3 in Free Play);
	...
	static RomLoadPtr rom_mhavoc = new RomLoadPtr(){ public void handler(){ 
		...
		/* Program ROM */
		ROM_LOAD( "136025.216",   0x08000, 0x4000, 0x522a9cc0 );	ROM_LOAD( "136025.217",   0x0c000, 0x4000, 0xea3d6877 );
		/* Paged Program ROM */
		...
		ROM_LOAD( "136025.108",   0x08000, 0x4000, 0x93faf210 );	ROM_RELOAD(               0x0c000, 0x4000 );/* reset+interrupt vectors */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_mhavoc2 = new RomLoadPtr(){ public void handler(){ 
		/* Alpha Processor ROMs */
		ROM_REGION( 0x21000, REGION_CPU1 );	/* Vector Generator ROM */
		ROM_LOAD( "136025.110",   0x05000, 0x2000, 0x16eef583 );
		/* Program ROM */
		ROM_LOAD( "136025.103",   0x08000, 0x4000, 0xbf192284 );	ROM_LOAD( "136025.104",   0x0c000, 0x4000, 0x833c5d4e );
	...
	static RomLoadPtr rom_mhavocrv = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "136025.210",   0x05000, 0x2000, 0xc67284ca );
		/* Program ROM */
		ROM_LOAD( "136025.916",   0x08000, 0x4000, 0x1255bd7f );	ROM_LOAD( "136025.917",   0x0c000, 0x4000, 0x21889079 );
		/* Paged Program ROM */
		...
		/* Gamma Processor ROM */
		ROM_REGION( 0x10000, REGION_CPU2 );/* 16k for code */
		ROM_LOAD( "136025.908",   0x08000, 0x4000, 0xc52ec664 );	ROM_RELOAD(               0x0c000, 0x4000 );/* reset+interrupt vectors */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_mhavocp = new RomLoadPtr(){ public void handler(){ 
		...
		/* Program ROM */
		ROM_LOAD( "136025.016",   0x08000, 0x4000, 0x94caf6c0 );	ROM_LOAD( "136025.017",   0x0c000, 0x4000, 0x05cba70a );
		/* Paged Program ROM - switched to 2000-3fff */
		ROM_LOAD( "136025.015",   0x10000, 0x4000, 0xc567c11b );	ROM_LOAD( "136025.018",   0x14000, 0x4000, 0xa8c35ccd );
		/* Paged Vector Generator ROM */
		ROM_LOAD( "136025.006",   0x18000, 0x4000, 0xe272ed41 );	ROM_LOAD( "136025.007",   0x1c000, 0x4000, 0xe152c9d8 );
		/* the last 0x1000 is used for the 2 RAM pages */
	
		/* Gamma Processor ROM */
		ROM_REGION( 0x10000, REGION_CPU2 );/* 16k for code */
		ROM_LOAD( "136025.008",   0x8000, 0x4000, 0x22ea7399 );	ROM_RELOAD(               0xc000, 0x4000 );* reset+interrupt vectors */
	ROM_END(); }}; 
