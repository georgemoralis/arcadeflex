...
public class sf1
{
	...
	static MemoryWriteAddress writemem[] =
	{
		...
		new MemoryWriteAddress( 0xc00014, 0xc00015, sf1_bgm_scroll_w ),
		new MemoryWriteAddress( 0xc00018, 0xc00019, sf1_bgb_scroll_w ),
	...
	PORT_START(); 
		...
		PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x0100, 0x0100, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(      0x0100, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0200, 0x0200, "Attract music" );	PORT_DIPSETTING(      0x0200, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x1000, 0x1000, "Speed" );	PORT_DIPSETTING(      0x0000, "Slow" );	PORT_DIPSETTING(      0x1000, "Normal" );	PORT_DIPNAME( 0x2000, 0x2000, "Attract sound?" );	PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		...
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* Freezes the game ? */
	...
	static RomLoadPtr rom_sf1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	ROM_LOAD_EVEN("sfe-19", 0x00000, 0x10000, 0x8346c3ca );	ROM_LOAD_ODD ("sfe-22", 0x00000, 0x10000, 0x3a4bfaa8 );	ROM_LOAD_EVEN("sfe-20", 0x20000, 0x10000, 0xb40e67ee );	ROM_LOAD_ODD ("sfe-23", 0x20000, 0x10000, 0x477c3d5b );	ROM_LOAD_EVEN("sfe-21", 0x40000, 0x10000, 0x2547192b );	ROM_LOAD_ODD ("sfe-24", 0x40000, 0x10000, 0x79680f4e );
		...
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sf-39.bin", 0x000000, 0x020000, 0xcee3d292 );/* Background b planes 0-1*/
		...
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sf-25.bin", 0x000000, 0x020000, 0x7f23042e );/* Background m planes 0-1 */
		...
		ROM_REGION( 0x1c0000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sf-15.bin", 0x000000, 0x020000, 0xfc0113db );/* Sprites planes 1-2 */
		...
		ROM_REGION( 0x004000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sf-27.bin", 0x000000, 0x004000, 0x2b09b36d );/* Characters planes 1-2 */
		...
		ROM_REGION( 0x0320, REGION_PROMS );	ROM_LOAD( "mb7114h.12k",  0x0000, 0x0100, 0x75af3553 );/* unknown */
	...
	static RomLoadPtr rom_sf1us = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	ROM_LOAD_EVEN("sfd-19", 0x00000, 0x10000, 0xfaaf6255 );	ROM_LOAD_ODD ("sfd-22", 0x00000, 0x10000, 0xe1fe3519 );	ROM_LOAD_EVEN("sfd-20", 0x20000, 0x10000, 0x44b915bd );	ROM_LOAD_ODD ("sfd-23", 0x20000, 0x10000, 0x79c43ff8 );	ROM_LOAD_EVEN("sfd-21", 0x40000, 0x10000, 0xe8db799b );	ROM_LOAD_ODD ("sfd-24", 0x40000, 0x10000, 0x466a3440 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the music CPU */
		ROM_LOAD( "sf-02.bin", 0x0000, 0x8000, 0x4a9ac534 );
		ROM_REGION( 0x40000, REGION_CPU3 );/* 256k for the samples CPU */
		ROM_LOAD( "sfu-00",    0x00000, 0x20000, 0xa7cce903 );	ROM_LOAD( "sf-01.bin", 0x20000, 0x20000, 0x86e0f0d5 );
	...
	static RomLoadPtr rom_sf1jp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );	ROM_LOAD_EVEN("sf-19.bin", 0x00000, 0x10000, 0x116027d7 );	ROM_LOAD_ODD ("sf-22.bin", 0x00000, 0x10000, 0xd3cbd09e );	ROM_LOAD_EVEN("sf-20.bin", 0x20000, 0x10000, 0xfe07e83f );	ROM_LOAD_ODD ("sf-23.bin", 0x20000, 0x10000, 0x1e435d33 );	ROM_LOAD_EVEN("sf-21.bin", 0x40000, 0x10000, 0xe086bc4c );	ROM_LOAD_ODD ("sf-24.bin", 0x40000, 0x10000, 0x13a6696b );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the music CPU */
		ROM_LOAD( "sf-02.bin", 0x0000, 0x8000, 0x4a9ac534 );
		ROM_REGION( 0x40000, REGION_CPU3 );/* 256k for the samples CPU */
		...
		ROM_REGION( 0x40000, REGION_GFX5 );/* background tilemaps */
		ROM_LOAD( "sf-37.bin", 0x000000, 0x010000, 0x23d09d3d );	ROM_LOAD( "sf-36.bin", 0x010000, 0x010000, 0xea16df6c );	ROM_LOAD( "sf-32.bin", 0x020000, 0x010000, 0x72df2bd9 );	ROM_LOAD( "sf-33.bin", 0x030000, 0x010000, 0x3e99d3d5 );
		ROM_REGION( 0x0320, REGION_PROMS );	ROM_LOAD( "sfb05.bin",    0x0000, 0x0100, 0x864199ad );/* unknown */
	...
	public static GameDriver driver_sf1	   = new GameDriver("1987"	,"sf1"	,"sf1.java"	,rom_sf1,null	,machine_driver_sf1	,input_ports_sf1	,null	,ROT0	,	"Capcom", "Street Fighter (World)", GAME_NO_COCKTAIL )
	public static GameDriver driver_sf1us	   = new GameDriver("1987"	,"sf1us"	,"sf1.java"	,rom_sf1us,driver_sf1	,machine_driver_sf1us	,input_ports_sf1us	,null	,ROT0	,	"Capcom", "Street Fighter (US)", GAME_NO_COCKTAIL )
	public static GameDriver driver_sf1jp	   = new GameDriver("1987"	,"sf1jp"	,"sf1.java"	,rom_sf1jp,driver_sf1	,machine_driver_sf1jp	,input_ports_sf1jp	,null	,ROT0	,	"Capcom", "Street Fighter (Japan)", GAME_NO_COCKTAIL )
}
