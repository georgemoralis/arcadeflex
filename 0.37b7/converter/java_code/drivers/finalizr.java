...
public class finalizr
{
	...
	PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_VBLANK );
		PORT_START(); 	/* IN0 */
	...
	/* 	PORT_DIPSETTING(    0x00, "Invalid" );*/
		...
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPSETTING(    0x00, "7" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "30000 150000" );	PORT_DIPSETTING(    0x10, "50000 300000" );	PORT_DIPSETTING(    0x08, "30000" );	PORT_DIPSETTING(    0x00, "50000" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_finalizr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "523k01.9c",    0x4000, 0x4000, 0x716633cb );	ROM_LOAD( "523k02.12c",   0x8000, 0x4000, 0x1bccc696 );	ROM_LOAD( "523k03.13c",   0xc000, 0x4000, 0xc48927c6 );
		...
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "523h04.5e",    0x00000, 0x4000, 0xc056d710 );	ROM_LOAD( "523h05.6e",    0x04000, 0x4000, 0xae0d0f76 );	ROM_LOAD( "523h06.7e",    0x08000, 0x4000, 0xd2db9689 );	/* 0c000-0ffff empty */
		ROM_LOAD( "523h07.5f",    0x10000, 0x4000, 0x50e512ba );	ROM_LOAD( "523h08.6f",    0x14000, 0x4000, 0x79f44e17 );	ROM_LOAD( "523h09.7f",    0x18000, 0x4000, 0x8896dc85 );	/* 1c000-1ffff empty */
	
		ROM_REGION( 0x0240, REGION_PROMS );	ROM_LOAD( "523h10.2f",    0x0000, 0x0020, 0xec15dd15 );/* palette */
	...
	static RomLoadPtr rom_finalizb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x10000, REGION_CPU1 );/* 64k for code + 64k for decrypted opcodes */
		ROM_LOAD( "finalizr.5",   0x4000, 0x8000, 0xa55e3f14 );	ROM_LOAD( "finalizr.6",   0xc000, 0x4000, 0xce177f6e );
		ROM_REGION( 0x1000, REGION_CPU2 );/* 8039 */
