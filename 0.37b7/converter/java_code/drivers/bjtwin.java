...
public class bjtwin
{
	...
	PORT_START(); 		/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );/* shown in service mode, but no effect */
		...
		PORT_DIPNAME( 0x0e, 0x0e, "Starting level" );	PORT_DIPSETTING(    0x08, "  Germany" );	PORT_DIPSETTING(    0x04, " Thailand" );	PORT_DIPSETTING(    0x0c, "   Nevada" );	PORT_DIPSETTING(    0x0e, "    Japan" );	PORT_DIPSETTING(    0x06, "    Korea" );	PORT_DIPSETTING(    0x0a, "  England" );	PORT_DIPSETTING(    0x02, "Hong Kong" );	PORT_DIPSETTING(    0x00, "    China" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		...
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x40, "2" );	PORT_DIPSETTING(    0xc0, "3" );	PORT_DIPSETTING(    0x80, "4" );
		PORT_START(); 	/* DSW B */
	...
	//	new int[] { 24000, 24000 },	/* this fixes pitch but music breaks up */
	...
	static RomLoadPtr rom_bjtwin = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bjt.35",		0x000000, 0x010000, 0xAA13DF7C );/* 8x8 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bjt.32",		0x000000, 0x100000, 0x8A4F26D0 );/* 16x16 tiles */
	
		ROM_REGION( 0x100000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bjt.100",	0x000000, 0x100000, 0xBB06245D );/* Sprites */
		...
		ROM_LOAD( "bjt.127",    0x000000, 0x100000, 0x8DA67808 );ROM_END(); }}; 
