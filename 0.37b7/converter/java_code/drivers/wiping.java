...
public class wiping
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_wiping = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "8",            0x0000, 0x1000, 0x601160f6 );/* chars */
	
		ROM_REGION( 0x2000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "7",            0x0000, 0x2000, 0x2c2cc054 );/* sprites */
	
		ROM_REGION( 0x0220, REGION_PROMS );	ROM_LOAD( "wip-g13.bin",  0x0000, 0x0020, 0xb858b897 );/* palette */
	...
	static RomLoadPtr rom_rugrats = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x1000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rugr8d2",      0x0000, 0x1000, 0xa3dcaca5 );/* chars */
	
		ROM_REGION( 0x2000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rugr7c13",     0x0000, 0x2000, 0xfe1191dd );/* sprites */
	
		ROM_REGION( 0x0220, REGION_PROMS );	ROM_LOAD( "prom.13g",     0x0000, 0x0020, 0xf21238f0 );/* palette */
