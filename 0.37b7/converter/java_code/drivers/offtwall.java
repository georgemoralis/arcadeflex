...
public class offtwall
{
	...
	PORT_START(); 	/* 260000 */
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );
		PORT_START(); 	/* 260002 */
		PORT_BIT(  0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER3 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER3 );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER3 );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER3 );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER3 );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER3 );
		JSA_III_PORT	/* audio board port */
	
		PORT_START(); 	/* 260010 */
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x0002, 0x0000, "Controls" );	PORT_DIPSETTING(      0x0000, "Whirly-gigs" );/* this is official Atari terminology! */
		PORT_DIPSETTING(      0x0002, "Joysticks" );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_UNUSED );/* tested at a454 */
		PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_UNUSED );/* tested at a466 */
		PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_UNUSED );/* tested before writing to 260040 */
		PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT(  0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 260012 */
		PORT_BIT(  0xffff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 260020 */
	    PORT_ANALOG( 0xff, 0, IPT_DIAL_V | IPF_PLAYER1, 50, 10, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 260022 */
	    PORT_ANALOG( 0xff, 0, IPT_DIAL | IPF_PLAYER2, 50, 10, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 260024 */
	    PORT_ANALOG( 0xff, 0, IPT_DIAL_V | IPF_PLAYER3 | IPF_REVERSE, 50, 10, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_offtwall = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "otw2012.bin", 0x00000, 0x20000, 0xd08d81eb );	ROM_LOAD_ODD ( "otw2013.bin", 0x00000, 0x20000, 0x61c2553d );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "otw1020.bin", 0x10000, 0x4000, 0x488112a5 );	ROM_CONTINUE(            0x04000, 0xc000 );
		ROM_REGION( 0xc0000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "otw1014.bin", 0x000000, 0x20000, 0x4d64507e );	ROM_LOAD( "otw1016.bin", 0x020000, 0x20000, 0xf5454f3a );	ROM_LOAD( "otw1018.bin", 0x040000, 0x20000, 0x17864231 );	ROM_LOAD( "otw1015.bin", 0x060000, 0x20000, 0x271f7856 );	ROM_LOAD( "otw1017.bin", 0x080000, 0x20000, 0x7f7f8012 );	ROM_LOAD( "otw1019.bin", 0x0a0000, 0x20000, 0x9efe511b );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_offtwalc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "090-2612.rom", 0x00000, 0x20000, 0xfc891a3f );	ROM_LOAD_ODD ( "090-2613.rom", 0x00000, 0x20000, 0x805d79d4 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "otw1020.bin", 0x10000, 0x4000, 0x488112a5 );	ROM_CONTINUE(            0x04000, 0xc000 );
		ROM_REGION( 0xc0000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "090-1614.rom", 0x000000, 0x20000, 0x307ed447 );	ROM_LOAD( "090-1616.rom", 0x020000, 0x20000, 0xa5bd3d9b );	ROM_LOAD( "090-1618.rom", 0x040000, 0x20000, 0xc7d9df5d );	ROM_LOAD( "090-1615.rom", 0x060000, 0x20000, 0xac3642c7 );	ROM_LOAD( "090-1617.rom", 0x080000, 0x20000, 0x15208a89 );	ROM_LOAD( "090-1619.rom", 0x0a0000, 0x20000, 0x8a5d79b3 );ROM_END(); }}; 
