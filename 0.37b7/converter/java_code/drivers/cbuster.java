...
public class cbuster
{
	...
	public static ReadHandlerPtr twocrude_pf1_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf1_data[offset]);} };
	public static ReadHandlerPtr twocrude_pf2_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf2_data[offset]);} };
	public static ReadHandlerPtr twocrude_pf3_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf3_data[offset]);} };
	public static ReadHandlerPtr twocrude_pf4_data_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf4_data[offset]);} };
	public static ReadHandlerPtr twocrude_pf1_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf1_rowscroll[offset]);} };
	public static ReadHandlerPtr twocrude_pf2_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf2_rowscroll[offset]);} };
	public static ReadHandlerPtr twocrude_pf3_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf3_rowscroll[offset]);} };
	public static ReadHandlerPtr twocrude_pf4_rowscroll_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&twocrude_pf4_rowscroll[offset]);} };
	...
	PORT_START(); 	/* Player 1 controls */
		...
		PORT_DIPSETTING(    0x0c, "Normal" );	PORT_DIPSETTING(    0x08, "Easy" );	PORT_DIPSETTING(    0x04, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unused") );
	...
	static RomLoadPtr rom_cbuster = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
	  	ROM_LOAD_EVEN( "fx01.rom", 0x00000, 0x20000, 0xddae6d83 );	ROM_LOAD_ODD ( "fx00.rom", 0x00000, 0x20000, 0x5bc2c0de );  	ROM_LOAD_EVEN( "fx03.rom", 0x40000, 0x20000, 0xc3d65bf9 ); 	ROM_LOAD_ODD ( "fx02.rom", 0x40000, 0x20000, 0xb875266b );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "fu11-.rom",     0x00000, 0x10000, 0x65f20f10 );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "fu05-.rom",     0x00000, 0x10000, 0x8134d412 );/* Chars */
		ROM_LOAD( "fu06-.rom",     0x10000, 0x10000, 0x2f914a45 );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mab-01",        0x00000, 0x80000, 0x1080d619 );/* Tiles */
	
		ROM_REGION( 0x80000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mab-00",        0x00000, 0x80000, 0x660eaabd );/* Tiles */
	
		ROM_REGION( 0x180000,REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mab-02",        0x000000, 0x80000, 0x58b7231d );/* Sprites */
		/* Space for extra sprites to be copied to (0x20000) */
		ROM_LOAD( "mab-03",        0x0a0000, 0x80000, 0x76053b9d ); 	/* Space for extra sprites to be copied to (0x20000) */
		ROM_LOAD( "fu07-.rom",     0x140000, 0x10000, 0xca8d0bb3 );/* Extra sprites */
		ROM_LOAD( "fu08-.rom",     0x150000, 0x10000, 0xc6afc5c8 );	ROM_LOAD( "fu09-.rom",     0x160000, 0x10000, 0x526809ca );	ROM_LOAD( "fu10-.rom",     0x170000, 0x10000, 0x6be6d50e );
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "mb7114h.18e",   0x0000, 0x0100, 0x3645b70f );/* timing? (not used) */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_cbusterw = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
	  	ROM_LOAD_EVEN( "fu01-.rom", 0x00000, 0x20000, 0x0203e0f8 );	ROM_LOAD_ODD ( "fu00-.rom", 0x00000, 0x20000, 0x9c58626d );  	ROM_LOAD_EVEN( "fu03-.rom", 0x40000, 0x20000, 0xdef46956 ); 	ROM_LOAD_ODD ( "fu02-.rom", 0x40000, 0x20000, 0x649c3338 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "fu11-.rom",     0x00000, 0x10000, 0x65f20f10 );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "fu05-.rom",     0x00000, 0x10000, 0x8134d412 );/* Chars */
		ROM_LOAD( "fu06-.rom",     0x10000, 0x10000, 0x2f914a45 );
	...
	static RomLoadPtr rom_cbusterj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
	  	ROM_LOAD_EVEN( "fr01-1",   0x00000, 0x20000, 0xaf3c014f );	ROM_LOAD_ODD ( "fr00-1",   0x00000, 0x20000, 0xf666ad52 );  	ROM_LOAD_EVEN( "fr03",     0x40000, 0x20000, 0x02c06118 ); 	ROM_LOAD_ODD ( "fr02",     0x40000, 0x20000, 0xb6c34332 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "fu11-.rom",     0x00000, 0x10000, 0x65f20f10 );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "fu05-.rom",     0x00000, 0x10000, 0x8134d412 );/* Chars */
		ROM_LOAD( "fu06-.rom",     0x10000, 0x10000, 0x2f914a45 );
		...
		ROM_LOAD( "fr08",          0x150000, 0x10000, 0xea25fbac );	ROM_LOAD( "fr09",          0x160000, 0x10000, 0xf8363424 );	ROM_LOAD( "fr10",          0x170000, 0x10000, 0x241d5760 );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM samples */
		ROM_LOAD( "fu12-.rom",     0x00000, 0x20000, 0x2d1d65f2 );
		ROM_REGION( 0x20000, REGION_SOUND2 );/* ADPCM samples */
		ROM_LOAD( "fu13-.rom",     0x00000, 0x20000, 0xb8525622 );
	...
	static RomLoadPtr rom_twocrude = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "ft01",     0x00000, 0x20000, 0x08e96489 );	ROM_LOAD_ODD ( "ft00",     0x00000, 0x20000, 0x6765c445 );	ROM_LOAD_EVEN( "ft03",     0x40000, 0x20000, 0x28002c99 );	ROM_LOAD_ODD ( "ft02",     0x40000, 0x20000, 0x37ea0626 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "fu11-.rom",     0x00000, 0x10000, 0x65f20f10 );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "fu05-.rom",     0x00000, 0x10000, 0x8134d412 );/* Chars */
		ROM_LOAD( "fu06-.rom",     0x10000, 0x10000, 0x2f914a45 );
		...
		/* Space for extra sprites to be copied to (0x20000) */
		ROM_LOAD( "mab-03",        0x0a0000, 0x80000, 0x76053b9d ); 	/* Space for extra sprites to be copied to (0x20000) */
		ROM_LOAD( "ft07",          0x140000, 0x10000, 0xe3465c25 );	ROM_LOAD( "ft08",          0x150000, 0x10000, 0xc7f1d565 );	ROM_LOAD( "ft09",          0x160000, 0x10000, 0x6e3657b9 );	ROM_LOAD( "ft10",          0x170000, 0x10000, 0xcdb83560 );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM samples */
		ROM_LOAD( "fu12-.rom",     0x00000, 0x20000, 0x2d1d65f2 );
		ROM_REGION( 0x20000, REGION_SOUND2 );/* ADPCM samples */
		ROM_LOAD( "fu13-.rom",     0x00000, 0x20000, 0xb8525622 );
