...
public class tmnt
{
	...
	***************************************************************************/
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_DIPSETTING(    0x18, "30000 80000" );	PORT_DIPSETTING(    0x10, "50000 100000" );	PORT_DIPSETTING(    0x08, "50000" );	PORT_DIPSETTING(    0x00, "100000" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Character Test" );	PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START();       /* COINS */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN4 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_SERVICE2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_SERVICE3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_SERVICE4 );
		PORT_START();       /* PLAYER 1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* button 3 - unused */
		...
		PORT_START();       /* PLAYER 3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER3 | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER3 | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER3 | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER3 | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* button 3 - unused */
		...
		PORT_START();       /* PLAYER 4 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER4 | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER4 | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER4 | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER4 | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* button 3 - unused */
	...
	PORT_START(); 	/* DSW1/DSW2 */
		...
		PORT_DIPNAME( 0x0010, 0x0010, "Continue" );	PORT_DIPSETTING(      0x0010, "Normal" );	PORT_DIPSETTING(      0x0000, "1 Coin" );	PORT_DIPNAME( 0x0020, 0x0020, DEF_STR( "Unknown") );
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0300, 0x0300, "Energy" );	PORT_DIPSETTING(      0x0300, "30" );	PORT_DIPSETTING(      0x0200, "40" );	PORT_DIPSETTING(      0x0100, "50" );	PORT_DIPSETTING(      0x0000, "60" );	PORT_DIPNAME( 0x0c00, 0x0c00, "Period Length" );	PORT_DIPSETTING(      0x0c00, "2 Minutes" );	PORT_DIPSETTING(      0x0800, "3 Minutes" );	PORT_DIPSETTING(      0x0400, "4 Minutes" );	PORT_DIPSETTING(      0x0000, "5 Minutes" );	PORT_DIPNAME( 0x1000, 0x1000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x6000, 0x6000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x6000, "Easy" );	PORT_DIPSETTING(      0x4000, "Medium" );	PORT_DIPSETTING(      0x2000, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x8000, 0x0000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	
		PORT_START(); 	/* COIN/DSW3 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_COIN4 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_SERVICE2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_SERVICE3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_SERVICE4 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x1000, 0x1000, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_SERVICE( 0x4000, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x8000, 0x8000, "Freeze" );	PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	
		PORT_START(); 	/* IN0/IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN2/IN3 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* DSW1/DSW2 */
		...
		PORT_DIPSETTING(      0x0080, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0300, 0x0300, "Energy" );	PORT_DIPSETTING(      0x0300, "40" );	PORT_DIPSETTING(      0x0200, "50" );	PORT_DIPSETTING(      0x0100, "60" );	PORT_DIPSETTING(      0x0000, "70" );	PORT_DIPNAME( 0x0c00, 0x0c00, "Period Length" );	PORT_DIPSETTING(      0x0c00, "3 Minutes" );	PORT_DIPSETTING(      0x0800, "4 Minutes" );	PORT_DIPSETTING(      0x0400, "5 Minutes" );	PORT_DIPSETTING(      0x0000, "6 Minutes" );	PORT_DIPNAME( 0x1000, 0x1000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x6000, 0x6000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x6000, "Easy" );	PORT_DIPSETTING(      0x4000, "Medium" );	PORT_DIPSETTING(      0x2000, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x8000, 0x0000, DEF_STR( "Demo_Sounds") );
		...
		PORT_START(); 	/* COIN/DSW3 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x1000, 0x1000, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* vblank? checked during boot */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x18, 0x18, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "100000 400000" );	PORT_DIPSETTING(    0x10, "150000 500000" );	PORT_DIPSETTING(    0x08, "200000" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x00, "Sound" );	PORT_DIPSETTING(    0x02, "Mono" );	PORT_DIPSETTING(    0x00, "Stereo" );	PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* COIN */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BITX(0x08, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );/* VBLANK? OBJMPX? */
		...
		PORT_BIT( 0xfc, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_glfgreat = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER3 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER4 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER4 );
		PORT_START(); 
	...
	//	PORT_DIPSETTING(      0x0000, "Invalid" );	PORT_DIPNAME( 0x0300, 0x0100, "Players/Controllers" );	PORT_DIPSETTING(      0x0300, "4/1" );	PORT_DIPSETTING(      0x0200, "4/2" );	PORT_DIPSETTING(      0x0100, "4/4" );	PORT_DIPSETTING(      0x0000, "3/3" );	PORT_DIPNAME( 0x0400, 0x0000, "Sound" );	PORT_DIPSETTING(      0x0400, "Mono" );	PORT_DIPSETTING(      0x0000, "Stereo" );	PORT_DIPNAME( 0x1800, 0x1800, "Initial/Maximum Credit" );	PORT_DIPSETTING(      0x1800, "2/3" );	PORT_DIPSETTING(      0x1000, "2/4" );	PORT_DIPSETTING(      0x0800, "2/5" );	PORT_DIPSETTING(      0x0000, "3/5" );	PORT_DIPNAME( 0x6000, 0x4000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x6000, "Easy" );	PORT_DIPSETTING(      0x4000, "Normal" );	PORT_DIPSETTING(      0x2000, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x8000, 0x0000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_COIN4 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_SERVICE1 );/* service coin */
		PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BITX(0x0400, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		...
		PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	//	PORT_SERVICE( 0x4000, IP_ACTIVE_LOW );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_DIPNAME( 0x8000, 0x8000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BITX(0x0800, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		...
		PORT_START(); 	/* EEPROM and service */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0100, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* EEPROM data */
		PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN );/* EEPROM status? - always 1 */
		PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );/* VBLK?? */
		PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_mia = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "808t20.h17",   0x00000, 0x20000, 0x6f0acb1d );	ROM_LOAD_ODD ( "808t21.j17",   0x00000, 0x20000, 0x42a30416 );
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "808a18.f16",   0x0000, 0x0100, 0xeb95aede );/* priority encoder (not used) */
	...
	static RomLoadPtr rom_mia2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 2*128k and 2*64k for 68000 code */
		ROM_LOAD_EVEN( "808s20.h17",   0x00000, 0x20000, 0xcaa2897f );	ROM_LOAD_ODD ( "808s21.j17",   0x00000, 0x20000, 0x3d892ffb );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "808e03.f4",    0x00000, 0x08000, 0x3d93a7cd );
		ROM_REGION( 0x40000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD_GFX_EVEN( "808e12.f28",   0x000000, 0x10000, 0xd62f1fde )        /* 8x8 tiles */
	...
	static RomLoadPtr rom_tmnt = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "963-r23",      0x00000, 0x20000, 0xa7f61195 );	ROM_LOAD_ODD ( "963-r24",      0x00000, 0x20000, 0x661e056a );	ROM_LOAD_EVEN( "963-r21",      0x40000, 0x10000, 0xde047bb6 );	ROM_LOAD_ODD ( "963-r22",      0x40000, 0x10000, 0xd86a0888 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		...
		ROM_REGION( 0x0200, REGION_PROMS );	ROM_LOAD( "tmnt.g7",      0x0000, 0x0100, 0xabd82680 );/* sprite address decoder */
		...
		ROM_LOAD( "963-a25",      0x00000, 0x80000, 0xfca078c7 );ROM_END(); }}; 
	
	static RomLoadPtr rom_tmht = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 2*128k and 2*64k for 68000 code */
		ROM_LOAD_EVEN( "963f23.j17",   0x00000, 0x20000, 0x9cb5e461 );	ROM_LOAD_ODD ( "963f24.k17",   0x00000, 0x20000, 0x2d902fab );	ROM_LOAD_EVEN( "963f21.j15",   0x40000, 0x10000, 0x9fa25378 );	ROM_LOAD_ODD ( "963f22.k15",   0x40000, 0x10000, 0x2127ee53 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "963-e20",      0x00000, 0x08000, 0x1692a6d6 );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "963-a28",      0x000000, 0x80000, 0xdb4769a8 );       /* 8x8 tiles */
	...
	static RomLoadPtr rom_tmntj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 2*128k and 2*64k for 68000 code */
		ROM_LOAD_EVEN( "963-x23",      0x00000, 0x20000, 0xa9549004 );	ROM_LOAD_ODD ( "963-x24",      0x00000, 0x20000, 0xe5cc9067 );	ROM_LOAD_EVEN( "963-x21",      0x40000, 0x10000, 0x5789cf92 );	ROM_LOAD_ODD ( "963-x22",      0x40000, 0x10000, 0x0a74e277 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "963-e20",      0x00000, 0x08000, 0x1692a6d6 );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "963-a28",      0x000000, 0x80000, 0xdb4769a8 );       /* 8x8 tiles */
	...
	static RomLoadPtr rom_tmht2p = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 2*128k and 2*64k for 68000 code */
		ROM_LOAD_EVEN( "963-u23",      0x00000, 0x20000, 0x58bec748 );	ROM_LOAD_ODD ( "963-u24",      0x00000, 0x20000, 0xdce87c8d );	ROM_LOAD_EVEN( "963-u21",      0x40000, 0x10000, 0xabce5ead );	ROM_LOAD_ODD ( "963-u22",      0x40000, 0x10000, 0x4ecc8d6b );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "963-e20",      0x00000, 0x08000, 0x1692a6d6 );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "963-a28",      0x000000, 0x80000, 0xdb4769a8 );       /* 8x8 tiles */
	...
	static RomLoadPtr rom_tmnt2pj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 2*128k and 2*64k for 68000 code */
		ROM_LOAD_EVEN( "963-123",      0x00000, 0x20000, 0x6a3527c9 );	ROM_LOAD_ODD ( "963-124",      0x00000, 0x20000, 0x2c4bfa15 );	ROM_LOAD_EVEN( "963-121",      0x40000, 0x10000, 0x4181b733 );	ROM_LOAD_ODD ( "963-122",      0x40000, 0x10000, 0xc64eb5ff );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "963-e20",      0x00000, 0x08000, 0x1692a6d6 );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "963-a28",      0x000000, 0x80000, 0xdb4769a8 );       /* 8x8 tiles */
	...
	static RomLoadPtr rom_tmnt2po = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 2*128k and 2*64k for 68000 code */
		ROM_LOAD_EVEN( "tmnt123.bin",  0x00000, 0x20000, 0x2d905183 );	ROM_LOAD_ODD ( "tmnt124.bin",  0x00000, 0x20000, 0xe0125352 );	ROM_LOAD_EVEN( "tmnt21.bin",   0x40000, 0x10000, 0x12deeafb );	ROM_LOAD_ODD ( "tmnt22.bin",   0x40000, 0x10000, 0xaec4f1c3 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "963-e20",      0x00000, 0x08000, 0x1692a6d6 );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "963-a28",      0x000000, 0x80000, 0xdb4769a8 );       /* 8x8 tiles */
	...
	static RomLoadPtr rom_punkshot = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "907-j02.i7",   0x00000, 0x20000, 0xdbb3a23b );	ROM_LOAD_ODD ( "907-j03.i10",  0x00000, 0x20000, 0x2151d1ab );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "907f01.e8",    0x0000, 0x8000, 0xf040c484 );
		ROM_REGION( 0x80000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "907d06.e23",   0x000000, 0x40000, 0xf5cc38f4 );	ROM_LOAD( "907d05.e22",   0x040000, 0x40000, 0xe25774c1 );
		ROM_REGION( 0x200000, REGION_GFX2 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "907d07l.k2",   0x000000, 0x80000, 0xfeeb345a );	ROM_LOAD( "907d07h.k2",   0x080000, 0x80000, 0x0bff4383 );	ROM_LOAD( "907d08l.k7",   0x100000, 0x80000, 0x05f3d196 );	ROM_LOAD( "907d08h.k7",   0x180000, 0x80000, 0xeaf18c22 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* samples for 053260 */
		ROM_LOAD( "907d04.d3",    0x0000, 0x80000, 0x090feb5e );ROM_END(); }}; 
	
	static RomLoadPtr rom_punksht2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "907m02.i7",    0x00000, 0x20000, 0x59e14575 );	ROM_LOAD_ODD ( "907m03.i10",   0x00000, 0x20000, 0xadb14b1e );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "907f01.e8",    0x0000, 0x8000, 0xf040c484 );
		ROM_REGION( 0x80000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "907d06.e23",   0x000000, 0x40000, 0xf5cc38f4 );	ROM_LOAD( "907d05.e22",   0x040000, 0x40000, 0xe25774c1 );
	...
	static RomLoadPtr rom_lgtnfght = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "939m02.e11",   0x00000, 0x20000, 0x61a12184 );	ROM_LOAD_ODD ( "939m03.e15",   0x00000, 0x20000, 0x6db6659d );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "939e01.d7",    0x0000, 0x8000, 0x4a5fc848 );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "939a07.k14",   0x000000, 0x80000, 0x7955dfcf );	ROM_LOAD( "939a08.k19",   0x080000, 0x80000, 0xed95b385 );
		ROM_REGION( 0x100000, REGION_GFX2 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "939a06.k8",    0x000000, 0x80000, 0xe393c206 );	ROM_LOAD( "939a05.k2",    0x080000, 0x80000, 0x3662d47a );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* samples for the 053260 */
		ROM_LOAD( "939a04.c5",    0x0000, 0x80000, 0xc24e2b6e );ROM_END(); }}; 
	
	static RomLoadPtr rom_trigon = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "939j02.bin",   0x00000, 0x20000, 0x38381d1b );	ROM_LOAD_ODD ( "939j03.bin",   0x00000, 0x20000, 0xb5beddcd );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "939e01.d7",    0x0000, 0x8000, 0x4a5fc848 );
		ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "939a07.k14",   0x000000, 0x80000, 0x7955dfcf );	ROM_LOAD( "939a08.k19",   0x080000, 0x80000, 0xed95b385 );
	...
	static RomLoadPtr rom_blswhstl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );	ROM_LOAD_EVEN( "e09.bin",     0x000000, 0x20000, 0xe8b7b234 );	ROM_LOAD_ODD ( "g09.bin",     0x000000, 0x20000, 0x3c26d281 );	ROM_LOAD_EVEN( "e11.bin",     0x040000, 0x20000, 0x14628736 );	ROM_LOAD_ODD ( "g11.bin",     0x040000, 0x20000, 0xf738ad4a );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		...
		ROM_LOAD( "060_e04.r16",  0x0000, 0x100000, 0xc680395d );ROM_END(); }}; 
	
	static RomLoadPtr rom_detatwin = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );	ROM_LOAD_EVEN( "060_j02.rom", 0x000000, 0x20000, 0x11b761ac );	ROM_LOAD_ODD ( "060_j03.rom", 0x000000, 0x20000, 0x8d0b588c );	ROM_LOAD_EVEN( "060_j09.rom", 0x040000, 0x20000, 0xf2a5f15f );	ROM_LOAD_ODD ( "060_j10.rom", 0x040000, 0x20000, 0x36eefdbc );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "060_j01.rom",  0x0000, 0x10000, 0xf9d9a673 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD_GFX_SWAP( "060_e07.r16",  0x000000, 0x080000, 0xc400edf3 )	/* tiles */
	...
	static RomLoadPtr rom_glfgreat = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "061l02.1h",   0x000000, 0x20000, 0xac7399f4 );	ROM_LOAD_ODD ( "061l03.4h",   0x000000, 0x20000, 0x77b0ff5c );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		...
		ROM_LOAD( "061b06.16d",   0x080000, 0x080000, 0x41ada2ad );	ROM_LOAD( "061b07.18d",   0x100000, 0x080000, 0x517887e2 );	ROM_LOAD( "061b08.14g",   0x180000, 0x080000, 0x6ab739c3 );	ROM_LOAD( "061b09.15g",   0x200000, 0x080000, 0x42c7a603 );	ROM_LOAD( "061b10.17g",   0x280000, 0x080000, 0x10f89ce7 );
		ROM_REGION( 0x100000, REGION_SOUND1 );/* samples for the 053260 */
		ROM_LOAD( "061e04.1d",    0x0000, 0x100000, 0x7921d8df );ROM_END(); }}; 
	
	static RomLoadPtr rom_glfgretj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "061j02.1h",   0x000000, 0x20000, 0x7f0d95f4 );	ROM_LOAD_ODD ( "061j03.4h",   0x000000, 0x20000, 0x06caa38b );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "061f01.4e",    0x0000, 0x8000, 0xab9a2a57 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "061d14.12l",   0x000000, 0x080000, 0xb9440924 );/* tiles */
	...
	static RomLoadPtr rom_tmnt2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );	ROM_LOAD_EVEN( "uaa02", 0x000000, 0x20000, 0x58d5c93d );	ROM_LOAD_ODD ( "uaa03", 0x000000, 0x20000, 0x0541fec9 );	ROM_LOAD_EVEN( "uaa04", 0x040000, 0x20000, 0x1d441a7d );	ROM_LOAD_ODD ( "uaa05", 0x040000, 0x20000, 0x9c428273 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		...
		ROM_LOAD( "b10",          0x100000, 0x080000, 0xf2dd296e );	/* second half empty */
		ROM_LOAD( "b07",          0x200000, 0x100000, 0xd9bee7bf );	ROM_LOAD( "b08",          0x300000, 0x080000, 0x3b1ae36f );	/* second half empty */
	
		ROM_REGION( 0x200000, REGION_SOUND1 );/* samples for the 053260 */
		ROM_LOAD( "063b06",       0x0000, 0x200000, 0x1e510aa5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_tmnt22p = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );	ROM_LOAD_EVEN( "a02",   0x000000, 0x20000, 0xaadffe3a );	ROM_LOAD_ODD ( "a03",   0x000000, 0x20000, 0x125687a8 );	ROM_LOAD_EVEN( "a04",   0x040000, 0x20000, 0xfb5c7ded );	ROM_LOAD_ODD ( "a05",   0x040000, 0x20000, 0x3c40fe66 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "b01",          0x0000, 0x10000, 0x364f548a );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "b12",          0x000000, 0x080000, 0xd3283d19 );/* tiles */
	...
	static RomLoadPtr rom_tmnt2a = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );	ROM_LOAD_EVEN( "ada02", 0x000000, 0x20000, 0x4f11b587 );	ROM_LOAD_ODD ( "ada03", 0x000000, 0x20000, 0x82a1b9ac );	ROM_LOAD_EVEN( "ada04", 0x040000, 0x20000, 0x05ad187a );	ROM_LOAD_ODD ( "ada05", 0x040000, 0x20000, 0xd4826547 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "b01",          0x0000, 0x10000, 0x364f548a );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "b12",          0x000000, 0x080000, 0xd3283d19 );/* tiles */
	...
	static RomLoadPtr rom_ssriders = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "064eac02",    0x000000, 0x40000, 0x5a5425f4 );	ROM_LOAD_ODD ( "064eac03",    0x000000, 0x40000, 0x093c00fb );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		...
		ROM_REGION( 0x100000, REGION_SOUND1 );/* samples for the 053260 */
		ROM_LOAD( "sr_1d.rom",    0x0000, 0x100000, 0x59810df9 );ROM_END(); }}; 
	
	static RomLoadPtr rom_ssrdrebd = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "064ebd02",    0x000000, 0x40000, 0x8deef9ac );	ROM_LOAD_ODD ( "064ebd03",    0x000000, 0x40000, 0x2370c107 );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "sr_e01.rom",   0x0000, 0x10000, 0x44b9bc52 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "sr_16k.rom",   0x000000, 0x080000, 0xe2bdc619 );/* tiles */
	...
	static RomLoadPtr rom_ssrdrebc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "sr_c02.rom",  0x000000, 0x40000, 0x9bd7d164 );	ROM_LOAD_ODD ( "sr_c03.rom",  0x000000, 0x40000, 0x40fd4165 );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "sr_e01.rom",   0x0000, 0x10000, 0x44b9bc52 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "sr_16k.rom",   0x000000, 0x080000, 0xe2bdc619 );/* tiles */
	...
	static RomLoadPtr rom_ssrdruda = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "064uda02",    0x000000, 0x40000, 0x5129a6b7 );	ROM_LOAD_ODD ( "064uda03",    0x000000, 0x40000, 0x9f887214 );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "sr_e01.rom",   0x0000, 0x10000, 0x44b9bc52 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "sr_16k.rom",   0x000000, 0x080000, 0xe2bdc619 );/* tiles */
	...
	static RomLoadPtr rom_ssrdruac = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "064uac02",    0x000000, 0x40000, 0x870473b6 );	ROM_LOAD_ODD ( "064uac03",    0x000000, 0x40000, 0xeadf289a );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "sr_e01.rom",   0x0000, 0x10000, 0x44b9bc52 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "sr_16k.rom",   0x000000, 0x080000, 0xe2bdc619 );/* tiles */
	...
	static RomLoadPtr rom_ssrdrubc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "2pl.8e",      0x000000, 0x40000, 0xaca7fda5 );	ROM_LOAD_ODD ( "2pl.8g",      0x000000, 0x40000, 0xbb1fdeff );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "sr_e01.rom",   0x0000, 0x10000, 0x44b9bc52 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "sr_16k.rom",   0x000000, 0x080000, 0xe2bdc619 );/* tiles */
	...
	static RomLoadPtr rom_ssrdrabd = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "064abd02.8e", 0x000000, 0x40000, 0x713406cb );	ROM_LOAD_ODD ( "064abd03.8g", 0x000000, 0x40000, 0x680feb3c );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "sr_e01.rom",   0x0000, 0x10000, 0x44b9bc52 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "sr_16k.rom",   0x000000, 0x080000, 0xe2bdc619 );/* tiles */
	...
	static RomLoadPtr rom_ssrdrjbd = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );	ROM_LOAD_EVEN( "064jbd02.8e", 0x000000, 0x40000, 0x7acdc1e3 );	ROM_LOAD_ODD ( "064jbd03.8g", 0x000000, 0x40000, 0x6a424918 );	ROM_LOAD_EVEN( "sr_b04.rom",  0x080000, 0x20000, 0xef2315bd );	ROM_LOAD_ODD ( "sr_b05.rom",  0x080000, 0x20000, 0x51d6fbc4 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "sr_e01.rom",   0x0000, 0x10000, 0x44b9bc52 );
	    ROM_REGION( 0x100000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "sr_16k.rom",   0x000000, 0x080000, 0xe2bdc619 );/* tiles */
	...
	static RomLoadPtr rom_thndrx2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "073-k02.11c", 0x000000, 0x20000, 0x0c8b2d3f );	ROM_LOAD_ODD ( "073-k03.12c", 0x000000, 0x20000, 0x3803b427 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
