...
public class superqix
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_superqix = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sq04.2",       0x00000, 0x08000, 0xf815ef45 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sq03.3",       0x00000, 0x10000, 0x6e8b6a67 );	ROM_LOAD( "sq06.14",      0x10000, 0x10000, 0x38154517 );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sq05.1",       0x00000, 0x10000, 0xdf326540 );
	...
	static RomLoadPtr rom_sqixbl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sq04.2",       0x00000, 0x08000, 0xf815ef45 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sq03.3",       0x00000, 0x10000, 0x6e8b6a67 );	ROM_LOAD( "sq06.14",      0x10000, 0x10000, 0x38154517 );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sq05.1",       0x00000, 0x10000, 0xdf326540 );ROM_END(); }}; 
