...
public class blockhl
{
	...
	***************************************************************************/
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Unknown") );
		...
		PORT_START(); 	/* DSW #3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_SERVICE( 0x40, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_blockhl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "973l02.e21", 0x10000, 0x08000, 0xe14f849a );	ROM_CONTINUE(           0x08000, 0x08000 );
	...
	static RomLoadPtr rom_quarth = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x18800, REGION_CPU1 );/* code + banked roms + space for banked RAM */
		ROM_LOAD( "973j02.e21", 0x10000, 0x08000, 0x27a90118 );	ROM_CONTINUE(           0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the sound CPU */
		ROM_LOAD( "973d01.g6",  0x0000, 0x8000, 0xeeee9d92 );
		ROM_REGION( 0x20000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
