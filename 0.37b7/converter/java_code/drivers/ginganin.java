...
public class ginganin
{
	...
	*/
	...
	static InputPortPtr input_ports_ginganin = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_START2 );
		...
		PORT_BITX(    0x0040, 0x0040, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Infinite Lives", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(      0x0040, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_BITX(    0x0080, 0x0080, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Free Play & Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(      0x0080, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	
		PORT_DIPNAME( 0x0300, 0x0300, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0000, "2");	PORT_DIPSETTING(      0x0300, "3");	PORT_DIPSETTING(      0x0100, "4");	PORT_DIPSETTING(      0x0200, "5");	PORT_DIPNAME( 0x0400, 0x0400, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_BITX(    0x8000, 0x8000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Freeze", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_ginganin = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "gn_02.bin", 0x00000, 0x10000, 0x4a4e012f );	ROM_LOAD_ODD(  "gn_01.bin", 0x00000, 0x10000, 0x30256fcb );
		ROM_REGION( 0x10000, REGION_CPU2 );/* sound cpu */
		ROM_LOAD( "gn_05.bin", 0x00000, 0x10000, 0xe76e10e7 );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gn_15.bin", 0x000000, 0x10000, 0x1b8ac9fb );// bg
		ROM_LOAD( "gn_14.bin", 0x010000, 0x10000, 0xe73fe668 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gn_12.bin", 0x000000, 0x10000, 0xc134a1e9 );// fg
		ROM_LOAD( "gn_13.bin", 0x010000, 0x10000, 0x1d3bec21 );
		ROM_REGION( 0x04000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gn_10.bin", 0x000000, 0x04000, 0xae371b2d );// txt
	
		ROM_REGION( 0x50000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gn_06.bin", 0x000000, 0x10000, 0xbdc65835 );// sprites
		ROM_CONTINUE(          0x040000, 0x10000 );	ROM_LOAD( "gn_07.bin", 0x010000, 0x10000, 0xc2b8eafe );	ROM_LOAD( "gn_08.bin", 0x020000, 0x10000, 0xf7c73c18 );	ROM_LOAD( "gn_09.bin", 0x030000, 0x10000, 0xa5e07c3b );
		...
		ROM_LOAD( "gn_04.bin", 0x00000, 0x10000, 0x0ed9133b );	ROM_LOAD( "gn_03.bin", 0x10000, 0x10000, 0xf1ba222c );
	ROM_END(); }}; 
