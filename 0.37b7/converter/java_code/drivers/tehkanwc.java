...
public class tehkanwc
{
	...
	public static timer_callback reset_callback = new timer_callback() { public void handler(int param) 
	{
	...
	PORT_START();  /* DSW1 - Active LOW */
		...
		PORT_DIPNAME( 0x40, 0x40, "Extra Time per Coin" );	PORT_DIPSETTING (   0x40, "Normal" );	PORT_DIPSETTING (   0x00, "Double" );	PORT_DIPNAME( 0x80, 0x80, "1 Player Start" );	PORT_DIPSETTING (   0x00, "2 Credits" );	PORT_DIPSETTING (   0x80, "1 Credit" );
		PORT_START();  /* DSW2 - Active LOW */
		PORT_DIPNAME( 0x03, 0x03, "1P Game Time" );	PORT_DIPSETTING (   0x00, "2:30" );	PORT_DIPSETTING (   0x01, "2:00" );	PORT_DIPSETTING (   0x03, "1:30" );	PORT_DIPSETTING (   0x02, "1:00" );	PORT_DIPNAME( 0x7c, 0x7c, "2P Game Time" );	PORT_DIPSETTING (   0x00, "5:00/3:00 Extra" );	PORT_DIPSETTING (   0x60, "5:00/2:45 Extra" );	PORT_DIPSETTING (   0x20, "5:00/2:35 Extra" );	PORT_DIPSETTING (   0x40, "5:00/2:30 Extra" );	PORT_DIPSETTING (   0x04, "4:00/2:30 Extra" );	PORT_DIPSETTING (   0x64, "4:00/2:15 Extra" );	PORT_DIPSETTING (   0x24, "4:00/2:05 Extra" );	PORT_DIPSETTING (   0x44, "4:00/2:00 Extra" );	PORT_DIPSETTING (   0x1c, "3:30/2:15 Extra" );	PORT_DIPSETTING (   0x7c, "3:30/2:00 Extra" );	PORT_DIPSETTING (   0x3c, "3:30/1:50 Extra" );	PORT_DIPSETTING (   0x5c, "3:30/1:45 Extra" );	PORT_DIPSETTING (   0x08, "3:00/2:00 Extra" );	PORT_DIPSETTING (   0x68, "3:00/1:45 Extra" );	PORT_DIPSETTING (   0x28, "3:00/1:35 Extra" );	PORT_DIPSETTING (   0x48, "3:00/1:30 Extra" );	PORT_DIPSETTING (   0x0c, "2:30/1:45 Extra" );	PORT_DIPSETTING (   0x6c, "2:30/1:30 Extra" );	PORT_DIPSETTING (   0x2c, "2:30/1:20 Extra" );	PORT_DIPSETTING (   0x4c, "2:30/1:15 Extra" );	PORT_DIPSETTING (   0x10, "2:00/1:30 Extra" );	PORT_DIPSETTING (   0x70, "2:00/1:15 Extra" );	PORT_DIPSETTING (   0x30, "2:00/1:05 Extra" );	PORT_DIPSETTING (   0x50, "2:00/1:00 Extra" );	PORT_DIPSETTING (   0x14, "1:30/1:15 Extra" );	PORT_DIPSETTING (   0x74, "1:30/1:00 Extra" );	PORT_DIPSETTING (   0x34, "1:30/0:50 Extra" );	PORT_DIPSETTING (   0x54, "1:30/0:45 Extra" );	PORT_DIPSETTING (   0x18, "1:00/1:00 Extra" );	PORT_DIPSETTING (   0x78, "1:00/0:45 Extra" );	PORT_DIPSETTING (   0x38, "1:00/0:35 Extra" );	PORT_DIPSETTING (   0x58, "1:00/0:30 Extra" );	PORT_DIPNAME( 0x80, 0x80, "Game Type" );	PORT_DIPSETTING (   0x80, "Timer In" );	PORT_DIPSETTING (   0x00, "Credit In" );
		PORT_START();  /* DSW3 - Active LOW */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Difficulty") );
		PORT_DIPSETTING (   0x02, "Easy" );	PORT_DIPSETTING (   0x03, "Normal" );	PORT_DIPSETTING (   0x01, "Hard" );	PORT_DIPSETTING (   0x00, "Very Hard" );	PORT_DIPNAME( 0x04, 0x04, "Timer Speed" );	PORT_DIPSETTING (   0x04, "60/60" );	PORT_DIPSETTING (   0x00, "55/60" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Demo_Sounds") );
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START2 );
		PORT_START(); 	/* fake port to emulate trackballs with keyboard */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );INPUT_PORTS_END(); }}; 
	
	
	static InputPortPtr input_ports_gridiron = new InputPortPtr(){ public void handler() { 
	PORT_START();  /* DSW1 - Active LOW */
		PORT_DIPNAME( 0x01, 0x01, "1 Player Start" );	PORT_DIPSETTING (   0x00, "2 Credits" );	PORT_DIPSETTING (   0x01, "1 Credit" );	PORT_DIPNAME( 0x02, 0x02, "2 Players Start" );	PORT_DIPSETTING (   0x02, "2 Credits" );	PORT_DIPSETTING (   0x00, "1 Credit" );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unknown") );
		PORT_DIPSETTING (   0x00, DEF_STR( "Off") );
		...
		PORT_START();  /* DSW2 - Active LOW */
		PORT_DIPNAME( 0x03, 0x03, "1P Game Time" );	PORT_DIPSETTING (   0x00, "2:30" );	PORT_DIPSETTING (   0x01, "2:00" );	PORT_DIPSETTING (   0x03, "1:30" );	PORT_DIPSETTING (   0x02, "1:00" );	PORT_DIPNAME( 0x7c, 0x7c, "2P Game Time" );	PORT_DIPSETTING (   0x60, "5:00/3:00 Extra" );	PORT_DIPSETTING (   0x00, "5:00/2:45 Extra" );	PORT_DIPSETTING (   0x20, "5:00/2:35 Extra" );	PORT_DIPSETTING (   0x40, "5:00/2:30 Extra" );	PORT_DIPSETTING (   0x64, "4:00/2:30 Extra" );	PORT_DIPSETTING (   0x04, "4:00/2:15 Extra" );	PORT_DIPSETTING (   0x24, "4:00/2:05 Extra" );	PORT_DIPSETTING (   0x44, "4:00/2:00 Extra" );	PORT_DIPSETTING (   0x68, "3:30/2:15 Extra" );	PORT_DIPSETTING (   0x08, "3:30/2:00 Extra" );	PORT_DIPSETTING (   0x28, "3:30/1:50 Extra" );	PORT_DIPSETTING (   0x48, "3:30/1:45 Extra" );	PORT_DIPSETTING (   0x6c, "3:00/2:00 Extra" );	PORT_DIPSETTING (   0x0c, "3:00/1:45 Extra" );	PORT_DIPSETTING (   0x2c, "3:00/1:35 Extra" );	PORT_DIPSETTING (   0x4c, "3:00/1:30 Extra" );	PORT_DIPSETTING (   0x7c, "2:30/1:45 Extra" );	PORT_DIPSETTING (   0x1c, "2:30/1:30 Extra" );	PORT_DIPSETTING (   0x3c, "2:30/1:20 Extra" );	PORT_DIPSETTING (   0x5c, "2:30/1:15 Extra" );	PORT_DIPSETTING (   0x70, "2:00/1:30 Extra" );	PORT_DIPSETTING (   0x10, "2:00/1:15 Extra" );	PORT_DIPSETTING (   0x30, "2:00/1:05 Extra" );	PORT_DIPSETTING (   0x50, "2:00/1:00 Extra" );	PORT_DIPSETTING (   0x74, "1:30/1:15 Extra" );	PORT_DIPSETTING (   0x14, "1:30/1:00 Extra" );	PORT_DIPSETTING (   0x34, "1:30/0:50 Extra" );	PORT_DIPSETTING (   0x54, "1:30/0:45 Extra" );	PORT_DIPSETTING (   0x78, "1:00/1:00 Extra" );	PORT_DIPSETTING (   0x18, "1:00/0:45 Extra" );	PORT_DIPSETTING (   0x38, "1:00/0:35 Extra" );	PORT_DIPSETTING (   0x58, "1:00/0:30 Extra" );	PORT_DIPNAME( 0x80, 0x80, "Game Type?" );	PORT_DIPSETTING (   0x80, "Timer In" );	PORT_DIPSETTING (   0x00, "Credit In" );
		PORT_START();  /* DSW3 - Active LOW */
		PORT_DIPNAME( 0x03, 0x03, "Difficulty?" );	PORT_DIPSETTING (   0x02, "Easy" );	PORT_DIPSETTING (   0x03, "Normal" );	PORT_DIPSETTING (   0x01, "Hard" );	PORT_DIPSETTING (   0x00, "Very Hard" );	PORT_DIPNAME( 0x04, 0x04, "Timer Speed?" );	PORT_DIPSETTING (   0x04, "60/60" );	PORT_DIPSETTING (   0x00, "55/60" );	PORT_DIPNAME( 0x08, 0x08, "Demo Sounds?" );	PORT_DIPSETTING (   0x00, DEF_STR( "Off") );
		PORT_DIPSETTING (   0x08, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_tehkanwc = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "twc-1.bin",    0x0000, 0x4000, 0x34d6d5ff );	ROM_LOAD( "twc-2.bin",    0x4000, 0x4000, 0x7017a221 );	ROM_LOAD( "twc-3.bin",    0x8000, 0x4000, 0x8b662902 );
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "twc-12.bin",   0x00000, 0x4000, 0xa9e274f8 );/* fg tiles */
	
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "twc-8.bin",    0x00000, 0x8000, 0x055a5264 );/* sprites */
		ROM_LOAD( "twc-7.bin",    0x08000, 0x8000, 0x59faebe7 );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "twc-11.bin",   0x00000, 0x8000, 0x669389fc );/* bg tiles */
		ROM_LOAD( "twc-9.bin",    0x08000, 0x8000, 0x347ef108 );
		ROM_REGION( 0x8000, REGION_SOUND1 );/* ADPCM samples */
		ROM_LOAD( "twc-5.bin",    0x0000, 0x4000, 0x444b5544 );ROM_END(); }}; 
	
	static RomLoadPtr rom_gridiron = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "gfight1.bin",  0x0000, 0x4000, 0x51612741 );	ROM_LOAD( "gfight2.bin",  0x4000, 0x4000, 0xa678db48 );	ROM_LOAD( "gfight3.bin",  0x8000, 0x4000, 0x8c227c33 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for code */
		ROM_LOAD( "gfight4.bin",  0x0000, 0x4000, 0x8821415f );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for code */
		ROM_LOAD( "gfight5.bin",  0x0000, 0x4000, 0x92ca3c07 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gfight7.bin",  0x00000, 0x4000, 0x04390cca );/* fg tiles */
	
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gfight8.bin",  0x00000, 0x4000, 0x5de6a70f );/* sprites */
		ROM_LOAD( "gfight9.bin",  0x04000, 0x4000, 0xeac9dc16 );	ROM_LOAD( "gfight10.bin", 0x08000, 0x4000, 0x61d0690f );	/* 0c000-0ffff empty */
	
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gfight11.bin", 0x00000, 0x4000, 0x80b09c03 );/* bg tiles */
		ROM_LOAD( "gfight12.bin", 0x04000, 0x4000, 0x1b615eae );	/* 08000-0ffff empty */
	
		ROM_REGION( 0x8000, REGION_SOUND1 );/* ADPCM samples */
		ROM_LOAD( "gfight6.bin",  0x0000, 0x4000, 0xd05d463d );ROM_END(); }}; 
	
	static RomLoadPtr rom_teedoff = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "to-1.bin",     0x0000, 0x4000, 0xcc2aebc5 );	ROM_LOAD( "to-2.bin",     0x4000, 0x4000, 0xf7c9f138 );	ROM_LOAD( "to-3.bin",     0x8000, 0x4000, 0xa0f0a6da );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for code */
		ROM_LOAD( "to-4.bin",     0x0000, 0x8000, 0xe922cbd2 );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for code */
		ROM_LOAD( "to-6.bin",     0x0000, 0x4000, 0xd8dfe1c8 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "to-12.bin",    0x00000, 0x4000, 0x4f44622c );/* fg tiles */
	
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "to-8.bin",     0x00000, 0x8000, 0x363bd1ba );/* sprites */
		ROM_LOAD( "to-7.bin",     0x08000, 0x8000, 0x6583fa5b );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "to-11.bin",    0x00000, 0x8000, 0x1ec00cb5 );/* bg tiles */
		ROM_LOAD( "to-9.bin",     0x08000, 0x8000, 0xa14347f0 );
		ROM_REGION( 0x8000, REGION_SOUND1 );/* ADPCM samples */
		ROM_LOAD( "to-5.bin",     0x0000, 0x8000, 0xe5e4246b );ROM_END(); }}; 
