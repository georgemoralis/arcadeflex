...
public class xmen
{
	...
	***************************************************************************/
	...
	PORT_START(); 	/* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER4 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_COIN4 );
		PORT_START(); 	/* IN0 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER3 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_COIN3 );
		...
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START4 );	PORT_BIT( 0x3000, IP_ACTIVE_LOW, IPT_UNKNOWN );/* unused? */
	...
	PORT_START(); 	/* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_COIN2 );/*
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER4 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_COIN4 );*/
		...
		PORT_START(); 	/* COIN  EEPROM and service */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN4 );	PORT_BIT( 0x003c, IP_ACTIVE_LOW, IPT_UNKNOWN );/* unused? */
		PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* EEPROM data */
		PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );/* EEPROM status - always 1 */
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x3000, IP_ACTIVE_LOW, IPT_UNKNOWN );/* unused? */
		PORT_BITX(0x4000, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );/* unused? */
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_xmen = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1 );	ROM_LOAD_EVEN( "065ubb04.10d",  0x00000, 0x20000, 0xf896c93b );	ROM_LOAD_ODD ( "065ubb05.10f",  0x00000, 0x20000, 0xe02e5d64 );	ROM_LOAD_EVEN( "xmen17g.bin",   0x80000, 0x40000, 0xb31dc44c );	ROM_LOAD_ODD ( "xmen17j.bin",   0x80000, 0x40000, 0x13842fe6 );
		ROM_REGION( 0x30000, REGION_CPU2 );	/* 64k+128k fpr sound cpu */
		ROM_LOAD( "065-a01.6f",   0x00000, 0x20000, 0x147d3a4d );	ROM_RELOAD(               0x10000, 0x20000 );
		...
		ROM_LOAD( "xmen17l.bin",  0x100000, 0x100000, 0x96b91802 );	ROM_LOAD( "xmen22h.bin",  0x200000, 0x100000, 0x321ed07a );	ROM_LOAD( "xmen22l.bin",  0x300000, 0x100000, 0x46da948e );
		ROM_REGION( 0x200000, REGION_SOUND1 );/* samples for the 054544 */
		ROM_LOAD( "xmenc25.bin",  0x000000, 0x200000, 0x5adbcee0 );ROM_END(); }}; 
	
	static RomLoadPtr rom_xmen6p = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1 );	ROM_LOAD_EVEN( "xmenb04.bin",   0x00000, 0x20000, 0x0f09b8e0 );	ROM_LOAD_ODD ( "xmenb05.bin",   0x00000, 0x20000, 0x867becbf );	ROM_LOAD_EVEN( "xmen17g.bin",   0x80000, 0x40000, 0xb31dc44c );	ROM_LOAD_ODD ( "xmen17j.bin",   0x80000, 0x40000, 0x13842fe6 );
		ROM_REGION( 0x30000, REGION_CPU2 );	/* 64k+128k fpr sound cpu */
		ROM_LOAD( "065-a01.6f",   0x00000, 0x20000, 0x147d3a4d );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x200000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "xmen1l.bin",   0x000000, 0x100000, 0x6b649aca );/* tiles */
	...
	static RomLoadPtr rom_xmen2pj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1 );	ROM_LOAD_EVEN( "065jaa04.10d",  0x00000, 0x20000, 0x66746339 );	ROM_LOAD_ODD ( "065jaa05.10f",  0x00000, 0x20000, 0x1215b706 );	ROM_LOAD_EVEN( "xmen17g.bin",   0x80000, 0x40000, 0xb31dc44c );	ROM_LOAD_ODD ( "xmen17j.bin",   0x80000, 0x40000, 0x13842fe6 );
		ROM_REGION( 0x30000, REGION_CPU2 );	/* 64k+128k fpr sound cpu */
		ROM_LOAD( "065-a01.6f",   0x00000, 0x20000, 0x147d3a4d );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x200000, REGION_GFX1 );/* graphics (addressable by the main CPU) */
		ROM_LOAD( "xmen1l.bin",   0x000000, 0x100000, 0x6b649aca );/* tiles */
