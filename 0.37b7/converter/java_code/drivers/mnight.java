...
public class mnight
{
	...
	PORT_START();  /* Player 1 controls */
		...
		PORT_DIPSETTING(    0x04, "Normal" );	PORT_DIPSETTING(    0x00, "Difficult" );	PORT_DIPNAME( 0x08, 0x08, "Free Game" );	PORT_DIPSETTING(    0x08, DEF_STR( "Off") ); )
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static RomLoadPtr rom_mnight = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "mn6-j19.bin",  0x00000, 0x8000, 0x56678d14 );	ROM_LOAD( "mn5-j17.bin",  0x10000, 0x8000, 0x2a73f88e );	ROM_LOAD( "mn4-j16.bin",  0x18000, 0x8000, 0xc5e42bb4 );	ROM_LOAD( "mn3-j14.bin",  0x20000, 0x8000, 0xdf6a4f7a );	ROM_LOAD( "mn2-j12.bin",  0x28000, 0x8000, 0x9c391d1b );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "mn1-j7.bin",   0x00000, 0x10000, 0xa0782a31 );
		ROM_REGION( 0x30000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mn11-b20.bin", 0x00000, 0x4000, 0x4d37e0f4 );  // background tiles
		...
		ROM_REGION( 0x30000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mn7-e11.bin",  0x00000, 0x4000, 0x4883059c );  // sprites tiles
		...
		ROM_REGION( 0x08000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mn10-b10.bin", 0x00000, 0x2000, 0x37b8221f );// foreground tiles OK
	...
	static RomLoadPtr rom_arkarea = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x30000, REGION_CPU1 );	ROM_LOAD( "arkarea.008",  0x00000, 0x8000, 0x1ce1b5b9 );	ROM_LOAD( "arkarea.009",  0x10000, 0x8000, 0xdb1c81d1 );	ROM_LOAD( "arkarea.010",  0x18000, 0x8000, 0x5a460dae );	ROM_LOAD( "arkarea.011",  0x20000, 0x8000, 0x63f022c9 );	ROM_LOAD( "arkarea.012",  0x28000, 0x8000, 0x3c4c65d5 );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "arkarea.013",  0x00000, 0x8000, 0x2d409d58 );
		ROM_REGION( 0x30000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "arkarea.003",  0x00000, 0x4000, 0x6f45a308 );  // background tiles
		...
		ROM_REGION( 0x30000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "arkarea.007",  0x00000, 0x4000, 0xd5684a27 );  // sprites tiles
		...
		ROM_REGION( 0x08000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "arkarea.004",  0x00000, 0x2000, 0x69e36af2 );// foreground tiles OK
		ROM_CONTINUE(             0x04000, 0x2000 );	ROM_CONTINUE(             0x02000, 0x2000 );	ROM_CONTINUE(             0x06000, 0x2000 );ROM_END(); }}; 
