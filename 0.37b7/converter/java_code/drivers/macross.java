...
public class macross
{
	...
	public static ReadHandlerPtr macross_protection_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr macross_oki6295_bankswitch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	static InputPortPtr input_ports_macross = new InputPortPtr(){ public void handler() { 
		...
		PORT_START(); 		/* IN0 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_START3 );/* Service */
		PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
		PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
		PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );/* Maybe unused */
	
		PORT_START();       /* IN1 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* DSW A */
		PORT_SERVICE( 0x01, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x02, 0x02, "Unknown 2" );	PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, "Unknown 3" );	PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Language" );	PORT_DIPSETTING(    0x08, "Japanese" );	PORT_DIPSETTING(    0x00, "English" );	PORT_DIPNAME( 0x10, 0x10, "Unknown 5" );	PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, "Unknown 6" );	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x40, "Unknown 7" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "Unknown 8" );	PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static RomLoadPtr rom_macross = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "921a01",		0x000000, 0x20000, 0xbbd8242d );/* 8x8 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "921a04",		0x000000, 0x200000, 0x4002e4bb );/* 16x16 tiles */
	
		ROM_REGION( 0x200000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "921a07",		0x000000, 0x200000, 0x7d2bf112 );/* Sprites */
		...
		ROM_REGION( 0x0220, REGION_PROMS );	ROM_LOAD( "921a08",    0x0000, 0x0100, 0xcfdbb86c );/* unknown */
		...
		ROM_LOAD( "921a02",  0x00000, 0x10000, 0x77c082c7 );ROM_END(); }}; 
