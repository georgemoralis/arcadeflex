...
public class z80bw
{
	...
	{
		new IOReadPort( 0x08, 0x08, input_port_0_r ),
		new IOReadPort( 0x09, 0x09, input_port_1_r ),
		new IOReadPort( 0x0a, 0x0a, input_port_2_r ),
	...
	PORT_START();       /* IN0 */
		...
		PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPNAME( 0x02, 0x02, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x02, "10000" );	PORT_DIPSETTING(    0x00, "20000" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
		...
		PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER2 );
		PORT_START();       /* IN2 */
		...
		PORT_BIT( 0xfe, IP_ACTIVE_HIGH, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	PORT_START();       /* IN0 */
		...
		PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPSETTING(    0x02, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x88, 0x88, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x88, "5000" );	PORT_DIPSETTING(    0x80, "10000" );	PORT_DIPSETTING(    0x08, "15000" );	PORT_DIPSETTING(    0x00, "20000" );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER2 );
		PORT_START();       /* IN2 */
		PORT_DIPNAME( 0x01, 0x00, "Freeze" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_BIT( 0xfe, IP_ACTIVE_HIGH, IPT_UNKNOWN );
	...
	***************************************************************************/
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_START2  );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_2WAY);	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_2WAY  );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_2WAY | IPF_PLAYER2);	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_2WAY | IPF_PLAYER2);	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2);
		PORT_START();       /* IN1 */
		PORT_DIPNAME( 0x01, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_DIPNAME( 0x06, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x04, "4" );  //PORT_DIPSETTING(    0x06, "4" );	PORT_DIPSETTING(    0x02, "5" );	PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x00, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(    0x08, DEF_STR( "1C_2C") );
	...
	static RomLoadPtr rom_astinvad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "ai_cpu_1.rom", 0x0000, 0x0400, 0x20e3ec41 );	ROM_LOAD( "ai_cpu_2.rom", 0x0400, 0x0400, 0xe8f1ab55 );	ROM_LOAD( "ai_cpu_3.rom", 0x0800, 0x0400, 0xa0092553 );	ROM_LOAD( "ai_cpu_4.rom", 0x0c00, 0x0400, 0xbe14185c );	ROM_LOAD( "ai_cpu_5.rom", 0x1000, 0x0400, 0xfee681ec );	ROM_LOAD( "ai_cpu_6.rom", 0x1400, 0x0400, 0xeb338863 );	ROM_LOAD( "ai_cpu_7.rom", 0x1800, 0x0400, 0x16dcfea4 );
		ROM_REGION( 0x0400, REGION_PROMS );	ROM_LOAD( "ai_vid_c.rom", 0x0000, 0x0400, 0xb45287ff );ROM_END(); }}; 
	
	static RomLoadPtr rom_kamikaze = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );    /* 64k for code */
		ROM_LOAD( "km01",         0x0000, 0x0800, 0x8aae7414 );	ROM_LOAD( "km02",         0x0800, 0x0800, 0x6c7a2beb );	ROM_LOAD( "km03",         0x1000, 0x0800, 0x3e8dedb6 );	ROM_LOAD( "km04",         0x1800, 0x0800, 0x494e1f6d );
		ROM_REGION( 0x0400, REGION_PROMS );	ROM_LOAD( "ai_vid_c.rom", 0x0000, 0x0400, BADCRC(0xb45287ff));
	ROM_END(); }}; 
	
	static RomLoadPtr rom_spaceint = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );    /* 64k for code */
		ROM_LOAD( "1",	 0x0000, 0x0400, 0x184314d2 );	ROM_LOAD( "2",	 0x0400, 0x0400, 0x55459aa1 );	ROM_LOAD( "3",	 0x0800, 0x0400, 0x9d6819be );	ROM_LOAD( "4",	 0x0c00, 0x0400, 0x432052d4 );	ROM_LOAD( "5",	 0x1000, 0x0400, 0xc6cfa650 );	ROM_LOAD( "6",	 0x1400, 0x0400, 0xc7ccf40f );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "clr", 0x0000, 0x0100, 0x13c1803f );ROM_END(); }}; 
