...
public class cyberbal
{
	...
	static UINT8 *ram;
	public static ReadHandlerPtr ram_r  = new ReadHandlerPtr() { public int handler(int offset) { return READ_WORD(&ram[offset]); } };
	public static WriteHandlerPtr ram_w = new WriteHandlerPtr() {public void handler(int offset, int data) { COMBINE_WORD_MEM(&ram[offset], data); } };
	
	static MemoryReadAddress sound_68k_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x03ffff, MRA_ROM ),
		new MemoryReadAddress( 0xff8000, 0xff87ff, sound_68k_r ),
		new MemoryReadAddress( 0xfff000, 0xffffff, ram_r, ram ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	
	static MemoryWriteAddress sound_68k_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x03ffff, MWA_ROM ),
		new MemoryWriteAddress( 0xff8800, 0xff8fff, sound_68k_w ),
		new MemoryWriteAddress( 0xff9000, 0xff97ff, io_68k_irq_ack_w ),
		new MemoryWriteAddress( 0xff9800, 0xff9fff, sound_68k_dac_w ),
		new MemoryWriteAddress( 0xfff000, 0xffffff, ram_w, ram ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	PORT_START();       /* fe0000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER4 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER4 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER4 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER4 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x00c0, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER3 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER3 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER3 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER3 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x8000, IP_ACTIVE_LOW );
		PORT_START();       /* fe1000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x00c0, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_VBLANK );
		PORT_START(); 		/* fake port for screen switching */
		PORT_BITX(  0x0001, IP_ACTIVE_HIGH, IPT_BUTTON2, "Select Left Screen", KEYCODE_9, IP_JOY_NONE );	PORT_BITX(  0x0002, IP_ACTIVE_HIGH, IPT_BUTTON2, "Select Right Screen", KEYCODE_0, IP_JOY_NONE );	PORT_BIT( 0xfffc, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* audio board port */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN4 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNUSED );/* output buffer full */
	...
	PORT_START();       /* fc0000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0xffc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();       /* fc2000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0xffc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* fc4000 */
		PORT_BIT( 0x1fff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x4000, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_SERVICE( 0x8000, IP_ACTIVE_LOW );
	...
	#else
		new WriteYmHandlerPtr[] { YM3012_VOL(60,MIXER_PAN_LEFT,60,MIXER_PAN_RIGHT) },
	#endif
		new WriteHandlerPtr[] { atarigen_ym2151_irq_gen }
	);
	...
	static RomLoadPtr rom_cyberbal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "4123.1m", 0x00000, 0x10000, 0xfb872740 );	ROM_LOAD_ODD ( "4124.1k", 0x00000, 0x10000, 0x87babad9 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "2131-snd.2f",  0x10000, 0x4000, 0xbd7e3d84 );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x40000, REGION_CPU3 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "2127.3c", 0x00000, 0x10000, 0x3e5feb1f );	ROM_LOAD_ODD ( "2128.1b", 0x00000, 0x10000, 0x4e642cc3 );	ROM_LOAD_EVEN( "2129.1c", 0x20000, 0x10000, 0xdb11d2f0 );	ROM_LOAD_ODD ( "2130.3b", 0x20000, 0x10000, 0xfd86b8aa );
		ROM_REGION( 0x40000, REGION_CPU4 );/* 256k for 68000 sound code */
		ROM_LOAD_EVEN( "1132-snd.5c",  0x00000, 0x10000, 0xca5ce8d8 );	ROM_LOAD_ODD ( "1133-snd.7c",  0x00000, 0x10000, 0xffeb8746 );	ROM_LOAD_EVEN( "1134-snd.5a",  0x20000, 0x10000, 0xbcbd4c00 );	ROM_LOAD_ODD ( "1135-snd.7a",  0x20000, 0x10000, 0xd520f560 );
		ROM_REGION( 0x140000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1150.15a",  0x000000, 0x10000, 0xe770eb3e );/* MO */
		...
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1146.9l",   0x000000, 0x10000, 0xa64b4da8 );/* playfield */
		...
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1166.14n",  0x000000, 0x10000, 0x0ca1e3b3 );/* alphanumerics */
	...
	static RomLoadPtr rom_cyberba2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "2123.1m", 0x00000, 0x10000, 0x502676e8 );	ROM_LOAD_ODD ( "2124.1k", 0x00000, 0x10000, 0x30f55915 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "2131-snd.2f",  0x10000, 0x4000, 0xbd7e3d84 );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x40000, REGION_CPU3 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "2127.3c", 0x00000, 0x10000, 0x3e5feb1f );	ROM_LOAD_ODD ( "2128.1b", 0x00000, 0x10000, 0x4e642cc3 );	ROM_LOAD_EVEN( "2129.1c", 0x20000, 0x10000, 0xdb11d2f0 );	ROM_LOAD_ODD ( "2130.3b", 0x20000, 0x10000, 0xfd86b8aa );
	...
	static RomLoadPtr rom_cyberbt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "cyb1007.bin", 0x00000, 0x10000, 0xd434b2d7 );	ROM_LOAD_ODD ( "cyb1008.bin", 0x00000, 0x10000, 0x7d6c4163 );	ROM_LOAD_EVEN( "cyb1009.bin", 0x20000, 0x10000, 0x3933e089 );	ROM_LOAD_ODD ( "cyb1010.bin", 0x20000, 0x10000, 0xe7a7cae8 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "cyb1029.bin",  0x10000, 0x4000, 0xafee87e1 );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x40000, REGION_CPU3 );	ROM_LOAD_EVEN( "cyb1011.bin", 0x00000, 0x10000, 0x22d3e09c );	ROM_LOAD_ODD ( "cyb1012.bin", 0x00000, 0x10000, 0xa8eeed8c );	ROM_LOAD_EVEN( "cyb1013.bin", 0x20000, 0x10000, 0x11d287c9 );	ROM_LOAD_ODD ( "cyb1014.bin", 0x20000, 0x10000, 0xbe15db42 );
		ROM_REGION( 0x40000, REGION_CPU4 );/* 256k for 68000 sound code */
		ROM_LOAD_EVEN( "1132-snd.5c",  0x00000, 0x10000, 0xca5ce8d8 );	ROM_LOAD_ODD ( "1133-snd.7c",  0x00000, 0x10000, 0xffeb8746 );	ROM_LOAD_EVEN( "1134-snd.5a",  0x20000, 0x10000, 0xbcbd4c00 );	ROM_LOAD_ODD ( "1135-snd.7a",  0x20000, 0x10000, 0xd520f560 );
		ROM_REGION( 0x140000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1001.bin",  0x000000, 0x20000, 0x586ba107 );/* MO */
		...
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cyb1015.bin",  0x000000, 0x10000, 0xdbbad153 );/* playfield */
		...
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cyb1019.bin",  0x000000, 0x10000, 0x833b4768 );/* alphanumerics */
	...
	static RomLoadPtr rom_cyberb2p = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "3019.bin", 0x00000, 0x10000, 0x029f8cb6 );	ROM_LOAD_ODD ( "3020.bin", 0x00000, 0x10000, 0x1871b344 );	ROM_LOAD_EVEN( "3021.bin", 0x20000, 0x10000, 0xfd7ebead );	ROM_LOAD_ODD ( "3022.bin", 0x20000, 0x10000, 0x173ccad4 );	ROM_LOAD_EVEN( "2023.bin", 0x40000, 0x10000, 0xe541b08f );	ROM_LOAD_ODD ( "2024.bin", 0x40000, 0x10000, 0x5a77ee95 );	ROM_LOAD_EVEN( "1025.bin", 0x60000, 0x10000, 0x95ff68c6 );	ROM_LOAD_ODD ( "1026.bin", 0x60000, 0x10000, 0xf61c4898 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "1042.bin",  0x10000, 0x4000, 0xe63cf125 );	ROM_CONTINUE(          0x04000, 0xc000 );
		ROM_REGION( 0x140000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1001.bin",  0x000000, 0x20000, 0x586ba107 );/* MO */
		ROM_LOAD( "1005.bin",  0x020000, 0x20000, 0xa53e6248 );/* MO */
		ROM_LOAD( "1032.bin",  0x040000, 0x10000, 0x131f52a0 );/* MO */
		...
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1036.bin",  0x000000, 0x10000, 0xcdf6e3d6 );/* playfield */
		...
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1040.bin",  0x000000, 0x10000, 0xa4c116f9 );/* alphanumerics */
		ROM_LOAD( "1041.bin",  0x010000, 0x10000, 0xe25d7847 );/* alphanumerics */
	
		ROM_REGION( 0x40000, REGION_SOUND1 );/* 256k for ADPCM samples */
		ROM_LOAD( "1049.bin",  0x00000, 0x10000, 0x94f24575 );	ROM_LOAD( "1050.bin",  0x10000, 0x10000, 0x87208e1e );	ROM_LOAD( "1051.bin",  0x20000, 0x10000, 0xf82558b9 );	ROM_LOAD( "1052.bin",  0x30000, 0x10000, 0xd96437ad );ROM_END(); }}; 
