...
public class skydiver
{
	...
	PORT_START();  /* fake port, gets mapped to Sky Diver ports */
		PORT_BIT (0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT );	PORT_BIT (0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT );	PORT_BIT (0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT (0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT (0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );/* Jump 1 */
		...
		PORT_BIT (0x10, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT_IMPULSE( 0x20, IP_ACTIVE_LOW, IPT_COIN1, 1 );	PORT_BIT (0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN2, 1 );
		PORT_START(); 		/* fake port, gets mapped to Sky Diver ports */
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPSETTING(    0x02, "5" );	PORT_DIPSETTING(    0x03, "6" );	PORT_DIPNAME( 0x0c, 0x08, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x0c, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x08, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(    0x04, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Free_Play") );
		PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x20, 0x00, "Extended Play" );	PORT_DIPSETTING(    0x20, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0xc0, 0x00, "Language" );	PORT_DIPSETTING(    0x00, "English" );	PORT_DIPSETTING(    0x40, "French" );	PORT_DIPSETTING(    0x80, "Spanish" );	PORT_DIPSETTING(    0xc0, "German" );
		PORT_START(); 		/* fake port, gets mapped to Sky Diver ports */
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_SERVICE | IPF_TOGGLE, "Self Test", KEYCODE_F2, IP_JOY_NONE );	PORT_BIT (0x02, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT (0x04, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT (0xF8, IP_ACTIVE_HIGH, IPT_UNUSED );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_skydiver = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "33167-02.f1", 0x2800, 0x0800, 0x25a5c976 );	ROM_LOAD( "33164-02.e1", 0x3000, 0x0800, 0xa348ac39 );	ROM_LOAD( "33165-02.d1", 0x3800, 0x0800, 0xa1fc5504 );	ROM_LOAD( "33166-02.c1", 0x7800, 0x0800, 0x3d26da2b );	ROM_RELOAD(              0xF800, 0x0800 );
		ROM_REGION( 0x0400, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "33163-01.h5", 0x0000, 0x0400, 0x5b9bb7c2 );
		ROM_REGION( 0x0800, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "33176-01.l5", 0x0000, 0x0400, 0x6b082a01 );	ROM_LOAD( "33177-01.k5", 0x0400, 0x0400, 0xf5541af0 );ROM_END(); }}; 
