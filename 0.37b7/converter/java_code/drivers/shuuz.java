...
public class shuuz
{
	...
	public static ReadHandlerPtr leta_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (which == 0)
		{
			int dx = (INT8)input_port_2_r.handler(offset);
			int dy = (INT8)input_port_3_r.handler(offset);
	...
	static RomLoadPtr rom_shuuz = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "4010.23p",     0x00000, 0x20000, 0x1c2459f8 );	ROM_LOAD_ODD ( "4011.13p",     0x00000, 0x20000, 0x6db53a85 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2030.43x", 0x000000, 0x20000, 0x8ecf1ed8 );	ROM_LOAD( "2032.20x", 0x020000, 0x20000, 0x5af184e6 );	ROM_LOAD( "2031.87x", 0x040000, 0x20000, 0x72e9db63 );	ROM_LOAD( "2033.65x", 0x060000, 0x20000, 0x8f552498 );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1020.43u", 0x000000, 0x20000, 0xd21ad039 );	ROM_LOAD( "1022.20u", 0x020000, 0x20000, 0x0c10bc90 );	ROM_LOAD( "1024.43m", 0x040000, 0x20000, 0xadb09347 );	ROM_LOAD( "1026.20m", 0x060000, 0x20000, 0x9b20e13d );	ROM_LOAD( "1021.87u", 0x080000, 0x20000, 0x8388910c );	ROM_LOAD( "1023.65u", 0x0a0000, 0x20000, 0x71353112 );	ROM_LOAD( "1025.87m", 0x0c0000, 0x20000, 0xf7b20a64 );	ROM_LOAD( "1027.65m", 0x0e0000, 0x20000, 0x55d54952 );
	...
	static RomLoadPtr rom_shuuz2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "23p.rom",     0x00000, 0x20000, 0x98aec4e7 );	ROM_LOAD_ODD ( "13p.rom",     0x00000, 0x20000, 0xdd9d5d5c );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2030.43x", 0x000000, 0x20000, 0x8ecf1ed8 );	ROM_LOAD( "2032.20x", 0x020000, 0x20000, 0x5af184e6 );	ROM_LOAD( "2031.87x", 0x040000, 0x20000, 0x72e9db63 );	ROM_LOAD( "2033.65x", 0x060000, 0x20000, 0x8f552498 );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1020.43u", 0x000000, 0x20000, 0xd21ad039 );	ROM_LOAD( "1022.20u", 0x020000, 0x20000, 0x0c10bc90 );	ROM_LOAD( "1024.43m", 0x040000, 0x20000, 0xadb09347 );	ROM_LOAD( "1026.20m", 0x060000, 0x20000, 0x9b20e13d );	ROM_LOAD( "1021.87u", 0x080000, 0x20000, 0x8388910c );	ROM_LOAD( "1023.65u", 0x0a0000, 0x20000, 0x71353112 );	ROM_LOAD( "1025.87m", 0x0c0000, 0x20000, 0xf7b20a64 );	ROM_LOAD( "1027.65m", 0x0e0000, 0x20000, 0x55d54952 );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "1040.75b", 0x00000, 0x20000, 0x0896702b );	ROM_LOAD( "1041.65b", 0x20000, 0x20000, 0xb3b07ce9 );ROM_END(); }}; 
