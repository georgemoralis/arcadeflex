...
public class nova2001
{
    ...
    PORT_START(); 
	    ...
	    PORT_DIPSETTING(    0x02, "3" );    PORT_DIPSETTING(    0x00, "4" );    PORT_DIPNAME( 0x04, 0x04, "1st Bonus Life" );    PORT_DIPSETTING(    0x04, "20000" );    PORT_DIPSETTING(    0x00, "30000" );    PORT_DIPNAME( 0x18, 0x18, "Extra Bonus Life" );    PORT_DIPSETTING(    0x18, "60000" );    PORT_DIPSETTING(    0x10, "70000" );    PORT_DIPSETTING(    0x08, "90000" );    PORT_DIPSETTING(    0x00, "None" );    PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Coinage") );
	    ...
	    PORT_DIPSETTING(    0x00, "Easy" );    PORT_DIPSETTING(    0x03, "Medium" );    PORT_DIPSETTING(    0x02, "Hard" );    PORT_DIPSETTING(    0x01, "Hardest" );    PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Demo_Sounds") );
	    PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
	    PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "High Score Names" );	PORT_DIPSETTING(    0x00, "3 Letters" );	PORT_DIPSETTING(    0x08, "8 Letters" );    PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
	...
	static RomLoadPtr rom_nova2001 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "1.6c",         0x0000, 0x2000, 0x368cffc0 );	ROM_LOAD( "2.6d",         0x2000, 0x2000, 0xbc4e442b );	ROM_LOAD( "3.6f",         0x4000, 0x2000, 0xb2849038 );	ROM_LOAD( "4.6g",         0x6000, 0x1000, 0x6b5bb12d );	ROM_RELOAD(               0x7000, 0x1000 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "5.12s",        0x0000, 0x2000, 0x54198941 );	ROM_LOAD( "6.12p",        0x2000, 0x2000, 0xcbd90dca );
		ROM_REGION( 0x4000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "7.12n",        0x0000, 0x2000, 0x9ebd8806 );	ROM_LOAD( "8.12l",        0x2000, 0x2000, 0xd1b18389 );
		ROM_REGION( 0x0020, REGION_PROMS );	ROM_LOAD( "nova2001.clr", 0x0000, 0x0020, 0xa2fac5cd );ROM_END(); }}; 
	
	static RomLoadPtr rom_nov2001u = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "nova2001.1",   0x0000, 0x2000, 0xb79461bd );	ROM_LOAD( "nova2001.2",   0x2000, 0x2000, 0xfab87144 );	ROM_LOAD( "3.6f",         0x4000, 0x2000, 0xb2849038 );	ROM_LOAD( "4.6g",         0x6000, 0x1000, 0x6b5bb12d );	ROM_RELOAD(               0x7000, 0x1000 );
		ROM_REGION( 0x4000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "nova2001.5",   0x0000, 0x2000, 0x8ea576e8 );	ROM_LOAD( "nova2001.6",   0x2000, 0x2000, 0x0c61656c );
		ROM_REGION( 0x4000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "7.12n",        0x0000, 0x2000, 0x9ebd8806 );	ROM_LOAD( "8.12l",        0x2000, 0x2000, 0xd1b18389 );
		ROM_REGION( 0x0020, REGION_PROMS );	ROM_LOAD( "nova2001.clr", 0x0000, 0x0020, 0xa2fac5cd );ROM_END(); }}; 
