...
public class klax
{
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x00fc, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0600, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );
		PORT_START(); 
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0600, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0800, IP_ACTIVE_LOW );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_klax = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "136075-6.006", 0x00000, 0x10000, 0xe8991709 );	ROM_LOAD_ODD ( "136075-6.005", 0x00000, 0x10000, 0x72b8c510 );	ROM_LOAD_EVEN( "136075-6.008", 0x20000, 0x10000, 0xc7c91a9d );	ROM_LOAD_ODD ( "136075-6.007", 0x20000, 0x10000, 0xd2021a88 );
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.010", 0x00000, 0x10000, 0x15290a0d );	ROM_LOAD( "136075-2.012", 0x10000, 0x10000, 0xc0d9eb0f );	ROM_LOAD( "136075-2.009", 0x20000, 0x10000, 0x6368dbaf );	ROM_LOAD( "136075-2.011", 0x30000, 0x10000, 0xe83cca91 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.014", 0x00000, 0x10000, 0x5c551e92 );	ROM_LOAD( "136075-2.013", 0x10000, 0x10000, 0x36764bbc );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "136075-1.015", 0x00000, 0x10000, 0x4d24c768 );	ROM_LOAD( "136075-1.016", 0x10000, 0x10000, 0x12e9b4b7 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_klax2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "136075.006",   0x00000, 0x10000, 0x05c98fc0 );	ROM_LOAD_ODD ( "136075.005",   0x00000, 0x10000, 0xd461e1ee );	ROM_LOAD_EVEN( "136075.008",   0x20000, 0x10000, 0xf1b8e588 );	ROM_LOAD_ODD ( "136075.007",   0x20000, 0x10000, 0xadbe33a8 );
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.010", 0x00000, 0x10000, 0x15290a0d );	ROM_LOAD( "136075-2.012", 0x10000, 0x10000, 0xc0d9eb0f );	ROM_LOAD( "136075-2.009", 0x20000, 0x10000, 0x6368dbaf );	ROM_LOAD( "136075-2.011", 0x30000, 0x10000, 0xe83cca91 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.014", 0x00000, 0x10000, 0x5c551e92 );	ROM_LOAD( "136075-2.013", 0x10000, 0x10000, 0x36764bbc );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "136075-1.015", 0x00000, 0x10000, 0x4d24c768 );	ROM_LOAD( "136075-1.016", 0x10000, 0x10000, 0x12e9b4b7 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_klax3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "5006",         0x00000, 0x10000, 0x65eb9a31 );	ROM_LOAD_ODD ( "5005",         0x00000, 0x10000, 0x7be27349 );	ROM_LOAD_EVEN( "4008",         0x20000, 0x10000, 0xf3c79106 );	ROM_LOAD_ODD ( "4007",         0x20000, 0x10000, 0xa23cde5d );
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.010", 0x00000, 0x10000, 0x15290a0d );	ROM_LOAD( "136075-2.012", 0x10000, 0x10000, 0xc0d9eb0f );	ROM_LOAD( "136075-2.009", 0x20000, 0x10000, 0x6368dbaf );	ROM_LOAD( "136075-2.011", 0x30000, 0x10000, 0xe83cca91 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.014", 0x00000, 0x10000, 0x5c551e92 );	ROM_LOAD( "136075-2.013", 0x10000, 0x10000, 0x36764bbc );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "136075-1.015", 0x00000, 0x10000, 0x4d24c768 );	ROM_LOAD( "136075-1.016", 0x10000, 0x10000, 0x12e9b4b7 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_klaxj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 4*64k for 68000 code */
		ROM_LOAD_EVEN( "136075-3.406", 0x00000, 0x10000, 0xab2aa50b );	ROM_LOAD_ODD ( "136075-3.405", 0x00000, 0x10000, 0x9dc9a590 );	ROM_LOAD_EVEN( "136075-2.408", 0x20000, 0x10000, 0x89d515ce );	ROM_LOAD_ODD ( "136075-2.407", 0x20000, 0x10000, 0x48ce4edb );
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.010", 0x00000, 0x10000, 0x15290a0d );	ROM_LOAD( "136075-2.012", 0x10000, 0x10000, 0xc0d9eb0f );	ROM_LOAD( "136075-2.009", 0x20000, 0x10000, 0x6368dbaf );	ROM_LOAD( "136075-2.011", 0x30000, 0x10000, 0xe83cca91 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136075-2.014", 0x00000, 0x10000, 0x5c551e92 );	ROM_LOAD( "136075-2.013", 0x10000, 0x10000, 0x36764bbc );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "136075-1.015", 0x00000, 0x10000, 0x4d24c768 );	ROM_LOAD( "136075-1.016", 0x10000, 0x10000, 0x12e9b4b7 );ROM_END(); }}; 
