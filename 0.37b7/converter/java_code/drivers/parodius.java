...
public class parodius
{
	...
	***************************************************************************/
	...
	//	PORT_DIPSETTING(    0x00, "No Use" );
		...
		PORT_DIPSETTING(    0x18, "20000 80000" );	PORT_DIPSETTING(    0x10, "30000 100000" );	PORT_DIPSETTING(    0x08, "20000" );	PORT_DIPSETTING(    0x00, "70000" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		...
		PORT_START(); 	/* DSW #3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, "Upright Controls" );	PORT_DIPSETTING(    0x20, "Single" );	PORT_DIPSETTING(    0x00, "Dual" );	PORT_SERVICE( 0x40, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_parodius = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "955e01.bin", 0x10000, 0x20000, 0x49baa334 );	ROM_LOAD( "955e02.bin", 0x30000, 0x18000, 0x14010d6f );	ROM_CONTINUE(           0x08000, 0x08000 );
		...
		ROM_LOAD( "955d04.bin", 0x00000, 0x80000, 0xe671491a );ROM_END(); }}; 
