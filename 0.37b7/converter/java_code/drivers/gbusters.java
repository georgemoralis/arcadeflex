...
public class gbusters
{
	...
	***************************************************************************/
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPSETTING(    0x00, "7" );	PORT_DIPNAME( 0x04, 0x04, "Bullets" );	PORT_DIPSETTING(    0x04, "50" );	PORT_DIPSETTING(    0x00, "60" );	PORT_DIPNAME( 0x18, 0x10, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x18, "50k, 200k & 400k" );	PORT_DIPSETTING(    0x10, "70k, 250k & 500k" );	PORT_DIPSETTING(    0x08, "50k" );	PORT_DIPSETTING(    0x00, "70k" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gbusters = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(           0x08000, 0x08000 );	ROM_LOAD( "878j03.rom", 0x20000, 0x10000, 0x3943a065 );/* ROM K15 */
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "878a09.rom",   0x0000, 0x0100, 0xe2d09a1b );/* priority encoder (not used) */
	
		ROM_REGION( 0x40000, REGION_SOUND1 );/* samples for 007232 */
		ROM_LOAD( "878c04.rom",  0x00000, 0x40000, 0x9e982d1c );ROM_END(); }}; 
