...
public class aerofgt
{
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_SERVICE( 0x0100, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0600, 0x0600, "1 Player Starting Score" );	PORT_DIPSETTING(      0x0600, "12-12" );	PORT_DIPSETTING(      0x0400, "11-11" );	PORT_DIPSETTING(      0x0200, "11-12" );	PORT_DIPSETTING(      0x0000, "10-12" );	PORT_DIPNAME( 0x1800, 0x1800, "2 Players Starting Score" );	PORT_DIPSETTING(      0x1800, "9-9" );	PORT_DIPSETTING(      0x1000, "7-7" );	PORT_DIPSETTING(      0x0800, "5-5" );	PORT_DIPSETTING(      0x0000, "0-0" );	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x2000, "Normal" );	PORT_DIPSETTING(      0x0000, "Hard" );	PORT_DIPNAME( 0x4000, 0x4000, "2 Players Time per Credit" );	PORT_DIPSETTING(      0x4000, "3 min" );	PORT_DIPSETTING(      0x0000, "2 min" );	PORT_DIPNAME( 0x8000, 0x8000, DEF_STR( "Unknown") );
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER3 );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_COIN4 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START4 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_SERVICE2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER4 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER4 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER4 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER4 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER4 );
		PORT_START(); 
		...
		PORT_DIPNAME( 0x0008, 0x0008, "2 Coins to Start, 1 to Continue" );	PORT_DIPSETTING(      0x0008, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0010, 0x0010, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0000, "1" );	PORT_DIPSETTING(      0x0010, "2" );	PORT_DIPNAME( 0x0060, 0x0060, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(      0x0060, "2 Players" );	PORT_DIPSETTING(      0x0040, "3 Players" );	PORT_DIPSETTING(      0x0020, "4 Players" );	PORT_DIPSETTING(      0x0000, "4 Players (Team); )
		...
		PORT_DIPNAME( 0x0080, 0x0080, "Coin Slot" );	PORT_DIPSETTING(      0x0080, "Same" );	PORT_DIPSETTING(      0x0000, "Individual" );	PORT_SERVICE( 0x0100, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0600, 0x0600, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(      0x0400, "Easy" );	PORT_DIPSETTING(      0x0600, "Normal" );	PORT_DIPSETTING(      0x0200, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x0800, 0x0800, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0800, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x1000, 0x1000, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x2000, 0x2000, "Freeze" );	PORT_DIPSETTING(      0x2000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		...
		PORT_DIPSETTING(      0x000d, "1 Credit 3 Health Packs" );	PORT_DIPSETTING(      0x000c, "1 Credit 4 Health Packs" );	PORT_DIPSETTING(      0x000b, "1 Credit 5 Health Packs" );	PORT_DIPSETTING(      0x000a, "1 Credit 6 Health Packs" );	PORT_DIPSETTING(      0x0009, "2 Credits 1 Health Pack" );	PORT_DIPSETTING(      0x0008, "3 Credits 1 Health Pack" );	PORT_DIPSETTING(      0x0007, "4 Credits 1 Health Pack" );	PORT_DIPSETTING(      0x0006, "5 Credits 1 Health Pack" );	PORT_DIPSETTING(      0x0005, "2 Credits 2 Health Packs" );	PORT_DIPSETTING(      0x0004, "2-1-1C  1-1-1 HPs" );	PORT_DIPSETTING(      0x0003, "2-2C 1-2 HPs" );	PORT_DIPSETTING(      0x0002, "1-1-1-1-1C 1-1-1-1-2 HPs" );	PORT_DIPSETTING(      0x0001, "1-1-1-1C 1-1-1-2 HPs" );	PORT_DIPSETTING(      0x0000, "1-1C 1-2 HPs" );/* The last 5 Coin/Credit selections are cycles:
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_SERVICE );/* "TEST" */
		PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_COIN4 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_COIN3 );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );/START1 )
		...
		PORT_DIPNAME( 0x0008, 0x0008, "2 Coins to Start, 1 to Continue" );	PORT_DIPSETTING(      0x0008, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0010, 0x0010, "Coin Slot" );	PORT_DIPSETTING(      0x0010, "Same" );	PORT_DIPSETTING(      0x0000, "Individual" );	PORT_DIPNAME( 0x0020, 0x0000, "Max Players" );	PORT_DIPSETTING(      0x0020, "2" );	PORT_DIPSETTING(      0x0000, "3" );	PORT_DIPNAME( 0x0040, 0x0000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0040, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0100, 0x0100, DEF_STR( "Flip_Screen") );
		...
		PORT_DIPSETTING(      0x0000, "2" );	PORT_DIPSETTING(      0x1000, "3" );	PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Unknown") );
		...
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_START3 );INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_aerofgtb = new InputPortPtr(){ public void handler() { 
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_DIPNAME( 0x0001, 0x0001, "Coin Slot" );	PORT_DIPSETTING(      0x0001, "Same" );	PORT_DIPSETTING(      0x0000, "Individual" );	PORT_DIPNAME( 0x000e, 0x000e, DEF_STR( "Coin_A") );
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "1C_6C") );
		PORT_DIPNAME( 0x0080, 0x0080, "2 Coins to Start, 1 to Continue" );	PORT_DIPSETTING(      0x0080, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		...
		PORT_DIPSETTING(      0x0800, "Easy" );	PORT_DIPSETTING(      0x0c00, "Normal" );	PORT_DIPSETTING(      0x0400, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x3000, 0x3000, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x2000, "1" );	PORT_DIPSETTING(      0x1000, "2" );	PORT_DIPSETTING(      0x3000, "3" );	PORT_DIPSETTING(      0x0000, "4" );	PORT_DIPNAME( 0x4000, 0x4000, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(      0x4000, "200000" );	PORT_DIPSETTING(      0x0000, "300000" );	PORT_SERVICE( 0x8000, IP_ACTIVE_LOW );
		PORT_START(); 
		PORT_DIPNAME( 0x0001, 0x0000, "Country" );	PORT_DIPSETTING(      0x0000, "Japan" );	PORT_DIPSETTING(      0x0001, "Taiwan" );	/* TODO: there are others in the table at 11910 */
		/* this port is checked at 1b080 */
	INPUT_PORTS_END(); }}; 
	
	static InputPortPtr input_ports_aerofgt = new InputPortPtr(){ public void handler() { 
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_DIPNAME( 0x0001, 0x0001, "Coin Slot" );	PORT_DIPSETTING(      0x0001, "Same" );	PORT_DIPSETTING(      0x0000, "Individual" );	PORT_DIPNAME( 0x000e, 0x000e, DEF_STR( "Coin_A") );
		PORT_DIPSETTING(      0x000a, DEF_STR( "3C_1C") );
		PORT_DIPSETTING(      0x000c, DEF_STR( "2C_1C") );
		...
		PORT_DIPSETTING(      0x0008, "Easy" );	PORT_DIPSETTING(      0x000c, "Normal" );	PORT_DIPSETTING(      0x0004, "Hard" );	PORT_DIPSETTING(      0x0000, "Hardest" );	PORT_DIPNAME( 0x0030, 0x0030, DEF_STR( "Lives") );
		PORT_DIPSETTING(      0x0020, "1" );	PORT_DIPSETTING(      0x0010, "2" );	PORT_DIPSETTING(      0x0030, "3" );	PORT_DIPSETTING(      0x0000, "4" );	PORT_DIPNAME( 0x0040, 0x0040, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(      0x0040, "200000" );	PORT_DIPSETTING(      0x0000, "300000" );	PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );
		PORT_START(); 
		PORT_DIPNAME( 0x000f, 0x0000, "Country" );	PORT_DIPSETTING(      0x0000, "Any" );	PORT_DIPSETTING(      0x000f, "USA" );	PORT_DIPSETTING(      0x000e, "Korea" );	PORT_DIPSETTING(      0x000d, "Hong Kong" );	PORT_DIPSETTING(      0x000b, "Taiwan" );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_pspikes = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "19",           0x00000, 0x20000, 0x7e8ed6e5 );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g7h",          0x000000, 0x80000, 0x74c23c3d );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g7j",          0x000000, 0x80000, 0x0b9e4739 );	ROM_LOAD( "g7l",          0x080000, 0x80000, 0x943139ff );
		...
		ROM_LOAD( "o5b",          0x000000, 0x100000, 0x07d6cbac );ROM_END(); }}; 
	...
	static RomLoadPtr rom_spinlbrk = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "ic98",    0x00000, 0x10000, 0x36c2bf70 );	ROM_LOAD_ODD ( "ic104",   0x00000, 0x10000, 0x34a7e158 );	ROM_LOAD_EVEN( "ic93",    0x20000, 0x10000, 0x726f4683 );	ROM_LOAD_ODD ( "ic94",    0x20000, 0x10000, 0xc4385e03 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "ic117",        0x00000, 0x08000, 0x625ada41 );	ROM_LOAD( "ic118",        0x10000, 0x10000, 0x1025f024 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic15",         0x000000, 0x80000, 0xe318cf3a );	ROM_LOAD( "ic9",          0x080000, 0x80000, 0xe071f674 );
		ROM_REGION( 0x200000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic17",         0x000000, 0x80000, 0xa63d5a55 );	ROM_LOAD( "ic11",         0x080000, 0x80000, 0x7dcc913d );	ROM_LOAD( "ic16",         0x100000, 0x80000, 0x0d84af7f );//FIRST AND SECOND HALF IDENTICAL
	
		ROM_REGION( 0x100000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic12",         0x000000, 0x80000, 0xd63fac4e );	ROM_LOAD( "ic18",         0x080000, 0x80000, 0x5a60444b );
		ROM_REGION( 0x200000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic14",         0x000000, 0x80000, 0x1befd0f3 );	ROM_LOAD( "ic20",         0x080000, 0x80000, 0xc2f84a61 );	ROM_LOAD( "ic35",         0x100000, 0x80000, 0xeba8e1a3 );	ROM_LOAD( "ic40",         0x180000, 0x80000, 0x5ef5aa7e );
		ROM_REGION( 0x24000, REGION_GFX5 );/* hardcoded sprite maps */
		ROM_LOAD_EVEN( "ic19",    0x00000, 0x10000, 0xdb24eeaa );	ROM_LOAD_ODD ( "ic13",    0x00000, 0x10000, 0x97025bf4 );	/* 20000-23fff empty space, filled in vh_startup */
	...
	static RomLoadPtr rom_spinlbru = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "ic98.u5", 0x00000, 0x10000, 0x3a0f7667 );	ROM_LOAD_ODD ( "ic104.u6",0x00000, 0x10000, 0xa0e0af31 );	ROM_LOAD_EVEN( "ic93.u4", 0x20000, 0x10000, 0x0cf73029 );	ROM_LOAD_ODD ( "ic94.u3", 0x20000, 0x10000, 0x5cf7c426 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "ic117",        0x00000, 0x08000, 0x625ada41 );	ROM_LOAD( "ic118",        0x10000, 0x10000, 0x1025f024 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic15",         0x000000, 0x80000, 0xe318cf3a );	ROM_LOAD( "ic9",          0x080000, 0x80000, 0xe071f674 );
		ROM_REGION( 0x200000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic17",         0x000000, 0x80000, 0xa63d5a55 );	ROM_LOAD( "ic11",         0x080000, 0x80000, 0x7dcc913d );	ROM_LOAD( "ic16",         0x100000, 0x80000, 0x0d84af7f );//FIRST AND SECOND HALF IDENTICAL
	...
	static RomLoadPtr rom_spinlbrj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "j5",      0x00000, 0x10000, 0x6a3d690e );	ROM_LOAD_ODD ( "j6",      0x00000, 0x10000, 0x869593fa );	ROM_LOAD_EVEN( "j4",      0x20000, 0x10000, 0x33e33912 );	ROM_LOAD_ODD ( "j3",      0x20000, 0x10000, 0x16ca61d0 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "ic117",        0x00000, 0x08000, 0x625ada41 );	ROM_LOAD( "ic118",        0x10000, 0x10000, 0x1025f024 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic15",         0x000000, 0x80000, 0xe318cf3a );	ROM_LOAD( "ic9",          0x080000, 0x80000, 0xe071f674 );
		ROM_REGION( 0x200000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic17",         0x000000, 0x80000, 0xa63d5a55 );	ROM_LOAD( "ic11",         0x080000, 0x80000, 0x7dcc913d );	ROM_LOAD( "ic16",         0x100000, 0x80000, 0x0d84af7f );//FIRST AND SECOND HALF IDENTICAL
	...
	static RomLoadPtr rom_karatblz = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_WIDE_SWAP( "rom2v3",  0x00000, 0x40000, 0x01f772e1 );	ROM_LOAD_WIDE_SWAP( "1.u15",   0x40000, 0x40000, 0xd16ee21b );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "5.u92",        0x00000, 0x20000, 0x97d67510 );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gha.u55",      0x00000, 0x80000, 0x3e0cea91 );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gh9.u61",      0x00000, 0x80000, 0x5d1676bd );
		ROM_REGION( 0x400000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "u42",          0x000000, 0x100000, 0x65f0da84 );	ROM_LOAD( "3.u44",        0x100000, 0x020000, 0x34bdead2 );	ROM_LOAD( "u43",          0x200000, 0x100000, 0x7b349e5d );	ROM_LOAD( "4.u45",        0x300000, 0x020000, 0xbe4d487d );
		ROM_REGION( 0x100000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "u59.ghb",      0x000000, 0x80000, 0x158c9cde );	ROM_LOAD( "ghd.u60",      0x080000, 0x80000, 0x73180ae3 );
		ROM_REGION( 0x080000, REGION_SOUND1 );/* sound samples */
		ROM_LOAD( "u105.gh8",     0x000000, 0x080000, 0x7a68cb1b );
		ROM_REGION( 0x100000, REGION_SOUND2 );/* sound samples */
		ROM_LOAD( "u104",         0x000000, 0x100000, 0x5795e884 );ROM_END(); }}; 
	
	static RomLoadPtr rom_karatblu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_WIDE_SWAP( "2.u14",   0x00000, 0x40000, 0x202e6220 );	ROM_LOAD_WIDE_SWAP( "1.u15",   0x40000, 0x40000, 0xd16ee21b );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "5.u92",        0x00000, 0x20000, 0x97d67510 );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gha.u55",      0x00000, 0x80000, 0x3e0cea91 );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gh9.u61",      0x00000, 0x80000, 0x5d1676bd );
	...
	static RomLoadPtr rom_turbofrc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0xc0000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_WIDE_SWAP( "tfrc2.bin",    0x00000, 0x40000, 0x721300ee );	ROM_LOAD_WIDE_SWAP( "tfrc1.bin",    0x40000, 0x40000, 0x6cd5312b );	ROM_LOAD_WIDE_SWAP( "tfrc3.bin",    0x80000, 0x40000, 0x63f50557 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "tfrcu166.bin", 0x00000, 0x20000, 0x2ca14a65 );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x0a0000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tfrcu94.bin",  0x000000, 0x80000, 0xbaa53978 );	ROM_LOAD( "tfrcu95.bin",  0x080000, 0x20000, 0x71a6c573 );
		ROM_REGION( 0x0a0000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tfrcu105.bin", 0x000000, 0x80000, 0x4de4e59e );	ROM_LOAD( "tfrcu106.bin", 0x080000, 0x20000, 0xc6479eb5 );
		ROM_REGION( 0x200000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tfrcu116.bin", 0x000000, 0x80000, 0xdf210f3b );	ROM_LOAD( "tfrcu118.bin", 0x080000, 0x40000, 0xf61d1d79 );	ROM_LOAD( "tfrcu117.bin", 0x100000, 0x80000, 0xf70812fd );	ROM_LOAD( "tfrcu119.bin", 0x180000, 0x40000, 0x474ea716 );
		ROM_REGION( 0x100000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tfrcu134.bin", 0x000000, 0x80000, 0x487330a2 );	ROM_LOAD( "tfrcu135.bin", 0x080000, 0x80000, 0x3a7e5b6d );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* sound samples */
		ROM_LOAD( "tfrcu180.bin",   0x00000, 0x20000, 0x39c7c7d5 );
		ROM_REGION( 0x100000, REGION_SOUND2 );/* sound samples */
		ROM_LOAD( "tfrcu179.bin", 0x000000, 0x100000, 0x60ca0333 );ROM_END(); }}; 
	
	static RomLoadPtr rom_aerofgt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_WIDE_SWAP( "1.u4",         0x00000, 0x80000, 0x6fdff0a2 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "2.153",        0x00000, 0x20000, 0xa1ef64ec );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "538a54.124",   0x000000, 0x80000, 0x4d2c4df2 );	ROM_LOAD( "1538a54.124",  0x080000, 0x80000, 0x286d109e );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "538a53.u9",    0x000000, 0x100000, 0x630d8e0b );
		ROM_REGION( 0x080000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "534g8f.u18",   0x000000, 0x80000, 0x76ce0926 );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* sound samples */
		ROM_LOAD( "it-19-01",     0x00000, 0x40000, 0x6d42723d );
		ROM_REGION( 0x100000, REGION_SOUND2 );/* sound samples */
		ROM_LOAD( "it-19-06",     0x000000, 0x100000, 0xcdbbdb1d );ROM_END(); }}; 
	
	static RomLoadPtr rom_aerofgtb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "v2",                0x00000, 0x40000, 0x5c9de9f0 );	ROM_LOAD_ODD ( "v1",                0x00000, 0x40000, 0x89c1dcf4 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "v3",           0x00000, 0x20000, 0xcbb18cf4 );	ROM_RELOAD(               0x10000, 0x20000 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "it-19-03",     0x000000, 0x80000, 0x85eba1a4 );
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "it-19-02",     0x000000, 0x80000, 0x4f57f8ba );
		ROM_REGION( 0x100000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "it-19-04",     0x000000, 0x80000, 0x3b329c1f );	ROM_LOAD( "it-19-05",     0x080000, 0x80000, 0x02b525af );
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "g27",          0x000000, 0x40000, 0x4d89cbc8 );	ROM_LOAD( "g26",          0x040000, 0x40000, 0x8072c1d2 );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* sound samples */
		ROM_LOAD( "it-19-01",     0x00000, 0x40000, 0x6d42723d );
		ROM_REGION( 0x100000, REGION_SOUND2 );/* sound samples */
		ROM_LOAD( "it-19-06",     0x000000, 0x100000, 0xcdbbdb1d );ROM_END(); }}; 
	...
	static RomLoadPtr rom_aerofgtc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "v2.149",            0x00000, 0x40000, 0xf187aec6 );	ROM_LOAD_ODD ( "v1.111",            0x00000, 0x40000, 0x9e684b19 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
		ROM_LOAD( "2.153",        0x00000, 0x20000, 0xa1ef64ec );	ROM_RELOAD(               0x10000, 0x20000 );
	...
	static RomLoadPtr rom_sonicwi = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "2.149",             0x00000, 0x40000, 0x3d1b96ba );	ROM_LOAD_ODD ( "1.111",             0x00000, 0x40000, 0xa3d09f94 );
		ROM_REGION( 0x30000, REGION_CPU2 );/* 64k for the audio CPU + banks */
