...
public class galpanic
{
	...
	public static WriteHandlerPtr oki_msb_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if ((data & 0xff000000) == 0)
		{
	...
	public static ReadHandlerPtr oki_msb_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr kludge  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return rand() & 0x0700;
	} };
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_SERVICE( 0x0004, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0008, 0x0008, DEF_STR( "Unknown") );	/* might affect coinage according to manual, */
		...
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_PLAYER1 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );/ BUTTON2 | IPF_PLAYER1 ) used in test mode
		PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_DIPNAME( 0x0003, 0x0003, "Difficulty?" );	PORT_DIPSETTING(      0x0002, "Easy?" );	PORT_DIPSETTING(      0x0003, "Normal?" );	PORT_DIPSETTING(      0x0001, "Hard?" );	PORT_DIPSETTING(      0x0000, "Hardest?" );	PORT_DIPNAME( 0x0004, 0x0004, DEF_STR( "Unknown") );
		...
		PORT_DIPSETTING(      0x0010, "2" );	PORT_DIPSETTING(      0x0030, "3" );	PORT_DIPSETTING(      0x0020, "4" );	PORT_DIPSETTING(      0x0000, "5" );	PORT_DIPNAME( 0x0040, 0x0040, DEF_STR( "Unknown") );	/* manual says demo sounds but has no effect */
		PORT_DIPSETTING(      0x0040, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0080, 0x0080, "Test Mode" );	PORT_DIPSETTING(      0x0080, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_4WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );/BUTTON2 | IPF_PLAYER2 )
		PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_DIPSETTING(      0x0002, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_SERVICE( 0x0004, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x0008, 0x0008, DEF_STR( "Unknown") );
		PORT_DIPSETTING(      0x0008, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x0030, 0x0030, DEF_STR( "Coin_A") );
		PORT_DIPSETTING(      0x0020, DEF_STR( "2C_1C") );
		...
		PORT_START(); 
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_SERVICE1 );/* in service mode, but doesn't add credits */
		PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 
		...
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_TILT );/* MAME crashes when pressed */
		PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_galpanic = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "pm110.4m2",    0x000000, 0x080000, 0xae6b17a8 );	ROM_LOAD_ODD ( "pm109.4m1",    0x000000, 0x080000, 0xb85d792d );	/* The above two ROMs contain valid 68000 code, but the game doesn't */
		...
		ROM_LOAD_EVEN( "pm112.6",      0x000000, 0x20000, 0x7b972b58 );	ROM_LOAD_ODD ( "pm111.5",      0x000000, 0x20000, 0x4eb7298d );	ROM_LOAD_ODD ( "pm004e.8",     0x100000, 0x80000, 0xd3af52bc );	ROM_LOAD_EVEN( "pm005e.7",     0x100000, 0x80000, 0xd7ec650c );	ROM_LOAD_ODD ( "pm000e.15",    0x200000, 0x80000, 0x5d220f3f );	ROM_LOAD_EVEN( "pm001e.14",    0x200000, 0x80000, 0x90433eb1 );	ROM_LOAD_ODD ( "pm002e.17",    0x300000, 0x80000, 0x713ee898 );	ROM_LOAD_EVEN( "pm003e.16",    0x300000, 0x80000, 0x6bb060fd );
		...
		ROM_LOAD( "pm008e.l",     0x00000, 0x80000, 0xd9379ba8 );	ROM_RELOAD(               0x40000, 0x80000 );	ROM_LOAD( "pm007e.u",     0xc0000, 0x80000, 0xc7ed7950 );ROM_END(); }}; 
	
	static RomLoadPtr rom_fantasia = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x500000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "prog2_16.rom", 0x000000, 0x80000, 0xe27c6c57 );	ROM_LOAD_ODD ( "prog1_13.rom", 0x000000, 0x80000, 0x68d27413 );	ROM_LOAD_EVEN( "iscr6_09.rom", 0x100000, 0x80000, 0x2a588393 );	ROM_LOAD_ODD ( "iscr5_05.rom", 0x100000, 0x80000, 0x6160e0f0 );	ROM_LOAD_EVEN( "iscr4_08.rom", 0x200000, 0x80000, 0xf776b743 );	ROM_LOAD_ODD ( "iscr3_04.rom", 0x200000, 0x80000, 0x5df0dff2 );	ROM_LOAD_EVEN( "iscr2_07.rom", 0x300000, 0x80000, 0x5707d861 );	ROM_LOAD_ODD ( "iscr1_03.rom", 0x300000, 0x80000, 0x36cb811a );	ROM_LOAD_EVEN( "imag2_10.rom", 0x400000, 0x80000, 0x1f14a395 );	ROM_LOAD_ODD ( "imag1_06.rom", 0x400000, 0x80000, 0xfaf870e4 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* sprites */
		ROM_LOAD( "obj1_17.rom",  0x00000, 0x80000, 0xaadb6eb7 );
		ROM_REGION( 0x140000, REGION_SOUND1 );/* OKIM6295 samples */
		/* 00000-2ffff is fixed, 30000-3ffff is bank switched from all the ROMs */
		ROM_LOAD( "mus-1_01.rom", 0x00000, 0x80000, 0x22955efb );	ROM_RELOAD(               0x40000, 0x80000 );	ROM_LOAD( "mus-2_02.rom", 0xc0000, 0x80000, 0x4cd4d6c3 );
		ROM_REGION( 0x200000, REGION_USER1 );/* unknown */
		ROM_LOAD_EVEN( "gscr2_15.rom", 0x000000, 0x80000, 0x46666768 );	ROM_LOAD_ODD ( "gscr1_12.rom", 0x000000, 0x80000, 0x4bd25be6 );	ROM_LOAD_EVEN( "gscr4_14.rom", 0x100000, 0x80000, 0x4e7e6ed4 );	ROM_LOAD_ODD ( "gscr3_11.rom", 0x100000, 0x80000, 0x6d00a4c5 );ROM_END(); }}; 
	
	static RomLoadPtr rom_newfant = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x500000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "prog2_12.rom", 0x000000, 0x80000, 0xde43a457 );	ROM_LOAD_ODD ( "prog1_07.rom", 0x000000, 0x80000, 0x370b45be );	ROM_LOAD_EVEN( "iscr2_10.rom", 0x100000, 0x80000, 0x4f2da2eb );	ROM_LOAD_ODD ( "iscr1_05.rom", 0x100000, 0x80000, 0x63c6894f );	ROM_LOAD_EVEN( "iscr4_09.rom", 0x200000, 0x80000, 0x725741ec );	ROM_LOAD_ODD ( "iscr3_04.rom", 0x200000, 0x80000, 0x51d6b362 );	ROM_LOAD_EVEN( "iscr6_08.rom", 0x300000, 0x80000, 0x178b2ef3 );	ROM_LOAD_ODD ( "iscr5_03.rom", 0x300000, 0x80000, 0xd2b5c5fa );	ROM_LOAD_EVEN( "iscr8_11.rom", 0x400000, 0x80000, 0xf4148528 );	ROM_LOAD_ODD ( "iscr7_06.rom", 0x400000, 0x80000, 0x2dee0c31 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* sprites */
		ROM_LOAD( "obj1_13.rom",  0x00000, 0x80000, 0xe6d1bc71 );
		ROM_REGION( 0x140000, REGION_SOUND1 );/* OKIM6295 samples */
		/* 00000-2ffff is fixed, 30000-3ffff is bank switched from all the ROMs */
		ROM_LOAD( "musc1_01.rom", 0x00000, 0x80000, 0x10347fce );	ROM_RELOAD(               0x40000, 0x80000 );	ROM_LOAD( "musc2_02.rom", 0xc0000, 0x80000, 0xb9646a8c );ROM_END(); }}; 
	
	static RomLoadPtr rom_missw96 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x400000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "mw96_10.bin",  0x000000, 0x80000, 0xb1309bb1 );	ROM_LOAD_ODD ( "mw96_06.bin",  0x000000, 0x80000, 0xa5892bb3 );	ROM_LOAD_EVEN( "mw96_09.bin",  0x100000, 0x80000, 0x7032dfdf );	ROM_LOAD_ODD ( "mw96_05.bin",  0x100000, 0x80000, 0x91de5ab5 );	ROM_LOAD_EVEN( "mw96_08.bin",  0x200000, 0x80000, 0xb8e66fb5 );	ROM_LOAD_ODD ( "mw96_04.bin",  0x200000, 0x80000, 0xe77a04f8 );	ROM_LOAD_EVEN( "mw96_07.bin",  0x300000, 0x80000, 0x26112ed3 );	ROM_LOAD_ODD ( "mw96_03.bin",  0x300000, 0x80000, 0xe9374a46 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* sprites */
		ROM_LOAD( "mw96_11.bin",  0x00000, 0x80000, 0x3983152f );
		ROM_REGION( 0x140000, REGION_SOUND1 );/* OKIM6295 samples */
		/* 00000-2ffff is fixed, 30000-3ffff is bank switched from all the ROMs */
		ROM_LOAD( "mw96_01.bin",  0x00000, 0x80000, 0xe78a659e );	ROM_RELOAD(               0x40000, 0x80000 );	ROM_LOAD( "mw96_02.bin",  0xc0000, 0x80000, 0x60fa0c00 );ROM_END(); }}; 
