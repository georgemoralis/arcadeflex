...
public class ddrible
{
	...
	PORT_START(); 	/* PLAYER 1 INPUTS */
		...
		PORT_DIPSETTING(	0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(	0x00, DEF_STR( "On") );
		PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x08, 0x00, "Allow vs match with 1 Credit" );	PORT_DIPSETTING(	0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(	0x00, DEF_STR( "On") );
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_ddribble = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "690c03.bin",	0x10000, 0x0a000, 0x07975a58 );	ROM_CONTINUE(			0x0a000, 0x06000 );
		...
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "690a05.bin",	0x00000, 0x20000, 0x6a816d0d );/* characters (set 1) & obtects (set 1) */
		ROM_LOAD( "690a06.bin",	0x20000, 0x20000, 0x46300cd0 );/* characters (set 1) & objects (set 1) */
	
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "690a10.bin", 0x00000, 0x20000, 0x61efa222 );/* characters (set 2) */
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "690a11.i15", 0x0000, 0x0100, 0xf34617ad );/* sprite lookup table */
	
		ROM_REGION( 0x20000, REGION_SOUND1 );/* 128k for the VLM5030 data */
		ROM_LOAD( "690a04.bin", 0x00000, 0x20000, 0x1bfeb763 );ROM_END(); }}; 
