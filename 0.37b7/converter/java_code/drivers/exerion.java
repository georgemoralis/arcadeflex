...
public class exerion
{
	...
	static RomLoadPtr rom_exerion = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "exerion.06",   0x00000, 0x2000, 0x435a85a4 );/* fg chars */
	
		ROM_REGION( 0x04000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "exerion.11",   0x00000, 0x2000, 0xf0633a09 );/* sprites */
		ROM_LOAD( "exerion.10",   0x02000, 0x2000, 0x80312de0 );
		ROM_REGION( 0x08000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "exerion.03",   0x00000, 0x2000, 0x790595b8 );/* bg data */
		...
		ROM_REGION( 0x0420, REGION_PROMS );	ROM_LOAD( "exerion.e1",   0x0000, 0x0020, 0x2befcc20 );/* palette */
