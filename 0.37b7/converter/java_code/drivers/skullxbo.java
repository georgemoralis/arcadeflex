...
public class skullxbo
{
	...
	PORT_START();       /* ff5800 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );
		PORT_START();       /* ff5802 */
		PORT_BIT( 0x000f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_UNUSED );/* HBLANK */
		PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNUSED );/* /AUDBUSY */
		PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );
	...
	static RomLoadPtr rom_skullxbo = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "5150", 0x00000, 0x10000, 0x9546d88b );	ROM_LOAD_ODD ( "5151", 0x00000, 0x10000, 0xb9ed8bd4 );	ROM_LOAD_EVEN( "5152", 0x20000, 0x10000, 0xc07e44fc );	ROM_LOAD_ODD ( "5153", 0x20000, 0x10000, 0xfef8297f );	ROM_LOAD_EVEN( "5154", 0x40000, 0x10000, 0xde4101a3 );	ROM_LOAD_ODD ( "5155", 0x40000, 0x10000, 0x78c0f6ad );	ROM_LOAD_EVEN( "5156", 0x70000, 0x08000, 0xcde16b55 );	ROM_LOAD_ODD ( "5157", 0x70000, 0x08000, 0x31c77376 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "1149",      0x10000, 0x4000, 0x8d730e7a );	ROM_CONTINUE(          0x04000, 0xc000 );
		ROM_REGION( 0x190000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1102",     0x000000, 0x10000, 0x90becdfa );/* MO */
		...
		ROM_REGION( 0x0a0000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2129",     0x000000, 0x10000, 0x36b1a578 );/* playfield */
		...
		ROM_REGION( 0x008000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2141",     0x000000, 0x08000, 0x60d6d6df );/* alphanumerics */
	
		ROM_REGION( 0x40000, REGION_SOUND1 );/* 256k for ADPCM samples */
		ROM_LOAD( "1145",      0x00000, 0x10000, 0xd9475d58 );	ROM_LOAD( "1146",      0x10000, 0x10000, 0x133e6aef );	ROM_LOAD( "1147",      0x20000, 0x10000, 0xba4d556e );	ROM_LOAD( "1148",      0x30000, 0x10000, 0xc48df49a );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_skullxb2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 8*64k for 68000 code */
		ROM_LOAD_EVEN( "sku0h.bin", 0x00000, 0x10000, 0x47083d59 );	ROM_LOAD_ODD ( "sku0l.bin", 0x00000, 0x10000, 0x2c03feaf );	ROM_LOAD_EVEN( "sku1h.bin", 0x20000, 0x10000, 0xaa0471de );	ROM_LOAD_ODD ( "sku1l.bin", 0x20000, 0x10000, 0xa65386f9 );	ROM_LOAD_EVEN( "5154",      0x40000, 0x10000, 0xde4101a3 );	ROM_LOAD_ODD ( "5155",      0x40000, 0x10000, 0x78c0f6ad );	ROM_LOAD_EVEN( "5156",      0x70000, 0x08000, 0xcde16b55 );	ROM_LOAD_ODD ( "5157",      0x70000, 0x08000, 0x31c77376 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "1149",      0x10000, 0x4000, 0x8d730e7a );	ROM_CONTINUE(          0x04000, 0xc000 );
		ROM_REGION( 0x190000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1102",     0x000000, 0x10000, 0x90becdfa );/* MO */
		ROM_LOAD( "1104",     0x010000, 0x10000, 0x33609071 );/* MO */
