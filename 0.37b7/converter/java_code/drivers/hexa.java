...
public class hexa
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x04, 0x00, "Naughty Pics" );	PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, "Difficulty?" );	PORT_DIPSETTING(    0x30, "Easy?" );	PORT_DIPSETTING(    0x20, "Medium?" );	PORT_DIPSETTING(    0x10, "Hard?" );	PORT_DIPSETTING(    0x00, "Hardest?" );	PORT_DIPNAME( 0x40, 0x40, "Pobys" );	PORT_DIPSETTING(    0x40, "2" );	PORT_DIPSETTING(    0x00, "4" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Demo_Sounds") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_hexa = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "hexa.20",      0x00000, 0x8000, 0x98b00586 );	ROM_LOAD( "hexa.21",      0x10000, 0x8000, 0x3d5d006c );
		ROM_REGION( 0x18000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "hexa.17",      0x00000, 0x8000, 0xf6911dd6 );	ROM_LOAD( "hexa.18",      0x08000, 0x8000, 0x6e3d95d2 );	ROM_LOAD( "hexa.19",      0x10000, 0x8000, 0xffe97a31 );
		ROM_REGION( 0x0300, REGION_PROMS );	ROM_LOAD( "hexa.001",     0x0000, 0x0100, 0x88a055b4 );	ROM_LOAD( "hexa.003",     0x0100, 0x0100, 0x3e9d4932 );	ROM_LOAD( "hexa.002",     0x0200, 0x0100, 0xff15366c );ROM_END(); }}; 
