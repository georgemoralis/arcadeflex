...
public class shanghai
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* DSW0 */
		PORT_SERVICE( 0x01, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x02, 0x02, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
		...
		PORT_START(); 	/* DSW1 */
		PORT_DIPNAME( 0x01, 0x01, "Confirmation" );	PORT_DIPSETTING(    0x01, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x02, 0x02, "Help" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x02, DEF_STR( "On") );
		PORT_DIPNAME( 0x0c, 0x0c, "2 Players Move Time" );	PORT_DIPSETTING(    0x0c, "8" );	PORT_DIPSETTING(    0x08, "10" );	PORT_DIPSETTING(    0x04, "12" );	PORT_DIPSETTING(    0x00, "14" );	PORT_DIPNAME( 0x30, 0x30, "Bonus Time for Making Pair" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0xc0, 0xc0, "Start Time" );	PORT_DIPSETTING(    0xc0, "30" );	PORT_DIPSETTING(    0x80, "60" );	PORT_DIPSETTING(    0x40, "90" );	PORT_DIPSETTING(    0x00, "120" );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_shanghai = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1 );	ROM_LOAD_V20_EVEN( "shg-22a.rom", 0xa0000, 0x10000, 0xe0a085be )
