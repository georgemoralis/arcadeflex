...
public class wc90
{
	...
	PORT_START(); 	/* IN0 bit 0-5 */
		...
		PORT_DIPSETTING(    0x30, "Easy" );	PORT_DIPSETTING(    0x10, "Normal" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x40, 0x40, "Countdown Speed" );	PORT_DIPSETTING(    0x40, "Normal" );	PORT_DIPSETTING(    0x00, "Fast" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x80, DEF_STR( "On") );
	
		PORT_START(); 	/* DSWB */
		PORT_DIPNAME( 0x03, 0x03, "1 Player Game Time" );	PORT_DIPSETTING(    0x01, "1:00" );	PORT_DIPSETTING(    0x02, "1:30" );	PORT_DIPSETTING(    0x03, "2:00" );	PORT_DIPSETTING(    0x00, "2:30" );	PORT_DIPNAME( 0x1c, 0x1c, "2 Players Game Time" );	PORT_DIPSETTING(    0x0c, "1:00" );	PORT_DIPSETTING(    0x14, "1:30" );	PORT_DIPSETTING(    0x04, "2:00" );	PORT_DIPSETTING(    0x18, "2:30" );	PORT_DIPSETTING(    0x1c, "3:00" );	PORT_DIPSETTING(    0x08, "3:30" );	PORT_DIPSETTING(    0x10, "4:00" );	PORT_DIPSETTING(    0x00, "5:00" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Unknown") );
		...
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START2 );INPUT_PORTS_END(); }}; 
	...
	(
		...
		new ReadHandlerPtr[] { YM2203_VOL(25,25), YM2203_VOL(25,25) },
	...
	static RomLoadPtr rom_wc90 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x010000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic85_07v.bin", 0x00000, 0x10000, 0xc5219426 );/* characters */
	
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic86_08v.bin", 0x00000, 0x20000, 0x8fa1a1ff );/* tiles #1 */
		ROM_LOAD( "ic90_09v.bin", 0x20000, 0x20000, 0x99f8841c );/* tiles #2 */
	
		ROM_REGION( 0x040000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic87_10v.bin", 0x00000, 0x20000, 0x8232093d );/* tiles #3 */
		ROM_LOAD( "ic91_11v.bin", 0x20000, 0x20000, 0x188d3789 );/* tiles #4 */
	
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic50_12v.bin", 0x00000, 0x20000, 0xda1fe922 );/* sprites  */
		...
		ROM_LOAD( "ic82_06.bin",  0x00000, 0x20000, 0x2fd692ed );ROM_END(); }}; 
