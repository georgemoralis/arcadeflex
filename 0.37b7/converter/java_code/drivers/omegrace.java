...
public class omegrace
{
	...
	static MemoryReadAddress readmem[] =
	{
		...
		new MemoryReadAddress( 0x9000, 0x9fff, MRA_ROM ), /* vector rom */
	...
	{
		new MemoryWriteAddress( 0x0000, 0x3fff, MWA_ROM ), /* Omega Race tries to write there! */
		new MemoryWriteAddress( 0x4000, 0x4bff, MWA_RAM ),
		new MemoryWriteAddress( 0x5c00, 0x5cff, MWA_RAM, nvram, nvram_size ), /* NVRAM */
		new MemoryWriteAddress( 0x8000, 0x8fff, MWA_RAM, vectorram, vectorram_size ), /* vector ram */
		new MemoryWriteAddress( 0x9000, 0x9fff, MWA_ROM ), /* vector rom */
	...
	{
		new IOReadPort( 0x08, 0x08, omegrace_vg_go_r ),
		...
		new IOReadPort( 0x16, 0x16, input_port_5_r ), /* 2nd controller (cocktail) */
		new IOReadPort( -1 )	/* end of table */
	};
	
	static IOWritePort writeport[] =
	{
		new IOWritePort( 0x0a, 0x0a, avgdvg_reset_w ),
		new IOWritePort( 0x13, 0x13, omegrace_leds_w ), /* coin counters, leds, flip screen */
		new IOWritePort( 0x14, 0x14, omegrace_soundlatch_w ), /* Sound command */
	...
	PORT_START();  /* SW0 */
		PORT_DIPNAME( 0x03, 0x03, "1st Bonus Life" );	PORT_DIPSETTING (   0x00, "40k" );	PORT_DIPSETTING (   0x01, "50k" );	PORT_DIPSETTING (   0x02, "70k" );	PORT_DIPSETTING (   0x03, "100k" );	PORT_DIPNAME( 0x0c, 0x0c, "2nd & 3rd Bonus Life" );	PORT_DIPSETTING (   0x00, "150k 250k" );	PORT_DIPSETTING (   0x04, "250k 500k" );	PORT_DIPSETTING (   0x08, "500k 750k" );	PORT_DIPSETTING (   0x0c, "750k 1500k" );	PORT_DIPNAME( 0x30, 0x30, "Credit(s);Ships" )
		PORT_DIPSETTING (   0x00, "1C/2S 2C/4S" );	PORT_DIPSETTING (   0x10, "1C/2S 2C/5S" );	PORT_DIPSETTING (   0x20, "1C/3S 2C/6S" );	PORT_DIPSETTING (   0x30, "1C/3S 2C/7S" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unknown") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_omegrace = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "omega.m7",     0x0000, 0x1000, 0x0424d46e );	ROM_LOAD( "omega.l7",     0x1000, 0x1000, 0xedcd7a7d );	ROM_LOAD( "omega.k7",     0x2000, 0x1000, 0x6d10f197 );	ROM_LOAD( "omega.j7",     0x3000, 0x1000, 0x8e8d4b54 );	ROM_LOAD( "omega.e1",     0x9000, 0x0800, 0x1d0fdf3a );	ROM_LOAD( "omega.f1",     0x9800, 0x0800, 0xd44c0814 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for audio cpu */
		ROM_LOAD( "sound.k5",     0x0000, 0x0800, 0x7d426017 );ROM_END(); }}; 
