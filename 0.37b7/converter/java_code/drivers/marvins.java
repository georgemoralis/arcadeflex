...
public class marvins
{
	...
	***************************************************************************/
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* sound CPU status */
		PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START();  /* player#1 controls */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* player#2 controls */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* DSW1 */
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x01, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x03, "5" );	PORT_BITX(0x04,     0x04, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Infinite Lives", IP_JOY_NONE, IP_KEY_NONE );	PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		...
		PORT_DIPNAME( 0x07, 0x07, "1st Bonus Life" );	PORT_DIPSETTING(    0x07, "10000" );	PORT_DIPSETTING(    0x06, "20000" );	PORT_DIPSETTING(    0x05, "30000" );	PORT_DIPSETTING(    0x04, "40000" );	PORT_DIPSETTING(    0x03, "50000" );	PORT_DIPSETTING(    0x02, "60000" );	PORT_DIPSETTING(    0x01, "70000" );	PORT_DIPSETTING(    0x00, "80000" );	PORT_DIPNAME( 0x18, 0x18, "2nd Bonus Life" );	PORT_DIPSETTING(    0x10, "1st bonus*2" );	PORT_DIPSETTING(    0x08, "1st bonus*3" );	PORT_DIPSETTING(    0x00, "1st bonus*4" );//	PORT_DIPSETTING(    0x18, "Unused" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Demo_Sounds") );
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW,  IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW,  IPT_START2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_UNKNOWN );/* sound CPU status */
		PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW,  IPT_UNKNOWN );
		PORT_START();  /* player#1 controls */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* player#2 controls */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* DSW1 */
		...
		PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x40, "2" );	PORT_DIPSETTING(    0x80, "3" );	PORT_DIPSETTING(    0xc0, "5" );
		PORT_START(); 	/* DSW2 */
		PORT_DIPNAME( 0x01, 0x01, DEF_STR( "Demo_Sounds"));
		PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x02, 0x02, "Freeze" );	PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x08, 0x08, "Language" );	PORT_DIPSETTING(    0x08, "English" );	PORT_DIPSETTING(    0x00, "Japanese" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BITX(0x20,     0x20, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Infinite Lives", IP_JOY_NONE, IP_KEY_NONE );	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Free_Play") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START(); 
		...
		PORT_BIT( 0x40, IP_ACTIVE_LOW,  IPT_UNKNOWN );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START();  /* player#1 controls */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();  /* player#2 controls */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0xc0, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	//	PORT_DIPSETTING(    0x08, DEF_STR( "5C_1C") );
		...
		PORT_DIPNAME( 0xc0, 0xc0, "Bonus?" );	PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x40, "2" );	PORT_DIPSETTING(    0x80, "3" );	PORT_DIPSETTING(    0xc0, "4" );
		PORT_START(); 	/* DSW2 */
		...
		PORT_DIPSETTING(    0x04, "Easy" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x18, 0x10, "Game mode" );	PORT_DIPSETTING(    0x18, "Demo Sounds Off" );	PORT_DIPSETTING(    0x10, "Demo Sounds On" );	PORT_BITX(0,        0x08, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite Lives", IP_JOY_NONE, IP_KEY_NONE );	PORT_DIPSETTING(    0x00, "Freeze" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_marvins = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "pa1",   0x0000, 0x2000, 0x0008d791 );	ROM_LOAD( "pa2",   0x2000, 0x2000, 0x9457003c );	ROM_LOAD( "pa3",   0x4000, 0x2000, 0x54c33ecb );
		...
		ROM_LOAD( "m1",    0x0000, 0x2000, 0x2314c696 );	ROM_LOAD( "m2",    0x2000, 0x2000, 0x74ba5799 );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "s1",    0x0000, 0x2000, 0x327f70f3 );/* characters */
	
		ROM_REGION( 0x2000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b1",    0x0000, 0x2000, 0xe528bc60 );/* background tiles */
	
		ROM_REGION( 0x2000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b2",    0x0000, 0x2000, 0xe528bc60 );/* foreground tiles */
	
		ROM_REGION( 0x6000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "f3",    0x0000, 0x2000, 0xe55c9b83 );/* sprites */
		ROM_LOAD( "f2",    0x2000, 0x2000, 0x8fc2b081 );	ROM_LOAD( "f1",    0x4000, 0x2000, 0x0bd6b4e5 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "marvmaze.j1",  0x000, 0x400, 0x92f5b06d );	ROM_LOAD( "marvmaze.j2",  0x400, 0x400, 0xd2b25665 );	ROM_LOAD( "marvmaze.j3",  0x800, 0x400, 0xdf9e6005 );ROM_END(); }}; 
	
	static RomLoadPtr rom_madcrash = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for CPUA code */
		ROM_LOAD( "p8",    0x0000, 0x2000, 0xecb2fdc9 );	ROM_LOAD( "p9",    0x2000, 0x2000, 0x0a87df26 );	ROM_LOAD( "p10",   0x4000, 0x2000, 0x6eb8a87c );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for CPUB code */
		ROM_LOAD( "p4",   0x0000, 0x2000, 0x5664d699 );	ROM_LOAD( "p5",   0x2000, 0x2000, 0xdea2865a );	ROM_LOAD( "p6",   0x4000, 0x2000, 0xe25a9b9c );	ROM_LOAD( "p7",   0x6000, 0x2000, 0x55b14a36 );	ROM_LOAD( "p3",   0x8000, 0x2000, 0xe3c8c2cb );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for sound code */
		ROM_LOAD( "p1",   0x0000, 0x2000, 0x2dcd036d );	ROM_LOAD( "p2",   0x2000, 0x2000, 0xcc30ae8b );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p13",    0x0000, 0x2000, 0x48c4ade0 );/* characters */
	
		ROM_REGION( 0x2000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p11",    0x0000, 0x2000, 0x67174956 );/* background tiles */
	
		ROM_REGION( 0x2000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p12",    0x0000, 0x2000, 0x085094c1 );/* foreground tiles */
	
		ROM_REGION( 0x6000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p14",    0x0000, 0x2000, 0x07e807bc );/* sprites */
		ROM_LOAD( "p15",    0x2000, 0x2000, 0xa74149d4 );	ROM_LOAD( "p16",    0x4000, 0x2000, 0x6153611a );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "m3-prom.j3",  0x000, 0x400, 0xd19e8a91 );	ROM_LOAD( "m2-prom.j4",  0x400, 0x400, 0x9fc325af );	ROM_LOAD( "m1-prom.j5",  0x800, 0x400, 0x07678443 );ROM_END(); }}; 
	
	static RomLoadPtr rom_vangrd2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );	ROM_LOAD( "p1.9a",  0x0000, 0x2000, 0xbc9eeca5 );	ROM_LOAD( "p3.11a", 0x2000, 0x2000, 0x3970f69d );	ROM_LOAD( "p2.12a", 0x4000, 0x2000, 0x58b08b58 );	ROM_LOAD( "p4.14a", 0x6000, 0x2000, 0xa95f11ea );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "p5.4a", 0x0000, 0x2000, 0xe4dfd0ba );	ROM_LOAD( "p6.6a", 0x2000, 0x2000, 0x894ff00d );	ROM_LOAD( "p7.7a", 0x4000, 0x2000, 0x40b4d069 );
		ROM_REGION( 0x10000, REGION_CPU3 );/* 64k for sound code */
		ROM_LOAD( "p8.6a", 0x0000, 0x2000, 0xa3daa438 );	ROM_LOAD( "p9.8a", 0x2000, 0x2000, 0x9345101a );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p15.1e", 0x0000, 0x2000, 0x85718a41 );/* characters */
	
		ROM_REGION( 0x2000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p13.1a", 0x0000, 0x2000, 0x912f22c6 );/* background tiles */
	
		ROM_REGION( 0x2000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p9",     0x0000, 0x2000, 0x7aa0b684 );/* foreground tiles */
	
		ROM_REGION( 0x6000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p12.1kl", 0x0000, 0x2000, 0x8658ea6c );/* sprites */
		ROM_LOAD( "p11.3kl", 0x2000, 0x2000, 0x620cd4ec );	ROM_LOAD( "p10.4kl", 0x4000, 0x2000, 0x5bfc04c0 );
		ROM_REGION( 0x0c00, REGION_PROMS );	ROM_LOAD( "mb7054.3j", 0x000, 0x400, 0x506f659a );	ROM_LOAD( "mb7054.4j", 0x400, 0x400, 0x222133ce );	ROM_LOAD( "mb7054.5j", 0x800, 0x400, 0x2e21a79b );ROM_END(); }}; 
