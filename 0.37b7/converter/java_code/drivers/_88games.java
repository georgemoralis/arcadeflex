...
public class _88games
{
	...
	***************************************************************************/
	...
	PORT_START(); 
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );//	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	/* Fake button to press buttons 1 and 3 impossibly fast. Handle via konami_IN1_r */
		PORT_BITX(0x08, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_CHEAT | IPF_PLAYER1, "Run Like Hell Cheat", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x20, "World Records" );	PORT_DIPSETTING(    0x20, "Don't Erase" );	PORT_DIPSETTING(    0x00, "Erase on Reset" );	PORT_SERVICE( 0x40, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_88games = new RomLoadPtr(){ public void handler(){ 
	    ...
	    ROM_LOAD( "861m01.k18", 0x08000, 0x08000, 0x4a4e2959 );	ROM_LOAD( "861m02.k16", 0x10000, 0x10000, 0xe19f15f6 );
		...
		ROM_LOAD( "861a04.b", 0x010000, 0x10000, 0x75744b56 );	ROM_LOAD( "861a04.c", 0x020000, 0x10000, 0xa00021c5 );	ROM_LOAD( "861a04.d", 0x030000, 0x10000, 0xd208304c );
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "861.g3",   0x0000, 0x0100, 0x429785db );/* priority encoder (not used) */
	
		ROM_REGION( 0x20000, REGION_SOUND1 );/* samples for UPD7759 #0 */
		ROM_LOAD( "861a07.a", 0x000000, 0x10000, 0x5d035d69 );	ROM_LOAD( "861a07.b", 0x010000, 0x10000, 0x6337dd91 );
		ROM_REGION( 0x20000, REGION_SOUND2 );/* samples for UPD7759 #1 */
		ROM_LOAD( "861a07.c", 0x000000, 0x10000, 0x5067a38b );	ROM_LOAD( "861a07.d", 0x010000, 0x10000, 0x86731451 );ROM_END(); }}; 
	
	static RomLoadPtr rom_konami88 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x21000, REGION_CPU1 );/* code + banked roms + space for banked ram */
		ROM_LOAD( "861.e03", 0x08000, 0x08000, 0x55979bd9 );	ROM_LOAD( "861.e02", 0x10000, 0x10000, 0x5b7e98a6 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code */
		ROM_LOAD( "861d01.d9", 0x00000, 0x08000, 0x0ff1dec0 );
		ROM_REGION(  0x080000, REGION_GFX1 );/* graphics ( dont dispose as the program can read them ) */
		ROM_LOAD_GFX_EVEN( "861a08.a", 0x000000, 0x10000, 0x77a00dd6 )	/* characters */
	...
	static RomLoadPtr rom_hypsptsp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x21000, REGION_CPU1 );/* code + banked roms + space for banked ram */
		ROM_LOAD( "861f03.k18", 0x08000, 0x08000, 0x8c61aebd );	ROM_LOAD( "861f02.k16", 0x10000, 0x10000, 0xd2460c28 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code */
		ROM_LOAD( "861d01.d9", 0x00000, 0x08000, 0x0ff1dec0 );
		ROM_REGION(  0x080000, REGION_GFX1 );/* graphics ( dont dispose as the program can read them ) */
		ROM_LOAD_GFX_EVEN( "861a08.a", 0x000000, 0x10000, 0x77a00dd6 )	/* characters */
