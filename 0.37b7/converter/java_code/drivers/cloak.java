...
public class cloak
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_SERVICE( 0x02, IP_ACTIVE_LOW );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 );
		PORT_START(); 	/* DSW0 */
		PORT_BIT( 0x3f, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_START2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_START1 );
		PORT_START();       /* DSW1 */
		PORT_DIPNAME( 0x03, 0x02, "Credits" );	PORT_DIPSETTING(    0x02, "*1" );	PORT_DIPSETTING(    0x01, "*2" );	PORT_DIPSETTING(    0x03, "/2" );	PORT_DIPSETTING(    0x00, DEF_STR( "Free_Play") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cloak = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "136023.501",   0x4000, 0x2000, 0xc2dbef1b );	ROM_LOAD( "136023.502",   0x6000, 0x2000, 0x316d0c7b );	ROM_LOAD( "136023.503",   0x8000, 0x4000, 0xb9c291a6 );	ROM_LOAD( "136023.504",   0xc000, 0x4000, 0xd014a1c0 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for code */
		ROM_LOAD( "136023.509",   0x2000, 0x2000, 0x46c021a4 );	ROM_LOAD( "136023.510",   0x4000, 0x2000, 0x8c9cf017 );	ROM_LOAD( "136023.511",   0x6000, 0x2000, 0x66fd8a34 );	ROM_LOAD( "136023.512",   0x8000, 0x2000, 0x48c8079e );	ROM_LOAD( "136023.513",   0xa000, 0x2000, 0x13f1cbab );	ROM_LOAD( "136023.514",   0xc000, 0x2000, 0x6f8c7991 );	ROM_LOAD( "136023.515",   0xe000, 0x2000, 0x835438a0 );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136023.305",   0x0000, 0x1000, 0xee443909 );	ROM_LOAD( "136023.306",   0x1000, 0x1000, 0xd708b132 );
		ROM_REGION( 0x2000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136023.307",   0x0000, 0x1000, 0xc42c84a4 );	ROM_LOAD( "136023.308",   0x1000, 0x1000, 0x4fe13d58 );ROM_END(); }}; 
