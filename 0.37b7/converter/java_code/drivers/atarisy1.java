...
public class atarisy1
{
	...
	public static ReadHandlerPtr joystick_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (joystick_type == 1)
			newval = (input_port_0_r.handler(offset) & (0x80 >> (offset / 2))) ? 0xf0 : 0x00;
	
		/* Hall-effect analog joystick */
		else if (joystick_type == 2)
			newval = (offset & 2) ? input_port_0_r.handler(offset) : input_port_1_r.handler(offset);
	...
	public static ReadHandlerPtr trakball_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (trackball_type == 1)
		{
			...
			if (which == 0)
			{
				...
				if (player == 0)
				{
					posx = (INT8)input_port_0_r.handler(offset);
					posy = (INT8)input_port_1_r.handler(offset);
				}
				else
				{
					posx = (INT8)input_port_2_r.handler(offset);
					posy = (INT8)input_port_3_r.handler(offset);
				}
	...
	public static ReadHandlerPtr switch_6502_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (!(input_port_4_r.handler(offset) & 0x0040)) temp ^= 0x80;
	...
	PORT_START();   /* F20000 */
		...
		PORT_START(); 	/* F60000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 1820 (sound) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x60, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_SPECIAL );INPUT_PORTS_END(); }}; 
	
	
	static InputPortPtr input_ports_peterpak = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* F40000 */
		PORT_BIT( 0x0f, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT );
		PORT_START(); 	/* n/a */
		...
		PORT_BIT( 0xff, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* F60000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 1820 (sound) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x60, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_SPECIAL );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* F40000 */
		...
		PORT_BIT( 0xff, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* F60000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN );/* freeze? */
		PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 1820 (sound) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x60, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_SPECIAL );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* F40000 */
		...
		PORT_BIT( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* F60000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 1820 (sound) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x60, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_SPECIAL );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* F20000 */
		...
		PORT_BIT( 0xff, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* F60000 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 1820 (sound) */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_SPECIAL );	PORT_BIT( 0x60, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_SPECIAL );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_marble = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136033.401",   0x10000, 0x08000, 0xecfc25a2 );	ROM_LOAD_ODD ( "136033.402",   0x10000, 0x08000, 0x7ce9bf53 );	ROM_LOAD_EVEN( "136033.403",   0x20000, 0x08000, 0xdafee7a2 );	ROM_LOAD_ODD ( "136033.404",   0x20000, 0x08000, 0xb59ffcf6 );	ROM_LOAD_EVEN( "136033.107",   0x80000, 0x04000, 0xf3b8745b );	ROM_LOAD_ODD ( "136033.108",   0x80000, 0x04000, 0xe51eecaa );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136033.421",   0x8000, 0x4000, 0x78153dc3 );	ROM_LOAD( "136033.422",   0xc000, 0x4000, 0x2e66300e );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	
		ROM_REGION( 0x60000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136033.137",   0x00000, 0x04000, 0x7a45f5c1 ); /* bank 1, plane 0 */
		ROM_LOAD( "136033.138",   0x04000, 0x04000, 0x7e954a88 );	ROM_LOAD( "136033.139",   0x08000, 0x04000, 0x1eb1bb5f ); /* bank 1, plane 1 */
		ROM_LOAD( "136033.140",   0x0c000, 0x04000, 0x8a82467b );	ROM_LOAD( "136033.141",   0x10000, 0x04000, 0x52448965 ); /* bank 1, plane 2 */
		ROM_LOAD( "136033.142",   0x14000, 0x04000, 0xb4a70e4f );	ROM_LOAD( "136033.143",   0x18000, 0x04000, 0x7156e449 ); /* bank 1, plane 3 */
		ROM_LOAD( "136033.144",   0x1c000, 0x04000, 0x4c3e4c79 );	ROM_LOAD( "136033.145",   0x20000, 0x04000, 0x9062be7f ); /* bank 1, plane 4 */
	...
	static RomLoadPtr rom_marble2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136033.201",   0x10000, 0x08000, 0x9395804d );	ROM_LOAD_ODD ( "136033.202",   0x10000, 0x08000, 0xedd313f5 );	ROM_LOAD_EVEN( "136033.403",   0x20000, 0x08000, 0xdafee7a2 );	ROM_LOAD_ODD ( "136033.204",   0x20000, 0x08000, 0x4d621731 );	ROM_LOAD_EVEN( "136033.107",   0x80000, 0x04000, 0xf3b8745b );	ROM_LOAD_ODD ( "136033.108",   0x80000, 0x04000, 0xe51eecaa );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136033.121",   0x8000, 0x4000, 0x73fe2b46 );	ROM_LOAD( "136033.122",   0xc000, 0x4000, 0x03bf65c3 );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	...
	static RomLoadPtr rom_marblea = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136033.323",   0x10000, 0x04000, 0x4dc2987a );	ROM_LOAD_ODD ( "136033.324",   0x10000, 0x04000, 0xe22e6e11 );	ROM_LOAD_EVEN( "136033.225",   0x18000, 0x04000, 0x743f6c5c );	ROM_LOAD_ODD ( "136033.226",   0x18000, 0x04000, 0xaeb711e3 );	ROM_LOAD_EVEN( "136033.227",   0x20000, 0x04000, 0xd06d2c22 );	ROM_LOAD_ODD ( "136033.228",   0x20000, 0x04000, 0xe69cec16 );	ROM_LOAD_EVEN( "136033.229",   0x28000, 0x04000, 0xc81d5c14 );	ROM_LOAD_ODD ( "136033.230",   0x28000, 0x04000, 0x526ce8ad );	ROM_LOAD_EVEN( "136033.107",   0x80000, 0x04000, 0xf3b8745b );	ROM_LOAD_ODD ( "136033.108",   0x80000, 0x04000, 0xe51eecaa );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136033.257",   0x8000, 0x4000, 0x2e2e0df8 );	ROM_LOAD( "136033.258",   0xc000, 0x4000, 0x1b9655cd );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	...
	static RomLoadPtr rom_peterpak = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136028.142",   0x10000, 0x04000, 0x4f9fc020 );	ROM_LOAD_ODD ( "136028.143",   0x10000, 0x04000, 0x9fb257cc );	ROM_LOAD_EVEN( "136028.144",   0x18000, 0x04000, 0x50267619 );	ROM_LOAD_ODD ( "136028.145",   0x18000, 0x04000, 0x7b6a5004 );	ROM_LOAD_EVEN( "136028.146",   0x20000, 0x04000, 0x4183a67a );	ROM_LOAD_ODD ( "136028.147",   0x20000, 0x04000, 0x14e2d97b );	ROM_LOAD_EVEN( "136028.148",   0x80000, 0x04000, 0x230e8ba9 );	ROM_LOAD_ODD ( "136028.149",   0x80000, 0x04000, 0x0ff0c13a );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136028.101",   0x8000, 0x4000, 0xff712aa2 );	ROM_LOAD( "136028.102",   0xc000, 0x4000, 0x89ea21a1 );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	
		ROM_REGION( 0x90000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136028.138",   0x00000, 0x08000, 0x53eaa018 ); /* bank 1, plane 0 */
	...
	static RomLoadPtr rom_indytemp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136036.432",   0x10000, 0x08000, 0xd888cdf1 );	ROM_LOAD_ODD ( "136036.431",   0x10000, 0x08000, 0xb7ac7431 );	ROM_LOAD_EVEN( "136036.434",   0x20000, 0x08000, 0x802495fd );	ROM_LOAD_ODD ( "136036.433",   0x20000, 0x08000, 0x3a914e5c );	ROM_LOAD_EVEN( "136036.456",   0x30000, 0x04000, 0xec146b09 );	ROM_LOAD_ODD ( "136036.457",   0x30000, 0x04000, 0x6628de01 );	ROM_LOAD_EVEN( "136036.358",   0x80000, 0x04000, 0xd9351106 );	ROM_LOAD_ODD ( "136036.359",   0x80000, 0x04000, 0xe731caea );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136036.153",   0x4000, 0x4000, 0x95294641 );	ROM_LOAD( "136036.154",   0x8000, 0x4000, 0xcbfc6adb );	ROM_LOAD( "136036.155",   0xc000, 0x4000, 0x4c8233ac );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	
		ROM_REGION( 0xc0000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136036.135",   0x00000, 0x08000, 0xffa8749c ); /* bank 1, plane 0 */
	...
	static RomLoadPtr rom_indytem2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136036.470",   0x10000, 0x08000, 0x7fac1dd8 );	ROM_LOAD_ODD ( "136036.471",   0x10000, 0x08000, 0xe93272fb );	ROM_LOAD_EVEN( "136036.434",   0x20000, 0x08000, 0x802495fd );	ROM_LOAD_ODD ( "136036.433",   0x20000, 0x08000, 0x3a914e5c );	ROM_LOAD_EVEN( "136036.456",   0x30000, 0x04000, 0xec146b09 );	ROM_LOAD_ODD ( "136036.457",   0x30000, 0x04000, 0x6628de01 );	ROM_LOAD_EVEN( "136036.358",   0x80000, 0x04000, 0xd9351106 );	ROM_LOAD_ODD ( "136036.359",   0x80000, 0x04000, 0xe731caea );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136036.153",   0x4000, 0x4000, 0x95294641 );	ROM_LOAD( "136036.154",   0x8000, 0x4000, 0xcbfc6adb );	ROM_LOAD( "136036.155",   0xc000, 0x4000, 0x4c8233ac );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	...
	static RomLoadPtr rom_indytem3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "232.10b",      0x10000, 0x08000, 0x1e80108f );	ROM_LOAD_ODD ( "231.10a",      0x10000, 0x08000, 0x8ae54c0c );	ROM_LOAD_EVEN( "234.12b",      0x20000, 0x08000, 0x86be7e07 );	ROM_LOAD_ODD ( "233.12a",      0x20000, 0x08000, 0xbfcea7ae );	ROM_LOAD_EVEN( "256.15b",      0x30000, 0x04000, 0x3a076fd2 );	ROM_LOAD_ODD ( "257.15a",      0x30000, 0x04000, 0x15293606 );	ROM_LOAD_EVEN( "158.16b",      0x80000, 0x04000, 0x10372888 );	ROM_LOAD_ODD ( "159.16a",      0x80000, 0x04000, 0x50f890a8 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136036.153",   0x4000, 0x4000, 0x95294641 );	ROM_LOAD( "136036.154",   0x8000, 0x4000, 0xcbfc6adb );	ROM_LOAD( "136036.155",   0xc000, 0x4000, 0x4c8233ac );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	...
	static RomLoadPtr rom_indytem4 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136036.332",   0x10000, 0x08000, 0xa5563773 );	ROM_LOAD_ODD ( "136036.331",   0x10000, 0x08000, 0x7d562141 );	ROM_LOAD_EVEN( "136036.334",   0x20000, 0x08000, 0xe40828e5 );	ROM_LOAD_ODD ( "136036.333",   0x20000, 0x08000, 0x96e1f1aa );	ROM_LOAD_EVEN( "136036.356",   0x30000, 0x04000, 0x5eba2ac7 );	ROM_LOAD_ODD ( "136036.357",   0x30000, 0x04000, 0x26e84b5c );	ROM_LOAD_EVEN( "136036.358",   0x80000, 0x04000, 0xd9351106 );	ROM_LOAD_ODD ( "136036.359",   0x80000, 0x04000, 0xe731caea );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136036.153",   0x4000, 0x4000, 0x95294641 );	ROM_LOAD( "136036.154",   0x8000, 0x4000, 0xcbfc6adb );	ROM_LOAD( "136036.155",   0xc000, 0x4000, 0x4c8233ac );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	...
	static RomLoadPtr rom_roadrunn = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "136040.228",   0x10000, 0x08000, 0xb66c629a );	ROM_LOAD_ODD ( "136040.229",   0x10000, 0x08000, 0x5638959f );	ROM_LOAD_EVEN( "136040.230",   0x20000, 0x08000, 0xcd7956a3 );	ROM_LOAD_ODD ( "136040.231",   0x20000, 0x08000, 0x722f2d3b );	ROM_LOAD_EVEN( "136040.134",   0x50000, 0x08000, 0x18f431fe );	ROM_LOAD_ODD ( "136040.135",   0x50000, 0x08000, 0xcb06f9ab );	ROM_LOAD_EVEN( "136040.136",   0x60000, 0x08000, 0x8050bce4 );	ROM_LOAD_ODD ( "136040.137",   0x60000, 0x08000, 0x3372a5cf );	ROM_LOAD_EVEN( "136040.138",   0x70000, 0x08000, 0xa83155ee );	ROM_LOAD_ODD ( "136040.139",   0x70000, 0x08000, 0x23aead1c );	ROM_LOAD_EVEN( "136040.140",   0x80000, 0x04000, 0xd1464c88 );	ROM_LOAD_ODD ( "136040.141",   0x80000, 0x04000, 0xf8f2acdf );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "136040.143",   0x8000, 0x4000, 0x62b9878e );	ROM_LOAD( "136040.144",   0xc000, 0x4000, 0x6ef1b804 );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136040.101",   0x00000, 0x08000, 0x26d9f29c ); /* bank 1, plane 0 */
	...
	static RomLoadPtr rom_roadblst = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x88000, REGION_CPU1 );/* 8.5*64k for 68000 code & slapstic ROM */
		ROM_LOAD_EVEN( "136032.205",   0x00000, 0x04000, 0x88d0be26 );	ROM_LOAD_ODD ( "136032.206",   0x00000, 0x04000, 0x3c79ef05 );	ROM_LOAD_EVEN( "048-1139.rom", 0x10000, 0x10000, 0xb73c1bd5 );	ROM_LOAD_ODD ( "048-1140.rom", 0x10000, 0x10000, 0x6305429b );	ROM_LOAD_EVEN( "048-1155.rom", 0x50000, 0x10000, 0xe95fc7d2 );	ROM_LOAD_ODD ( "048-1156.rom", 0x50000, 0x10000, 0x727510f9 );	ROM_LOAD_EVEN( "048-1167.rom", 0x70000, 0x08000, 0xc6d30d6f );	ROM_LOAD_ODD ( "048-1168.rom", 0x70000, 0x08000, 0x16951020 );	ROM_LOAD_EVEN( "048-2147.rom", 0x80000, 0x04000, 0x5c1adf67 );	ROM_LOAD_ODD ( "048-2148.rom", 0x80000, 0x04000, 0xd9ac8966 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "048-1149.rom", 0x4000, 0x4000, 0x2e54f95e );	ROM_LOAD( "048-1169.rom", 0x8000, 0x4000, 0xee318052 );	ROM_LOAD( "048-1170.rom", 0xc000, 0x4000, 0x75dfec33 );
		ROM_REGION( 0x2000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "136032.107",   0x00000, 0x02000, 0x7a29dc07 ); /* alpha font */
	
		ROM_REGION( 0x120000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "048-1101.rom", 0x00000, 0x08000, 0xfe342d27 ); /* bank 1, plane 0 */
