...
public class arcadecl
{
	...
	PORT_START(); 	/* 640000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640002 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640010 */
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT(  0x0080, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT(  0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640012 */
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT(  0x000c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT(  0xffc0, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640020 */
	    PORT_ANALOGX( 0x00ff, 0, IPT_TRACKBALL_X | IPF_REVERSE | IPF_PLAYER2, 50, 32, 0, 0, KEYCODE_UP, KEYCODE_DOWN, JOYCODE_2_UP, JOYCODE_2_DOWN );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640022 */
		PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_Y | IPF_PLAYER2, 50, 32, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640024 */
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_X | IPF_REVERSE | IPF_PLAYER1, 50, 32, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640026 */
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_Y | IPF_PLAYER1, 50, 32, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	
	
	static InputPortPtr input_ports_sparkz = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* 640000 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );
		PORT_START(); 	/* 640002 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );
		PORT_START(); 	/* 640010 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 640012 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x000c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT( 0xffc0, IP_ACTIVE_LOW, IPT_UNUSED );
	...
	static RomLoadPtr rom_arcadecl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1 );	ROM_LOAD_EVEN( "pgm0",  0x00000, 0x80000, 0xb5b93623 );	ROM_LOAD_ODD ( "prog1", 0x00000, 0x80000, 0xe7efef85 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "atcl_mob",   0x00000, 0x80000, 0x0e9b3930 );
		ROM_REGION( 0x80000, REGION_SOUND1 );	ROM_LOAD( "adpcm",      0x00000, 0x80000, 0x03ca7f03 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_sparkz = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1 );	ROM_LOAD_EVEN( "sparkzpg.0", 0x00000, 0x80000, 0xa75c331c );	ROM_LOAD_ODD ( "sparkzpg.1", 0x00000, 0x80000, 0x1af1fc04 );
		ROM_REGION( 0x20, REGION_GFX1 | REGIONFLAG_DISPOSE );	/* empty */
	
		ROM_REGION( 0x80000, REGION_SOUND1 );	ROM_LOAD( "sparkzsn",      0x00000, 0x80000, 0x87097ce2 );ROM_END(); }}; 
