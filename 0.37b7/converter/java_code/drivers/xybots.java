...
public class xybots
{
	...
	PORT_START(); 	/* ffe100 */
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BITX(0x0004, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2, "P2 Twist Right", KEYCODE_W, IP_JOY_DEFAULT );	PORT_BITX(0x0008, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2, "P2 Twist Left", KEYCODE_Q, IP_JOY_DEFAULT );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 | IPF_8WAY );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BITX(0x0400, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1, "P1 Twist Right", KEYCODE_X, IP_JOY_DEFAULT );	PORT_BITX(0x0800, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1, "P1 Twist Left", KEYCODE_Z, IP_JOY_DEFAULT );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 | IPF_8WAY );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 | IPF_8WAY );
		PORT_START(); 	/* ffe200 */
		PORT_BIT( 0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0100, IP_ACTIVE_LOW );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_UNUSED );	/* /AUDBUSY */
	...
	static RomLoadPtr rom_xybots = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "2112.c17",     0x00000, 0x10000, 0x16d64748 );	ROM_LOAD_ODD ( "2113.c19",     0x00000, 0x10000, 0x2677d44a );	ROM_LOAD_EVEN( "2114.b17",     0x20000, 0x08000, 0xd31890cb );	ROM_LOAD_ODD ( "2115.b19",     0x20000, 0x08000, 0x750ab1b0 );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "xybots.snd",   0x10000, 0x4000, 0x3b9f155d );	ROM_CONTINUE(             0x04000, 0xc000 );
		ROM_REGION( 0x40000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2102.l13",     0x00000, 0x08000, 0xc1309674 );	ROM_RELOAD(               0x08000, 0x08000 );	ROM_LOAD( "2103.l11",     0x10000, 0x10000, 0x907c024d );	ROM_LOAD( "2117.l7",      0x30000, 0x10000, 0x0cc9b42d );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1105.de1",     0x00000, 0x10000, 0x315a4274 );	ROM_LOAD( "1106.e1",      0x10000, 0x10000, 0x3d8c1dd2 );	ROM_LOAD( "1107.f1",      0x20000, 0x10000, 0xb7217da5 );	ROM_LOAD( "1108.fj1",     0x30000, 0x10000, 0x77ac65e1 );	ROM_LOAD( "1109.j1",      0x40000, 0x10000, 0x1b482c53 );	ROM_LOAD( "1110.k1",      0x50000, 0x10000, 0x99665ff4 );	ROM_LOAD( "1111.kl1",     0x60000, 0x10000, 0x416107ee );
		ROM_REGION( 0x02000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1101.c4",      0x00000, 0x02000, 0x59c028a2 );ROM_END(); }}; 
