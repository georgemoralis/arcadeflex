...
public class psikyo
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr psikyo_soundlatch_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr gunbird_input_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch(offset)
		{
	...
	public static ReadHandlerPtr s1945_input_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch(offset)
		{
			case 0x0:	return readinputport(0);
	...
	public static ReadHandlerPtr sngkace_input_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch(offset)
		{
			case 0x0:	return readinputport(0);
	...
	***************************************************************************/
	...
	static MemoryReadAddress sngkace_readmem[] =
	{
		new MemoryReadAddress( 0x000000, 0x0fffff, MRA_ROM			),	// ROM (not all used)
		new MemoryReadAddress( 0xfe0000, 0xffffff, MRA_BANK1			),	// RAM
		new MemoryReadAddress( 0x400000, 0x4017ff, MRA_BANK2			),	// Sprites Data
		new MemoryReadAddress( 0x401800, 0x401fff, MRA_BANK3			),	// Sprites List
		new MemoryReadAddress( 0x600000, 0x601fff, MRA_BANK4			),	// Palette
		new MemoryReadAddress( 0x800000, 0x801fff, MRA_BANK5			),	// Layer 0
		new MemoryReadAddress( 0x802000, 0x803fff, MRA_BANK6			),	// Layer 1
		new MemoryReadAddress( 0x804000, 0x807fff, MRA_BANK7			),	// RAM + Vregs
		new MemoryReadAddress( 0xc00000, 0xc0000b, sngkace_input_r	),	// Input Ports
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress sngkace_writemem[] =
	{
		new MemoryWriteAddress( 0x000000, 0x0fffff, MWA_ROM							),	// ROM (not all used)
		new MemoryWriteAddress( 0xfe0000, 0xffffff, MWA_BANK1							),	// RAM
		new MemoryWriteAddress( 0x400000, 0x4017ff, MWA_BANK2, spriteram				),	// Sprites Data
		new MemoryWriteAddress( 0x401800, 0x401fff, MWA_BANK3, spriteram_2			),	// Sprites List
		new MemoryWriteAddress( 0x600000, 0x601fff, paletteram_xRRRRRGGGGGBBBBB_word_w, paletteram	),	// Palette
		new MemoryWriteAddress( 0x800000, 0x801fff, psikyo_vram_0_w, psikyo_vram_0	),	// Layer 0
		new MemoryWriteAddress( 0x802000, 0x803fff, psikyo_vram_1_w, psikyo_vram_1	),	// Layer 1
		new MemoryWriteAddress( 0x804000, 0x807fff, MWA_BANK7, psikyo_vregs			),	// RAM + Vregs
		new MemoryWriteAddress( 0xc00010, 0xc00011, MWA_NOP							),	// To Sound CPU
		new MemoryWriteAddress( 0xc00012, 0xc00013, psikyo_soundlatch_w				),	//
	...
	***************************************************************************/
	...
	static MemoryReadAddress gunbird_sound_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x7fff, MRA_ROM		),	// ROM
		new MemoryReadAddress( 0x8000, 0x81ff, MRA_RAM		),	// RAM
		new MemoryReadAddress( 0x8200, 0xffff, MRA_BANK15	),	// Banked ROM
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress gunbird_sound_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x7fff, MWA_ROM		),	// ROM
		new MemoryWriteAddress( 0x8000, 0x81ff, MWA_RAM		),	// RAM
		new MemoryWriteAddress( 0x8200, 0xffff, MWA_ROM		),	// Banked ROM
		new MemoryWriteAddress( -1 )
	};
	
	
	static IOReadPort gunbird_sound_readport[] =
	{
		new IOReadPort( 0x04, 0x04, YM2610_status_port_0_A_r		),
		new IOReadPort( 0x06, 0x06, YM2610_status_port_0_B_r		),
		new IOReadPort( 0x08, 0x08, soundlatch_r					),
		new IOReadPort( -1 )
	};
	static IOWritePort gunbird_sound_writeport[] =
	{
		new IOWritePort( 0x00, 0x00, gunbird_sound_bankswitch_w	),
		new IOWritePort( 0x04, 0x04, YM2610_control_port_0_A_w		),
		new IOWritePort( 0x05, 0x05, YM2610_data_port_0_A_w		),
		new IOWritePort( 0x06, 0x06, YM2610_control_port_0_B_w		),
		new IOWritePort( 0x07, 0x07, YM2610_data_port_0_B_w		),
		new IOWritePort( 0x0c, 0x0c, psikyo_ack_latch_w			),
		new IOWritePort( -1 )
	};
	...
	***************************************************************************/
	...
	static MemoryReadAddress sngkace_sound_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x77ff, MRA_ROM		),	// ROM
		new MemoryReadAddress( 0x7800, 0x7fff, MRA_RAM		),	// RAM
		new MemoryReadAddress( 0x8000, 0xffff, MRA_BANK15	),	// Banked ROM
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress sngkace_sound_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x77ff, MWA_ROM		),	// ROM
		new MemoryWriteAddress( 0x7800, 0x7fff, MWA_RAM		),	// RAM
		new MemoryWriteAddress( 0x8000, 0xffff, MWA_ROM		),	// Banked ROM
		new MemoryWriteAddress( -1 )
	};
	
	
	static IOReadPort sngkace_sound_readport[] =
	{
	...
	static IOWritePort sngkace_sound_writeport[] =
	{
		...
		new IOWritePort( 0x04, 0x04, sngkace_sound_bankswitch_w	),
		new IOWritePort( 0x0c, 0x0c, psikyo_ack_latch_w			),
		new IOWritePort( -1 )
	};
	...
	***************************************************************************/
	...
	static IOReadPort s1945_sound_readport[] =
	{
		new IOReadPort( 0x08, 0x08, YM2610_status_port_0_A_r		),
	//	new IOReadPort( 0x06, 0x06, YM2610_status_port_0_B_r		),
		new IOReadPort( 0x10, 0x10, soundlatch_r					),
		new IOReadPort( -1 )
	};
	static IOWritePort s1945_sound_writeport[] =
	{
		new IOWritePort( 0x00, 0x00, gunbird_sound_bankswitch_w	),
	//	new IOWritePort( 0x02, 0x02, IOWP_NOP	),
	//	new IOWritePort( 0x03, 0x03, IOWP_NOP	),
		new IOWritePort( 0x08, 0x08, YM2610_control_port_0_A_w		),
		new IOWritePort( 0x09, 0x09, YM2610_data_port_0_A_w		),
		new IOWritePort( 0x0a, 0x0a, YM2610_control_port_0_B_w		),
		new IOWritePort( 0x0b, 0x0b, YM2610_data_port_0_B_w		),
	//	new IOWritePort( 0x0c, 0x0c, IOWP_NOP	),
	//	new IOWritePort( 0x0d, 0x0d, IOWP_NOP	),
		new IOWritePort( 0x18, 0x18, psikyo_ack_latch_w			),
		new IOWritePort( -1 )
	};
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_gunbird = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_START2                       );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER2 );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER2 );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER2 );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER2 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER2 );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER2 );
		PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_START1                       );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_BUTTON3        | IPF_PLAYER1 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_BUTTON2        | IPF_PLAYER1 );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_BUTTON1        | IPF_PLAYER1 );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 );
		PORT_START(); 	// IN1 - c00002&3
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_COIN1    );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2    );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN  );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BITX(0x0020, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_TILT     );/*	PORT_BIT( 0x0080,  From Sound CPU here );*/
		...
		PORT_DIPNAME( 0x0002, 0x0000, "Sound" );	PORT_DIPSETTING(      0x0002, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_DIPNAME( 0x000c, 0x000c, "?Difficulty?" );	PORT_DIPSETTING(      0x0008, "0" );	PORT_DIPSETTING(      0x000c, "1" );	PORT_DIPSETTING(      0x0004, "2" );	PORT_DIPSETTING(      0x0000, "3" );	PORT_DIPNAME( 0x0030, 0x0030, DEF_STR( "Lives") );
		...
		PORT_DIPSETTING(      0x0040, "400K" );	PORT_DIPSETTING(      0x0000, "600K" );	PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );
		PORT_DIPNAME( 0x0100, 0x0100, "Credits/Coinage" );// [Free Play] on all for free play
		PORT_DIPSETTING(      0x0100, "A+B/A&B" );	PORT_DIPSETTING(      0x0000, "A&B/A [Free Play]" );	PORT_DIPNAME( 0x0e00, 0x0e00, DEF_STR( "Coin_A") );
		...
		PORT_DIPSETTING(      0x0000, "1C 6C [Free Play]" );	PORT_DIPNAME( 0x7000, 0x7000, DEF_STR( "Coin_B") );
		...
		PORT_DIPSETTING(      0x0000, "1C 6C [Free Play]" );	PORT_DIPNAME( 0x8000, 0x8000, "Force 1C 1C" );	PORT_DIPSETTING(      0x8000, DEF_STR( "No") );
		...
		PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_VBLANK  );// vblank
	
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );// tested!
		PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );// tested!
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_sngkace = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	// IN3
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_VBLANK  );// vblank
		PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN );// unused?
		PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_UNKNOWN );// unused?
		PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static YM2610interface gunbird_ym2610_interface = new YM2610interface
	(
		1,
		8000000,	/* ? */
		new int[] { MIXERG(30,MIXER_GAIN_4x,MIXER_PAN_CENTER) },
		new ReadHandlerPtr[] { 0 },	/* A_r */
		new ReadHandlerPtr[] { 0 },	/* B_r */
		new WriteHandlerPtr[] { 0 },	/* A_w */
		new WriteHandlerPtr[] { 0 },	/* B_w */
		new WriteYmHandlerPtr[] { sound_irq },	/* irq */
		new int[] { REGION_SOUND1 },	/* delta_t */
		new int[] { REGION_SOUND2 },	/* adpcm */
	...
	***************************************************************************/
	...
	static YM2610interface sngkace_ym2610_interface = new YM2610interface
	(
		1,
		8000000,	/* ? */
		new int[] { MIXERG(30,MIXER_GAIN_4x,MIXER_PAN_CENTER) },
	...
	***************************************************************************/
	...
	static YM2610interface s1945_ym2610_interface = new YM2610interface
	(
		1,
		8000000,	/* ? */
		new int[] { MIXERG(30,MIXER_GAIN_4x,MIXER_PAN_CENTER) },
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_gunbird = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "3-u71.bin", 0x00000, 0x20000, 0x2168e4ba );	ROM_RELOAD(            0x10000, 0x20000             );
		ROM_REGION( 0x700000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "u14.bin",  0x000000, 0x200000, 0x7d7e8a00 );	ROM_LOAD( "u24.bin",  0x200000, 0x200000, 0x5e3ffc9d );	ROM_LOAD( "u15.bin",  0x400000, 0x200000, 0xa827bfb5 );	ROM_LOAD( "u25.bin",  0x600000, 0x100000, 0xef652e0c );
		...
		ROM_LOAD( "u33.bin",  0x000000, 0x100000, 0x54494e6b );	ROM_CONTINUE(         0x000000, 0x100000             );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_sngkace = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x030000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD( "3-u58.bin", 0x00000, 0x20000, 0x310f5c76 );	ROM_RELOAD(            0x10000, 0x20000             );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_sngkblad = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x030000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD( "1-u63.bin", 0x00000, 0x20000, 0x2025e387 );	ROM_RELOAD(            0x10000, 0x20000             );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_s1945 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x030000, REGION_CPU2 );	/* Sound CPU Code */
		ROM_LOAD( "3-u63.bin", 0x00000, 0x20000, 0x42d40ae1 );	ROM_RELOAD(            0x10000, 0x20000             );
		ROM_REGION( 0x000100, REGION_CPU3 );	/* MCU? */
		ROM_LOAD( "4-u59.bin", 0x00000, 0x00100, 0x00000000 );
		ROM_REGION( 0x800000, REGION_GFX1 | REGIONFLAG_DISPOSE );/* Sprites */
		ROM_LOAD( "u20.bin",  0x000000, 0x200000, 0x28a27fee );	ROM_LOAD( "u21.bin",  0x200000, 0x200000, 0xc5d60ea9 );	ROM_LOAD( "u22.bin",  0x400000, 0x200000, 0xca152a32 );	ROM_LOAD( "u23.bin",  0x600000, 0x200000, 0x48710332 );
		ROM_REGION( 0x200000, REGION_GFX2 | REGIONFLAG_DISPOSE );/* Layer 0 */
		ROM_LOAD( "u34.bin",  0x000000, 0x200000, 0xaaf83e23 );
		ROM_REGION( 0x100000, REGION_GFX3 | REGIONFLAG_DISPOSE );/* Layer 1 */
		ROM_LOAD( "u34.bin",  0x000000, 0x100000, 0xaaf83e23 );	ROM_CONTINUE(         0x000000, 0x100000             );
	...
	***************************************************************************/
	...
	public static GameDriver driver_sngkace	   = new GameDriver("1993"	,"sngkace"	,"psikyo.java"	,rom_sngkace,null	,machine_driver_sngkace	,input_ports_sngkace	,init_sngkace	,ROT270	,	"Psikyo", "Sengoku Ace (Japan)",   GAME_NO_COCKTAIL ) // Banpresto?
	public static GameDriver driver_gunbird	   = new GameDriver("1994"	,"gunbird"	,"psikyo.java"	,rom_gunbird,null	,machine_driver_gunbird	,input_ports_gunbird	,init_gunbird	,ROT270	,	"Psikyo", "Gun Bird (Japan)",      GAME_NO_COCKTAIL )
