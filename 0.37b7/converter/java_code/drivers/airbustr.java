...
public class airbustr
{
	...
	*/
	...
	static InputPortPtr input_ports_airbustr = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );// used
	
		PORT_START(); 	// IN3 - DSW-1
		PORT_DIPNAME( 0x01, 0x01, "Unknown 1-0" );	PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		...
		PORT_SERVICE( 0x04, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x08, 0x08, "Unknown 1-3" );	//	routine 56d:	11 21 12 16 (bit 3 active)
		...
		PORT_DIPSETTING(    0x02, "Easy" );	PORT_DIPSETTING(    0x03, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x04, 0x04, "Unknown 2-2" );	PORT_DIPSETTING(    0x04, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x08, "Freeze" );	PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPSETTING(    0x00, "7" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Demo_Sounds") );
	...
	*/
	...
	(
		...
		new WriteHandlerPtr[] { input_port_4_r },			/* DSW-2 connected to port B */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_airbustr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x24000, REGION_CPU1 );	ROM_LOAD( "pr-14j.bin", 0x00000, 0x0c000, 0x6b9805bd );	ROM_CONTINUE(           0x10000, 0x14000 );
		ROM_REGION( 0x24000, REGION_CPU2 );	ROM_LOAD( "pr-11j.bin", 0x00000, 0x0c000, 0x85464124 );	ROM_CONTINUE(           0x10000, 0x14000 );
		ROM_REGION( 0x24000, REGION_CPU3 );	ROM_LOAD( "pr-21.bin",  0x00000, 0x0c000, 0x6e0a5df0 );	ROM_CONTINUE(           0x10000, 0x14000 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pr-000.bin", 0x000000, 0x80000, 0x8ca68f0d );// scrolling layers
	
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pr-001.bin", 0x000000, 0x80000, 0x7e6cb377 );// sprites
		ROM_LOAD( "pr-02.bin",  0x080000, 0x10000, 0x6bbd5e46 );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* OKI-M6295 samples */
		ROM_LOAD( "pr-200.bin", 0x00000, 0x40000, 0xa4dd3390 );ROM_END(); }}; 
