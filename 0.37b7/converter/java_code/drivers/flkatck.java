...
public class flkatck
{
	...
	PORT_START(); 	/* DSW #1 */
		...
		PORT_DIPSETTING(	0x18, "30000 70000" );	PORT_DIPSETTING(	0x10, "40000 80000" );	PORT_DIPSETTING(	0x08, "30000" );	PORT_DIPSETTING(	0x00, "40000" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
	...
	static RomLoadPtr rom_mx5000 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mask4m.bin",     0x000000, 0x080000, 0xff1d718b );* tiles + sprites */
	
		ROM_REGION( 0x040000, REGION_SOUND1 );/* 007232 data (chip 1) */
		ROM_LOAD( "mask2m.bin",     0x000000, 0x040000, 0x6d1ea61c );ROM_END(); }}; 
