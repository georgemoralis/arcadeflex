...
public class toaplan1
{
	...
	*****************************************************************************/
	...
	PORT_START(); 		/* VBlank */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0xfe, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		...
		PORT_SERVICE( 0x04, IP_ACTIVE_HIGH );	PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x03, "Hardest" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x08, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x20, "Territory/Copyright" );	PORT_DIPSETTING(    0x20, "World/Taito Corp Japan" );	PORT_DIPSETTING(    0x10, "USA/Taito America" );	PORT_DIPSETTING(    0x00, "Japan/Taito Corp" );	PORT_DIPSETTING(    0x30, "USA/Taito America (Romstar); )
		PORT_DIPNAME( 0x40, 0x00, "Dip Switch Display" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	*/
		...
		PORT_DIPSETTING(    0x04, "50K, every 150K" );	PORT_DIPSETTING(    0x00, "70K, every 200K" );	PORT_DIPSETTING(    0x08, "100K only" );	PORT_DIPSETTING(    0x0c, "None" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPNAME( 0x40, 0x00, "Show Dip Switches" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x80, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		...
		PORT_DIPNAME( 0x07, 0x02, "Territory/Copyright" );	PORT_DIPSETTING(    0x02, "World/Taito Corp" );	PORT_DIPSETTING(    0x06, "World/Taito America" );	PORT_DIPSETTING(    0x04, "US/Taito America" );	PORT_DIPSETTING(    0x01, "US/Romstar" );	PORT_DIPSETTING(    0x00, "Japan/Taito Corp" );//	PORT_DIPSETTING(    0x05, "Same as 0x04" );//	PORT_DIPSETTING(    0x03, "Same as 0x02" );//	PORT_DIPSETTING(    0x07, "Same as 0x06" );	PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Unused") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x08, DEF_STR( "On") );
	...
	PORT_START(); 		/* VBlank */
		...
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x03, "Hardest" );	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
	    PORT_DIPSETTING(    0x00, "70K, every 200K" );    PORT_DIPSETTING(    0x04, "100K, every 250K" );	PORT_DIPSETTING(    0x08, "100K" );	PORT_DIPSETTING(    0x0c, "200K" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_BITX(    0x40, 0x00, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		...
		PORT_START(); 		/* Territory Jumper block */
		PORT_DIPNAME( 0x03, 0x02, "Territory" );	PORT_DIPSETTING(    0x02, "Europe" );//	PORT_DIPSETTING(    0x03, "Europe" );	PORT_DIPSETTING(    0x01, "US" );	PORT_DIPSETTING(    0x00, "Japan" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unused") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
	...
	PORT_START(); 		/* VBlank */
		...
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x03, "Hardest" );	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
	    PORT_DIPSETTING(    0x00, "200K, every 500K" );    PORT_DIPSETTING(    0x04, "500K, every 1M" );	PORT_DIPSETTING(    0x08, "500K" );	PORT_DIPSETTING(    0x0c, "None" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_BITX(    0x40, 0x00, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x80, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
	...
	PORT_START(); 		/* VBlank */
		...
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x03, "Hardest" );	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "30K, every 100K" );    PORT_DIPSETTING(    0x04, "50K and 100K" );	PORT_DIPSETTING(    0x08, "100K only" );	PORT_DIPSETTING(    0x0c, "None" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Lives") );
		...
		PORT_START(); 		/* Territory Jumper Block */
		PORT_DIPNAME( 0x03, 0x02, "Territory/Copyright" );	PORT_DIPSETTING(    0x02, "World/Taito Japan" );	PORT_DIPSETTING(    0x03, "US/Toaplan" );	PORT_DIPSETTING(    0x01, "US/Taito America" );	PORT_DIPSETTING(    0x00, "Japan/Taito Corp" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x04, DEF_STR( "On") );
		PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	*/
		...
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x03, "Hardest" );	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x04, "50K, every 150K" );	PORT_DIPSETTING(    0x00, "70K, every 200K" );	PORT_DIPSETTING(    0x08, "100K" );	PORT_DIPSETTING(    0x0c, "None" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_BITX(    0x40, 0x00, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x80, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
	...
	PORT_START(); 		/* VBlank */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x01, DEF_STR( "On") );
		PORT_DIPNAME( 0x06, 0x02, "Territory" );	PORT_DIPSETTING(    0x02, "Europe" );	PORT_DIPSETTING(    0x04, "USA" );	PORT_DIPSETTING(    0x00, "USA (Romstar); )
		PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x08, DEF_STR( "On") );
		PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 		/* VBlank */
		...
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x03, "Hardest" );	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "Every 300K" );	PORT_DIPSETTING(    0x04, "200K and 500K" );	PORT_DIPSETTING(    0x08, "300K only" );	PORT_DIPSETTING(    0x0c, "None" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "1" );	PORT_DIPSETTING(    0x20, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x10, "5" );	PORT_BITX( 0x40,    0x00, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", 0 ,0 );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Unused") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x80, DEF_STR( "On") );
		...
		PORT_START(); 		/* Territory Jumper Block */
		PORT_DIPNAME( 0x07, 0x02, "Territory" );	PORT_DIPSETTING(    0x02, "Europe" );	PORT_DIPSETTING(    0x01, "US" );	PORT_DIPSETTING(    0x00, "Japan" );	PORT_DIPSETTING(    0x03, "Hong Kong" );	PORT_DIPSETTING(    0x04, "Korea" );	PORT_DIPSETTING(    0x05, "Taiwan" );	PORT_DIPNAME( 0x08, 0x00, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x08, DEF_STR( "On") );
		PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 		/* VBlank */
		...
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x03, "Hardest" );	PORT_DIPNAME( 0x0c, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "70K and 200K" );	PORT_DIPSETTING(    0x04, "100K and 250K" );	PORT_DIPSETTING(    0x08, "100K" );	PORT_DIPSETTING(    0x0c, "200K" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "2" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_BITX(    0x40, 0x00, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x00, "Allow Continue" );	PORT_DIPSETTING(    0x80, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		...
		PORT_START(); 		/* Territory Jumper Block */
		PORT_DIPNAME( 0x0f, 0x02, "Territory" );	PORT_DIPSETTING(    0x02, "Europe" );	PORT_DIPSETTING(    0x01, "US" );	PORT_DIPSETTING(    0x00, "Japan" );	PORT_DIPSETTING(    0x03, "Hong Kong" );	PORT_DIPSETTING(    0x04, "Korea" );	PORT_DIPSETTING(    0x05, "Taiwan" );//	PORT_DIPSETTING(    0x06, "Taiwan" );//	PORT_DIPSETTING(    0x07, "US" );//	PORT_DIPSETTING(    0x08, "Hong Kong" );//	PORT_DIPSETTING(    0x09, DEF_STR( "Unused") );
	...
	//	PORT_DIPSETTING(    0x0f, "Japan" );	PORT_BIT( 0xf0, IP_ACTIVE_HIGH, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rallybik = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "b45-02.rom",  0x000000, 0x08000, 0x383386d7 );	ROM_LOAD_ODD ( "b45-01.rom",  0x000000, 0x08000, 0x7602f6a7 );	ROM_LOAD_EVEN( "b45-04.rom",  0x040000, 0x20000, 0xe9b005b1 );	ROM_LOAD_ODD ( "b45-03.rom",  0x040000, 0x20000, 0x555344ce );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound Z80 code */
		ROM_LOAD( "b45-05.rom",  0x0000, 0x4000, 0x10814601 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b45-09.bin",  0x00000, 0x20000, 0x1dc7b010 );	ROM_LOAD( "b45-08.bin",  0x20000, 0x20000, 0xfab661ba );	ROM_LOAD( "b45-07.bin",  0x40000, 0x20000, 0xcd3748b4 );	ROM_LOAD( "b45-06.bin",  0x60000, 0x20000, 0x144b085c );
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b45-11.rom",  0x00000, 0x10000, 0x0d56e8bb );	ROM_LOAD( "b45-10.rom",  0x10000, 0x10000, 0xdbb7c57e );	ROM_LOAD( "b45-12.rom",  0x20000, 0x10000, 0xcf5aae4e );	ROM_LOAD( "b45-13.rom",  0x30000, 0x10000, 0x1683b07c );
	...
	static RomLoadPtr rom_truxton = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "b65_11.bin",  0x000000, 0x20000, 0x1a62379a );	ROM_LOAD_ODD ( "b65_10.bin",  0x000000, 0x20000, 0xaff5195d );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound Z80 code */
		ROM_LOAD( "b65_09.bin",  0x0000, 0x8000, 0xf1c0f410 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b65_08.bin",  0x00000, 0x20000, 0xd2315b37 );	ROM_LOAD( "b65_07.bin",  0x20000, 0x20000, 0xfb83252a );	ROM_LOAD( "b65_06.bin",  0x40000, 0x20000, 0x36cedcbe );	ROM_LOAD( "b65_05.bin",  0x60000, 0x20000, 0x81cd95f1 );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b65_04.bin",  0x00000, 0x20000, 0x8c6ff461 );	ROM_LOAD( "b65_03.bin",  0x20000, 0x20000, 0x58b1350b );	ROM_LOAD( "b65_02.bin",  0x40000, 0x20000, 0x1dd55161 );	ROM_LOAD( "b65_01.bin",  0x60000, 0x20000, 0xe974937f );ROM_END(); }}; 
	
	static RomLoadPtr rom_hellfire = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "b90-14.bin",  0x000000, 0x20000, 0x101df9f5 );	ROM_LOAD_ODD ( "b90-15.bin",  0x000000, 0x20000, 0xe67fd452 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound Z80 code */
		ROM_LOAD( "b90-03.bin",  0x0000, 0x8000, 0x4058fa67 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b90-04.bin",  0x00000, 0x20000, 0xea6150fc );	ROM_LOAD( "b90-05.bin",  0x20000, 0x20000, 0xbb52c507 );	ROM_LOAD( "b90-06.bin",  0x40000, 0x20000, 0xcf5b0252 );	ROM_LOAD( "b90-07.bin",  0x60000, 0x20000, 0xb98af263 );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "b90-11.bin",  0x00000, 0x20000, 0xc33e543c );	ROM_LOAD( "b90-10.bin",  0x20000, 0x20000, 0x35fd1092 );	ROM_LOAD( "b90-09.bin",  0x40000, 0x20000, 0xcf01009e );	ROM_LOAD( "b90-08.bin",  0x60000, 0x20000, 0x3404a5e3 );ROM_END(); }}; 
	
	static RomLoadPtr rom_zerowing = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "o15-11.rom",  0x000000, 0x08000, 0x6ff2b9a0 );	ROM_LOAD_ODD ( "o15-12.rom",  0x000000, 0x08000, 0x9773e60b );	ROM_LOAD_EVEN( "o15-09.rom",  0x040000, 0x20000, 0x13764e95 );	ROM_LOAD_ODD ( "o15-10.rom",  0x040000, 0x20000, 0x351ba71a );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound Z80 code */
		ROM_LOAD( "o15-13.rom",  0x0000, 0x8000, 0xe7b72383 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "o15-05.rom",  0x00000, 0x20000, 0x4e5dd246 );	ROM_LOAD( "o15-06.rom",  0x20000, 0x20000, 0xc8c6d428 );	ROM_LOAD( "o15-07.rom",  0x40000, 0x20000, 0xefc40e99 );	ROM_LOAD( "o15-08.rom",  0x60000, 0x20000, 0x1b019eab );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "o15-03.rom",  0x00000, 0x20000, 0x7f245fd3 );	ROM_LOAD( "o15-04.rom",  0x20000, 0x20000, 0x0b1a1289 );	ROM_LOAD( "o15-01.rom",  0x40000, 0x20000, 0x70570e43 );	ROM_LOAD( "o15-02.rom",  0x60000, 0x20000, 0x724b487f );ROM_END(); }}; 
	
	static RomLoadPtr rom_demonwld = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "rom10",  0x000000, 0x20000, 0x036ee46c );	ROM_LOAD_ODD ( "rom09",  0x000000, 0x20000, 0xbed746e3 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound Z80 code */
		ROM_LOAD( "rom11",  0x0000, 0x8000, 0x397eca1b );
		ROM_REGION( 0x10000, REGION_CPU3 );/* Co-Processor TMS320C10 MCU code */
		ROM_LOAD_EVEN( "dsp_22.bin",  0x8000, 0x0800, 0x79389a71 );	ROM_LOAD_ODD ( "dsp_21.bin",  0x8000, 0x0800, 0x2d135376 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rom05",  0x00000, 0x20000, 0x6506c982 );	ROM_LOAD( "rom07",  0x20000, 0x20000, 0xa3a0d993 );	ROM_LOAD( "rom06",  0x40000, 0x20000, 0x4fc5e5f3 );	ROM_LOAD( "rom08",  0x60000, 0x20000, 0xeb53ab09 );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rom01",  0x00000, 0x20000, 0x1b3724e9 );	ROM_LOAD( "rom02",  0x20000, 0x20000, 0x7b20a44d );	ROM_LOAD( "rom03",  0x40000, 0x20000, 0x2cacdcd0 );	ROM_LOAD( "rom04",  0x60000, 0x20000, 0x76fd3201 );
	...
	static RomLoadPtr rom_samesame = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "o17_09.bin",  0x000000, 0x08000, 0x3f69e437 );	ROM_LOAD_ODD ( "o17_10.bin",  0x000000, 0x08000, 0x4e723e0a );	ROM_LOAD_EVEN( "o17_11.bin",  0x040000, 0x20000, 0xbe07d101 );	ROM_LOAD_ODD ( "o17_12.bin",  0x040000, 0x20000, 0xef698811 );
		...
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "o17_05.bin",  0x00000, 0x20000, 0x565315f8 );	ROM_LOAD( "o17_06.bin",  0x20000, 0x20000, 0x95262d4c );	ROM_LOAD( "o17_07.bin",  0x40000, 0x20000, 0x4c4b735c );	ROM_LOAD( "o17_08.bin",  0x60000, 0x20000, 0x95c6586c );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "o17_01.bin",  0x00000, 0x20000, 0xea12e491 );	ROM_LOAD( "o17_02.bin",  0x20000, 0x20000, 0x32a13a9f );	ROM_LOAD( "o17_03.bin",  0x40000, 0x20000, 0x68723dc9 );	ROM_LOAD( "o17_04.bin",  0x60000, 0x20000, 0xfe0ecb13 );ROM_END(); }}; 
	
	static RomLoadPtr rom_fireshrk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "9.bin",  0x000000, 0x08000, 0xf0c70e6f );	ROM_LOAD_ODD ( "10.bin", 0x000000, 0x08000, 0x9d253d77 );	ROM_LOAD_EVEN( "11.bin", 0x040000, 0x20000, 0x6beac378 );	ROM_LOAD_ODD ( "12.bin", 0x040000, 0x20000, 0x6adb6eb5 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound HD647180 code */
		/* sound CPU is a HD647180 (Z180) with internal ROM - not yet supported */
		ROM_LOAD( "hd647180.017",  0x00000, 0x08000, 0x00000000 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "o17_05.bin",  0x00000, 0x20000, 0x565315f8 );	ROM_LOAD( "o17_06.bin",  0x20000, 0x20000, 0x95262d4c );	ROM_LOAD( "o17_07.bin",  0x40000, 0x20000, 0x4c4b735c );	ROM_LOAD( "o17_08.bin",  0x60000, 0x20000, 0x95c6586c );
	...
	static RomLoadPtr rom_outzone = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "rom7.bin",  0x000000, 0x20000, 0x936e25d8 );	ROM_LOAD_ODD ( "rom8.bin",  0x000000, 0x20000, 0xd19b3ecf );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound Z80 code */
		ROM_LOAD( "rom9.bin",  0x0000, 0x8000, 0x73d8e235 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rom5.bin",  0x00000, 0x80000, 0xc64ec7b6 );	ROM_LOAD( "rom6.bin",  0x80000, 0x80000, 0x64b6c5ac );
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rom2.bin",  0x00000, 0x20000, 0x6bb72d16 );	ROM_LOAD( "rom1.bin",  0x20000, 0x20000, 0x0934782d );	ROM_LOAD( "rom3.bin",  0x40000, 0x20000, 0xec903c07 );	ROM_LOAD( "rom4.bin",  0x60000, 0x20000, 0x50cbf1a8 );ROM_END(); }}; 
	
	static RomLoadPtr rom_outzonep = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "18.bin",  0x000000, 0x20000, 0x31a171bb );	ROM_LOAD_ODD ( "19.bin",  0x000000, 0x20000, 0x804ecfd1 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound Z80 code */
		ROM_LOAD( "rom9.bin",  0x0000, 0x8000, 0x73d8e235 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rom5.bin",  0x00000, 0x80000, 0xc64ec7b6 );	ROM_LOAD( "rom6.bin",  0x80000, 0x80000, 0x64b6c5ac );/* same data, different layout
	...
	*/
	...
	static RomLoadPtr rom_vimana = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "vim07.bin",  0x000000, 0x20000, 0x1efaea84 );	ROM_LOAD_ODD ( "vim08.bin",  0x000000, 0x20000, 0xe45b7def );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound HD647180 code */
		/* sound CPU is a HD647180 (Z180) with internal ROM - not yet supported */
		ROM_LOAD( "hd647180.019",  0x00000, 0x08000, 0x00000000 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "vim6.bin",  0x00000, 0x20000, 0x2886878d );	ROM_LOAD( "vim5.bin",  0x20000, 0x20000, 0x61a63d7a );	ROM_LOAD( "vim4.bin",  0x40000, 0x20000, 0xb0515768 );	ROM_LOAD( "vim3.bin",  0x60000, 0x20000, 0x0b539131 );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "vim1.bin",  0x00000, 0x80000, 0xcdde26cd );	ROM_LOAD( "vim2.bin",  0x80000, 0x80000, 0x1dbfc118 );
		ROM_REGION( 0x40, REGION_PROMS );	/* nibble bproms, lo/hi order to be determined */
	...
	static RomLoadPtr rom_vimana2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "vimana07.bin",  0x000000, 0x20000, 0x5a4bf73e );	ROM_LOAD_ODD ( "vimana08.bin",  0x000000, 0x20000, 0x03ba27e8 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound HD647180 code */
		/* sound CPU is a HD647180 (Z180) with internal ROM - not yet supported */
		ROM_LOAD( "hd647180.019",  0x00000, 0x08000, 0x00000000 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "vim6.bin",  0x00000, 0x20000, 0x2886878d );	ROM_LOAD( "vim5.bin",  0x20000, 0x20000, 0x61a63d7a );	ROM_LOAD( "vim4.bin",  0x40000, 0x20000, 0xb0515768 );	ROM_LOAD( "vim3.bin",  0x60000, 0x20000, 0x0b539131 );
	...
	static RomLoadPtr rom_vimanan = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x040000, REGION_CPU1 );/* Main 68K code */
		ROM_LOAD_EVEN( "tp019-07.rom",  0x000000, 0x20000, 0x78888ff2 );	ROM_LOAD_ODD ( "tp019-08.rom",  0x000000, 0x20000, 0x6cd2dc3c );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound HD647180 code */
		/* sound CPU is a HD647180 (Z180) with internal ROM - not yet supported */
		ROM_LOAD( "hd647180.019",  0x00000, 0x08000, 0x00000000 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "vim6.bin",  0x00000, 0x20000, 0x2886878d );	ROM_LOAD( "vim5.bin",  0x20000, 0x20000, 0x61a63d7a );	ROM_LOAD( "vim4.bin",  0x40000, 0x20000, 0xb0515768 );	ROM_LOAD( "vim3.bin",  0x60000, 0x20000, 0x0b539131 );
