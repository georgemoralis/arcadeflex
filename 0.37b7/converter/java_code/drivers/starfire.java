...
public class starfire
{
	...
	static MemoryReadAddress readmem[] =
	{
		...
		new MemoryReadAddress( 0x8000, 0x9fff, starfire_scratch_r ),
	...
	static MemoryWriteAddress writemem[] =
	{
		...
		new MemoryWriteAddress( 0x8000, 0x9fff, starfire_scratch_w ),
		new MemoryWriteAddress( 0xa000, 0xbfff, starfire_colorram_w, starfire_colorram ),
		new MemoryWriteAddress( 0xc000, 0xffff, starfire_videoram_w, starfire_videoram ),
	...
	PORT_START();       /* DSW0 */
		PORT_DIPNAME( 0x03, 0x00, "Time" );	PORT_DIPSETTING(    0x00, "90 Sec" );	PORT_DIPSETTING(    0x01, "80 Sec" );	PORT_DIPSETTING(    0x02, "70 Sec" );	PORT_DIPSETTING(    0x03, "60 Sec" );	PORT_DIPNAME( 0x04, 0x00, "Coin(s);to Start" )
	...
	public static GameDriver driver_starfire	   = new GameDriver("1979"	,"starfire"	,"starfire.java"	,rom_starfire,null	,machine_driver_starfire	,input_ports_starfire	,init_starfire	,ROT0	,	"Exidy", "Star Fire", GAME_NO_SOUND )
