...
public class liberatr
{
	...
	static MemoryReadAddress liberatr_readmem[] =
	{
		new MemoryReadAddress( 0x0002, 0x0002, liberatr_bitmap_xy_r ),
		new MemoryReadAddress( 0x0000, 0x3fff, MRA_RAM ),	/* overlapping for my convenience */
		new MemoryReadAddress( 0x4000, 0x403f, atari_vg_earom_r ),
		new MemoryReadAddress( 0x5000, 0x5000, liberatr_input_port_0_r ),
		new MemoryReadAddress( 0x5001, 0x5001, input_port_1_r ),
		new MemoryReadAddress( 0x7000, 0x701f, pokey2_r ),
		new MemoryReadAddress( 0x7800, 0x781f, pokey1_r ),
		new MemoryReadAddress( 0x8000, 0xefff, MRA_ROM ),
		new MemoryReadAddress( 0xfffa, 0xffff, MRA_ROM ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	
	static MemoryReadAddress liberat2_readmem[] =
	{
		new MemoryReadAddress( 0x0002, 0x0002, liberatr_bitmap_xy_r ),
		new MemoryReadAddress( 0x0000, 0x3fff, MRA_RAM ),	/* overlapping for my convenience */
		new MemoryReadAddress( 0x4000, 0x4000, liberatr_input_port_0_r ),
		new MemoryReadAddress( 0x4001, 0x4001, input_port_1_r ),
		new MemoryReadAddress( 0x4800, 0x483f, atari_vg_earom_r ),
		new MemoryReadAddress( 0x5000, 0x501f, pokey2_r ),
		new MemoryReadAddress( 0x5800, 0x581f, pokey1_r ),
	...
	static MemoryWriteAddress liberatr_writemem[] =
	{
		new MemoryWriteAddress( 0x0002, 0x0002, liberatr_bitmap_xy_w ),
		new MemoryWriteAddress( 0x0000, 0x3fff, liberatr_bitmap_w, liberatr_bitmapram ),	/* overlapping for my convenience */
		new MemoryWriteAddress( 0x6000, 0x600f, MWA_RAM, liberatr_base_ram ),
		new MemoryWriteAddress( 0x6200, 0x621f, liberatr_colorram_w ),
		new MemoryWriteAddress( 0x6400, 0x6400, MWA_NOP ),
		new MemoryWriteAddress( 0x6600, 0x6600, atari_vg_earom_ctrl_w ),
		new MemoryWriteAddress( 0x6800, 0x6800, MWA_RAM, liberatr_planet_frame ),
		new MemoryWriteAddress( 0x6a00, 0x6a00, watchdog_reset_w ),
		new MemoryWriteAddress( 0x6c00, 0x6c01, liberatr_led_w ),
		new MemoryWriteAddress( 0x6c04, 0x6c04, MWA_RAM, liberatr_ctrld ),
		new MemoryWriteAddress( 0x6c05, 0x6c06, liberatr_coin_counter_w ),
		new MemoryWriteAddress( 0x6c07, 0x6c07, MWA_RAM, liberatr_planet_select ),
		new MemoryWriteAddress( 0x6e00, 0x6e3f, atari_vg_earom_w ),
		new MemoryWriteAddress( 0x7000, 0x701f, pokey2_w ),
		new MemoryWriteAddress( 0x7800, 0x781f, pokey1_w ),
		new MemoryWriteAddress( 0x8000, 0xefff, MWA_ROM ),
		new MemoryWriteAddress( 0xfffa, 0xffff, MWA_ROM ),
	
		new MemoryWriteAddress( 0x0000, 0x0000, MWA_RAM, liberatr_x ),	/* just here to assign pointer */
		new MemoryWriteAddress( 0x0001, 0x0001, MWA_RAM, liberatr_y ),	/* just here to assign pointer */
		new MemoryWriteAddress( -1 )	/* end of table */
	};
	
	static MemoryWriteAddress liberat2_writemem[] =
	{
		new MemoryWriteAddress( 0x0002, 0x0002, liberatr_bitmap_xy_w ),
		new MemoryWriteAddress( 0x0000, 0x3fff, liberatr_bitmap_w, liberatr_bitmapram ),	/* overlapping for my convenience */
		new MemoryWriteAddress( 0x4000, 0x400f, MWA_RAM, liberatr_base_ram ),
		new MemoryWriteAddress( 0x4200, 0x421f, liberatr_colorram_w ),
		new MemoryWriteAddress( 0x4400, 0x4400, MWA_NOP ),
		new MemoryWriteAddress( 0x4600, 0x4600, atari_vg_earom_ctrl_w ),
		new MemoryWriteAddress( 0x4800, 0x4800, MWA_RAM, liberatr_planet_frame ),
		new MemoryWriteAddress( 0x4a00, 0x4a00, watchdog_reset_w ),
		new MemoryWriteAddress( 0x4c00, 0x4c01, liberatr_led_w ),
		new MemoryWriteAddress( 0x4c04, 0x4c04, MWA_RAM, liberatr_ctrld ),
		new MemoryWriteAddress( 0x4c05, 0x4c06, liberatr_coin_counter_w ),
		new MemoryWriteAddress( 0x4c07, 0x4c07, MWA_RAM, liberatr_planet_select ),
		new MemoryWriteAddress( 0x4e00, 0x4e3f, atari_vg_earom_w ),
		new MemoryWriteAddress( 0x5000, 0x501f, pokey2_w ),
		new MemoryWriteAddress( 0x5800, 0x581f, pokey1_w ),
		//new MemoryWriteAddress( 0x6000, 0x601f, pokey1_w ), /* bug ??? */
	...
	PORT_START(); 			/* IN0 - $5000 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 			/* IN1 - $5001 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH,IPT_VBLANK );
		PORT_START(); 			/* IN2  -  Game Option switches DSW @ D4 on PCB */
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPSETTING(    0x02, "6" );	PORT_DIPSETTING(    0x03, "8" );	PORT_DIPNAME( 0x0C, 0x04, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "15000" );	PORT_DIPSETTING(    0x04, "20000" );	PORT_DIPSETTING(    0x08, "25000" );	PORT_DIPSETTING(    0x0C, "30000" );	PORT_DIPNAME( 0x30, 0x00, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x00, "Normal" );	PORT_DIPSETTING(    0x20, "Hard" );	PORT_DIPSETTING(    0x30, "???" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Unknown") );
		...
		PORT_DIPNAME( 0x0c, 0x00, "Right Coin" );	PORT_DIPSETTING (   0x00, "*1" );	PORT_DIPSETTING (   0x04, "*4" );	PORT_DIPSETTING (   0x08, "*5" );	PORT_DIPSETTING (   0x0c, "*6" );	PORT_DIPNAME( 0x10, 0x00, "Left Coin" );	PORT_DIPSETTING (   0x00, "*1" );	PORT_DIPSETTING (   0x10, "*2" );	/* TODO: verify the following settings */
		PORT_DIPNAME( 0xe0, 0x00, "Bonus Coins" );	PORT_DIPSETTING (   0x00, "None" );	PORT_DIPSETTING (   0x80, "1 each 5" );	PORT_DIPSETTING (   0x40, "1 each 4 (+Demo); )
		...
		PORT_ANALOG( 0x0f, 0x0, IPT_TRACKBALL_Y, 30, 10, 0, 0 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_liberatr = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "136012.206",   0x8000, 0x1000, 0x1a0cb4a0 );	ROM_LOAD( "136012.205",   0x9000, 0x1000, 0x2f071920 );	ROM_LOAD( "136012.204",   0xa000, 0x1000, 0xbcc91827 );	ROM_LOAD( "136012.203",   0xb000, 0x1000, 0xb558c3d4 );	ROM_LOAD( "136012.202",   0xc000, 0x1000, 0x569ba7ea );	ROM_LOAD( "136012.201",   0xd000, 0x1000, 0xd12cd6d0 );	ROM_LOAD( "136012.200",   0xe000, 0x1000, 0x1e98d21a );	ROM_RELOAD(				  0xf000, 0x1000 );	/* for interrupt/reset vectors  */
	
		ROM_REGION( 0x4000, REGION_GFX1 );/* planet image, used at runtime */
		ROM_LOAD( "136012.110",   0x0000, 0x1000, 0x6eb11221 );	ROM_LOAD( "136012.107",   0x1000, 0x1000, 0x8a616a63 );	ROM_LOAD( "136012.108",   0x2000, 0x1000, 0x3f8e4cf6 );	ROM_LOAD( "136012.109",   0x3000, 0x1000, 0xdda0c0ef );ROM_END(); }}; 
	
	static RomLoadPtr rom_liberat2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code and data  */
		ROM_LOAD( "l6.bin",       0x6000, 0x1000, 0x78093d06 );	ROM_LOAD( "l5.bin",       0x7000, 0x1000, 0x988db636 );	ROM_LOAD( "l4.bin",       0x8000, 0x1000, 0xec114540 );	ROM_LOAD( "l3.bin",       0x9000, 0x1000, 0x184c751f );	ROM_LOAD( "l2.bin",       0xa000, 0x1000, 0xc3f61f88 );	ROM_LOAD( "l1.bin",       0xb000, 0x1000, 0xef6e9f9e );	ROM_RELOAD(				  0xf000, 0x1000 );	/* for interrupt/reset vectors  */
