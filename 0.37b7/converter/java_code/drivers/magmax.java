...
public class magmax
{
	...
	*/
	...
	PORT_START(); 	/* Player 1 controls */
		...
		PORT_DIPSETTING(    0x0c, "30000 every" );	PORT_DIPSETTING(    0x04, "70000 every" );	PORT_DIPSETTING(    0x08, "50000 every" );	PORT_DIPSETTING(    0x00, "90000 every" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Demo_Sounds") );
	...
	(
		...
		new WriteHandlerPtr[] { ay8910_portA_0_w, 0, 0 }, //ay8910_data_w, ay8910_data_w, ay8910_data_w ), //write port A
	...
	static RomLoadPtr rom_magmax = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_ODD ( "1.3b", 0x00000, 0x4000, 0x33793cbb );	ROM_LOAD_EVEN( "6.3d", 0x00000, 0x4000, 0x677ef450 );	ROM_LOAD_ODD ( "2.5b", 0x08000, 0x4000, 0x1a0c84df );	ROM_LOAD_EVEN( "7.5d", 0x08000, 0x4000, 0x01c35e95 );	ROM_LOAD_ODD ( "3.6b", 0x10000, 0x2000, 0xd06e6cae );	ROM_LOAD_EVEN( "8.6d", 0x10000, 0x2000, 0x790a82be );
		ROM_REGION( 0x10000, REGION_CPU2 );/* sound cpu code */
		ROM_LOAD( "15.17b", 0x00000, 0x2000, 0x19e7b983 );	ROM_LOAD( "16.18b", 0x02000, 0x2000, 0x055e3126 );
		...
		ROM_LOAD( "17.3e",  0x00000, 0x2000, 0x8e305b2e );	ROM_LOAD( "18.5e",  0x02000, 0x2000, 0x14c55a60 );	ROM_LOAD( "19.6e",  0x04000, 0x2000, 0xfa4141d8 );	ROM_LOAD( "20.3g",  0x08000, 0x2000, 0x6fa3918b );	ROM_LOAD( "21.5g",  0x0a000, 0x2000, 0xdd52eda4 );	ROM_LOAD( "22.6g",  0x0c000, 0x2000, 0x4afc98ff );
		...
		ROM_LOAD( "4.18b",  0x00000, 0x2000, 0x1550942e );	ROM_LOAD( "5.20b",  0x02000, 0x2000, 0x3b93017f );
