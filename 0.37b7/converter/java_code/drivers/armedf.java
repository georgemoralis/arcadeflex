...
public class armedf
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* Test Mode */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_SERVICE( 0x02, IP_ACTIVE_LOW );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_TILT );    /* Tilt */
		PORT_BIT( 0xf8, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "3");	PORT_DIPSETTING(    0x02, "4");	PORT_DIPSETTING(    0x01, "5");	PORT_DIPSETTING(    0x00, "6");	PORT_DIPNAME( 0x04, 0x04, "First Bonus" );	PORT_DIPSETTING(    0x04, "20k");	PORT_DIPSETTING(    0x00, "40k");	PORT_DIPNAME( 0x08, 0x08, "Second Bonus" );	PORT_DIPSETTING(    0x08, "60k");	PORT_DIPSETTING(    0x00, "80k");	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPNAME( 0x20, 0x20, "Allow Continue" );	PORT_DIPSETTING(    0x20, DEF_STR( "No") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
		PORT_DIPNAME( 0x40, 0x40, "Flip Screen ?" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x0c, "20k");	PORT_DIPSETTING(    0x08, "50k");	PORT_DIPSETTING(    0x04, "60k");	PORT_DIPSETTING(    0x00, "90k");	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0xc0, 0xc0, "Allow Continue" );	PORT_DIPSETTING(    0xc0, "0" );	PORT_DIPSETTING(    0x80, "3" );	PORT_DIPSETTING(    0x40, "5" );	PORT_DIPSETTING(    0x00, "Unlimited" );INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "3");	PORT_DIPSETTING(    0x02, "4");	PORT_DIPSETTING(    0x01, "5");	PORT_DIPSETTING(    0x00, "6");	PORT_DIPNAME( 0x04, 0x04, "1st Bonus Life" );	PORT_DIPSETTING(    0x04, "None");	PORT_DIPSETTING(    0x00, "50k");	PORT_DIPNAME( 0x08, 0x08, "2nd Bonus Life" );	PORT_DIPSETTING(    0x08, "60k");	PORT_DIPSETTING(    0x00, "90k");	PORT_DIPNAME( 0x10, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_UP     | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_DOWN   | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT   | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_RIGHT | IPF_8WAY | IPF_PLAYER1 );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_UP     | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_DOWN   | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT   | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_RIGHT | IPF_8WAY | IPF_PLAYER2 );
		PORT_START(); 	/* Coin, Start */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* Test Mode */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN3 );	PORT_SERVICE( 0x02, IP_ACTIVE_LOW );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_TILT );    /* Tilt */
		...
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "3");	PORT_DIPSETTING(    0x02, "4");	PORT_DIPSETTING(    0x01, "5");	PORT_DIPSETTING(    0x00, "6");	PORT_DIPNAME( 0x04, 0x04, "First Bonus" );	PORT_DIPSETTING(    0x04, "30k");	PORT_DIPSETTING(    0x00, "60k");	PORT_DIPNAME( 0x08, 0x08, "Second Bonus" );	PORT_DIPSETTING(    0x08, "70k Only");	PORT_DIPSETTING(    0x00, "Nothing");	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x10, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x40, "Easy");	PORT_DIPSETTING(    0x00, "Hard");#if 0
		PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	#endif
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "2C_3C") );
		PORT_DIPSETTING(    0x08, DEF_STR( "1C_2C") );
		PORT_DIPNAME( 0x10, 0x10, "Continue Play" );	PORT_DIPSETTING(    0x10, "3");	PORT_DIPSETTING(    0x00, "0");#if 0
		PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	#endif
	...
	static RomLoadPtr rom_terraf = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "terrafor.014", 0x00000, 0x10000, 0x8e5f557f );	ROM_LOAD_ODD(  "terrafor.011", 0x00000, 0x10000, 0x5320162a );	ROM_LOAD_EVEN( "terrafor.013", 0x20000, 0x10000, 0xa86951e0 );	ROM_LOAD_ODD(  "terrafor.010", 0x20000, 0x10000, 0x58b5f43b );	ROM_LOAD_EVEN( "terrafor.012", 0x40000, 0x08000, 0x4f0e1d76 );	ROM_LOAD_ODD(  "terrafor.009", 0x40000, 0x08000, 0xd1014280 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code (sound) */
		ROM_LOAD( "terrafor.001", 0x00000, 0x10000, 0xeb6b4138 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "terrafor.008", 0x00000, 0x08000, 0xbc6f7cbc );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "terrafor.006", 0x00000, 0x10000, 0x25d23dfd );/* foreground tiles */
		ROM_LOAD( "terrafor.007", 0x10000, 0x10000, 0xb9b0fe27 );
		ROM_REGION( 0x20000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "terrafor.004", 0x00000, 0x10000, 0x2144d8e0 );/* background tiles */
		ROM_LOAD( "terrafor.005", 0x10000, 0x10000, 0x744f5c9e );
		ROM_REGION( 0x40000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "terrafor.003", 0x00000, 0x10000, 0xd74085a1 );/* sprites */
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "tf.clr",       0x0000, 0x0100, 0x81244757 );/* ??? */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_terrafu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 64K*8 for 68000 code */
		ROM_LOAD_EVEN( "tf.8",         0x00000, 0x10000, 0xfea6dd64 );	ROM_LOAD_ODD(  "tf.3",         0x00000, 0x10000, 0x02f9d05a );	ROM_LOAD_EVEN( "tf.7",         0x20000, 0x10000, 0xfde8de7e );	ROM_LOAD_ODD(  "tf.2",         0x20000, 0x10000, 0xdb987414 );	ROM_LOAD_EVEN( "tf.6",         0x40000, 0x08000, 0xb91e9ba3 );	ROM_LOAD_ODD(  "tf.1",         0x40000, 0x08000, 0xd6e22375 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code (sound) */
		ROM_LOAD( "terrafor.001", 0x00000, 0x10000, 0xeb6b4138 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "terrafor.008", 0x00000, 0x08000, 0xbc6f7cbc );/* characters */
	...
	static RomLoadPtr rom_kodure = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "kodure8.6e", 0x00000, 0x10000, 0x6bbfb1e6 );	ROM_LOAD_ODD(  "kodure3.6h", 0x00000, 0x10000, 0xf9178ec8 );	ROM_LOAD_EVEN( "kodure7.5e", 0x20000, 0x10000, 0xa7ee09bb );	ROM_LOAD_ODD(  "kodure2.5h", 0x20000, 0x10000, 0x236d820f );	ROM_LOAD_EVEN( "kodure6.3e", 0x40000, 0x10000, 0x9120e728 );	ROM_LOAD_ODD(  "kodure1.3h", 0x40000, 0x10000, 0x345fe7a5 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code (sound) */
		ROM_LOAD( "kodure11.17k", 0x00000, 0x10000, 0xdba51e2d );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "kodure9.11e", 0x00000, 0x08000, 0xe041356e );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "kodure5.15h", 0x00000, 0x20000, 0x0b510258 );/* foreground tiles */
		ROM_LOAD( "kodure4.14h", 0x20000, 0x10000, 0xfb8e13e6 );
		ROM_REGION( 0x20000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "kodure14.8a", 0x00000, 0x10000, 0x94a9c3d0 );/* background tiles */
	
		ROM_REGION( 0x40000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "kodure12.8d", 0x00000, 0x20000, 0x15f4021d );/* sprites */
		ROM_LOAD( "kodure13.9d", 0x20000, 0x20000, 0xb3b6c753 );
		ROM_REGION( 0x4000, REGION_GFX5 );/* data for mcu/blitter? */
		ROM_LOAD( "kodure10.11c", 0x0000, 0x4000, 0xf48be21d );/* TEST DATA ? */
	
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "tf.11j", 0x0000, 0x0100, 0x81244757 );/* ??? */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_armedf = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 68000 code */
		ROM_LOAD_EVEN( "af_06.rom", 0x00000, 0x10000, 0xc5326603 );	ROM_LOAD_ODD(  "af_01.rom", 0x00000, 0x10000, 0x458e9542 );	ROM_LOAD_EVEN( "af_07.rom", 0x20000, 0x10000, 0xcc8517f5 );	ROM_LOAD_ODD(  "af_02.rom", 0x20000, 0x10000, 0x214ef220 );	ROM_LOAD_EVEN( "af_08.rom", 0x40000, 0x10000, 0xd1d43600 );	ROM_LOAD_ODD(  "af_03.rom", 0x40000, 0x10000, 0xbbe1fe2d );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code (sound) */
		ROM_LOAD( "af_10.rom", 0x00000, 0x10000, 0xc5eacb87 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "af_09.rom", 0x00000, 0x08000, 0x7025e92d );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "af_04.rom", 0x00000, 0x10000, 0x44d3af4f );/* foreground tiles */
		ROM_LOAD( "af_05.rom", 0x10000, 0x10000, 0x92076cab );
		ROM_REGION( 0x20000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "af_14.rom", 0x00000, 0x10000, 0x8c5dc5a7 );/* background tiles */
		ROM_LOAD( "af_13.rom", 0x10000, 0x10000, 0x136a58a3 );
		ROM_REGION( 0x40000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "af_11.rom", 0x00000, 0x20000, 0xb46c473c );/* sprites */
		ROM_LOAD( "af_12.rom", 0x20000, 0x20000, 0x23cb6bfe );ROM_END(); }}; 
	
	static RomLoadPtr rom_cclimbr2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 64K*8 for 68000 code */
		ROM_LOAD_EVEN( "4.bin", 0x00000, 0x10000, 0x7922ea14 );	ROM_LOAD_ODD(  "1.bin", 0x00000, 0x10000, 0x2ac7ed67 );	ROM_LOAD_EVEN( "6.bin", 0x20000, 0x10000, 0x7905c992 );	ROM_LOAD_ODD(  "5.bin", 0x20000, 0x10000, 0x47be6c1e );	ROM_LOAD_EVEN( "3.bin", 0x40000, 0x10000, 0x1fb110d6 );	ROM_LOAD_ODD(  "2.bin", 0x40000, 0x10000, 0x0024c15b );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code (sound) */
		ROM_LOAD( "11.bin", 0x00000, 0x04000, 0xfe0175be );	ROM_LOAD( "12.bin", 0x04000, 0x08000, 0x5ddf18f2 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "10.bin", 0x00000, 0x08000, 0x7f475266 );/* characters */
	
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "7.bin",  0x00000, 0x10000, 0xcbdd3906 );/* foreground tiles */
		ROM_LOAD( "8.bin",  0x10000, 0x10000, 0xb2a613c0 );
		ROM_REGION( 0x20000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "17.bin", 0x00000, 0x10000, 0xe24bb2d7 );/* background tiles */
		ROM_LOAD( "18.bin", 0x10000, 0x10000, 0x56834554 );
		ROM_REGION( 0x40000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "15.bin", 0x00000, 0x10000, 0x4bf838be );/* sprites */
		ROM_LOAD( "16.bin", 0x10000, 0x10000, 0x21a265c5 );	ROM_LOAD( "13.bin", 0x20000, 0x10000, 0x6b6ec999 );	ROM_LOAD( "14.bin", 0x30000, 0x10000, 0xf426a4ad );
		ROM_REGION( 0x4000, REGION_GFX5 );/* data for mcu/blitter? */
