...
public class retofinv
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_retofinv = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic61.rom", 0x0000, 0x2000, 0x4e3f501c );
		ROM_REGION( 0x04000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic55.rom", 0x0000, 0x2000, 0xef7f8651 );	ROM_LOAD( "ic56.rom", 0x2000, 0x2000, 0x03b40905 );
		ROM_REGION( 0x08000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic8.rom",  0x0000, 0x2000, 0x6afdeec8 );	ROM_LOAD( "ic9.rom",  0x2000, 0x2000, 0xd3dc9da3 );	ROM_LOAD( "ic10.rom", 0x4000, 0x2000, 0xd10b2eed );	ROM_LOAD( "ic11.rom", 0x6000, 0x2000, 0x00ca6b3d );
		ROM_REGION( 0x0b00, REGION_PROMS );	ROM_LOAD( "74s287.p6", 0x0000, 0x0100, 0x50030af0 );/* palette blue bits   */
