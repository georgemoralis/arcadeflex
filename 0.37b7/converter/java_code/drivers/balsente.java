...
public class balsente
{
	...
	public static timer_callback m6850_data_ready_callback = new timer_callback() { public void handler(int param) 
	{
	...
	public static timer_callback m6850_w_callback = new timer_callback() { public void handler(int param) 
	{
	...
	public static timer_callback counter_callback = new timer_callback() { public void handler(int param) 
	{
	...
	{
		return (input_port_2_r.handler(offset) & 0xf0) | nstocker_bits;
	} };
	...
	#define UNUSED_ANALOG \
		PORT_START\
		PORT_BIT( 0xff, IP_ACTIVE_HIGH, IPT_UNUSED );#define UNUSED_ANALOG_X2 UNUSED_ANALOG UNUSED_ANALOG
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x7c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x80, "High Scores" );	PORT_DIPSETTING(    0x80, "Keep Top 5" );	PORT_DIPSETTING(    0x00, "Keep All" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x03, 0x00, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x00, "Every 10,000" );	PORT_DIPSETTING(    0x01, "Every 15,000" );	PORT_DIPSETTING(    0x02, "Every 20,000" );	PORT_DIPSETTING(    0x03, "Every 25,000" );	PORT_DIPNAME( 0x0c, 0x08, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_DIPSETTING(    0x08, "4" );	PORT_DIPSETTING(    0x0c, "5" );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x40, "Easy" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_UP | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x38, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X2
		PLAYER1_TRACKBALL
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x7c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x80, "High Scores" );	PORT_DIPSETTING(    0x80, "Keep Top 5" );	PORT_DIPSETTING(    0x00, "Keep All" );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x03, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_BIT( 0x70, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X4
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x01, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Free_Play") );
		PORT_DIPNAME( 0x04, 0x04, "Players Per Credit" );	PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x04, "1 or 2" );	PORT_BIT( 0xf8, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x07, 0x05, "Game Duration" );	PORT_DIPSETTING(    0x00, "9 points" );	PORT_DIPSETTING(    0x02, "11 points" );	PORT_DIPSETTING(    0x04, "15 points" );	PORT_DIPSETTING(    0x06, "21 points" );	PORT_DIPSETTING(    0x01, "timed, 1:15" );	PORT_DIPSETTING(    0x03, "timed, 1:30" );	PORT_DIPSETTING(    0x05, "timed, 2:00" );	PORT_DIPSETTING(    0x07, "timed, 2:30" );	PORT_BIT( 0x78, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x0f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		PLAYER2_TRACKBALL
		PLAYER1_TRACKBALL
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x04, 0x04, "Players Per Credit" );	PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x04, "1 or 2" );	PORT_BIT( 0xf8, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x07, 0x02, "Game Time" );	PORT_DIPSETTING(    0x00, "1:15" );	PORT_DIPSETTING(    0x01, "1:30" );	PORT_DIPSETTING(    0x02, "1:45" );	PORT_DIPSETTING(    0x03, "2:00" );	PORT_DIPSETTING(    0x04, "2:15" );	PORT_DIPSETTING(    0x05, "2:30" );	PORT_DIPSETTING(    0x06, "2:45" );	PORT_DIPSETTING(    0x07, "3:00" );	PORT_BIT( 0x78, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X4
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x01, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Free_Play") );
		PORT_DIPNAME( 0x04, 0x04, "Players Per Credit" );	PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x04, "1 or 2" );	PORT_BIT( 0xf8, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x7f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X2
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, "Every 15,000" );	PORT_DIPSETTING(    0x01, "Every 20,000" );	PORT_DIPSETTING(    0x02, "Every 25,000" );	PORT_DIPSETTING(    0x03, "Every 30,000" );	PORT_DIPNAME( 0x0c, 0x04, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_DIPSETTING(    0x08, "4" );	PORT_DIPSETTING(    0x0c, "5" );	PORT_BIT( 0x70, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x3f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x38, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X2
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x3f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X3
		PLAYER1_WHEEL
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x01, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Free_Play") );
		PORT_BIT( 0x1c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x20, 0x00, "Sound" );	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x00, "Sound Test" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "High Scores" );	PORT_DIPSETTING(    0x00, "Keep Top 5" );	PORT_DIPSETTING(    0x80, "Keep Top 10" );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x03, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x0c, 0x04, "Guesses" );	PORT_DIPSETTING(    0x00, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x08, "5" );	PORT_DIPSETTING(    0x0c, "6" );	PORT_BIT( 0x70, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START4 );	PORT_BITX(0x10, IP_ACTIVE_LOW, IPT_BUTTON2, "Red Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON1, "Green Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X4
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x03, 0x01, "Bonus Shot" );	PORT_DIPSETTING(    0x00, "Every 6 Balls" );	PORT_DIPSETTING(    0x01, "Every 8 Balls" );	PORT_DIPSETTING(    0x02, "Every 10 Balls" );	PORT_DIPSETTING(    0x03, "Every 12 Balls" );	PORT_DIPNAME( 0x0c, 0x08, "Initial Shots" );	PORT_DIPSETTING(    0x00, "8" );	PORT_DIPSETTING(    0x04, "10" );	PORT_DIPSETTING(    0x08, "12" );	PORT_DIPSETTING(    0x0c, "14" );	PORT_DIPNAME( 0x10, 0x00, "Players Per Credit" );	PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x10, "1 or 2" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x40, 0x40, "High Scores" );	PORT_DIPSETTING(    0x40, "Keep Top 5" );	PORT_DIPSETTING(    0x00, "Keep All" );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_BIT( 0x3f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		PLAYER1_TRACKBALL
		UNUSED_ANALOG_X2
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x01, 0x01, "Add-A-Coin" );	PORT_DIPSETTING(    0x01, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x7e, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_BIT( 0x3f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X2
		PLAYER1_TRACKBALL
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x7c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x80, "High Scores" );	PORT_DIPSETTING(    0x80, "Keep Top 5" );	PORT_DIPSETTING(    0x00, "Keep All" );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x03, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_BIT( 0x78, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x7f, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1, "P1 Blue Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1, "P1 Green Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x04, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1, "P1 Yellow Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x08, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1, "P1 Red Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BITX(0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2, "P2 Red Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x08, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2, "P2 Yellow Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x10, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2, "P2 Green Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BITX(0x20, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2, "P2 Blue Button", IP_KEY_DEFAULT, IP_JOY_DEFAULT );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X4
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x01, "Easy" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_BIT( 0x7e, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x07, 0x03, "Game Duration" );	PORT_DIPSETTING(    0x00, "1:30" );	PORT_DIPSETTING(    0x01, "1:40" );	PORT_DIPSETTING(    0x02, "1:50" );	PORT_DIPSETTING(    0x03, "2:00" );	PORT_DIPSETTING(    0x04, "2:20" );	PORT_DIPSETTING(    0x05, "2:40" );	PORT_DIPSETTING(    0x06, "3:00" );	PORT_DIPSETTING(    0x07, "3:30" );	PORT_DIPNAME( 0x08, 0x00, "Players Per Credit" );	PORT_DIPSETTING(    0x00, "1" );	PORT_DIPSETTING(    0x08, "1 or 2" );	PORT_BIT( 0x70, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x3c, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x1c, 0x00, "Bonus Coins" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPSETTING(    0x04, "2 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x08, "3 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x0c, "4 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x10, "4 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x14, "5 Coins = 1 Bonus" );	PORT_DIPSETTING(    0x18, "5 Coins = 2 Bonus" );	PORT_DIPSETTING(    0x1c, "5 Coins = 3 Bonus" );	PORT_DIPNAME( 0x20, 0x00, "Left Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x20, "x2" );	PORT_DIPNAME( 0xc0, 0x00, "Right Coin Mech" );	PORT_DIPSETTING(    0x00, "x1" );	PORT_DIPSETTING(    0x40, "x4" );	PORT_DIPSETTING(    0x80, "x5" );	PORT_DIPSETTING(    0xc0, "x6" );
		PORT_START(); 	/* IN1 */
		PORT_DIPNAME( 0x01, 0x00, "Game Duration" );	PORT_DIPSETTING(    0x00, "11 points" );	PORT_DIPSETTING(    0x01, "15 points" );	PORT_BIT( 0x7e, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_DIPNAME( 0x80, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x0f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x38, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		PLAYER2_TRACKBALL
		PLAYER1_TRACKBALL
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPNAME( 0x0c, 0x04, "Minimum Game Time" );	PORT_DIPSETTING(    0x08, "45" );	PORT_DIPSETTING(    0x04, "60" );	PORT_DIPSETTING(    0x00, "90" );	PORT_DIPSETTING(    0x0c, "120" );	PORT_BIT( 0x30, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_DIPNAME( 0x40, 0x40, "Keep High Scores" );	PORT_DIPSETTING(    0x40, DEF_STR( "No") );
		...
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_UP | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKRIGHT_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START(); 	/* IN3 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_UP | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICKLEFT_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_VBLANK );
		/* analog ports */
		UNUSED_ANALOG_X4
	INPUT_PORTS_END(); }}; 
	...
	static public static InitDriverPtr init_minigolf = new InitDriverPtr() { public void handler()  { expand_roms(0x0c);        balsente_shooter = 0; adc_shift = 2; } };
	static public static InitDriverPtr init_minigol2 = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_NONE); balsente_shooter = 0; adc_shift = 2; } };
	...
	static RomLoadPtr rom_sentetst = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "sdiaggr0.bin", 0x00000, 0x2000, 0x5e0ff62a );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_cshift = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "cs-ab0.bin", 0x10000, 0x2000, 0xd2069e75 );	ROM_LOAD( "cs-ab1.bin", 0x12000, 0x2000, 0x198f25a8 );	ROM_LOAD( "cs-ab2.bin", 0x14000, 0x2000, 0x2e2b2b82 );	ROM_LOAD( "cs-ab3.bin", 0x16000, 0x2000, 0xb97fc520 );	ROM_LOAD( "cs-ab4.bin", 0x18000, 0x2000, 0xb4f0d673 );	ROM_LOAD( "cs-ab5.bin", 0x1a000, 0x2000, 0xb1f8e589 );	ROM_LOAD( "cs-cd.bin",  0x2c000, 0x2000, 0xf555a0b2 );	ROM_LOAD( "cs-ef.bin",  0x2e000, 0x2000, 0x368b1ce3 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",   0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "cs-gr0.bin", 0x00000, 0x2000, 0x67f9d3b3 );	ROM_LOAD( "cs-gr1.bin", 0x02000, 0x2000, 0x78973d50 );	ROM_LOAD( "cs-gr2.bin", 0x04000, 0x2000, 0x1784f939 );	ROM_LOAD( "cs-gr3.bin", 0x06000, 0x2000, 0xb43916a2 );	ROM_LOAD( "cs-gr4.bin", 0x08000, 0x2000, 0xa94cd35b );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_gghost = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ggh-ab0.bin", 0x10000, 0x2000, 0xed0fdeac );	ROM_LOAD( "ggh-ab1.bin", 0x12000, 0x2000, 0x5bfbae58 );	ROM_LOAD( "ggh-ab2.bin", 0x14000, 0x2000, 0xf0baf921 );	ROM_LOAD( "ggh-ab3.bin", 0x16000, 0x2000, 0xed0fdeac );	ROM_LOAD( "ggh-ab4.bin", 0x18000, 0x2000, 0x5bfbae58 );	ROM_LOAD( "ggh-ab5.bin", 0x1a000, 0x2000, 0xf0baf921 );	ROM_LOAD( "ggh-cd.bin",  0x2c000, 0x2000, 0xd3d75f84 );	ROM_LOAD( "ggh-ef.bin",  0x2e000, 0x2000, 0xa02b4243 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",    0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "ggh-gr0.bin", 0x00000, 0x2000, 0x03515526 );	ROM_LOAD( "ggh-gr1.bin", 0x02000, 0x2000, 0xb4293435 );	ROM_LOAD( "ggh-gr2.bin", 0x04000, 0x2000, 0xece0cb97 );	ROM_LOAD( "ggh-gr3.bin", 0x06000, 0x2000, 0xdd7e25d0 );	ROM_LOAD( "ggh-gr4.bin", 0x08000, 0x2000, 0xb4293435 );	ROM_LOAD( "ggh-gr5.bin", 0x0a000, 0x2000, 0xd3da0093 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_hattrick = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "rom-ab0.u9a", 0x10000, 0x2000, 0xf25c1b99 );	ROM_LOAD( "rom-ab1.u8a", 0x12000, 0x2000, 0xc1df3d1f );	ROM_LOAD( "rom-ab2.u7a", 0x14000, 0x2000, 0xf6c41257 );	ROM_LOAD( "rom-cd.u3a",  0x2c000, 0x2000, 0xfc44f36c );	ROM_LOAD( "rom-ef.u2a",  0x2e000, 0x2000, 0xd8f910fb );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",    0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "rom-gr0.u9b", 0x00000, 0x2000, 0x9f41baba );	ROM_LOAD( "rom-gr1.u8b", 0x02000, 0x2000, 0x951f08c9 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_otwalls = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "otw-ab0.bin", 0x10000, 0x2000, 0x474441c7 );	ROM_LOAD( "otw-ab1.bin", 0x12000, 0x2000, 0x2e9e9411 );	ROM_LOAD( "otw-ab2.bin", 0x14000, 0x2000, 0xba092128 );	ROM_LOAD( "otw-ab3.bin", 0x16000, 0x2000, 0x74bc479d );	ROM_LOAD( "otw-ab4.bin", 0x18000, 0x2000, 0xf5f67619 );	ROM_LOAD( "otw-ab5.bin", 0x1a000, 0x2000, 0xf5f67619 );	ROM_LOAD( "otw-cd.bin",  0x2c000, 0x2000, 0x8e2d15ab );	ROM_LOAD( "otw-ef.bin",  0x2e000, 0x2000, 0x57eab299 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",    0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "otw-gr0.bin", 0x00000, 0x2000, 0x210bad3c );	ROM_LOAD( "otw-gr1.bin", 0x02000, 0x2000, 0x13e6aaa5 );	ROM_LOAD( "otw-gr2.bin", 0x04000, 0x2000, 0x5cfefee5 );	ROM_LOAD( "otw-gr3.bin", 0x06000, 0x2000, 0x6b17e4a9 );	ROM_LOAD( "otw-gr4.bin", 0x08000, 0x2000, 0x15985c8c );	ROM_LOAD( "otw-gr5.bin", 0x0a000, 0x2000, 0x448f7e3c );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_snakepit = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "spit-ab0.bin", 0x10000, 0x2000, 0x5aa86081 );	ROM_LOAD( "spit-ab1.bin", 0x12000, 0x2000, 0x588228b8 );	ROM_LOAD( "spit-ab2.bin", 0x14000, 0x2000, 0x60173ab6 );	ROM_LOAD( "spit-ab3.bin", 0x16000, 0x2000, 0x56cb51a8 );	ROM_LOAD( "spit-ab4.bin", 0x18000, 0x2000, 0x40ba61e0 );	ROM_LOAD( "spit-ab5.bin", 0x1a000, 0x2000, 0x2a1d9d8f );	ROM_LOAD( "spit-cd.bin",  0x2c000, 0x2000, 0x54095cbb );	ROM_LOAD( "spit-ef.bin",  0x2e000, 0x2000, 0x5f836a66 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",     0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "spit-gr0.bin", 0x00000, 0x2000, 0xf77fd85d );	ROM_LOAD( "spit-gr1.bin", 0x02000, 0x2000, 0x3ad10334 );	ROM_LOAD( "spit-gr2.bin", 0x04000, 0x2000, 0x24887703 );	ROM_LOAD( "spit-gr3.bin", 0x06000, 0x2000, 0xc6703ec2 );	ROM_LOAD( "spit-gr4.bin", 0x08000, 0x2000, 0xb4293435 );	ROM_LOAD( "spit-gr5.bin", 0x0a000, 0x2000, 0xdc27c970 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_snakjack = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "rom-ab0.u9a", 0x10000, 0x2000, 0xda2dd119 );	ROM_LOAD( "rom-ab1.u8a", 0x12000, 0x2000, 0x657ddf26 );	ROM_LOAD( "rom-ab2.u7a", 0x14000, 0x2000, 0x15333dcf );	ROM_LOAD( "rom-ab3.u6a", 0x16000, 0x2000, 0x57671f6f );	ROM_LOAD( "rom-ab4.u5a", 0x18000, 0x2000, 0xc16c5dc0 );	ROM_LOAD( "rom-ab5.u4a", 0x1a000, 0x2000, 0xd7019747 );	ROM_LOAD( "rom-cd.u3a",  0x2c000, 0x2000, 0x7b44ca4c );	ROM_LOAD( "rom-ef.u1a",  0x2e000, 0x2000, 0xf5309b38 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",    0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "rom-gr0.u9b", 0x00000, 0x2000, 0x3e64b5d5 );	ROM_LOAD( "rom-gr1.u8b", 0x02000, 0x2000, 0xb3b8baee );	ROM_LOAD( "rom-gr2.u7b", 0x04000, 0x2000, 0xe9d89dac );	ROM_LOAD( "rom-gr3.u6b", 0x06000, 0x2000, 0xb6602be8 );	ROM_LOAD( "rom-gr4.u5b", 0x08000, 0x2000, 0x3fbfa686 );	ROM_LOAD( "rom-gr5.u4b", 0x0a000, 0x2000, 0x345f94fb );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_stocker = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "stkr-ab0.bin", 0x10000, 0x2000, 0x784a00ad );	ROM_LOAD( "stkr-ab1.bin", 0x12000, 0x2000, 0xcdae01dc );	ROM_LOAD( "stkr-ab2.bin", 0x14000, 0x2000, 0x18527d57 );	ROM_LOAD( "stkr-ab3.bin", 0x16000, 0x2000, 0x028f6c06 );	ROM_LOAD( "stkr-cd.bin",  0x2c000, 0x2000, 0x53dbc4e5 );	ROM_LOAD( "stkr-ef.bin",  0x2e000, 0x2000, 0xcdcf46bc );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",    0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "stkr-gr0.bin", 0x00000, 0x2000, 0x76d5694c );	ROM_LOAD( "stkr-gr1.bin", 0x02000, 0x2000, 0x4a5cc00b );	ROM_LOAD( "stkr-gr2.bin", 0x04000, 0x2000, 0x70002382 );	ROM_LOAD( "stkr-gr3.bin", 0x06000, 0x2000, 0x68c862d8 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_triviag1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "tpg1-ab0.bin", 0x10000, 0x2000, 0x79fd3ac3 );	ROM_LOAD( "tpg1-ab1.bin", 0x12000, 0x2000, 0x0ff677e9 );	ROM_LOAD( "tpg1-ab2.bin", 0x14000, 0x2000, 0x3b4d03e7 );	ROM_LOAD( "tpg1-ab3.bin", 0x16000, 0x2000, 0x2c6c0651 );	ROM_LOAD( "tpg1-ab4.bin", 0x18000, 0x2000, 0x397529e7 );	ROM_LOAD( "tpg1-ab5.bin", 0x1a000, 0x2000, 0x499773a4 );	ROM_LOAD( "tpg1-cd.bin",  0x2c000, 0x2000, 0x35c9b9c2 );	ROM_LOAD( "tpg1-ef.bin",  0x2e000, 0x2000, 0x64878342 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",    0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "tpg1-gr0.bin", 0x00000, 0x2000, 0x20c9217a );	ROM_LOAD( "tpg1-gr1.bin", 0x02000, 0x2000, 0xd7f44504 );	ROM_LOAD( "tpg1-gr2.bin", 0x04000, 0x2000, 0x4e59a15d );	ROM_LOAD( "tpg1-gr3.bin", 0x06000, 0x2000, 0x323a8640 );	ROM_LOAD( "tpg1-gr4.bin", 0x08000, 0x2000, 0x673acf42 );	ROM_LOAD( "tpg1-gr5.bin", 0x0a000, 0x2000, 0x067bfd66 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_triviag2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.bin",  0x10000, 0x4000, 0x4fca20c5 );	ROM_LOAD( "ab23.bin",  0x14000, 0x4000, 0x6cf2ddeb );	ROM_LOAD( "ab45.bin",  0x18000, 0x4000, 0xa7ff789c );	ROM_LOAD( "ab67.bin",  0x1c000, 0x4000, 0xcc5c68ef );	ROM_LOAD( "cd45.bin",  0x28000, 0x4000, 0xfc9c752a );	ROM_LOAD( "cd6ef.bin", 0x2c000, 0x4000, 0x23b56fb8 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.bin",  0x00000, 0x4000, 0x6829de8e );	ROM_LOAD( "gr23.bin",  0x04000, 0x4000, 0x89398700 );	ROM_LOAD( "gr45.bin",  0x08000, 0x4000, 0x1e870293 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_triviasp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "allsport.8a", 0x10000, 0x4000, 0x54b7ff31 );	ROM_LOAD( "allsport.7a", 0x14000, 0x4000, 0x59fae9d2 );	ROM_LOAD( "allsport.6a", 0x18000, 0x4000, 0x237b6b95 );	ROM_LOAD( "allsport.5a", 0x1c000, 0x4000, 0xb64d7f61 );	ROM_LOAD( "allsport.3a", 0x28000, 0x4000, 0xe45d09d6 );	ROM_LOAD( "allsport.1a", 0x2c000, 0x4000, 0x8bb3e831 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",     0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.bin",    0x00000, 0x4000, 0x6829de8e );	ROM_LOAD( "gr23.bin",    0x04000, 0x4000, 0x89398700 );	ROM_LOAD( "allsport.3b", 0x08000, 0x4000, 0x7415a7fc );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_triviayp = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.bin",  0x10000, 0x4000, 0x97d35a85 );	ROM_LOAD( "ab23.bin",  0x14000, 0x4000, 0x2ff67c70 );	ROM_LOAD( "ab45.bin",  0x18000, 0x4000, 0x511a0fab );	ROM_LOAD( "ab67.bin",  0x1c000, 0x4000, 0xdf99d00c );	ROM_LOAD( "cd45.bin",  0x28000, 0x4000, 0xac45809e );	ROM_LOAD( "cd6ef.bin", 0x2c000, 0x4000, 0xa008059f );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.bin", 0x00000, 0x4000, 0x6829de8e );	ROM_LOAD( "gr23.bin", 0x04000, 0x4000, 0x89398700 );	ROM_LOAD( "gr45.bin", 0x08000, 0x4000, 0x1242033e );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_triviabb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.bin",  0x10000, 0x4000, 0x1b7c439d );	ROM_LOAD( "ab23.bin",  0x14000, 0x4000, 0xe4f1e704 );	ROM_LOAD( "ab45.bin",  0x18000, 0x4000, 0xdaa2d8bc );	ROM_LOAD( "ab67.bin",  0x1c000, 0x4000, 0x3622c4f1 );	ROM_LOAD( "cd45.bin",  0x28000, 0x4000, 0x07fd88ff );	ROM_LOAD( "cd6ef.bin", 0x2c000, 0x4000, 0x2d03f241 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.bin", 0x00000, 0x4000, 0x6829de8e );	ROM_LOAD( "gr23.bin", 0x04000, 0x4000, 0x89398700 );	ROM_LOAD( "gr45.bin", 0x08000, 0x4000, 0x92fb6fb1 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_gimeabrk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.u8a",  0x10000, 0x4000, 0x18cc53db );	ROM_LOAD( "ab23.u7a",  0x14000, 0x4000, 0x6bd4190a );	ROM_LOAD( "ab45.u6a",  0x18000, 0x4000, 0x5dca4f33 );	ROM_LOAD( "cd6ef.uia", 0x2c000, 0x4000, 0x5e2b3510 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.u6b", 0x00000, 0x4000, 0xe3cdc476 );	ROM_LOAD( "gr23.u5b", 0x04000, 0x4000, 0x0555d9c0 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_minigolf = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.u8a",  0x10000, 0x4000, 0x348f827f );	ROM_LOAD( "ab23.u7a",  0x14000, 0x4000, 0x19a6ff47 );	ROM_LOAD( "ab45.u6a",  0x18000, 0x4000, 0x925d76eb );	ROM_LOAD( "ab67.u5a",  0x1c000, 0x4000, 0x6a311c9a );	ROM_LOAD( "cd23.u3a",  0x24000, 0x4000, 0x52279801 );	ROM_LOAD( "cd6ef.u1a", 0x2c000, 0x4000, 0x34c64f4c );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.u6b", 0x00000, 0x4000, 0x8e24d594 );	ROM_LOAD( "gr23.u5b", 0x04000, 0x4000, 0x3bf355ef );	ROM_LOAD( "gr45.u4b", 0x08000, 0x4000, 0x8eb14921 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_minigol2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "4a-ver2",  0x10000, 0x10000, 0x97d50493 );	ROM_LOAD( "1a-ver2",  0x20000, 0x10000, 0x60b6cd58 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "6b-ver2",  0x00000, 0x8000, 0x5988f4ba );	ROM_LOAD( "4b-ver2",  0x08000, 0x8000, 0x78a30e23 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_toggle = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "tgle-ab0.bin", 0x10000, 0x2000, 0x8c7b7fad );	ROM_LOAD( "tgle-ab1.bin", 0x12000, 0x2000, 0x771e5434 );	ROM_LOAD( "tgle-ab2.bin", 0x14000, 0x2000, 0x9b4baa3f );	ROM_LOAD( "tgle-ab3.bin", 0x16000, 0x2000, 0x35308a41 );	ROM_LOAD( "tgle-ab4.bin", 0x18000, 0x2000, 0xbaf5617b );	ROM_LOAD( "tgle-ab5.bin", 0x1a000, 0x2000, 0x88077dad );	ROM_LOAD( "tgle-cd.bin",  0x2c000, 0x2000, 0x0a2bb949 );	ROM_LOAD( "tgle-ef.bin",  0x2e000, 0x2000, 0x3ec10804 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",    0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "tgle-gr0.bin", 0x00000, 0x2000, 0x0e0e5d0e );	ROM_LOAD( "tgle-gr1.bin", 0x02000, 0x2000, 0x3b141ad2 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_nametune = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "nttab01.bin",  0x10000, 0x4000, 0xf99054f1 );	ROM_CONTINUE(             0x40000, 0x4000 );	ROM_LOAD( "nttab23.bin",  0x14000, 0x4000, 0xf2b8f7fa );	ROM_CONTINUE(             0x44000, 0x4000 );	ROM_LOAD( "nttab45.bin",  0x18000, 0x4000, 0x89e1c769 );	ROM_CONTINUE(             0x48000, 0x4000 );	ROM_LOAD( "nttab67.bin",  0x1c000, 0x4000, 0x7e5572a1 );	ROM_CONTINUE(             0x4c000, 0x4000 );	ROM_LOAD( "nttcd01.bin",  0x20000, 0x4000, 0xdb9d6154 );	ROM_CONTINUE(             0x50000, 0x4000 );	ROM_LOAD( "nttcd23.bin",  0x24000, 0x4000, 0x9d2e458f );	ROM_CONTINUE(             0x54000, 0x4000 );	ROM_LOAD( "nttcd45.bin",  0x28000, 0x4000, 0x9a4b87aa );	ROM_CONTINUE(             0x58000, 0x4000 );	ROM_LOAD( "nttcd6ef.bin", 0x2c000, 0x4000, 0x0459e6f8 );	ROM_CONTINUE(             0x5c000, 0x4000 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "nttgr0.bin",  0x00000, 0x8000, 0x6b75bb4b );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_nstocker = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.u8a",  0x10000, 0x4000, 0xa635f973 );	ROM_LOAD( "ab23.u7a",  0x14000, 0x4000, 0x223acbb2 );	ROM_LOAD( "ab45.u6a",  0x18000, 0x4000, 0x27a728b5 );	ROM_LOAD( "ab67.u5a",  0x1c000, 0x4000, 0x2999cdf2 );	ROM_LOAD( "cd01.u4a",  0x20000, 0x4000, 0x75e9b51a );	ROM_LOAD( "cd23.u3a",  0x24000, 0x4000, 0x0a32e0a5 );	ROM_LOAD( "cd45.u2a",  0x28000, 0x4000, 0x9bb292fe );	ROM_LOAD( "cd6ef.u1a", 0x2c000, 0x4000, 0xe77c1aea );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.u4c", 0x00000, 0x4000, 0xfd0c38be );	ROM_LOAD( "gr23.u3c", 0x04000, 0x4000, 0x35d4433e );	ROM_LOAD( "gr45.u2c", 0x08000, 0x4000, 0x734b858a );	ROM_LOAD( "gr67.u1c", 0x0c000, 0x4000, 0x3311f9c0 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_sfootbal = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "sfbab01.bin",  0x10000, 0x4000, 0x2a69803f );	ROM_LOAD( "sfbab23.bin",  0x14000, 0x4000, 0x89f157c2 );	ROM_LOAD( "sfbab45.bin",  0x18000, 0x4000, 0x91ad42c5 );	ROM_LOAD( "sfbcd6ef.bin", 0x2c000, 0x4000, 0xbf80bb1a );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "sfbgr01.bin", 0x00000, 0x4000, 0xe3108d35 );	ROM_LOAD( "sfbgr23.bin", 0x04000, 0x4000, 0x5c5af726 );	ROM_LOAD( "sfbgr45.bin", 0x08000, 0x4000, 0xe767251e );	ROM_LOAD( "sfbgr67.bin", 0x0c000, 0x4000, 0x42452a7a );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_spiker = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab01.u8a",  0x10000, 0x4000, 0x2d53d023 );	ROM_LOAD( "ab23.u7a",  0x14000, 0x4000, 0x3be87edf );	ROM_LOAD( "cd6ef.u1a", 0x2c000, 0x4000, 0xf2c73ece );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr01.u4c", 0x00000, 0x4000, 0x0caa6e3e );	ROM_LOAD( "gr23.u3c", 0x04000, 0x4000, 0x970c81f6 );	ROM_LOAD( "gr45.u2c", 0x08000, 0x4000, 0x90ddd737 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_rescraid = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab1.a10",   0x10000, 0x8000, 0x33a76b47 );	ROM_LOAD( "ab12.a12",  0x18000, 0x8000, 0x7c7a9f12 );	ROM_LOAD( "cd8.a16",   0x20000, 0x8000, 0x90917a43 );	ROM_LOAD( "cd12.a18",  0x28000, 0x8000, 0x0450e9d7 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr0.a5",    0x00000, 0x8000, 0xe0dfc133 );	ROM_LOAD( "gr4.a7",    0x08000, 0x8000, 0x952ade30 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_rescrdsa = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );    /* 64k for code for the first CPU, plus 128k of banked ROMs */
		ROM_LOAD( "ab1-sa.a10",   0x10000, 0x8000, 0xaa0a9f48 );	ROM_LOAD( "ab12-sa.a12",  0x18000, 0x8000, 0x16d4da86 );	ROM_LOAD( "cd8-sa.a16",   0x20000, 0x8000, 0x9dfb50c2 );	ROM_LOAD( "cd12-sa.a18",  0x28000, 0x8000, 0x18c62613 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* 64k for Z80 */
		ROM_LOAD( "sentesnd",  0x00000, 0x2000, 0x4dd0a525 );
		ROM_REGION( 0x10000, REGION_GFX1 );	/* up to 64k of sprites */
		ROM_LOAD( "gr0.a5",    0x00000, 0x8000, 0xe0dfc133 );	ROM_LOAD( "gr4.a7",    0x08000, 0x8000, 0x952ade30 );ROM_END(); }}; 
