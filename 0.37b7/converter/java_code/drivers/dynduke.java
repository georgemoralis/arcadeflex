...
public class dynduke
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x20, 0x20, "Starting Coin" );	PORT_DIPSETTING(    0x20, "normal" );	PORT_DIPSETTING(    0x00, "X 2" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unused") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, "Difficulty?" );	PORT_DIPSETTING(    0x30, "Normal" );	PORT_DIPSETTING(    0x20, "Easy" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPSETTING(    0x00, "Very Hard" );	PORT_DIPNAME( 0x40, 0x40, "Continue?" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x40, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x00, "Demo Sound?" );	PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
	...
	static public static VhEofCallbackPtr dynduke_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
	...
	static RomLoadPtr rom_dynduke = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "dd8.w8", 0x000000, 0x08000, 0x3c29480b );	ROM_CONTINUE(       0x010000, 0x08000 );
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dd9.jk5",	0x000000, 0x04000, 0xf2bc9af4 );/* chars */
		ROM_LOAD( "dd10.jk3",	0x010000, 0x04000, 0xc2a9f19b );
		ROM_REGION( 0x180000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dd.a2",		0x000000, 0x40000, 0x598f343f );/* background */
		ROM_LOAD( "dd.b2",		0x040000, 0x40000, 0x41a9088d );	ROM_LOAD( "dd.c2",		0x080000, 0x40000, 0xcc341b42 );	ROM_LOAD( "dd.d2",		0x0c0000, 0x40000, 0x4752b4d7 );	ROM_LOAD( "dd.de3",		0x100000, 0x40000, 0x44a4cb62 );	ROM_LOAD( "dd.ef3",		0x140000, 0x40000, 0xaa8aee1a );
		ROM_REGION( 0x100000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dd.mn3",		0x000000, 0x40000, 0x2ee0ca98 );/* foreground */
		ROM_LOAD( "dd.mn4",		0x040000, 0x40000, 0x6c71e2df );	ROM_LOAD( "dd.n45",		0x080000, 0x40000, 0x85d918e1 );	ROM_LOAD( "dd.mn5",		0x0c0000, 0x40000, 0xe71e34df );
		ROM_REGION( 0x200000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD_GFX_EVEN(  "dd.n1", 0x000000, 0x40000, 0xcf1db927 ) /* sprites */
		...
		ROM_LOAD( "dd7.x10", 0x000000, 0x10000, 0x9cbc7b41 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_dbldyn = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x18000, REGION_CPU3 );/* sound Z80 */
		ROM_LOAD( "8.8w", 0x000000, 0x08000, 0xf4066081 );	ROM_CONTINUE(     0x010000, 0x08000 );
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "9.5k",	    0x004000, 0x4000, 0x16bec703 );/* chars */
		ROM_CONTINUE(           0x000000, 0x4000 );	ROM_CONTINUE(           0x008000, 0x8000 );	ROM_LOAD( "10.4k",	    0x014000, 0x4000, 0x719f909d );	ROM_CONTINUE(           0x010000, 0x4000 );	ROM_CONTINUE(           0x008000, 0x8000 );
		ROM_REGION( 0x180000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dd.a2",		0x000000, 0x40000, 0x598f343f );/* background */
		ROM_LOAD( "dd.b2",		0x040000, 0x40000, 0x41a9088d );	ROM_LOAD( "dd.c2",		0x080000, 0x40000, 0xcc341b42 );	ROM_LOAD( "dd.d2",		0x0c0000, 0x40000, 0x4752b4d7 );	ROM_LOAD( "dd.de3",		0x100000, 0x40000, 0x44a4cb62 );	ROM_LOAD( "dd.ef3",		0x140000, 0x40000, 0xaa8aee1a );
		ROM_REGION( 0x100000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dd.mn3",		0x000000, 0x40000, 0x2ee0ca98 );/* foreground */
		ROM_LOAD( "dd.mn4",		0x040000, 0x40000, 0x6c71e2df );	ROM_LOAD( "dd.n45",		0x080000, 0x40000, 0x85d918e1 );	ROM_LOAD( "dd.mn5",		0x0c0000, 0x40000, 0xe71e34df );
