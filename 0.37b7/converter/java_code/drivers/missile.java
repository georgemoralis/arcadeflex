...
public class missile
{
	...
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN3 );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x18, 0x00, IPT_UNUSED );/* trackball input, handled in machine/missile.c */
		PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_TILT );	PORT_BITX(0x40, IP_ACTIVE_LOW, IPT_SERVICE , DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		...
		PORT_DIPNAME(0x0c, 0x00, "Right Coin" );	PORT_DIPSETTING(   0x00, "*1" );	PORT_DIPSETTING(   0x04, "*4" );	PORT_DIPSETTING(   0x08, "*5" );	PORT_DIPSETTING(   0x0c, "*6" );	PORT_DIPNAME(0x10, 0x00, "Center Coin" );	PORT_DIPSETTING(   0x00, "*1" );	PORT_DIPSETTING(   0x10, "*2" );	PORT_DIPNAME(0x60, 0x00, "Language" );	PORT_DIPSETTING(   0x00, "English" );	PORT_DIPSETTING(   0x20, "French" );	PORT_DIPSETTING(   0x40, "German" );	PORT_DIPSETTING(   0x60, "Spanish" );	PORT_DIPNAME(0x80, 0x80, DEF_STR( "Unknown") );
		PORT_DIPSETTING(   0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(   0x00, DEF_STR( "On") );
	
		PORT_START(); 	/* IN3 */
		PORT_DIPNAME(0x03, 0x00, "Cities" );	PORT_DIPSETTING(   0x02, "4" );	PORT_DIPSETTING(   0x01, "5" );	PORT_DIPSETTING(   0x03, "6" );	PORT_DIPSETTING(   0x00, "7" );	PORT_DIPNAME(0x04, 0x04, "Bonus Credit for 4 Coins" );	PORT_DIPSETTING(   0x04, DEF_STR( "No") );
		PORT_DIPSETTING(   0x00, DEF_STR( "Yes") );
		PORT_DIPNAME(0x08, 0x00, "Trackball Size" );	PORT_DIPSETTING(   0x00, "Large" );	PORT_DIPSETTING(   0x08, "Mini" );	PORT_DIPNAME(0x70, 0x70, "Bonus City" );	PORT_DIPSETTING(   0x10, "8000" );	PORT_DIPSETTING(   0x70, "10000" );	PORT_DIPSETTING(   0x60, "12000" );	PORT_DIPSETTING(   0x50, "14000" );	PORT_DIPSETTING(   0x40, "15000" );	PORT_DIPSETTING(   0x30, "18000" );	PORT_DIPSETTING(   0x20, "20000" );	PORT_DIPSETTING(   0x00, "None" );	PORT_DIPNAME(0x80, 0x00, DEF_STR( "Cabinet") );
		...
		PORT_START(); 	/* FAKE */
		PORT_ANALOG( 0x0f, 0x00, IPT_TRACKBALL_Y | IPF_REVERSE | IPF_COCKTAIL, 20, 10, 0, 0);INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(   0x03, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(   0x02, DEF_STR( "Free_Play") );
		PORT_DIPNAME(0x0c, 0x00, "Right Coin" );	PORT_DIPSETTING(   0x00, "*1" );	PORT_DIPSETTING(   0x04, "*4" );	PORT_DIPSETTING(   0x08, "*5" );	PORT_DIPSETTING(   0x0c, "*6" );	PORT_DIPNAME(0x10, 0x00, "Center Coin" );	PORT_DIPSETTING(   0x00, "*1" );	PORT_DIPSETTING(   0x10, "*2" );	PORT_DIPNAME(0x20, 0x20, DEF_STR( "Unknown") );
		PORT_DIPSETTING(   0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(   0x00, DEF_STR( "On") );
		PORT_DIPNAME(0xc0, 0x40, "Game" );	PORT_DIPSETTING(   0x00, "Missile Command" );	PORT_DIPSETTING(   0x40, "Easy Super Missile Attack" );	PORT_DIPSETTING(   0x80, "Reg. Super Missile Attack" );	PORT_DIPSETTING(   0xc0, "Hard Super Missile Attack" );
		PORT_START(); 	/* IN3 */
		PORT_DIPNAME(0x03, 0x00, "Cities" );	PORT_DIPSETTING(   0x02, "4" );	PORT_DIPSETTING(   0x01, "5" );	PORT_DIPSETTING(   0x03, "6" );	PORT_DIPSETTING(   0x00, "7" );	PORT_DIPNAME(0x04, 0x04, "Bonus Credit for 4 Coins" );	PORT_DIPSETTING(   0x04, DEF_STR( "No") );
		PORT_DIPSETTING(   0x00, DEF_STR( "Yes") );
		PORT_DIPNAME(0x08, 0x00, "Trackball Size" );	PORT_DIPSETTING(   0x00, "Large" );	PORT_DIPSETTING(   0x08, "Mini" );	PORT_DIPNAME(0x70, 0x70, "Bonus City" );	PORT_DIPSETTING(   0x10, "8000" );	PORT_DIPSETTING(   0x70, "10000" );	PORT_DIPSETTING(   0x60, "12000" );	PORT_DIPSETTING(   0x50, "14000" );	PORT_DIPSETTING(   0x40, "15000" );	PORT_DIPSETTING(   0x30, "18000" );	PORT_DIPSETTING(   0x20, "20000" );	PORT_DIPSETTING(   0x00, "None" );	PORT_DIPNAME(0x80, 0x00, DEF_STR( "Cabinet") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_missile = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "035820.02",    0x5000, 0x0800, 0x7a62ce6a );	ROM_LOAD( "035821.02",    0x5800, 0x0800, 0xdf3bd57f );	ROM_LOAD( "035822.02",    0x6000, 0x0800, 0xa1cd384a );	ROM_LOAD( "035823.02",    0x6800, 0x0800, 0x82e552bb );	ROM_LOAD( "035824.02",    0x7000, 0x0800, 0x606e42e0 );	ROM_LOAD( "035825.02",    0x7800, 0x0800, 0xf752eaeb );	ROM_RELOAD( 		   0xF800, 0x0800 );	/* for interrupt vectors  */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_missile2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "35820-01.h1",  0x5000, 0x0800, 0x41cbb8f2 );	ROM_LOAD( "35821-01.jk1", 0x5800, 0x0800, 0x728702c8 );	ROM_LOAD( "35822-01.kl1", 0x6000, 0x0800, 0x28f0999f );	ROM_LOAD( "35823-01.mn1", 0x6800, 0x0800, 0xbcc93c94 );	ROM_LOAD( "35824-01.np1", 0x7000, 0x0800, 0x0ca089c8 );	ROM_LOAD( "35825-01.r1",  0x7800, 0x0800, 0x428cf0d5 );	ROM_RELOAD( 		      0xF800, 0x0800 );	/* for interrupt vectors  */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_suprmatk = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "035820.sma",   0x5000, 0x0800, 0x75f01b87 );	ROM_LOAD( "035821.sma",   0x5800, 0x0800, 0x3320d67e );	ROM_LOAD( "035822.sma",   0x6000, 0x0800, 0xe6be5055 );	ROM_LOAD( "035823.sma",   0x6800, 0x0800, 0xa6069185 );	ROM_LOAD( "035824.sma",   0x7000, 0x0800, 0x90a06be8 );	ROM_LOAD( "035825.sma",   0x7800, 0x0800, 0x1298213d );	ROM_RELOAD( 		   0xF800, 0x0800 );	/* for interrupt vectors  */
	ROM_END(); }}; 
