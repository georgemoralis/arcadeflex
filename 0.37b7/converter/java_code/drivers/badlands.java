...
public class badlands
{
	...
	PORT_START(); 		/* fe4000 */
		PORT_BIT( 0x000f, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0010, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0020, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_SERVICE( 0x0080, IP_ACTIVE_LOW );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();       /* fe6000 */
		PORT_ANALOG( 0x00ff, 0, IPT_DIAL | IPF_PLAYER1, 50, 10, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START();       /* fe6002 */
		PORT_ANALOG( 0x00ff, 0, IPT_DIAL | IPF_PLAYER2, 50, 10, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 		/* audio port */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_UNUSED );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_SPECIAL );/* self test */
		...
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0xfffe, IP_ACTIVE_HIGH, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_badlands = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "1008.20f",  0x00000, 0x10000, 0xa3da5774 );	ROM_LOAD_ODD ( "1006.27f",  0x00000, 0x10000, 0xaa03b4f3 );	ROM_LOAD_EVEN( "1009.17f",  0x20000, 0x10000, 0x0e2e807f );	ROM_LOAD_ODD ( "1007.24f",  0x20000, 0x10000, 0x99a20c2c );
		ROM_REGION( 0x14000, REGION_CPU2 );/* 64k for 6502 code */
		ROM_LOAD( "1018.9c", 0x10000, 0x4000, 0xa05fd146 );	ROM_CONTINUE(        0x04000, 0xc000 );
		ROM_REGION( 0x60000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1012.4n",  0x000000, 0x10000, 0x5d124c6c );/* playfield */
		ROM_LOAD( "1013.2n",  0x010000, 0x10000, 0xb1ec90d6 );	ROM_LOAD( "1014.4s",  0x020000, 0x10000, 0x248a6845 );	ROM_LOAD( "1015.2s",  0x030000, 0x10000, 0x792296d8 );	ROM_LOAD( "1016.4u",  0x040000, 0x10000, 0x878f7c66 );	ROM_LOAD( "1017.2u",  0x050000, 0x10000, 0xad0071a3 );
		ROM_REGION( 0x30000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "1010.14r", 0x000000, 0x10000, 0xc15f629e );/* mo */
		ROM_LOAD( "1011.10r", 0x010000, 0x10000, 0xfb0b6717 );	ROM_LOAD( "1019.14t", 0x020000, 0x10000, 0x0e26bff6 );ROM_END(); }}; 
