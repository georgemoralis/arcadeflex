...
public class relief
{
	...
	PORT_START(); 	/* 260000 */
		PORT_BIT(  0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1 );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1 );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER1 );
		PORT_START(); 	/* 260002 */
		PORT_BIT(  0x00ff, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_START3 );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_PLAYER2 );
		PORT_START(); 	/* 260010 */
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_UNUSED );/* tested before writing to 260040 */
		PORT_SERVICE( 0x0040, IP_ACTIVE_LOW );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_VBLANK );	PORT_BIT(  0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* 260012 */
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT(  0xffdc, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_relief = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "0011d.19e", 0x00000, 0x20000, 0xcb3f73ad );	ROM_LOAD_ODD ( "0012d.19j", 0x00000, 0x20000, 0x90655721 );	ROM_LOAD_EVEN( "093-0013.17e", 0x40000, 0x20000, 0x1e1e82e5 );	ROM_LOAD_ODD ( "093-0014.17j", 0x40000, 0x20000, 0x19e5decd );
		ROM_REGION( 0x240000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "093-0025.14s", 0x000000, 0x80000, 0x1b9e5ef2 );	ROM_LOAD( "093-0026.8d",  0x080000, 0x80000, 0x09b25d93 );	ROM_LOAD( "093-0027.18s", 0x100000, 0x80000, 0x5bc1c37b );	ROM_LOAD( "093-0028.10d", 0x180000, 0x80000, 0x55fb9111 );	ROM_LOAD( "093-0029.4d",  0x200000, 0x40000, 0xe4593ff4 );
		ROM_REGION( 0x200000, REGION_SOUND1 );/* 2MB for ADPCM data */
		ROM_LOAD( "093-0030.9b",  0x100000, 0x80000, 0xf4c567f5 );	ROM_LOAD( "093-0031.10b", 0x180000, 0x80000, 0xba908d73 );ROM_END(); }}; 
	
	static RomLoadPtr rom_relief2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x80000, REGION_CPU1 );/* 8*64k for 68000 code */
		ROM_LOAD_EVEN( "093-0011.19e", 0x00000, 0x20000, 0x794cea33 );	ROM_LOAD_ODD ( "093-0012.19j", 0x00000, 0x20000, 0x577495f8 );	ROM_LOAD_EVEN( "093-0013.17e", 0x40000, 0x20000, 0x1e1e82e5 );	ROM_LOAD_ODD ( "093-0014.17j", 0x40000, 0x20000, 0x19e5decd );
		ROM_REGION( 0x240000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "093-0025.14s", 0x000000, 0x80000, 0x1b9e5ef2 );	ROM_LOAD( "093-0026.8d",  0x080000, 0x80000, 0x09b25d93 );	ROM_LOAD( "093-0027.18s", 0x100000, 0x80000, 0x5bc1c37b );	ROM_LOAD( "093-0028.10d", 0x180000, 0x80000, 0x55fb9111 );	ROM_LOAD( "093-0029.4d",  0x200000, 0x40000, 0xe4593ff4 );
		ROM_REGION( 0x200000, REGION_SOUND1 );/* 2MB for ADPCM data */
		ROM_LOAD( "093-0030.9b",  0x100000, 0x80000, 0xf4c567f5 );	ROM_LOAD( "093-0031.10b", 0x180000, 0x80000, 0xba908d73 );ROM_END(); }}; 
