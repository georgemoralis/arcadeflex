...
public class rastan
{
	...
	public static ReadHandlerPtr rastan_input_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
			case 0:
	...
	public static ReadHandlerPtr rastan_cycle_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x0c, "100000" );	PORT_DIPSETTING(    0x08, "150000" );	PORT_DIPSETTING(    0x04, "200000" );	PORT_DIPSETTING(    0x00, "250000" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0x40, 0x40, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
	...
	static InputPortPtr input_ports_rastsaga = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rastan = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "ic19_38.bin", 0x00000, 0x10000, 0x1c91dbb1 );	ROM_LOAD_ODD ( "ic07_37.bin", 0x00000, 0x10000, 0xecf20bdd );	ROM_LOAD_EVEN( "ic20_40.bin", 0x20000, 0x10000, 0x0930d4b3 );	ROM_LOAD_ODD ( "ic08_39.bin", 0x20000, 0x10000, 0xd95ade5e );	ROM_LOAD_EVEN( "ic21_42.bin", 0x40000, 0x10000, 0x1857a7cb );	ROM_LOAD_ODD ( "ic09_43.bin", 0x40000, 0x10000, 0xc34b9152 );
		ROM_REGION( 0x1c000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "ic49_19.bin", 0x00000, 0x4000, 0xee81fdd8 );	ROM_CONTINUE(            0x10000, 0xc000 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic40_01.bin",  0x00000, 0x20000, 0xcd30de19 );       /* 8x8 0 */
		...
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic15_05.bin",  0x00000, 0x20000, 0xc22d94ac );       /* sprites 1a */
	...
	static RomLoadPtr rom_rastanu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 6*64k for 68000 code */
		ROM_LOAD_EVEN( "ic19_38.bin", 0x00000, 0x10000, 0x1c91dbb1 );	ROM_LOAD_ODD ( "ic07_37.bin", 0x00000, 0x10000, 0xecf20bdd );	ROM_LOAD_EVEN( "b04-45.20",   0x20000, 0x10000, 0x362812dd );	ROM_LOAD_ODD ( "b04-44.8",    0x20000, 0x10000, 0x51cc5508 );	ROM_LOAD_EVEN( "ic21_42.bin", 0x40000, 0x10000, 0x1857a7cb );	ROM_LOAD_ODD ( "b04-41-1.9",  0x40000, 0x10000, 0xbd403269 );
		ROM_REGION( 0x1c000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "ic49_19.bin", 0x00000, 0x4000, 0xee81fdd8 );	ROM_CONTINUE(            0x10000, 0xc000 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic40_01.bin",  0x00000, 0x20000, 0xcd30de19 );       /* 8x8 0 */
		ROM_LOAD( "ic39_03.bin",  0x20000, 0x20000, 0xab67e064 );       /* 8x8 0 */
	...
	static RomLoadPtr rom_rastanu2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 6*64k for 68000 code */
		ROM_LOAD_EVEN( "rs19_38.bin", 0x00000, 0x10000, 0xa38ac909 );	ROM_LOAD_ODD ( "b04-21.7",    0x00000, 0x10000, 0x7c8dde9a );	ROM_LOAD_EVEN( "b04-23.20",   0x20000, 0x10000, 0x254b3dce );	ROM_LOAD_ODD ( "b04-22.8",    0x20000, 0x10000, 0x98e8edcf );	ROM_LOAD_EVEN( "b04-25.21",   0x40000, 0x10000, 0xd1e5adee );	ROM_LOAD_ODD ( "b04-24.9",    0x40000, 0x10000, 0xa3dcc106 );
		ROM_REGION( 0x1c000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "ic49_19.bin", 0x00000, 0x4000, 0xee81fdd8 );	ROM_CONTINUE(            0x10000, 0xc000 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic40_01.bin",  0x00000, 0x20000, 0xcd30de19 );       /* 8x8 0 */
		ROM_LOAD( "ic39_03.bin",  0x20000, 0x20000, 0xab67e064 );       /* 8x8 0 */
	...
	static RomLoadPtr rom_rastsaga = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 6*64k for 68000 code */
		ROM_LOAD_EVEN( "rs19_38.bin", 0x00000, 0x10000, 0xa38ac909 );	ROM_LOAD_ODD ( "rs07_37.bin", 0x00000, 0x10000, 0xbad60872 );	ROM_LOAD_EVEN( "rs20_40.bin", 0x20000, 0x10000, 0x6bcf70dc );	ROM_LOAD_ODD ( "rs08_39.bin", 0x20000, 0x10000, 0x8838ecc5 );	ROM_LOAD_EVEN( "rs21_42.bin", 0x40000, 0x10000, 0xb626c439 );	ROM_LOAD_ODD ( "rs09_43.bin", 0x40000, 0x10000, 0xc928a516 );
		ROM_REGION( 0x1c000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "ic49_19.bin", 0x00000, 0x4000, 0xee81fdd8 );	ROM_CONTINUE(            0x10000, 0xc000 );
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ic40_01.bin",  0x00000, 0x20000, 0xcd30de19 );       /* 8x8 0 */
		ROM_LOAD( "ic39_03.bin",  0x20000, 0x20000, 0xab67e064 );       /* 8x8 0 */
