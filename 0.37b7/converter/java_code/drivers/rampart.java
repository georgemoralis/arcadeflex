...
public class rampart
{
	...
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BITX(  0x0004, 0x0004, IPT_DIPSWITCH_NAME, "Number of Players", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x0000, "2-player Version");	PORT_DIPSETTING(    0x0004, "3-player Version");	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x00f0, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0800, IP_ACTIVE_LOW );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_Y | IPF_REVERSE | IPF_PLAYER2, 100, 30, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_X | IPF_REVERSE | IPF_PLAYER2, 100, 30, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_Y | IPF_REVERSE | IPF_PLAYER1, 100, 30, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_X | IPF_REVERSE | IPF_PLAYER1, 100, 30, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_Y | IPF_REVERSE | IPF_PLAYER3, 100, 30, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
	    PORT_ANALOG( 0x00ff, 0, IPT_TRACKBALL_X | IPF_REVERSE | IPF_PLAYER3, 100, 30, 0, 0 );	PORT_BIT( 0xff00, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	
	
	static InputPortPtr input_ports_ramprt2p = new InputPortPtr(){ public void handler() { 
	PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER3 );	PORT_BITX(  0x0004, 0x0000, IPT_DIPSWITCH_NAME, "Number of Players", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x0000, "2-player Version");	PORT_DIPSETTING(    0x0004, "3-player Version");	PORT_BIT( 0x0008, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x00f0, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER3 );	PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_VBLANK );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_SERVICE );	PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x00f8, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_BIT( 0x0100, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x0200, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x0400, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x0800, IP_ACTIVE_LOW );	PORT_BIT( 0xf000, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_PLAYER2 );	PORT_BIT( 0x0002, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_PLAYER2 );	PORT_BIT( 0x0004, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_PLAYER2 );	PORT_BIT( 0x0008, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_PLAYER2 );	PORT_BIT( 0x0010, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_PLAYER1 );	PORT_BIT( 0x0020, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_PLAYER1 );	PORT_BIT( 0x0040, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_PLAYER1 );	PORT_BIT( 0x0080, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_PLAYER1 );	PORT_BIT( 0x0100, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT | IPF_PLAYER3 );	PORT_BIT( 0x0200, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_PLAYER3 );	PORT_BIT( 0x0400, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_PLAYER3 );	PORT_BIT( 0x0800, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN | IPF_PLAYER3 );	PORT_BIT( 0xf000, IP_ACTIVE_HIGH, IPT_UNUSED );
		PORT_START(); 
		...
		PORT_BIT( 0xffff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 
		PORT_BIT( 0xffff, IP_ACTIVE_LOW, IPT_UNUSED );INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_rampart = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x148000, REGION_CPU1 );	ROM_LOAD_EVEN( "082-1033.13l", 0x00000, 0x80000, 0x5c36795f );	ROM_LOAD_ODD ( "082-1032.13j", 0x00000, 0x80000, 0xec7bc38c );	ROM_LOAD_EVEN( "082-2031.13l", 0x00000, 0x10000, 0x07650c7e );	ROM_LOAD_ODD ( "082-2030.13h", 0x00000, 0x10000, 0xe2bf2a26 );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "082-1009.2n",   0x000000, 0x20000, 0x23b95f59 );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "082-1007.2d", 0x00000, 0x20000, 0xc96a0fc3 );	ROM_LOAD( "082-1008.1d", 0x20000, 0x20000, 0x518218d9 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_ramprt2p = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x148000, REGION_CPU1 );	ROM_LOAD_EVEN( "082-1033.13l", 0x00000, 0x80000, 0x5c36795f );	ROM_LOAD_ODD ( "082-1032.13j", 0x00000, 0x80000, 0xec7bc38c );	ROM_LOAD_EVEN( "205113kl.rom", 0x00000, 0x20000, 0xd4e26d0f );	ROM_LOAD_ODD ( "205013h.rom",  0x00000, 0x20000, 0xed2a49bd );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "10192n.rom",   0x000000, 0x20000, 0xefa38bef );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "082-1007.2d", 0x00000, 0x20000, 0xc96a0fc3 );	ROM_LOAD( "082-1008.1d", 0x20000, 0x20000, 0x518218d9 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_rampartj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x148000, REGION_CPU1 );	ROM_LOAD_EVEN( "3451.bin",  0x00000, 0x20000, 0xc6596d32 );	ROM_LOAD_ODD ( "3450.bin",  0x00000, 0x20000, 0x563b33cc );	ROM_LOAD_EVEN( "1463.bin",  0x40000, 0x20000, 0x65fe3491 );	ROM_LOAD_ODD ( "1462.bin",  0x40000, 0x20000, 0xba731652 );	ROM_LOAD_EVEN( "1465.bin",  0x80000, 0x20000, 0x9cb87d1b );	ROM_LOAD_ODD ( "1464.bin",  0x80000, 0x20000, 0x2ff75c40 );	ROM_LOAD_EVEN( "1467.bin",  0xc0000, 0x20000, 0xe0cfcda5 );	ROM_LOAD_ODD ( "1466.bin",  0xc0000, 0x20000, 0xa7a5a951 );
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "2419.bin",   0x000000, 0x20000, 0x456a8aae );
		ROM_REGION( 0x40000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "082-1007.2d", 0x00000, 0x20000, 0xc96a0fc3 );	ROM_LOAD( "082-1008.1d", 0x20000, 0x20000, 0x518218d9 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_arcadecr = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x148000, REGION_CPU1 );	ROM_LOAD_EVEN( "pgm0",  0x00000, 0x80000, 0xb5b93623 );	ROM_LOAD_ODD ( "prog1", 0x00000, 0x80000, 0xe7efef85 );
		ROM_REGION( 0x80000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "atcl_mob",   0x00000, 0x80000, 0x0e9b3930 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* ADPCM data */
		ROM_LOAD( "adpcm",      0x00000, 0x80000, 0x03ca7f03 );ROM_END(); }}; 
	...
	static public static InitDriverPtr init_arcadecr = new InitDriverPtr() { public void handler() 
	{
