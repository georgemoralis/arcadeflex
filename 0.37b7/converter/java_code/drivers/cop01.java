...
public class cop01
{
	...
	PORT_START();       /* IN0 */
		...
		PORT_DIPSETTING(    0x03, "Easy" );	PORT_DIPSETTING(    0x01, "Medium" );	PORT_DIPSETTING(    0x02, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x0c, "3" );	PORT_DIPSETTING(    0x04, "4" );	PORT_DIPSETTING(    0x08, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0x10, 0x10, "1st Bonus Life" );	PORT_DIPSETTING(    0x10, "20000" );	PORT_DIPSETTING(    0x00, "30000" );	PORT_DIPNAME( 0x60, 0x60, "2nd Bonus Life" );	PORT_DIPSETTING(    0x60, "30000" );	PORT_DIPSETTING(    0x20, "50000" );	PORT_DIPSETTING(    0x40, "100000" );	PORT_DIPSETTING(    0x00, "150000" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Unknown") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cop01 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "cop01.2b",     0x0000, 0x4000, 0x5c2734ab );	ROM_LOAD( "cop02.4b",     0x4000, 0x4000, 0x9c7336ef );	ROM_LOAD( "cop03.5b",     0x8000, 0x4000, 0x2566c8bf );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for code */
		ROM_LOAD( "cop15.17b",    0x0000, 0x4000, 0x6a5f08fa );	ROM_LOAD( "cop16.18b",    0x4000, 0x4000, 0x56bf6946 );
		ROM_REGION( 0x02000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cop14.15g",    0x00000, 0x2000, 0x066d1c55 );/* chars */
	
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cop04.15c",    0x00000, 0x4000, 0x622d32e6 );/* tiles */
		ROM_LOAD( "cop05.16c",    0x04000, 0x4000, 0xc6ac5a35 );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cop10.3e",     0x00000, 0x2000, 0x444cb19d );/* sprites */
		ROM_LOAD( "cop11.5e",     0x02000, 0x2000, 0x9078bc04 );	ROM_LOAD( "cop12.6e",     0x04000, 0x2000, 0x257a6706 );	ROM_LOAD( "cop13.8e",     0x06000, 0x2000, 0x07c4ea66 );	ROM_LOAD( "cop06.3g",     0x08000, 0x2000, 0xf1c1f4a5 );	ROM_LOAD( "cop07.5g",     0x0a000, 0x2000, 0x11db7b72 );	ROM_LOAD( "cop08.6g",     0x0c000, 0x2000, 0xa63ddda6 );	ROM_LOAD( "cop09.8g",     0x0e000, 0x2000, 0x855a2ec3 );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "copproma.13d", 0x0000, 0x0100, 0x97f68a7a );/* red */
	...
	static RomLoadPtr rom_cop01a = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );    /* 64k for code */
		ROM_LOAD( "cop01alt.001", 0x0000, 0x4000, 0xa13ee0d3 );	ROM_LOAD( "cop01alt.002", 0x4000, 0x4000, 0x20bad28e );	ROM_LOAD( "cop01alt.003", 0x8000, 0x4000, 0xa7e10b79 );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for code */
		ROM_LOAD( "cop01alt.015", 0x0000, 0x4000, 0x95be9270 );	ROM_LOAD( "cop01alt.016", 0x4000, 0x4000, 0xc20bf649 );
		ROM_REGION( 0x02000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cop01alt.014", 0x00000, 0x2000, 0xedd8a474 );/* chars */
	
		ROM_REGION( 0x08000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cop04.15c",    0x00000, 0x4000, 0x622d32e6 );/* tiles */
		ROM_LOAD( "cop05.16c",    0x04000, 0x4000, 0xc6ac5a35 );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cop01alt.010", 0x00000, 0x2000, 0x94aee9d6 );/* sprites */
		ROM_LOAD( "cop11.5e",     0x02000, 0x2000, 0x9078bc04 );	ROM_LOAD( "cop12.6e",     0x04000, 0x2000, 0x257a6706 );	ROM_LOAD( "cop13.8e",     0x06000, 0x2000, 0x07c4ea66 );	ROM_LOAD( "cop01alt.006", 0x08000, 0x2000, 0xcac7dac8 );	ROM_LOAD( "cop07.5g",     0x0a000, 0x2000, 0x11db7b72 );	ROM_LOAD( "cop08.6g",     0x0c000, 0x2000, 0xa63ddda6 );	ROM_LOAD( "cop09.8g",     0x0e000, 0x2000, 0x855a2ec3 );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "copproma.13d", 0x0000, 0x0100, 0x97f68a7a );/* red */
		ROM_LOAD( "coppromb.14d", 0x0100, 0x0100, 0x39a40b4c );/* green */
		ROM_LOAD( "coppromc.15d", 0x0200, 0x0100, 0x8181748b );/* blue */
		ROM_LOAD( "coppromd.19d", 0x0300, 0x0100, 0x6a63dbb8 );/* lookup table? (not implemented) */
