...
public class jailbrek
{
	...
	PORT_START(); 	/* DSW0  - $3303 */
		...
		PORT_DIPSETTING(    0x08, "30000 70000" );	PORT_DIPSETTING(    0x00, "40000 80000" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Unknown") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_jailbrek = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "jailb11d.bin", 0x8000, 0x4000, 0xa0b88dfd );	ROM_LOAD( "jailb9d.bin",  0xc000, 0x4000, 0x444b7d8e );
	    ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "jailb4f.bin",  0x00000, 0x4000, 0xe3b7a226 );/* characters */
	    ROM_LOAD( "jailb5f.bin",  0x04000, 0x4000, 0x504f0912 );
	    ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );    ROM_LOAD( "jailb3e.bin",  0x00000, 0x4000, 0x0d269524 );/* sprites */
	    ROM_LOAD( "jailb4e.bin",  0x04000, 0x4000, 0x27d4f6f4 );    ROM_LOAD( "jailb5e.bin",  0x08000, 0x4000, 0x717485cb );    ROM_LOAD( "jailb3f.bin",  0x0c000, 0x4000, 0xe933086f );
		ROM_REGION( 0x0240, REGION_PROMS );	ROM_LOAD( "jailbbl.cl2",  0x0000, 0x0020, 0xf1909605 );/* red & green */
		...
		ROM_LOAD( "jailb8c.bin",  0x0000, 0x2000, 0xd91d15e3 );ROM_END(); }}; 
