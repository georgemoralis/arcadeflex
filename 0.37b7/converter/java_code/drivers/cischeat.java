...
public class cischeat
{
	...
	*/
	...
	public static ReadHandlerPtr sharedram1_r  = new ReadHandlerPtr() { public int handler(int offset)			{return READ_WORD(&sharedram1[offset]);	} };
	public static ReadHandlerPtr sharedram2_r  = new ReadHandlerPtr() { public int handler(int offset)			{return READ_WORD(&sharedram2[offset]);	} };
	
	public static WriteHandlerPtr sharedram1_w = new WriteHandlerPtr() {public void handler(int offset, int data) {WRITE_WORD(&sharedram1[offset],data);	} };
	public static WriteHandlerPtr sharedram2_w = new WriteHandlerPtr() {public void handler(int offset, int data) {WRITE_WORD(&sharedram2[offset],data);	} };
	
	public static ReadHandlerPtr rom_1_r  = new ReadHandlerPtr() { public int handler(int offset) {return READ_WORD(&rom_1[offset]);} };
	public static ReadHandlerPtr rom_2_r  = new ReadHandlerPtr() { public int handler(int offset) {return READ_WORD(&rom_2[offset]);} };
	public static ReadHandlerPtr rom_3_r  = new ReadHandlerPtr() { public int handler(int offset) {return READ_WORD(&rom_3[offset]);} };
	...
	**************************************************************************/
	...
	public static WriteHandlerPtr cischeat_soundbank_##_n_##_w = new WriteHandlerPtr() {public void handler(int offset, int data) \
	{ \
	...
	**************************************************************************/
	...
	static InputPortPtr input_ports_cischeat = new InputPortPtr(){ public void handler() { 
		...
		PORT_BIT(  0x01, IP_ACTIVE_LOW, IPT_COIN1   );	PORT_BIT(  0x02, IP_ACTIVE_LOW, IPT_COIN2   );	PORT_BIT(  0x04, IP_ACTIVE_LOW, IPT_COIN3   );// operator's facility
		PORT_BITX( 0x08, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE ) 	// called "Test"
		PORT_BIT(  0x10, IP_ACTIVE_LOW, IPT_START1  );	PORT_BIT(  0x20, IP_ACTIVE_LOW, IPT_START2  );	PORT_BIT(  0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
	...
	//	PORT_BIT(  0x02, IP_ACTIVE_LOW, IPT_BUTTON4 );// Shift - We handle it using buttons 3&4
		PORT_BIT(  0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );// Accel
		PORT_BIT(  0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x80, IP_ACTIVE_LOW, IPT_BUTTON5 );// Horn
		...
		PORT_DIPNAME( 0x02, 0x02, "Down Limit SW"	);	PORT_DIPSETTING(    0x02, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") ); )
		PORT_BIT(  0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x10, 0x10, "Right Limit SW"	);	PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") ); )
		PORT_DIPNAME( 0x20, 0x20, "Left Limit SW"	);	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") ); )
		...
		PORT_DIPSETTING(      0x0000, "Easy"    );	PORT_DIPSETTING(      0x0c00, "Normal"  );	PORT_DIPSETTING(      0x0800, "Hard"    );	PORT_DIPSETTING(      0x0400, "Hardest" );	PORT_BITX(    0x1000, 0x1000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Infinite Time", IP_KEY_NONE, IP_JOY_NONE );// . !f0028
		PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") ); )
		PORT_DIPNAME( 0x2000, 0x2000, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x2000, DEF_STR( "On") ); )
		PORT_DIPNAME( 0x4000, 0x4000, "Country" );	PORT_DIPSETTING(      0x4000, "Japan" );	PORT_DIPSETTING(      0x0000, "USA"   );	PORT_DIPNAME( 0x8000, 0x8000, "Allow Continue" );	// . !f00c0
		PORT_DIPSETTING(      0x8000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") ); )
	
	
		PORT_START(); 	// IN5 - DSW 3 (4 bits, Cabinet Linking) - $82200.w
		PORT_BIT(  0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_DIPNAME( 0x06, 0x06, "Unit ID (2); )	// . f0020 (like DSW2 !!)
		PORT_DIPSETTING(    0x06, "Use other"      );	PORT_DIPSETTING(    0x00, "0 (Red Car);    )
		PORT_DIPSETTING(    0x02, "1 (Blue Car);   )
		PORT_DIPSETTING(    0x04, "2 (Yellow Car); )
		PORT_BIT(  0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
	...
	**************************************************************************/
	...
	/*	[Country]
		...
		PORT_DIPSETTING(      0x0300, "Japan"   );	PORT_DIPSETTING(      0x0200, "USA"     );	PORT_DIPSETTING(      0x0100, "UK"      );	PORT_DIPSETTING(      0x0000, "France"  );	PORT_DIPNAME( 0x0c00, 0x0c00, DEF_STR( "Difficulty") );	// . !f9026
		...
		PORT_BITX(    0x1000, 0x1000, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Infinite Time", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(      0x1000, DEF_STR( "Off") );
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") ); )
		...
		PORT_DIPNAME( 0x8000, 0x8000, "Vibrations" );	PORT_DIPSETTING(      0x8000, "High?" );	PORT_DIPSETTING(      0x0000, "Low?"  );
	
		PORT_START(); 	// IN2 - Controls - $80004.w . !f9016
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_COIN1   );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_COIN2   );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_COIN3   );// operator's facility
		PORT_BITX( 0x0008, IP_ACTIVE_LOW, IPT_SERVICE, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE ) 	// . f0100 (called "Test")
		PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_START1  );//	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_BUTTON4 );// Shift . !f900e - We handle it with 2 buttons
		...
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0008, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0010, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0020, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0040, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0080, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0100, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0200, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0400, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x0800, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x1000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x2000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x4000, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT(  0x8000, IP_ACTIVE_LOW, IPT_UNKNOWN );
	/*	DSW3-2&1 (Country: JP)	Effect
		...
		PORT_DIPNAME( 0x01, 0x01, "This Unit Is" );	PORT_DIPSETTING(    0x01, "Slave" );	PORT_DIPSETTING(    0x00, "Master" );	PORT_DIPNAME( 0x06, 0x06, "Unit ID" );		// . !f901c
	...
	**************************************************************************/
	...
	\
	static YM2151interface _shortname_##_ym2151_interface = new YM2151interface\
	( \
		1, \
		_fm_clock_, \
	...
	\
	static OKIM6295interface _shortname_##_okim6295_interface = new OKIM6295interface\
	( \
		2, \
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_cischeat = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x080000, REGION_CPU1 );	ROM_LOAD_EVEN( "ch9071v2.03", 0x000000, 0x040000, 0xdd1bb26f );	ROM_LOAD_ODD(  "ch9071v2.01", 0x000000, 0x040000, 0x7b65276a );
		ROM_REGION( 0x80000, REGION_CPU2 );	ROM_LOAD_EVEN( "ch9073.01",  0x000000, 0x040000, 0xba331526 );	ROM_LOAD_ODD(  "ch9073.02",  0x000000, 0x040000, 0xb45ff10f );
		ROM_REGION( 0x80000, REGION_CPU3 );	ROM_LOAD_EVEN( "ch9073v1.03", 0x000000, 0x040000, 0xbf1d1cbf );	ROM_LOAD_ODD(  "ch9073v1.04", 0x000000, 0x040000, 0x1ec8a597 );
		ROM_REGION( 0x40000, REGION_CPU4 );	ROM_LOAD_EVEN( "ch9071.11", 0x000000, 0x020000, 0xbc137bea );	ROM_LOAD_ODD(  "ch9071.10", 0x000000, 0x020000, 0xbf7b634d );
		ROM_REGION( 0x100000, REGION_USER1 );/* second halves of program ROMs */
		ROM_LOAD_EVEN( "ch9071.04",   0x000000, 0x040000, 0x7fb48cbc );// cpu #1
		ROM_LOAD_ODD(  "ch9071.02",   0x000000, 0x040000, 0xa5d0f4dc );	// cpu #2 (0x40000 bytes will be copied here)
		// cpu #3 (0x40000 bytes will be copied here)
	
		ROM_REGION( 0x040000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ch9071.a14",  0x000000, 0x040000, 0x7a6d147f );// scroll 0
	
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ch9071.t74",  0x000000, 0x040000, 0x735a2e25 );// scroll 1
	
		ROM_REGION( 0x010000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ch9071.07",   0x000000, 0x010000, 0x3724ccc3 );// scroll 2
	
		ROM_REGION( 0x100000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ch9073.r21",  0x000000, 0x080000, 0x2943d2f6 );// Road
	...
	//	ROM_LOAD( "ch9072.02",  0x000000, 0x080000, 0x536edde4 );//	ROM_LOAD( "ch9072.03",  0x000000, 0x080000, 0x7e79151a );ROM_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_f1gpstar = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1 );	ROM_LOAD_EVEN( "9188a-27.v20", 0x000000, 0x040000, 0x0a9d3896 );	ROM_LOAD_ODD(  "9188a-22.v20", 0x000000, 0x040000, 0xde15c9ca );
		ROM_REGION( 0x80000, REGION_CPU2 );	/* Should Use ROMs:	90015-01.W06, 90015-02.W07, 90015-03.W08, 90015-04.W09 */
		ROM_LOAD_EVEN( "9188a-16.v10",  0x000000, 0x020000, 0xef0f7ca9 );	ROM_LOAD_ODD(  "9188a-11.v10",  0x000000, 0x020000, 0xde292ea3 );
		ROM_REGION( 0x80000, REGION_CPU3 );	/* Should Use ROMs:	90015-01.W06, 90015-02.W07, 90015-03.W08, 90015-04.W09 */
		ROM_LOAD_EVEN( "9188a-6.v10",  0x000000, 0x020000, 0x18ba0340 );	ROM_LOAD_ODD(  "9188a-1.v10",  0x000000, 0x020000, 0x109d2913 );
		ROM_REGION( 0x40000, REGION_CPU4 );	ROM_LOAD_EVEN( "9190a-2.v11", 0x000000, 0x020000, 0xacb2fd80 );	ROM_LOAD_ODD(  "9190a-1.v11", 0x000000, 0x020000, 0x7cccadaf );
		...
		ROM_REGION( 0x080000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "90015-31.r56",  0x000000, 0x080000, 0x0c8f0e2b );// scroll 0
	
		ROM_REGION( 0x080000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "90015-32.r57",  0x000000, 0x080000, 0x9c921cfb );// scroll 1
	
		ROM_REGION( 0x020000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "9188a-30.v10",  0x000000, 0x020000, 0x0ef1fbf1 );// scroll 2
	
		ROM_REGION( 0x200000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "90015-05.w10",  0x000000, 0x080000, 0x8eb48a23 );// Road 0
		ROM_LOAD( "90015-06.w11",  0x080000, 0x080000, 0x32063a68 );	ROM_LOAD( "90015-07.w12",  0x100000, 0x080000, 0x0d0d54f3 );	ROM_LOAD( "90015-08.w14",  0x180000, 0x080000, 0xf48a42c5 );
		ROM_REGION( 0x100000, REGION_GFX5 | REGIONFLAG_DISPOSE );	ROM_LOAD( "90015-09.w13",  0x000000, 0x080000, 0x55f49315 );// Road 1
	...
	//	ROM_LOAD( "ch9072-6",  0x000000, 0x001000, 0x76ff63c5 );//	ROM_LOAD( "ch9072-8",  0x000000, 0x001000, 0xca04bace );// FIXED BITS (0xxx0xxx)
