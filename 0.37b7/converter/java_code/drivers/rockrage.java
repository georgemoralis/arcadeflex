...
public class rockrage
{
	...
	***************************************************************************/
	...
	//	PORT_DIPSETTING(    0x00, "Invalid" );
		...
		PORT_DIPSETTING(    0x08, "30k and every 70k" );	PORT_DIPSETTING(    0x00, "40k and every 80k" );	PORT_DIPNAME( 0x10, 0x10, "Freeze Screen" );	PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_START(); 	/* COINSW */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_COIN2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_COIN3 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_START2 );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* PLAYER 2 INPUTS */
		PORT_BIT( 0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x02, IP_ACTIVE_HIGH, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x04, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_HIGH, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_HIGH, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_HIGH, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_HIGH, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_HIGH, IPT_UNKNOWN );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rockrage = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x040000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "620k06.15g",	0x000000, 0x20000, BADCRC( 0xc0e2b35c ));	/* tiles */
		ROM_LOAD( "620k05.16g",	0x020000, 0x20000, BADCRC( 0xca9d9346 ));
	
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "rr-k11.rom",	0x000000, 0x20000, 0x70449239 );/* sprites */
		ROM_LOAD( "rr-l10.rom",	0x020000, 0x20000, 0x06d108e0 );
		ROM_REGION( 0x0300, REGION_PROMS );	ROM_LOAD( "620k09.11g", 0x00000, 0x00100, 0x9f0e0608 );/* layer 0 lookup table */
		...
		ROM_LOAD( "620k04.6e", 0x00000, 0x08000, 0x8be969f3 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_rockragj = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION(  0x10000 , REGION_CPU2 );/* 64k for the sound CPU */
		ROM_LOAD( "620k03.11c", 0x08000, 0x08000, 0x9fbefe82 );
		ROM_REGION( 0x040000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "620k06.15g",	0x000000, 0x20000, 0xc0e2b35c );/* tiles */
		ROM_LOAD( "620k05.16g",	0x020000, 0x20000, 0xca9d9346 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "620k11.7g",	0x000000, 0x20000, 0x7430f6e9 );/* sprites */
