...
public class junofrst
{
	...
	PORT_START();       /* DSW2 */
		...
		PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x02, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "256", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Cabinet") );
		...
		PORT_DIPSETTING(    0x60, "2" );	PORT_DIPSETTING(    0x50, "3" );	PORT_DIPSETTING(    0x40, "4" );	PORT_DIPSETTING(    0x30, "5" );	PORT_DIPSETTING(    0x20, "6" );	PORT_DIPSETTING(    0x10, "7" );	PORT_DIPSETTING(    0x00, "8 (Hardest); )
		...
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_COCKTAIL );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START();       /* DSW1 */
		...
		PORT_DIPSETTING(    0x00, "Disabled" );/* 0x00 not remmed out since the game makes the usual sound if you insert the coin */
	INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_junofrst = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "jfb_b10.bin",  0x0c000, 0x2000, 0xf20626e0 );	ROM_LOAD( "jfc_a10.bin",  0x0e000, 0x2000, 0x1e7744a7 );
		ROM_LOAD( "jfc1_a4.bin",  0x10000, 0x2000, 0x03ccbf1d );/* graphic and code ROMs (banked) */
		ROM_LOAD( "jfc2_a5.bin",  0x12000, 0x2000, 0xcb372372 );	ROM_LOAD( "jfc3_a6.bin",  0x14000, 0x2000, 0x879d194b );	ROM_LOAD( "jfc4_a7.bin",  0x16000, 0x2000, 0xf28af80b );	ROM_LOAD( "jfc5_a8.bin",  0x18000, 0x2000, 0x0539f328 );	ROM_LOAD( "jfc6_a9.bin",  0x1a000, 0x2000, 0x1da2ad6e );
		...
		ROM_LOAD( "jfs3_c7.bin",  0x00000, 0x2000, 0xaeacf6db );	ROM_LOAD( "jfs4_d7.bin",  0x02000, 0x2000, 0x206d954c );	ROM_LOAD( "jfs5_e7.bin",  0x04000, 0x2000, 0x1eb87a6e );ROM_END(); }}; 
	...
	static RomLoadPtr rom_junofstg = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "jfg_b.10b",    0x0c000, 0x2000, 0xcd645673 );	ROM_LOAD( "jfg_c.10a",    0x0e000, 0x2000, 0x47852761 );
		ROM_LOAD( "jfgc1.4a",     0x10000, 0x2000, 0x90a05ae6 );/* graphic and code ROMs (banked) */
		ROM_LOAD( "jfc2_a5.bin",  0x12000, 0x2000, 0xcb372372 );	ROM_LOAD( "jfc3_a6.bin",  0x14000, 0x2000, 0x879d194b );	ROM_LOAD( "jfgc4.7a",     0x16000, 0x2000, 0xe8864a43 );	ROM_LOAD( "jfc5_a8.bin",  0x18000, 0x2000, 0x0539f328 );	ROM_LOAD( "jfc6_a9.bin",  0x1a000, 0x2000, 0x1da2ad6e );
		ROM_REGION(  0x10000 , REGION_CPU2 );/* 64k for Z80 sound CPU code */
		ROM_LOAD( "jfs1_j3.bin",  0x0000, 0x1000, 0x235a2893 );
		ROM_REGION( 0x1000, REGION_CPU3 );/* 8039 */
		ROM_LOAD( "jfs2_p4.bin",  0x0000, 0x1000, 0xd0fa5d5f );
