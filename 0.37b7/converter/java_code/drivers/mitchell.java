...
public class mitchell
{
	...
	***************************************************************************/
	...
	PORT_START();       /* DSW */
		...
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );/* unused? */
		...
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P1 Kan", KEYCODE_LCONTROL, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P1 M", KEYCODE_M, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 I", KEYCODE_I, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P1 E", KEYCODE_E, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 A", KEYCODE_A, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P1 Reach", KEYCODE_LSHIFT, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P1 N", KEYCODE_N, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 J", KEYCODE_J, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P1 F", KEYCODE_F, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 B", KEYCODE_B, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P1 Ron", KEYCODE_Z, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P1 Chi", KEYCODE_SPACE, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 K", KEYCODE_K, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P1 G", KEYCODE_G, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 C", KEYCODE_C, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P1 Pon", KEYCODE_LALT, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 L", KEYCODE_L, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P1 H", KEYCODE_H, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 D", KEYCODE_D, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P1 Flip", KEYCODE_X, IP_JOY_NONE );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START2 );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P2 Kan", KEYCODE_LCONTROL, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2 M", KEYCODE_M, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 I", KEYCODE_I, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P2 E", KEYCODE_E, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 A", KEYCODE_A, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P2 Reach", KEYCODE_LSHIFT, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2 N", KEYCODE_N, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 J", KEYCODE_J, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P2 F", KEYCODE_F, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 B", KEYCODE_B, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P2 Ron", KEYCODE_Z, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2 Chi", KEYCODE_SPACE, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 K", KEYCODE_K, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P2 G", KEYCODE_G, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 C", KEYCODE_C, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2 Pon", KEYCODE_LALT, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 L", KEYCODE_L, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P2 H", KEYCODE_H, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 D", KEYCODE_D, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2 Flip", KEYCODE_X, IP_JOY_NONE );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* DSW1 */
		...
		PORT_DIPNAME( 0x08, 0x08, "Rules" );	PORT_DIPSETTING(    0x08, "Kantou" );	PORT_DIPSETTING(    0x00, "Kansai" );	PORT_DIPNAME( 0x10, 0x00, "Harness Type" );	PORT_DIPSETTING(    0x10, "Generic" );	PORT_DIPSETTING(    0x00, "Royal Mahjong" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
		...
		PORT_START(); 	/* DSW2 */
		PORT_DIPNAME( 0x03, 0x03, "Player 1 Skill" );	PORT_DIPSETTING(    0x03, "Weak" );	PORT_DIPSETTING(    0x02, "Normal" );	PORT_DIPSETTING(    0x01, "Strong" );	PORT_DIPSETTING(    0x00, "Very Strong" );	PORT_DIPNAME( 0x0c, 0x0c, "Player 1 Skill" );	PORT_DIPSETTING(    0x0c, "Weak" );	PORT_DIPSETTING(    0x08, "Normal" );	PORT_DIPSETTING(    0x04, "Strong" );	PORT_DIPSETTING(    0x00, "Very Strong" );	PORT_DIPNAME( 0x10, 0x00, "Music" );	PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x00, "Help Mode" );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	PORT_START();       /* DSW */
		...
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P1 Kan", KEYCODE_LCONTROL, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P1 M", KEYCODE_M, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 I", KEYCODE_I, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P1 E", KEYCODE_E, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 A", KEYCODE_A, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x08, IP_ACTIVE_LOW, 0, "P1 Reach", KEYCODE_LSHIFT, IP_JOY_NONE );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P1 N", KEYCODE_N, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 J", KEYCODE_J, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P1 F", KEYCODE_F, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 B", KEYCODE_B, IP_JOY_NONE );
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2 Pon", KEYCODE_LALT, IP_JOY_NONE );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 L", KEYCODE_L, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P2 H", KEYCODE_H, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 D", KEYCODE_D, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x10, IP_ACTIVE_LOW, 0, "P2 Flip", KEYCODE_X, IP_JOY_NONE );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	PORT_START();       /* DSW */
		...
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 Deal", KEYCODE_LCONTROL, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P1 E", KEYCODE_E, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 A", KEYCODE_A, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 Cancel", KEYCODE_LALT, IP_JOY_NONE );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 B", KEYCODE_B, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P1 Flip", KEYCODE_SPACE, IP_JOY_NONE );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 C", KEYCODE_C, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P1 D", KEYCODE_D, IP_JOY_NONE );
		PORT_START();       /* IN1 */
		...
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 Deal", KEYCODE_LCONTROL, IP_JOY_NONE );	PORT_BITX(0x40, IP_ACTIVE_LOW, 0, "P2 E", KEYCODE_E, IP_JOY_NONE );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 A", KEYCODE_A, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 Cancel", KEYCODE_LALT, IP_JOY_NONE );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 B", KEYCODE_B, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x20, IP_ACTIVE_LOW, 0, "P2 Flip", KEYCODE_SPACE, IP_JOY_NONE );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 C", KEYCODE_C, IP_JOY_NONE );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BITX(0x80, IP_ACTIVE_LOW, 0, "P2 D", KEYCODE_D, IP_JOY_NONE );
		PORT_START();       /* IN2 */
	...
	PORT_START();       /* DSW */
		...
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );   /* probably unused */
		PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );   /* probably unused */
		...
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2 );INPUT_PORTS_END(); }}; 
	...
	PORT_START();       /* DSW */
		...
		PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_SERVICE );/* same as the service mode farther down */
		PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON4 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );INPUT_PORTS_END(); }}; 
	...
	PORT_START();       /* DSW */
		...
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_COIN1 );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );/* dial direction */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 );
		PORT_START();       /* IN2 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );/* dial direction */
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );
		PORT_START();       /* DIAL1 */
		PORT_ANALOG( 0xff, 0x00, IPT_DIAL, 50, 20, 0, 0);
		PORT_START();       /* DIAL2 */
		PORT_ANALOG( 0xff, 0x00, IPT_DIAL | IPF_PLAYER2, 50, 20, 0, 0);INPUT_PORTS_END(); }}; 
	...
	static RomLoadPtr rom_mgakuen = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "mg-1.1j",      0x00000, 0x08000, 0xbf02ea6b );	ROM_LOAD( "mg-2.1l",      0x10000, 0x20000, 0x64141b0c );
		ROM_REGION( 0x200000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mg-1.13h",     0x000000, 0x80000, 0xfd6a0805 );/* chars */
		ROM_LOAD( "mg-2.14h",     0x080000, 0x80000, 0xe26e871e );	ROM_LOAD( "mg-3.16h",     0x100000, 0x80000, 0xdd781d9a );	ROM_LOAD( "mg-4.17h",     0x180000, 0x80000, 0x97afcc79 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mg-6.4l",      0x000000, 0x20000, 0x34594e62 );/* sprites */
	...
	static RomLoadPtr rom_mgakuen2 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "mg2-xf.1j",    0x00000, 0x08000, 0xc8165d2d );	ROM_LOAD( "mg2-y.1l",     0x10000, 0x20000, 0x75bbcc14 );	ROM_LOAD( "mg2-z.3l",     0x30000, 0x20000, 0xbfdba961 );
		ROM_REGION( 0x200000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mg2-a.13h",    0x000000, 0x80000, 0x31a0c55e );/* chars */
		ROM_LOAD( "mg2-b.14h",    0x080000, 0x80000, 0xc18488fa );	ROM_LOAD( "mg2-c.16h",    0x100000, 0x80000, 0x9425b364 );	ROM_LOAD( "mg2-d.17h",    0x180000, 0x80000, 0x6cc9eeba );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mg2-f.4l",     0x000000, 0x20000, 0x3172c9fe );/* sprites */
	...
	static RomLoadPtr rom_pkladies = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "pko-prg1.14f", 0x00000, 0x08000, 0x86585a94 );	ROM_LOAD( "pko-prg2.15f", 0x10000, 0x10000, 0x86cbe82d );
		ROM_REGION( 0x200000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD_GFX_EVEN( "pko-001.8h",   0x000000, 0x80000, 0x1ead5d9b )	/* chars */
		...
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pko-chr1.2j",  0x000000, 0x20000, 0x31ce33cd );/* sprites */
		ROM_LOAD( "pko-chr2.3j",  0x020000, 0x20000, 0xad7e055f );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "pko-voi1.2d",  0x00000, 0x20000, 0x07e0f531 );	ROM_LOAD( "pko-voi2.3d",  0x20000, 0x20000, 0x18398bf6 );ROM_END(); }}; 
	
	static RomLoadPtr rom_dokaben = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "db06.11h",     0x00000, 0x08000, 0x413e0886 );	ROM_LOAD( "db07.13h",     0x10000, 0x20000, 0x8bdcf49e );	ROM_LOAD( "db08.14h",     0x30000, 0x20000, 0x1643bdd9 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "db02.1e",      0x000000, 0x20000, 0x9aa8470c );/* chars */
		ROM_LOAD( "db03.2e",      0x020000, 0x20000, 0x3324e43d );	/* 40000-7ffff empty */
		ROM_LOAD( "db04.1g",      0x080000, 0x20000, 0xc0c5b6c2 );	ROM_LOAD( "db05.2g",      0x0a0000, 0x20000, 0xd2ab25f2 );	/* c0000-fffff empty */
	
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "db10.2k",      0x000000, 0x20000, 0x9e70f7ae );/* sprites */
		ROM_LOAD( "db09.1k",      0x020000, 0x20000, 0x2d9263f7 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "db01.1d",      0x00000, 0x20000, 0x62fa6b81 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_pang = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "pang6.bin",    0x00000, 0x08000, 0x68be52cd );	ROM_LOAD( "pang7.bin",    0x10000, 0x20000, 0x4a2e70f6 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pang_09.bin",  0x000000, 0x20000, 0x3a5883f5 );/* chars */
		ROM_LOAD( "bb3.bin",      0x020000, 0x20000, 0x79a8ed08 );	/* 40000-7ffff empty */
		ROM_LOAD( "pang_11.bin",  0x080000, 0x20000, 0x166a16ae );	ROM_LOAD( "bb5.bin",      0x0a0000, 0x20000, 0x2fb3db6c );	/* c0000-fffff empty */
	
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bb10.bin",     0x000000, 0x20000, 0xfdba4f6e );/* sprites */
		ROM_LOAD( "bb9.bin",      0x020000, 0x20000, 0x39f47a63 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "bb1.bin",      0x00000, 0x20000, 0xc52e5b8e );ROM_END(); }}; 
	...
	static RomLoadPtr rom_pangb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(             0x00000, 0x08000 );	ROM_LOAD( "pang_02.bin",  0x40000, 0x20000, 0x3f15bb61 );  /* Decrypted op codes */
	...
	static RomLoadPtr rom_bbros = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x30000, REGION_CPU1 );/* 192k for code + 192k for decrypted opcodes */
		ROM_LOAD( "bb6.bin",      0x00000, 0x08000, 0xa3041ca4 );	ROM_LOAD( "bb7.bin",      0x10000, 0x20000, 0x09231c68 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bb2.bin",      0x000000, 0x20000, 0x62f29992 );/* chars */
		ROM_LOAD( "bb3.bin",      0x020000, 0x20000, 0x79a8ed08 );	/* 40000-7ffff empty */
		ROM_LOAD( "bb4.bin",      0x080000, 0x20000, 0xf705aa89 );	ROM_LOAD( "bb5.bin",      0x0a0000, 0x20000, 0x2fb3db6c );	/* c0000-fffff empty */
	...
	static RomLoadPtr rom_pompingw = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x30000, REGION_CPU1 );/* 192k for code + 192k for decrypted opcodes */
		ROM_LOAD( "pwj_06.11h",   0x00000, 0x08000, 0x4a0a6426 );	ROM_LOAD( "pwj_07.13h",   0x10000, 0x20000, 0xa9402420 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pw_02.1e",     0x000000, 0x20000, 0x4b5992e4 );/* chars */
		ROM_LOAD( "bb3.bin",      0x020000, 0x20000, 0x79a8ed08 );	/* 40000-7ffff empty */
		ROM_LOAD( "pwj_04.1g",    0x080000, 0x20000, 0x01e49081 );	ROM_LOAD( "bb5.bin",      0x0a0000, 0x20000, 0x2fb3db6c );	/* c0000-fffff empty */
	...
	static RomLoadPtr rom_cworld = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "cw05.bin",     0x00000, 0x08000, 0xd3c1723d );	ROM_LOAD( "cw06.bin",     0x10000, 0x20000, 0xd71ed4a3 );	ROM_LOAD( "cw07.bin",     0x30000, 0x20000, 0xd419ce08 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cw08.bin",     0x000000, 0x20000, 0x6c80da3c );/* chars */
		ROM_LOAD( "cw09.bin",     0x020000, 0x20000, 0x7607da71 );	ROM_LOAD( "cw10.bin",     0x040000, 0x20000, 0x6f0e639f );	ROM_LOAD( "cw11.bin",     0x060000, 0x20000, 0x130bd7c0 );	ROM_LOAD( "cw18.bin",     0x080000, 0x20000, 0xbe6ee0c9 );	ROM_LOAD( "cw19.bin",     0x0a0000, 0x20000, 0x51fc5532 );	ROM_LOAD( "cw20.bin",     0x0c0000, 0x20000, 0x58381d58 );	ROM_LOAD( "cw21.bin",     0x0e0000, 0x20000, 0x910cc753 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cw16.bin",     0x000000, 0x20000, 0xf90217d1 );/* sprites */
		ROM_LOAD( "cw17.bin",     0x020000, 0x20000, 0xc953c702 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "cw01.bin",     0x00000, 0x20000, 0xf4368f5b );ROM_END(); }}; 
	
	static RomLoadPtr rom_hatena = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "q2-05.rom",    0x00000, 0x08000, 0x66c9e1da );	ROM_LOAD( "q2-06.rom",    0x10000, 0x20000, 0x5fc39916 );	ROM_LOAD( "q2-07.rom",    0x30000, 0x20000, 0xec6d5e5e );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "q2-08.rom",    0x000000, 0x20000, 0x6c80da3c );/* chars */
		ROM_LOAD( "q2-09.rom",    0x020000, 0x20000, 0xabe3e15c );	ROM_LOAD( "q2-10.rom",    0x040000, 0x20000, 0x6963450d );	ROM_LOAD( "q2-11.rom",    0x060000, 0x20000, 0x1e319fa2 );	ROM_LOAD( "q2-18.rom",    0x080000, 0x20000, 0xbe6ee0c9 );	ROM_LOAD( "q2-19.rom",    0x0a0000, 0x20000, 0x70300445 );	ROM_LOAD( "q2-20.rom",    0x0c0000, 0x20000, 0x21a6ff42 );	ROM_LOAD( "q2-21.rom",    0x0e0000, 0x20000, 0x076280c9 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "q2-16.rom",    0x000000, 0x20000, 0xec19b2f0 );/* sprites */
		ROM_LOAD( "q2-17.rom",    0x020000, 0x20000, 0xecd69d92 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "q2-01.rom",    0x00000, 0x20000, 0x149e7a89 );ROM_END(); }}; 
	
	static RomLoadPtr rom_spang = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "spe_06.rom",   0x00000, 0x08000, 0x1af106fb );	ROM_LOAD( "spe_07.rom",   0x10000, 0x20000, 0x208b5f54 );	ROM_LOAD( "spe_08.rom",   0x30000, 0x20000, 0x2bc03ade );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "spe_02.rom",   0x000000, 0x20000, 0x63c9dfd2 );/* chars */
		ROM_LOAD( "03.f2",        0x020000, 0x20000, 0x3ae28bc1 );	/* 40000-7ffff empty */
		ROM_LOAD( "spe_04.rom",   0x080000, 0x20000, 0x9d7b225b );	ROM_LOAD( "05.g2",        0x0a0000, 0x20000, 0x4a060884 );	/* c0000-fffff empty */
	
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "spe_10.rom",   0x000000, 0x20000, 0xeedd0ade );/* sprites */
		ROM_LOAD( "spe_09.rom",   0x020000, 0x20000, 0x04b41b75 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "spe_01.rom",   0x00000, 0x20000, 0x2d19c133 );ROM_END(); }}; 
	
	static RomLoadPtr rom_sbbros = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "06.j12",       0x00000, 0x08000, 0x292eee6a );	ROM_LOAD( "07.j13",       0x10000, 0x20000, 0xf46b698d );	ROM_LOAD( "08.j14",       0x30000, 0x20000, 0xa75e7fbe );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "02.f1",        0x000000, 0x20000, 0x0c22ffc6 );/* chars */
		ROM_LOAD( "03.f2",        0x020000, 0x20000, 0x3ae28bc1 );	/* 40000-7ffff empty */
		ROM_LOAD( "04.g2",        0x080000, 0x20000, 0xbb3dee5b );	ROM_LOAD( "05.g2",        0x0a0000, 0x20000, 0x4a060884 );	/* c0000-fffff empty */
	
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "10.l2",        0x000000, 0x20000, 0xd6675d8f );/* sprites */
		ROM_LOAD( "09.l1",        0x020000, 0x20000, 0x8f678bc8 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "01.d1",        0x00000, 0x20000, 0xb96ea126 );ROM_END(); }}; 
	
	static RomLoadPtr rom_marukin = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x30000, REGION_CPU1 );/* 192k for code + 192k for decrypted opcodes */
		ROM_LOAD( "mg3-01.9d",    0x00000, 0x08000, 0x04357973 );	ROM_LOAD( "mg3-02.10d",   0x10000, 0x20000, 0x50d08da0 );
		ROM_REGION( 0x200000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mg3-a.3k",     0x000000, 0x80000, 0x420f1de7 );/* chars */
		ROM_LOAD( "mg3-b.4k",     0x080000, 0x80000, 0xd8de13fa );	ROM_LOAD( "mg3-c.6k",     0x100000, 0x80000, 0xfbeb66e8 );	ROM_LOAD( "mg3-d.7k",     0x180000, 0x80000, 0x8f6bd831 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "mg3-05.2g",    0x000000, 0x20000, 0x7a738d2d );/* sprites */
	...
	static RomLoadPtr rom_qtono1 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "q3-05.rom",    0x00000, 0x08000, 0x1dd0a344 );	ROM_LOAD( "q3-06.rom",    0x10000, 0x20000, 0xbd6a2110 );	ROM_LOAD( "q3-07.rom",    0x30000, 0x20000, 0x61e53c4f );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "q3-08.rom",    0x000000, 0x20000, 0x1533b978 );/* chars */
		ROM_LOAD( "q3-09.rom",    0x020000, 0x20000, 0xa32db2f2 );	ROM_LOAD( "q3-10.rom",    0x040000, 0x20000, 0xed681aa8 );	ROM_LOAD( "q3-11.rom",    0x060000, 0x20000, 0x38b2fd10 );	ROM_LOAD( "q3-18.rom",    0x080000, 0x20000, 0x9e4292ac );	ROM_LOAD( "q3-19.rom",    0x0a0000, 0x20000, 0xb7f6d40f );	ROM_LOAD( "q3-20.rom",    0x0c0000, 0x20000, 0x6cd7f38d );	ROM_LOAD( "q3-21.rom",    0x0e0000, 0x20000, 0xb4aa6b4b );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "q3-16.rom",    0x000000, 0x20000, 0x863d6836 );/* sprites */
		ROM_LOAD( "q3-17.rom",    0x020000, 0x20000, 0x459bf59c );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "q3-01.rom",    0x00000, 0x20000, 0x6c1be591 );ROM_END(); }}; 
	
	static RomLoadPtr rom_qsangoku = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "q4-05c.rom",   0x00000, 0x08000, 0xe1d010b4 );	ROM_LOAD( "q4-06.rom",    0x10000, 0x20000, 0xa0301849 );	ROM_LOAD( "q4-07.rom",    0x30000, 0x20000, 0x2941ef5b );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "q4-08.rom",    0x000000, 0x20000, 0xdc84c6cb );/* chars */
		ROM_LOAD( "q4-09.rom",    0x020000, 0x20000, 0xcbb6234c );	ROM_LOAD( "q4-10.rom",    0x040000, 0x20000, 0xc20a27a8 );	ROM_LOAD( "q4-11.rom",    0x060000, 0x20000, 0x4ff66aed );	ROM_LOAD( "q4-18.rom",    0x080000, 0x20000, 0xca3acea5 );	ROM_LOAD( "q4-19.rom",    0x0a0000, 0x20000, 0x1fd92b7d );	ROM_LOAD( "q4-20.rom",    0x0c0000, 0x20000, 0xb02dc6a1 );	ROM_LOAD( "q4-21.rom",    0x0e0000, 0x20000, 0x432b1dc1 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "q4-16.rom",    0x000000, 0x20000, 0x77342320 );/* sprites */
		ROM_LOAD( "q4-17.rom",    0x020000, 0x20000, 0x1275c436 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "q4-01.rom",    0x00000, 0x20000, 0x5d0d07d8 );ROM_END(); }}; 
	
	static RomLoadPtr rom_block = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "ble_05.rom",   0x00000, 0x08000, 0xc12e7f4c );	ROM_LOAD( "ble_06.rom",   0x10000, 0x20000, 0xcdb13d55 );	ROM_LOAD( "ble_07.rom",   0x30000, 0x20000, 0x1d114f13 );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bl_08.rom",    0x000000, 0x20000, 0xaa0f4ff1 );/* chars */
		ROM_RELOAD(               0x040000, 0x20000 );	ROM_LOAD( "bl_09.rom",    0x020000, 0x20000, 0x6fa8c186 );	ROM_RELOAD(               0x060000, 0x20000 );	ROM_LOAD( "bl_18.rom",    0x080000, 0x20000, 0xc0acafaf );	ROM_RELOAD(               0x0c0000, 0x20000 );	ROM_LOAD( "bl_19.rom",    0x0a0000, 0x20000, 0x1ae942f5 );	ROM_RELOAD(               0x0e0000, 0x20000 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bl_16.rom",    0x000000, 0x20000, 0xfadcaff7 );/* sprites */
		ROM_LOAD( "bl_17.rom",    0x020000, 0x20000, 0x5f8cab42 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "bl_01.rom",    0x00000, 0x20000, 0xc2ec2abb );ROM_END(); }}; 
	
	static RomLoadPtr rom_blockj = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 2*0x50000, REGION_CPU1 );/* 320k for code + 320k for decrypted opcodes */
		ROM_LOAD( "blj_05.rom",   0x00000, 0x08000, 0x3b55969a );	ROM_LOAD( "ble_06.rom",   0x10000, 0x20000, 0xcdb13d55 );	ROM_LOAD( "blj_07.rom",   0x30000, 0x20000, 0x1723883c );
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bl_08.rom",    0x000000, 0x20000, 0xaa0f4ff1 );/* chars */
		ROM_RELOAD(               0x040000, 0x20000 );	ROM_LOAD( "bl_09.rom",    0x020000, 0x20000, 0x6fa8c186 );	ROM_RELOAD(               0x060000, 0x20000 );	ROM_LOAD( "bl_18.rom",    0x080000, 0x20000, 0xc0acafaf );	ROM_RELOAD(               0x0c0000, 0x20000 );	ROM_LOAD( "bl_19.rom",    0x0a0000, 0x20000, 0x1ae942f5 );	ROM_RELOAD(               0x0e0000, 0x20000 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bl_16.rom",    0x000000, 0x20000, 0xfadcaff7 );/* sprites */
		ROM_LOAD( "bl_17.rom",    0x020000, 0x20000, 0x5f8cab42 );
	...
	static RomLoadPtr rom_blockbl = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_CONTINUE(             0x00000, 0x08000 );	ROM_LOAD( "m5.l3",        0x60000, 0x20000, 0x7c988bb7 );  /* Decrypted opcode + data */
		ROM_CONTINUE(             0x10000, 0x20000 );	ROM_LOAD( "m6.l5",        0x30000, 0x20000, 0x5768d8eb );  /* Decrypted data */
	
		ROM_REGION( 0x100000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "m12.o10",      0x000000, 0x20000, 0x963154d9 );/* chars */
		ROM_RELOAD(               0x040000, 0x20000 );	ROM_LOAD( "m13.o14",      0x020000, 0x20000, 0x069480bb );	ROM_RELOAD(               0x060000, 0x20000 );	ROM_LOAD( "m4.j17",       0x080000, 0x20000, 0x9e3b6f4f );	ROM_RELOAD(               0x0c0000, 0x20000 );	ROM_LOAD( "m3.j20",       0x0a0000, 0x20000, 0x629d58fe );	ROM_RELOAD(               0x0e0000, 0x20000 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "m11.o7",       0x000000, 0x10000, 0x255180a5 );/* sprites */
		ROM_LOAD( "m10.o5",       0x010000, 0x10000, 0x3201c088 );	ROM_LOAD( "m9.o3",        0x020000, 0x10000, 0x29357fe4 );	ROM_LOAD( "m8.o2",        0x030000, 0x10000, 0xabd665d1 );
		ROM_REGION( 0x80000, REGION_SOUND1 );/* OKIM */
		ROM_LOAD( "bl_01.rom",    0x00000, 0x20000, 0xc2ec2abb );ROM_END(); }}; 
