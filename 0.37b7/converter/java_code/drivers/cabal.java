...
public class cabal
{
	...
	extern 
	static public static InitMachinePtr cabal_init_machine = new InitMachinePtr() { public void handler()  {
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0xf0, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN2 */
		PORT_BIT( 0x0f, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2);	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON3 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_START1 );
		PORT_START(); 	/* IN3 */
		...
		PORT_DIPSETTING(    0x0b, "3 Coins/1 Credit 5/2" );	PORT_DIPSETTING(    0x0c, DEF_STR( "2C_1C") );
		PORT_DIPSETTING(    0x0d, "2 Coins/1 Credit 3/2" );	PORT_DIPSETTING(    0x01, DEF_STR( "4C_3C") );
		PORT_DIPSETTING(    0x0e, DEF_STR( "1C_1C") );
		PORT_DIPSETTING(    0x03, "2 Coins/2 Credits 3/4" );	PORT_DIPSETTING(    0x02, DEF_STR( "3C_3C") );
		PORT_DIPSETTING(    0x0f, DEF_STR( "1C_2C") );
		PORT_DIPSETTING(    0x04, DEF_STR( "1C_3C") );
		PORT_DIPSETTING(    0x09, DEF_STR( "1C_4C") );
		PORT_DIPSETTING(    0x08, DEF_STR( "1C_6C") );
		PORT_DIPSETTING(    0x07, DEF_STR( "1C_8C") );
		PORT_DIPSETTING(    0x06, "1 Coin/10 Credits" );	PORT_DIPSETTING(    0x05, "1 Coin/12 Credits" );	PORT_DIPSETTING(    0x00, "Free 99 Credits" );/* 0x10 is different from the Free 99 Credits.
	   ...
	   while they stay at 99 using the 0x10 dip. */
		...
		PORT_DIPNAME( 0x20, 0x20, "Invert Buttons" );	PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "Trackball" );	PORT_DIPSETTING(    0x80, "Small" );	PORT_DIPSETTING(    0x00, "Large" );
		PORT_START(); 	/* DIPSW2 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x02, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x01, "5" );	PORT_BITX( 0,       0x00, IPT_DIPSWITCH_SETTING | IPF_CHEAT, "Infinite", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x0c, "20k 50k" );	PORT_DIPSETTING(    0x08, "30k 100k" );	PORT_DIPSETTING(    0x04, "50k 150k" );	PORT_DIPSETTING(    0x00, "70K" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x30, "Easy" );	PORT_DIPSETTING(    0x20, "Normal" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPSETTING(    0x00, "Very Hard" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	...
	static RomLoadPtr rom_cabal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "h7_512.bin",      0x00000, 0x10000, 0x8fe16fb4 );	ROM_LOAD_ODD ( "h6_512.bin",      0x00000, 0x10000, 0x6968101c );	ROM_LOAD_EVEN( "k7_512.bin",      0x20000, 0x10000, 0x562031a2 );	ROM_LOAD_ODD ( "k6_512.bin",      0x20000, 0x10000, 0x4fda2856 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for sound cpu code */
		ROM_LOAD( "4-3n",           0x0000, 0x2000, 0x4038eff2 );	ROM_LOAD( "3-3p",           0x8000, 0x8000, 0xd9defcbf );
		ROM_REGION( 0x4000,  REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "t6_128.bin",     0x00000, 0x04000, 0x1ccee214 );/* characters */
	
		/* the gfx ROMs were missing in this set, I'm using the ones from */
		/* the bootleg */
		ROM_REGION( 0x80000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cabal_17.bin",   0x00000, 0x10000, 0x3b6d2b09 );/* tiles, planes0,1 */
		ROM_LOAD( "cabal_16.bin",   0x10000, 0x10000, 0x77bc7a60 );	ROM_LOAD( "cabal_18.bin",   0x20000, 0x10000, 0x0bc50075 );	ROM_LOAD( "cabal_19.bin",   0x30000, 0x10000, 0x67e4fe47 );	ROM_LOAD( "cabal_15.bin",   0x40000, 0x10000, 0x1023319b );/* tiles, planes2,3 */
		ROM_LOAD( "cabal_14.bin",   0x50000, 0x10000, 0x420b0801 );	ROM_LOAD( "cabal_12.bin",   0x60000, 0x10000, 0x543fcb37 );	ROM_LOAD( "cabal_13.bin",   0x70000, 0x10000, 0xd28d921e );
		ROM_REGION( 0x80000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cabal_05.bin",   0x00000, 0x10000, 0x4e49c28e );/* sprites, planes0,1 */
		ROM_LOAD( "cabal_06.bin",   0x10000, 0x10000, 0x6a0e739d );	ROM_LOAD( "cabal_07.bin",   0x20000, 0x10000, 0x581a50c1 );	ROM_LOAD( "cabal_08.bin",   0x30000, 0x10000, 0x702735c9 );	ROM_LOAD( "cabal_04.bin",   0x40000, 0x10000, 0x34d3cac8 );/* sprites, planes2,3 */
		ROM_LOAD( "cabal_03.bin",   0x50000, 0x10000, 0x7065e840 );	ROM_LOAD( "cabal_02.bin",   0x60000, 0x10000, 0x0e1ec30e );	ROM_LOAD( "cabal_01.bin",   0x70000, 0x10000, 0x55c44764 );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* Samples? */
		ROM_LOAD( "2-1s",           0x00000, 0x10000, 0x850406b4 );	ROM_LOAD( "1-1u",           0x10000, 0x10000, 0x8b3e0789 );ROM_END(); }}; 
	
	static RomLoadPtr rom_cabal2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x50000, REGION_CPU1 );/* 64k for cpu code */
		ROM_LOAD_EVEN( "9-7h",            0x00000, 0x10000, 0xebbb9484 );	ROM_LOAD_ODD ( "7-6h",            0x00000, 0x10000, 0x51aeb49e );	ROM_LOAD_EVEN( "8-7k",            0x20000, 0x10000, 0x4c24ed9a );	ROM_LOAD_ODD ( "6-6k",            0x20000, 0x10000, 0x681620e8 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for sound cpu code */
		ROM_LOAD( "4-3n",           0x0000, 0x2000, 0x4038eff2 );	ROM_LOAD( "3-3p",           0x8000, 0x8000, 0xd9defcbf );
		ROM_REGION( 0x4000,  REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "5-6s",           0x00000, 0x04000, 0x6a76955a );/* characters */
	...
	static RomLoadPtr rom_cabalbl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x50000, REGION_CPU1 );/* 64k for cpu code */
		ROM_LOAD_EVEN( "cabal_24.bin",    0x00000, 0x10000, 0x00abbe0c );	ROM_LOAD_ODD ( "cabal_22.bin",    0x00000, 0x10000, 0x78c4af27 );	ROM_LOAD_EVEN( "cabal_23.bin",    0x20000, 0x10000, 0xd763a47c );	ROM_LOAD_ODD ( "cabal_21.bin",    0x20000, 0x10000, 0x96d5e8af );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for sound cpu code */
		...
		ROM_LOAD( "cabal_06.bin",   0x10000, 0x10000, 0x6a0e739d );	ROM_LOAD( "cabal_07.bin",   0x20000, 0x10000, 0x581a50c1 );	ROM_LOAD( "cabal_08.bin",   0x30000, 0x10000, 0x702735c9 );	ROM_LOAD( "cabal_04.bin",   0x40000, 0x10000, 0x34d3cac8 );/* sprites, planes2,3 */
		ROM_LOAD( "cabal_03.bin",   0x50000, 0x10000, 0x7065e840 );	ROM_LOAD( "cabal_02.bin",   0x60000, 0x10000, 0x0e1ec30e );	ROM_LOAD( "cabal_01.bin",   0x70000, 0x10000, 0x55c44764 );
		ROM_REGION( 0x20000, REGION_SOUND1 );	ROM_LOAD( "cabal_09.bin",   0x00000, 0x10000, 0x4ffa7fe3 );/* Z80 code/adpcm data */
