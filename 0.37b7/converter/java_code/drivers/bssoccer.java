...
public class bssoccer
{
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_bssoccer = new InputPortPtr(){ public void handler() { 
		...
		PORT_DIPSETTING(      0x0010, "Easy"     );	PORT_DIPSETTING(      0x0018, "Normal"   );	PORT_DIPSETTING(      0x0008, "Hard"     );	PORT_DIPSETTING(      0x0000, "Hardest?" );	PORT_DIPNAME( 0x0020, 0x0020, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPNAME( 0x0300, 0x0300, "Play Time P1" );	PORT_DIPSETTING(      0x0300, "1:30" );	PORT_DIPSETTING(      0x0200, "1:45" );	PORT_DIPSETTING(      0x0100, "2:00" );	PORT_DIPSETTING(      0x0000, "2:15" );	PORT_DIPNAME( 0x0c00, 0x0c00, "Play Time P2" );	PORT_DIPSETTING(      0x0c00, "1:30" );	PORT_DIPSETTING(      0x0800, "1:45" );	PORT_DIPSETTING(      0x0400, "2:00" );	PORT_DIPSETTING(      0x0000, "2:15" );	PORT_DIPNAME( 0x3000, 0x3000, "Play Time P3" );	PORT_DIPSETTING(      0x3000, "1:30" );	PORT_DIPSETTING(      0x2000, "1:45" );	PORT_DIPSETTING(      0x1000, "2:00" );	PORT_DIPSETTING(      0x0000, "2:15" );	PORT_DIPNAME( 0xc000, 0xc000, "Play Time P4" );	PORT_DIPSETTING(      0xc000, "1:30" );	PORT_DIPSETTING(      0x8000, "1:45" );	PORT_DIPSETTING(      0x4000, "2:00" );	PORT_DIPSETTING(      0x0000, "2:15" );
		PORT_START(); 	// IN5 - Coins
		PORT_DIPNAME( 0x0001, 0x0001, "Copyright" );		// these 4 are shown in test mode
		PORT_DIPSETTING(      0x0001, "Distributer Unico" );	PORT_DIPSETTING(      0x0000, "All Rights Reserved" );	PORT_DIPNAME( 0x0002, 0x0002, DEF_STR( "Unknown") );	// used!
		...
		PORT_DIPSETTING(      0x0000, DEF_STR( "On") );
		PORT_BIT(  0x0010, IP_ACTIVE_LOW,  IPT_COIN1   );	PORT_BIT(  0x0020, IP_ACTIVE_LOW,  IPT_COIN2   );	PORT_BIT(  0x0040, IP_ACTIVE_LOW,  IPT_COIN3   );	PORT_BIT(  0x0080, IP_ACTIVE_LOW,  IPT_COIN4   );
	INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	(
		...
		new WriteHandlerPtr[] { 0 }		/* port write handler */
	);
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bssoccer = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "02", 0x000000, 0x080000, 0x32871005 );	ROM_LOAD_ODD(  "01", 0x000000, 0x080000, 0xace00db6 );	ROM_LOAD_EVEN( "04", 0x100000, 0x080000, 0x25ee404d );	ROM_LOAD_ODD(  "03", 0x100000, 0x080000, 0x1a131014 );
		...
		ROM_LOAD( "05", 0x000000, 0x080000, 0xa5245bd4 );	ROM_LOAD( "07", 0x080000, 0x080000, 0xfdb765c2 );	ROM_LOAD( "09", 0x100000, 0x080000, 0x0e82277f );	ROM_LOAD( "06", 0x180000, 0x080000, 0xd42ce84b );	ROM_LOAD( "08", 0x200000, 0x080000, 0x96cd2136 );	ROM_LOAD( "10", 0x280000, 0x080000, 0x1ca94d21 );
	ROM_END(); }}; 
