...
public class psychic5
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_psychic5 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p5b",          0x00000, 0x10000, 0x7e3f87d4 );/* sprite tiles */
		ROM_LOAD( "p5c",          0x10000, 0x10000, 0x8710fedb );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p5g",          0x00000, 0x10000, 0xf9262f32 );/* background tiles */
		ROM_LOAD( "p5h",          0x10000, 0x10000, 0xc411171a );
		ROM_REGION( 0x08000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "p5f",          0x00000, 0x08000, 0x04d7e21c );/* foreground tiles */
	ROM_END(); }}; 
