...
public class thunderx
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_scontra = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "775a09.b19",   0x0000, 0x0100, 0x46d1e0df );/* priority encoder (not used) */
	ROM_END(); }}; 
	...
	static RomLoadPtr rom_thunderx = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x80000, REGION_GFX2 );	ROM_LOAD_GFX_EVEN( "873c04a.f11",  0x00000, 0x10000, 0xf7740bf3 ) /* Sprites */
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "873a08.f20",   0x0000, 0x0100, 0xe2d09a1b );/* priority encoder (not used) */
	ROM_END(); }}; 
	...
	public static GameDriver driver_thunderx	   = new GameDriver("1988"	,"thunderx"	,"thunderx.java"	,rom_thunderx,null	,machine_driver_thunderx	,input_ports_thunderx	,init_scontra	,ROT0	,	"Konami", "Thunder Cross", GAME_NOT_WORKING )
	public static GameDriver driver_thnderxj	   = new GameDriver("1988"	,"thnderxj"	,"thunderx.java"	,rom_thnderxj,driver_thunderx	,machine_driver_thunderx	,input_ports_thunderx	,init_scontra	,ROT0	,	"Konami", "Thunder Cross (Japan)", GAME_NOT_WORKING )
}
