...
public class sbasketb
{
	...
	extern UBytePtr sbasketb_scroll;
	extern UBytePtr sbasketb_palettebank;
	extern UBytePtr sbasketb_spriteram_select;
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x00, "Game Time" );	PORT_DIPSETTING(    0x03, "30" );	PORT_DIPSETTING(    0x01, "40" );	PORT_DIPSETTING(    0x02, "50" );	PORT_DIPSETTING(    0x00, "60" );	PORT_DIPNAME( 0x04, 0x00, DEF_STR( "Cabinet") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Upright") );
		PORT_DIPSETTING(    0x04, DEF_STR( "Cocktail") );
		PORT_DIPNAME( 0x08, 0x08, "Starting Score" );	PORT_DIPSETTING(    0x08, "70-78" );	PORT_DIPSETTING(    0x00, "100-115" );	PORT_DIPNAME( 0x10, 0x00, "Ranking" );	PORT_DIPSETTING(    0x00, "Data Remaining" );	PORT_DIPSETTING(    0x10, "Data Initialized" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
	...
	static VLM5030interface sbasketb_vlm5030_interface = new VLM5030interface
	(
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_sbasketb = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "sbb_j13.bin",  0x6000, 0x2000, 0x263ec36b );	ROM_LOAD( "sbb_j11.bin",  0x8000, 0x4000, 0x0a4d7a82 );	ROM_LOAD( "sbb_j09.bin",  0xc000, 0x4000, 0x4f9dd9a0 );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64k for audio cpu */
		ROM_LOAD( "sbb_e13.bin",  0x0000, 0x2000, 0x1ec7458b );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sbb_e12.bin",  0x0000, 0x4000, 0xe02c54da );
		ROM_REGION( 0x0c000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sbb_h06.bin",  0x0000, 0x4000, 0xcfbbff07 );	ROM_LOAD( "sbb_h08.bin",  0x4000, 0x4000, 0xc75901b6 );	ROM_LOAD( "sbb_h10.bin",  0x8000, 0x4000, 0x95bc5942 );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "405e17",       0x0000, 0x0100, 0xb4c36d57 );/* palette red component */
		...
		ROM_LOAD( "sbb_e15.bin",  0x0000, 0x2000, 0x01bb5ce9 );ROM_END(); }}; 
