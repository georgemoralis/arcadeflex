...
public class mcr3
{
	...
	public static WriteHandlerPtr maxrpm_mux_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		input_mux = (data >> 1) & 3;
	} };
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_START(); 	/* IN3 -- dipswitches */
		PORT_DIPNAME( 0x01, 0x01, "Coin Meters" );	PORT_DIPSETTING(    0x01, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_BIT( 0xfe, IP_ACTIVE_LOW, IPT_UNKNOWN );
		PORT_START(); 	/* IN4 */
		PORT_BIT( 0xff, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* AIN0 */
	...
	static InputPortPtr input_ports_destderb = new InputPortPtr(){ public void handler() { 
	PORT_START(); 	/* IN0 */
		...
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_ANALOG( 0xfc, 0x00, IPT_DIAL | IPF_REVERSE, 50, 10, 0, 0 );
	...
	static RomLoadPtr rom_dotron = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "loc-bg2.6f",   0x00000, 0x2000, 0x40167124 );	ROM_LOAD( "loc-bg1.5f",   0x02000, 0x2000, 0xbb2d7a5d );
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "loc-g.cp4",    0x00000, 0x2000, 0x57a2b1ff );	ROM_LOAD( "loc-h.cp3",    0x02000, 0x2000, 0x3bb4d475 );	ROM_LOAD( "loc-e.cp6",    0x04000, 0x2000, 0xce957f1a );	ROM_LOAD( "loc-f.cp5",    0x06000, 0x2000, 0xd26053ce );	ROM_LOAD( "loc-c.cp8",    0x08000, 0x2000, 0xef45d146 );	ROM_LOAD( "loc-d.cp7",    0x0a000, 0x2000, 0x5e8a3ef3 );	ROM_LOAD( "loc-a.cp0",    0x0c000, 0x2000, 0xb35f5374 );	ROM_LOAD( "loc-b.cp9",    0x0e000, 0x2000, 0x565a5c48 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_destderb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dd_bg0.6f",    0x00000, 0x2000, 0xcf80be19 );	ROM_LOAD( "dd_bg1.5f",    0x02000, 0x2000, 0x4e173e52 );
	...
	static RomLoadPtr rom_destderm = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "pro0.3b",      0x00000, 0x8000, 0x2e24527b );	ROM_LOAD( "pro1.5b",      0x08000, 0x8000, 0x034c00fc );
		ROM_REGION( 0x10000, REGION_CPU2 ); /* 64k for the Turbo Cheap Squeak */
		ROM_LOAD( "tcs_u5.bin",   0x0c000, 0x2000, 0xeca33b2c );	ROM_LOAD( "tcs_u4.bin",   0x0e000, 0x2000, 0x3490289a );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bg0.15a",      0x00000, 0x2000, 0xa35d13b8 );	ROM_LOAD( "bg1.14b",      0x02000, 0x2000, 0x22ca93f3 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dd_fg-0.a4",   0x00000, 0x4000, 0xe57a4de6 );	ROM_LOAD( "dd_fg-4.a3",   0x04000, 0x4000, 0x55aa667f );	ROM_LOAD( "dd_fg-1.a6",   0x08000, 0x4000, 0x70259651 );	ROM_LOAD( "dd_fg-5.a5",   0x0c000, 0x4000, 0x5fe99007 );	ROM_LOAD( "dd_fg-2.a8",   0x10000, 0x4000, 0x6cab7b95 );	ROM_LOAD( "dd_fg-6.a7",   0x14000, 0x4000, 0xabfb9a8b );	ROM_LOAD( "dd_fg-3.a10",  0x18000, 0x4000, 0x801d9b86 );	ROM_LOAD( "dd_fg-7.a9",   0x1c000, 0x4000, 0x0ec3f60a );ROM_END(); }}; 
	...
	static RomLoadPtr rom_sarge = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "til_15a.bin",  0x00000, 0x2000, 0x685001b8 );	ROM_LOAD( "til_14b.bin",  0x02000, 0x2000, 0x8449eb45 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "spr_8e.bin",   0x00000, 0x8000, 0x93fac29d );	ROM_LOAD( "spr_6e.bin",   0x08000, 0x8000, 0x7cc6fb28 );	ROM_LOAD( "spr_5e.bin",   0x10000, 0x8000, 0xc832375c );	ROM_LOAD( "spr_4e.bin",   0x18000, 0x8000, 0xc382267d );ROM_END(); }}; 
	...
	static RomLoadPtr rom_rampage = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_ODD ( "ramp_u17.snd", 0x00000, 0x8000, 0xe92c596b );	ROM_LOAD_EVEN( "ramp_u8.snd",  0x10000, 0x8000, 0x11f787e4 );	ROM_LOAD_ODD ( "ramp_u18.snd", 0x10000, 0x8000, 0x6b8bf5e1 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bg-0",         0x00000, 0x04000, 0xc0d8b7a5 );	ROM_LOAD( "bg-1",         0x04000, 0x04000, 0x2f6e3aa1 );
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "fg-0",         0x00000, 0x10000, 0x0974be5d );	ROM_LOAD( "fg-1",         0x10000, 0x10000, 0x8728532b );	ROM_LOAD( "fg-2",         0x20000, 0x10000, 0x9489f714 );	ROM_LOAD( "fg-3",         0x30000, 0x10000, 0x81e1de40 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_powerdrv = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x20000, REGION_CPU2 ); /* 128k for the Sounds Good board */
		ROM_LOAD_EVEN( "pdsndu7.bin",  0x00000, 0x8000, 0x78713e78 );	ROM_LOAD_ODD ( "pdsndu17.bin", 0x00000, 0x8000, 0xc41de6e4 );	ROM_LOAD_EVEN( "pdsndu8.bin",  0x10000, 0x8000, 0x15714036 );	ROM_LOAD_ODD ( "pdsndu18.bin", 0x10000, 0x8000, 0xcae14c70 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pdrv15a.bin",  0x00000, 0x04000, 0xb858b5a8 );	ROM_LOAD( "pdrv14b.bin",  0x04000, 0x04000, 0x12ee7fc2 );
		ROM_REGION( 0x40000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pdrv8e.bin",   0x00000, 0x10000, 0xdd3a2adc );	ROM_LOAD( "pdrv6e.bin",   0x10000, 0x10000, 0x1a1f7f81 );	ROM_LOAD( "pdrv5e.bin",   0x20000, 0x10000, 0x4cb4780e );	ROM_LOAD( "pdrv4e.bin",   0x30000, 0x10000, 0xde400335 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_maxrpm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "bg-0",         0x00000, 0x4000, 0xe3fb693a );	ROM_LOAD( "bg-1",         0x04000, 0x4000, 0x50d1db6c );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "fg-0",         0x00000, 0x8000, 0x1d1435c1 );	ROM_LOAD( "fg-1",         0x08000, 0x8000, 0xe54b7f2a );	ROM_LOAD( "fg-2",         0x10000, 0x8000, 0x38be8505 );	ROM_LOAD( "fg-3",         0x18000, 0x8000, 0x9ae3eb52 );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_spyhunt = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "cpu_pg0.6d",   0x0000, 0x2000, 0x1721b88f );	ROM_LOAD( "cpu_pg1.7d",   0x2000, 0x2000, 0x909d044f );	ROM_LOAD( "cpu_pg2.8d",   0x4000, 0x2000, 0xafeeb8bd );	ROM_LOAD( "cpu_pg3.9d",   0x6000, 0x2000, 0x5e744381 );	ROM_LOAD( "cpu_pg4.10d",  0x8000, 0x2000, 0xa3033c15 );	ROM_LOAD( "cpu_pg5.11d",  0xa000, 0x4000, 0x88aa1e99 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		...
		ROM_LOAD_EVEN( "csd_u7a.u7",   0x00000, 0x2000, 0x6e689fe7 );	ROM_LOAD_ODD ( "csd_u17b.u17", 0x00000, 0x2000, 0x0d9ddce6 );	ROM_LOAD_EVEN( "csd_u8c.u8",   0x04000, 0x2000, 0x35563cd0 );	ROM_LOAD_ODD ( "csd_u18d.u18", 0x04000, 0x2000, 0x63d3f5b1 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cpu_bg0.3a",   0x00000, 0x2000, 0xdea34fed );	ROM_LOAD( "cpu_bg1.4a",   0x02000, 0x2000, 0x8f64525f );	ROM_LOAD( "cpu_bg2.5a",   0x04000, 0x2000, 0xba0fd626 );	ROM_LOAD( "cpu_bg3.6a",   0x06000, 0x2000, 0x7b482d61 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "vid_0fg.a8",   0x00000, 0x4000, 0x292c5466 );	ROM_LOAD( "vid_1fg.a7",   0x04000, 0x4000, 0x9fe286ec );	ROM_LOAD( "vid_2fg.a6",   0x08000, 0x4000, 0x62c8bfa5 );	ROM_LOAD( "vid_3fg.a5",   0x0c000, 0x4000, 0xb894934d );	ROM_LOAD( "vid_4fg.a4",   0x10000, 0x4000, 0x7ca4941b );	ROM_LOAD( "vid_5fg.a3",   0x14000, 0x4000, 0x2d9fbcec );	ROM_LOAD( "vid_6fg.a2",   0x18000, 0x4000, 0x8cb8a066 );	ROM_LOAD( "vid_7fg.a1",   0x1c000, 0x4000, 0x940fe17e );
		ROM_REGION( 0x01000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cpu_alph.10g", 0x00000, 0x1000, 0x936dc87f );ROM_END(); }}; 
	
	
	static RomLoadPtr rom_turbotag = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
		ROM_LOAD( "ttprog0.bin",  0x0000, 0x2000, 0x6110fd80 );	ROM_LOAD( "ttprog1.bin",  0x2000, 0x2000, BADCRC( 0xb0505e18 );
		...
		ROM_LOAD_EVEN( "ttu7.bin",  0x00000, 0x2000, 0x8ebb3302 );	ROM_LOAD_ODD ( "ttu17.bin", 0x00000, 0x2000, 0x605d6c74 );	ROM_LOAD_EVEN( "ttu8.bin",  0x04000, 0x2000, 0x6bfcb22a );	ROM_LOAD_ODD ( "ttu18.bin", 0x04000, 0x2000, 0xbb25852c );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ttbg0.bin",    0x00000, 0x2000, 0x1cd2023f );	ROM_LOAD( "ttbg1.bin",    0x02000, 0x2000, 0x784e84cd );	ROM_LOAD( "ttbg2.bin",    0x04000, 0x2000, 0xda9d47d2 );	ROM_LOAD( "ttbg3.bin",    0x06000, 0x2000, 0x367e06a5 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ttfg0.bin",    0x00000, 0x4000, 0xed69e1a8 );	ROM_LOAD( "ttfg1.bin",    0x04000, 0x4000, 0x9d7e6ebc );	ROM_LOAD( "ttfg2.bin",    0x08000, 0x4000, 0x037ec6fc );	ROM_LOAD( "ttfg3.bin",    0x0c000, 0x4000, 0x74e21c1c );	ROM_LOAD( "ttfg4.bin",    0x10000, 0x4000, 0x6fdb0c13 );	ROM_LOAD( "ttfg5.bin",    0x14000, 0x4000, 0x8b718879 );	ROM_LOAD( "ttfg6.bin",    0x18000, 0x4000, 0x4094e996 );	ROM_LOAD( "ttfg7.bin",    0x1c000, 0x4000, 0x212019dc );
		ROM_REGION( 0x01000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ttan.bin",     0x00000, 0x1000, 0xaa0b1471 );ROM_END(); }}; 
	...
	static RomLoadPtr rom_crater = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "crcpu.3a",     0x00000, 0x2000, 0x9d73504a );	ROM_LOAD( "crcpu.4a",     0x02000, 0x2000, 0x42a47dff );	ROM_LOAD( "crcpu.5a",     0x04000, 0x2000, 0x2fe4a6e1 );	ROM_LOAD( "crcpu.6a",     0x06000, 0x2000, 0xd0659042 );
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "crvid.a3",     0x00000, 0x4000, 0x2c2f5b29 );	ROM_LOAD( "crvid.a4",     0x04000, 0x4000, 0x579a8e36 );	ROM_LOAD( "crvid.a5",     0x08000, 0x4000, 0x9bdec312 );	ROM_LOAD( "crvid.a6",     0x0c000, 0x4000, 0x5bf954e0 );	ROM_LOAD( "crvid.a7",     0x10000, 0x4000, 0x9fa307d5 );	ROM_LOAD( "crvid.a8",     0x14000, 0x4000, 0x4b913498 );	ROM_LOAD( "crvid.a9",     0x18000, 0x4000, 0x811f152d );	ROM_LOAD( "crvid.a10",    0x1c000, 0x4000, 0x7a22d6bc );
		ROM_REGION( 0x01000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "crcpu.10g",    0x00000, 0x1000, 0x6fe53c8d );ROM_END(); }}; 
	...
	static public static InitDriverPtr init_destderb = new InitDriverPtr() { public void handler() 
	{
	...
	static public static InitDriverPtr init_destderm = new InitDriverPtr() { public void handler() 
	{
		MCR_CONFIGURE_SOUND(MCR_TURBO_CHIP_SQUEAK);
