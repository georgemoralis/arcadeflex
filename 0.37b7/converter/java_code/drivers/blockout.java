...
public class blockout
{
	...
	PORT_START();       /* IN0 */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x10, 0x10, "1 Coin to Continue" );	PORT_DIPSETTING(    0x10, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x02, "Easy" );	PORT_DIPSETTING(    0x03, "Normal" );	PORT_DIPSETTING(    0x01, "Hard" );	PORT_DIPSETTING(    0x00, "Very Hard" );	PORT_DIPNAME( 0x04, 0x04, "Rotate Buttons" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x04, "3" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_blockout = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "bo29a0-2.bin", 0x00000, 0x20000, 0xb0103427 );	ROM_LOAD_ODD ( "bo29a1-2.bin", 0x00000, 0x20000, 0x5984d5a2 );
		...
		ROM_REGION( 0x0100, REGION_PROMS );	ROM_LOAD( "mb7114h.25",   0x0000, 0x0100, 0xb25bbda7 );/* unknown */
	ROM_END(); }}; 
	
	static RomLoadPtr rom_blckout2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );/* 2*128k for 68000 code */
		ROM_LOAD_EVEN( "29a0",         0x00000, 0x20000, 0x605f931e );	ROM_LOAD_ODD ( "29a1",         0x00000, 0x20000, 0x38f07000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for the audio CPU */
		ROM_LOAD( "bo29e3-0.bin", 0x0000, 0x8000, 0x3ea01f78 );
		ROM_REGION( 0x20000, REGION_SOUND1 );/* 128k for ADPCM samples - sound chip is OKIM6295 */
		ROM_LOAD( "bo29e2-0.bin", 0x0000, 0x20000, 0x15c5a99d );
