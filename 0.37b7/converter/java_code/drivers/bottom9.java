...
public class bottom9
{
	...
	{
		if (nmienable != 0) return nmi_interrupt();
		else return ignore_interrupt();
	} };
	...
	PORT_START(); 
		...
		PORT_START(); 
		PORT_DIPNAME( 0x07, 0x04, "Play Time" );	PORT_DIPSETTING(    0x07, "1'00" );	PORT_DIPSETTING(    0x06, "1'10" );	PORT_DIPSETTING(    0x05, "1'20" );	PORT_DIPSETTING(    0x04, "1'30" );	PORT_DIPSETTING(    0x03, "1'40" );	PORT_DIPSETTING(    0x02, "1'50" );	PORT_DIPSETTING(    0x01, "2'00" );	PORT_DIPSETTING(    0x00, "2'10" );	PORT_DIPNAME( 0x18, 0x08, "Bonus Time" );	PORT_DIPSETTING(    0x18, "00" );	PORT_DIPSETTING(    0x10, "20" );	PORT_DIPSETTING(    0x08, "30" );	PORT_DIPSETTING(    0x00, "40" );	PORT_DIPNAME( 0x60, 0x40, DEF_STR( "Difficulty") );
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_SERVICE( 0x40, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x80, 0x80, "Fielder Control" );	PORT_DIPSETTING(    0x80, "Normal" );	PORT_DIPSETTING(    0x00, "Auto" );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bottom9 = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "891n03.k17",   0x10000, 0x10000, 0x8b083ff3 );    ROM_LOAD( "891-t02.k15",  0x20000, 0x08000, 0x2c10ced2 );    ROM_CONTINUE(             0x08000, 0x08000 );
		...
		ROM_REGION( 0x0200, REGION_PROMS );	ROM_LOAD( "891b11.f23",   0x0000, 0x0100, 0xecb854aa );/* priority encoder (not used) */
	
		ROM_REGION( 0x40000, REGION_SOUND1 );/* samples for 007232 #0 */
		ROM_LOAD( "891e08a",      0x00000, 0x10000, 0xcef667bf );	ROM_LOAD( "891e08b",      0x10000, 0x10000, 0xf7c14a7a );	ROM_LOAD( "891e08c",      0x20000, 0x10000, 0x756b7f3c );	ROM_LOAD( "891e08d",      0x30000, 0x10000, 0xcd0d7305 );
		ROM_REGION( 0x40000, REGION_SOUND2 );/* samples for 007232 #1 */
		ROM_LOAD( "891e04a",      0x00000, 0x10000, 0xdaebbc74 );	ROM_LOAD( "891e04b",      0x10000, 0x10000, 0x5ffb9ad1 );	ROM_LOAD( "891e04c",      0x20000, 0x10000, 0x2dbbf16b );	ROM_LOAD( "891e04d",      0x30000, 0x10000, 0x8b0cd2cc );ROM_END(); }}; 
	
	static RomLoadPtr rom_bottom9n = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x28000, REGION_CPU1 );/* code + banked roms */
		ROM_LOAD( "891n03.k17",   0x10000, 0x10000, 0x8b083ff3 );    ROM_LOAD( "891n02.k15",   0x20000, 0x08000, 0xd44d9ed4 );    ROM_CONTINUE(             0x08000, 0x08000 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Z80 code */
		ROM_LOAD( "891j01.g8",    0x0000, 0x8000, 0x31b0a0a8 );
		ROM_REGION( 0x080000, REGION_GFX1 );/* graphics ( dont dispose as the program can read them ) */
		ROM_LOAD_GFX_EVEN( "891e10c", 0x00000, 0x10000, 0x209b0431 )	/* characters */
