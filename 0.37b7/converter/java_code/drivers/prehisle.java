...
public class prehisle
{
	...
	PORT_START(); 	/* Player 1 controls */
		...
		PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_TILT );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
		...
		PORT_DIPSETTING(    0x04, "Only Twice" );	PORT_DIPSETTING(    0x00, "Always" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Coinage") );
		PORT_DIPSETTING(    0x00, "A 4/1 B 1/4" );	PORT_DIPSETTING(    0x10, "A 3/1 B 1/3" );	PORT_DIPSETTING(    0x20, "A 2/1 B 1/2" );	PORT_DIPSETTING(    0x30, DEF_STR( "1C_1C") );
		...
		PORT_DIPSETTING(    0x30, "100000 200000" );	PORT_DIPSETTING(    0x20, "150000 300000" );	PORT_DIPSETTING(    0x10, "300000 500000" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x40, 0x40, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
	...
	static RomLoadPtr rom_prehisle = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "gt.2", 0x00000, 0x20000, 0x7083245a );	ROM_LOAD_ODD ( "gt.3", 0x00000, 0x20000, 0x6d8cdf58 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "gt.1",  0x000000, 0x10000, 0x80a4c093 );
		ROM_REGION( 0x008000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gt15.b15",   0x000000, 0x08000, 0xac652412 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pi8914.b14", 0x000000, 0x40000, 0x207d6187 );
		ROM_REGION( 0x040000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pi8916.h16", 0x000000, 0x40000, 0x7cffe0f6 );
		ROM_REGION( 0x0a0000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pi8910.k14", 0x000000, 0x80000, 0x5a101b0b );	ROM_LOAD( "gt.5",       0x080000, 0x20000, 0x3d3ab273 );
		...
		ROM_LOAD( "gt.4",  0x000000, 0x20000, 0x85dfb9ec );ROM_END(); }}; 
	
	static RomLoadPtr rom_prehislu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "gt-u2.2h", 0x00000, 0x20000, 0xa14f49bb );	ROM_LOAD_ODD ( "gt-u3.3h", 0x00000, 0x20000, 0xf165757e );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "gt.1",  0x000000, 0x10000, 0x80a4c093 );
		ROM_REGION( 0x008000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gt15.b15",   0x000000, 0x08000, 0xac652412 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pi8914.b14", 0x000000, 0x40000, 0x207d6187 );
	...
	static RomLoadPtr rom_gensitou = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x40000, REGION_CPU1 );	ROM_LOAD_EVEN( "gt2j.bin", 0x00000, 0x20000, 0xa2da0b6b );	ROM_LOAD_ODD ( "gt3j.bin", 0x00000, 0x20000, 0xc1a0ae8e );
		ROM_REGION( 0x10000, REGION_CPU2 );/* Sound CPU */
		ROM_LOAD( "gt.1",  0x000000, 0x10000, 0x80a4c093 );
		ROM_REGION( 0x008000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gt15.b15",   0x000000, 0x08000, 0xac652412 );
		ROM_REGION( 0x040000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "pi8914.b14", 0x000000, 0x40000, 0x207d6187 );
