...
public class crbaloon
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_crbaloon = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x0800, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cl07.bin",     0x0000, 0x0800, 0x2c1fbea8 );
		ROM_REGION( 0x0800, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "cl08.bin",     0x0000, 0x0800, 0xba898659 );ROM_END(); }}; 
