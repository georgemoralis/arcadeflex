...
public class exedexes
{
	...
	static RomLoadPtr rom_exedexes = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "05c_ee00.bin", 0x00000, 0x2000, 0xcadb75bd );/* Characters */
	
		ROM_REGION( 0x04000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "h01_ee08.bin", 0x00000, 0x4000, 0x96a65c1d );/* 32x32 tiles planes 0-1 */
	
		ROM_REGION( 0x08000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "a03_ee06.bin", 0x00000, 0x4000, 0x6039bdd1 );/* 16x16 tiles planes 0-1 */
		ROM_LOAD( "a02_ee05.bin", 0x04000, 0x4000, 0xb32d8252 );/* 16x16 tiles planes 2-3 */
	
		ROM_REGION( 0x08000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "j11_ee10.bin", 0x00000, 0x4000, 0xbc83e265 );/* Sprites planes 0-1 */
		...
		ROM_REGION( 0x0b20, REGION_PROMS );	ROM_LOAD( "02d_e-02.bin", 0x0000, 0x0100, 0x8d0d5935 );/* red component */
	...
	static RomLoadPtr rom_savgbees = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x02000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ee00e.5c",     0x00000, 0x2000, 0x5972f95f );/* Characters */
