...
public class goindol
{
	...
	static InputPortPtr input_ports_goindol = new InputPortPtr(){ public void handler() { 
		...
		PORT_START(); 	/* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN1, 1 );
		PORT_START(); 	/* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT_IMPULSE( 0x80, IP_ACTIVE_LOW, IPT_COIN2, 1 );
		PORT_START();       /* IN2 - spinner */
		PORT_ANALOG( 0xff, 0x00, IPT_DIAL , 40, 10, 0, 0);
		PORT_START(); 	/* DSW0 */
		PORT_DIPNAME( 0x03, 0x02, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "2" );	PORT_DIPSETTING(    0x02, "3" );	PORT_DIPSETTING(    0x01, "4" );	PORT_DIPSETTING(    0x00, "5" );	PORT_DIPNAME( 0x1c, 0x0c, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x1c, "Easiest" );	PORT_DIPSETTING(    0x18, "Very Very Easy" );	PORT_DIPSETTING(    0x14, "Very Easy" );	PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x0c, "Normal" );	PORT_DIPSETTING(    0x08, "Difficult" );	PORT_DIPSETTING(    0x04, "Hard" );	PORT_DIPSETTING(    0x00, "Very Hard" );	PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(    0x04, "30k and every 50k" );	PORT_DIPSETTING(    0x05, "50k and every 100k" );	PORT_DIPSETTING(    0x06, "50k and every 200k" );	PORT_DIPSETTING(    0x07, "100k and every 200k" );	PORT_DIPSETTING(    0x01, "10000 only" );	PORT_DIPSETTING(    0x02, "30000 only" );	PORT_DIPSETTING(    0x03, "50000 only" );	PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x38, 0x00, DEF_STR( "Coinage") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_goindol = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_REGION( 0x18000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "r4", 0x00000, 0x8000, 0x1ab84225 );/* Characters */
		ROM_LOAD( "r5", 0x08000, 0x8000, 0x4997d469 );	ROM_LOAD( "r6", 0x10000, 0x8000, 0x752904b0 );
		ROM_REGION( 0x18000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "r7", 0x00000, 0x8000, 0x362f2a27 );	ROM_LOAD( "r8", 0x08000, 0x8000, 0x9fc7946e );	ROM_LOAD( "r9", 0x10000, 0x8000, 0xe6212fe4 );
		ROM_REGION( 0x0300, REGION_PROMS );	ROM_LOAD( "am27s21.pr1", 0x0000, 0x0100, 0x361f0868 );/* palette red bits   */
