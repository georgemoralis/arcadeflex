...
public class mikie
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPNAME( 0x02, 0x00, "Controls" );	PORT_DIPSETTING(    0x00, "Single" );	PORT_DIPSETTING(    0x02, "Dual" );	PORT_BIT( 0xfc, IP_ACTIVE_HIGH, IPT_UNKNOWN );
		PORT_START(); 	/* DSW0 */
		...
		PORT_DIPSETTING(    0x18, "20000 50000" );	PORT_DIPSETTING(    0x10, "30000 60000" );	PORT_DIPSETTING(    0x08, "30000" );	PORT_DIPSETTING(    0x00, "40000" );	PORT_DIPNAME( 0x60, 0x60, DEF_STR( "Difficulty") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_mikie = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "11c_n14.bin",  0x6000, 0x2000, 0xf698e6dd );	ROM_LOAD( "12a_o13.bin",  0x8000, 0x4000, 0x826e7035 );	ROM_LOAD( "12d_o17.bin",  0xc000, 0x4000, 0x161c25c8 );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "06e_n10.bin",  0x0000, 0x2000, 0x2cf9d670 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "o11",          0x00000, 0x4000, 0x3c82aaf3 );
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "001",          0x00000, 0x4000, 0xa2ba0df5 );	ROM_LOAD( "003",          0x04000, 0x4000, 0x9775ab32 );	ROM_LOAD( "005",          0x08000, 0x4000, 0xba44aeef );	ROM_LOAD( "007",          0x0c000, 0x4000, 0x31afc153 );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "01i_d19.bin",  0x0000, 0x0100, 0x8b83e7cf );/* red component */
	...
	static RomLoadPtr rom_mikiej = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "11c_n14.bin",  0x6000, 0x2000, 0xf698e6dd );	ROM_LOAD( "12a_o13.bin",  0x8000, 0x4000, 0x826e7035 );	ROM_LOAD( "12d_o17.bin",  0xc000, 0x4000, 0x161c25c8 );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "06e_n10.bin",  0x0000, 0x2000, 0x2cf9d670 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "08i_q11.bin",  0x00000, 0x4000, 0xc48b269b );
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "f01_q01.bin",  0x00000, 0x4000, 0x31551987 );	ROM_LOAD( "f03_q03.bin",  0x04000, 0x4000, 0x34414df0 );	ROM_LOAD( "h01_q05.bin",  0x08000, 0x4000, 0xf9e1ebb1 );	ROM_LOAD( "h03_q07.bin",  0x0c000, 0x4000, 0x15dc093b );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "01i_d19.bin",  0x0000, 0x0100, 0x8b83e7cf );/* red component */
		ROM_LOAD( "03i_d21.bin",  0x0100, 0x0100, 0x3556304a );/* green component */
		ROM_LOAD( "02i_d20.bin",  0x0200, 0x0100, 0x676a0669 );/* blue component */
		ROM_LOAD( "12h_d22.bin",  0x0300, 0x0100, 0x872be05c );/* character lookup table */
	...
	static RomLoadPtr rom_mikiehs = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );    /* 64k for code */
		ROM_LOAD( "11c_l14.bin",  0x6000, 0x2000, 0x633f3a6d );	ROM_LOAD( "12a_m13.bin",  0x8000, 0x4000, 0x9c42d715 );	ROM_LOAD( "12d_m17.bin",  0xc000, 0x4000, 0xcb5c03c9 );
		ROM_REGION( 0x10000, REGION_CPU2 );	ROM_LOAD( "06e_h10.bin",  0x0000, 0x2000, 0x4ed887d2 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "08i_l11.bin",  0x00000, 0x4000, 0x5ba9d86b );
		ROM_REGION( 0x10000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "f01_i01.bin",  0x00000, 0x4000, 0x0c0cab5f );	ROM_LOAD( "f03_i03.bin",  0x04000, 0x4000, 0x694da32f );	ROM_LOAD( "h01_i05.bin",  0x08000, 0x4000, 0x00e357e1 );	ROM_LOAD( "h03_i07.bin",  0x0c000, 0x4000, 0xceeba6ac );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "01i_d19.bin",  0x0000, 0x0100, 0x8b83e7cf );/* red component */
		ROM_LOAD( "03i_d21.bin",  0x0100, 0x0100, 0x3556304a );/* green component */
		ROM_LOAD( "02i_d20.bin",  0x0200, 0x0100, 0x676a0669 );/* blue component */
		ROM_LOAD( "12h_d22.bin",  0x0300, 0x0100, 0x872be05c );/* character lookup table */
