...
public class speedbal
{
	...
	PORT_START();       /* DSW2 */
		...
		PORT_DIPSETTING(    0x06, "70000 200000 1M" );	PORT_DIPSETTING(    0x07, "70000 200000" );	PORT_DIPSETTING(    0x03, "100000 300000 1M" );	PORT_DIPSETTING(    0x04, "100000 300000" );	PORT_DIPSETTING(    0x01, "200000 1M" );	PORT_DIPSETTING(    0x05, "200000" );/*	PORT_DIPSETTING(    0x02, "200000" );*/
		PORT_DIPSETTING(    0x00, "None" );	PORT_DIPNAME( 0x08, 0x08, DEF_STR( "Unknown") );
		PORT_DIPSETTING(    0x08, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x30, 0x30, "Difficulty 1" );	PORT_DIPSETTING(    0x30, "Very Easy" );	PORT_DIPSETTING(    0x20, "Easy" );	PORT_DIPSETTING(    0x10, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );	PORT_DIPNAME( 0xc0, 0xc0, "Difficulty 2" );	PORT_DIPSETTING(    0xc0, "Very Easy" );	PORT_DIPSETTING(    0x80, "Easy" );	PORT_DIPSETTING(    0x40, "Difficult" );	PORT_DIPSETTING(    0x00, "Very Difficult" );
		PORT_START();       /* DSW1 */
		...
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x30, "3" );	PORT_DIPSETTING(    0x20, "4" );	PORT_DIPSETTING(    0x10, "5" );	PORT_DIPNAME( 0x40, 0x00, DEF_STR( "Cabinet") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_speedbal = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "sb1.bin",  0x0000,  0x8000, 0x1c242e34 );	ROM_LOAD( "sb3.bin",  0x8000,  0x8000, 0x7682326a );
		ROM_REGION( 0x10000, REGION_CPU2 );    /* 64K for second CPU: sound */
		ROM_LOAD( "sb2.bin",  0x0000, 0x8000, 0xe6a6d9b7 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD("sb10.bin",  0x00000, 0x08000, 0x36dea4bf );   /* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sb9.bin",  0x00000, 0x08000, 0xb567e85e );   /* bg tiles */
		ROM_LOAD( "sb5.bin",  0x08000, 0x08000, 0xb0eae4ba );	ROM_LOAD( "sb8.bin",  0x10000, 0x08000, 0xd2bfbdb6 );	ROM_LOAD( "sb4.bin",  0x18000, 0x08000, 0x1d23a130 );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "sb6.bin",  0x00000, 0x08000, 0x0e2506eb );   /* sprites */
		ROM_LOAD( "sb7.bin",  0x08000, 0x08000, 0x9f1b33d1 );ROM_END(); }}; 
