...
public class starcrus
{
	...
	static InputPortPtr input_ports_starcrus = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* player 1 */
	        ...
	        PORT_BIT (0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );        PORT_BIT (0x10, IP_ACTIVE_LOW, IPT_BUTTON3 );/* torpedo */
	        PORT_BIT (0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );        PORT_BIT (0x40, IP_ACTIVE_LOW, IPT_BUTTON1 );/* phaser */
	        ...
	        PORT_BIT (0x08, IP_ACTIVE_LOW, IPT_UNKNOWN );        PORT_BIT (0x10, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2 );/* torpedo */
	        PORT_BIT (0x20, IP_ACTIVE_LOW, IPT_UNKNOWN );        PORT_BIT (0x40, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );/* phaser */
	        PORT_BIT (0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );
			PORT_START(); 
	        PORT_DIPNAME ( 0x03, 0x02, "Game Time" );        PORT_DIPSETTING ( 0x03, "60 secs" );        PORT_DIPSETTING ( 0x02, "90 secs" );        PORT_DIPSETTING ( 0x01, "120 secs" );        PORT_DIPSETTING ( 0x00, "150 secs" );        PORT_DIPNAME ( 0x04, 0x00, DEF_STR( "Coinage") );
	        PORT_DIPSETTING ( 0x04, DEF_STR( "2C_1C") );
	        PORT_DIPSETTING ( 0x00, DEF_STR( "1C_1C") );
	        PORT_BIT (0x08, IP_ACTIVE_LOW, IPT_COIN2 );        PORT_BIT (0x10, IP_ACTIVE_LOW, IPT_COIN1 );        PORT_DIPNAME ( 0x20, 0x20, "Mode" );        PORT_DIPSETTING ( 0x20, "Standard" );        PORT_DIPSETTING ( 0x00, "Alternate" );        PORT_BIT (0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );        PORT_BIT (0x80, IP_ACTIVE_LOW, IPT_UNKNOWN );INPUT_PORTS_END(); }}; 
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_starcrus = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "starcrus.j1",   0x0000, 0x0200, 0x0ee60a50 );	ROM_LOAD( "starcrus.k1",   0x0200, 0x0200, 0xa7bc3bc4 );	ROM_LOAD( "starcrus.l1",   0x0400, 0x0200, 0x10d233ec );	ROM_LOAD( "starcrus.m1",   0x0600, 0x0200, 0x2facbfee );	ROM_LOAD( "starcrus.n1",   0x0800, 0x0200, 0x42083247 );	ROM_LOAD( "starcrus.p1",   0x0a00, 0x0200, 0x61dfe581 );	ROM_LOAD( "starcrus.r1",   0x0c00, 0x0200, 0x010cdcfe );	ROM_LOAD( "starcrus.s1",   0x0e00, 0x0200, 0xda4e276b );
	    ROM_REGION( 0x0200, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "starcrus.e6",   0x0000, 0x0200, 0x54887a25 );
	    ROM_REGION( 0x0200, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "starcrus.l2",   0x0000, 0x0200, 0x54887a25 );
	    ROM_REGION( 0x0400, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "starcrus.j4",   0x0000, 0x0200, 0x25f15ae1 );	ROM_LOAD( "starcrus.g5",   0x0200, 0x0200, 0x73b27f6e );ROM_END(); }}; 
