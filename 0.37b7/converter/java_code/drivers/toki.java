...
public class toki
{
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x1E, "A 1/1 B 1/2" );	PORT_DIPSETTING(    0x14, "A 2/1 B 1/3" );	PORT_DIPSETTING(    0x0A, "A 3/1 B 1/5" );	PORT_DIPSETTING(    0x00, "A 5/1 B 1/6" );	PORT_DIPSETTING(    0x01, DEF_STR( "Free_Play") );
		PORT_DIPNAME( 0x20, 0x20, "Joysticks" );	PORT_DIPSETTING(    0x20, "1" );	PORT_DIPSETTING(    0x00, "2" );	PORT_DIPNAME( 0x40, 0x40, DEF_STR( "Cabinet") );
		...
		PORT_DIPSETTING(    0x08, "50000 150000" );	PORT_DIPSETTING(    0x00, "70000 140000 210000" );	PORT_DIPSETTING(    0x0C, "70000" );	PORT_DIPSETTING(    0x04, "100000 200000" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Difficulty") );
		PORT_DIPSETTING(    0x20, "Easy" );	PORT_DIPSETTING(    0x30, "Medium" );	PORT_DIPSETTING(    0x10, "Hard" );	PORT_DIPSETTING(    0x00, "Hardest" );	PORT_DIPNAME( 0x40, 0x40, "Allow Continue" );	PORT_DIPSETTING(    0x00, DEF_STR( "No") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_toki = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_EVEN( "tokijp.006",   0x00000, 0x20000, 0x03d726b1 );	ROM_LOAD_ODD ( "tokijp.004",   0x00000, 0x20000, 0x54a45e12 );	ROM_LOAD_EVEN( "tokijp.005",   0x40000, 0x10000, 0xd6a82808 );	ROM_LOAD_ODD ( "tokijp.003",   0x40000, 0x10000, 0xa01a5b10 );
		...
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tokijp.001",   0x000000, 0x10000, 0x8aa964a2 );/* chars */
		ROM_LOAD( "tokijp.002",   0x010000, 0x10000, 0x86e87e48 );
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "toki.ob1",     0x000000, 0x80000, 0xa27a80ba );/* sprites */
		ROM_LOAD( "toki.ob2",     0x080000, 0x80000, 0xfa687718 );
		ROM_REGION( 0x080000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "toki.bk1",     0x000000, 0x80000, 0xfdaa5f4b );/* tiles 1 */
	
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "toki.bk2",     0x000000, 0x80000, 0xd86ac664 );/* tiles 2 */
		...
		ROM_LOAD( "tokijp.007",   0x00000, 0x10000, 0xa67969c4 );ROM_END(); }}; 
	
	static RomLoadPtr rom_toki2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 6*64k for 68000 code */
		ROM_LOAD_EVEN( "tokijp.006",   0x00000, 0x20000, 0x03d726b1 );	ROM_LOAD_ODD ( "4c.10k",       0x00000, 0x20000, 0xb2c345c5 );	ROM_LOAD_EVEN( "tokijp.005",   0x40000, 0x10000, 0xd6a82808 );	ROM_LOAD_ODD ( "tokijp.003",   0x40000, 0x10000, 0xa01a5b10 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for code */
		/* is this the Z80 code? maybe its encrypted */
		ROM_LOAD( "tokijp.008",   0x00000, 0x2000, 0x6c87c4c5 );
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tokijp.001",   0x000000, 0x10000, 0x8aa964a2 );/* chars */
	...
	static RomLoadPtr rom_toki3 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 6*64k for 68000 code */
		ROM_LOAD_EVEN( "l10_6.bin",    0x00000, 0x20000, 0x94015d91 );	ROM_LOAD_ODD ( "k10_4e.bin",   0x00000, 0x20000, 0x531bd3ef );	ROM_LOAD_EVEN( "tokijp.005",   0x40000, 0x10000, 0xd6a82808 );	ROM_LOAD_ODD ( "tokijp.003",   0x40000, 0x10000, 0xa01a5b10 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for code */
		/* is this the Z80 code? maybe its encrypted */
		ROM_LOAD( "tokijp.008",   0x00000, 0x2000, 0x6c87c4c5 );
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tokijp.001",   0x000000, 0x10000, 0x8aa964a2 );/* chars */
	...
	static RomLoadPtr rom_tokiu = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 6*64k for 68000 code */
		ROM_LOAD_EVEN( "6b.10m",       0x00000, 0x20000, 0x3674d9fe );	ROM_LOAD_ODD ( "14.10k",       0x00000, 0x20000, 0xbfdd48af );	ROM_LOAD_EVEN( "tokijp.005",   0x40000, 0x10000, 0xd6a82808 );	ROM_LOAD_ODD ( "tokijp.003",   0x40000, 0x10000, 0xa01a5b10 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* 64k for code */
		/* is this the Z80 code? maybe its encrypted */
		ROM_LOAD( "tokijp.008",   0x00000, 0x2000, 0x6c87c4c5 );
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "tokijp.001",   0x000000, 0x10000, 0x8aa964a2 );/* chars */
	...
	static RomLoadPtr rom_tokib = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x60000, REGION_CPU1 );/* 6*64k for 68000 code */
		ROM_LOAD_EVEN( "toki.e3",      0x00000, 0x20000, 0xae9b3da4 );	ROM_LOAD_ODD ( "toki.e5",      0x00000, 0x20000, 0x66a5a1d6 );	ROM_LOAD_EVEN( "tokijp.005",   0x40000, 0x10000, 0xd6a82808 );	ROM_LOAD_ODD ( "tokijp.003",   0x40000, 0x10000, 0xa01a5b10 );
		...
		ROM_REGION( 0x020000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "toki.e21",     0x000000, 0x08000, 0xbb8cacbd );/* chars */
		...
		ROM_REGION( 0x100000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "toki.e26",     0x000000, 0x20000, 0xa8ba71fc );/* sprites */
		...
		ROM_REGION( 0x080000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "toki.e23",     0x000000, 0x10000, 0xfeb13d35 );/* tiles 1 */
		...
		ROM_REGION( 0x080000, REGION_GFX4 | REGIONFLAG_DISPOSE );	ROM_LOAD( "toki.e25",     0x000000, 0x10000, 0x63026cad );/* tiles 2 */
