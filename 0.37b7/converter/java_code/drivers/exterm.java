...
public class exterm
{
	...
	/*new MemoryWriteAddress( TOBYTE(0x00000000), TOBYTE(0x000fffff), exterm_slave_videoram_8_w ),       OR		*/
		new MemoryWriteAddress( TOBYTE(0xc0000000), TOBYTE(0xc00001ff), tms34010_io_register_w ),
		new MemoryWriteAddress( TOBYTE(0xfffffb90), TOBYTE(0xfffffb9f), exterm_slave_speedup_w, exterm_slave_speedup ),
	...
	static MemoryWriteAddress sound_dac_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x8000, 0x8000, DAC_0_data_w ),
		new MemoryWriteAddress( 0x8001, 0x8001, DAC_1_data_w ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	static InputPortPtr input_ports_exterm = new InputPortPtr(){ public void handler() { 
		...
		PORT_START();       /* IN0 LO */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER1);	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER1);	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER1);	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER1);	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER1 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER1 );
		PORT_START();       /* IN0 HI */
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER1, "Aim Left",  KEYCODE_Z, IP_JOY_DEFAULT );	PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER1, "Aim Right", KEYCODE_X, IP_JOY_DEFAULT );	PORT_BIT( 0xec, IP_ACTIVE_LOW, IPT_UNUSED );	PORT_SERVICE( 0x80, IP_ACTIVE_LOW );
		PORT_START();       /* IN1 LO */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_PLAYER2);	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_PLAYER2);	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_PLAYER2);	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_PLAYER2);	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_PLAYER2 );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_PLAYER2 );
		PORT_START();       /* IN1 HI */
		PORT_BITX(0x01, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_PLAYER2, "2 Aim Left",  KEYCODE_H, IP_JOY_DEFAULT );	PORT_BITX(0x02, IP_ACTIVE_LOW, IPT_BUTTON4 | IPF_PLAYER2, "2 Aim Right", KEYCODE_J, IP_JOY_DEFAULT );	PORT_BIT( 0xfc, IP_ACTIVE_LOW, IPT_UNUSED );
		PORT_START(); 	/* DSW */
		...
		PORT_DIPNAME( 0x40, 0x40, "Memory Test" );	PORT_DIPSETTING(    0x40, "Single" );	PORT_DIPSETTING(    0x00, "Continous" );	PORT_DIPNAME( 0x80, 0x80, DEF_STR( "Free_Play") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_exterm = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD_ODD(  "v101bg0",  0x000000, 0x10000, 0x8c8e72cf );	ROM_LOAD_EVEN( "v101bg1",  0x000000, 0x10000, 0xcc2da0d8 );	ROM_LOAD_ODD(  "v101bg2",  0x020000, 0x10000, 0x2dcb3653 );	ROM_LOAD_EVEN( "v101bg3",  0x020000, 0x10000, 0x4aedbba0 );	ROM_LOAD_ODD(  "v101bg4",  0x040000, 0x10000, 0x576922d4 );	ROM_LOAD_EVEN( "v101bg5",  0x040000, 0x10000, 0xa54a4bc2 );	ROM_LOAD_ODD(  "v101bg6",  0x060000, 0x10000, 0x7584a676 );	ROM_LOAD_EVEN( "v101bg7",  0x060000, 0x10000, 0xa4f24ff6 );	ROM_LOAD_ODD(  "v101bg8",  0x080000, 0x10000, 0xfda165d6 );	ROM_LOAD_EVEN( "v101bg9",  0x080000, 0x10000, 0xe112a4c4 );	ROM_LOAD_ODD(  "v101bg10", 0x0a0000, 0x10000, 0xf1a5cf54 );	ROM_LOAD_EVEN( "v101bg11", 0x0a0000, 0x10000, 0x8677e754 );	ROM_LOAD_ODD(  "v101fg0",  0x180000, 0x10000, 0x38230d7d );	ROM_LOAD_EVEN( "v101fg1",  0x180000, 0x10000, 0x22a2bd61 );	ROM_LOAD_ODD(  "v101fg2",  0x1a0000, 0x10000, 0x9420e718 );	ROM_LOAD_EVEN( "v101fg3",  0x1a0000, 0x10000, 0x84992aa2 );	ROM_LOAD_ODD(  "v101fg4",  0x1c0000, 0x10000, 0x38da606b );	ROM_LOAD_EVEN( "v101fg5",  0x1c0000, 0x10000, 0x842de63a );	ROM_LOAD_ODD(  "v101p0",   0x1e0000, 0x10000, 0x6c8ee79a );	ROM_LOAD_EVEN( "v101p1",   0x1e0000, 0x10000, 0x557bfc84 );
		...
		ROM_LOAD( "v101y1", 0x08000, 0x08000, 0xcbeaa837 );ROM_END(); }}; 
