...
public class galivan
{
	...
	PORT_START();       /* IN0 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON3 );
		PORT_START();       /* IN1 */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_JOYSTICK_RIGHT | IPF_8WAY | IPF_COCKTAIL );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_BUTTON1 | IPF_COCKTAIL );	PORT_BIT( 0x20, IP_ACTIVE_LOW, IPT_BUTTON2 | IPF_COCKTAIL );	PORT_BIT( 0x40, IP_ACTIVE_LOW, IPT_UNKNOWN );	PORT_BIT( 0x80, IP_ACTIVE_LOW, IPT_BUTTON3 | IPF_COCKTAIL );
		PORT_START();   /* IN2 - TEST, COIN, START */
		PORT_BIT( 0x01, IP_ACTIVE_LOW, IPT_START1 );	PORT_BIT( 0x02, IP_ACTIVE_LOW, IPT_START2 );	PORT_BIT( 0x04, IP_ACTIVE_LOW, IPT_COIN1 );	PORT_BIT( 0x08, IP_ACTIVE_LOW, IPT_COIN2 );	PORT_BIT( 0x10, IP_ACTIVE_LOW, IPT_SERVICE1 );	PORT_BITX(0x20, 0x20, 0, DEF_STR( "Service_Mode") ); KEYCODE_F2, IP_JOY_NONE )
		...
		PORT_DIPSETTING(    0x0c, "20000 and every 60000" );	PORT_DIPSETTING(    0x04, "20000 and every 90000" );	PORT_DIPSETTING(    0x08, "50000 and every 60000" );	PORT_DIPSETTING(    0x00, "50000 and every 90000" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Demo_Sounds") );
		...
		PORT_DIPSETTING(    0x10, "Easy" );	PORT_DIPSETTING(    0x00, "Hard" );	PORT_DIPNAME( 0x20, 0x20, DEF_STR( "Flip_Screen") );
	...
	PORT_START();       /* IN0 */
		...
		/* two switches to allow continue... both work */
	    	PORT_DIPNAME( 0xc0, 0x00, "Continue" );    	PORT_DIPSETTING(    0xc0, DEF_STR( "No") );
	    	PORT_DIPSETTING(    0x80, "3 Times" );    	PORT_DIPSETTING(    0x40, "5 Times" );    	PORT_DIPSETTING(    0x00, DEF_STR( "Yes") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START();       /* IN0 */
		...
		PORT_START(); 	/* IN3 - DSW1 */
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x00, "2" );	PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x02, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x0c, "20000 and every 60000" );	PORT_DIPSETTING(    0x04, "20000 and every 90000" );	PORT_DIPSETTING(    0x08, "50000 and every 60000" );	PORT_DIPSETTING(    0x00, "50000 and every 90000" );	PORT_DIPNAME( 0x10, 0x10, DEF_STR( "Demo_Sounds") );
		PORT_DIPSETTING(    0x00, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x10, DEF_STR( "On") );
		PORT_DIPNAME( 0x20, 0x00, DEF_STR( "Cabinet") );
		...
		PORT_DIPSETTING(    0x20, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BITX(    0x40, 0x40, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Complete Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_BITX(    0x80, 0x80, IPT_DIPSWITCH_NAME | IPF_CHEAT, "Base Ship Invulnerability", IP_KEY_NONE, IP_JOY_NONE );	PORT_DIPSETTING(    0x80, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
	INPUT_PORTS_END(); }}; 
	...
	PORT_START(); 	/* IN0 */
		...
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_SERVICE( 0x02, IP_ACTIVE_LOW );	PORT_DIPNAME( 0x04, 0x04, DEF_STR( "Unknown") );
		...
		PORT_DIPNAME( 0x03, 0x03, DEF_STR( "Lives") );
		PORT_DIPSETTING(    0x03, "3" );	PORT_DIPSETTING(    0x02, "4" );	PORT_DIPSETTING(    0x01, "5" );	PORT_DIPSETTING(    0x00, "6" );	PORT_DIPNAME( 0x0c, 0x0c, DEF_STR( "Bonus_Life") );
		PORT_DIPSETTING(    0x0c, "20000 and every 60000" );	PORT_DIPSETTING(    0x08, "50000 and every 60000" );	PORT_DIPSETTING(    0x04, "20000 and every 90000" );	PORT_DIPSETTING(    0x00, "50000 and every 90000" );	PORT_DIPNAME( 0x30, 0x30, DEF_STR( "Coin_A") );
		...
		PORT_DIPSETTING(    0x40, DEF_STR( "Off") );
		PORT_DIPSETTING(    0x00, DEF_STR( "On") );
		PORT_DIPNAME( 0x80, 0x80, "Allow Continue" );	PORT_DIPSETTING(    0x80, DEF_STR( "No") );
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_galivan = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "gv1.1b",       0x00000, 0x8000, 0x5e480bfc );	ROM_LOAD( "gv2.3b",       0x08000, 0x4000, 0x0d1b3538 );	ROM_LOAD( "gv3.4b",       0x10000, 0x4000, 0x82f0c5e6 );/* 2 banks at c000 */
	
		ROM_REGION( 0x10000, REGION_CPU2 );	/* sound cpu code */
		ROM_LOAD( "gv11.14b",     0x0000, 0x4000, 0x05f1a0e3 );	ROM_LOAD( "gv12.15b",     0x4000, 0x8000, 0x5b7a0d6d );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gv4.13d",      0x00000, 0x4000, 0x162490b4 );/* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gv7.14f",      0x00000, 0x8000, 0xeaa1a0db );/* tiles */
		ROM_LOAD( "gv8.15f",      0x08000, 0x8000, 0xf174a41e );	ROM_LOAD( "gv9.17f",      0x10000, 0x8000, 0xedc60f5d );	ROM_LOAD( "gv10.19f",     0x18000, 0x8000, 0x41f27fca );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "gv14.4f",      0x00000, 0x8000, 0x03e2229f );/* sprites */
		ROM_LOAD( "gv13.1f",      0x08000, 0x8000, 0xbca9e66b );
		ROM_REGION( 0x8000, REGION_GFX4 );/* background tilemaps */
		ROM_LOAD( "gv6.19d",      0x0000, 0x4000, 0xda38168b );	ROM_LOAD( "gv5.17d",      0x4000, 0x4000, 0x22492d2a );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "mb7114e.9f",   0x0000, 0x0100, 0xde782b3e );/* red */
	...
	static RomLoadPtr rom_galivan2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x14000, REGION_CPU1 );	/* main cpu code */
		ROM_LOAD( "e-1",          0x00000, 0x8000, 0xd8cc72b8 );	ROM_LOAD( "e-2",          0x08000, 0x4000, 0x9e5b3157 );	ROM_LOAD( "gv3.4b",       0x10000, 0x4000, 0x82f0c5e6 );/* 2 banks at c000 */
	...
	static RomLoadPtr rom_dangar = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x14000, REGION_CPU1 );	/* main cpu code */
		ROM_LOAD( "dangar08.1b",  0x00000, 0x8000, 0xe52638f2 );	ROM_LOAD( "dangar09.3b",  0x08000, 0x4000, 0x809d280f );	ROM_LOAD( "dangar10.5b",  0x10000, 0x4000, 0x99a3591b );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* sound cpu code */
		ROM_LOAD( "dangar13.b14", 0x0000, 0x4000, 0x3e041873 );	ROM_LOAD( "dangar14.b15", 0x4000, 0x8000, 0x488e3463 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dangar05.13d", 0x00000, 0x4000, 0x40cb378a );/* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dangar01.14f", 0x00000, 0x8000, 0xd59ed1f1 ); /* tiles */
		ROM_LOAD( "dangar02.15f", 0x08000, 0x8000, 0xdfdb931c );	ROM_LOAD( "dangar03.17f", 0x10000, 0x8000, 0x6954e8c3 );	ROM_LOAD( "dangar04.19f", 0x18000, 0x8000, 0x4af6a8bf );
		ROM_REGION( 0x10000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dangarxx.f4",  0x00000, 0x8000, 0x55711884 ); /* sprites */
		ROM_LOAD( "dangarxx.f1",  0x08000, 0x8000, 0x8cf11419 );
		ROM_REGION( 0x8000, REGION_GFX4 );/* background tilemaps */
		ROM_LOAD( "dangar07.19d", 0x0000, 0x4000, 0x6dba32cf );	ROM_LOAD( "dangar06.17d", 0x4000, 0x4000, 0x6c899071 );
		ROM_REGION( 0x0500, REGION_PROMS );	ROM_LOAD( "82s129.9f",    0x0000, 0x0100, 0xb29f6a07 );/* red */
	...
	static RomLoadPtr rom_dangar2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x14000, REGION_CPU1 );	/* main cpu code */
		ROM_LOAD( "dangar2.016",  0x00000, 0x8000, 0x743fa2d4 );	ROM_LOAD( "dangar2.017",  0x08000, 0x4000, 0x1cdc60a5 );	ROM_LOAD( "dangar2.018",  0x10000, 0x4000, 0xdb7f6613 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* sound cpu code */
		ROM_LOAD( "dangar13.b14", 0x0000, 0x4000, 0x3e041873 );	ROM_LOAD( "dangar14.b15", 0x4000, 0x8000, 0x488e3463 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dangar2.011",  0x00000, 0x4000, 0xe804ffe1 );/* chars */
	...
	static RomLoadPtr rom_dangarb = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x14000, REGION_CPU1 );	/* main cpu code */
		ROM_LOAD( "8",            0x00000, 0x8000, 0x8136fd10 );	ROM_LOAD( "9",            0x08000, 0x4000, 0x3ce5ec11 );	ROM_LOAD( "dangar2.018",  0x10000, 0x4000, 0xdb7f6613 );
		ROM_REGION( 0x10000, REGION_CPU2 );	/* sound cpu code */
		ROM_LOAD( "dangar13.b14", 0x0000, 0x4000, 0x3e041873 );	ROM_LOAD( "dangar14.b15", 0x4000, 0x8000, 0x488e3463 );
		ROM_REGION( 0x04000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "dangar2.011",  0x00000, 0x4000, 0xe804ffe1 );/* chars */
	...
	static RomLoadPtr rom_ninjemak = new RomLoadPtr(){ public void handler(){ 
		...
		ROM_LOAD( "ninjemak.1",   0x00000, 0x8000, 0x12b0a619 );	ROM_LOAD( "ninjemak.2",   0x08000, 0x4000, 0xd5b505d1 );	ROM_LOAD( "ninjemak.3",   0x10000, 0x8000, 0x68c92bf6 );
		ROM_REGION( 0x10000, REGION_CPU2 );/* sound cpu code */
		ROM_LOAD( "ninjemak.12",  0x0000, 0x4000, 0x3d1cd329 );	ROM_LOAD( "ninjemak.13",  0x4000, 0x8000, 0xac3a0b81 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ninjemak.4",   0x00000, 0x8000, 0x83702c37 );/* chars */
	
		ROM_REGION( 0x20000, REGION_GFX2 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ninjemak.8",   0x00000, 0x8000, 0x655f0a58 );/* tiles */
		ROM_LOAD( "ninjemak.9",   0x08000, 0x8000, 0x934e1703 );	ROM_LOAD( "ninjemak.10",  0x10000, 0x8000, 0x955b5c45 );	ROM_LOAD( "ninjemak.11",  0x18000, 0x8000, 0xbbd2e51c );
		ROM_REGION( 0x20000, REGION_GFX3 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ninjemak.16",  0x00000, 0x8000, 0x8df93fed ); /* sprites */
		ROM_LOAD( "ninjemak.17",  0x08000, 0x8000, 0xa3efd0fc );	ROM_LOAD( "ninjemak.14",  0x10000, 0x8000, 0xbff332d3 );	ROM_LOAD( "ninjemak.15",  0x18000, 0x8000, 0x56430ed4 );
		ROM_REGION( 0x8000, REGION_GFX4 );/* background tilemaps */
		ROM_LOAD( "ninjemak.7",   0x0000, 0x4000, 0x80c20d36 );	ROM_LOAD( "ninjemak.6",   0x4000, 0x4000, 0x1da7a651 );
	...
	static RomLoadPtr rom_youma = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x18000, REGION_CPU1 );/* main cpu code */
		ROM_LOAD( "ync-1.bin",    0x00000, 0x8000, 0x0552adab );	ROM_LOAD( "ync-2.bin",    0x08000, 0x4000, 0xf961e5e6 );	ROM_LOAD( "ync-3.bin",    0x10000, 0x8000, 0x9ad50a5e );
		ROM_REGION( 0x10000, REGION_CPU2 );/* sound cpu code */
		ROM_LOAD( "ninjemak.12",  0x0000, 0x4000, 0x3d1cd329 );	ROM_LOAD( "ninjemak.13",  0x4000, 0x8000, 0xac3a0b81 );
		ROM_REGION( 0x08000, REGION_GFX1 | REGIONFLAG_DISPOSE );	ROM_LOAD( "ync-4.bin",    0x00000, 0x8000, 0xa1954f44 );/* chars */
