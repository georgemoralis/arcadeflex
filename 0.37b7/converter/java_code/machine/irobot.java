...
public class irobot
{
	...
	public static timer_callback irvg_done_callback = new timer_callback() { public void handler(int param) 
	{
		logerror("vg done. ");
		IR_CPU_STATE;
		irvg_running = 0;
	...
	***********************************************************************/
	...
	public static timer_callback irmb_done_callback = new timer_callback() { public void handler(int param) 
	{
	    logerror("mb done. ");
		IR_CPU_STATE;
		irmb_running = 0;
