...
public class wmswolfu
{
	...
	public static WriteHandlerPtr wms_wolfu_cmos_enable_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		cmos_write_enable = 1;
	} };
	
	public static WriteHandlerPtr wms_wolfu_cmos_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_wolfu_cmos_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr wms_wolfu_io_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_wolfu_io_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset / 2)
		{
			case 0:
	...
	public static InitDriverPtr init_nbamaxht = new InitDriverPtr() { public void handler() 
	{
		/* common init */
		init_wolfu_generic(SOUND_DCS);
	...
	public static ReadHandlerPtr wms_generic_speedup_1_address  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr wms_wolfu_security_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr wms_wolfu_security_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_wolfu_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr wms_wolfu_sound_state_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if ( sound_type == SOUND_DCS && Machine.sample_rate )
	...
	public static WriteHandlerPtr wms_wolfu_sound_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
