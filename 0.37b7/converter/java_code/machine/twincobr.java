...
public class twincobr
{
	...
	public static ReadHandlerPtr twincobr_dsp_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		switch (main_ram_seg) {
			...
			case 0x50000:	input_data = READ_WORD(&paletteram.read(dsp_addr_w)); break;
	...
	public static ReadHandlerPtr fsharkbt_dsp_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr twincobr_dsp_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if (offset == 0) {
		...
		if (offset == 1) {
			...
			switch (main_ram_seg) {
				...
				case 0x50000:	WRITE_WORD(&paletteram.read(dsp_addr_w),data); break;
