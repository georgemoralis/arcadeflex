...
public class wmstunit
{
	...
	public static WriteHandlerPtr wms_tunit_cmos_enable_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		cmos_write_enable = 1;
	} };
	
	public static WriteHandlerPtr wms_tunit_cmos_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_tunit_cmos_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr wms_tunit_input_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr mk_prot_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr mk_prot_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr mk_mirror_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr mk2_prot_const_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return 2;
	} };
	
	public static ReadHandlerPtr mk2_prot_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return mk2_prot_data;
	} };
	
	public static ReadHandlerPtr mk2_prot_shift_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return mk2_prot_data >> 1;
	} };
	
	public static WriteHandlerPtr mk2_prot_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		mk2_prot_data = data;
	} };
	...
	public static ReadHandlerPtr nbajam_prot_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr nbajam_prot_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static InitDriverPtr init_mk2r32 = new InitDriverPtr() { public void handler() 
	{
		init_mk2_common();
		INSTALL_SPEEDUP_3(0x01068e70, 0xff80db70, 0x105d480, 0x105d4a0, 0x105d4c0);
	} };
	...
	public static ReadHandlerPtr wms_tunit_sound_state_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr wms_tunit_sound_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr wms_tunit_sound_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
