...
public class neogeo
{
	...
	public static ReadHandlerPtr bios_cycle_skip_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		cpu_spinuntil_int();
		return 0;
	} };
	...
	/******************************************************************************/
	#define NEO_CYCLE_R(name,pc,hit,other) public static ReadHandlerPtr name##_cycle_r  = new ReadHandlerPtr() { public int handler(int offset) {	if (cpu_get_pc()==pc) {cpu_spinuntil_int(); return hit;} return other;} };
	#define NEO_CYCLE_RX(name,pc,hit,other,xxx) public static ReadHandlerPtr name##_cycle_r  = new ReadHandlerPtr() { public int handler(int offset) {	if (cpu_get_pc()==pc) {if(other==xxx) cpu_spinuntil_int(); return hit;} return other;} };
