...
public class wmsyunit
{
	...
	public static WriteHandlerPtr wms_yunit_cmos_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_yunit_cmos_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr wms_yunit_cmos_enable_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_yunit_protection_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr wms_yunit_input_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr term2_input_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 4)
			return readinputport(offset / 2);
		...
		{
			default:
			case 0:  return input_port_2_r.handler(offset);  break;
			case 1:  return input_port_6_r.handler(offset);  break;
			case 2:  return input_port_7_r.handler(offset);  break;
			case 3:  return input_port_8_r.handler(offset);  break;
		}
	} };
	
	public static WriteHandlerPtr term2_sound_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if (offset == 0)
	...
	public static WriteHandlerPtr term2_hack_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr term2_speedup_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	public static ReadHandlerPtr wms_generic_speedup_1_16bit  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr wms_generic_speedup_1_mixedbits  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UINT16 value = READ_WORD(&wms_speedup_base[offset]);
	...
	public static ReadHandlerPtr wms_generic_speedup_1_32bit  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UINT16 value = READ_WORD(&wms_speedup_base[offset]);
	...
	public static ReadHandlerPtr wms_generic_speedup_3  = new ReadHandlerPtr() { public int handler(int offset)
	{
		UINT16 value = READ_WORD(&wms_speedup_base[offset]);
	...
	public static WriteHandlerPtr wms_yunit_sound_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
