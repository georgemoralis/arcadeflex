...
public class williams
{
	...
	public static timer_callback williams_count240_off_callback = new timer_callback() { public void handler(int param) 
	{
	...
	public static timer_callback williams_count240_callback = new timer_callback() { public void handler(int param) 
	{
		/* the COUNT240 signal comes into CA1, and is set to the logical AND of VA10-VA13 */
		pia_1_ca1_w(0, 1);
	...
	public static timer_callback williams2_endscreen_off_callback = new timer_callback() { public void handler(int param) 
	{
	...
	public static timer_callback williams2_endscreen_callback = new timer_callback() { public void handler(int param) 
	{
		/* the /ENDSCREEN signal comes into CA1 */
		pia_0_ca1_w(0, 0);
