...
public class exidy
{
	...
	public static timer_callback collision_irq_callback = new timer_callback() { public void handler(int param) 
	{
	...
	***************************************************************************/
	...
	public static VhUpdatePtr exidy_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int sx, sy;
