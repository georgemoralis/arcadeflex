...
public class deniam
{
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr deniam_videoram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	   return READ_WORD(&deniam_videoram[offset]);
	} };
	
	public static WriteHandlerPtr deniam_videoram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr deniam_textram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	   return READ_WORD(&deniam_textram[offset]);
	} };
	
	public static WriteHandlerPtr deniam_textram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr deniam_coinctrl_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return coinctrl;
	} };
	
	public static WriteHandlerPtr deniam_coinctrl_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	***************************************************************************/
	...
	public static VhUpdatePtr deniam_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
