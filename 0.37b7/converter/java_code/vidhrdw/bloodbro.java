...
public class bloodbro
{
	...
	public static ReadHandlerPtr bloodbro_foreground_r  = new ReadHandlerPtr() { public int handler(int offset){
		return READ_WORD (&bloodbro_videoram2[offset]);
	} };
	
	public static WriteHandlerPtr bloodbro_foreground_w = new WriteHandlerPtr() {public void handler(int offset, int data){
	...
	public static VhStopPtr bloodbro_vh_stop = new VhStopPtr() { public void handler()  {
		if (tmpbitmap != 0) bitmap_free( tmpbitmap );
		if (tmpbitmap2 != 0) bitmap_free( tmpbitmap2 );
		free( dirtybuffer2 );
		free( dirtybuffer );
	} };
	...
	public static VhUpdatePtr bloodbro_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) {
		get_sprite_info();
	...
	*/
	...
	public static VhUpdatePtr weststry_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) {
