...
public class blktiger
{
	...
	***************************************************************************/
	...
	public static GetTileInfoPtr get_bg_tile_info = new GetTileInfoPtr() { public void handler(int tile_index) 
	{
		...
		if ((attr & 0x80) != 0) tile_info.flags |= TILE_FLIPX;
	} };
	...
	***************************************************************************/
	...
	public static VhUpdatePtr blktiger_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	public static VhEofCallbackPtr blktiger_eof_callback = new VhEofCallbackPtr() { public void handler() 
	{
