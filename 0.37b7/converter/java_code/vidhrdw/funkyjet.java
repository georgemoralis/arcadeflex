...
public class funkyjet
{
	...
	public static VhUpdatePtr funkyjet_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int scrollx,scrolly;
	...
	public static VhStopPtr funkyjet_vh_stop = new VhStopPtr() { public void handler() 
	{
