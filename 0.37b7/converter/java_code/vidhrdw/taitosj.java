...
public class taitosj
{
	...
	***************************************************************************/
	public static VhStopPtr taitosj_vh_stop = new VhStopPtr() { public void handler() 
	{
		...
		if (sprite_sprite_collbitmap2 != 0) bitmap_free(sprite_sprite_collbitmap2);
		if (sprite_sprite_collbitmap1 != 0) bitmap_free(sprite_sprite_collbitmap1);
		if (sprite_plane_collbitmap1 != 0) bitmap_free(sprite_plane_collbitmap1);
