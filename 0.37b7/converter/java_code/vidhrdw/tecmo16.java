...
public class tecmo16
{
	...
	public static ReadHandlerPtr tecmo16_videoram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	   return READ_WORD(&tecmo16_videoram[offset]);
	} };
	
	public static ReadHandlerPtr tecmo16_colorram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	   return READ_WORD(&tecmo16_colorram[offset]);
	} };
	
	public static ReadHandlerPtr tecmo16_videoram2_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	   return READ_WORD(&tecmo16_videoram2[offset]);
	} };
	
	public static ReadHandlerPtr tecmo16_colorram2_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	   return READ_WORD(&tecmo16_colorram2[offset]);
	} };
	
	public static ReadHandlerPtr tecmo16_charram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr tecmo16_colorram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr tecmo16_videoram2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr tecmo16_colorram2_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr tecmo16_charram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr tecmo16_scroll_x_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		tilemap_set_scrollx(fg_tilemap,0,data);
	} };
	
	public static WriteHandlerPtr tecmo16_scroll_y_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		tilemap_set_scrolly(fg_tilemap,0,data);
	} };
	
	public static WriteHandlerPtr tecmo16_scroll2_x_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		tilemap_set_scrollx(bg_tilemap,0,data);
	} };
	
	public static WriteHandlerPtr tecmo16_scroll2_y_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		tilemap_set_scrolly(bg_tilemap,0,data);
	} };
	
	public static WriteHandlerPtr tecmo16_scroll_char_x_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		tilemap_set_scrollx(tx_tilemap,0,data);
	} };
	
	public static WriteHandlerPtr tecmo16_scroll_char_y_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
