...
public class vector
{
	...
	public static plot_pixel_procPtr vector_pp_8  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { b.line[y][x] = p; } };
	public static plot_pixel_procPtr vector_pp_16  = new plot_pixel_procPtr() { public void handler(osd_bitmap b,int x,int y,int p)   { ((unsigned short *)b.line[y])[x] = p; } };
