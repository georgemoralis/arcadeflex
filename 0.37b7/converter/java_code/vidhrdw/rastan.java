...
public class rastan
{
	...
	public static WriteHandlerPtr rastan_videocontrol_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if (offset == 0)
		{
	...
	public static WriteHandlerPtr rastan_flipscreen_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		if (offset == 0)
		{
	...
	***************************************************************************/
	public static VhUpdatePtr rastan_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
		int scrollx,scrolly;
	...
	public static VhUpdatePtr rainbow_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
		int scrollx,scrolly;
	...
	public static VhUpdatePtr jumping_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
		int scrollx,scrolly;
