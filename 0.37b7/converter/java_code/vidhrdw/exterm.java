...
public class exterm
{
	...
	public static WriteHandlerPtr exterm_master_videoram_16_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr exterm_master_videoram_8_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(&exterm_master_videoram[offset], data);
	...
	public static WriteHandlerPtr exterm_slave_videoram_16_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int x,y;
	...
	public static WriteHandlerPtr exterm_slave_videoram_8_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int x,y;
		unsigned short *pens = Machine.pens;
		struct osd_bitmap *foreground;
