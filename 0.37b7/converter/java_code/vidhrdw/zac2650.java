...
public class zac2650
{
	...
	public static WriteHandlerPtr s2636_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr s2636_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
