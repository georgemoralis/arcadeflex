...
public class wmstunit
{
	...
	public static ReadHandlerPtr wms_tunit_gfxrom_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr wms_wolfu_gfxrom_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr wms_tunit_vram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_tunit_vram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (videobank_select != 0)
	...
	public static WriteHandlerPtr wms_tunit_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* 
	...
	public static WriteHandlerPtr wms_wolfu_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/* 
			other important bits:
				bit 2 (0x0004) is toggled periodically
	...
	public static ReadHandlerPtr wms_wolfu_control_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		return wms_control;
	} };
	...
	public static WriteHandlerPtr wms_tunit_paletteram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_tunit_dma_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr wms_tunit_dma_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
