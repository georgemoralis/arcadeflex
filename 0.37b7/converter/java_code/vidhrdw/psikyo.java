...
public class psikyo
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr psikyo_vram_1_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	***************************************************************************/
	...
	/* Show (part of) the video registers */
	{
		...
		if ((layers_ctrl & 1) != 0)	tilemap_draw(bitmap, tilemap_0, (0 << 16) | TILEMAP_IGNORE_TRANSPARENCY );
		if ((layers_ctrl & 2) != 0)	tilemap_draw(bitmap, tilemap_1, (1 << 16)  );
