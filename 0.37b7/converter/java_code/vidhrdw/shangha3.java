...
public class shangha3
{
	...
	public static WriteHandlerPtr shangha3_flipscreen_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr shangha3_gfxlist_addr_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		gfxlist_addr = data * 0x10;
	} };
	
	
	public static WriteHandlerPtr shangha3_blitter_go_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		int offs;
	...
	public static VhUpdatePtr shangha3_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		palette_recalc();
