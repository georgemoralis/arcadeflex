...
public class pipedrm
{
	...
	public static VhStopPtr pipedrm_vh_stop = new VhStopPtr() { public void handler() 
	{
	...
	public static WriteHandlerPtr pipedrm_videoram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr hatris_videoram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr pipedrm_scroll_regs_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		scroll_regs[offset] = data;
	} };
	
	
	public static ReadHandlerPtr pipedrm_videoram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int which = (pipedrm_video_control >> 3) & 1;
	...
	public static ReadHandlerPtr hatris_videoram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int which = (~pipedrm_video_control >> 1) & 1;
		return local_videoram[which][offset];
	} };
	...
	public static VhUpdatePtr pipedrm_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
	...
	public static VhUpdatePtr hatris_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y;
