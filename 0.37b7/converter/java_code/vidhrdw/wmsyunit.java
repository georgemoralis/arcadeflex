...
public class wmsyunit
{
	...
	public static ReadHandlerPtr wms_yunit_gfxrom_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (pixel_mask == 0x0f)
	...
	public static WriteHandlerPtr wms_yunit_vram_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr wms_yunit_vram_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (videobank_select != 0)
	...
	public static WriteHandlerPtr wms_yunit_control_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		/*
	...
	public static ReadHandlerPtr wms_yunit_dma_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr wms_yunit_dma_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		UINT32 gfxoffset;
		int command;
	...
	public static VhUpdatePtr wms_yunit_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
