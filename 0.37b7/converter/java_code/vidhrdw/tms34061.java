...
public class tms34061
{
	...
	INLINE public static WriteHandlerPtr TMS34061_register_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
	...
	INLINE public static ReadHandlerPtr TMS34061_register_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int ret;
	...
	INLINE public static WriteHandlerPtr TMS34061_xypixel_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		// Currently only implements when the X-Y addresses are 8 bits each
		// Case #7 on Page 4-18 in User's Guide
	...
	INLINE public static ReadHandlerPtr TMS34061_xypixel_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		// Currently only implements when the X-Y addresses are 8 bits each
		// Case #7 on Page 4-18 in User's Guide
