...
public class galaxian
{
	...
	***************************************************************************/
	...
	public static InterruptPtr mariner_vh_interrupt = new InterruptPtr() { public int handler() 
	{
		stars_scroll--;
	...
	public static InterruptPtr jumpbug_vh_interrupt = new InterruptPtr() { public int handler() 
	{
		static int blink_count;
