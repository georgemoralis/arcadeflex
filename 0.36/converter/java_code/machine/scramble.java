...
public class scramble
{
	...
	{
		if (errorlog != 0) fprintf(errorlog,"%04x: read protection\n",cpu_get_pc());
	...
	public static ReadHandlerPtr scramblb_protection_1_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		default:
			if (errorlog != 0) fprintf(errorlog,"%04x: read protection 1\n",cpu_get_pc());
			return 0;
		}
	} };
	...
	public static ReadHandlerPtr scramblb_protection_2_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		default:
			if (errorlog != 0) fprintf(errorlog,"%04x: read protection 2\n",cpu_get_pc());
			return 0;
		}
	} };
	...
	{
		if (errorlog != 0) fprintf(errorlog,"PC %04x: read port 2\n",cpu_get_pc());
	...
	{
		if (errorlog != 0) fprintf(errorlog,"PC %04x: read port 3\n",cpu_get_pc());
