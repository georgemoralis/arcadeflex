...
public class bsktball
{
	...
	***************************************************************************/
	...
	bsktball_led_w
	***************************************************************************/
	public static WriteHandlerPtr bsktball_led1_w = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
	        osd_led_w(0,(offset & 0x01));
	} };
	
	public static WriteHandlerPtr bsktball_led2_w = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
