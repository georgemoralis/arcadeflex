...
public class sbrkout
{
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr sbrkout_select1 = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr sbrkout_select2 = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr sbrkout_read_DIPs = new ReadHandlerPtr() { public int handler(int offset)
	{
	        switch (offset)
	        {
	                /* DSW */
	...
	***************************************************************************/
	public static WriteHandlerPtr sbrkout_start_1_led = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
	    if (offset==0)
	        osd_led_w(0,0);
	    else
	...
	public static WriteHandlerPtr sbrkout_start_2_led = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
	    if (offset==0)
	        osd_led_w(1,0);
	    else
	...
	public static WriteHandlerPtr sbrkout_serve_led = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
	    if (offset==0)
	        osd_led_w(2,1);
	    else
