...
public class jedi
{
	...
	public static WriteHandlerPtr jedi_rom_banksel = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr jedi_sound_reset = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	    if ((data & 1) != 0)
