...
public class exctsccr
{
	...
	public static WriteHandlerPtr exctsccr_mcu_w = new WriteHandlerPtr() { public void handler(int offs, int data);
	public static WriteHandlerPtr exctsccr_mcu_control_w = new WriteHandlerPtr() { public void handler(int offs, int data);
