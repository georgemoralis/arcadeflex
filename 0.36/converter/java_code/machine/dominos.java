...
public class dominos
{
	...
	***************************************************************************/
	...
	Attract
	***************************************************************************/
	public static WriteHandlerPtr dominos_attract_w = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
	...
	Lamps
	***************************************************************************/
	public static WriteHandlerPtr dominos_lamp1_w = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
		/* Address Line 0 is the data passed to LAMP1 */
		osd_led_w(0,offset & 0x01);
	} };
	
	public static WriteHandlerPtr dominos_lamp2_w = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
	...
	Sound function
	***************************************************************************/
	public static WriteHandlerPtr dominos_tumble_w = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
		/* ??? */
		return;
	} };
