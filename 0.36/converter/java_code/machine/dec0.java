...
public class dec0
{
	...
	public static ReadHandlerPtr dec0_rotary_read = new ReadHandlerPtr() { public int handler(int offset)
	{
		switch (offset)
		{
			...
			default:
				if (errorlog != 0) fprintf(errorlog,"Unknown rotary read at 300000 %02x\n",offset);
		}
	...
	public static ReadHandlerPtr midres_controls_read = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"PC %06x unknown control read at %02x\n",cpu_get_pc(),0x180000+offset);
		return 0xffff;
	} };
	...
	public static ReadHandlerPtr slyspy_controls_read = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Unknown control read at 30c000 %d\n",offset);
		return 0xffff;
	} };
	...
	public static ReadHandlerPtr slyspy_protection_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"%04x, Unknown protection read at 30c000 %d\n",cpu_get_pc(),offset);
		return 0;
	} };
	...
	*/
	...
	public static WriteHandlerPtr slyspy_240000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Wrote to 240000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_242000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Wrote to 242000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_246000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Wrote to 246000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_248000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Wrote to 248000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_24c000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Wrote to 24c000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	public static WriteHandlerPtr slyspy_24e000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Wrote to 24e000 %02x at %04x %04x (Trap %02x)\n",offset,cpu_get_pc(),data,slyspy_state);
	} };
	...
	static public static ReadHandlerPtr hippodrm_68000_share_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset==0) cpu_yield(); /* A wee helper */
		return share[offset/2];
	} };
	
	static public static WriteHandlerPtr hippodrm_68000_share_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static void birdtry_i8751_write(int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"%04x: warning - write unknown command %02x to 8571\n",cpu_get_pc(),data);
	...
	*/
	...
	if (errorlog != 0) fprintf(errorlog,"i8751:  Timer called!!!\n");
	...
	*/
	...
	static public static ReadHandlerPtr hbarrel_cycle_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (cpu_get_pc()==0x130ca) {cpu_spinuntil_int(); return 0;} return READ_WORD(&dec0_ram[0x10]);
	} };
	
	static public static ReadHandlerPtr hbarrelu_cycle_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (cpu_get_pc()==0x131a0) {cpu_spinuntil_int(); return 0;} return READ_WORD(&dec0_ram[0x10]);
	} };
	
	static public static WriteHandlerPtr sprite_mirror = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
