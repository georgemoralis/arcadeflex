...
public class subs
{
	...
	***************************************************************************/
	...
	subs_steer_reset
	***************************************************************************/
	public static WriteHandlerPtr subs_steer_reset_w = new WriteHandlerPtr() { public void handler(int offset, int value)
	{
	    subs_steering_val1 = 0x00;
	    subs_steering_val2 = 0x00;
	} };
	...
	***************************************************************************/
	public static WriteHandlerPtr subs_lamp1_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		{
			osd_led_w(0,0);
			if (errorlog != 0) fprintf(errorlog,"LED 0 OFF\n");
		}
		else
		{
			osd_led_w(0,1);
			if (errorlog != 0) fprintf(errorlog,"LED 0 ON\n");
		}
	} };
	...
	***************************************************************************/
	public static WriteHandlerPtr subs_lamp2_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		{
			osd_led_w(1,0);
			if (errorlog != 0) fprintf(errorlog,"LED 1 OFF\n");
		}
		else
		{
			osd_led_w(1,1);
			if (errorlog != 0) fprintf(errorlog,"LED 1 ON\n");
		}
	} };
