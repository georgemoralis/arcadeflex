...
public class swmathbx
{
	...
	if (errorlog != 0) fprintf(errorlog, "Running Mathbox...\n");
	...
	if (errorlog != 0) fprintf(errorlog, "MATH ADDR: %x, CPU ADDR: %x, RAMWORD: %x\n", MA, MA_byte, RAMWORD);
	...
	public static ReadHandlerPtr prng = new ReadHandlerPtr() { public int handler(int offset)
	{
	#if(MATHDEBUG==1)
	printf("prng\n");
	#endif
	...
	/********************************************************/
	public static WriteHandlerPtr prngclr = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	#if(MATHDEBUG==1)
	printf("prngclr\n");
	#endif
	...
	/********************************************************/
	public static WriteHandlerPtr mw0 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	#if(MATHDEBUG==1)
	printf("mw0: %x\n",data);
	#endif
	...
	/********************************************************/
	/* BIC - write high bit */
	public static WriteHandlerPtr mw1 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	#if(MATHDEBUG==1)
	printf("mw1: %x\n",data);
	#endif
	...
	/********************************************************/
	/* BIC - write low byte */
	public static WriteHandlerPtr mw2 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	#if(MATHDEBUG==1)
	printf("mw2: %x\n",data);
	#endif
	...
	/********************************************************/
	public static ReadHandlerPtr reh = new ReadHandlerPtr() { public int handler(int offset)
	{
		return((RESULT & 0xff00)>>8 );
	} };
	/********************************************************/
	public static ReadHandlerPtr rel = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr swmathbx = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
