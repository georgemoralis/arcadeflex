...
public class turbo
{
	...
	*/
	...
	static public static ReadHandlerPtr portA_r = new ReadHandlerPtr() { public int handler(int chip)
	{
		if (chip == 3)
	...
	static public static ReadHandlerPtr portB_r = new ReadHandlerPtr() { public int handler(int chip)
	{
		if (chip == 3)
	...
	static public static WriteHandlerPtr portA_w = new WriteHandlerPtr() { public void handler(int chip, int data)
	{
		switch (chip)
		{
	...
	static public static WriteHandlerPtr portB_w = new WriteHandlerPtr() { public void handler(int chip, int data)
	{
		switch (chip)
		{
				...
				*/
				...
				if (!(data & 0x40))
				{
					if (!sample_playing(7))
						...
						if (errorlog != 0) fprintf(errorlog, "ambu didnt start\n");
				}
				else
					sample_stop(7);
	...
	static public static WriteHandlerPtr portC_w = new WriteHandlerPtr() { public void handler(int chip, int data)
	{
		switch (chip)
		{
	...
	*******************************************/
	...
	public static ReadHandlerPtr turbo_8279_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		{
			if (errorlog != 0) fprintf(errorlog, "read 0xfc%02x\n", offset);
			return 0x10;
		}
	} };
