...
public class phozon
{
	...
	************************************************************************************/
	...
	public static WriteHandlerPtr phozon_customio_w_1 = new WriteHandlerPtr() { public void handler(int offset, int data){
		phozon_customio_1[offset] = data;
	} };
	
	public static WriteHandlerPtr phozon_customio_w_2 = new WriteHandlerPtr() { public void handler(int offset, int data){
	...
	public static ReadHandlerPtr phozon_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset){
	...
	public static ReadHandlerPtr phozon_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int mode, val;
