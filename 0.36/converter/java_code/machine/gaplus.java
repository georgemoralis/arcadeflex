...
public class gaplus
{
	...
	************************************************************************************/
	...
	public static WriteHandlerPtr gaplus_customio_w_1 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	    gaplus_customio_1[offset] = data;
	} };
	
	public static WriteHandlerPtr gaplus_customio_w_2 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	    gaplus_customio_2[offset] = data;
	} };
	
	public static WriteHandlerPtr gaplus_customio_w_3 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr gaplus_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr gaplus_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int val, mode;
	...
	public static ReadHandlerPtr gaplus_customio_r_3 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int mode;
	...
	************************************************************************************/
	...
	public static ReadHandlerPtr gaplusa_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int mode, val, temp1, temp2;
	...
	public static ReadHandlerPtr gaplusa_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int val, mode;
	...
	public static ReadHandlerPtr gaplusa_customio_r_3 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int mode;
	...
	************************************************************************************/
	...
	public static ReadHandlerPtr galaga3_customio_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int mode;
	...
	public static ReadHandlerPtr galaga3_customio_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int val, mode;
	...
	public static ReadHandlerPtr galaga3_customio_r_3 = new ReadHandlerPtr() { public int handler(int offset)
	{
	    int mode;
