...
public class qix
{
	...
	static public static ReadHandlerPtr sdungeon_coin_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr sdungeon_coinctrl_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr sdungeon_coin_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	static public static ReadHandlerPtr qix_sound_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr qix_dac_w = new WriteHandlerPtr() { public void handler(int offset, int data);
