...
public class williams
{
	...
	static public static WriteHandlerPtr williams_snd_cmd_w = new WriteHandlerPtr() { public void handler(int offset, int cmd);
	
	/* input port mapping */
	static UINT8 port_select;
	static public static WriteHandlerPtr williams_port_select_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static ReadHandlerPtr williams_input_port_0_3_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr williams_input_port_1_4_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr williams_49way_port_0_r = new ReadHandlerPtr() { public int handler(int offset);
	
	/* newer-Williams routines */
	public static WriteHandlerPtr williams2_bank_select = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams2_snd_cmd_w = new WriteHandlerPtr() { public void handler(int offset, int cmd);
	...
	static public static ReadHandlerPtr defender_io_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr defender_io_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	static public static ReadHandlerPtr tshoot_input_port_0_3 = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr tshoot_lamp_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr tshoot_maxvol_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	/* Joust 2-specific code */
	static public static WriteHandlerPtr joust2_snd_cmd_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr joust2_pia_3_cb1_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	public static WriteHandlerPtr williams2_7segment = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		int n;
		char dot;
		char buffer[5];
	...
	public static WriteHandlerPtr joust2_snd_cmd_w = new WriteHandlerPtr() { public void handler(int offset, int cmd)
	{
