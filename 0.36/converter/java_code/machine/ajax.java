...
public class ajax
{
	...
	*/
	...
	static public static WriteHandlerPtr ajax_bankswitch_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	*/
	...
	static public static WriteHandlerPtr ajax_lamps_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	*/
	...
	public static ReadHandlerPtr ajax_ls138_f10_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		switch ((offset & 0x01c0) >> 6){
			...
			default:
				if (errorlog != 0) fprintf(errorlog,"%04x: (ls138_f10) read from an unknown address %02x\n",cpu_get_pc(), offset);
		}
	...
	public static WriteHandlerPtr ajax_ls138_f10_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		switch ((offset & 0x01c0) >> 6){
			...
			default:
				if (errorlog != 0) fprintf(errorlog,"%04x: (ls138_f10) write %02x to an unknown address %02x\n",cpu_get_pc(), data, offset);
		}
	} };
