...
public class smashtv
{
	...
	static public static WriteHandlerPtr narc_sound_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr adpcm_sound_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr cvsd_sound_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	public static WriteHandlerPtr wms_vram_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static WriteHandlerPtr wms_objpalram_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static ReadHandlerPtr wms_vram_r = new ReadHandlerPtr() { public int handler(int offset);
	public static ReadHandlerPtr wms_objpalram_r = new ReadHandlerPtr() { public int handler(int offset);
	...
	static public static ReadHandlerPtr narc_input_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int ans = 0xffff;
		switch (offset)
		{
	...
	//		break;
		default:
			if (errorlog != 0) fprintf(errorlog, "CPU #0 PC %08x: warning - read from unmapped bit address %x\n", cpu_get_pc(), (offset<<3));
		}
		return ans;
	} };
	public static ReadHandlerPtr wms_input_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int ans = 0xffff;
		switch (offset)
		{
	...
	static public static ReadHandlerPtr term2_input_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int ans = 0xffff;
		switch (offset)
		{
	...
	static public static ReadHandlerPtr term2_input_lo_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int ans = 0xffff;
		switch (offset)
		{
	...
	static public static WriteHandlerPtr term2_sound_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if (offset == 0)
		{
	...
	static public static ReadHandlerPtr irq_callback = new ReadHandlerPtr() { public int handler(int irqline)
	{
	...
	public static ReadHandlerPtr wms_dma_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if ((wms_dma_stat & 0x8000) != 0)
		{
			...
			default:
	//			if (errorlog != 0) fprintf(errorlog, "CPU #0 PC %08x: read hi dma\n", cpu_get_pc());
				break;
			}
		}
		return wms_dma_stat;
	...
	#define DMA2_GET_SKIPS(xdir)									\
		...
		{															\
			...
			{														\
				...
				if ((write_cols_do & 0x80000000) != 0) write_cols_do = 1;	\
			}														\
			wms_dma_8pos+=4;										\
		}															\
	...
	//		wms_dma_pal = (data&0xffff);
		...
		case 0x1e:
			...
			break;
		default:
			if (errorlog != 0) fprintf(errorlog,"dma offset %x: %x\n",offset, data);
			break;
		}
	} };
	...
	public static WriteHandlerPtr wms_01c00060_w = new WriteHandlerPtr() { public void handler(int offset, int data)/* protection and more */
	{
		if ((data&0xfdff) == 0x0000) /* enable CMOS write */
		{
			smashtv_cmos_w_enable = 1;
	//		if (errorlog != 0) fprintf(errorlog, "Enable CMOS writes\n");
		}
		else if ((data&0xfdff) == 0x0100) /* disable CMOS write */
		{
	//		smashtv_cmos_w_enable = 0;
	//		if (errorlog != 0) fprintf(errorlog, "Disable CMOS writes\n");
		}
		else
		if (errorlog != 0) fprintf(errorlog, "CPU #0 PC %08x: warning - write %x to protection chip\n", cpu_get_pc(), data);
	} };
	public static ReadHandlerPtr wms_01c00060_r = new ReadHandlerPtr() { public int handler(int offset)/* protection and more */
	{
		...
		if (errorlog != 0) fprintf(errorlog, "CPU #0 PC %08x: warning - unhandled read from protection chip\n",cpu_get_pc());
		return 0xffffffff;
	} };
	...
	public static WriteHandlerPtr wms_sysreg_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if ((data & 0x10) != 0) /* turn off auto-erase */
		{
			if (wms_autoerase_enable != 0)
	...
	//	if (errorlog != 0) fprintf(errorlog, "wms_unk1:       %04x\n", data);
	//#ifdef MAME_DEBUG
	...
	static public static ReadHandlerPtr narc_unknown_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int ans = 0xffff;
		return ans;
	} };
	...
	{
		if (smashtv_cmos_w_enable != 0)
		{
			COMBINE_WORD_MEM(&wms_cmos_ram[(offset)+wms_cmos_page], data);
		}
		else
		if (errorlog != 0) fprintf(errorlog, "CPU #0 PC %08x: warning - write %x to disabled CMOS address %x\n", cpu_get_pc(), data, offset);
	...
	static public static ReadHandlerPtr narc_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr smashtv_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr smashtv4_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr totcarn_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr trogp_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr trog_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr trog3_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr mk_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr mkla1_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr mkla2_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr mkla3_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr mkla4_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (!offset)
		{
	...
	static public static ReadHandlerPtr hiimpact_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (!offset)
		{
	...
	static public static ReadHandlerPtr shimpact_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (!offset)
		{
	...
	static public static ReadHandlerPtr term2_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	public static ReadHandlerPtr strkforc_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (!offset)
		{
	...
	static public static ReadHandlerPtr mk2_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (!offset)
		{
	...
	static public static ReadHandlerPtr mk2r14_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static ReadHandlerPtr nbajam_speedup_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		if (offset != 0)
		{
	...
	static public static WriteHandlerPtr wms_modify_pen = new WriteHandlerPtr() { public void handler(int i, int rgb)
	{
	...
	static public static WriteHandlerPtr wms_8bit_t_paletteram_xRRRRRGGGGGBBBBB_word_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		int i;
	...
	static public static WriteHandlerPtr wms_8bit_paletteram_xRRRRRGGGGGBBBBB_word_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		int i;
		int oldword = READ_WORD(&paletteram[offset]);
		int newword = COMBINE_WORD(oldword,data);
	...
	static public static WriteHandlerPtr wms_6bit_paletteram_xRRRRRGGGGGBBBBB_word_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		/*
	...
	static public static WriteHandlerPtr wms_4bit_paletteram_xRRRRRGGGGGBBBBB_word_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		/*
		 * the palette entry to find is mapped like this:
		 * Bit 07 - PAL Bit 07
	...
	public static InitMachinePtr narc_init_machine = new InitMachinePtr() { public void handler() 
	{
		/*
		 * Z-Unit
		 *
	...
	public static InitMachinePtr smashtv_init_machine = new InitMachinePtr() { public void handler() 
	{
		/*
		 * Y-Unit
		 *
	...
	public static InitMachinePtr mk_init_machine = new InitMachinePtr() { public void handler() 
	{
		/*
		 * Y-Unit
		 *
	...
	public static InitMachinePtr term2_init_machine = new InitMachinePtr() { public void handler() 
	{
		/*
		 * Y-Unit
		 *
	...
	public static InitMachinePtr trog_init_machine = new InitMachinePtr() { public void handler() 
	{
		/*
		 * Y-Unit
		 *
	...
	public static InitMachinePtr mk2_init_machine = new InitMachinePtr() { public void handler() 
	{
		if (!wms_rom_loaded)
		{
			wms_load_code_roms();
	...
	public static InitMachinePtr nbajam_init_machine = new InitMachinePtr() { public void handler() 
	{
		if (!wms_rom_loaded)
		{
			wms_load_code_roms();
	...
	static public static WriteHandlerPtr cvsd_sound_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if (errorlog != 0) fprintf(errorlog, "CPU #0 PC %08x: ", cpu_get_pc());
		if (errorlog != 0) fprintf(errorlog, "sound write %x\n", data);
