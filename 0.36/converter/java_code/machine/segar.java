...
public class segar
{
	...
	extern public static WriteHandlerPtr segar_characterram_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	extern public static WriteHandlerPtr segar_characterram2_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	extern public static WriteHandlerPtr segar_colortable_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	extern public static WriteHandlerPtr segar_bcolortable_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	
	public static WriteHandlerPtr segar_wr = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		int pc,op,page,off;
		unsigned int bad;
		...
		{
			if (errorlog != 0) fprintf(errorlog, "unmapped write at %04X:%02X\n",off,data);
		}
	} };
