...
public class tait8741
{
	...
	/* read status port */
	static public static ReadHandlerPtr I8741_status_r = new ReadHandlerPtr() { public int handler(int num)
	{
		I8741 *st = &taito8741[num];
	...
	/* read data port */
	static public static ReadHandlerPtr I8741_data_r = new ReadHandlerPtr() { public int handler(int num)
	{
		I8741 *st = &taito8741[num];
		int ret = st.toData;
		st.status &= 0xfe;
	...
	/* Write data port */
	static public static WriteHandlerPtr I8741_data_w = new WriteHandlerPtr() { public void handler(int num, int data)
	{
		I8741 *st = &taito8741[num];
	#if __log__
	...
	/* Write command port */
	static public static WriteHandlerPtr I8741_command_w = new WriteHandlerPtr() { public void handler(int num, int data)
	{
		I8741 *st = &taito8741[num];
	#if __log__
