...
public class toaplan1
{
	...
	public static ReadHandlerPtr demonwld_dsp_in = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr demonwld_dsp_out = new WriteHandlerPtr() { public void handler(int fnction, int data)
	{
		if (fnction == 0) {
		...
		if (fnction == 3) {
			...
			if (data == 0) {
				if (dsp_execute != 0) {
					if (errorlog != 0) fprintf(errorlog,"Turning 68000 on\n");
	...
	public static WriteHandlerPtr demonwld_dsp_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		switch (data) {
			case 0x0000: 	/* This means assert the INT line to the DSP */
							if (errorlog != 0) fprintf(errorlog,"Turning DSP on and 68000 off\n");
	...
	{
		if (errorlog != 0) fprintf(errorlog,"Z80 writing %02x to coin control\n",data);
