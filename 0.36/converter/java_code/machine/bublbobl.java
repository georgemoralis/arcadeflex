...
public class bublbobl
{
	...
	public static WriteHandlerPtr tokio_nmitrigger_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	***************************************************************************/
	...
	if (errorlog != 0) fprintf(errorlog,"%04x: 68705 unknown read address %04x\n",cpu_get_pc(),address);
			}
			else	/* write */
			{
	...
	if (errorlog != 0) fprintf(errorlog,"%04x: 68705 unknown write to address %04x\n",cpu_get_pc(),address);
			}
		}
		...
		{
	if (errorlog != 0) fprintf(errorlog,"%04x: 68705 unknown port B bit %02x\n",cpu_get_pc(),data);
		}
