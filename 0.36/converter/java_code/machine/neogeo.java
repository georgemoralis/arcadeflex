...
public class neogeo
{
	...
	void init_neogeo(void)
	{
		...
		{
			if (errorlog != 0) fprintf(errorlog,"using memory region %d for Delta T samples\n",REGION_SOUND2);
	...
	static public static ReadHandlerPtr bios_cycle_skip_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		cpu_spinuntil_int();
		return 0;
	} };
	...
	/******************************************************************************/
	#define NEO_CYCLE_R(name,pc,hit,other) static public static ReadHandlerPtr name##_cycle_r = new ReadHandlerPtr() { public int handler(int offset){	if (cpu_get_pc()==pc) {cpu_spinuntil_int(); return hit;} return other;} };
	#define NEO_CYCLE_RX(name,pc,hit,other,xxx) static public static ReadHandlerPtr name##_cycle_r = new ReadHandlerPtr() { public int handler(int offset){	if (cpu_get_pc()==pc) {if(other==xxx) cpu_spinuntil_int(); return hit;} return other;} };
	...
	static public static ReadHandlerPtr mahretsu_cycle_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int pc=cpu_get_pc();
	...
	static public static ReadHandlerPtr samsho_cycle_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int pc=cpu_get_pc();
	...
	static public static ReadHandlerPtr minasan_cycle_r = new ReadHandlerPtr() { public int handler(int offset)
	{
	        int mem;
	...
	static public static ReadHandlerPtr bakatono_cycle_r = new ReadHandlerPtr() { public int handler(int offset)
	{
	        int mem;
	 ...
	 *
	 */
	static public static ReadHandlerPtr cycle_v3_sr = new ReadHandlerPtr() { public int handler(int offset)
	{
	 ...
	 */
	static public static ReadHandlerPtr ssideki_cycle_sr = new ReadHandlerPtr() { public int handler(int offset)
	{
		unsigned char *RAM = memory_region(REGION_CPU2);
	...
	static public static ReadHandlerPtr aof_cycle_sr = new ReadHandlerPtr() { public int handler(int offset)
	{
		unsigned char *RAM = memory_region(REGION_CPU2);
	...
	static public static ReadHandlerPtr cycle_v2_sr = new ReadHandlerPtr() { public int handler(int offset)
	{
		unsigned char *RAM = memory_region(REGION_CPU2);
	...
	static public static ReadHandlerPtr vwpoint_cycle_sr = new ReadHandlerPtr() { public int handler(int offset)
	{
		unsigned char *RAM = memory_region(REGION_CPU2);
	...
	*/
	...
	static public static ReadHandlerPtr maglord_cycle_sr = new ReadHandlerPtr() { public int handler(int offset)
	{
		unsigned char *RAM = memory_region(REGION_CPU2);
	...
	static public static ReadHandlerPtr fatfury2_protection_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		switch (offset)
		{
			...
			default:
	if (errorlog != 0) fprintf(errorlog,"unknown protection read at pc %06x, offset %08x\n",cpu_get_pc(),offset);
				return 0;
		}
	} };
	
	static public static WriteHandlerPtr fatfury2_protection_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		switch (offset)
		{
			...
			default:
	if (errorlog != 0) fprintf(errorlog,"unknown protection write at pc %06x, offset %08x, data %02x\n",cpu_get_pc(),offset,data);
				break;
		}
	} };
	
	static public static ReadHandlerPtr popbounc_sfix_r = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr neogeo_sram_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if (sram_locked != 0)
		{
	if (errorlog != 0) fprintf(errorlog,"PC %06x: warning: write %02x to SRAM %04x while it was protected\n",cpu_get_pc(),data,offset);
		}
		else
		{
	...
	*/
	...
	public static ReadHandlerPtr neogeo_memcard_load = new ReadHandlerPtr() { public int handler(int number)
	{
	    char name[16];
	    void *f;
	...
	public static ReadHandlerPtr neogeo_memcard_create = new ReadHandlerPtr() { public int handler(int number)
	{
	    char buf[0x800];
	    char name[16];
	    void *f1, *f2;
