...
public class grobda
{
	...
	***************************************************************************/
	public static VhConvertColorPromPtr grobda_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	public static VhStartPtr grobda_vh_start = new VhStartPtr() { public int handler() 
	{
	...
	public static VhStopPtr grobda_vh_stop = new VhStopPtr() { public void handler() 
	{
		generic_vh_stop();
	} };
	...
	***************************************************************************/
	...
	public static VhUpdatePtr grobda_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
