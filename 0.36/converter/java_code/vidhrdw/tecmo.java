...
public class tecmo
{
	...
	***************************************************************************/
	...
	public static VhStartPtr rygar_vh_start = new VhStartPtr() { public int handler() 
	{
		video_type = 0;
	...
	public static VhStartPtr gemini_vh_start = new VhStartPtr() { public int handler() 
	{
		video_type = 2;
		return tecmo_vh_start();
	} };
	...
	***************************************************************************/
	public static VhStopPtr tecmo_vh_stop = new VhStopPtr() { public void handler() {
	...
	public static WriteHandlerPtr tecmo_videoram_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr tecmo_colorram_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
