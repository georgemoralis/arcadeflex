...
public class footchmp
{
	...
	***************************************************************************/
	...
	#define LAYER_CALLBACK( layer_name ) \
		static public static WriteHandlerPtr layer_name##_map_info = new WriteHandlerPtr() { public void handler(int col, int row){ \
	...
	static public static WriteHandlerPtr text_layer_info = new WriteHandlerPtr() { public void handler(int col, int row){
	...
	#define LAYER_READ( layer_name ) \
		public static ReadHandlerPtr footchmp_##layer_name##ram_r = new ReadHandlerPtr() { public int handler(int offset){ \
			return READ_WORD( &footchmp_##layer_name##_ram[offset] ); \
		} };
	
	#define LAYER_WRITE( layer_name ) \
		public static WriteHandlerPtr footchmp_##layer_name##ram_w = new WriteHandlerPtr() { public void handler(int offset, int data){ \
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr footchmp_textram_r = new ReadHandlerPtr() { public int handler(int offset){
		return READ_WORD( &footchmp_text_ram[offset] );
	} };
	
	public static WriteHandlerPtr footchmp_textram_w = new WriteHandlerPtr() { public void handler(int offset, int data){
	...
	public static ReadHandlerPtr footchmp_chargen_r = new ReadHandlerPtr() { public int handler(int offset){
		int res;
	...
	public static WriteHandlerPtr footchmp_chargen_w = new WriteHandlerPtr() { public void handler(int offset, int data){
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr footchmp_spriteram_r = new ReadHandlerPtr() { public int handler(int offset){
		return READ_WORD( &spriteram[offset] );
	} };
	
	public static WriteHandlerPtr footchmp_spriteram_w = new WriteHandlerPtr() { public void handler(int offset, int data){
		COMBINE_WORD_MEM( &spriteram[offset], data );
	} };
	
	public static WriteHandlerPtr footchmp_spritebank_w = new WriteHandlerPtr() { public void handler(int offset, int data){
		if (errorlog != 0) fprintf (errorlog, "PC = %06x: bank %d, new value: %04x\n", cpu_get_pc(), offset >> 1, ( data & 0x0f ) << 10);
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr footchmp_scroll_w = new WriteHandlerPtr() { public void handler(int offset, int data){
	...
	***************************************************************************/
	...
	public static VhStartPtr footchmp_vh_start = new VhStartPtr() { public int handler() 
	{
	...
	public static VhStopPtr footchmp_vh_stop = new VhStopPtr() { public void handler()  {
		free( char_dirty );
	} };
}
