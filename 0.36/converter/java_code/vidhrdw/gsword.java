...
public class gsword
{
	...
	public static VhConvertColorPromPtr gsword_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
	...
	public static VhUpdatePtr gsword_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
