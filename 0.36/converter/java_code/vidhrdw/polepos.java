...
public class polepos
{
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr polepos_sprite_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return READ_WORD(&polepos_sprite_memory[offs]);
	} };
	
	public static WriteHandlerPtr polepos_sprite_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
		COMBINE_WORD_MEM(&polepos_sprite_memory[offs], data);
	} };
	
	public static ReadHandlerPtr polepos_z80_sprite_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return polepos_sprite_r(offs << 1) & 0xff;
	} };
	
	public static WriteHandlerPtr polepos_z80_sprite_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr polepos_road_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return READ_WORD(&polepos_road_memory[offs]);
	} };
	
	public static WriteHandlerPtr polepos_road_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
		COMBINE_WORD_MEM(&polepos_road_memory[offs], data);
	} };
	
	public static ReadHandlerPtr polepos_z80_road_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return polepos_road_r(offs << 1) & 0xff;
	} };
	
	public static WriteHandlerPtr polepos_z80_road_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
		polepos_road_w(offs << 1, data | 0xff000000);
	} };
	
	public static WriteHandlerPtr polepos_road_vscroll_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
		road_vscroll = data;
	} };
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr polepos_view_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return READ_WORD(&polepos_view_memory[offs]);
	} };
	
	public static WriteHandlerPtr polepos_view_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	...
	public static ReadHandlerPtr polepos_z80_view_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return polepos_view_r(offs << 1) & 0xff;
	} };
	
	public static WriteHandlerPtr polepos_z80_view_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
		polepos_view_w(offs << 1, data | 0xff000000);
	} };
	
	public static WriteHandlerPtr polepos_view_hscroll_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
		view_hscroll = data;
	} };
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr polepos_alpha_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return READ_WORD(&polepos_alpha_memory[offs]);
	} };
	
	public static WriteHandlerPtr polepos_alpha_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	...
	public static ReadHandlerPtr polepos_z80_alpha_r = new ReadHandlerPtr() { public int handler(int offs)
	{
		return polepos_alpha_r(offs << 1) & 0xff;
	} };
	
	public static WriteHandlerPtr polepos_z80_alpha_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
