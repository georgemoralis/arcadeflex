...
public class aerofgt
{
	...
	***************************************************************************/
	...
	public static VhStartPtr aerofgt_vh_start = new VhStartPtr() { public int handler() 
	{
		bg2_chardisplacement = 0;
		return common_vh_start(512,512);
	} };
	
	public static VhStartPtr aerofgtb_vh_start = new VhStartPtr() { public int handler() 
	{
	...
	***************************************************************************/
	public static VhStopPtr aerofgt_vh_stop = new VhStopPtr() { public void handler() 
	{
		free(dirtybuffer);
		osd_free_bitmap(tmpbitmap);
		free(dirtybuffer2);
