...
public class m92
{
	...
	static public static WriteHandlerPtr get_pf1_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_pf1_htile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs,tile,color,pri;
		offs=(col*4) + (row*256);
		offs+=0xc000;
	...
	static public static WriteHandlerPtr get_pf1_ltile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs,tile,color,pri;
		offs=(col*4) + (row*256);
	...
	static public static WriteHandlerPtr get_pf2_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs,tile,color,pri;
		offs=(col*4) + (row*256);
		offs+=pf2_vram_ptr;
	...
	static public static WriteHandlerPtr get_pf3_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs,tile,color,pri;
		offs=(col*4) + (row*256);
		offs+=pf3_vram_ptr;
	...
	static public static WriteHandlerPtr get_pf1_wide_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs,tile,color,pri;
		offs=(col*4) + (row*512);
		offs+=pf1_vram_ptr;
	...
	static public static WriteHandlerPtr get_pf3_wide_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs,tile,color,pri;
		offs=(col*4) + (row*512);
		offs+=pf3_vram_ptr;
