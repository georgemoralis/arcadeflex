...
public class ginganin
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_txt_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	//		case 0xa : break;
			...
			default  : {if (errorlog != 0) fprintf(errorlog, "CPU #0 PC %06X : Warning, videoreg %04X <- %04X\n",cpu_get_pc(),offset,data);}
		}
	} };
	...
	int color, colmask[16];
		...
		if ((layers_ctrl1 & 4) != 0)	tilemap_draw(bitmap, txt_tilemap, 0);
