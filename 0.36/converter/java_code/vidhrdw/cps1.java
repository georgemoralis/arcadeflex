...
public class cps1
{
	...
	********************************************************************/
	...
	INLINE public static ReadHandlerPtr cps1_port = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	*/
	...
	void cps1_gfx_stop(void)
	{
		...
		if (cps1_char_pen_usage != 0)
		{
			free(cps1_char_pen_usage);
		}
		if (cps1_tile16_pen_usage != 0)
		{
			free(cps1_tile16_pen_usage);
		}
		if (cps1_tile32_pen_usage != 0)
		{
