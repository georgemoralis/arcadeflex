...
public class blockout
{
	...
	static public static WriteHandlerPtr setcolor = new WriteHandlerPtr() { public void handler(int color, int rgb)
	{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr updatepixels = new WriteHandlerPtr() { public void handler(int x, int y)
	{
		int front,back;
		int color;
