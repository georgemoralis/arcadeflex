...
public class senjyo
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr senjyo_get_bg1_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr starforc_get_bg1_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_bg3_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = 16*row+col;
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr senjyo_flipscreen_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
