...
public class phoenix
{
	...
	***************************************************************************/
	public static VhConvertColorPromPtr phoenix_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr phoenix_input_port_0_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		case 0x30:
			...
			break;
		default:
			if (errorlog != 0) fprintf(errorlog, "Unknown protection question %02X at %04X\n", protection_question, cpu_get_pc());
		}
