...
public class snk68
{
	...
	static public static WriteHandlerPtr get_pow_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_sar_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs=(row*4) + (col*128);
