...
public class capbowl
{
	...
	static public static ReadHandlerPtr capbowl_tms34061_getfunction = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr capbowl_tms34061_getrowaddress = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr capbowl_tms34061_getcoladdress = new ReadHandlerPtr() { public int handler(int offset);
