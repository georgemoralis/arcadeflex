...
public class mystston
{
	...
	***************************************************************************/
	public static VhConvertColorPromPtr mystston_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr mystston_2000_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		/* other bits unused? */
	if (errorlog != 0) fprintf(errorlog,"PC %04x: 2000 = %02x\n",cpu_get_pc(),data);
	} };
