...
public class xain
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_bgram0_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_bgram1_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int addr = (col & 0xf)|((col & 0x10)<<4)|((row & 0xf)<<4)|((row & 0x10)<<5);
