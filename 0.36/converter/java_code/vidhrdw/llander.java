...
public class llander
{
	...
	***************************************************************************/
	...
	int llander_start(void)
	{
		...
		if (llander_panel != 0) backdrop_refresh(llander_panel);
		if (llander_lit_panel != 0) backdrop_refresh(llander_lit_panel);
		return 0;
	}
	...
	*/
	...
	{
		/*      if (errorlog != 0) fprintf (errorlog, "LANDER LED: %02x\n",data); */
