...
public class wc90b
{
	...
	public static WriteHandlerPtr wc90b_tile_videoram_w = new WriteHandlerPtr() { public void handler(int offset, int v){
	...
	public static WriteHandlerPtr wc90b_tile_colorram_w = new WriteHandlerPtr() { public void handler(int offset, int v){
	...
	public static WriteHandlerPtr wc90b_tile_videoram2_w = new WriteHandlerPtr() { public void handler(int offset, int v){
	...
	public static WriteHandlerPtr wc90b_tile_colorram2_w = new WriteHandlerPtr() { public void handler(int offset, int v){
	...
	public static WriteHandlerPtr wc90b_shared_w = new WriteHandlerPtr() { public void handler(int offset, int v){
