...
public class taitol
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_bg18_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_bg19_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_char1a_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
