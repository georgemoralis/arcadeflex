...
public class xexex
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr K053157_get_char01_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr K053157_get_char11_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
