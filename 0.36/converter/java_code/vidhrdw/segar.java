...
public class segar
{
	...
	***************************************************************************/
	...
	{
		if (errorlog != 0) fprintf(errorlog, "VPort = %02X\n",data);
	...
	***************************************************************************/
	public static WriteHandlerPtr segar_colortable_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		{
			if (errorlog != 0) fprintf(errorlog,"color %02X:%02X (write=%d)\n",offset,data,sv.color_write_enable);
	...
	***************************************************************************/
	public static VhUpdatePtr segar_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	...
	***************************************************************************/
	public static VhUpdatePtr spaceod_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
		int charcode;
	...
	***************************************************************************/
	public static VhUpdatePtr monsterb_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
		int charcode;
		int sprite_transparency;
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr pignewt_back_ports_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Port %02X:%02X\n",offset + 0xb8,data);
	...
	***************************************************************************/
	public static VhUpdatePtr sindbadm_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
		int charcode;
		int sprite_transparency;
