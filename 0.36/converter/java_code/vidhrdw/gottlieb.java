...
public class gottlieb
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr gottlieb_video_outputs = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr usvsthem_video_outputs = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		background_priority = data & 1;
