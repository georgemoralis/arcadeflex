...
public class namcos1
{
	...
	*/
	...
	public static VhConvertColorPromPtr namcos1_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	static public static WriteHandlerPtr namcos1_playfield_control_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
		/* 0-15 : scrolling */
		if ( offs < 16 )
		{
	...
	static public static WriteHandlerPtr namcos1_spriteram_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	8-15 unknown
	*/
	static public static WriteHandlerPtr namcos1_displaycontrol_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static public static WriteHandlerPtr background_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr foreground_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
