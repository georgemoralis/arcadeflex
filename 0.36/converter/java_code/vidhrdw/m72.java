...
public class m72
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr m72_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr m72_get_fg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = 4*(64*row+col);
	...
	static public static WriteHandlerPtr dbreed_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = 4*(64*row+col);
		unsigned char attr = m72_videoram2[tile_index+1];
		SET_TILE_INFO(2,m72_videoram2[tile_index] + ((attr & 0x3f) << 8),m72_videoram2[tile_index+2] & 0x0f)
	...
	static public static WriteHandlerPtr rtype2_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = 4*(64*row+col);
	...
	static public static WriteHandlerPtr rtype2_get_fg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = 4*(64*row+col);
	...
	static public static WriteHandlerPtr majtitle_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr hharry_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		hharry_get_tile_info(1,m72_videoram2,col,row);
	} };
	
	static public static WriteHandlerPtr hharry_get_fg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
