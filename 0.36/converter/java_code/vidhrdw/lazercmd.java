...
public class lazercmd
{
	...
	/*     3      6 + 7      11      16 + 17 */
	/*     4      8 + 9      12      18 + 19 */
	static  public static ReadHandlerPtr vert_scale = new ReadHandlerPtr() { public int handler(int data)
	{
	...
	static  public static WriteHandlerPtr plot_pattern = new WriteHandlerPtr() { public void handler(int x, int y)
	{
	int xbit, ybit, size;
	    size = 2;
	...
	public static VhUpdatePtr lazercmd_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	int     i;
