...
public class liberatr
{
	...
	*/
	 ...
	 ********************************************************************************************/
	static public static ReadHandlerPtr liberatr_init_planet = new ReadHandlerPtr() { public int handler(int planet_select)
	{
		UINT16 longitude;
		UINT8 *planet_rom;
	...
	***************************************************************************/
	...
	public static VhUpdatePtr liberatr_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
