...
public class sf1
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_bgb_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_bgm_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int addr = (col*32 + row*2 + 128) & 0xffff;
	...
	***************************************************************************/
	...
	INLINE public static ReadHandlerPtr sf1_invert = new ReadHandlerPtr() { public int handler(int nb)
	{
