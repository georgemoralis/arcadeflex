...
public class dcon
{
	...
	public static WriteHandlerPtr dcon_control_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		dcon_enable=data;
		if ((dcon_enable&4)==4)
	...
	public static WriteHandlerPtr dcon_background_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(&dcon_back_data[offset],data);
		tilemap_mark_tile_dirty( background_layer,(offset/2)%32,(offset/2)/32 );
	} };
	
	public static WriteHandlerPtr dcon_foreground_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(&dcon_fore_data[offset],data);
		tilemap_mark_tile_dirty( foreground_layer,(offset/2)%32,(offset/2)/32 );
	} };
	
	public static WriteHandlerPtr dcon_midground_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static public static WriteHandlerPtr get_mid_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs=(col*2) + (row*64);
