...
public class combatsc
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_tile_info1 = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = row*32 + col;
	...
	static public static WriteHandlerPtr get_text_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_tile_info0_bootleg = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = row*32 + col;
		unsigned char attributes = combasc_page[0][tile_index];
		int bank = 4*((combasc_vreg & 0x0f) - 1);
	...
	static public static WriteHandlerPtr get_tile_info1_bootleg = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = row*32 + col;
		unsigned char attributes = combasc_page[1][tile_index];
		int bank = 4*((combasc_vreg >> 4) - 1);
	...
	static public static WriteHandlerPtr get_text_info_bootleg = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index = row*32 + col + 0x800;
	//	unsigned char attributes = combasc_page[0][tile_index];
		int number = combasc_page[0][tile_index + 0x400];
