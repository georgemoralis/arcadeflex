...
public class dec0
{
	...
	static void dec0_pf1_update(void)
	{
		...
		switch (READ_WORD(&dec0_pf1_control_0[6])&0xf)
		{
			...
			case 2:	/* 1x4 */
				...
				break;
			default:
				if (errorlog != 0) fprintf(errorlog,"error: pf1_update with unknown shape %04x\n",READ_WORD(&dec0_pf1_control_0[6]));
				return;
		}
	...
	static public static WriteHandlerPtr dec0_pf2_update = new WriteHandlerPtr() { public void handler(int transparent, int special)
	{
		int offs,mx,my,color,tile,quarter;
		int offsetx[4],offsety[4];
		...
		switch (READ_WORD(&dec0_pf2_control_0[6])&0xf)
		{
			...
			case 2:	/* 1x4 */
				...
				break;
			default:
				if (errorlog != 0) fprintf(errorlog,"error: pf2_update with unknown shape %04x\n",READ_WORD(&dec0_pf2_control_0[6]));
				return;
		}
	...
	static public static WriteHandlerPtr dec0_pf3_update = new WriteHandlerPtr() { public void handler(int transparent, int special)
	{
		int offs,mx,my,color,tile,quarter;
		int offsetx[4],offsety[4];
		static int last_transparent;
		...
		switch (READ_WORD(&dec0_pf3_control_0[6])&0xf)
		{
			...
			case 2:	/* 1x4 */
				...
				break;
			default:
				if (errorlog != 0) fprintf(errorlog,"error: pf3_update with unknown shape %04x\n",READ_WORD(&dec0_pf3_control_0[6]));
				return;
		}
