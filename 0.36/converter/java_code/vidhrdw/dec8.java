...
public class dec8
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr dec8_pf1_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	  ...
	  if (errorlog != 0) fprintf(errorlog,"Write %d to playfield 1 register %d\n",data,offset);
	} };
	...
	public static WriteHandlerPtr dec8_pf2_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	  ...
	  if (errorlog != 0) fprintf(errorlog,"Write %d to playfield 2 register %d\n",data,offset);
	} };
	...
	static public static WriteHandlerPtr get_srdarwin_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
