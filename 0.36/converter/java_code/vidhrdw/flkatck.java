...
public class flkatck
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_tile_info_A = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int offs = row*32 + col;
	...
	static public static WriteHandlerPtr get_tile_info_B = new WriteHandlerPtr() { public void handler(int col, int row)
	{
