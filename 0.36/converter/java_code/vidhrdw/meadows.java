...
public class meadows
{
	...
	/* video handler stop                                        */
	/*************************************************************/
	public static VhStopPtr meadows_vh_stop = new VhStopPtr() { public void handler() 
	{
		if (overlay != 0)
	...
	/*************************************************************/
	static public static WriteHandlerPtr meadows_char_dirty = new WriteHandlerPtr() { public void handler(int x, int y)
	{
	int     i;
		/* scan sprites */
		for (i = 0; i < 4; i++)
	...
	/* Screen refresh											 */
	/*************************************************************/
	public static VhUpdatePtr meadows_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int 	i;
