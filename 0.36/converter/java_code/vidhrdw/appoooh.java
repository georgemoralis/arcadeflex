...
public class appoooh
{
	...
	***************************************************************************/
	public static VhConvertColorPromPtr appoooh_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr appoooh_videoram2_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr appoooh_colorram2_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	{
		/* bit 0 controls NMI */
		if ((data & 0x01) != 0) interrupt_enable_w(0,1);
	...
	***************************************************************************/
	public static VhUpdatePtr appoooh_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
		int scroll;
