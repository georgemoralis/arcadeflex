...
public class marvins
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_bg_tilemap_info = new WriteHandlerPtr() { public void handler(int col, int row){
	    SET_TILE_INFO(
	        2,
	        videoram[col*32+row],
	        0
	...
	static public static WriteHandlerPtr get_fg_tilemap_info = new WriteHandlerPtr() { public void handler(int col, int row){
	    SET_TILE_INFO(
	        1,
	...
	static public static WriteHandlerPtr get_text_tilemap_info = new WriteHandlerPtr() { public void handler(int col, int row){
