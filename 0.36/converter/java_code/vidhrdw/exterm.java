...
public class exterm
{
	...
	static public static WriteHandlerPtr exterm_master_videoram_16_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static public static WriteHandlerPtr exterm_master_videoram_8_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		COMBINE_WORD_MEM(&exterm_master_videoram[offset], data);
	...
	static public static WriteHandlerPtr exterm_slave_videoram_16_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		int x,y;
	...
	static public static WriteHandlerPtr exterm_slave_videoram_8_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		int x,y;
		unsigned short *pens = Machine.pens;
		struct osd_bitmap *foreground;
	...
	public static VhUpdatePtr exterm_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
