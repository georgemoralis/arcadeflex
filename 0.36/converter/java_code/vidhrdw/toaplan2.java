...
public class toaplan2
{
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_top0_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr get_fg0_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int color, tile_number, attrib, offset;
	...
	static public static WriteHandlerPtr get_bg0_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int color, tile_number, attrib, offset;
	...
	static public static WriteHandlerPtr get_top1_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int color, tile_number, attrib, offset;
	...
	static public static WriteHandlerPtr get_fg1_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int color, tile_number, attrib, offset;
	...
	static public static WriteHandlerPtr get_bg1_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int color, tile_number, attrib, offset;
	...
	***************************************************************************/
	...
	static public static ReadHandlerPtr toaplan2_vh_start = new ReadHandlerPtr() { public int handler(int controller)
	{
	...
	***************************************************************************/
	...
	void toaplan2_scroll_reg_select_w(int offset, int data, int controller)
	{
		...
		{
			if (errorlog != 0) fprintf(errorlog,"Hmmm, unknown video control register selected (%08x)  Video controller %01x  \n",toaplan2_scroll_reg[controller],controller);
		}
	}
	...
	void toaplan2_log_vram(void)
	{
		...
		if ( keyboard_pressed(KEYCODE_M) )
		{
			...
			for ( sprite_voffs = 0; sprite_voffs < (TOAPLAN2_SPRITERAM_SIZE/2); sprite_voffs+=4 )
			{
				...
				if (errorlog != 0) fprintf (errorlog, "SPoffs     Sprt Attr Xpos Ypos     Sprt Attr Xpos Ypos     Sprt Attr Xpos Ypos\n");
				if (errorlog != 0) fprintf (errorlog, "0:%03x now:%04x %04x %04x %04x nxt:%04x %04x %04x %04x new:%04x %04x %04x %04x\n",sprite_voffs,
				...
				if (vid_controllers == 2)
				{
					...
					if (errorlog != 0) fprintf (errorlog, "1:%03x now:%04x %04x %04x %04x nxt:%04x %04x %04x %04x new:%04x %04x %04x %04x\n",sprite_voffs,
								 					schar[0], sattr[0],sxpos[0], sypos[0],
								 					schar[1], sattr[1],sxpos[1], sypos[1],
								 					schar[2], sattr[2],sxpos[2], sypos[2]);
				}
		...
		if ( keyboard_pressed(KEYCODE_N) )
		{
			...
			for ( tile_voffs = 0; tile_voffs < TOAPLAN2_TOP_VRAM_SIZE; tile_voffs+=4 )
			{
				...
				if (vid_controllers == 2)
				{
					...
					if (errorlog != 0) fprintf (errorlog, "TXoffs:%04x   Tile0:%04x  Attr0:%04x    Tile1:%04x  Attr1:%04x\n", tile_voffs/2, tchar[0], tattr[0], tchar[1], tattr[1]);
				}
				else
				{
					if (errorlog != 0) fprintf (errorlog, "TXoffs:%04x   Tile0:%04x  Attr0:%04x\n", tile_voffs/2, tchar[0], tattr[0]);
				}
			}
		}
			...
			if (vid_controllers == 2)
				{
					...
					if (errorlog != 0) fprintf (errorlog, "FGoffs:%04x   Tile0:%04x  Attr0:%04x    Tile1:%04x  Attr1:%04x\n", tile_voffs/2, tchar[0], tattr[0], tchar[1], tattr[1]);
				}
				else
				{
					if (errorlog != 0) fprintf (errorlog, "FGoffs:%04x   Tile0:%04x  Attr0:%04x\n", tile_voffs/2, tchar[0], tattr[0]);
				}
			}
		}
		if ( keyboard_pressed(KEYCODE_V) )
		{
			...
			for ( tile_voffs = 0; tile_voffs < TOAPLAN2_BG_VRAM_SIZE; tile_voffs+=4 )
			{
				...
				if (vid_controllers == 2)
				{
					...
					if (errorlog != 0) fprintf (errorlog, "BGoffs:%04x   Tile0:%04x  Attr0:%04x    Tile1:%04x  Attr1:%04x\n", tile_voffs/2, tchar[0], tattr[0], tchar[1], tattr[1]);
				}
				else
				{
					if (errorlog != 0) fprintf (errorlog, "BGoffs:%04x   Tile0:%04x  Attr0:%04x\n", tile_voffs/2, tchar[0], tattr[0]);
				}
			}
		}
		...
		if ( keyboard_pressed(KEYCODE_C) )
		{
			...
			if (errorlog != 0) fprintf (errorlog, "Mark here\n");
		}
	...
	***************************************************************************/
	...
	#if TOAPLAN2_DEBUG
		if (errorlog != 0) toaplan2_log_vram();
	#endif
