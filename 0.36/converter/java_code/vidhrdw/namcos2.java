...
public class namcos2
{
	...
	static public static WriteHandlerPtr namcos2_tilemap0_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile,colour;
		if ((namcos2_tilemap0_flip & TILEMAP_FLIPX) != 0) col=63-col;
		if ((namcos2_tilemap0_flip & TILEMAP_FLIPY) != 0) row=63-row;
	...
	static public static WriteHandlerPtr namcos2_tilemap1_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile,colour;
		if ((namcos2_tilemap1_flip & TILEMAP_FLIPX) != 0) col=63-col;
		if ((namcos2_tilemap1_flip & TILEMAP_FLIPY) != 0) row=63-row;
	...
	static public static WriteHandlerPtr namcos2_tilemap2_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile,colour;
		if ((namcos2_tilemap2_flip & TILEMAP_FLIPX) != 0) col=63-col;
		if ((namcos2_tilemap2_flip & TILEMAP_FLIPY) != 0) row=63-row;
	...
	static public static WriteHandlerPtr namcos2_tilemap3_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile,colour;
		if ((namcos2_tilemap3_flip & TILEMAP_FLIPX) != 0) col=63-col;
		if ((namcos2_tilemap3_flip & TILEMAP_FLIPY) != 0) row=63-row;
	...
	static public static WriteHandlerPtr namcos2_tilemap4_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile,colour;
		if ((namcos2_tilemap4_flip & TILEMAP_FLIPX) != 0) col=35-col;
		if ((namcos2_tilemap4_flip & TILEMAP_FLIPY) != 0) row=27-row;
	...
	static public static WriteHandlerPtr namcos2_tilemap5_get_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile,colour;
		if ((namcos2_tilemap5_flip & TILEMAP_FLIPX) != 0) col=35-col;
		if ((namcos2_tilemap5_flip & TILEMAP_FLIPY) != 0) row=27-row;
	...
	public static VhConvertColorPromPtr namcos2_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
