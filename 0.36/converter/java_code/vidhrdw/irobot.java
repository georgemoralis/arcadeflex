...
public class irobot
{
	...
	***************************************************************************/
	public static VhConvertColorPromPtr irobot_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	***************************************************************************/
	...
	void run_video(void)
	{
		...
		if (errorlog != 0) fprintf(errorlog,"Starting Polygon Generator, Clear=%d\n",irvg_clear);
		...
		//    if (irvg_clear != 0) irobot_poly_clear();
		lpnt=0;
		while (lpnt < 0xFFF)
		{
	...
	***************************************************************************/
	public static VhUpdatePtr irobot_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int x, y, offs;
	
		if (errorlog != 0) fprintf(errorlog,"Screen Refresh\n");
