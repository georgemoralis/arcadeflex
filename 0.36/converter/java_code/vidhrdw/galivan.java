...
public class galivan
{
	...
	***************************************************************************/
	...
	public static VhConvertColorPromPtr galivan_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	***************************************************************************/
	...
	static public static WriteHandlerPtr get_char_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int addr = 32 * col + row;
	...
	static public static WriteHandlerPtr ninjemak_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		unsigned char *BGROM = memory_region(REGION_GFX4);
		int addr = 32 * col + row;
		int attr = BGROM[addr + 0x4000];
	...
	static public static WriteHandlerPtr ninjemak_get_char_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int addr = 32 * col + row;
		int attr = colorram[addr];
	...
	***************************************************************************/
	...
	if (errorlog != 0) fprintf(errorlog,"%04x: write %02x to port 80\n",cpu_get_pc(),data);
