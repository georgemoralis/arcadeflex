...
public class centiped
{
	...
	***************************************************************************/
	static public static WriteHandlerPtr setcolor = new WriteHandlerPtr() { public void handler(int pen, int data)
	{
		int r,g,b;
	...
	public static WriteHandlerPtr centiped_vh_flipscreen_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	***************************************************************************/
	public static VhUpdatePtr centiped_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
		int offs;
