...
public class taitosj
{
	...
	***************************************************************************/
	...
	public static VhConvertColorPromPtr taitosj_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	***************************************************************************/
	public static VhStopPtr taitosj_vh_stop = new VhStopPtr() { public void handler() 
	{
		...
		if (sprite_sprite_collbitmap2 != 0) osd_free_bitmap(sprite_sprite_collbitmap2);
		if (sprite_sprite_collbitmap1 != 0) osd_free_bitmap(sprite_sprite_collbitmap1);
		if (sprite_plane_collbitmap1 != 0) osd_free_bitmap(sprite_plane_collbitmap1);
	...
	public static WriteHandlerPtr taitosj_colorbank_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		{
	if (errorlog != 0) fprintf(errorlog,"colorbank %d = %02x\n",offset,data);
	...
	public static WriteHandlerPtr taitosj_videoenable_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		{
	if (errorlog != 0) fprintf(errorlog,"videoenable = %02x\n",data);
	...
	***************************************************************************/
	...
	static public static ReadHandlerPtr check_sprite_plane_bitpattern = new ReadHandlerPtr() { public int handler(int num)
	{
