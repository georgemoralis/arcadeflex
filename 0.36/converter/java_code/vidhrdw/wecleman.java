...
public class wecleman
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr wecleman_get_txt_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	public static WriteHandlerPtr wecleman_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	public static WriteHandlerPtr wecleman_get_fg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
		int tile_index	=	(col % PAGE_NX) + (row % PAGE_NY) * PAGE_NX;
	...
	*/
	...
	static public static WriteHandlerPtr hotchase_get_bg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	static public static WriteHandlerPtr hotchase_get_fg_tile_info = new WriteHandlerPtr() { public void handler(int col, int row)
	{
	...
	*/
	...
	{
		if (temp_bitmap != 0)	osd_free_bitmap(temp_bitmap);
		if (temp_bitmap2 != 0)	osd_free_bitmap(temp_bitmap2);
	} };
