...
public class tagteam
{
	...
	public static VhConvertColorPromPtr tagteam_vh_convert_color_prom = new VhConvertColorPromPtr() { public void handler(UByte []palette, char []colortable, UBytePtr color_prom) 
	{
		int i;
	...
	{
	if (errorlog != 0) fprintf(errorlog,"%04x: control = %02x\n",cpu_get_pc(),data);
