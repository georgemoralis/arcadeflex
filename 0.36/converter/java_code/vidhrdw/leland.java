...
public class leland
{
	...
	extern public static WriteHandlerPtr leland_sound_port_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	    leland_gfx_control=data;
	    if (leland_update_master_bank != 0)
	    {
	        /* Update master bank */
	...
	public static ReadHandlerPtr leland_vram_low_r = new ReadHandlerPtr() { public int handler(int num)
	{
	    int addr=leland_video_addr[num];
	    return leland_video_ram[addr];
	} };
	
	public static ReadHandlerPtr leland_vram_high_r = new ReadHandlerPtr() { public int handler(int num)
	{
	    int addr=leland_video_addr[num];
	    return leland_video_ram[addr+VRAM_HIGH];
	} };
	
	public static WriteHandlerPtr leland_vram_low_w = new WriteHandlerPtr() { public void handler(int data, int num)
	{
	    int addr=leland_video_addr[num];
	...
	public static WriteHandlerPtr leland_vram_high_w = new WriteHandlerPtr() { public void handler(int data, int num)
	{
	    int addr=leland_video_addr[num];
	    leland_video_ram[addr+VRAM_HIGH]=data;
	} };
	
	public static WriteHandlerPtr leland_vram_all_w = new WriteHandlerPtr() { public void handler(int data, int num)
	{
	    int addr=leland_video_addr[num];
	...
	public static WriteHandlerPtr leland_vram_fill_w = new WriteHandlerPtr() { public void handler(int data, int num)
	{
	    int i;
	...
	public static WriteHandlerPtr leland_vram_planar_w = new WriteHandlerPtr() { public void handler(int data, int num)
	{
	    int addr=leland_video_addr[num];
	...
	public static WriteHandlerPtr leland_vram_planar_masked_w = new WriteHandlerPtr() { public void handler(int data, int num)
	{
	    int addr=leland_video_addr[num];
	    addr+=(leland_video_plane_count[num]&0x01)*VRAM_HIGH;
	    addr+=(leland_video_plane_count[num])>>1;
	...
	public static ReadHandlerPtr leland_vram_planar_r = new ReadHandlerPtr() { public int handler(int num)
	{
	    int ret;
	    int addr=leland_video_addr[num];
	    addr+=(leland_video_plane_count[num]&0x01)*VRAM_HIGH;
	...
	public static ReadHandlerPtr leland_vram_plane_r = new ReadHandlerPtr() { public int handler(int num)
	{
	    int ret;
	    int addr=leland_video_addr[num];
	    addr+=(leland_video_plane_count[num]&0x01)*VRAM_HIGH;
	...
	***************************************************************************/
	...
	public static VhUpdatePtr leland_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	    int bkcharbank=((leland_gfx_control>>4)&0x01)*0x0400;
	    leland_screenrefresh(bitmap, full_refresh, bkcharbank);
	} };
	
	public static VhUpdatePtr pigout_vh_screenrefresh = new VhUpdatePtr() { public void handler(osd_bitmap bitmap,int full_refresh) 
	{
	    /*
	...
	***************************************************************************/
	...
	public static VhStopPtr ataxx_vh_stop = new VhStopPtr() { public void handler() 
	{
	    ...
	    if (ataxx_qram1dirty != 0)
		{
	        free(ataxx_qram1dirty);
		}
	    if (ataxx_qram2dirty != 0)
		{
