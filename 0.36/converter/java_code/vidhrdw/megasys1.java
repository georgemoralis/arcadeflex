...
public class megasys1
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr megasys1_get_scroll_##_n_##_tile_info_8x8 = new WriteHandlerPtr() { public void handler(int col, int row)\
	{ \
		int tile_index = \
	...
	\
	public static WriteHandlerPtr megasys1_get_scroll_##_n_##_tile_info_16x16 = new WriteHandlerPtr() { public void handler(int col, int row)\
	{ \
		int tile_index = \
	...
	public static ReadHandlerPtr megasys1_scrollram_##_n_##_r = new ReadHandlerPtr() { public int handler(int offset){return READ_WORD(&megasys1_scrollram_##_n_[offset]);} };
	
	#define MEGASYS1_SCROLLRAM_W(_n_) \
	public static WriteHandlerPtr megasys1_scrollram_##_n_##_w = new WriteHandlerPtr() { public void handler(int offset, int data)\
	{ \
