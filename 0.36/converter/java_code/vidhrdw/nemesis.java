...
public class nemesis
{
	...
	public static ReadHandlerPtr gx400_xscroll1_r = new ReadHandlerPtr() { public int handler(int offset){ return READ_WORD(&nemesis_xscroll1[offset]);} };
	public static ReadHandlerPtr gx400_xscroll2_r = new ReadHandlerPtr() { public int handler(int offset){ return READ_WORD(&nemesis_xscroll2[offset]);} };
	public static ReadHandlerPtr gx400_yscroll_r = new ReadHandlerPtr() { public int handler(int offset){ return READ_WORD(&nemesis_yscroll[offset]);} };
			...
			if (zoom != 0xFF || code!=0)
			{
				...
				switch(size&0x38)
				{
					...
					case 0x30:
						...
						break;
					default:
						if (errorlog != 0) fprintf(errorlog,"UN-SUPPORTED SPRITE SIZE %-4x\n",size&0x38);
					case 0x38:
						/* sprite 16x16 */
						char_type=1;
						code/=2;
