...
The loop at $cf60 should count down from Y=null instead of Y=0xff.  Because of this the first
...
public class liberatr
{
	...
	static MemoryWriteAddress liberatr_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x6600, 0x6600, atari_vg_earom_ctrl ),
	...
	static MemoryWriteAddress liberat2_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x4600, 0x4600, atari_vg_earom_ctrl ),
