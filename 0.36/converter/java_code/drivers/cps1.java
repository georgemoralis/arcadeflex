...
public class cps1
{
	...
	*/
	...
	public static ReadHandlerPtr cps1_protection_ram_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		/*
	...
	********************************************************************/
	...
	public static WriteHandlerPtr qsound_sharedram_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	***************************************************************************/
	...
	GAMEX(1991, kodb,     kod,      cps1,     kod,      null,        ROT0,       "Capcom", "The King of Dragons (bootleg)", GAME_NOT_WORKING )
