...
public class zn
{
	...
	static GfxDecodeInfo zn_gfxdecodeinfo[] =
	{
	...
	{
	    new MemoryReadAddress( 0x000000, 0x307ffff, MRA_ROM ),
	    new MemoryReadAddress( -1 )  /* end of table */
	};
	...
	public static InitMachinePtr zn_init_machine = new InitMachinePtr() { public void handler() 
	{
	...
	public static GameDriver driver_ts2j	   = new GameDriver("1995"	,"ts2j"	,"zn.java"	,rom_ts2j,null	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Takara", "Battle Arena Toshinden 2 (JAPAN 951124)" )
	public static GameDriver driver_sfex	   = new GameDriver("1996"	,"sfex"	,"zn.java"	,rom_sfex,null	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Arika", "Street Fighter EX (ASIA 961219)" )
	public static GameDriver driver_sfexj	   = new GameDriver("1996"	,"sfexj"	,"zn.java"	,rom_sfexj,driver_sfex	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Arika", "Street Fighter EX (JAPAN 961130)" )
	public static GameDriver driver_sfexp	   = new GameDriver("1997"	,"sfexp"	,"zn.java"	,rom_sfexp,null	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Arika", "Street Fighter EX Plus (USA 970311)" )
	public static GameDriver driver_sfexpj	   = new GameDriver("1997"	,"sfexpj"	,"zn.java"	,rom_sfexpj,driver_sfexp	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Arika", "Street Fighter EX Plus (JAPAN 970311)" )
	public static GameDriver driver_rvschool	   = new GameDriver("1997"	,"rvschool"	,"zn.java"	,rom_rvschool,null	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom", "Rival Schools (ASIA 971117)" )
	public static GameDriver driver_jgakuen	   = new GameDriver("1997"	,"jgakuen"	,"zn.java"	,rom_jgakuen,driver_rvschool	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom", "Justice Gakuen (JAPAN 971117)" )
	public static GameDriver driver_sfex2	   = new GameDriver("1998"	,"sfex2"	,"zn.java"	,rom_sfex2,null	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Arika", "Street Fighter EX 2 (JAPAN 980312)" )
	public static GameDriver driver_tgmj	   = new GameDriver("1998"	,"tgmj"	,"zn.java"	,rom_tgmj,null	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Akira", "Tetris The Grand Master (JAPAN 980710)" )
	public static GameDriver driver_sfex2p	   = new GameDriver("1999"	,"sfex2p"	,"zn.java"	,rom_sfex2p,driver_sfex2	,machine_driver_zn	,input_ports_zn	,null	,ROT0	,	"Capcom/Arika", "Street Fighter EX 2 Plus (JAPAN 990611)" )
}
