...
public class gunsmoke
{
	...
	public static WriteHandlerPtr gunsmoke_c804_w = new WriteHandlerPtr() { public void handler(int offset, int data);	/* in vidhrdw/c1943.c */
	public static WriteHandlerPtr gunsmoke_d806_w = new WriteHandlerPtr() { public void handler(int offset, int data);	/* in vidhrdw/c1943.c */
