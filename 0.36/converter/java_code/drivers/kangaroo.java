...
public class kangaroo
{
	...
	public static WriteHandlerPtr kangaroo_blitter_w = new WriteHandlerPtr() { public void handler(int offset, int val);
	public static WriteHandlerPtr kangaroo_videoram_w = new WriteHandlerPtr() { public void handler(int offset, int val);
