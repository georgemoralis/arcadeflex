...
Interrupts:
Runs in interrupt mode null, the interrupt vectors are 0xcf (RST 08h) and
0xd7 (RST 10h)
...
public class gundealr
{
	...
	***************************************************************************/
	...
	public static GameDriver driver_	   = new GameDriver(""	,""	,"gundealr.java"	,rom_,driver_	,machine_driver_	,input_ports_	,init_gundeala	,gundealr	,	gundealr, gundealr, gundealr, ROT270, "Dooyong", "Gun Dealer (set 2)" )
