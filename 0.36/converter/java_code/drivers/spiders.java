...
$0000-$1bff, $4000-$5bff, $8000-$9bff 	Bank null
$2000-$3bff, %6000-$7bff, $a000-$bbff	Bank 1

The game normally runs from bank null only, but when lots of screen changes are required
...
$F987 - Addresses table at $f98d containing four structs:
            3c 0C 04 0D 80 (Inverted screen bank null)
            34 0C 00 0D 00 (Normal screen   bank null)
