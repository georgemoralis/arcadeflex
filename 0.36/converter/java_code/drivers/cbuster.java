...
public class cbuster
{
	...
	public static WriteHandlerPtr twocrude_palette_24bit_rg = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static WriteHandlerPtr twocrude_palette_24bit_b = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	public static WriteHandlerPtr twocrude_update_sprites = new WriteHandlerPtr() { public void handler(int offset, int data);
	static int prot;
	...
	static MemoryWriteAddress twocrude_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x0b8000, 0x0b8fff, twocrude_palette_24bit_rg, paletteram ),
		new MemoryWriteAddress( 0x0b9000, 0x0b9fff, twocrude_palette_24bit_b, paletteram_2 ),
