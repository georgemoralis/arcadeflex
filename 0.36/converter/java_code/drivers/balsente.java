...
****************************************************************************
	...
	0000-007F   R/W   xxxxxxxx    Sprite RAM (32 entries x 4 bytes)
	            R/W   x-------       (null: Vertical flip)
	            R/W   -x------       (null: Horizontal flip)
	            R/W   ------xx       (null: Upper 2 bits of image number)
	...
	8000-8FFF   R/W   ----xxxx    Palette RAM (1024 entries x 4 bytes)
	            R/W   ----xxxx       (null: red entry)
	            R/W   ----xxxx       (1: green entry)
	            R/W   ----xxxx       (2: blue entry)
	9000-9007     W   --------    ADC start trigger, inputs null-7
    ...
    0008          W   --xxxxxx    Counter control
                  W   --x-----    NMI enable (1=enabled, null=disabled/clear)
...
public class balsente
{
	...
	public static WriteHandlerPtr counter_set_out = new WriteHandlerPtr() { public void handler(int which, int gate);
	...
	public static WriteHandlerPtr counter_set_gate = new WriteHandlerPtr() { public void handler(int which, int gate)
	{
	...
	public static WriteHandlerPtr counter_set_out = new WriteHandlerPtr() { public void handler(int which, int out)
	{
	...
	public static InitDriverPtr init_sentetst = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; /* noanalog */ } };
	public static InitDriverPtr init_cshift = new InitDriverPtr() { public void handler()    { expand_roms(EXPAND_ALL);  balsente_shooter = 0; /* noanalog */ } };
	public static InitDriverPtr init_gghost = new InitDriverPtr() { public void handler()    { expand_roms(EXPAND_ALL);  balsente_shooter = 0; adc_shift = 1; } };
	public static InitDriverPtr init_hattrick = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; /* noanalog */ } };
	public static InitDriverPtr init_otwalls = new InitDriverPtr() { public void handler()   { expand_roms(EXPAND_ALL);  balsente_shooter = 0; adc_shift = 0; } };
	public static InitDriverPtr init_snakepit = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; adc_shift = 1; } };
	public static InitDriverPtr init_snakjack = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; adc_shift = 1; } };
	public static InitDriverPtr init_stocker = new InitDriverPtr() { public void handler()   { expand_roms(EXPAND_ALL);  balsente_shooter = 0; adc_shift = 0; } };
	public static InitDriverPtr init_triviag1 = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; /* noanalog */ } };
	public static InitDriverPtr init_triviag2 = new InitDriverPtr() { public void handler() 
	{
	...
	public static InitDriverPtr init_gimeabrk = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL);  balsente_shooter = 0; adc_shift = 1; } };
	public static InitDriverPtr init_minigolf = new InitDriverPtr() { public void handler()  { expand_roms(0x0c);        balsente_shooter = 0; adc_shift = 2; } };
	public static InitDriverPtr init_minigol2 = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_NONE); balsente_shooter = 0; adc_shift = 2; } };
	public static InitDriverPtr init_toggle = new InitDriverPtr() { public void handler()    { expand_roms(EXPAND_ALL);  balsente_shooter = 0; /* noanalog */ } };
	public static InitDriverPtr init_nametune = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_NONE | SWAP_HALVES); balsente_shooter = 0; /* noanalog */ } };
	public static InitDriverPtr init_nstocker = new InitDriverPtr() { public void handler() 
	{
	...
	public static InitDriverPtr init_sfootbal = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_ALL  | SWAP_HALVES); balsente_shooter = 0; adc_shift = 0; } };
	public static InitDriverPtr init_spiker = new InitDriverPtr() { public void handler() 
	{
	...
	public static InitDriverPtr init_rescraid = new InitDriverPtr() { public void handler()  { expand_roms(EXPAND_NONE); balsente_shooter = 0; /* noanalog */ } };
