...
public class nemesis
{
	...
	public static WriteHandlerPtr gx400_xscroll1_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static WriteHandlerPtr gx400_xscroll2_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static WriteHandlerPtr gx400_yscroll_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static ReadHandlerPtr gx400_xscroll1_r = new ReadHandlerPtr() { public int handler(int offset);
	public static ReadHandlerPtr gx400_xscroll2_r = new ReadHandlerPtr() { public int handler(int offset);
	public static ReadHandlerPtr gx400_yscroll_r = new ReadHandlerPtr() { public int handler(int offset);
