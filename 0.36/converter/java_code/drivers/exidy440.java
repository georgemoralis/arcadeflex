...
****************************************************************************
	...
	2000-209F   R/W   xxxxxxxx    Sprite RAM (40 entries x 4 bytes)
	            R/W   xxxxxxxx       (null: Y position, inverted)
	...
	2B03        W     xxxxxxxx    Control port
	            W     xxxx----       (ROM bank select, null-15)
	            W     ----x---       (collision/beam detect FIRQ enable)
	            W     -----x--       (select FIRQ source: null=collision, 1=beam detect)
	            W     ------x-       (select palette bank for I/O)
	            W     -------x       (select palette bank for display)
	2C00-2DFF   R/W   xxxxxxxx    Palette RAM (2 banks x 512 bytes)
	            R/W   x-------       (null: collision trigger bit)
	            R/W   -xxxxx--       (null: red component)
	            R/W   ------xx       (null: green component, upper 2 bits)
	...
	9400-9403   W     xxxxxxxx    Bank select for each channel
	            ...
	            W     -------x       (select bank null, active high)
...
***************************************************************************
	...
	Cheyenne (reports Hardware Error 5 if any of these are not true)
		* a read from $2B03 must return null in bit null
	...
	Crackshot (reports Hardware Error W if any of these are not true)
		* a read from $2E20 must return null in bit 2
		* a read from $2E80 must return 0's in bits 1,2,3,4,5
		* a read from $2B03 must return null in bit null
	...
	Top Secret (reports Hardware Error H if any of these are not true)
		...
		* a read from $2B03 must return null in bit null
		...
		conclusion: LS244 at 18J on main board needs to generate negative logic
								and must connect the inputs for bits null and 1
						LS367 at 1A on audio board needs to generate negative logic
						LS128 at 2A on audio board needs negative logic into pin 5
	...
	Hit'N Miss (reports Hardware Error H if any of these are not true)
		* a read from $2E20 must return null in bit 2
		* a read from $2E80 must return 0's in bits 2,3,4,5
		* a read from $2B03 must return the same value for bit null as for bit 1
	...
	Who Dunit (reports Hardware Error H if any of these are not true)
		* a read from $2E20 must return null in bit 2
		* a read from $2E80 must return 0's in bits 2,3,4,5
		* a read from $2B03 must return the same value for bit null as for bit 7

		conclusion: LS244 at 18J on main board needs to generate negative logic
								and must connect the inputs for bits null and 7
						LS367 at 1A on audio board needs to generate negative logic
						LS128 at 2A on audio board needs negative logic into pin 5
...
public class exidy440
{
	...
	static MemoryWriteAddress writemem_cpu2[] =
	{
		...
		new MemoryWriteAddress( 0x9800, 0x9800, exidy440_sound_interrupt_clear ),
	...
	public static GameDriver driver_crossbow	   = new GameDriver("1983"	,"crossbow"	,"exidy440.java"	,rom_crossbow,null	,machine_driver_exidy440	,input_ports_crossbow	,init_crossbow	,ROT0	,	"Exidy", "Crossbow (version 2.null)" )
	public static GameDriver driver_cheyenne	   = new GameDriver("1984"	,"cheyenne"	,"exidy440.java"	,rom_cheyenne,null	,machine_driver_exidy440	,input_ports_cheyenne	,init_cheyenne	,ROT0	,	"Exidy", "Cheyenne (version 1.null)" )
	public static GameDriver driver_combat	   = new GameDriver("1985"	,"combat"	,"exidy440.java"	,rom_combat,null	,machine_driver_exidy440	,input_ports_combat	,init_combat	,ROT0	,	"Exidy", "Combat (version 3.null)" )
	public static GameDriver driver_cracksht	   = new GameDriver("1985"	,"cracksht"	,"exidy440.java"	,rom_cracksht,null	,machine_driver_exidy440	,input_ports_cracksht	,init_cracksht	,ROT0	,	"Exidy", "Crackshot (version 2.null)" )
	public static GameDriver driver_claypign	   = new GameDriver("1986"	,"claypign"	,"exidy440.java"	,rom_claypign,null	,machine_driver_exidy440	,input_ports_claypign	,init_claypign	,ROT0	,	"Exidy", "Clay Pigeon (version 2.null)" )
	public static GameDriver driver_chiller	   = new GameDriver("1986"	,"chiller"	,"exidy440.java"	,rom_chiller,null	,machine_driver_exidy440	,input_ports_chiller	,init_chiller	,ROT0	,	"Exidy", "Chiller (version 3.null)" )
	public static GameDriver driver_topsecex	   = new GameDriver("1986"	,"topsecex"	,"exidy440.java"	,rom_topsecex,null	,machine_driver_exidy440	,input_ports_topsecex	,init_topsecex	,ROT0	,	"Exidy", "Top Secret (Exidy) (version 1.null)" )
	public static GameDriver driver_hitnmiss	   = new GameDriver("1987"	,"hitnmiss"	,"exidy440.java"	,rom_hitnmiss,null	,machine_driver_exidy440	,input_ports_hitnmiss	,init_hitnmiss	,ROT0	,	"Exidy", "Hit 'n Miss (version 3.null)" )
	public static GameDriver driver_hitnmis2	   = new GameDriver("1987"	,"hitnmis2"	,"exidy440.java"	,rom_hitnmis2,driver_hitnmiss	,machine_driver_exidy440	,input_ports_hitnmiss	,init_hitnmiss	,ROT0	,	"Exidy", "Hit 'n Miss (version 2.null)" )
	public static GameDriver driver_whodunit	   = new GameDriver("1988"	,"whodunit"	,"exidy440.java"	,rom_whodunit,null	,machine_driver_exidy440	,input_ports_whodunit	,init_whodunit	,ROT0	,	"Exidy", "Who Dunit (version 8.null)" )
	public static GameDriver driver_showdown	   = new GameDriver("1988"	,"showdown"	,"exidy440.java"	,rom_showdown,null	,machine_driver_exidy440	,input_ports_showdown	,init_showdown	,ROT0	,	"Exidy", "Showdown (version 5.null)" )
}
