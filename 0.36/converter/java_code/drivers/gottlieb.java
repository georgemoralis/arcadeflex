...
main board ensures a command is correctly received by sending nul (null)
...
public class gottlieb
{
	...
	public static WriteHandlerPtr reactor_output = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr stooges_output = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		joympx = (data >> 5) & 0x03;
		gottlieb_video_outputs(offset,data);
	} };
	...
	static MemoryReadAddress reactor_readmem[] =
	{
		...
		new MemoryReadAddress( 0x7001, 0x7001, input_port_1_r ),	/* buttons */
		new MemoryReadAddress( 0x7002, 0x7002, gottlieb_track_0_r ),	/* trackball H */
		new MemoryReadAddress( 0x7003, 0x7003, gottlieb_track_1_r ),	/* trackball V */
	...
	static MemoryWriteAddress reactor_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x3400, 0x37ff, videoram_w ),	/* mirror address, some games write to it */
		new MemoryWriteAddress( 0x4000, 0x4fff, gottlieb_characterram_w, gottlieb_characterram ),
		new MemoryWriteAddress( 0x6000, 0x601f, gottlieb_paletteram_w, paletteram ),
		new MemoryWriteAddress( 0x7000, 0x7000, watchdog_reset_w ),
		new MemoryWriteAddress( 0x7001, 0x7001, gottlieb_track_reset_w ),
		new MemoryWriteAddress( 0x7002, 0x7002, gottlieb_sh_w ), /* sound/speech command */
		new MemoryWriteAddress( 0x7003, 0x7003, reactor_output ),       /* OUT1 */
	...
	static MemoryReadAddress gottlieb_readmem[] =
	{
		...
		new MemoryReadAddress( 0x1000, 0x1fff, MRA_RAM ),	/* or ROM */
		new MemoryReadAddress( 0x2000, 0x2fff, MRA_RAM ),	/* or ROM */
		new MemoryReadAddress( 0x3800, 0x3bff, MRA_RAM ),
		new MemoryReadAddress( 0x4000, 0x4fff, MRA_RAM ),
		new MemoryReadAddress( 0x5800, 0x5800, input_port_0_r ),	/* DSW */
		new MemoryReadAddress( 0x5801, 0x5801, input_port_1_r ),	/* buttons */
		new MemoryReadAddress( 0x5802, 0x5802, gottlieb_track_0_r ),	/* trackball H */
		new MemoryReadAddress( 0x5803, 0x5803, gottlieb_track_1_r ),	/* trackball V */
		new MemoryReadAddress( 0x5804, 0x5804, input_port_4_r ),	/* joystick */
		new MemoryReadAddress( 0x5805, 0x5807, gottlieb_laserdisc_status_r ),
	...
	{
		new MemoryWriteAddress( 0x0000, 0x0fff, MWA_RAM, nvram, nvram_size ),
		new MemoryWriteAddress( 0x1000, 0x1fff, MWA_RAM ),	/* ROM in Krull */
		new MemoryWriteAddress( 0x2000, 0x2fff, MWA_RAM ),	/* ROM in Krull and 3 Stooges */
		...
		new MemoryWriteAddress( 0x3c00, 0x3fff, videoram_w ),	/* mirror address, some games write to it */
		new MemoryWriteAddress( 0x4000, 0x4fff, gottlieb_characterram_w, gottlieb_characterram ),
		new MemoryWriteAddress( 0x5000, 0x501f, gottlieb_paletteram_w, paletteram ),
		new MemoryWriteAddress( 0x5800, 0x5800, watchdog_reset_w ),
		new MemoryWriteAddress( 0x5801, 0x5801, gottlieb_track_reset_w ),
		new MemoryWriteAddress( 0x5802, 0x5802, gottlieb_sh_w ), /* sound/speech command */
		new MemoryWriteAddress( 0x5803, 0x5803, gottlieb_video_outputs ),       /* OUT1 */
	...
	static MemoryWriteAddress usvsthem_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x5801, 0x5801, gottlieb_track_reset_w ),
		new MemoryWriteAddress( 0x5802, 0x5802, gottlieb_sh_w ), /* sound/speech command */
		new MemoryWriteAddress( 0x5803, 0x5803, usvsthem_video_outputs ),       /* OUT1 */
		new MemoryWriteAddress( 0x5805, 0x5805, gottlieb_laserdisc_command_w ),	/* command for the player */
		new MemoryWriteAddress( 0x5806, 0x5806, gottlieb_laserdisc_mpx_w ),
		new MemoryWriteAddress( 0x6000, 0xffff, MWA_ROM ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	static MemoryReadAddress stooges_readmem[] =
	{
		...
		new MemoryReadAddress( 0x5802, 0x5802, gottlieb_track_0_r ),	/* trackball H */
		new MemoryReadAddress( 0x5803, 0x5803, gottlieb_track_1_r ),	/* trackball V */
		new MemoryReadAddress( 0x5804, 0x5804, stooges_IN4_r ),	/* joystick */
		new MemoryReadAddress( 0x6000, 0xffff, MRA_ROM ),
		new MemoryReadAddress( -1 )  /* end of table */
	};
	...
	static MemoryWriteAddress stooges_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x5801, 0x5801, gottlieb_track_reset_w ),
		new MemoryWriteAddress( 0x5802, 0x5802, gottlieb_sh_w ), /* sound/speech command */
		new MemoryWriteAddress( 0x5803, 0x5803, stooges_output ),       /* OUT1 */
		new MemoryWriteAddress( 0x6000, 0xffff, MWA_ROM ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	static MemoryWriteAddress gottlieb_sound_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x1000, 0x1000, DAC_data_w ),
		...
		new MemoryWriteAddress( 0x9000, 0x9000, DAC_data_w ),
	...
	static MemoryWriteAddress stooges_sound_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x4000, 0x4001, DAC_data_w ),
		new MemoryWriteAddress( 0xe000, 0xffff, MWA_ROM ),
		new MemoryWriteAddress( -1 )  /* end of table */
	};
	...
	(
		...
		256,    /* 256 sprites */
		4,      /* 4 bits per pixel */
		new int[] { 0, 256*32*8, 2*256*32*8, 3*256*32*8 },
	...
	static GfxLayout qbertqub_spritelayout = new GfxLayout
	(
		16,16,  /* 16*16 sprites */
		512,    /* 512 sprites */
		4,      /* 4 bits per pixel */
	...
	static GfxDecodeInfo qbertqub_gfxdecodeinfo[] =
	{
		new GfxDecodeInfo( REGION_GFX1, 0x0000, charROMlayout,         0, 1 ),
		new GfxDecodeInfo( REGION_GFX2, 0x0000, qbertqub_spritelayout, 0, 1 ),
		new GfxDecodeInfo( -1 ) /* end of array */
	};
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_reactor = new InitDriverPtr() { public void handler() 
	{
		samples_interface.samplenames = reactor_sample_names;
	} };
	
	public static InitDriverPtr init_qbert = new InitDriverPtr() { public void handler() 
	{
	...
	public static GameDriver driver_reactor	   = new GameDriver("1982"	,"reactor"	,"gottlieb.java"	,rom_reactor,null	,machine_driver_reactor	,input_ports_reactor	,init_reactor	,ROT0	,	"Gottlieb", "Reactor" )
	...
	public static GameDriver driver_qbert	   = new GameDriver("1982"	,"qbert"	,"gottlieb.java"	,rom_qbert,null	,machine_driver_gottlieb	,input_ports_qbert	,init_qbert	,ROT270	,	"Gottlieb", "Q*bert (US)" )
	public static GameDriver driver_qbertjp	   = new GameDriver("1982"	,"qbertjp"	,"gottlieb.java"	,rom_qbertjp,driver_qbert	,machine_driver_gottlieb	,input_ports_qbert	,init_qbert	,ROT270	,	"Gottlieb (Konami license)", "Q*bert (Japan)" )
	public static GameDriver driver_sqbert	   = new GameDriver("1983"	,"sqbert"	,"gottlieb.java"	,rom_sqbert,null	,machine_driver_gottlieb	,input_ports_qbert	,init_qbert	,ROT270	,	"Mylstar", "Faster, Harder, More Challenging Q*bert" )
	public static GameDriver driver_qbertqub	   = new GameDriver("1983"	,"qbertqub"	,"gottlieb.java"	,rom_qbertqub,null	,machine_driver_qbertqub	,input_ports_qbertqub	,init_qbert	,ROT270	,	"Mylstar", "Q*bert's Qubes" )
	...
	GAMEX(1983, mach3,    null,     mach3,    mach3,    gottlieb, ROT0,   "Mylstar", "M.A.C.H. 3", GAME_NOT_WORKING )
	public static GameDriver driver_	   = new GameDriver(""	,""	,"gottlieb.java"	,rom_,driver_	,machine_driver_	,input_ports_	,init_usvsthem	,0	,	usvsthem, usvsthem, gottlieb, ROT0,   "Mylstar", "Us vs. Them", GAME_NOT_WORKING )
	GAMEX(1984, 3stooges, null,     stooges,  3stooges, gottlieb, ROT0,   "Mylstar", "Three Stooges", GAME_IMPERFECT_SOUND )
