...
public class tmnt
{
	...
	public static ReadHandlerPtr punkshot_kludge = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static ReadHandlerPtr ssriders_kludge = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	***************************************************************************/
	...
	static MemoryWriteAddress detatwin_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x780600, 0x780601, K053260_WriteReg ),
	...
	public static ReadHandlerPtr ball = new ReadHandlerPtr() { public int handler(int offset)
	{
		return 0x11;
	} };
	...
	static MemoryReadAddress glfgreat_readmem[] =
	{
		...
		new MemoryReadAddress( 0x121000, 0x121001, ball ),	/* protection? returning 0, every shot is a "water" */
	...
	static MemoryReadAddress glfgreat_s_readmem[] =
	{
		new MemoryReadAddress( 0x0000, 0x7fff, MRA_ROM ),
		new MemoryReadAddress( 0xf000, 0xf7ff, MRA_RAM ),
		new MemoryReadAddress( 0xf800, 0xf82f, K053260_ReadReg ),
		new MemoryReadAddress( -1 )	/* end of table */
	};
	...
	static MemoryWriteAddress glfgreat_s_writemem[] =
	{
		new MemoryWriteAddress( 0x0000, 0x7fff, MWA_ROM ),
		new MemoryWriteAddress( 0xf000, 0xf7ff, MWA_RAM ),
		new MemoryWriteAddress( 0xf800, 0xf82f, K053260_WriteReg ),
		new MemoryWriteAddress( 0xfa00, 0xfa00, sound_arm_nmi ),
		new MemoryWriteAddress( -1 )	/* end of table */
	};
	...
	***************************************************************************/
	...
	GAMEX(1991, glfgreat, null,        glfgreat, glfgreat, glfgreat, ROT0,  "Konami", "Golfing Greats", GAME_NOT_WORKING )
	
	GAMEX(1991, tmnt2,    null,        tmnt2,    ssridr4p, gfx,      ROT0,  "Konami", "Teenage Mutant Ninja Turtles - Turtles in Time (4 Players US)", GAME_IMPERFECT_COLORS )
