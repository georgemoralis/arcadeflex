...
public class cinemat
{
	...
	{
		new IOReadPort( 0, CCPU_PORT_MAX, cinemat_readport ),
		new IOReadPort( -1 )  /* end of table */
	};
	
	static IOWritePort writeport[] =
	{
		new IOWritePort( 0, CCPU_PORT_MAX, cinemat_writeport ),
		new IOWritePort( -1 )  /* end of table */
	};
	
	static IOReadPort speedfrk_readport[] =
	{
		new IOReadPort( 0, CCPU_PORT_MAX, speedfrk_readports ),
		new IOReadPort( -1 )  /* end of table */
	};
	
	static IOReadPort boxingb_readport[] =
	{
		new IOReadPort( 0, CCPU_PORT_MAX, boxingb_readports ),
		new IOReadPort( -1 )  /* end of table */
	};
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr speedfrk_in2_r = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	***************************************************************************/
	...
	public static GameDriver driver_	   = new GameDriver("19"	,""	,"cinemat.java"	,rom_,driver_	,machine_driver_speedfrk	,input_ports_0	,init_speedfrk	,speedfrk	,	speedfrk, ROT0,   "Vectorbeam", "Speed Freak" )
	GAMEX(1979, sundance, null,       sundance, sundance, sundance, ROT270, "Cinematronics", "Sundance", GAME_NOT_WORKING )
	...
	GAMEX(1981, wotw,     null,       wotw,     wotw,     wotw,     ROT0,   "Cinematronics", "War of the Worlds", GAME_IMPERFECT_COLORS )
	GAMEX(1981, boxingb,  null,       boxingb,  boxingb,  boxingb,  ROT0,   "Cinematronics", "Boxing Bugs", GAME_IMPERFECT_COLORS )
}
