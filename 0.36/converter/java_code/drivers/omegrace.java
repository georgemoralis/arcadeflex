...
15 14 13 12 11 10
--+--+--+--+--+--
null  null  null  null                       M8 - 2732  (4k)
null  null  null  1                       L8 - 2732
null  null  1  null                       K8 - 2732
null  null  1  1                       J8 - 2732

null  1  -  null  null  null                 RAM (3k)
null  1  -  null  null  1
null  1  -  null  1  null

null  1  -  1  1  1                 4 Bit BB RAM (d0-d3)

1  -  -  null  null                    Vec RAM (4k)
1  -  -  null  1
1  -  -  1  null			 Vec ROM (2k) E1
1  -  -  1  1                    Vec ROM (2k) F1
...
B	RDSTOP/ d7 = stop (VG running if null)
...
10 I	DIP SW C4 (game ship settings)
	...
	6 5  4 3  2 1
        ...
        | |  null null      150,000   250,000
        | |  null 1      250,000   500,000
        | |  1 null      500,000   750,000
        | |  1 1      750,000 1,500,000
        | |           ships per credit
        null null           1 credit = 2 ships / 2 credits = 4 ships
        null 1           1 credit = 2 ships / 2 credits = 5 ships
        1 null           1 credit = 3 ships / 2 credits = 6 ships
...
17 I	DIP SW C6 (coin/cocktail settings)
        ...
        8  7  6 5 4  3 2 1
                             coin switch 1
        |  |  | | |  null null null   1 coin  2 credits
        |  |  | | |  null null 1   1 coin  3 credits
        |  |  | | |  null 1 null   1 coin  5 credits
        |  |  | | |  null 1 1   4 coins 5 credits
        |  |  | | |  1 null null   3 coins 4 credits
        |  |  | | |  1 null 1   2 coins 3 credits
        |  |  | | |  1 1 null   2 coins 1 credit
...
+------+------+------+------+------+------+------+------+
|DY07   DY06   DY05   DY04   DY03   DY02   DY01   DY00  | null
+------+------+------+------+------+------+------+------+
...
null                       input port from main CPU.
                        main CPU writing port generated INT
Sound Commands:

null - reset sound CPU
***************************************************************************/
...
public class omegrace
{
	...
	public static ReadHandlerPtr omegrace_vg_go = new ReadHandlerPtr() { public int handler(int data)
	{
		avgdvg_go(0,0);
		return 0;
	} };
	...
	{
		new IOWritePort( 0x0a, 0x0a, avgdvg_reset ),
	...
	***************************************************************************/
	...
	public static GameDriver driver_omegrace	   = new GameDriver("1981"	,"omegrace"	,"omegrace.java"	,rom_omegrace,null	,machine_driver_omegrace	,input_ports_omegrace	,null	,ROT0	,	"Midway", "Omega Race" )
