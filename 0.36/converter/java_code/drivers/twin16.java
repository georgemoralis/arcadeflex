...
public class twin16
{
	...
	#define CPUA_IRQ_ENABLE (twin16_CPUA_register0x20)
	#define CPUB_IRQ_ENABLE (twin16_CPUB_register0x02)
	...
	(
		return (twin16_CPUA_register0x40)==null;
	)
	...
	public static WriteHandlerPtr UPD7759_start_wx = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static MemoryWriteAddress writemem_sound[] =
	{
		...
		new MemoryWriteAddress( 0xe000, 0xe000, UPD7759_start_wx ),	// Changed by Takahiro Nogi. (1999/10/27)
