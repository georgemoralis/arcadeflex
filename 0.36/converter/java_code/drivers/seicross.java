...
public class seicross
{
	...
	public static InitMachinePtr friskyt_init_machine = new InitMachinePtr() { public void handler() 
	{
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_friskyt = new InitDriverPtr() { public void handler() 
	{
		int A;
