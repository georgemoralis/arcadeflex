...
public class hexa
{
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_hexa = new InitDriverPtr() { public void handler() 
	{
	...
	public static GameDriver driver_	   = new GameDriver(""	,""	,"hexa.java"	,rom_,driver_	,machine_driver_	,input_ports_	,init_hexa	,0	,	hexa, hexa, hexa, ROT0, "D. R. Korea", "Hexa" )
}
