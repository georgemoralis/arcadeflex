...
on the display (null-255).  Several places in the ROM code wait until the
...
public class qix
{
	...
	public static InterruptPtr qix_interrupt_video = new InterruptPtr() { public int handler() ;
