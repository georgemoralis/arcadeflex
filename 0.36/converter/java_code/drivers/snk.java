...
public class snk
{
	...
	*/
	...
	public static ReadHandlerPtr snk_rot8 = new ReadHandlerPtr() { public int handler(int which){
	...
	public static ReadHandlerPtr snk_rot12 = new ReadHandlerPtr() { public int handler(int which){
	/*
	...
	*/
	...
	public static ReadHandlerPtr snk_input_port_r = new ReadHandlerPtr() { public int handler(int which){
		switch( snk_io[which] ){
			case SNK_INP0:
			{
	...
	*/
	...
	public static ReadHandlerPtr snk_soundlatch_clear = new ReadHandlerPtr() { public int handler(int offset){ /* TNK3 */
		soundlatch_w( 0, 0 );
