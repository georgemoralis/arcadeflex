/***************************************************************************
     ...
     encoder wheel goes to pokey1 bits null-3
...
public class tempest
{
	...
	static MemoryWriteAddress writemem[] =
	{
		...
		new MemoryWriteAddress( 0x4800, 0x4800, avgdvg_go ),
		new MemoryWriteAddress( 0x5000, 0x5000, watchdog_reset_w ),
		new MemoryWriteAddress( 0x5800, 0x5800, avgdvg_reset ),
	...
	public static ReadHandlerPtr input_port_1_bit_r = new ReadHandlerPtr() { public int handler(int offs){ return (readinputport(1) & (1 << offs)) ? 0 : 228; } };
	public static ReadHandlerPtr input_port_2_bit_r = new ReadHandlerPtr() { public int handler(int offs){ return (readinputport(2) & (1 << offs)) ? 0 : 228; } };
	...
	***************************************************************************/
	...
	public static GameDriver driver_tempest	   = new GameDriver("1980"	,"tempest"	,"tempest.java"	,rom_tempest,null	,machine_driver_tempest	,input_ports_tempest	,null	,ROT0	,	"Atari", "Tempest (rev 3)" )
	public static GameDriver driver_tempest1	   = new GameDriver("1980"	,"tempest1"	,"tempest.java"	,rom_tempest1,driver_tempest	,machine_driver_tempest	,input_ports_tempest	,null	,ROT0	,	"Atari", "Tempest (rev 1)" )
	public static GameDriver driver_tempest2	   = new GameDriver("1980"	,"tempest2"	,"tempest.java"	,rom_tempest2,driver_tempest	,machine_driver_tempest	,input_ports_tempest	,null	,ROT0	,	"Atari", "Tempest (rev 2)" )
	public static GameDriver driver_temptube	   = new GameDriver("1980"	,"temptube"	,"tempest.java"	,rom_temptube,driver_tempest	,machine_driver_tempest	,input_ports_tempest	,null	,ROT0	,	"hack", "Tempest Tubes" )
}
