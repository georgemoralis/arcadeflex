...
public class rampart
{
	...
	public static ReadHandlerPtr opbase_override = new ReadHandlerPtr() { public int handler(int pc)
	{
	...
	static MemoryReadAddress readmem[] =
	{
		...
		new MemoryReadAddress( 0x200000, 0x21fffe, MRA_BANK1 ),
	...
	static MemoryWriteAddress writemem[] =
	{
		...
		new MemoryWriteAddress( 0x200000, 0x21fffe, rampart_playfieldram_w, atarigen_playfieldram ),
