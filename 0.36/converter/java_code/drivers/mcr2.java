...
public class mcr2
{
	...
	{
		new IOReadPort( 0x00, 0x04, mcr_port_04_dispatch_r ),
		new IOReadPort( 0x07, 0x07, ssio_status_r ),
		new IOReadPort( 0x10, 0x10, mcr_port_04_dispatch_r ),
	...
	{
		new IOWritePort( 0x00, 0x01, mcr_port_01_w ),
		new IOWritePort( 0x04, 0x07, mcr_port_47_dispatch_w ),
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, charlayout,    0, 4 ),	/* colors 0-63 */
		new GfxDecodeInfo( REGION_GFX2, 0, spritelayout,  0, 4 ),	/* colors 0-63 */
	...
	public static InitDriverPtr init_shollow = new InitDriverPtr() { public void handler() 
	{
	...
	public static InitDriverPtr init_tron = new InitDriverPtr() { public void handler() 
	{
		MCR_CONFIGURE_HISCORE(0xc000, 0x800, NULL);
		MCR_CONFIGURE_SOUND(MCR_SSIO);
		MCR_CONFIGURE_DEFAULT_PORTS;
	...
	public static InitDriverPtr init_twotiger = new InitDriverPtr() { public void handler() 
	{
		MCR_CONFIGURE_HISCORE(0xc000, 0x800, NULL);
		MCR_CONFIGURE_SOUND(MCR_SSIO);
		MCR_CONFIGURE_DEFAULT_PORTS;
	...
	public static InitDriverPtr init_journey = new InitDriverPtr() { public void handler() 
	{
		MCR_CONFIGURE_HISCORE(0xc000, 0x800, NULL);
		MCR_CONFIGURE_SOUND(MCR_SSIO);
		MCR_CONFIGURE_DEFAULT_PORTS;
	...
	public static GameDriver driver_shollow	   = new GameDriver("1981"	,"shollow"	,"mcr2.java"	,rom_shollow,null	,machine_driver_mcr2	,input_ports_shollow	,init_shollow	,ROT90	,	"Bally Midway", "Satan's Hollow (set 1)" )
	public static GameDriver driver_shollow2	   = new GameDriver("1981"	,"shollow2"	,"mcr2.java"	,rom_shollow2,driver_shollow	,machine_driver_mcr2	,input_ports_shollow	,init_shollow	,ROT90	,	"Bally Midway", "Satan's Hollow (set 2)" )
	public static GameDriver driver_tron	   = new GameDriver("1982"	,"tron"	,"mcr2.java"	,rom_tron,null	,machine_driver_mcr2	,input_ports_tron	,init_tron	,ROT90	,	"Bally Midway", "Tron (set 1)" )
	public static GameDriver driver_tron2	   = new GameDriver("1982"	,"tron2"	,"mcr2.java"	,rom_tron2,driver_tron	,machine_driver_mcr2	,input_ports_tron	,init_tron	,ROT90	,	"Bally Midway", "Tron (set 2)" )
	...
	public static GameDriver driver_twotiger	   = new GameDriver("1984"	,"twotiger"	,"mcr2.java"	,rom_twotiger,null	,machine_driver_mcr2	,input_ports_twotiger	,init_twotiger	,ROT0	,	"Bally Midway", "Two Tigers" )
	GAMEX(1983, journey,  null,       journey, domino,   journey,  ROT90, "Bally Midway", "Journey", GAME_IMPERFECT_SOUND )
}
