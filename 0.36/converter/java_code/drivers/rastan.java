...
public class rastan
{
	...
	public static WriteHandlerPtr rastan_background_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	public static ReadHandlerPtr rastan_sound_spin = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	static MemoryWriteAddress rastan_s_writemem[] =
	{
		...
		new MemoryWriteAddress( 0xb000, 0xb000, ADPCM_trigger ),
