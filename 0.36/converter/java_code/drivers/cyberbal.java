...
public class cyberbal
{
	...
	public static InitDriverPtr init_machine = new InitDriverPtr() { public void handler() 
	{
	...
	public static GameDriver driver_cyberbal	   = new GameDriver("1988"	,"cyberbal"	,"cyberbal.java"	,rom_cyberbal,null	,machine_driver_cyberbal	,input_ports_cyberbal	,init_cyberbal	,ROT0_16BIT	,	"Atari Games", "Cyberball" )
