...
public class wow
{
	...
	public static WriteHandlerPtr gorf_sound_control_a_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	public static WriteHandlerPtr wow_colour_register_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static WriteHandlerPtr wow_colour_split_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	{
		new IOWritePort( 0x00, 0x07, wow_colour_register_w ),
		new IOWritePort( 0x08, 0x08, MWA_NOP ), /* Gorf uses this */
		new IOWritePort( 0x09, 0x09, wow_colour_split_w ),
		new IOWritePort( 0x0a, 0x0b, MWA_NOP ), /* Gorf uses this */
	...
	public static InitMachinePtr wow_machine_init = new InitMachinePtr() { public void handler() 
	{
	...
	public static InitMachinePtr gorf_machine_init = new InitMachinePtr() { public void handler() 
	{
	...
	public static InitMachinePtr seawolf2_machine_init = new InitMachinePtr() { public void handler() 
	{
	...
	public static InitMachinePtr ebases_machine_init = new InitMachinePtr() { public void handler() 
	{
	...
	***************************************************************************/
	...
	public static GameDriver driver_wow	   = new GameDriver("1980"	,"wow"	,"wow.java"	,rom_wow,null	,machine_driver_wow	,input_ports_wow	,null	,ROT0	,	"Midway", "Wizard of Wor", GAME_IMPERFECT_COLORS )
	public static GameDriver driver_robby	   = new GameDriver("1981"	,"robby"	,"wow.java"	,rom_robby,null	,machine_driver_robby	,input_ports_robby	,null	,ROT0	,	"Bally Midway", "Robby Roto", GAME_IMPERFECT_COLORS )
	public static GameDriver driver_gorf	   = new GameDriver("1981"	,"gorf"	,"wow.java"	,rom_gorf,null	,machine_driver_gorf	,input_ports_gorf	,null	,ROT270	,	"Midway", "Gorf", GAME_IMPERFECT_COLORS )
	public static GameDriver driver_gorfpgm1	   = new GameDriver("1981"	,"gorfpgm1"	,"wow.java"	,rom_gorfpgm1,driver_gorf	,machine_driver_gorf	,input_ports_gorf	,null	,ROT270	,	"Midway", "Gorf (Program 1)", GAME_IMPERFECT_COLORS )
	public static GameDriver driver_spacezap	   = new GameDriver("1980"	,"spacezap"	,"wow.java"	,rom_spacezap,null	,machine_driver_spacezap	,input_ports_spacezap	,null	,ROT0	,	"Midway", "Space Zap", GAME_IMPERFECT_COLORS )
	public static GameDriver driver_seawolf2	   = new GameDriver("1978"	,"seawolf2"	,"wow.java"	,rom_seawolf2,null	,machine_driver_seawolf	,input_ports_seawolf2	,null	,ROT0	,	"Midway", "Sea Wolf II", GAME_IMPERFECT_COLORS )
	public static GameDriver driver_ebases	   = new GameDriver("1980"	,"ebases"	,"wow.java"	,rom_ebases,null	,machine_driver_ebases	,input_ports_ebases	,null	,ROT0	,	"Midway", "Extra Bases", GAME_WRONG_COLORS )
}
