...
Program Page null Address             1400            W   D10-D15
...
Alphanumerics RAM (VMMU=null)         2000-37FE      R/W  D0-D15
Motion Object RAM (VMMU=null)         3800-3FFF      R/W  D0-D15
Playfield RAM Top (VMMU=2)         2000-3FFF      R/W  D0-D15
Playfield RAM Bottom (VMMU=3)      2000-3FFF      R/W  D0-D15

Paged Program ROM (Page null)         4000-5FFF       R   D0-D15
...
public class atarisy2
{
	...
	public static WriteHandlerPtr atarisys2_paletteram_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	{
		new MemoryReadAddress( 0x0000, 0x0fff, MRA_RAM ),
		new MemoryReadAddress( 0x1000, 0x17ff, MRA_RAM ),	/* EEPROM */
	...
	{
		new MemoryWriteAddress( 0x0000, 0x0fff, MWA_RAM ),
		new MemoryWriteAddress( 0x1000, 0x17ff, MWA_RAM, atarigen_eeprom, atarigen_eeprom_size ),	/* EEPROM */
		...
		new MemoryWriteAddress( 0x1876, 0x1876, MWA_NOP ),	/* coin counters */
	...
	(
		...
		16384,  /* 16384 of them */
		4,		/* 4 bits per pixel */
		new int[] { 0, 4, 16384*16*8, 16384*16*8+4 },
		new int[] { 0, 1, 2, 3, 8, 9, 10, 11 },
		new int[] { 0*16, 1*16, 2*16, 3*16, 4*16, 5*16, 6*16, 7*16 },
	...
	(
		...
		8192,  /* 8192 of them */
		4,	   /* 4 bits per pixel */
		new int[] { 0, 4, 8192*64*8, 8192*64*8+4 },
