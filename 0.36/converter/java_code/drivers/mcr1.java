...
public class mcr1
{
	...
	static GfxDecodeInfo gfxdecodeinfo[] =
	{
		...
		new GfxDecodeInfo( REGION_GFX2, 0, spritelayout, 16, 1 ),	/* colors 16-31 */
	...
	(
		...
		/* video hardware */
		32*16, 32*16, new rectangle( 0, 32*16-1, 0, 30*16-1 ),
		gfxdecodeinfo,
		32,32,
		null,
	...
	public static GameDriver driver_solarfox	   = new GameDriver("1981"	,"solarfox"	,"mcr1.java"	,rom_solarfox,null	,machine_driver_mcr1	,input_ports_solarfox	,init_solarfox	,ORIENTATION_SWAP_XY	,	"Bally Midway", "Solar Fox" )
	public static GameDriver driver_kick	   = new GameDriver("1981"	,"kick"	,"mcr1.java"	,rom_kick,null	,machine_driver_mcr1	,input_ports_kick	,init_kick	,ORIENTATION_SWAP_XY	,	"Midway", "Kick (mirror version)" )
	public static GameDriver driver_kicka	   = new GameDriver("1981"	,"kicka"	,"mcr1.java"	,rom_kicka,driver_kick	,machine_driver_mcr1	,input_ports_kick	,init_kick	,ROT90	,	"bootleg?", "Kick (upright version)" )
}
