...
Scroll null	RW	090000-093fff	050000-053fff	0e0000-0e3fff	0d0000-0d3fff
...
- Making the M6295 status register return null fixes the music tempo in
  avspirit, 64street, astyanax etc. but makes most of the effects in
  hachoo disappear! Define SOUND_HACK to null to turn this hack off
...
public class megasys1
{
	...
	public static WriteHandlerPtr paletteram_RRRRRGGGGGBBBBBx_word_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	***************************************************************************/
	...
	public static ReadHandlerPtr coins_r = new ReadHandlerPtr() { public int handler(int offset){return input_port_0_r(0);} };	// < 00 | Coins >
	public static ReadHandlerPtr player1_r = new ReadHandlerPtr() { public int handler(int offset){return input_port_1_r(0);} };	// < 00 | Player 1 >
	public static ReadHandlerPtr player2_r = new ReadHandlerPtr() { public int handler(int offset){return (input_port_2_r(0)<<8)+input_port_3_r(0);} };		// < Reserve | Player 2 >
	public static ReadHandlerPtr dsw1_r = new ReadHandlerPtr() { public int handler(int offset){return input_port_4_r(0);} };							//   DSW 1
	public static ReadHandlerPtr dsw2_r = new ReadHandlerPtr() { public int handler(int offset){return input_port_5_r(0);} };							//   DSW 2
	public static ReadHandlerPtr dsw_r = new ReadHandlerPtr() { public int handler(int offset){return (input_port_4_r(0)<<8)+input_port_5_r(0);} };		// < DSW 1 | DSW 2 >
