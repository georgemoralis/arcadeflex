...
public class vaportra
{
	...
	public static WriteHandlerPtr vaportra_palette_24bit_rg = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static WriteHandlerPtr vaportra_palette_24bit_b = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	static unsigned char *vaportra_ram;
	
	public static WriteHandlerPtr vaportra_update_sprites = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	static MemoryWriteAddress vaportra_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x300000, 0x3009ff, vaportra_palette_24bit_rg, paletteram ),
		new MemoryWriteAddress( 0x304000, 0x3049ff, vaportra_palette_24bit_b, paletteram_2 ),
		new MemoryWriteAddress( 0x308000, 0x308001, MWA_NOP ),
		new MemoryWriteAddress( 0x30c000, 0x30c001, vaportra_update_sprites ),
	...
	public static GameDriver driver_vaportra	   = new GameDriver("1989"	,"vaportra"	,"vaportra.java"	,rom_vaportra,null	,machine_driver_vaportra	,input_ports_vaportra	,init_vaportra	,ROT270	,	"Data East USA", "Vapor Trail - Hyper Offence Formation (US)" )
