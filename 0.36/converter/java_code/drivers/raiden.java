...
public class raiden
{
	...
	public static ReadHandlerPtr sub_cpu_spin = new ReadHandlerPtr() { public int handler(int offset)
	{
		int pc=cpu_get_pc();
	...
	public static ReadHandlerPtr sub_cpu_spina = new ReadHandlerPtr() { public int handler(int offset)
	{
		int pc=cpu_get_pc();
		int ret=raiden_shared_ram[0x8];
