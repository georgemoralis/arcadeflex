...
public class z80bw
{
	...
	public static InterruptPtr astinvad_interrupt = new InterruptPtr() { public int handler() ;
	...
	***************************************************************************/
	...
	GAMEX(1980, spaceint, null,        spaceint, spaceint, spaceint, ROT0,   "Shoei", "Space Intruder", GAME_WRONG_COLORS | GAME_NO_SOUND )
}
