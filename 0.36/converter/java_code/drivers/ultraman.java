...
public class ultraman
{
	...
	public static ReadHandlerPtr ultraman_K051316_r_0 = new ReadHandlerPtr() { public int handler(int offset)
	{
		return K051316_0_r(offset >> 1);
	} };
	
	public static ReadHandlerPtr ultraman_K051316_r_1 = new ReadHandlerPtr() { public int handler(int offset)
	{
		return K051316_1_r(offset >> 1);
	} };
	
	public static ReadHandlerPtr ultraman_K051316_r_2 = new ReadHandlerPtr() { public int handler(int offset)
	{
		return K051316_2_r(offset >> 1);
	} };
	
	public static WriteHandlerPtr ultraman_K051316_w_0 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
			K051316_0_w(offset >> 1, data & 0xff);
	} };
	
	public static WriteHandlerPtr ultraman_K051316_w_1 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
			K051316_1_w(offset >> 1, data & 0xff);
	} };
	
	public static WriteHandlerPtr ultraman_K051316_w_2 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
			K051316_2_w(offset >> 1, data & 0xff);
	} };
	
	public static WriteHandlerPtr ultraman_K051316_ctrl_w_0 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
			K051316_ctrl_0_w(offset >> 1, data & 0xff);
	} };
	
	public static WriteHandlerPtr ultraman_K051316_ctrl_w_1 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
	...
	public static WriteHandlerPtr ultraman_K051316_ctrl_w_2 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		if ((data & 0x00ff0000) == 0)
	...
	static MemoryReadAddress ultraman_readmem[] =
	{
		...
		new MemoryReadAddress( 0x204000, 0x204fff, ultraman_K051316_r_0 ),	/* K051316 #0 RAM */
		new MemoryReadAddress( 0x205000, 0x205fff, ultraman_K051316_r_1 ),	/* K051316 #1 RAM */
		new MemoryReadAddress( 0x206000, 0x206fff, ultraman_K051316_r_2 ),	/* K051316 #2 RAM */
	...
	static MemoryWriteAddress ultraman_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x204000, 0x204fff, ultraman_K051316_w_0 ),		/* K051316 #0 RAM */
		new MemoryWriteAddress( 0x205000, 0x205fff, ultraman_K051316_w_1 ),		/* K051316 #1 RAM */
		new MemoryWriteAddress( 0x206000, 0x206fff, ultraman_K051316_w_2 ),		/* K051316 #2 RAM */
		new MemoryWriteAddress( 0x207f80, 0x207f9f, ultraman_K051316_ctrl_w_0	),	/* K051316 #0 registers  */
		new MemoryWriteAddress( 0x207fa0, 0x207fbf, ultraman_K051316_ctrl_w_1	),	/* K051316 #1 registers */
		new MemoryWriteAddress( 0x207fc0, 0x207fdf, ultraman_K051316_ctrl_w_2	),	/* K051316 #2 registers */
	...
	(
		...
		/* video hardware */
		64*8, 32*8, new rectangle( 14*8, (64-14)*8, 2*8, 30*8-1 ),
