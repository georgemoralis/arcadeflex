...
public class marvins
{
	...
	***************************************************************************/
	...
	public static WriteHandlerPtr CPUA_int_enable = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr CPUA_int_trigger = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr CPUB_int_enable = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static ReadHandlerPtr CPUB_int_trigger = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	***************************************************************************/
	...
	public static InitDriverPtr init_marvins = new InitDriverPtr() { public void handler() 
	{
		init_sound( 0x40 );
	} };
	
	public static InitDriverPtr init_madcrash = new InitDriverPtr() { public void handler() 
	{
	/*
	...
	*/
	...
	public static InitDriverPtr init_vangrd2 = new InitDriverPtr() { public void handler() 
	{
		init_sound( 0x20 );
		madcrash_vreg = 0xf1;
	} };
	...
	GAMEX(1984, madcrash, null, madcrash, madcrash, madcrash, ROT0,   "SNK", "Mad Crasher", GAME_IMPERFECT_SOUND )
