...
public class armedf
{
	...
	static void io_w (int offset,int data)(
		switch (offset/2)(
			...
			/* bits null and 1 of armedf_vreg are coin counters */
			break;
			...
			case 0x4:
			(
				static int flipflop = null; /* hack? - needed for Terra Force */
				flipflop = 1-flipflop;
				if( !flipflop )(
	...
	public static ReadHandlerPtr soundlatch_clr = new ReadHandlerPtr() { public int handler(int offset){
	...
	{
		new IOReadPort( 0x4, 0x4, soundlatch_clr ),
	...
	static IOWritePort writeport[] =
	{
		...
		new IOWritePort( 0x1, 0x1, YM3812_write_port_0_w ),
	  	new IOWritePort( 0x2, 0x3, DAC_signed_data_w ),	/* 2 channels */
