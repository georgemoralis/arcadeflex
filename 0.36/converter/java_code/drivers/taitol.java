...
- The source of   irqs null and  1 is  ignored, while  2 is vblank  (null is
...
Registers null-3 are data,  register 4 is  flags.  They probably are only
4bits wide.
...
bit null : set to 1 when register 1 is written, set to null when it is read
bit 1 : set to 1 when register 3 is written, set to null when it is read
...
public class taitol
{
	...
	public static WriteHandlerPtr taitol_bankg_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static ReadHandlerPtr taitol_bankg_r = new ReadHandlerPtr() { public int handler(int offset);
	...
	static MemoryReadAddress horshoes_readmem[] ={
		COMMON_BANKS_READ,
		COMMON_SINGLE_READ,
		new MemoryReadAddress( 0xa800, 0xa800, input_port_4_r ),
		new MemoryReadAddress( 0xa804, 0xa804, input_port_5_r ),
		new MemoryReadAddress( 0xa808, 0xa808, input_port_6_r ),
		new MemoryReadAddress( 0xa80c, 0xa80c, input_port_7_r ),
	...
	static MemoryWriteAddress horshoes_writemem[] ={
		COMMON_BANKS_WRITE,
		COMMON_SINGLE_WRITE,
		new MemoryWriteAddress( 0xb802, 0xb802, taitol_bankg_w ),
	...
	static MemoryReadAddress fhawk_2_readmem[] ={
		...
		new MemoryReadAddress( 0xc800, 0xc801, MRA_NOP ), // Pipe
	...
	static MemoryWriteAddress fhawk_2_writemem[] ={
		...
		new MemoryWriteAddress( 0xc800, 0xc801, MWA_NOP ), // Pipe
	...
	static MemoryReadAddress fhawk_3_readmem[] ={
		new MemoryReadAddress( 0x0000, 0x7fff, MRA_ROM ),
		new MemoryReadAddress( 0x8000, 0x9fff, MRA_RAM ),
		new MemoryReadAddress( 0xe000, 0xe001, MRA_NOP ), // Pipe
	...
	static MemoryWriteAddress fhawk_3_writemem[] ={
		...
		new MemoryWriteAddress( 0xe000, 0xe001, MWA_NOP ), // Pipe
	...
	static MemoryReadAddress raimais_readmem[] ={
		...
		new MemoryReadAddress( 0x8c00, 0x8c01, MRA_NOP ), // Pipe
		new MemoryReadAddress( 0xa000, 0xbfff, MRA_RAM ),
		new MemoryReadAddress( -1 )
	};
	static MemoryWriteAddress raimais_writemem[] ={
		...
		new MemoryWriteAddress( 0x8c00, 0x8c01, MWA_NOP ), // Pipe
		new MemoryWriteAddress( 0xa000, 0xbfff, MWA_RAM ),
		new MemoryWriteAddress( -1 )
	};
	...
	static MemoryReadAddress raimais_3_readmem[] ={
		...
		new MemoryReadAddress( 0xe200, 0xe201, MRA_NOP ), // Pipe
		new MemoryReadAddress( -1 )
	};
	...
	static MemoryWriteAddress raimais_3_writemem[] ={
		...
		new MemoryWriteAddress( 0xe200, 0xe201, MWA_NOP ), // Pipe
		new MemoryWriteAddress( -1 )
	};
	...
	static MemoryReadAddress champwr_3_readmem[] ={
		...
		new MemoryReadAddress( 0xa000, 0xa001, MRA_NOP ), // Pipe
		new MemoryReadAddress( -1 )
	};
	...
	static MemoryWriteAddress champwr_3_writemem[] ={
		...
		new MemoryWriteAddress( 0xa000, 0xa001, MWA_NOP ), // Pipe
		new MemoryWriteAddress( -1 )
	};
	...
	(
		...
		16384,
		4,
		new int[] { 8*0x40000, 8*0x40000+4, 0, 4 },
	...
	(														\
		...
		name ## _init,										\
															\
		320, 256, new rectangle( 0, 319, 16, 239 ),						\
		gfxdecodeinfo1,										\
		256, 256, null,										\
															\
	...
	// bits 7..0 => bits 0..7
	public static InitDriverPtr init_plotting = new InitDriverPtr() { public void handler() 
	{
	...
	public static GameDriver driver_puzznic	   = new GameDriver("1989"	,"puzznic"	,"taitol.java"	,rom_puzznic,null	,machine_driver_puzznic	,input_ports_puzznic	,null	,ROT0	,	"Taito Corporation", "Puzznic (Japan)" )
	public static GameDriver driver_plotting	   = new GameDriver("1989"	,"plotting"	,"taitol.java"	,rom_plotting,null	,machine_driver_plotting	,input_ports_plotting	,init_plotting	,ROT0	,	"Taito Corporation Japan", "Plotting (World)" )
	public static GameDriver driver_palamed	   = new GameDriver("1990"	,"palamed"	,"taitol.java"	,rom_palamed,null	,machine_driver_palamed	,input_ports_palamed	,null	,ROT0	,	"Taito Corporation", "Palamedes (Japan)" )
	GAMEX(1990, horshoes, null,       horshoes, horshoes, null,        ROT270, "Taito America Corporation", "American Horseshoes (US)", GAME_NOT_WORKING )
	public static GameDriver driver_cachat	   = new GameDriver("1993"	,"cachat"	,"taitol.java"	,rom_cachat,null	,machine_driver_cachat	,input_ports_palamed	,null	,ROT0	,	"Taito Corporation", "Cachat (Japan)" )
}
