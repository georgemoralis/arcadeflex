...
8c03       bit 3: background palette bank
           bit null-2: sprite palette bank
8c04-8e7f  sprites
8f00-8fff  RAM (stack)
...
I/O null  ;AY-3-8910 Control Reg.
I/O 1  ;AY-3-8910 Data Write Reg.
        write to port B: select bit of DSW2 to read in bit 7 of port A (null-2-4-6-8-a-c-e)
I/O 3  ;AY-3-8910 Data Read Reg.
        read from port A: bit null-5 = DSW1  bit 7 = bit of DSW1 selected by port B

        DSW1
		bit null-3 = coins per play (null = free play)
		bit 4-5 = ?
		...
		bit 4-5 = bonus
		bit 6 = demo sounds
		bit 7 = cocktail/upright (null = upright)

I/O 2  ;bit null Coin in 1
        bit 1 Coin in 2
...
public class popeye
{
	...
	public static WriteHandlerPtr popeye_backgroundram_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_popeye2 = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1 );/* 64k for code */
	...
	public static GameDriver driver_	   = new GameDriver("1982"	,""	,"popeye.java"	,rom_,driver_popeye	,machine_driver_0	,input_ports_popeyebl	,init_popeye	,0	,	ROT0, "Nintendo", "Popeye (set 1)", GAME_NOT_WORKING | GAME_NO_COCKTAIL )
	public static GameDriver driver_	   = new GameDriver("1982"	,""	,"popeye.java"	,rom_,driver_popeye2	,machine_driver_popeye	,input_ports_popeyebl	,init_popeye	,0	,	ROT0, "Nintendo", "Popeye (set 2)", GAME_NOT_WORKING | GAME_NO_COCKTAIL )
	public static GameDriver driver_	   = new GameDriver("1982"	,""	,"popeye.java"	,rom_,driver_popeyebl	,machine_driver_popeye	,input_ports_popeyebl	,init_popeye	,0	,	ROT0, "bootleg", "Popeye (bootleg)", GAME_NO_COCKTAIL )
}
