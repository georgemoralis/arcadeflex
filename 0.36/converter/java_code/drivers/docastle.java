...
c002      DSWA
          bit 6-7 = lives
		  bit 5 = upright/cocktail (null = upright)
...
c005	  IN1
          ...
          bit null = fire player 1
c085      during the boot sequence, clearing any of bits null, 1, 3, 4, 5, 7 enters the
