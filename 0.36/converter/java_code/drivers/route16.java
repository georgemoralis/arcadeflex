/***************************************************************************
 ...
 48xx OUT0 - D0-D4 color select for VRAM null
             D5    coin counter
...
public class route16
{
	...
	static MemoryWriteAddress cpu2_writemem[] =
	{
		...
		new MemoryWriteAddress( 0x2800, 0x2800, DAC_data_w ), // Not used by Route 16
	...
	***************************************************************************/
	...
	public static GameDriver driver_	   = new GameDriver(""	,""	,"route16.java"	,rom_,driver_	,machine_driver_	,input_ports_	,init_speakres	,stratvox	,	stratvox, stratvox, stratvox, ROT270, "<unknown>", "Speak  Rescue" )
}
