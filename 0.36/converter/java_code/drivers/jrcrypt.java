...
public class jrcrypt
{
	...
	public static ReadHandlerPtr jrpacman_romdecode = new ReadHandlerPtr() { public int handler(int offset);
	public static ReadHandlerPtr jrpacman_romdecodeA = new ReadHandlerPtr() { public int handler(int offset)
	{
		jrpacman_romdecode(offset);
	} };
	
	public static ReadHandlerPtr jrpacman_romdecodeB = new ReadHandlerPtr() { public int handler(int offset)
	{
