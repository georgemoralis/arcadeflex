...
2400      bit null = to sound chip MSM5205 (1 = play sample); bit 1 = IRQ enable
...
public class firetrap
{
	...
	public static WriteHandlerPtr firetrap_flipscreen_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	static MemoryWriteAddress writemem[] =
	{
		...
		new MemoryWriteAddress( 0xd000, 0xd7ff, firetrap_bg1videoram_w, firetrap_bg1videoram, firetrap_bgvideoram_size ),
		new MemoryWriteAddress( 0xd800, 0xdfff, firetrap_bg2videoram_w, firetrap_bg2videoram ),
		new MemoryWriteAddress( 0xe000, 0xe3ff, MWA_RAM, firetrap_videoram, firetrap_videoram_size ),
		new MemoryWriteAddress( 0xe400, 0xe7ff, MWA_RAM, firetrap_colorram ),
		...
		new MemoryWriteAddress( 0xf003, 0xf003, firetrap_flipscreen_w ),
		new MemoryWriteAddress( 0xf004, 0xf004, firetrap_nmi_disable_w ),
	//	new MemoryWriteAddress( 0xf005, 0xf005, firetrap_8751_w ),
		new MemoryWriteAddress( 0xf008, 0xf009, MWA_RAM, firetrap_scroll1y ),
		new MemoryWriteAddress( 0xf00a, 0xf00b, MWA_RAM, firetrap_scroll1x ),
		new MemoryWriteAddress( 0xf00c, 0xf00d, MWA_RAM, firetrap_scroll2y ),
		new MemoryWriteAddress( 0xf00e, 0xf00f, MWA_RAM, firetrap_scroll2x ),
	...
	(
		...
		256,	/* 256 characters */
		4,	/* 4 bits per pixel */
		new int[] { 0, 4, 0x8000*8+0, 0x8000*8+4 },	/* the two bitplanes for 4 pixels are packed into one byte */
		new int[] { 3, 2, 1, 0, 0x2000*8+3, 0x2000*8+2, 0x2000*8+1, 0x2000*8+0,
	...
	(
		...
		1024,	/* 1024 sprites */
		4,	/* 4 bits per pixel */
		new int[] { 0, 1024*16*16, 2*1024*16*16, 3*1024*16*16 },	/* the bitplanes are separated */
	...
	static GfxDecodeInfo gfxdecodeinfo[] =
	{
		...
		new GfxDecodeInfo( REGION_GFX2, 0x00000, tilelayout,             16*4,  4 ),
		new GfxDecodeInfo( REGION_GFX2, 0x04000, tilelayout,             16*4,  4 ),
		new GfxDecodeInfo( REGION_GFX2, 0x10000, tilelayout,             16*4,  4 ),
		new GfxDecodeInfo( REGION_GFX2, 0x14000, tilelayout,             16*4,  4 ),
		new GfxDecodeInfo( REGION_GFX3, 0x00000, tilelayout,        16*4+4*16,  4 ),
		new GfxDecodeInfo( REGION_GFX3, 0x04000, tilelayout,        16*4+4*16,  4 ),
		new GfxDecodeInfo( REGION_GFX3, 0x10000, tilelayout,        16*4+4*16,  4 ),
		new GfxDecodeInfo( REGION_GFX3, 0x14000, tilelayout,        16*4+4*16,  4 ),
		new GfxDecodeInfo( REGION_GFX4, 0x00000, spritelayout, 16*4+4*16+4*16,  4 ),
