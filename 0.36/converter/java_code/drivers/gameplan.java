...
public class gameplan
{
	...
	public static WriteHandlerPtr gameplan_select_port = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static ReadHandlerPtr gameplan_read_port = new ReadHandlerPtr() { public int handler(int offset);
	...
	static MemoryReadAddress readmem[] =
	{
	    ...
	    new MemoryReadAddress( 0x2801, 0x2801, gameplan_read_port ),
	...
	static MemoryWriteAddress writemem[] =
	{
	    ...
	    new MemoryWriteAddress( 0x2800, 0x280f, gameplan_select_port ),	/* VIA 2 */
