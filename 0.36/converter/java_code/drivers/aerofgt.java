...
public class aerofgt
{
	...
	public static WriteHandlerPtr turbofrc_bg2scrollx_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_unkvsys = new RomLoadPtr(){ public void handler(){ 
	...
	public static GameDriver driver_	   = new GameDriver(""	,""	,"aerofgt.java"	,rom_,driver_	,machine_driver_	,input_ports_	,init_unkvsys	,0	,	unkvsys,  aerofgt,  null, ROT90,  "Video System Co.", "unknown", GAME_NO_COCKTAIL )
}
