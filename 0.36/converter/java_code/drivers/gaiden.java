...
public class gaiden
{
	...
	public static WriteHandlerPtr gaiden_unknownram_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	public static ReadHandlerPtr gaiden_unknownram_r = new ReadHandlerPtr() { public int handler(int offset);
	...
	public static WriteHandlerPtr gaiden_background_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	void gaiden_vh_screenrefresh(struct osd_bitmap *bitmap,int full_refresh);
	...
	{
		if (data & 0xff000000) soundlatch_w.handler(0,data & 0xff);	/* Ninja Gaiden */
		if (data & 0x00ff0000) soundlatch_w.handler(0,(data >> 8) & 0xff);	/* Tecmo Knight */
	...
	#if 0
	static GfxLayout old_spritelayout = new GfxLayout
	(
		8,8,	/* sprites size */
