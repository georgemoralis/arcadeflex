...
public class meadows
{
	...
	/* Sound handler stop				*/
	/************************************/
	public static ShStopPtr meadows_sh_stop = new ShStopPtr() { public void handler() 
	{
	...
	/************************************/
	public static ShUpdatePtr meadows_sh_update = new ShUpdatePtr() { public void handler() 
	{
	...
	int preset, amp;
	    ...
	    if (latched_0c01 != meadows_0c01 || latched_0c03 != meadows_0c03)
		{
			...
			if (errorlog != 0) fprintf(errorlog, "meadows ctr1 channel #%d preset:%3d freq:%5d amp:%d\n", channel, preset, freq1, amp);
		...
		if (latched_0c02 != meadows_0c02 || latched_0c03 != meadows_0c03)
		{
			...
			if (errorlog != 0) fprintf(errorlog, "meadows ctr2 channel #%d preset:%3d freq:%5d amp:%d\n", channel+1, preset, freq2, amp);
