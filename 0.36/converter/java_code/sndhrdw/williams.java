...
public class williams
{
	...
	****************************************************************************/
	...
	static public static ReadHandlerPtr williams_cvsd_pia_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr williams_ym2151_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr counter_down_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr counter_value_r = new ReadHandlerPtr() { public int handler(int offset);
	
	static public static WriteHandlerPtr williams_dac_data_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams_dac2_data_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams_cvsd_pia_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams_ym2151_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams_cvsd_bank_select_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	static public static ReadHandlerPtr williams_adpcm_command_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr williams_adpcm_bank_select_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams_adpcm_6295_bank_select_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	static public static ReadHandlerPtr williams_narc_command_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static ReadHandlerPtr williams_narc_command2_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr williams_narc_command2_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams_narc_master_bank_select_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr williams_narc_slave_bank_select_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	static void counter_enable(int param);
	static public static WriteHandlerPtr counter_divisor_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr counter_down_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr counter_value_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	
	static public static WriteHandlerPtr cvsd_state_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static WriteHandlerPtr dac_state_bank_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	****************************************************************************/
	...
	public static WriteHandlerPtr williams_cvsd_init = new WriteHandlerPtr() { public void handler(int cpunum, int pianum)
	{
		UINT16 entry_point;
		UINT8 *RAM;
	...
	static void locate_audio_hotspot(UINT8 *base, UINT16 start)
	{
		...
		for (i = start; i < 0x10000; i++)
		{
				...
				base[i +10] == 0x1c && base[i +11] == 0xaf)				/* 1C AF       ANDCC #$00AF  */
			{
				...
				if (errorlog != 0) fprintf(errorlog, "Found hotspot @ %04X", i);
				return;
			}
		}
		if (errorlog != 0) fprintf(errorlog, "Found no hotspot!");
	}
