...
public class llander
{
	...
	//	if (errorlog != 0) fprintf (errorlog, "LANDER: Multiplier=%lx remainder=%lx fraction=%lx rate=%x\n",multiplier,remainder,fraction,emulation_rate);
	...
	//		if (errorlog != 0) fprintf (errorlog, "LFSR Buffer: %04x    Next=%04x\n",loop, lfsr_buffer[loop]);
		}
	...
	public static ShStopPtr llander_sh_stop = new ShStopPtr() { public void handler() 
	{
	} };
	...
	***************************************************************************/
	...
	//		if (errorlog != 0) fprintf (errorlog, "LANDER: sampnum=%x oversampnum=%lx\n",sampnum, oversampnum);
	...
	public static ShUpdatePtr llander_sh_update_partial = new ShUpdatePtr() { public void handler() 
	{
		int newpos;
	...
	public static ShUpdatePtr llander_sh_update = new ShUpdatePtr() { public void handler() 
	{
		if (Machine.sample_rate == 0) return;
