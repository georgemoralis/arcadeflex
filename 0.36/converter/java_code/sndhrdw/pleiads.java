...
public class pleiads
{
	 ...
	 *****************************************************************************/
	INLINE public static ReadHandlerPtr tone1 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	 ...
	 *****************************************************************************/
	INLINE public static ReadHandlerPtr update_pb4 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr tone23 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	 ...
	 *****************************************************************************/
	INLINE public static ReadHandlerPtr update_c_pc4 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr update_c_pc5 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int counter, level;
	...
	INLINE public static ReadHandlerPtr update_c_pa5 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int counter, level;
	...
	INLINE public static ReadHandlerPtr tone4 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	 ...
	 *****************************************************************************/
	INLINE public static ReadHandlerPtr update_c_pa6 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int counter, level;
	...
	INLINE public static ReadHandlerPtr noise = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	public static WriteHandlerPtr pleiads_sound_control_a_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog, "pleiads_sound_control_b_w $%02x\n", data);
	...
	public static WriteHandlerPtr pleiads_sound_control_c_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if (errorlog != 0) fprintf(errorlog, "pleiads_sound_control_c_w $%02x\n", data);
		stream_update(channel,0);
		sound_latch_c = data;
	} };
	...
	public static ShStopPtr pleiads_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (poly18 != 0)
			free(poly18);
		poly18 = NULL;
