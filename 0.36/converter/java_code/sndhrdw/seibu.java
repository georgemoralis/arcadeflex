...
public class seibu
{
	...
	public static WriteHandlerPtr seibu_rst10_ack = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		/* Unused for now */
	} };
	
	public static WriteHandlerPtr seibu_rst18_ack = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	public static WriteHandlerPtr seibu_bank_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		...
		if ((data & 1) != 0) { cpu_setbank(1,&RAM[0x0000]); }
	...
	public static WriteHandlerPtr seibu_soundclear_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		seibu_shared_sound_ram[0]=data;
	} };
	
	public static WriteHandlerPtr seibu_soundlatch_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static public static ReadHandlerPtr sound_cpu_spin = new ReadHandlerPtr() { public int handler(int offset)
	{
		unsigned char *RAM;
