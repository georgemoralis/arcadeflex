...
public class phoenix
{
	...
	INLINE public static ReadHandlerPtr tone1_vco1 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr tone1_vco2 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int output, counter, level;
	...
	INLINE public static ReadHandlerPtr tone2_vco = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr tone2 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int counter, divisor, output;
	...
	INLINE public static ReadHandlerPtr update_c24 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int counter, level;
		/*
	...
	INLINE public static ReadHandlerPtr update_c25 = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int counter, level;
		/*
	...
	public static ShStopPtr phoenix_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (poly18 != 0)
			free(poly18);
		poly18 = NULL;
