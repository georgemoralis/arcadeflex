...
public class segar
{
	...
	***************************************************************************/
	...
	public static ShUpdatePtr astrob_speech_sh_update = new ShUpdatePtr() { public void handler() 
	{
		int sound;
	...
	public static WriteHandlerPtr astrob_speech_port_w = new WriteHandlerPtr() { public void handler(int offset, int val)
	{
		if( Machine.samples == 0 )
			return;
