...
public class geebee
{
	...
	public static WriteHandlerPtr geebee_sound_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	...
	public static ShStopPtr geebee_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (volume_timer != 0)
			timer_remove(volume_timer);
		volume_timer = NULL;
	...
	public static ShUpdatePtr geebee_sh_update = new ShUpdatePtr() { public void handler() 
	{
		stream_update(channel,0);
	} };
}
