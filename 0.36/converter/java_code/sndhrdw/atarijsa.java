...
public class atarijsa
{
	...
	static public static ReadHandlerPtr jsa1_io_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr jsa1_io_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static ReadHandlerPtr jsa2_io_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr jsa2_io_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	static public static ReadHandlerPtr jsa3_io_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr jsa3_io_w = new WriteHandlerPtr() { public void handler(int offset, int data);
	...
	static public static ReadHandlerPtr jsa1_io_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		...
		{
			case 0x000:		/* n/c */
				if (errorlog != 0) fprintf(errorlog, "atarijsa: Unknown read at %04X\n", offset & 0x206);
				break;
	...
	static public static WriteHandlerPtr jsa1_io_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		switch (offset & 0x206)
		{
			...
			case 0x002:		/* /RDP */
			case 0x004:		/* /RDIO */
				if (errorlog != 0) fprintf(errorlog, "atarijsa: Unknown write (%02X) at %04X\n", data & 0xff, offset & 0x206);
				break;
	...
	static public static ReadHandlerPtr jsa3s_io_r = new ReadHandlerPtr() { public int handler(int offset)
	{
		int result = 0xff;
	...
	static public static WriteHandlerPtr jsa3s_io_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
		switch (offset & 0x206)
		{
			case 0x000:		/* /RDV */
