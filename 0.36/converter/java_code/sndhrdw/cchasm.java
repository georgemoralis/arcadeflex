...
public class cchasm
{
	...
	static public static WriteHandlerPtr ctc_timer_1 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
	...
	static public static WriteHandlerPtr ctc_timer_2 = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
