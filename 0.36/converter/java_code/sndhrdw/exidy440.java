...
public class exidy440
{
	...
	public static ShStopPtr exidy440_sh_stop = new ShStopPtr() { public void handler() 
	{
	...
	public static ShUpdatePtr exidy440_sh_update = new ShUpdatePtr() { public void handler() 
	{
	} };
	...
	public static WriteHandlerPtr exidy440_sound_interrupt_clear = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
