...
public class gottlieb
{
	...
	if (errorlog != 0) fprintf(errorlog,"Votrax: intonation %d, phoneme %02x %s\n",data >> 6,data & 0x3f,PhonemeTable[data & 0x3f]);
	...
	static public static WriteHandlerPtr common_sound_control_w = new WriteHandlerPtr() { public void handler(int offset, int data)
	{
