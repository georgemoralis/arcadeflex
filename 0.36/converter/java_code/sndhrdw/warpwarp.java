...
public class warpwarp
{
	...
	public static WriteHandlerPtr warpwarp_sound_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	...
	public static WriteHandlerPtr warpwarp_music1_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	    stream_update(channel,0);
	...
	public static WriteHandlerPtr warpwarp_music2_w = new WriteHandlerPtr() { public void handler(int offs, int data)
	{
	    stream_update(channel,0);
		music2_latch = data;
		music_volume = 0x7fff;
	...
	public static ShStopPtr warpwarp_sh_stop = new ShStopPtr() { public void handler() 
	{
		if (decay != 0)
			free(decay);
		decay = NULL;
	...
	public static ShUpdatePtr warpwarp_sh_update = new ShUpdatePtr() { public void handler() 
	{
		stream_update(channel,0);
	} };
