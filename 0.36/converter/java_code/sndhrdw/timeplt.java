...
public class timeplt
{
	...
	static public static ReadHandlerPtr timeplt_portB_r = new ReadHandlerPtr() { public int handler(int offset);
	static public static WriteHandlerPtr timeplt_filter_w = new WriteHandlerPtr() { public void handler(int offset, int data);
