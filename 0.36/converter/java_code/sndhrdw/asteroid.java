...
public class asteroid
{
	...
	INLINE public static ReadHandlerPtr explosion = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr thrust = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr thump = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr saucer = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr saucerfire = new ReadHandlerPtr() { public int handler(int samplerate)
	{
	...
	INLINE public static ReadHandlerPtr shipfire = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int vco, vco_counter;
		static int amp, amp_counter;
	    static int out, counter;
	...
	INLINE public static ReadHandlerPtr life = new ReadHandlerPtr() { public int handler(int samplerate)
	{
		static int counter, out;
