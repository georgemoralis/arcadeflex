...
public class asteroid {
    ...
    static int NE555_T1(int Ra, int Rb, double C) {
        return (int) (VMAX * 2 / 3 / (0.639 * ((Ra) + (Rb)) * (C)));
    }

    static int NE555_T2(int Ra, int Rb, double C) {
        return (int) (VMAX * 2 / 3 / (0.639 * (Rb) * (C)));
    }

    static int NE555_F(int Ra, int Rb, double C) {
        return (int) (1.44 / (((Ra) + 2 * (Rb)) * (C)));
    }
    static int channel;
    ...
    public static ShStartHandlerPtr asteroid_sh_start = new ShStartHandlerPtr() {
    ...
    public static ShStopHandlerPtr asteroid_sh_stop = new ShStopHandlerPtr() {
        public void handler() {
            if (discharge != null) {
                discharge = null;
            }
    ...
    public static ShUpdateHandlerPtr asteroid_sh_update = new ShUpdateHandlerPtr() {
        public void handler() {
            stream_update(channel, 0);
        }
    };

    public static WriteHandlerPtr asteroid_explode_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr asteroid_thump_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr asteroid_sounds_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            data &= 0x80;
    ...
    public static ShStartHandlerPtr astdelux_sh_start = new ShStartHandlerPtr() {
        public int handler(MachineSound msound) {
            /* initialize explosion volume lookup table */
            explosion_init();
    ...
    public static ShStopHandlerPtr astdelux_sh_stop = new ShStopHandlerPtr() {
        public void handler() {
        }
    };

    public static ShUpdateHandlerPtr astdelux_sh_update = new ShUpdateHandlerPtr() {
        public void handler() {
            stream_update(channel, 0);
        }
    };

    public static WriteHandlerPtr astdelux_sounds_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            data = ~data & 0x80;
