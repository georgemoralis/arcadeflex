...
public class rockola {
    ...
    static int count;
    public static ShUpdateHandlerPtr rockola_sh_update = new ShUpdateHandlerPtr() {
        public void handler() {
    ...
    public static WriteHandlerPtr satansat_sound0_w = new WriteHandlerPtr() {
 ...
 /* bit 7 sound1 volume control (TODO) */
    ...
    public static WriteHandlerPtr satansat_sound1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr vanguard_sound0_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr vanguard_sound1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* select tune in ROM based on sound command byte */
    ...
    public static WriteHandlerPtr fantasy_sound0_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* select musical tune in ROM based on sound command byte */
    ...
    public static WriteHandlerPtr fantasy_sound1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* select tune in ROM based on sound command byte */
            Sound1Base = 0x0800 + ((data & 0x07) << 8);
            Sound1Mask = 0xff;
    ...
    public static WriteHandlerPtr fantasy_sound2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
