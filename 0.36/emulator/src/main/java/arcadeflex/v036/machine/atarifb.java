...
public class atarifb {
    ...
    public static WriteHandlerPtr atarifb_out1_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr atarifb4_out1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            CTRLD = data;
    ...
    public static WriteHandlerPtr soccer_out1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* bit 0 = whistle */
 /* bit 1 = hit */
 /* bit 2 = kicker */
 ...
 /* bit 7 = Rule LED */
    ...
    public static ReadHandlerPtr atarifb_in0_r = new ReadHandlerPtr() {
    ...
    public static ReadHandlerPtr atarifb_in2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            if ((CTRLD & 0x20) == 0x00) {
    ...
    public static ReadHandlerPtr atarifb4_in0_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            ...
            if ((CTRLD & 0x60) == 0x00) {
                ...
                val = (sign_x_4 >> 7)
                        ...
                        | (sign_y_1 >> 0);
                return val;
            } else if ((CTRLD & 0x60) == 0x60) /* LD1 and LD2 both high, return Team 1 right player (player 1) */ {
            ...
            } else if ((CTRLD & 0x60) == 0x40) /* LD1 high, LD2 low, return Team 1 left player (player 2) */ {
    ...
    public static ReadHandlerPtr atarifb4_in2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            if ((CTRLD & 0x40) == 0x00) {
                return input_port_2_r.handler(offset);
            } else if ((CTRLD & 0x60) == 0x60) /* LD1 and LD2 both high, return Team 2 right player (player 3) */ {
            ...
            } else if ((CTRLD & 0x60) == 0x40) /* LD1 high, LD2 low, return Team 2 left player (player 4) */ {
