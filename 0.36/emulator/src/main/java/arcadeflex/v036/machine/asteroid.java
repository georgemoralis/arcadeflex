...
public class asteroid {
    ...
    public static InterruptHandlerPtr asteroid_interrupt = new InterruptHandlerPtr() {
        public int handler() {
    ...
    public static InterruptHandlerPtr llander_interrupt = new InterruptHandlerPtr() {
        public int handler() {
            /* Turn off interrupts if self-test is enabled */
    ...
    public static WriteHandlerPtr asteroid_bank_switch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            osd_led_w.handler(0, ~(data >> 1));
            osd_led_w.handler(1, ~data);
        }
    };
    ...
    public static WriteHandlerPtr astdelux_led_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            osd_led_w.handler(offset, ~data);
        }
    };

    public static InitMachineHandlerPtr asteroid_init_machine = new InitMachineHandlerPtr() {
        public void handler() {
