...
//vidhrdw imports
import static arcadeflex.v036.vidhrdw.missile.*;
//TODO
...
public class missile {
     ...
     * *****************************************************************************************
     */
    public static InitMachineHandlerPtr missile_init_machine = new InitMachineHandlerPtr() {
        public void handler() {
            h_pos = v_pos = 0;
        }
    };
    ...
    public static WriteHandlerPtr missile_w = new WriteHandlerPtr() {
        public void handler(int address, int data) {
            ...
            if (errorlog != null) {
                fprintf(errorlog, "possible unmapped write, offset: %04x, data: %02x\n", address, data);
            }
        }
    };
    ...
    public static ReadHandlerPtr missile_r = new ReadHandlerPtr() {
        public int handler(int address) {
            ...
            if (errorlog != null) {
                fprintf(errorlog, "possible unmapped read, offset: %04x\n", address);
            }
            return 0;
        }
    };
