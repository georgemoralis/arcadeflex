...
//vidhrdw imports
import static arcadeflex.v036.vidhrdw.mainevt.*;
...
public class mainevt {
    ...
    public static InterruptHandlerPtr mainevt_interrupt = new InterruptHandlerPtr() {
        public int handler() {
    ...
    public static WriteHandlerPtr dv_nmienable_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            nmi_enable = data;
        }
    };

    public static InterruptHandlerPtr dv_interrupt = new InterruptHandlerPtr() {
        public int handler() {
            if (nmi_enable != 0) {
    ...
    public static ReadHandlerPtr zero_ret = new ReadHandlerPtr() {
        public int handler(int offset) {
            return 0xff;
        }
    };

    public static WriteHandlerPtr mainevt_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
 ...
 /* other bits unused */
    ...
    public static WriteHandlerPtr mainevt_coin_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            coin_counter_w.handler(0, data & 0x10);
            coin_counter_w.handler(1, data & 0x20);
            osd_led_w.handler(0, data >> 0);
            osd_led_w.handler(1, data >> 1);
            osd_led_w.handler(2, data >> 2);
            osd_led_w.handler(3, data >> 3);
        }
    };

    public static WriteHandlerPtr mainevt_sh_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            cpu_cause_interrupt(1, 0xff);
        }
    };

    public static WriteHandlerPtr mainevt_sh_irqcontrol_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr devstor_sh_irqcontrol_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            interrupt_enable_w.handler(0, data & 4);
        }
    };

    public static WriteHandlerPtr mainevt_sh_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            UBytePtr src;
            UBytePtr dest;
    ...
    public static WriteHandlerPtr dv_sh_bankswitch_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            UBytePtr RAM = memory_region(REGION_SOUND1);
            int bank_A, bank_B;
     ...
     * **************************************************************************
     */
    static InputPortHandlerPtr input_ports_mainevt = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
    ...
    static InputPortHandlerPtr input_ports_ringohja = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_COIN1);
    ...
    static InputPortHandlerPtr input_ports_devstors = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_COIN1);
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_mainevt = new RomLoadHandlerPtr() {
        public void handler() {
 ...
 /* 00000-1ffff space where the following ROM is bank switched */
    ...
    static RomLoadHandlerPtr rom_mainevt2 = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
 ...
 /* 00000-1ffff space where the following ROM is bank switched */
    ...
    static RomLoadHandlerPtr rom_ringohja = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
 ...
 /* 00000-1ffff space where the following ROM is bank switched */
    ...
    static RomLoadHandlerPtr rom_devstors = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
    ...
    static RomLoadHandlerPtr rom_devstor2 = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
    ...
    static RomLoadHandlerPtr rom_devstor3 = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
    ...
    static RomLoadHandlerPtr rom_garuka = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x40000, REGION_CPU1);
    ...
    public static InitDriverHandlerPtr init_mainevt = new InitDriverHandlerPtr() {
        public void handler() {
