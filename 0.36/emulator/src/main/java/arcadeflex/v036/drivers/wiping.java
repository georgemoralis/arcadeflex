...
//sndhrdw imports
import static arcadeflex.v036.sndhrdw.wiping.*;
//vidhrdw imports
import static arcadeflex.v036.vidhrdw.generic.*;
import static arcadeflex.v036.vidhrdw.wiping.*;
//TODO
...
public class wiping {
    ...
    public static ReadHandlerPtr read_ports = new ReadHandlerPtr() {
        public int handler(int offset) {
            int i, res;
    ...
    static InputPortHandlerPtr input_ports_wiping = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* 0 */
    ...
    static InputPortHandlerPtr input_ports_rugrats = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* 0 */
            PORT_BIT(0x01, IP_ACTIVE_HIGH, IPT_JOYSTICK_UP | IPF_4WAY);
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_wiping = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_rugrats = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);/* main cpu code */
