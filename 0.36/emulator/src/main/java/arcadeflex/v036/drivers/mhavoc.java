...
//machine imports
import static arcadeflex.v036.machine.mhavoc.*;
//mame imports
...
public class mhavoc {
    ...
    static MemoryWriteAddress writemem[]
            = {
                ...
                new MemoryWriteAddress(0x1640, 0x1640, avgdvg_go), /* Vector Generator GO */
                new MemoryWriteAddress(0x1680, 0x1680, MWA_NOP), /* Watchdog Clear */
                new MemoryWriteAddress(0x16c0, 0x16c0, avgdvg_reset), /* Vector Generator Reset */
    ...
    static InputPortHandlerPtr input_ports_mhavoc = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
    ...
    static InputPortHandlerPtr input_ports_mhavocp = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 - alpha (player_1 = 0) */
            PORT_BIT(0x0f, IP_ACTIVE_HIGH, IPT_UNKNOWN);
     ...
     */
    static RomLoadHandlerPtr rom_mhavoc = new RomLoadHandlerPtr() {
        public void handler() {
 ...
 /* Gamma Processor ROM */
    ...
    static RomLoadHandlerPtr rom_mhavoc2 = new RomLoadHandlerPtr() {
        public void handler() {
            /* Alpha Processor ROMs */
 ...
 /* Gamma Processor ROM */
    ...
    static RomLoadHandlerPtr rom_mhavocrv = new RomLoadHandlerPtr() {
        public void handler() {
            /* Alpha Processor ROMs */
            ROM_REGION(0x21000, REGION_CPU1);/* 152KB for ROMs */
 /* Vector Generator ROM */
 ...
 /* Gamma Processor ROM */
    ...
    static RomLoadHandlerPtr rom_mhavocp = new RomLoadHandlerPtr() {
        public void handler() {
            /* Alpha Processor ROMs */
            ROM_REGION(0x21000, REGION_CPU1);
            /* Vector Generator ROM */
