...
public class junofrst {
 ...
 /* incremented every other state change of the clock) */
    ...
    static InputPortHandlerPtr input_ports_junofrst = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* DSW2 */
    ...
    static RomLoadHandlerPtr rom_junofrst = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    public static InitDriverHandlerPtr init_junofrst = new InitDriverHandlerPtr() {
        public void handler() {
            konami1_decode();
        }
    };
