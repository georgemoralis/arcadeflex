...
public class goindol {
    ...
    static InputPortHandlerPtr input_ports_goindol = new InputPortHandlerPtr() {
        public void handler() {
    ...
    static InputPortHandlerPtr input_ports_homo = new InputPortHandlerPtr() {
        public void handler() {
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_goindol = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_homo = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);
            /* 2*64k for code */
    ...
    public static InitDriverHandlerPtr init_goindol = new InitDriverHandlerPtr() {
        public void handler() {
    ...
    public static InitDriverHandlerPtr init_homo = new InitDriverHandlerPtr() {
        public void handler() {
            UBytePtr rom = memory_region(REGION_CPU1);
