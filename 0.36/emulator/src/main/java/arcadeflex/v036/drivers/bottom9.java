...
public class bottom9 {
    ...
    public static InterruptHandlerPtr bottom9_interrupt = new InterruptHandlerPtr() {
        public int handler() {
    ...
    public static ReadHandlerPtr bottom9_bankedram1_r = new ReadHandlerPtr() {
    ...
    public static WriteHandlerPtr bottom9_bankedram1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (K052109_selected != 0) {
                K052109_051960_w.handler(offset, data);
            } else {
    ...
    public static ReadHandlerPtr bottom9_bankedram2_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            if (K052109_selected != 0) {
                return K052109_051960_r.handler(offset + 0x2000);
            } else {
    ...
    public static WriteHandlerPtr bottom9_bankedram2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (K052109_selected != 0) {
                K052109_051960_w.handler(offset + 0x2000, data);
            } else {
    ...
    public static WriteHandlerPtr bottom9_1f90_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr bottom9_sh_irqtrigger_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static InterruptHandlerPtr bottom9_sound_interrupt = new InterruptHandlerPtr() {
        public int handler() {
            if (nmienable != 0) {
    ...
    static InputPortHandlerPtr input_ports_bottom9 = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_bottom9 = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_bottom9n = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* code + banked roms */
            ROM_LOAD("891n03.k17", 0x10000, 0x10000, 0x8b083ff3);
    ...
    public static InitDriverHandlerPtr init_bottom9 = new InitDriverHandlerPtr() {
        public void handler() {
