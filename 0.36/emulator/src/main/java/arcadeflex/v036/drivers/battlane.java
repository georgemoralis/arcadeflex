...
//vidhrdw imports
import static arcadeflex.v036.vidhrdw.battlane.*;
//TODO
...
public class battlane {
 ...
 /*
    ...
    public static InterruptHandlerPtr battlane_cpu1_interrupt = new InterruptHandlerPtr() {
        public int handler() {
    ...
    public static InterruptHandlerPtr battlane_cpu2_interrupt = new InterruptHandlerPtr() {
        public int handler() {
    ...
    static InputPortHandlerPtr input_ports_battlane = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
     ...
     * *************************************************************************
     */
    static RomLoadHandlerPtr rom_battlane = new RomLoadHandlerPtr() {
        public void handler() {
 ...
 /* first half of da00-5 will be copied at 0x4000-0x7fff */
    ...
    static RomLoadHandlerPtr rom_battlan2 = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);
            /* 64k for main CPU */
 /* first half of da00-3 will be copied at 0x4000-0x7fff */
    ...
    static RomLoadHandlerPtr rom_battlan3 = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x10000, REGION_CPU1);
            /* 64k for main CPU */
 /* first half of bl_04.rom will be copied at 0x4000-0x7fff */
    ...
    public static InitDriverHandlerPtr init_battlane = new InitDriverHandlerPtr() {
        public void handler() {
            UBytePtr src;
            UBytePtr dest;
            int A;
