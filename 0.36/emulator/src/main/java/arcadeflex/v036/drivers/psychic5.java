...
import static arcadeflex.v036.vidhrdw.psychic5.*;
//TODO
...
public class psychic5 {
    ...
    public static InterruptHandlerPtr psychic5_interrupt = new InterruptHandlerPtr() {
        public int handler() {
            if (cpu_getiloops() == 0) {
                return 0xd7;
                /* RST 10h */
    ...
    static InputPortHandlerPtr input_ports_psychic5 = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_psychic5 = new RomLoadHandlerPtr() {
        public void handler() {
