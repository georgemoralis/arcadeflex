...
//vidhrdw imports
import static arcadeflex.v036.vidhrdw.flkatck.*;
//TODO
...
public class flkatck {
     ...
     * ************************************************************************
     */
    public static InitMachineHandlerPtr flkatck_init_machine = new InitMachineHandlerPtr() {
        public void handler() {
    ...
    public static InterruptHandlerPtr flkatck_interrupt = new InterruptHandlerPtr() {
        public int handler() {
    ...
    static InputPortHandlerPtr input_ports_flkatck = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* DSW #1 */
    ...
    static RomLoadHandlerPtr rom_mx5000 = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_flkatck = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x18000, REGION_CPU1);
            /* 6309 code */
