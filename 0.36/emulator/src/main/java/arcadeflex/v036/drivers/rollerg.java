...
import static gr.codebb.arcadeflex.v037b7.sound._3812intf.YM3812_control_port_0_w;
import static gr.codebb.arcadeflex.v037b7.sound._3812intf.YM3812_status_port_0_r;
import static gr.codebb.arcadeflex.v037b7.sound._3812intf.YM3812_write_port_0_w;
...
public class rollerg {
    ...
    public static InitMachineHandlerPtr rollerg_init_machine = new InitMachineHandlerPtr() {
        public void handler() {
    ...
    public static WriteHandlerPtr rollerg_0010_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            if (errorlog != null) {
                fprintf(errorlog, "%04x: write %02x to 0010\n", cpu_get_pc(), data);
            }
     ...
     **************************************************************************
     */
    static InputPortHandlerPtr input_ports_rollerg = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_rollerg = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_rollergj = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);/* code + banked roms */
     ...
     **************************************************************************
     */
    public static InitDriverHandlerPtr init_rollerg = new InitDriverHandlerPtr() {
        public void handler() {
