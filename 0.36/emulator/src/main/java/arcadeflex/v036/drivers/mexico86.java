...
//machine imports
import static arcadeflex.v036.machine.mexico86.*;
//mame imports
...
//vidhrdw imports
import static arcadeflex.v036.vidhrdw.mexico86.*;
//TODO
...
public class mexico86 {
    ...
    static InputPortHandlerPtr input_ports_mexico86 = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
 ...
 /* and the other as slave, probably to play four players */
    ...
    static InputPortHandlerPtr input_ports_kikikai = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* IN0 */
            PORT_BIT(0x01, IP_ACTIVE_LOW, IPT_COIN1);
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_kikikai = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_kicknrun = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);
            /* 196k for code */
    ...
    static RomLoadHandlerPtr rom_mexico86 = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x28000, REGION_CPU1);
            /* 196k for code */
