 ...
 * Changelog
 * =========
 * 29/01/2023 - shadow - 0.36 version not working
 */
...
//vidhrdw imports
import static arcadeflex.v036.vidhrdw.gbusters.*;
...
public class gbusters {
    ...
    public static konami_cpu_setlines_callbackPtr gbusters_banking = new konami_cpu_setlines_callbackPtr() {
    ...
    public static InitMachineHandlerPtr gbusters_init_machine = new InitMachineHandlerPtr() {
        public void handler() {
            UBytePtr RAM = memory_region(REGION_CPU1);
    ...
    public static InterruptHandlerPtr gbusters_interrupt = new InterruptHandlerPtr() {
        public int handler() {
 ...
 /*if (data & 0xf8)
     ...
     **************************************************************************
     */
    static InputPortHandlerPtr input_ports_gbusters = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* DSW #1 */
     ...
     **************************************************************************
     */
    static RomLoadHandlerPtr rom_gbusters = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_crazycop = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x30800, REGION_CPU1);/* code + banked roms + space for banked RAM */
    ...
    public static InitDriverHandlerPtr init_gbusters = new InitDriverHandlerPtr() {
        public void handler() {
