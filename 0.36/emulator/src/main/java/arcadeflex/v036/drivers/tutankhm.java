...
public class tutankhm {
    ...
    static InputPortHandlerPtr input_ports_tutankhm = new InputPortHandlerPtr() {
        public void handler() {
            PORT_START();
            /* DSW2 */
    ...
    static RomLoadHandlerPtr rom_tutankhm = new RomLoadHandlerPtr() {
        public void handler() {
    ...
    static RomLoadHandlerPtr rom_tutankst = new RomLoadHandlerPtr() {
        public void handler() {
            ROM_REGION(0x20000, REGION_CPU1);
            /* 64k for M6809 CPU code + 64k for ROM banks */
            ROM_LOAD("h1.bin", 0x0a000, 0x1000, 0xda18679f);/* program ROMs */
