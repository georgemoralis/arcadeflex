...
public class missile {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr missile_vh_start = new VhStartHandlerPtr() {
        public int handler() {
 ...
 /*if ((missile_videoram = malloc (256 * 256)) == 0)
     ...
     **************************************************************************
     */
    public static VhStopHandlerPtr missile_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
     ...
     * *****************************************************************************************
     */
    public static VhUpdateHandlerPtr missile_vh_screenrefresh = new VhUpdateHandlerPtr() {
