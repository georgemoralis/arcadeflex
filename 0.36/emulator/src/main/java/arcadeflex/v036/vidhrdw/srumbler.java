...
public class srumbler {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr srumbler_vh_start = new VhStartHandlerPtr() {
        public int handler() {
            ...
            bg_tilemap.transmask[0] = 0xffff;
            /* split type 0 is totally transparent in front half */
            bg_tilemap.transmask[1] = 0x07ff;
            /* split type 1 has pens 0-10 transparent in front half */
     ...
     **************************************************************************
     */
    public static WriteHandlerPtr srumbler_foreground_w = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr srumbler_background_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr srumbler_4009_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            /* bit 0 flips screen */
            flipscreen = data & 1;
 ...
 /* bits 6-7 coin counters */
    ...
    public static WriteHandlerPtr srumbler_scroll_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static VhUpdateHandlerPtr srumbler_vh_screenrefresh = new VhUpdateHandlerPtr() {
