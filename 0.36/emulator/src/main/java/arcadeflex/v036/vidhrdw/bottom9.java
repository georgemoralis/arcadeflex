...
public class bottom9 {
 ...
 /* bit 5 = priority over B (1 = have priority) */
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr bottom9_vh_start = new VhStartHandlerPtr() {
        public int handler() {
            layer_colorbase[0] = 0;
            /* not used */
            layer_colorbase[1] = 0;
    ...
    public static VhStopHandlerPtr bottom9_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
            K052109_vh_stop();
            K051960_vh_stop();
            K051316_vh_stop_0();
     ...
     **************************************************************************
     */
    public static VhUpdateHandlerPtr bottom9_vh_screenrefresh = new VhUpdateHandlerPtr() {
