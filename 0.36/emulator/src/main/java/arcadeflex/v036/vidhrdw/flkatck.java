...
public class flkatck {
     ...
     **************************************************************************
     */
    public static WriteHandlerPtr get_tile_info_A = new WriteHandlerPtr() {
    ...
    public static WriteHandlerPtr get_tile_info_B = new WriteHandlerPtr() {
        public void handler(int col, int row) {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr flkatck_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStopHandlerPtr flkatck_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
        }
    };
     ...
     **************************************************************************
     */
    public static VhUpdateHandlerPtr flkatck_vh_screenrefresh = new VhUpdateHandlerPtr() {
