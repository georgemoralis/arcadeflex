...
public class vendetta {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr vendetta_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStopHandlerPtr vendetta_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
            K052109_vh_stop();
            K053247_vh_stop();
        }
 ...
 /*static void sortlayers(int *layer,int *pri)
    ...
    public static VhUpdateHandlerPtr vendetta_vh_screenrefresh = new VhUpdateHandlerPtr() {
