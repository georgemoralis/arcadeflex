...
public class surpratk {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr surpratk_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStopHandlerPtr surpratk_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
            K052109_vh_stop();
            K053245_vh_stop();
        }
 ...
 /*static void sortlayers(int *layer,int *pri)
    ...
    public static VhUpdateHandlerPtr surpratk_vh_screenrefresh = new VhUpdateHandlerPtr() {
