...
public class dec8 {
     ...
     **************************************************************************
     */
    public static VhConvertColorPromHandlerPtr ghostb_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
    ...
    public static WriteHandlerPtr dec8_pf1_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            ...
            if (errorlog != null) {
                fprintf(errorlog, "Write %d to playfield 1 register %d\n", data, offset);
            }
        }
    };

    public static WriteHandlerPtr dec8_pf2_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            switch (offset) {
                case 0:
                case 2:
            ...
            if (errorlog != null) {
                fprintf(errorlog, "Write %d to playfield 2 register %d\n", data, offset);
            }
        }
    };
 ...
 /* multi = 0   1   3   7 */
     ...
     * ***************************************************************************
     */
    public static VhUpdateHandlerPtr dec8_vh_screenrefresh = new VhUpdateHandlerPtr() {
     ...
     * ***************************************************************************
     */
    public static VhUpdateHandlerPtr ghostb_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
     ...
     * ***************************************************************************
     */
    public static VhUpdateHandlerPtr srdarwin_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int my, mx, offs, color, tile;
     ...
     * ***************************************************************************
     */
    public static VhUpdateHandlerPtr gondo_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int my, mx, offs, color, tile;
            int scrollx, scrolly;
     ...
     * ***************************************************************************
     */
    public static VhUpdateHandlerPtr garyoret_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int my, mx, offs, color, tile;
            int scrollx, scrolly;
 ...
 /* Top tiles */
     ...
     * ***************************************************************************
     */
    public static VhUpdateHandlerPtr oscar_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int my, mx, offs, color, tile;
            int scrollx, scrolly;
    ...
    public static VhUpdateHandlerPtr lastmiss_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            int my, mx, offs, color, tile;
     ...
     * ***************************************************************************
     */
    public static ReadHandlerPtr dec8_video_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return pf_video[offset];
        }
    };

    public static WriteHandlerPtr dec8_video_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static VhStartHandlerPtr dec8_vh_start = new VhStartHandlerPtr() {
        public int handler() {
            int i;
            ...
            shackled_priority = 0;
            if (strcmp(Machine.gamedrv.name, "breywood") == 0) {
                shackled_priority = 1;
            }
            if (strcmp(Machine.gamedrv.name, "shackled") == 0) {
                shackled_priority = 1;
            }
    ...
    public static VhStopHandlerPtr dec8_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
    ...
    static int old;
    public static WriteHandlerPtr dec8_flipscreen_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
     ...
     * ***************************************************************************
     */
    public static ReadHandlerPtr srdarwin_video_r = new ReadHandlerPtr() {
        public int handler(int offset) {
            return srdarwin_tileram.read(offset);
        }
    };

    public static WriteHandlerPtr srdarwin_video_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
    ...
    public static WriteHandlerPtr get_srdarwin_tile_info = new WriteHandlerPtr() {
    ...
    public static VhStartHandlerPtr srdarwin_vh_start = new VhStartHandlerPtr() {
        public int handler() {
            ...
            if (background_layer != null) {
                background_layer.transmask[0] = 0x00ff;
                /* Bottom 8 pens */
                background_layer.transmask[1] = 0xff00;
                /* Top 8 pens */
