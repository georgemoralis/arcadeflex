...
public class battlane {
     ...
     * *************************************************************************
     */
    public static VhStartHandlerPtr battlane_vh_start = new VhStartHandlerPtr() {
        public int handler() {
     ...
     * *************************************************************************
     */
    public static VhStopHandlerPtr battlane_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
            if (screen_bitmap != null) {
     ...
     * *************************************************************************
     */
    public static VhUpdateHandlerPtr battlane_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
            ...
            /* copy the background graphics */
            {
                ...
                scrlx = -scrollx;
                scrly = -scrolly;
                copyscrollbitmap(bitmap, bkgnd_bitmap, 1, new int[]{scrly}, 1, new int[]{scrlx}, Machine.drv.visible_area, TRANSPARENCY_NONE, 0);
            }
            {
                //char baf[256];
                //char baf2[40];
