...
public class tnzs {
     ...
     **************************************************************************
     */
    public static VhConvertColorPromHandlerPtr arkanoi2_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr tnzs_vh_start = new VhStartHandlerPtr() {
        public int handler() {
            int column, x, y;
     ...
     **************************************************************************
     */
    public static VhStopHandlerPtr tnzs_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
            int column;
 ...
 /* for the end of game animation */
    ...
    public static VhUpdateHandlerPtr arkanoi2_vh_screenrefresh = new VhUpdateHandlerPtr() {
    ...
    public static VhUpdateHandlerPtr tnzs_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
