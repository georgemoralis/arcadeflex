...
public class sidepckt {
    ...
    public static WriteHandlerPtr sidepckt_flipscreen_w = new WriteHandlerPtr() {
        public void handler(int offset, int data) {
            flipscreen = data;
            /* The game never seems to write here?! */
        }
    };

    public static VhConvertColorPromHandlerPtr sidepckt_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
     ...
     **************************************************************************
     */
    public static VhStartHandlerPtr sidepckt_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhUpdateHandlerPtr sidepckt_vh_screenrefresh = new VhUpdateHandlerPtr() {
