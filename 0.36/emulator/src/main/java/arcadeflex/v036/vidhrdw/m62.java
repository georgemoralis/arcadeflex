...
public class m62 {
     ...
     **************************************************************************
     */
    public static VhConvertColorPromHandlerPtr irem_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
    ...
    public static VhConvertColorPromHandlerPtr battroad_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
            int i;
    ...
    public static VhConvertColorPromHandlerPtr spelunk2_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
        public void handler(char[] palette, char[] colortable, UBytePtr color_prom) {
            int i;
    ...
    public static VhStartHandlerPtr ldrun_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStartHandlerPtr kidniki_vh_start = new VhStartHandlerPtr() {
        public int handler() {
            return irem_vh_start(512, 256);
        }
    };

    public static VhStartHandlerPtr spelunkr_vh_start = new VhStartHandlerPtr() {
        public int handler() {
 ...
 /* since last time and update it accordingly. */
    ...
    public static VhUpdateHandlerPtr kungfum_vh_screenrefresh = new VhUpdateHandlerPtr() {
    ...
    public static VhUpdateHandlerPtr battroad_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdateHandlerPtr ldrun_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdateHandlerPtr ldrun4_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdateHandlerPtr lotlot_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdateHandlerPtr kidniki_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdateHandlerPtr spelunkr_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
    ...
    public static VhUpdateHandlerPtr spelunk2_vh_screenrefresh = new VhUpdateHandlerPtr() {
        public void handler(osd_bitmap bitmap, int full_refresh) {
