...
public class pacland {
    ...
    public static VhConvertColorPromHandlerPtr pacland_vh_convert_color_prom = new VhConvertColorPromHandlerPtr() {
 ...
 /* the foreground has priority over sprites */
    ...
    public static VhStartHandlerPtr pacland_vh_start = new VhStartHandlerPtr() {
        public int handler() {
    ...
    public static VhStopHandlerPtr pacland_vh_stop = new VhStopHandlerPtr() {
        public void handler() {
    ...
    public static VhUpdateHandlerPtr pacland_vh_screenrefresh = new VhUpdateHandlerPtr() {
